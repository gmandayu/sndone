...
public partial class SnDOne {
    ...
    public class SubAktivitasHasilPemeriksaanPenyaluranLpgEditBase : SubAktivitasHasilPemeriksaanPenyaluranLpg
    {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasHasilPemeriksaanPenyaluranLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasHasilPemeriksaanPenyaluranLpgList") {
                                ...
                                returnUrl = "SubAktivitasHasilPemeriksaanPenyaluranLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
