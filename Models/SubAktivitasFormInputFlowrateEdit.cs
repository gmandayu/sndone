...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputFlowrateEdit
    /// </summary>
    public static SubAktivitasFormInputFlowrateEdit subAktivitasFormInputFlowrateEdit
    {
        get => HttpData.Get<SubAktivitasFormInputFlowrateEdit>("subAktivitasFormInputFlowrateEdit")!;
        set => HttpData["subAktivitasFormInputFlowrateEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputFlowrate
    /// </summary>
    public class SubAktivitasFormInputFlowrateEdit : SubAktivitasFormInputFlowrateEditBase
    {
        // Constructor
        public SubAktivitasFormInputFlowrateEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputFlowrateEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputFlowrateEditBase : SubAktivitasFormInputFlowrate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputFlowrateEdit";
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputFlowrateEdit";
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputFlowrateEdit?.PageRender();
                    }
        }
