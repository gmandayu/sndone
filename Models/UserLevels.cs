...
public partial class SnDOne {
    ...
    /// </summary>
    public class UserLevels : DbTable
    {
        ...
        public UserLevels()
        {
            ...
            UserLevelID.Lookup = new Lookup<DbField>(UserLevelID, "UserLevels", true, "UserLevelID", new List<string> {"UserLevelID", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            UserLevelName.Lookup = new Lookup<DbField>(UserLevelName, "UserLevels", true, "UserLevelName", new List<string> {"UserLevelName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities._UserLevel type", "data");
            row = row.Where(kvp => {
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("UserLevelsDelete", parm)); // DN
        }
        ...
        public async Task RenderEditRow()
        {
            ...
            UserLevelName.EditValue = UserLevelName.CurrentValue;
