...
public partial class SnDOne {
    ...
    /// masterRegionView
    /// </summary>
    public static MasterRegionView masterRegionView
    {
        get => HttpData.Get<MasterRegionView>("masterRegionView")!;
        set => HttpData["masterRegionView"] = value;
    }

    /// <summary>
    /// Page class for MasterRegion
    /// </summary>
    public class MasterRegionView : MasterRegionViewBase
    {
        // Constructor
        public MasterRegionView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterRegionView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterRegionViewBase : MasterRegion
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterRegionView";
        ...
        public MasterRegionViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdRegion"] = keys[0];
            } else {
                RecordKeys["IdRegion"] = RouteValues.TryGetValue("IdRegion", out obj) && obj != null ? UrlDecode(obj) : Get("IdRegion"); // DN
            }
        ...
        // Page name
        public string PageName => "MasterRegionView";
        ...
        // Constructor
        public MasterRegionViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdRegion", out v) && !Empty(v)) { // DN
                IdRegion.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdRegion"] = IdRegion.QueryValue;
            } else if (Get("IdRegion", out sv)) {
                IdRegion.QueryValue = sv.ToString();
                RecordKeys["IdRegion"] = IdRegion.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdRegion.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdRegion"] = IdRegion.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "MasterRegionList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterRegionList"); // Return to list page
                            }
                        }
                    break;
            }
