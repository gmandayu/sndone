...
public partial class SnDOne {
    /// <summary>
    /// masterFungsiKunjungan
    /// </summary>
    [MaybeNull]
    public static MasterFungsiKunjungan masterFungsiKunjungan
    {
        get => HttpData.Resolve<MasterFungsiKunjungan>("MasterFungsiKunjungan");
        set => HttpData["MasterFungsiKunjungan"] = value;
    }

    /// <summary>
    /// Table class for MasterFungsiKunjungan
    /// </summary>
    public class MasterFungsiKunjungan : DbTable
    {
        ...
        public readonly DbField<SqlDbType> FungsiKunjungan;

        // Constructor
        public MasterFungsiKunjungan()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MasterFungsiKunjungan";
            Name = "MasterFungsiKunjungan";
            Type = "TABLE";
            UpdateTable = "dbo.MasterFungsiKunjungan"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new(this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterFungsiKunjungan", "ID", "CustomMsg"),
                IsUpload = false
            };
            ID.Raw = true;
            Fields.Add("ID", ID);
            ...
            // FungsiKunjungan
            FungsiKunjungan = new(this, "x_FungsiKunjungan", 202, SqlDbType.NVarChar) {
                Name = "FungsiKunjungan",
                Expression = "[FungsiKunjungan]",
                UseBasicSearch = true,
                BasicSearchExpression = "[FungsiKunjungan]",
                DateTimeFormat = -1,
                VirtualExpression = "[FungsiKunjungan]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MasterFungsiKunjungan", "FungsiKunjungan", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("FungsiKunjungan", FungsiKunjungan);
        ...
        {
            get => _sqlFrom ?? "dbo.MasterFungsiKunjungan";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MasterFungsiKunjungan type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                FungsiKunjungan.DbValue = row["FungsiKunjungan"]; // Set DB value only
            } catch {}
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "MasterFungsiKunjunganList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MasterFungsiKunjunganView" => Language.Phrase("View"),
                "MasterFungsiKunjunganEdit" => Language.Phrase("Edit"),
                "MasterFungsiKunjunganAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MasterFungsiKunjunganView",
                Config.ApiAddAction => "MasterFungsiKunjunganAdd",
                Config.ApiEditAction => "MasterFungsiKunjunganEdit",
                Config.ApiDeleteAction => "MasterFungsiKunjunganDelete",
                Config.ApiListAction => "MasterFungsiKunjunganList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MasterFungsiKunjunganList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MasterFungsiKunjunganView", parm);
            else
                url = KeyUrl("MasterFungsiKunjunganView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MasterFungsiKunjunganAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MasterFungsiKunjunganAdd?" + parm;
            else
                url = "MasterFungsiKunjunganAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MasterFungsiKunjunganEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterFungsiKunjunganList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MasterFungsiKunjunganAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterFungsiKunjunganList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MasterFungsiKunjunganDelete", parm)); // DN
        }
        ...
        {
            string pageName = "MasterFungsiKunjunganList";
        ...
        public async Task RenderEditRow()
        {
            ...
            FungsiKunjungan.EditValue = FungsiKunjungan.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(FungsiKunjungan);
                    } else {
                        doc.ExportCaption(ID);
                        doc.ExportCaption(FungsiKunjungan);
                    }
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(FungsiKunjungan);
                        } else {
                            await doc.ExportField(ID);
                            await doc.ExportField(FungsiKunjungan);
                        }
