...
public partial class SnDOne {
    ...
    /// masterPlantView
    /// </summary>
    public static MasterPlantView masterPlantView
    {
        get => HttpData.Get<MasterPlantView>("masterPlantView")!;
        set => HttpData["masterPlantView"] = value;
    }

    /// <summary>
    /// Page class for MasterPlant
    /// </summary>
    public class MasterPlantView : MasterPlantViewBase
    {
        // Constructor
        public MasterPlantView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterPlantView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterPlantViewBase : MasterPlant
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterPlantView";
        ...
        public MasterPlantViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdPlant"] = keys[0];
            } else {
                RecordKeys["IdPlant"] = RouteValues.TryGetValue("IdPlant", out obj) && obj != null ? UrlDecode(obj) : Get("IdPlant"); // DN
            }
        ...
        // Page name
        public string PageName => "MasterPlantView";
        ...
        // Constructor
        public MasterPlantViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdPlant", out v) && !Empty(v)) { // DN
                IdPlant.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdPlant"] = IdPlant.QueryValue;
            } else if (Get("IdPlant", out sv)) {
                IdPlant.QueryValue = sv.ToString();
                RecordKeys["IdPlant"] = IdPlant.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdPlant.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdPlant"] = IdPlant.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "MasterPlantList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterPlantList"); // Return to list page
                            }
                        }
                    break;
            }
