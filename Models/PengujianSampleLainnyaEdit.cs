...
public partial class SnDOne {
    ...
    public class PengujianSampleLainnyaEditBase : PengujianSampleLainnya
    {
        ...
        // Constructor
        public PengujianSampleLainnyaEditBase()
        {
        ...
        // Constructor
        public PengujianSampleLainnyaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("PengujianSampleLainnyaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "PengujianSampleLainnyaList") {
                                ...
                                returnUrl = "PengujianSampleLainnyaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'NomorPengujianSampelLainnya' before field var 'x_NomorPengujianSampelLainnya'
            val = CurrentForm.HasValue("NomorPengujianSampelLainnya") ? CurrentForm.GetValue("NomorPengujianSampelLainnya") : CurrentForm.GetValue("x_NomorPengujianSampelLainnya");
            if (!NomorPengujianSampelLainnya.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("NomorPengujianSampelLainnya") && !CurrentForm.HasValue("x_NomorPengujianSampelLainnya")) // DN
                    NomorPengujianSampelLainnya.Visible = false; // Disable update for API request
                else
                    NomorPengujianSampelLainnya.SetFormValue(val);
            }
            ...
            bool validateForm = true;
                if (NomorPengujianSampelLainnya.Visible && NomorPengujianSampelLainnya.Required) {
                    if (!NomorPengujianSampelLainnya.IsDetailKey && Empty(NomorPengujianSampelLainnya.FormValue)) {
                        NomorPengujianSampelLainnya.AddErrorMessage(ConvertToString(NomorPengujianSampelLainnya.RequiredErrorMessage).Replace("%s", NomorPengujianSampelLainnya.Caption));
                    }
                }
