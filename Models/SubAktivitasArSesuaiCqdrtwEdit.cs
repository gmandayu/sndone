...
public partial class SnDOne {
    ...
    public class SubAktivitasArSesuaiCqdrtwEditBase : SubAktivitasArSesuaiCqdrtw
    {
        ...
        // Constructor
        public SubAktivitasArSesuaiCqdrtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasArSesuaiCqdrtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasArSesuaiCqdrtwList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasArSesuaiCqdrtwList") {
                                ...
                                returnUrl = "SubAktivitasArSesuaiCqdrtwList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
