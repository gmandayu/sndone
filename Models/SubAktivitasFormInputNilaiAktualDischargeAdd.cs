...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiAktualDischargeAdd
    /// </summary>
    public static SubAktivitasFormInputNilaiAktualDischargeAdd subAktivitasFormInputNilaiAktualDischargeAdd
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiAktualDischargeAdd>("subAktivitasFormInputNilaiAktualDischargeAdd")!;
        set => HttpData["subAktivitasFormInputNilaiAktualDischargeAdd"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiAktualDischarge
    /// </summary>
    public class SubAktivitasFormInputNilaiAktualDischargeAdd : SubAktivitasFormInputNilaiAktualDischargeAddBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiAktualDischargeAddBase : SubAktivitasFormInputNilaiAktualDischarge
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiAktualDischargeAdd";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeAddBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiAktualDischargeAdd";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeAddBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private string DetermineReturnUrl()
        {
            ...
            else if (GetPageName(returnUrl) == "SubAktivitasFormInputNilaiAktualDischargeView")
                returnUrl = ViewUrl;
            return returnUrl;
        }
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputNilaiAktualDischargeAdd?.PageRender();
                    }
        }
        ...
        private void ValidateCustomuserInput() {
            if (userInput.Visible && userInput.Required) {
                if (!userInput.IsDetailKey && Empty(userInput.FormValue)) {
                    userInput.AddErrorMessage(ConvertToString(Tujuan.RequiredErrorMessage).Replace("%s", Tujuan.Caption));
                }
            }
        }
        ...
        private void ValidateCustometlDate() {
            if (etlDate.Visible && etlDate.Required) {
                if (!etlDate.IsDetailKey && Empty(etlDate.FormValue)) {
                    etlDate.AddErrorMessage(ConvertToString(Tujuan.RequiredErrorMessage).Replace("%s", Tujuan.Caption));
                }
            }
        }
