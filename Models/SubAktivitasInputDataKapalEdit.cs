...
public partial class SnDOne {
    ...
    public class SubAktivitasInputDataKapalEditBase : SubAktivitasInputDataKapal
    {
        ...
        // Constructor
        public SubAktivitasInputDataKapalEditBase()
        {
        ...
        // Constructor
        public SubAktivitasInputDataKapalEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasInputDataKapalList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasInputDataKapalList") {
                                ...
                                returnUrl = "SubAktivitasInputDataKapalList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
