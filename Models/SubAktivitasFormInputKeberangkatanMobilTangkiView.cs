...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputKeberangkatanMobilTangkiViewBase : SubAktivitasFormInputKeberangkatanMobilTangki
    {
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiViewBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputKeberangkatanMobilTangkiList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputKeberangkatanMobilTangkiList"); // Return to list page
                            }
                        }
                    break;
            }
