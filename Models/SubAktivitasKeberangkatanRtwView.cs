...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasKeberangkatanRtwView
    /// </summary>
    public static SubAktivitasKeberangkatanRtwView subAktivitasKeberangkatanRtwView
    {
        get => HttpData.Get<SubAktivitasKeberangkatanRtwView>("subAktivitasKeberangkatanRtwView")!;
        set => HttpData["subAktivitasKeberangkatanRtwView"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasKeberangkatanRTW
    /// </summary>
    public class SubAktivitasKeberangkatanRtwView : SubAktivitasKeberangkatanRtwViewBase
    {
        // Constructor
        public SubAktivitasKeberangkatanRtwView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasKeberangkatanRtwView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasKeberangkatanRtwViewBase : SubAktivitasKeberangkatanRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasKeberangkatanRtwView";
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwViewBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasKeberangkatanRtwView";
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void PageRunEnd()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasKeberangkatanRtwView?.PageRender();
            }
        }
