...
public partial class SnDOne {
    ...
    public class TemplateAktivitasDokumenEditBase : TemplateAktivitasDokumen
    {
        ...
        // Constructor
        public TemplateAktivitasDokumenEditBase(Controller? controller)
        {
        ...
        // Constructor
        public TemplateAktivitasDokumenEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<ActionSetupResult> SetupCurrentAction()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("IdTemplateAktivitasDokumen", out rv)) {
                    IdTemplateAktivitasDokumen.FormValue = UrlDecode(rv);
                ...
                if (!Empty(Post("action"))) {
                    ...
                    if (RouteValues.TryGetValue("IdTemplateAktivitasDokumen", out rv)) {
                        IdTemplateAktivitasDokumen.QueryValue = UrlDecode(rv);
                        loadByQuery = true;
