...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStartPenyaluranLpgEdit
    /// </summary>
    public static SubAktivitasDataStartPenyaluranLpgEdit subAktivitasDataStartPenyaluranLpgEdit
    {
        get => HttpData.Get<SubAktivitasDataStartPenyaluranLpgEdit>("subAktivitasDataStartPenyaluranLpgEdit")!;
        set => HttpData["subAktivitasDataStartPenyaluranLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStartPenyaluranLPG
    /// </summary>
    public class SubAktivitasDataStartPenyaluranLpgEdit : SubAktivitasDataStartPenyaluranLpgEditBase
    {
        // Constructor
        public SubAktivitasDataStartPenyaluranLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStartPenyaluranLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStartPenyaluranLpgEditBase : SubAktivitasDataStartPenyaluranLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStartPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStartPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataStartPenyaluranLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataStartPenyaluranLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataStartPenyaluranLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStartPenyaluranLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataStartPenyaluranLpgList")), "", TableVar, true);
            string pageId = "edit";
