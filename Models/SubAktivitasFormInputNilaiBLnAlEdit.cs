...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputNilaiBLnAlEditBase : SubAktivitasFormInputNilaiBLnAl
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLnAlEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLnAlEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputNilaiBLnAlList"); // No matching record, return to list
                        }
                    break;
