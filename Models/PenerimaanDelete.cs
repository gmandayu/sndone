...
public partial class SnDOne {
    ...
    /// penerimaanDelete
    /// </summary>
    public static PenerimaanDelete penerimaanDelete
    {
        get => HttpData.Get<PenerimaanDelete>("penerimaanDelete")!;
        set => HttpData["penerimaanDelete"] = value;
    }

    /// <summary>
    /// Page class for Penerimaan
    /// </summary>
    public class PenerimaanDelete : PenerimaanDeleteBase
    {
        // Constructor
        public PenerimaanDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenerimaanDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PenerimaanDeleteBase : Penerimaan
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penerimaanDelete";
        ...
        // Page name
        public string PageName => "PenerimaanDelete";
        ...
        // Constructor
        public PenerimaanDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("PenerimaanList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("PenerimaanList"); // Return to list
                }
            }
