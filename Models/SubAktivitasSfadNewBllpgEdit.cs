...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasSfadNewBllpgEdit
    /// </summary>
    public static SubAktivitasSfadNewBllpgEdit subAktivitasSfadNewBllpgEdit
    {
        get => HttpData.Get<SubAktivitasSfadNewBllpgEdit>("subAktivitasSfadNewBllpgEdit")!;
        set => HttpData["subAktivitasSfadNewBllpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasSFADNewBLLPG
    /// </summary>
    public class SubAktivitasSfadNewBllpgEdit : SubAktivitasSfadNewBllpgEditBase
    {
        // Constructor
        public SubAktivitasSfadNewBllpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasSfadNewBllpgEdit() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasSfadNewBllpgEditBase : SubAktivitasSfadNewBllpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasSfadNewBllpgEdit";
        ...
        // Constructor
        public SubAktivitasSfadNewBllpgEditBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasSfadNewBllpgEdit";
        ...
        // Constructor
        public SubAktivitasSfadNewBllpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasSfadNewBllpgList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "SubAktivitasSfadNewBllpgList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasSfadNewBllpgList") {
                                ...
                                returnUrl = "SubAktivitasSfadNewBllpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasSfadNewBllpgEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasSfadNewBllpgList")), "", TableVar, true);
            string pageId = "edit";
