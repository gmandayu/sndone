...
public partial class SnDOne {
    ...
    public class MasterTangkiViewBase : MasterTangki
    {
        ...
        // Constructor
        public MasterTangkiViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MasterTangkiList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterTangkiList"); // Return to list page
                            }
                        }
                    break;
            }
