...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasKeberangkatanRtwAdd
    /// </summary>
    public static SubAktivitasKeberangkatanRtwAdd subAktivitasKeberangkatanRtwAdd
    {
        get => HttpData.Get<SubAktivitasKeberangkatanRtwAdd>("subAktivitasKeberangkatanRtwAdd")!;
        set => HttpData["subAktivitasKeberangkatanRtwAdd"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasKeberangkatanRTW
    /// </summary>
    public class SubAktivitasKeberangkatanRtwAdd : SubAktivitasKeberangkatanRtwAddBase
    {
        // Constructor
        public SubAktivitasKeberangkatanRtwAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasKeberangkatanRtwAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasKeberangkatanRtwAddBase : SubAktivitasKeberangkatanRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasKeberangkatanRtwAdd";
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwAddBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasKeberangkatanRtwAdd";
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasKeberangkatanRtwList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "SubAktivitasKeberangkatanRtwView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanRtwList") {
                                ...
                                returnUrl = "SubAktivitasKeberangkatanRtwList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasKeberangkatanRtwAdd?.PageRender();
            }
            return PageResult();
        }
