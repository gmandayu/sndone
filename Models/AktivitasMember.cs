...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static AktivitasMember aktivitasMember
    {
        get => HttpData.Resolve<AktivitasMember>("AktivitasMember");
        set => HttpData["AktivitasMember"] = value;
    }

    /// <summary>
    /// Table class for AktivitasMember
    /// </summary>
    public class AktivitasMember : DbTable
    {
        public override Dictionary<string, string> KeyFields { get; set; } = new() { // DN
            { "IdAktivitasMember", "IdAktivitasMember" },
        };
        ...
        public readonly DbField<SqlDbType> IdAktivitasMember;
        ...
        // Constructor
        public AktivitasMember()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "AktivitasMember";
            Name = "AktivitasMember";
            Type = "TABLE";
            UpdateTable = "dbo.AktivitasMember"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // IdAktivitasMember
            IdAktivitasMember = new(this, "x_IdAktivitasMember", 3, SqlDbType.Int) {
                Name = "IdAktivitasMember",
                Expression = "[IdAktivitasMember]",
                BasicSearchExpression = "CAST([IdAktivitasMember] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[IdAktivitasMember]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("AktivitasMember", "IdAktivitasMember", "CustomMsg"),
                IsUpload = false
            };
            IdAktivitasMember.Raw = true;
            Fields.Add("IdAktivitasMember", IdAktivitasMember);
            ...
            IdAktivitas = new(this, "x_IdAktivitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("AktivitasMember", "IdAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            _Username = new(this, "x__Username", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>"],
                CustomMessage = Language.FieldPhrase("AktivitasMember", "_Username", "CustomMsg"),
                IsUpload = false
            };
            _Username.Lookup = new Lookup<DbField>(_Username, "MasterUser", true, "Username", new List<string> {"Username", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[Username]");
            ...
            Peran = new(this, "x_Peran", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("AktivitasMember", "Peran", "CustomMsg"),
                IsUpload = false
            };
            Peran.Lookup = new Lookup<DbField>(Peran, "AktivitasMember", true, "Peran", new List<string> {"Peran", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("AktivitasMember", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            DibuatOleh.Lookup = new Lookup<DbField>(DibuatOleh, "AktivitasMember", true, "DibuatOleh", new List<string> {"DibuatOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("AktivitasMember", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            TanggalDibuat.Raw = true;
            TanggalDibuat.Lookup = new Lookup<DbField>(TanggalDibuat, "AktivitasMember", true, "TanggalDibuat", new List<string> {"TanggalDibuat", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("AktivitasMember", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            DiperbaruiOleh.Lookup = new Lookup<DbField>(DiperbaruiOleh, "AktivitasMember", true, "DiperbaruiOleh", new List<string> {"DiperbaruiOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("AktivitasMember", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiperbarui.Raw = true;
            TanggalDiperbarui.Lookup = new Lookup<DbField>(TanggalDiperbarui, "AktivitasMember", true, "TanggalDiperbarui", new List<string> {"TanggalDiperbarui", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        {
            get => _sqlFrom ?? "dbo.AktivitasMember";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.AktivitasMember type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdAktivitasMember"))
                    row["IdAktivitasMember"] = lastInsertedId;
                else
                    row.Add("IdAktivitasMember", lastInsertedId);
                IdAktivitasMember.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                IdAktivitasMember.DbValue = row["IdAktivitasMember"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[IdAktivitasMember] = @IdAktivitasMember@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "AktivitasMemberView" => Language.Phrase("View"),
                "AktivitasMemberEdit" => Language.Phrase("Edit"),
                "AktivitasMemberAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "AktivitasMemberView",
                Config.ApiAddAction => "AktivitasMemberAdd",
                Config.ApiEditAction => "AktivitasMemberEdit",
                Config.ApiDeleteAction => "AktivitasMemberDelete",
                Config.ApiListAction => "AktivitasMemberList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "AktivitasMemberList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("AktivitasMemberView", parm);
            else
                url = KeyUrl("AktivitasMemberView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "AktivitasMemberAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "AktivitasMemberAdd?" + parm;
            else
                url = "AktivitasMemberAdd";
        ...
        {
            string url = "";
            url = KeyUrl("AktivitasMemberEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("AktivitasMemberList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("AktivitasMemberAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("AktivitasMemberList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("AktivitasMemberDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdAktivitasMember\":" + ConvertToJson(IdAktivitasMember.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdAktivitasMember.CurrentValue)) {
                url += "/" + IdAktivitasMember.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdAktivitasMember", out object? v0)) { // IdAktivitasMember // DN
                    key = UrlDecode(v0); // DN
                } else if (IsApi() && !Empty(keyValues)) {
                    key = keyValues[0];
                } else {
                    key = Param("IdAktivitasMember");
                }
                keysList.Add(key);
            }
            // Check keys
            foreach (var keys in keysList) {
                if (KeyFields.Count > 1 && (!IsArray(keys) || keys.Length != KeyFields.Count))
                    continue;
                if (!IsNumeric(keys)) // IdAktivitasMember
                    continue;
                result.Add(keys);
            }
            return result;
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdAktivitasMember.CurrentValue = keys;
                else
                    IdAktivitasMember.OldValue = keys;
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            IdAktivitasMember.SetDbValue(row["IdAktivitasMember"]);
        ...
        {
            string pageName = "AktivitasMemberList";
        ...
        public async Task RenderListRow()
        {
            ...
            // IdAktivitasMember
            IdAktivitasMember.ViewValue = IdAktivitasMember.CurrentValue;
            ...
            // Username
            List<object?>? listWrk2 = [ // DN
                _Username.CurrentValue,
                _Username.CurrentValue,
            ];
            listWrk2 = _Username.Lookup?.RenderViewRow(listWrk2, this);
            ...
            // IdAktivitasMember
            IdAktivitasMember.HrefValue = "";
            IdAktivitasMember.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // IdAktivitasMember
            IdAktivitasMember.SetupEditAttributes();
            IdAktivitasMember.EditValue = IdAktivitasMember.CurrentValue;
            IdAktivitasMember.ViewCustomAttributes = "";
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(IdAktivitasMember);
                        doc.ExportCaption(IdAktivitas);
                        doc.ExportCaption(_Username);
                        doc.ExportCaption(Peran);
                        doc.ExportCaption(DibuatOleh);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(IdAktivitasMember);
                            await doc.ExportField(IdAktivitas);
                            await doc.ExportField(_Username);
                            await doc.ExportField(Peran);
                            await doc.ExportField(DibuatOleh);
