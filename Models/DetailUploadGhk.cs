...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static DetailUploadGhk detailUploadGhk
    {
        get => HttpData.Resolve<DetailUploadGhk>("DetailUploadGHK");
        set => HttpData["DetailUploadGHK"] = value;
    }

    /// <summary>
    /// Table class for DetailUploadGHK
    /// </summary>
    public class DetailUploadGhk : DbTable
    {
        ...
        public readonly DbField<SqlDbType> idGHK;
        ...
        // Constructor
        public DetailUploadGhk()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "DetailUploadGHK";
            Name = "DetailUploadGHK";
            Type = "TABLE";
            UpdateTable = "dbo.DetailUploadGHK"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("DetailUploadGHK", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            // idGHK
            idGHK = new(this, "x_idGHK", 3, SqlDbType.Int) {
                Name = "idGHK",
                Expression = "[idGHK]",
                BasicSearchExpression = "CAST([idGHK] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[idGHK]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("DetailUploadGHK", "idGHK", "CustomMsg"),
                IsUpload = false
            };
            idGHK.Raw = true;
            Fields.Add("idGHK", idGHK);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("DetailUploadGHK", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            FileName = new(this, "x_FileName", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadGHK", "FileName", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadGHK", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadGHK", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadGHK", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadGHK", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.DetailUploadGHK";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.DetailUploadGhk type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                idGHK.DbValue = row["idGHK"]; // Set DB value only
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "DetailUploadGhkView" => Language.Phrase("View"),
                "DetailUploadGhkEdit" => Language.Phrase("Edit"),
                "DetailUploadGhkAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "DetailUploadGhkView",
                Config.ApiAddAction => "DetailUploadGhkAdd",
                Config.ApiEditAction => "DetailUploadGhkEdit",
                Config.ApiDeleteAction => "DetailUploadGhkDelete",
                Config.ApiListAction => "DetailUploadGhkList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "DetailUploadGhkList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("DetailUploadGhkView", parm);
            else
                url = KeyUrl("DetailUploadGhkView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "DetailUploadGhkAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "DetailUploadGhkAdd?" + parm;
            else
                url = "DetailUploadGhkAdd";
        ...
        {
            string url = "";
            url = KeyUrl("DetailUploadGhkEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("DetailUploadGhkList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("DetailUploadGhkAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("DetailUploadGhkList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("DetailUploadGhkDelete", parm)); // DN
        }
        ...
        {
            string pageName = "DetailUploadGhkList";
        ...
        public async Task RenderListRow()
        {
            ...
            // idGHK
            idGHK.ViewValue = idGHK.CurrentValue;
            idGHK.ViewValue = FormatNumber(idGHK.ViewValue, idGHK.FormatPattern);
            idGHK.ViewCustomAttributes = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // idGHK
            idGHK.SetupEditAttributes();
            idGHK.EditValue = idGHK.CurrentValue;
            idGHK.PlaceHolder = RemoveHtml(idGHK.Caption);
            if (!Empty(idGHK.EditValue) && IsNumeric(idGHK.EditValue))
                idGHK.EditValue = FormatNumber(idGHK.EditValue, null);
