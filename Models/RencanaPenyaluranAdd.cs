...
public partial class SnDOne {
    ...
    public class RencanaPenyaluranAddBase : RencanaPenyaluran
    {
        ...
        // Constructor
        public RencanaPenyaluranAddBase()
        {
        ...
        // Constructor
        public RencanaPenyaluranAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("RencanaPenyaluranList"); // No matching record, return to List page // DN
                    }
                    break;
