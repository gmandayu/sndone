...
public partial class SnDOne {
    ...
    public class RencanaPenyaluranViewBase : RencanaPenyaluran
    {
        ...
        // Constructor
        public RencanaPenyaluranViewBase(Controller? controller)
        {
        ...
        // Constructor
        public RencanaPenyaluranViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdRencanaPenyaluran", out v) && !Empty(v))
                {
                IdRencanaPenyaluran.QueryValue = UrlDecode(v);
                RecordKeys["IdRencanaPenyaluran"] = IdRencanaPenyaluran.QueryValue;
                return;
                }
                if (Get("IdRencanaPenyaluran", out sv))
                {
