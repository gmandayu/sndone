...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasKeberangkatanKapalPenyaluranLpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasKeberangkatanKapalPenyaluranLpg subAktivitasKeberangkatanKapalPenyaluranLpg
    {
        get => HttpData.Resolve<SubAktivitasKeberangkatanKapalPenyaluranLpg>("SubAktivitasKeberangkatanKapalPenyaluranLPG");
        set => HttpData["SubAktivitasKeberangkatanKapalPenyaluranLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasKeberangkatanKapalPenyaluranLPG
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenyaluranLpg : DbTable
    {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasKeberangkatanKapalPenyaluranLPG";
            Name = "SubAktivitasKeberangkatanKapalPenyaluranLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasKeberangkatanKapalPenyaluranLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranLPG", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasKeberangkatanKapalPenyaluranLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasKeberangkatanKapalPenyaluranLpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasKeberangkatanKapalPenyaluranLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasKeberangkatanKapalPenyaluranLpgView" => Language.Phrase("View"),
                "SubAktivitasKeberangkatanKapalPenyaluranLpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasKeberangkatanKapalPenyaluranLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasKeberangkatanKapalPenyaluranLpgView",
                Config.ApiAddAction => "SubAktivitasKeberangkatanKapalPenyaluranLpgAdd",
                Config.ApiEditAction => "SubAktivitasKeberangkatanKapalPenyaluranLpgEdit",
                Config.ApiDeleteAction => "SubAktivitasKeberangkatanKapalPenyaluranLpgDelete",
                Config.ApiListAction => "SubAktivitasKeberangkatanKapalPenyaluranLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasKeberangkatanKapalPenyaluranLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranLpgView", parm);
            else
                url = KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasKeberangkatanKapalPenyaluranLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasKeberangkatanKapalPenyaluranLpgAdd?" + parm;
            else
                url = "SubAktivitasKeberangkatanKapalPenyaluranLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasKeberangkatanKapalPenyaluranLpgList";
