...
public partial class SnDOne {
    ...
    public class SubAktivitasStopBongkarLpgEditBase : SubAktivitasStopBongkarLpg
    {
        ...
        // Constructor
        public SubAktivitasStopBongkarLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasStopBongkarLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasStopBongkarLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasStopBongkarLpgList") {
                                ...
                                returnUrl = "SubAktivitasStopBongkarLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
