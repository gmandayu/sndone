...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEditBase : SubAktivitasNilaiNewBlsfadsfblstsPyrBbm
    {
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList") {
                        ...
                        returnUrl = "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
