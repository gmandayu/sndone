...
public partial class SnDOne {
    ...
    public class SubaktivitasNilaiLoadedFigurePipaListBase : SubaktivitasNilaiLoadedFigurePipa
    {
        ...
        // Constructor
        public SubaktivitasNilaiLoadedFigurePipaListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubaktivitasNilaiLoadedFigurePipaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field klobs
            if (filter.TryGetValue("x_klobs", out sv)) {
                RestoreFieldFilter(klobs, filter, "klobs", sv);
            }

            // Field kl15
            if (filter.TryGetValue("x_kl15", out sv)) {
                RestoreFieldFilter(kl15, filter, "kl15", sv);
            }
