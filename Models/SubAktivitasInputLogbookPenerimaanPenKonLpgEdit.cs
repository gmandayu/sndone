...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputLogbookPenerimaanPenKonLpgEdit
    /// </summary>
    public static SubAktivitasInputLogbookPenerimaanPenKonLpgEdit subAktivitasInputLogbookPenerimaanPenKonLpgEdit
    {
        get => HttpData.Get<SubAktivitasInputLogbookPenerimaanPenKonLpgEdit>("subAktivitasInputLogbookPenerimaanPenKonLpgEdit")!;
        set => HttpData["subAktivitasInputLogbookPenerimaanPenKonLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasInputLogbookPenerimaanPenKonLPG
    /// </summary>
    public class SubAktivitasInputLogbookPenerimaanPenKonLpgEdit : SubAktivitasInputLogbookPenerimaanPenKonLpgEditBase
    {
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasInputLogbookPenerimaanPenKonLpgEditBase : SubAktivitasInputLogbookPenerimaanPenKonLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasInputLogbookPenerimaanPenKonLpgEdit";
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonLpgEditBase(Controller? controller)
        {
            TableName = "SubAktivitasInputLogbookPenerimaanPenKonLPG";
        ...
        if (controller != null)
            ...
            // Table object (subAktivitasInputLogbookPenerimaanPenKonLpg)
            if (subAktivitasInputLogbookPenerimaanPenKonLpg == null || subAktivitasInputLogbookPenerimaanPenKonLpg is SubAktivitasInputLogbookPenerimaanPenKonLpg)
                subAktivitasInputLogbookPenerimaanPenKonLpg = this;
        ...
        // Page name
        public string PageName => "SubAktivitasInputLogbookPenerimaanPenKonLpgEdit";
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonLpgEditBase() : this(null) { }
            ...
            string pageName = GetPageName(url);
                ...
                // List / View / Master View page
                    if (!SameString(pageName, ListUrl))
                    {
                        ...
                        result.Add("view", pageName == "SubAktivitasInputLogbookPenerimaanPenKonLpgView" ? "1" : "0"); // If View page, no primary button
                    }
                    else
                    {
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasInputLogbookPenerimaanPenKonLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasInputLogbookPenerimaanPenKonLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasInputLogbookPenerimaanPenKonLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasInputLogbookPenerimaanPenKonLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasInputLogbookPenerimaanPenKonLpgList")), "", TableVar, true);
            string pageId = "edit";
