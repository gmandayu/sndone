...
/**
 * Entity class for "SubAktivitasLogbookPenerimaanSTSPymBBM" table
 */
[Table("SubAktivitasLogbookPenerimaanSTSPymBBM")]
public class SubAktivitasLogbookPenerimaanStspymBbm
{
    [Key("id")]
