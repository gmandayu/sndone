...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiBLsesuaiCqlTruckList
    /// </summary>
    public static SubAktivitasFormInputNilaiBLsesuaiCqlTruckList subAktivitasFormInputNilaiBLsesuaiCqlTruckList
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiBLsesuaiCqlTruckList>("subAktivitasFormInputNilaiBLsesuaiCqlTruckList")!;
        set => HttpData["subAktivitasFormInputNilaiBLsesuaiCqlTruckList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiBLsesuaiCQLTruck
    /// </summary>
    public class SubAktivitasFormInputNilaiBLsesuaiCqlTruckList : SubAktivitasFormInputNilaiBLsesuaiCqlTruckListBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiBLsesuaiCqlTruckListBase : SubAktivitasFormInputNilaiBLsesuaiCqlTruck
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiBLsesuaiCqlTruckList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasFormInputNilaiBLsesuaiCQLTrucklist";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckListBase()
        {
            TableName = "SubAktivitasFormInputNilaiBLsesuaiCQLTruck";

            // CSS class name as context
            TableVar = "SubAktivitasFormInputNilaiBLsesuaiCQLTruck";
            ...
            // Table object (subAktivitasFormInputNilaiBLsesuaiCqlTruck)
            if (subAktivitasFormInputNilaiBLsesuaiCqlTruck == null || subAktivitasFormInputNilaiBLsesuaiCqlTruck is SubAktivitasFormInputNilaiBLsesuaiCqlTruck)
                subAktivitasFormInputNilaiBLsesuaiCqlTruck = this;

            // Initialize URLs
            AddUrl = "SubAktivitasFormInputNilaiBLsesuaiCqlTruckAdd";
            ...
            MultiDeleteUrl = "SubAktivitasFormInputNilaiBLsesuaiCqlTruckDelete";
            MultiUpdateUrl = "SubAktivitasFormInputNilaiBLsesuaiCqlTruckUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiBLsesuaiCqlTruckList";
        ...
        public void SetVisibility()
        {
            ...
            TotalPenyaluran.SetVisibility();
        }

        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasFormInputNilaiBLsesuaiCqlTruckView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasFormInputNilaiBLsesuaiCQLTruckgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputNilaiBLsesuaiCqlTruckList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(TotalPenyaluran.AdvancedSearch.ToJson())); // Field TotalPenyaluran
        ...
        protected bool RestoreFilterList() {
            ...
            // Field TotalPenyaluran
            if (filter?.TryGetValue("x_TotalPenyaluran", out sv) ?? false) {
                TotalPenyaluran.AdvancedSearch.SearchValue = sv;
                TotalPenyaluran.AdvancedSearch.SearchOperator = filter["z_TotalPenyaluran"];
                TotalPenyaluran.AdvancedSearch.SearchCondition = filter["v_TotalPenyaluran"];
                TotalPenyaluran.AdvancedSearch.SearchValue2 = filter["y_TotalPenyaluran"];
                TotalPenyaluran.AdvancedSearch.SearchOperator2 = filter["w_TotalPenyaluran"];
                TotalPenyaluran.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(TotalPenyaluran);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(TotalPenyaluran, ctrl); // TotalPenyaluran
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasFormInputNilaiBLsesuaiCQLTruck"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputNilaiBLsesuaiCQLTrucklist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputNilaiBLsesuaiCQLTrucklist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("TotalPenyaluran")); // DN
            }
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasFormInputNilaiBLsesuaiCQLTrucksrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasFormInputNilaiBLsesuaiCQLTrucksrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputNilaiBLsesuaiCQLTrucklist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasFormInputNilaiBLsesuaiCQLTruck");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasFormInputNilaiBLsesuaiCqlTruckList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasFormInputNilaiBLsesuaiCqlTruckList.RowCount) + "_SubAktivitasFormInputNilaiBLsesuaiCQLTruck");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasFormInputNilaiBLsesuaiCqlTruckList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasFormInputNilaiBLsesuaiCqlTruckList.RowType == RowType.Add || IsEdit && subAktivitasFormInputNilaiBLsesuaiCqlTruckList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            TotalPenyaluran.SetDbValue(row["TotalPenyaluran"]);
        }
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("TotalPenyaluran", TotalPenyaluran.DefaultValue ?? DbNullValue); // DN
            return row;
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // TotalPenyaluran
                TotalPenyaluran.ViewValue = ConvertToString(TotalPenyaluran.CurrentValue); // DN
                TotalPenyaluran.ViewCustomAttributes = "";
                ...
                // TotalPenyaluran
                TotalPenyaluran.HrefValue = "";
                TotalPenyaluran.TooltipValue = "";
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasFormInputNilaiBLsesuaiCQLTrucklist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasFormInputNilaiBLsesuaiCQLTrucklist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasFormInputNilaiBLsesuaiCQLTrucklist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
