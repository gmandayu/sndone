...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasRealisasiPenyaluranPerProdukEdit
    /// </summary>
    public static SubAktivitasRealisasiPenyaluranPerProdukEdit subAktivitasRealisasiPenyaluranPerProdukEdit
    {
        get => HttpData.Get<SubAktivitasRealisasiPenyaluranPerProdukEdit>("subAktivitasRealisasiPenyaluranPerProdukEdit")!;
        set => HttpData["subAktivitasRealisasiPenyaluranPerProdukEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasRealisasiPenyaluranPerProduk
    /// </summary>
    public class SubAktivitasRealisasiPenyaluranPerProdukEdit : SubAktivitasRealisasiPenyaluranPerProdukEditBase
    {
        // Constructor
        public SubAktivitasRealisasiPenyaluranPerProdukEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasRealisasiPenyaluranPerProdukEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasRealisasiPenyaluranPerProdukEditBase : SubAktivitasRealisasiPenyaluranPerProduk
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasRealisasiPenyaluranPerProdukEdit";
        ...
        // Constructor
        public SubAktivitasRealisasiPenyaluranPerProdukEditBase(Controller? controller)
        {
            TableName = "SubAktivitasRealisasiPenyaluranPerProduk";
        ...
        if (controller != null)
            ...
            // Table object (subAktivitasRealisasiPenyaluranPerProduk)
            if (subAktivitasRealisasiPenyaluranPerProduk == null || subAktivitasRealisasiPenyaluranPerProduk is SubAktivitasRealisasiPenyaluranPerProduk)
                subAktivitasRealisasiPenyaluranPerProduk = this;
        ...
        // Page name
        public string PageName => "SubAktivitasRealisasiPenyaluranPerProdukEdit";
        ...
        public void SetVisibility()
        {
            ...
            Shift1.SetVisibility();
            Shift2.SetVisibility();
            Shift3.SetVisibility();
            Shift4.SetVisibility();
            Total.SetVisibility();
        ...
        // Constructor
        public SubAktivitasRealisasiPenyaluranPerProdukEditBase() : this(null) { }
            ...
            string pageName = GetPageName(url);
                ...
                // List / View / Master View page
                    if (!SameString(pageName, ListUrl))
                    {
                        ...
                        result.Add("view", pageName == "SubAktivitasRealisasiPenyaluranPerProdukView" ? "1" : "0"); // If View page, no primary button
                    }
                    else
                    {
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasRealisasiPenyaluranPerProdukList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasRealisasiPenyaluranPerProdukList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasRealisasiPenyaluranPerProdukList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasRealisasiPenyaluranPerProdukEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'Shift1'
            Shift1.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(Shift1, "Shift1", "x_Shift1");

            // Standard handling for 'Shift2'
            Shift2.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(Shift2, "Shift2", "x_Shift2");

            // Standard handling for 'Shift3'
            Shift3.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(Shift3, "Shift3", "x_Shift3");

            // Standard handling for 'Shift4'
            Shift4.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(Shift4, "Shift4", "x_Shift4");
        ...
        public void RestoreFormValues()
        {
            ...
            Shift1.CurrentValue = Shift1.FormValue;
            Shift2.CurrentValue = Shift2.FormValue;
            Shift3.CurrentValue = Shift3.FormValue;
            Shift4.CurrentValue = Shift4.FormValue;
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            Shift1.SetDbValue(row["Shift1"]);
            Shift2.SetDbValue(row["Shift2"]);
            Shift3.SetDbValue(row["Shift3"]);
            Shift4.SetDbValue(row["Shift4"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("Shift1", Shift1.DefaultValue ?? DbNullValue); // DN
            row.Add("Shift2", Shift2.DefaultValue ?? DbNullValue); // DN
            row.Add("Shift3", Shift3.DefaultValue ?? DbNullValue); // DN
            row.Add("Shift4", Shift4.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            // Shift1
            Shift1.RowCssClass = "row";

            // Shift2
            Shift2.RowCssClass = "row";

            // Shift3
            Shift3.RowCssClass = "row";

            // Shift4
            Shift4.RowCssClass = "row";
            ...
            if (RowType == RowType.View) {
                ...
                // lastUpdatedDate
                    ...
                    // Shift1
                    Shift1.ViewValue = ConvertToString(Shift1.CurrentValue); // DN
                    Shift1.ViewCustomAttributes = "";

                    // Shift2
                    Shift2.ViewValue = ConvertToString(Shift2.CurrentValue); // DN
                    Shift2.ViewCustomAttributes = "";

                    // Shift3
                    Shift3.ViewValue = ConvertToString(Shift3.CurrentValue); // DN
                    Shift3.ViewCustomAttributes = "";

                    // Shift4
                    Shift4.ViewValue = ConvertToString(Shift4.CurrentValue); // DN
                    Shift4.ViewCustomAttributes = "";
                ...
                // Shift1
                Shift1.SetupEditAttributes();
                if (!Shift1.Raw)
                    Shift1.CurrentValue = HtmlDecode(Shift1.CurrentValue);
                Shift1.EditValue = HtmlEncode(Shift1.CurrentValue);
                Shift1.PlaceHolder = RemoveHtml(Shift1.Caption);

                // Shift2
                Shift2.SetupEditAttributes();
                if (!Shift2.Raw)
                    Shift2.CurrentValue = HtmlDecode(Shift2.CurrentValue);
                Shift2.EditValue = HtmlEncode(Shift2.CurrentValue);
                Shift2.PlaceHolder = RemoveHtml(Shift2.Caption);

                // Shift3
                Shift3.SetupEditAttributes();
                if (!Shift3.Raw)
                    Shift3.CurrentValue = HtmlDecode(Shift3.CurrentValue);
                Shift3.EditValue = HtmlEncode(Shift3.CurrentValue);
                Shift3.PlaceHolder = RemoveHtml(Shift3.Caption);

                // Shift4
                Shift4.SetupEditAttributes();
                if (!Shift4.Raw)
                    Shift4.CurrentValue = HtmlDecode(Shift4.CurrentValue);
                Shift4.EditValue = HtmlEncode(Shift4.CurrentValue);
                Shift4.PlaceHolder = RemoveHtml(Shift4.Caption);
        ...
        private void ValidateCustomShift1() {
            if (Shift1.Visible && Shift1.Required) {
                if (!Shift1.IsDetailKey && Empty(Shift1.FormValue)) {
                    Shift1.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }

        private void ValidateCustomShift2() {
            if (Shift2.Visible && Shift2.Required) {
                if (!Shift2.IsDetailKey && Empty(Shift2.FormValue)) {
                    Shift2.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }

        private void ValidateCustomShift3() {
            if (Shift3.Visible && Shift3.Required) {
                if (!Shift3.IsDetailKey && Empty(Shift3.FormValue)) {
                    Shift3.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }

        private void ValidateCustomShift4() {
            if (Shift4.Visible && Shift4.Required) {
                if (!Shift4.IsDetailKey && Empty(Shift4.FormValue)) {
                    Shift4.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustomTotal() {
            if (Total.Visible && Total.Required) {
                if (!Total.IsDetailKey && Empty(Total.FormValue)) {
                    Total.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ...
                ValidateCustomShift1();
                ValidateCustomShift2();
                ValidateCustomShift3();
                ValidateCustomShift4();
                ValidateCustomTotal();
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // Shift1
            Shift1.SetDbValue(rsnew, Shift1.CurrentValue, Shift1.ReadOnly);

            // Shift2
            Shift2.SetDbValue(rsnew, Shift2.CurrentValue, Shift2.ReadOnly);

            // Shift3
            Shift3.SetDbValue(rsnew, Shift3.CurrentValue, Shift3.ReadOnly);

            // Shift4
            Shift4.SetDbValue(rsnew, Shift4.CurrentValue, Shift4.ReadOnly);
        ...
        protected void RestoreEditFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("Shift1", out value)) // Shift1
                Shift1.CurrentValue = value;
            if (row.TryGetValue("Shift2", out value)) // Shift2
                Shift2.CurrentValue = value;
            if (row.TryGetValue("Shift3", out value)) // Shift3
                Shift3.CurrentValue = value;
            if (row.TryGetValue("Shift4", out value)) // Shift4
                Shift4.CurrentValue = value;
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasRealisasiPenyaluranPerProdukList")), "", TableVar, true);
            string pageId = "edit";
