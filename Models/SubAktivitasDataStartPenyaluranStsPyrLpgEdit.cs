...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStartPenyaluranStsPyrLpgEdit
    /// </summary>
    public static SubAktivitasDataStartPenyaluranStsPyrLpgEdit subAktivitasDataStartPenyaluranStsPyrLpgEdit
    {
        get => HttpData.Get<SubAktivitasDataStartPenyaluranStsPyrLpgEdit>("subAktivitasDataStartPenyaluranStsPyrLpgEdit")!;
        set => HttpData["subAktivitasDataStartPenyaluranStsPyrLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStartPenyaluranSTSPyrLPG
    /// </summary>
    public class SubAktivitasDataStartPenyaluranStsPyrLpgEdit : SubAktivitasDataStartPenyaluranStsPyrLpgEditBase
    {
        // Constructor
        public SubAktivitasDataStartPenyaluranStsPyrLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStartPenyaluranStsPyrLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStartPenyaluranStsPyrLpgEditBase : SubAktivitasDataStartPenyaluranStsPyrLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStartPenyaluranStsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranStsPyrLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStartPenyaluranStsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranStsPyrLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataStartPenyaluranStsPyrLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataStartPenyaluranStsPyrLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataStartPenyaluranStsPyrLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStartPenyaluranStsPyrLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataStartPenyaluranStsPyrLpgList")), "", TableVar, true);
            string pageId = "edit";
