...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataGerbongKetelRtw
    /// </summary>
    [MaybeNull]
    public static SubAktivitasFormInputDataGerbongKetelRtw subAktivitasFormInputDataGerbongKetelRtw
    {
        get => HttpData.Resolve<SubAktivitasFormInputDataGerbongKetelRtw>("SubAktivitasFormInputDataGerbongKetelRTW");
        set => HttpData["SubAktivitasFormInputDataGerbongKetelRTW"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasFormInputDataGerbongKetelRTW
    /// </summary>
    public class SubAktivitasFormInputDataGerbongKetelRtw : DbTable
    {
        ...
        public readonly DbField<SqlDbType> Jns_Produk;

        public readonly DbField<SqlDbType> Nominasi;

        public readonly DbField<SqlDbType> Tanggal;

        public readonly DbField<SqlDbType> DetailGerbong;

        public readonly DbField<SqlDbType> userInput;

        public readonly DbField<SqlDbType> etlDate;

        public readonly DbField<SqlDbType> DetailQuantity;

        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtw()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasFormInputDataGerbongKetelRTW";
            Name = "SubAktivitasFormInputDataGerbongKetelRTW";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasFormInputDataGerbongKetelRTW"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            // Jns_Produk
            Jns_Produk = new(this, "x_Jns_Produk", 202, SqlDbType.NVarChar) {
                Name = "Jns_Produk",
                Expression = "[Jns_Produk]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Jns_Produk]",
                DateTimeFormat = -1,
                VirtualExpression = "[Jns_Produk]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "Jns_Produk", "CustomMsg"),
                IsUpload = false
            };
            Jns_Produk.Lookup = new Lookup<DbField>(Jns_Produk, "MasterProduk", false, "NoProduk", new List<string> {"NoProduk", "NamaProduk", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "CONCAT([NoProduk],'" + ValueSeparator(1, Jns_Produk) + "',[NamaProduk])");
            Fields.Add("Jns_Produk", Jns_Produk);
            ...
            Nominasi = new(this, "x_Nominasi", 202, SqlDbType.NVarChar) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "Nominasi", "CustomMsg"),
                IsUpload = false
            };
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            ...
            // DetailGerbong
            DetailGerbong = new(this, "x_DetailGerbong", 202, SqlDbType.NVarChar) {
                Name = "DetailGerbong",
                Expression = "[DetailGerbong]",
                UseBasicSearch = true,
                BasicSearchExpression = "[DetailGerbong]",
                DateTimeFormat = -1,
                VirtualExpression = "[DetailGerbong]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "DetailGerbong", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("DetailGerbong", DetailGerbong);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            // DetailQuantity
            DetailQuantity = new(this, "x_DetailQuantity", 202, SqlDbType.NVarChar) {
                Name = "DetailQuantity",
                Expression = "[DetailQuantity]",
                UseBasicSearch = true,
                BasicSearchExpression = "[DetailQuantity]",
                DateTimeFormat = -1,
                VirtualExpression = "[DetailQuantity]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputDataGerbongKetelRTW", "DetailQuantity", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("DetailQuantity", DetailQuantity);
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasFormInputDataGerbongKetelRTW";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasFormInputDataGerbongKetelRtw type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasFormInputDataGerbongKetelRtwList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasFormInputDataGerbongKetelRtwView" => Language.Phrase("View"),
                "SubAktivitasFormInputDataGerbongKetelRtwEdit" => Language.Phrase("Edit"),
                "SubAktivitasFormInputDataGerbongKetelRtwAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasFormInputDataGerbongKetelRtwView",
                Config.ApiAddAction => "SubAktivitasFormInputDataGerbongKetelRtwAdd",
                Config.ApiEditAction => "SubAktivitasFormInputDataGerbongKetelRtwEdit",
                Config.ApiDeleteAction => "SubAktivitasFormInputDataGerbongKetelRtwDelete",
                Config.ApiListAction => "SubAktivitasFormInputDataGerbongKetelRtwList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasFormInputDataGerbongKetelRtwList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasFormInputDataGerbongKetelRtwView", parm);
            else
                url = KeyUrl("SubAktivitasFormInputDataGerbongKetelRtwView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasFormInputDataGerbongKetelRtwAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasFormInputDataGerbongKetelRtwAdd?" + parm;
            else
                url = "SubAktivitasFormInputDataGerbongKetelRtwAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputDataGerbongKetelRtwEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputDataGerbongKetelRtwList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputDataGerbongKetelRtwAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputDataGerbongKetelRtwList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasFormInputDataGerbongKetelRtwDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasFormInputDataGerbongKetelRtwList";
        ...
        public async Task RenderListRow()
        {
            ...
            Jns_Produk.ViewValue = Empty(curVal4) ? DbNullValue : Jns_Produk.CurrentValue;
            if (!Empty(curVal4)) {
        ...
        public async Task RenderEditRow()
        {
            ...
            // Jns_Produk
            Jns_Produk.SetupEditAttributes();
            Jns_Produk.EditValue = ConvertToString(Jns_Produk.CurrentValue); // DN

            // awallookupbung
            string curVal4 = ConvertToString(Jns_Produk.CurrentValue);
            Jns_Produk.EditValue = Empty(curVal4) ? DbNullValue : Jns_Produk.CurrentValue;
            if (!Empty(curVal4)) {
                if (Jns_Produk.Lookup != null && IsDictionary(Jns_Produk.Lookup?.Options) && Jns_Produk.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    Jns_Produk.EditValue = Jns_Produk.LookupCacheOption(curVal4);
                } else { // Lookup from database // DN
                    string filterWrk4 = SearchFilter(Jns_Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchExpression, "=", Jns_Produk.CurrentValue, Jns_Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchDataType, "");
                    string? sqlWrk4 = Jns_Produk.Lookup?.GetSql(false, filterWrk4, null, this, true, true);
                    List<Dictionary<string, object>>? rswrk4 = sqlWrk4 != null ? Connection.GetRows(sqlWrk4) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
                    if (rswrk4?.Count > 0 && Jns_Produk.Lookup != null) { // Lookup values found
                        var listwrk = Jns_Produk.Lookup?.RenderViewRow(rswrk4[0]);
                        Jns_Produk.EditValue = Jns_Produk.DisplayValue(listwrk);
                    }
                }
            }
            ...
            DetailGerbong.EditValue = DetailGerbong.CurrentValue;
            ...
            DetailQuantity.EditValue = DetailQuantity.CurrentValue;
