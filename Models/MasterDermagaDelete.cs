...
public partial class SnDOne {
    ...
    /// masterDermagaDelete
    /// </summary>
    public static MasterDermagaDelete masterDermagaDelete
    {
        get => HttpData.Get<MasterDermagaDelete>("masterDermagaDelete")!;
        set => HttpData["masterDermagaDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterDermaga
    /// </summary>
    public class MasterDermagaDelete : MasterDermagaDeleteBase
    {
        // Constructor
        public MasterDermagaDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterDermagaDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class MasterDermagaDeleteBase : MasterDermaga
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterDermagaDelete";
        ...
        // Constructor
        public MasterDermagaDeleteBase()
        {
        ...
        // Page name
        public string PageName => "MasterDermagaDelete";
        ...
        // Constructor
        public MasterDermagaDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterDermagaList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterDermagaList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                masterDermagaDelete?.PageRender();
            }
            return PageResult();
        }
