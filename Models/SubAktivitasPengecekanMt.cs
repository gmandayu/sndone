...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasPengecekanMt
    /// </summary>
    [MaybeNull]
    public static SubAktivitasPengecekanMt subAktivitasPengecekanMt
    {
        get => HttpData.Resolve<SubAktivitasPengecekanMt>("SubAktivitasPengecekanMT");
        set => HttpData["SubAktivitasPengecekanMT"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasPengecekanMT
    /// </summary>
    public class SubAktivitasPengecekanMt : DbTable
    {
        ...
        public readonly DbField<SqlDbType> JamPemeriksaan;

        public readonly DbField<SqlDbType> ExTangki;
        ...
        // Constructor
        public SubAktivitasPengecekanMt()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasPengecekanMT";
            Name = "SubAktivitasPengecekanMT";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasPengecekanMT"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "Produk", "CustomMsg"),
                IsUpload = false
            };
            Produk.Lookup = new Lookup<DbField>(Produk, "MasterProduk", false, "NoProduk", new List<string> {"NamaProduk", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[NamaProduk]");
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomorPolisi = new(this, "x_NomorPolisi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "NomorPolisi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NomorPolisi", NomorPolisi);

            // JamPemeriksaan
            JamPemeriksaan = new(this, "x_JamPemeriksaan", 135, SqlDbType.DateTime) {
                Name = "JamPemeriksaan",
                Expression = "[JamPemeriksaan]",
                BasicSearchExpression = CastDateFieldForLike("[JamPemeriksaan]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[JamPemeriksaan]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "JamPemeriksaan", "CustomMsg"),
                IsUpload = false
            };
            JamPemeriksaan.Raw = true;
            Fields.Add("JamPemeriksaan", JamPemeriksaan);

            // ExTangki
            ExTangki = new(this, "x_ExTangki", 202, SqlDbType.NVarChar) {
                Name = "ExTangki",
                Expression = "[ExTangki]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ExTangki]",
                DateTimeFormat = -1,
                VirtualExpression = "[ExTangki]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "ExTangki", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ExTangki", ExTangki);
            ...
            Keterangan = new(this, "x_Keterangan", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasPengecekanMT", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasPengecekanMT";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasPengecekanMt type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                JamPemeriksaan.DbValue = row["JamPemeriksaan"]; // Set DB value only
                ExTangki.DbValue = row["ExTangki"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasPengecekanMtList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasPengecekanMtView" => Language.Phrase("View"),
                "SubAktivitasPengecekanMtEdit" => Language.Phrase("Edit"),
                "SubAktivitasPengecekanMtAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasPengecekanMtView",
                Config.ApiAddAction => "SubAktivitasPengecekanMtAdd",
                Config.ApiEditAction => "SubAktivitasPengecekanMtEdit",
                Config.ApiDeleteAction => "SubAktivitasPengecekanMtDelete",
                Config.ApiListAction => "SubAktivitasPengecekanMtList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasPengecekanMtList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasPengecekanMtView", parm);
            else
                url = KeyUrl("SubAktivitasPengecekanMtView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasPengecekanMtAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasPengecekanMtAdd?" + parm;
            else
                url = "SubAktivitasPengecekanMtAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasPengecekanMtEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasPengecekanMtList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasPengecekanMtAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasPengecekanMtList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasPengecekanMtDelete", parm)); // DN
        }
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            ...
            JamPemeriksaan.SetDbValue(row["JamPemeriksaan"]);
            ExTangki.SetDbValue(row["ExTangki"]);
        ...
        {
            string pageName = "SubAktivitasPengecekanMtList";
        ...
        public async Task RenderListRow()
        {
            ...
            // awallookupbung
            string curVal3 = ConvertToString(Produk.CurrentValue);
            Produk.ViewValue = Empty(curVal3) ? DbNullValue : Produk.CurrentValue;
            if (!Empty(curVal3)) {
                if (Produk.Lookup != null && IsDictionary(Produk.Lookup?.Options) && Produk.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    Produk.ViewValue = Produk.LookupCacheOption(curVal3);
                } else { // Lookup from database // DN
                    string filterWrk3 = SearchFilter(Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchExpression, "=", Produk.CurrentValue, Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchDataType, "");
                    string? sqlWrk3 = Produk.Lookup?.GetSql(false, filterWrk3, null, this, true, true);
                    ...
                    if (rswrk3?.Count > 0 && Produk.Lookup != null) { // Lookup values found
                        var listwrk = Produk.Lookup?.RenderViewRow(rswrk3[0]);
            ...
            // JamPemeriksaan
            JamPemeriksaan.ViewValue = JamPemeriksaan.CurrentValue;
            JamPemeriksaan.ViewValue = FormatDateTime(JamPemeriksaan.ViewValue, JamPemeriksaan.FormatPattern);
            JamPemeriksaan.ViewCustomAttributes = "";

            // ExTangki
            ExTangki.ViewValue = ConvertToString(ExTangki.CurrentValue); // DN
            ExTangki.ViewCustomAttributes = "";
            ...
            // JamPemeriksaan
            JamPemeriksaan.HrefValue = "";
            JamPemeriksaan.TooltipValue = "";

            // ExTangki
            ExTangki.HrefValue = "";
            ExTangki.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // awallookupbung
            string curVal3 = ConvertToString(Produk.CurrentValue);
            Produk.EditValue = Empty(curVal3) ? DbNullValue : Produk.CurrentValue;
            if (!Empty(curVal3)) {
                if (Produk.Lookup != null && IsDictionary(Produk.Lookup?.Options) && Produk.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    Produk.EditValue = Produk.LookupCacheOption(curVal3);
                } else { // Lookup from database // DN
                    string filterWrk3 = SearchFilter(Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchExpression, "=", Produk.CurrentValue, Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchDataType, "");
                    string? sqlWrk3 = Produk.Lookup?.GetSql(false, filterWrk3, null, this, true, true);
                    List<Dictionary<string, object>>? rswrk3 = sqlWrk3 != null ? Connection.GetRows(sqlWrk3) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
            ...
            // JamPemeriksaan
            JamPemeriksaan.SetupEditAttributes();
            JamPemeriksaan.EditValue = FormatDateTime(JamPemeriksaan.CurrentValue, JamPemeriksaan.FormatPattern);
            JamPemeriksaan.PlaceHolder = RemoveHtml(JamPemeriksaan.Caption);

            // ExTangki
            ExTangki.SetupEditAttributes();
            if (!ExTangki.Raw)
                ExTangki.CurrentValue = HtmlDecode(ExTangki.CurrentValue);
            ExTangki.EditValue = ExTangki.CurrentValue;
            ExTangki.PlaceHolder = RemoveHtml(ExTangki.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(JamPemeriksaan);
                        doc.ExportCaption(ExTangki);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(JamPemeriksaan);
                            await doc.ExportField(ExTangki);
