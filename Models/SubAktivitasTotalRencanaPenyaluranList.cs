...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasTotalRencanaPenyaluranList
    /// </summary>
    public static SubAktivitasTotalRencanaPenyaluranList subAktivitasTotalRencanaPenyaluranList
    {
        get => HttpData.Get<SubAktivitasTotalRencanaPenyaluranList>("subAktivitasTotalRencanaPenyaluranList")!;
        set => HttpData["subAktivitasTotalRencanaPenyaluranList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasTotalRencanaPenyaluran
    /// </summary>
    public class SubAktivitasTotalRencanaPenyaluranList : SubAktivitasTotalRencanaPenyaluranListBase
    {
        // Constructor
        public SubAktivitasTotalRencanaPenyaluranList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasTotalRencanaPenyaluranList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasTotalRencanaPenyaluranListBase : SubAktivitasTotalRencanaPenyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasTotalRencanaPenyaluranList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasTotalRencanaPenyaluranlist";
        ...
        // Constructor
        public SubAktivitasTotalRencanaPenyaluranListBase()
        {
            TableName = "SubAktivitasTotalRencanaPenyaluran";

            // CSS class name as context
            TableVar = "SubAktivitasTotalRencanaPenyaluran";
            ...
            // Table object (subAktivitasTotalRencanaPenyaluran)
            if (subAktivitasTotalRencanaPenyaluran == null || subAktivitasTotalRencanaPenyaluran is SubAktivitasTotalRencanaPenyaluran)
                subAktivitasTotalRencanaPenyaluran = this;

            // Initialize URLs
            AddUrl = "SubAktivitasTotalRencanaPenyaluranAdd";
            ...
            MultiDeleteUrl = "SubAktivitasTotalRencanaPenyaluranDelete";
            MultiUpdateUrl = "SubAktivitasTotalRencanaPenyaluranUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasTotalRencanaPenyaluranList";
        ...
        public void SetVisibility()
        {
            ...
            RencanaPenyaluranKL.SetVisibility();
        ...
        // Constructor
        public SubAktivitasTotalRencanaPenyaluranListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasTotalRencanaPenyaluranView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasTotalRencanaPenyalurangrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasTotalRencanaPenyaluranList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(RencanaPenyaluranKL);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(RencanaPenyaluranKL, ctrl); // RencanaPenyaluranKL
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasTotalRencanaPenyaluran"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasTotalRencanaPenyaluranlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasTotalRencanaPenyaluranlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("RencanaPenyaluranKL")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasTotalRencanaPenyaluransrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasTotalRencanaPenyaluransrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasTotalRencanaPenyaluranlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasTotalRencanaPenyaluran");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasTotalRencanaPenyaluranList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasTotalRencanaPenyaluranList.RowCount) + "_SubAktivitasTotalRencanaPenyaluran");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasTotalRencanaPenyaluranList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasTotalRencanaPenyaluranList.RowType == RowType.Add || IsEdit && subAktivitasTotalRencanaPenyaluranList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            RencanaPenyaluranKL.SetDbValue(row["RencanaPenyaluranKL"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("RencanaPenyaluranKL", RencanaPenyaluranKL.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // RencanaPenyaluranKL
                RencanaPenyaluranKL.ViewValue = ConvertToString(RencanaPenyaluranKL.CurrentValue); // DN
                RencanaPenyaluranKL.ViewCustomAttributes = "";
                ...
                // RencanaPenyaluranKL
                RencanaPenyaluranKL.HrefValue = "";
                RencanaPenyaluranKL.TooltipValue = "";
