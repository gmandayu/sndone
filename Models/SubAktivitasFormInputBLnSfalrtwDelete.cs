...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputBLnSfalrtwDelete
    /// </summary>
    public static SubAktivitasFormInputBLnSfalrtwDelete subAktivitasFormInputBLnSfalrtwDelete
    {
        get => HttpData.Get<SubAktivitasFormInputBLnSfalrtwDelete>("subAktivitasFormInputBLnSfalrtwDelete")!;
        set => HttpData["subAktivitasFormInputBLnSfalrtwDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputBLnSFALRTW
    /// </summary>
    public class SubAktivitasFormInputBLnSfalrtwDelete : SubAktivitasFormInputBLnSfalrtwDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputBLnSfalrtwDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputBLnSfalrtwDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputBLnSfalrtwDeleteBase : SubAktivitasFormInputBLnSfalrtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputBLnSfalrtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputBLnSfalrtwDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputBLnSfalrtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputBLnSfalrtwDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputBLnSfalrtwList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputBLnSfalrtwList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputBLnSfalrtwDelete?.PageRender();
            }
            return PageResult();
        }
