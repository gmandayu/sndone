...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputDataStartPembongkaranEditBase : SubAktivitasFormInputDataStartPembongkaran
    {
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputDataStartPembongkaranList"); // No matching record, return to list
                        }
                    break;
