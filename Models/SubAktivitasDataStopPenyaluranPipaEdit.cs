...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStopPenyaluranPipaEditBase : SubAktivitasDataStopPenyaluranPipa
    {
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranPipaEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranPipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStopPenyaluranPipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStopPenyaluranPipaList") {
                                ...
                                returnUrl = "SubAktivitasDataStopPenyaluranPipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
