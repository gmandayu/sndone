...
public partial class SnDOne {
    ...
    public class SubAktivitasInputDataKapalLpgEditBase : SubAktivitasInputDataKapalLpg
    {
        ...
        // Constructor
        public SubAktivitasInputDataKapalLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasInputDataKapalLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasInputDataKapalLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasInputDataKapalLpgList") {
                                ...
                                returnUrl = "SubAktivitasInputDataKapalLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
