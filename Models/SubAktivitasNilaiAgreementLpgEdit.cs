...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiAgreementLpgEditBase : SubAktivitasNilaiAgreementLpg
    {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiAgreementLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiAgreementLpgList") {
                                ...
                                returnUrl = "SubAktivitasNilaiAgreementLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
