...
public partial class SnDOne {
    /// <summary>
    /// formInputProofOfVisitDelete
    /// </summary>
    public static FormInputProofOfVisitDelete formInputProofOfVisitDelete
    {
        get => HttpData.Get<FormInputProofOfVisitDelete>("formInputProofOfVisitDelete")!;
        set => HttpData["formInputProofOfVisitDelete"] = value;
    }

    /// <summary>
    /// Page class for FormInputProofOfVisit
    /// </summary>
    public class FormInputProofOfVisitDelete : FormInputProofOfVisitDeleteBase
    {
        // Constructor
        public FormInputProofOfVisitDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public FormInputProofOfVisitDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class FormInputProofOfVisitDeleteBase : FormInputProofOfVisit
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "formInputProofOfVisitDelete";
        ...
        // Constructor
        public FormInputProofOfVisitDeleteBase()
        {
        ...
        // Page name
        public string PageName => "FormInputProofOfVisitDelete";
        ...
        // Constructor
        public FormInputProofOfVisitDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("FormInputProofOfVisitList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("FormInputProofOfVisitList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                formInputProofOfVisitDelete?.PageRender();
            }
            return PageResult();
        }
