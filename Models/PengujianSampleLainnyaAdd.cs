...
public partial class SnDOne {
    ...
    public class PengujianSampleLainnyaAddBase : PengujianSampleLainnya
    {
        ...
        // Constructor
        public PengujianSampleLainnyaAddBase()
        {
        ...
        // Constructor
        public PengujianSampleLainnyaAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("PengujianSampleLainnyaList"); // No matching record, return to List page // DN
                    }
                    break;
