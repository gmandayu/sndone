...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbookPenerimaanStsPymLpgListBase : SubAktivitasFormInputLogbookPenerimaanStsPymLpg
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field Nama_Kapal
            if (filter.TryGetValue("x_Nama_Kapal", out sv)) {
                RestoreFieldFilter(Nama_Kapal, filter, "Nama_Kapal", sv);
            }
            ...
            // Field Temperatur
            if (filter.TryGetValue("x_Temperatur", out sv)) {
                RestoreFieldFilter(Temperatur, filter, "Temperatur", sv);
            }
