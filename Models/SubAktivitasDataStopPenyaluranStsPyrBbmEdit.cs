...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStopPenyaluranStsPyrBbmEdit
    /// </summary>
    public static SubAktivitasDataStopPenyaluranStsPyrBbmEdit subAktivitasDataStopPenyaluranStsPyrBbmEdit
    {
        get => HttpData.Get<SubAktivitasDataStopPenyaluranStsPyrBbmEdit>("subAktivitasDataStopPenyaluranStsPyrBbmEdit")!;
        set => HttpData["subAktivitasDataStopPenyaluranStsPyrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStopPenyaluranSTSPyrBBM
    /// </summary>
    public class SubAktivitasDataStopPenyaluranStsPyrBbmEdit : SubAktivitasDataStopPenyaluranStsPyrBbmEditBase
    {
        // Constructor
        public SubAktivitasDataStopPenyaluranStsPyrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStopPenyaluranStsPyrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStopPenyaluranStsPyrBbmEditBase : SubAktivitasDataStopPenyaluranStsPyrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStopPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranStsPyrBbmEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStopPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranStsPyrBbmEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataStopPenyaluranStsPyrBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataStopPenyaluranStsPyrBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataStopPenyaluranStsPyrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStopPenyaluranStsPyrBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataStopPenyaluranStsPyrBbmList")), "", TableVar, true);
            string pageId = "edit";
