...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiAktualDischargeDelete
    /// </summary>
    public static SubAktivitasFormInputNilaiAktualDischargeDelete subAktivitasFormInputNilaiAktualDischargeDelete
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiAktualDischargeDelete>("subAktivitasFormInputNilaiAktualDischargeDelete")!;
        set => HttpData["subAktivitasFormInputNilaiAktualDischargeDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiAktualDischarge
    /// </summary>
    public class SubAktivitasFormInputNilaiAktualDischargeDelete : SubAktivitasFormInputNilaiAktualDischargeDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiAktualDischargeDeleteBase : SubAktivitasFormInputNilaiAktualDischarge
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiAktualDischargeDelete";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiAktualDischargeDelete";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputNilaiAktualDischargeList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputNilaiAktualDischargeList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputNilaiAktualDischargeDelete?.PageRender();
            }
            return PageResult();
        }
