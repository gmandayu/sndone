...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiSfbdrtwViewBase : SubAktivitasNilaiSfbdrtw
    {
        ...
        // Constructor
        public SubAktivitasNilaiSfbdrtwViewBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiSfbdrtwViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasNilaiSfbdrtwList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasNilaiSfbdrtwList"); // Return to list page
                            }
                        }
                    break;
            }
