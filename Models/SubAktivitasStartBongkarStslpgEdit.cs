...
public partial class SnDOne {
    ...
    public class SubAktivitasStartBongkarStslpgEditBase : SubAktivitasStartBongkarStslpg
    {
        ...
        // Constructor
        public SubAktivitasStartBongkarStslpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasStartBongkarStslpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasStartBongkarStslpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasStartBongkarStslpgList") {
                                ...
                                returnUrl = "SubAktivitasStartBongkarStslpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
