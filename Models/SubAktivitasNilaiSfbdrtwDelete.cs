...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiSfbdrtwDelete
    /// </summary>
    public static SubAktivitasNilaiSfbdrtwDelete subAktivitasNilaiSfbdrtwDelete
    {
        get => HttpData.Get<SubAktivitasNilaiSfbdrtwDelete>("subAktivitasNilaiSfbdrtwDelete")!;
        set => HttpData["subAktivitasNilaiSfbdrtwDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiSFBDRTW
    /// </summary>
    public class SubAktivitasNilaiSfbdrtwDelete : SubAktivitasNilaiSfbdrtwDeleteBase
    {
        // Constructor
        public SubAktivitasNilaiSfbdrtwDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiSfbdrtwDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiSfbdrtwDeleteBase : SubAktivitasNilaiSfbdrtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiSfbdrtwDelete";
        ...
        // Constructor
        public SubAktivitasNilaiSfbdrtwDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiSfbdrtwDelete";
        ...
        // Constructor
        public SubAktivitasNilaiSfbdrtwDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasNilaiSfbdrtwList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasNilaiSfbdrtwList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiSfbdrtwDelete?.PageRender();
            }
            return PageResult();
        }
