...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiBDperGerbongEditBase : SubAktivitasNilaiBDperGerbong
    {
        ...
        // Constructor
        public SubAktivitasNilaiBDperGerbongEditBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiBDperGerbongEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiBDperGerbongList"); // No matching record, return to list
                        }
                    break;
