...
public partial class SnDOne {
    /// <summary>
    /// masterTemplateDelete
    /// </summary>
    public static MasterTemplateDelete masterTemplateDelete
    {
        get => HttpData.Get<MasterTemplateDelete>("masterTemplateDelete")!;
        set => HttpData["masterTemplateDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterTemplate
    /// </summary>
    public class MasterTemplateDelete : MasterTemplateDeleteBase
    {
        // Constructor
        public MasterTemplateDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterTemplateDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterTemplateDeleteBase : MasterTemplate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterTemplateDelete";
        ...
        // Constructor
        public MasterTemplateDeleteBase()
        {
        ...
        // Page name
        public string PageName => "MasterTemplateDelete";
        ...
        // Constructor
        public MasterTemplateDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterTemplateList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterTemplateList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                masterTemplateDelete?.PageRender();
            }
            return PageResult();
        }
