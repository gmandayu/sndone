...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiNewBlsfadsfbl
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiNewBlsfadsfbl subAktivitasNilaiNewBlsfadsfbl
    {
        get => HttpData.Resolve<SubAktivitasNilaiNewBlsfadsfbl>("SubAktivitasNilaiNewBLSFADSFBL");
        set => HttpData["SubAktivitasNilaiNewBLSFADSFBL"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiNewBLSFADSFBL
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfbl : DbTable
    {
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfbl()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiNewBLSFADSFBL";
            Name = "SubAktivitasNilaiNewBLSFADSFBL";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiNewBLSFADSFBL"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_KLObs = new(this, "x_NewBL_KLObs", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "NewBL_KLObs", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_KL15 = new(this, "x_NewBL_KL15", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "NewBL_KL15", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_Barrels = new(this, "x_NewBL_Barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "NewBL_Barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_LT = new(this, "x_NewBL_LT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "NewBL_LT", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_MT = new(this, "x_NewBL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "NewBL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_KLObs = new(this, "x_SFAD_KLObs", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "SFAD_KLObs", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_KL15 = new(this, "x_SFAD_KL15", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "SFAD_KL15", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_Barrels = new(this, "x_SFAD_Barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "SFAD_Barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_MT = new(this, "x_SFAD_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "SFAD_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_LT = new(this, "x_SFAD_LT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "SFAD_LT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFBL_KLObs = new(this, "x_SFBL_KLObs", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "SFBL_KLObs", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFBL_KL15 = new(this, "x_SFBL_KL15", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "SFBL_KL15", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFBL_Barrels = new(this, "x_SFBL_Barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "SFBL_Barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFBL_LT = new(this, "x_SFBL_LT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "SFBL_LT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFBL_MT = new(this, "x_SFBL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "SFBL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            ExROB = new(this, "x_ExROB", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "ExROB", "CustomMsg"),
                IsUpload = false
            };
            ExROB.Raw = true;
            ExROB.Lookup = new Lookup<DbField>(ExROB, "SubAktivitasNilaiNewBLSFADSFBL", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ExROB.UserValues = ["1"];
            ...
            NoPenerimaan = new(this, "x_NoPenerimaan", 202, SqlDbType.NVarChar) {
                ...
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "NoPenerimaan", "CustomMsg"),
                IsUpload = false
            };
            NoPenerimaan.Lookup = new Lookup<DbField>(NoPenerimaan, "Penerimaan", false, "NomorPenerimaan", new List<string> {"NomorPenerimaan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[NomorPenerimaan]");
            NoPenerimaan.GetSelectFilter = () => "NomorPenerimaan IN (SELECT NoReferensi FROM SubAktivitasSFADNewBL WHERE ApakahTerdapatROB = 1 UNION SELECT NoReferensi FROM SubAktivitasSFADNewBLSTSPnrBBM WHERE ApakahTerdapatROB = 1)";
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBL", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiNewBLSFADSFBL";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiNewBlsfadsfbl type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiNewBlsfadsfblList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiNewBlsfadsfblView" => Language.Phrase("View"),
                "SubAktivitasNilaiNewBlsfadsfblEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiNewBlsfadsfblAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiNewBlsfadsfblView",
                Config.ApiAddAction => "SubAktivitasNilaiNewBlsfadsfblAdd",
                Config.ApiEditAction => "SubAktivitasNilaiNewBlsfadsfblEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiNewBlsfadsfblDelete",
                Config.ApiListAction => "SubAktivitasNilaiNewBlsfadsfblList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiNewBlsfadsfblList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiNewBlsfadsfblAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiNewBlsfadsfblAdd?" + parm;
            else
                url = "SubAktivitasNilaiNewBlsfadsfblAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiNewBlsfadsfblList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiNewBlsfadsfblList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiNewBlsfadsfblDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiNewBlsfadsfblList";
