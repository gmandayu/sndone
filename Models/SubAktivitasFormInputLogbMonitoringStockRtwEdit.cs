...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbMonitoringStockRtwEdit
    /// </summary>
    public static SubAktivitasFormInputLogbMonitoringStockRtwEdit subAktivitasFormInputLogbMonitoringStockRtwEdit
    {
        get => HttpData.Get<SubAktivitasFormInputLogbMonitoringStockRtwEdit>("subAktivitasFormInputLogbMonitoringStockRtwEdit")!;
        set => HttpData["subAktivitasFormInputLogbMonitoringStockRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbMonitoringStockRTW
    /// </summary>
    public class SubAktivitasFormInputLogbMonitoringStockRtwEdit : SubAktivitasFormInputLogbMonitoringStockRtwEditBase
    {
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbMonitoringStockRtwEditBase : SubAktivitasFormInputLogbMonitoringStockRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbMonitoringStockRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbMonitoringStockRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputLogbMonitoringStockRtwEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // NoTangki
            NoTangki.SetDbValue(rsnew, NoTangki.CurrentValue, NoTangki.ReadOnly);
            ...
            // LevelTangki
            LevelTangki.SetDbValue(rsnew, LevelTangki.CurrentValue, LevelTangki.ReadOnly);
        ...
        protected void RestoreEditFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("LevelTangki", out value)) // LevelTangki
                LevelTangki.CurrentValue = value;
