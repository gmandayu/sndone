...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbookPenerimaanRtwList
    /// </summary>
    public static SubAktivitasFormInputLogbookPenerimaanRtwList subAktivitasFormInputLogbookPenerimaanRtwList
    {
        get => HttpData.Get<SubAktivitasFormInputLogbookPenerimaanRtwList>("subAktivitasFormInputLogbookPenerimaanRtwList")!;
        set => HttpData["subAktivitasFormInputLogbookPenerimaanRtwList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbookPenerimaanRTW
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanRtwList : SubAktivitasFormInputLogbookPenerimaanRtwListBase
    {
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanRtwListBase : SubAktivitasFormInputLogbookPenerimaanRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbookPenerimaanRtwList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasFormInputLogbookPenerimaanRTWlist";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwListBase()
        {
            TableName = "SubAktivitasFormInputLogbookPenerimaanRTW";

            // CSS class name as context
            TableVar = "SubAktivitasFormInputLogbookPenerimaanRTW";
            ...
            // Table object (subAktivitasFormInputLogbookPenerimaanRtw)
            if (subAktivitasFormInputLogbookPenerimaanRtw == null || subAktivitasFormInputLogbookPenerimaanRtw is SubAktivitasFormInputLogbookPenerimaanRtw)
                subAktivitasFormInputLogbookPenerimaanRtw = this;

            // Initialize URLs
            AddUrl = "SubAktivitasFormInputLogbookPenerimaanRtwAdd";
            ...
            MultiDeleteUrl = "SubAktivitasFormInputLogbookPenerimaanRtwDelete";
            MultiUpdateUrl = "SubAktivitasFormInputLogbookPenerimaanRtwUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbookPenerimaanRtwList";
        ...
        public void SetVisibility()
        {
            ...
            SubAktivitasFormInputHslPemeriksaanRTWId.SetVisibility();
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasFormInputLogbookPenerimaanRtwView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasFormInputLogbookPenerimaanRTWgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputLogbookPenerimaanRtwList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(SubAktivitasFormInputHslPemeriksaanRTWId.AdvancedSearch.ToJson())); // Field SubAktivitasFormInputHslPemeriksaanRTWId
        ...
        protected bool RestoreFilterList() {
            ...
            // Field SubAktivitasFormInputHslPemeriksaanRTWId
            if (filter?.TryGetValue("x_SubAktivitasFormInputHslPemeriksaanRTWId", out sv) ?? false) {
                SubAktivitasFormInputHslPemeriksaanRTWId.AdvancedSearch.SearchValue = sv;
                SubAktivitasFormInputHslPemeriksaanRTWId.AdvancedSearch.SearchOperator = filter["z_SubAktivitasFormInputHslPemeriksaanRTWId"];
                SubAktivitasFormInputHslPemeriksaanRTWId.AdvancedSearch.SearchCondition = filter["v_SubAktivitasFormInputHslPemeriksaanRTWId"];
                SubAktivitasFormInputHslPemeriksaanRTWId.AdvancedSearch.SearchValue2 = filter["y_SubAktivitasFormInputHslPemeriksaanRTWId"];
                SubAktivitasFormInputHslPemeriksaanRTWId.AdvancedSearch.SearchOperator2 = filter["w_SubAktivitasFormInputHslPemeriksaanRTWId"];
                SubAktivitasFormInputHslPemeriksaanRTWId.AdvancedSearch.Save();
            }
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(SubAktivitasFormInputHslPemeriksaanRTWId, ctrl); // SubAktivitasFormInputHslPemeriksaanRTWId
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    NoReferensi.Sort = "";
                    SubAktivitasFormInputHslPemeriksaanRTWId.Sort = "";
                    TanggalJamSOP.Sort = "";
                    SelisihWaktu.Sort = "";
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasFormInputLogbookPenerimaanRTW"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputLogbookPenerimaanRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputLogbookPenerimaanRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("SubAktivitasFormInputHslPemeriksaanRTWId")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasFormInputLogbookPenerimaanRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasFormInputLogbookPenerimaanRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputLogbookPenerimaanRTWlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasFormInputLogbookPenerimaanRTW");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasFormInputLogbookPenerimaanRtwList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasFormInputLogbookPenerimaanRtwList.RowCount) + "_SubAktivitasFormInputLogbookPenerimaanRTW");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasFormInputLogbookPenerimaanRtwList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasFormInputLogbookPenerimaanRtwList.RowType == RowType.Add || IsEdit && subAktivitasFormInputLogbookPenerimaanRtwList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            SubAktivitasFormInputHslPemeriksaanRTWId.SetDbValue(row["SubAktivitasFormInputHslPemeriksaanRTWId"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("SubAktivitasFormInputHslPemeriksaanRTWId", SubAktivitasFormInputHslPemeriksaanRTWId.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            // SubAktivitasFormInputHslPemeriksaanRTWId
            ...
            if (RowType == RowType.View) {
                ...
                // SubAktivitasFormInputHslPemeriksaanRTWId
                SubAktivitasFormInputHslPemeriksaanRTWId.ViewValue = SubAktivitasFormInputHslPemeriksaanRTWId.CurrentValue;
                SubAktivitasFormInputHslPemeriksaanRTWId.ViewValue = FormatNumber(SubAktivitasFormInputHslPemeriksaanRTWId.ViewValue, SubAktivitasFormInputHslPemeriksaanRTWId.FormatPattern);
                SubAktivitasFormInputHslPemeriksaanRTWId.ViewCustomAttributes = "";
                ...
                // SubAktivitasFormInputHslPemeriksaanRTWId
                SubAktivitasFormInputHslPemeriksaanRTWId.HrefValue = "";
                SubAktivitasFormInputHslPemeriksaanRTWId.TooltipValue = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasFormInputLogbookPenerimaanRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasFormInputLogbookPenerimaanRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasFormInputLogbookPenerimaanRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasFormInputLogbookPenerimaanRTWsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
