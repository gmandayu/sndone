...
public partial class SnDOne {
    ...
    public class SubAktivitasKapalBerangkatStslpgEditBase : SubAktivitasKapalBerangkatStslpg
    {
        ...
        // Constructor
        public SubAktivitasKapalBerangkatStslpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasKapalBerangkatStslpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasKapalBerangkatStslpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasKapalBerangkatStslpgList") {
                                ...
                                returnUrl = "SubAktivitasKapalBerangkatStslpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
