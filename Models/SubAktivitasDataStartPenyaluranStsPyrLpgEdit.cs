...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStartPenyaluranStsPyrLpgEditBase : SubAktivitasDataStartPenyaluranStsPyrLpg
    {
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranStsPyrLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranStsPyrLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStartPenyaluranStsPyrLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStartPenyaluranStsPyrLpgList") {
                                ...
                                returnUrl = "SubAktivitasDataStartPenyaluranStsPyrLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
