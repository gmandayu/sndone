...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasKeberangkatanRtwEdit
    /// </summary>
    public static SubAktivitasKeberangkatanRtwEdit subAktivitasKeberangkatanRtwEdit
    {
        get => HttpData.Get<SubAktivitasKeberangkatanRtwEdit>("subAktivitasKeberangkatanRtwEdit")!;
        set => HttpData["subAktivitasKeberangkatanRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasKeberangkatanRTW
    /// </summary>
    public class SubAktivitasKeberangkatanRtwEdit : SubAktivitasKeberangkatanRtwEditBase
    {
        // Constructor
        public SubAktivitasKeberangkatanRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasKeberangkatanRtwEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasKeberangkatanRtwEditBase : SubAktivitasKeberangkatanRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasKeberangkatanRtwEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasKeberangkatanRtwEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasKeberangkatanRtwList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanRtwList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasKeberangkatanRtwList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasKeberangkatanRtwEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasKeberangkatanRtwList")), "", TableVar, true);
            string pageId = "edit";
