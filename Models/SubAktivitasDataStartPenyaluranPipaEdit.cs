...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStartPenyaluranPipaEditBase : SubAktivitasDataStartPenyaluranPipa
    {
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranPipaEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranPipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStartPenyaluranPipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStartPenyaluranPipaList") {
                                ...
                                returnUrl = "SubAktivitasDataStartPenyaluranPipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
