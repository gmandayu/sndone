...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasSfadNewBlstslpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasSfadNewBlstslpg subAktivitasSfadNewBlstslpg
    {
        get => HttpData.Resolve<SubAktivitasSfadNewBlstslpg>("SubAktivitasSFADNewBLSTSLPG");
        set => HttpData["SubAktivitasSFADNewBLSTSLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasSFADNewBLSTSLPG
    /// </summary>
    public class SubAktivitasSfadNewBlstslpg : DbTable
    {
        ...
        // Constructor
        public SubAktivitasSfadNewBlstslpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasSFADNewBLSTSLPG";
            Name = "SubAktivitasSFADNewBLSTSLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasSFADNewBLSTSLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            ApakahTerdapatROB = new(this, "x_ApakahTerdapatROB", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "ApakahTerdapatROB", "CustomMsg"),
                IsUpload = false
            };
            ApakahTerdapatROB.Raw = true;
            ApakahTerdapatROB.Lookup = new Lookup<DbField>(ApakahTerdapatROB, "SubAktivitasSFADNewBLSTSLPG", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Import = new(this, "x_Import", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "Import", "CustomMsg"),
                IsUpload = false
            };
            Import.Raw = true;
            Import.Lookup = new Lookup<DbField>(Import, "SubAktivitasSFADNewBLSTSLPG", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Import.UserValues = ["1"];
            ...
            Tujuan = new(this, "x_Tujuan", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "Tujuan", "CustomMsg"),
                IsUpload = false
            };
            Tujuan.Raw = true;
            ...
            ApakahAdaROB = new(this, "x_ApakahAdaROB", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "ApakahAdaROB", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_mt = new(this, "x_SFAD_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "SFAD_mt", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBl_mt = new(this, "x_NewBl_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "NewBl_mt", "CustomMsg"),
                IsUpload = false
            };
            ...
            AR45B_mt = new(this, "x_AR45B_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "AR45B_mt", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasSFADNewBLSTSLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasSfadnewBlstslpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasSfadNewBlstslpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasSfadNewBlstslpgView" => Language.Phrase("View"),
                "SubAktivitasSfadNewBlstslpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasSfadNewBlstslpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasSfadNewBlstslpgView",
                Config.ApiAddAction => "SubAktivitasSfadNewBlstslpgAdd",
                Config.ApiEditAction => "SubAktivitasSfadNewBlstslpgEdit",
                Config.ApiDeleteAction => "SubAktivitasSfadNewBlstslpgDelete",
                Config.ApiListAction => "SubAktivitasSfadNewBlstslpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasSfadNewBlstslpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasSfadNewBlstslpgView", parm);
            else
                url = KeyUrl("SubAktivitasSfadNewBlstslpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasSfadNewBlstslpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasSfadNewBlstslpgAdd?" + parm;
            else
                url = "SubAktivitasSfadNewBlstslpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasSfadNewBlstslpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasSfadNewBlstslpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasSfadNewBlstslpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasSfadNewBlstslpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasSfadNewBlstslpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasSfadNewBlstslpgList";
