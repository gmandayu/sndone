...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStopPenyaluranEdit
    /// </summary>
    public static SubAktivitasDataStopPenyaluranEdit subAktivitasDataStopPenyaluranEdit
    {
        get => HttpData.Get<SubAktivitasDataStopPenyaluranEdit>("subAktivitasDataStopPenyaluranEdit")!;
        set => HttpData["subAktivitasDataStopPenyaluranEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStopPenyaluran
    /// </summary>
    public class SubAktivitasDataStopPenyaluranEdit : SubAktivitasDataStopPenyaluranEditBase
    {
        // Constructor
        public SubAktivitasDataStopPenyaluranEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStopPenyaluranEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStopPenyaluranEditBase : SubAktivitasDataStopPenyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStopPenyaluranEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStopPenyaluranEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataStopPenyaluranList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataStopPenyaluranList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataStopPenyaluranList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStopPenyaluranEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataStopPenyaluranList")), "", TableVar, true);
            string pageId = "edit";
