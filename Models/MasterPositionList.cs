...
public partial class SnDOne {
    ...
    public class MasterPositionListBase : MasterPosition
    {
        ...
        // Constructor
        public MasterPositionListBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterPositionListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field NamaPosition
            if (filter.TryGetValue("x_NamaPosition", out sv)) {
                RestoreFieldFilter(NamaPosition, filter, "NamaPosition", sv);
            }

            // Field Location
            if (filter.TryGetValue("x_Location", out sv)) {
                RestoreFieldFilter(Location, filter, "Location", sv);
            }

            // Field UserLevel
            if (filter.TryGetValue("x__UserLevel", out sv)) {
                RestoreFieldFilter(_UserLevel, filter, "_UserLevel", sv);
            }

            // Field Role
            if (filter.TryGetValue("x_Role", out sv)) {
                RestoreFieldFilter(Role, filter, "Role", sv);
            }
        }
        ...
        private string BuildFieldFilters(FilterConfiguration config)
        {
            ...
            filterList += ProcessFieldFilter("NamaPosition", NamaPosition, true, config);
            filterList += ProcessFieldFilter("Location", Location, true, config);
            filterList += ProcessFieldFilter("UserLevel", _UserLevel, true, config);
            filterList += ProcessFieldFilter("Role", Role, true, config);
            return filterList;
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void LoadFieldSearchValues()
        {
            ...
            LoadFieldNamaPositionSearchValues();
            LoadFieldLocationSearchValues();
            LoadField_UserLevelSearchValues();
            LoadFieldRoleSearchValues();
        }
        ...
        private void LoadFieldNamaPositionSearchValues()
        {
            // NamaPosition
            LoadPrimarySearchValueNamaPosition();
            LoadSearchOperatorNamaPosition();
        }

        private void LoadPrimarySearchValueNamaPosition()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_NamaPosition[]")) {
        ...
        private void LoadSearchOperatorNamaPosition()
        {
        ...
        private void LoadFieldLocationSearchValues()
        {
            // Location
            LoadPrimarySearchValueLocation();
            LoadSearchOperatorLocation();
        }

        private void LoadPrimarySearchValueLocation()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Location[]")) {
        ...
        private void LoadSearchOperatorLocation()
        {
        ...
        private void LoadFieldRoleSearchValues()
        {
            // Role
            LoadPrimarySearchValueRole();
            LoadSearchOperatorRole();
        }

        private void LoadPrimarySearchValueRole()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Role[]")) {
        ...
        private void LoadSearchOperatorRole()
        {
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // Role
                    ...
                    // awallookupbung
                    // Role
                    ResolveLookupView(Role, "IdPIC", "number");
                    // akhirlookupbung
