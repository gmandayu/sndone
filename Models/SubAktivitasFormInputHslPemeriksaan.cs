...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputHslPemeriksaan
    /// </summary>
    [MaybeNull]
    public static SubAktivitasFormInputHslPemeriksaan subAktivitasFormInputHslPemeriksaan
    {
        get => HttpData.Resolve<SubAktivitasFormInputHslPemeriksaan>("SubAktivitasFormInputHslPemeriksaan");
        set => HttpData["SubAktivitasFormInputHslPemeriksaan"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasFormInputHslPemeriksaan
    /// </summary>
    public class SubAktivitasFormInputHslPemeriksaan : DbTable
    {
        ...
        // Constructor
        public SubAktivitasFormInputHslPemeriksaan()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasFormInputHslPemeriksaan";
            Name = "SubAktivitasFormInputHslPemeriksaan";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasFormInputHslPemeriksaan"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            ...
            // NamaKegiatan
            NamaKegiatan = new(this, "x_NamaKegiatan", 200, SqlDbType.VarChar) {
                Name = "NamaKegiatan",
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "NamaKegiatan", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "Produk", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Produk", Produk);

            // Density
            Density = new(this, "x_Density", 200, SqlDbType.VarChar) {
                Name = "Density",
                Expression = "[Density]",
                UseBasicSearch = true,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "Density", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Density", Density);

            // Temperature
            Temperature = new(this, "x_Temperature", 200, SqlDbType.VarChar) {
                Name = "Temperature",
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "Temperature", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Temperature", Temperature);

            // Pressure
            Pressure = new(this, "x_Pressure", 200, SqlDbType.VarChar) {
                Name = "Pressure",
                Expression = "[Pressure]",
                UseBasicSearch = true,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "Pressure", "CustomMsg"),
                IsUpload = false
            };
            ...
            Keterangan = new(this, "x_Keterangan", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalJamSOP = new(this, "x_TanggalJamSOP", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "TanggalJamSOP", "CustomMsg"),
                IsUpload = false
            };
            ...
            SelisihWaktu = new(this, "x_SelisihWaktu", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "SelisihWaktu", "CustomMsg"),
                IsUpload = false
            };
            ...
            IsQualityActive = new(this, "x_IsQualityActive", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputHslPemeriksaan", "IsQualityActive", "CustomMsg"),
                IsUpload = false
            };
            IsQualityActive.Raw = true;
            IsQualityActive.Lookup = new Lookup<DbField>(IsQualityActive, "SubAktivitasFormInputHslPemeriksaan", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasFormInputHslPemeriksaan";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasFormInputHslPemeriksaan type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasFormInputHslPemeriksaanList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasFormInputHslPemeriksaanView" => Language.Phrase("View"),
                "SubAktivitasFormInputHslPemeriksaanEdit" => Language.Phrase("Edit"),
                "SubAktivitasFormInputHslPemeriksaanAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasFormInputHslPemeriksaanView",
                Config.ApiAddAction => "SubAktivitasFormInputHslPemeriksaanAdd",
                Config.ApiEditAction => "SubAktivitasFormInputHslPemeriksaanEdit",
                Config.ApiDeleteAction => "SubAktivitasFormInputHslPemeriksaanDelete",
                Config.ApiListAction => "SubAktivitasFormInputHslPemeriksaanList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasFormInputHslPemeriksaanList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasFormInputHslPemeriksaanView", parm);
            else
                url = KeyUrl("SubAktivitasFormInputHslPemeriksaanView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasFormInputHslPemeriksaanAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasFormInputHslPemeriksaanAdd?" + parm;
            else
                url = "SubAktivitasFormInputHslPemeriksaanAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputHslPemeriksaanEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputHslPemeriksaanList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputHslPemeriksaanAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputHslPemeriksaanList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasFormInputHslPemeriksaanDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasFormInputHslPemeriksaanList";
