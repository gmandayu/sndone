...
public partial class SnDOne {
    ...
    public class SubAktivitasInputDataKapalStsPyrBbmEditBase : SubAktivitasInputDataKapalStsPyrBbm
    {
        ...
        // Constructor
        public SubAktivitasInputDataKapalStsPyrBbmEditBase()
        {
        ...
        // Constructor
        public SubAktivitasInputDataKapalStsPyrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasInputDataKapalStsPyrBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasInputDataKapalStsPyrBbmList") {
                                ...
                                returnUrl = "SubAktivitasInputDataKapalStsPyrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
