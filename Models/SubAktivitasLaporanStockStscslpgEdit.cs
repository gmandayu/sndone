...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLaporanStockStscslpgEdit
    /// </summary>
    public static SubAktivitasLaporanStockStscslpgEdit subAktivitasLaporanStockStscslpgEdit
    {
        get => HttpData.Get<SubAktivitasLaporanStockStscslpgEdit>("subAktivitasLaporanStockStscslpgEdit")!;
        set => HttpData["subAktivitasLaporanStockStscslpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasLaporanStockSTSCSLPG
    /// </summary>
    public class SubAktivitasLaporanStockStscslpgEdit : SubAktivitasLaporanStockStscslpgEditBase
    {
        // Constructor
        public SubAktivitasLaporanStockStscslpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasLaporanStockStscslpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasLaporanStockStscslpgEditBase : SubAktivitasLaporanStockStscslpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasLaporanStockStscslpgEdit";
        ...
        // Constructor
        public SubAktivitasLaporanStockStscslpgEditBase()
        {
            TableName = "SubAktivitasLaporanStockSTSCSLPG";
            ...
            // Table object (subAktivitasLaporanStockStscslpg)
            if (subAktivitasLaporanStockStscslpg == null || subAktivitasLaporanStockStscslpg is SubAktivitasLaporanStockStscslpg)
                subAktivitasLaporanStockStscslpg = this;
        ...
        // Page name
        public string PageName => "SubAktivitasLaporanStockStscslpgEdit";
        ...
        // Constructor
        public SubAktivitasLaporanStockStscslpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (SameString(pageName, GetPageName(ListUrl)) ||
                            ...
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasLaporanStockStscslpgView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasLaporanStockStscslpgList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "SubAktivitasLaporanStockStscslpgList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasLaporanStockStscslpgList") {
                                ...
                                returnUrl = "SubAktivitasLaporanStockStscslpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasLaporanStockStscslpgEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasLaporanStockStscslpgList")), "", TableVar, true);
            string pageId = "edit";
