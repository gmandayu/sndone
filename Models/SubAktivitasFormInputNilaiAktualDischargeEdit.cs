...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputNilaiAktualDischargeEditBase : SubAktivitasFormInputNilaiAktualDischarge
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputNilaiAktualDischargeList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputNilaiAktualDischargeList") {
                                ...
                                returnUrl = "SubAktivitasFormInputNilaiAktualDischargeList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
