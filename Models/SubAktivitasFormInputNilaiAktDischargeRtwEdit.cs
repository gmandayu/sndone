...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiAktDischargeRtwEdit
    /// </summary>
    public static SubAktivitasFormInputNilaiAktDischargeRtwEdit subAktivitasFormInputNilaiAktDischargeRtwEdit
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiAktDischargeRtwEdit>("subAktivitasFormInputNilaiAktDischargeRtwEdit")!;
        set => HttpData["subAktivitasFormInputNilaiAktDischargeRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiAktDischargeRTW
    /// </summary>
    public class SubAktivitasFormInputNilaiAktDischargeRtwEdit : SubAktivitasFormInputNilaiAktDischargeRtwEditBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwEdit() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiAktDischargeRtwEditBase : SubAktivitasFormInputNilaiAktDischargeRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiAktDischargeRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiAktDischargeRtwEdit";
        ...
        public void SetVisibility()
        {
            ...
            AR45B_klobs.Visible = false;
            AR45B_kl15.Visible = false;
            AR45B_Barrel.Visible = false;
            AR45B_lt.Visible = false;
            AR45B_mt.Visible = false;
        }

        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputNilaiAktDischargeRtwEdit?.PageRender();
                    }
        }
        ...
        private void ValidateCustomNoReferensi() {
            if (NoReferensi.Visible && NoReferensi.Required) {
                if (!NoReferensi.IsDetailKey && Empty(NoReferensi.FormValue)) {
                    NoReferensi.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidProses() {
            if (idProses.Visible && idProses.Required) {
                if (!idProses.IsDetailKey && Empty(idProses.FormValue)) {
                    idProses.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidAktifitas() {
            if (idAktifitas.Visible && idAktifitas.Required) {
                if (!idAktifitas.IsDetailKey && Empty(idAktifitas.FormValue)) {
                    idAktifitas.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomStatusAktivitas() {
            if (StatusAktivitas.Visible && StatusAktivitas.Required) {
                if (!StatusAktivitas.IsDetailKey && Empty(StatusAktivitas.FormValue)) {
                    StatusAktivitas.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLastUpdatedBy() {
            if (LastUpdatedBy.Visible && LastUpdatedBy.Required) {
                if (!LastUpdatedBy.IsDetailKey && Empty(LastUpdatedBy.FormValue)) {
                    LastUpdatedBy.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomlastUpdatedDate() {
            if (lastUpdatedDate.Visible && lastUpdatedDate.Required) {
                if (!lastUpdatedDate.IsDetailKey && Empty(lastUpdatedDate.FormValue)) {
                    lastUpdatedDate.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomApakahAdaROB() {
            if (ApakahAdaROB.Visible && ApakahAdaROB.Required) {
                if (Empty(ApakahAdaROB.FormValue)) {
                    ApakahAdaROB.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomTujuan() {
            if (Tujuan.Visible && Tujuan.Required) {
                if (!Tujuan.IsDetailKey && Empty(Tujuan.FormValue)) {
                    Tujuan.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomSFAD_KLObs() {
            if (SFAD_KLObs.Visible && SFAD_KLObs.Required) {
                if (!SFAD_KLObs.IsDetailKey && Empty(SFAD_KLObs.FormValue)) {
                    SFAD_KLObs.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomSFAD_KL15() {
            if (SFAD_KL15.Visible && SFAD_KL15.Required) {
                if (!SFAD_KL15.IsDetailKey && Empty(SFAD_KL15.FormValue)) {
                    SFAD_KL15.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomSFAD_Barrels() {
            if (SFAD_Barrels.Visible && SFAD_Barrels.Required) {
                if (!SFAD_Barrels.IsDetailKey && Empty(SFAD_Barrels.FormValue)) {
                    SFAD_Barrels.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomSFAD_LT() {
            if (SFAD_LT.Visible && SFAD_LT.Required) {
                if (!SFAD_LT.IsDetailKey && Empty(SFAD_LT.FormValue)) {
                    SFAD_LT.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomSFAD_MT() {
            if (SFAD_MT.Visible && SFAD_MT.Required) {
                if (!SFAD_MT.IsDetailKey && Empty(SFAD_MT.FormValue)) {
                    SFAD_MT.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNewBL_KLObs() {
            if (NewBL_KLObs.Visible && NewBL_KLObs.Required) {
                if (!NewBL_KLObs.IsDetailKey && Empty(NewBL_KLObs.FormValue)) {
                    NewBL_KLObs.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNewBL_KL15() {
            if (NewBL_KL15.Visible && NewBL_KL15.Required) {
                if (!NewBL_KL15.IsDetailKey && Empty(NewBL_KL15.FormValue)) {
                    NewBL_KL15.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNewBL_Barrels() {
            if (NewBL_Barrels.Visible && NewBL_Barrels.Required) {
                if (!NewBL_Barrels.IsDetailKey && Empty(NewBL_Barrels.FormValue)) {
                    NewBL_Barrels.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNewBL_LT() {
            if (NewBL_LT.Visible && NewBL_LT.Required) {
                if (!NewBL_LT.IsDetailKey && Empty(NewBL_LT.FormValue)) {
                    NewBL_LT.AddErrorMessage(ConvertToString(NewBL_MT.RequiredErrorMessage).Replace("%s", NewBL_MT.Caption));
                }
            }
        }
