...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputNilaiBLsesuaiCqlTruckListBase : SubAktivitasFormInputNilaiBLsesuaiCqlTruck
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            if (filter.TryGetValue("x_TotalPenyaluran", out sv)) {
                RestoreFieldFilter(TotalPenyaluran, filter, "TotalPenyaluran", sv);
            }
        }
