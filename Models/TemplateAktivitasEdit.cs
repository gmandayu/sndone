...
public partial class SnDOne {
    ...
    public class TemplateAktivitasEditBase : TemplateAktivitas
    {
        ...
        // Constructor
        public TemplateAktivitasEditBase(Controller? controller)
        {
        ...
        // Constructor
        public TemplateAktivitasEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<ActionSetupResult> SetupCurrentAction()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("IdTemplateAktivitas", out rv)) {
                    IdTemplateAktivitas.FormValue = UrlDecode(rv);
                ...
                if (!Empty(Post("action"))) {
                    ...
                    if (RouteValues.TryGetValue("IdTemplateAktivitas", out rv)) {
                        IdTemplateAktivitas.QueryValue = UrlDecode(rv);
                        loadByQuery = true;
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "TemplateAktivitasList") {
                        ...
                        returnUrl = "TemplateAktivitasList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
