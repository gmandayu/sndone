...
public partial class SnDOne {
    ...
    /// userLevelsView
    /// </summary>
    public static UserLevelsView userLevelsView
    {
        get => HttpData.Get<UserLevelsView>("userLevelsView")!;
        set => HttpData["userLevelsView"] = value;
    }

    /// <summary>
    /// Page class for UserLevels
    /// </summary>
    public class UserLevelsView : UserLevelsViewBase
    {
        // Constructor
        public UserLevelsView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public UserLevelsView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class UserLevelsViewBase : UserLevels
    {
        // Page ID
        ...
        // Page name
        public string PageName => "UserLevelsView";
        ...
        // Constructor
        public UserLevelsViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("UserLevelsList"); // Return to list page
                            }
                        }
                    break;
            }
