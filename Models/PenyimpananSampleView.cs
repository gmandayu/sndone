...
public partial class SnDOne {
    /// <summary>
    /// penyimpananSampleView
    /// </summary>
    public static PenyimpananSampleView penyimpananSampleView
    {
        get => HttpData.Get<PenyimpananSampleView>("penyimpananSampleView")!;
        set => HttpData["penyimpananSampleView"] = value;
    }

    /// <summary>
    /// Page class for PenyimpananSample
    /// </summary>
    public class PenyimpananSampleView : PenyimpananSampleViewBase
    {
        // Constructor
        public PenyimpananSampleView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenyimpananSampleView() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PenyimpananSampleViewBase : PenyimpananSample
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penyimpananSampleView";
        ...
        // Constructor
        public PenyimpananSampleViewBase()
        {
        ...
        // Page name
        public string PageName => "PenyimpananSampleView";
        ...
        // Constructor
        public PenyimpananSampleViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "PenyimpananSampleList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("PenyimpananSampleList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                penyimpananSampleView?.PageRender();
            }
            return PageResult();
        }
