...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputNilaiAktDischargeRtwEditBase : SubAktivitasFormInputNilaiAktDischargeRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputNilaiAktDischargeRtwList"); // No matching record, return to list
                        }
                    break;
