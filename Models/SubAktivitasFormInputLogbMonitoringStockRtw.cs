...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbMonitoringStockRtw
    /// </summary>
    [MaybeNull]
    public static SubAktivitasFormInputLogbMonitoringStockRtw subAktivitasFormInputLogbMonitoringStockRtw
    {
        get => HttpData.Resolve<SubAktivitasFormInputLogbMonitoringStockRtw>("SubAktivitasFormInputLogbMonitoringStockRTW");
        set => HttpData["SubAktivitasFormInputLogbMonitoringStockRTW"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasFormInputLogbMonitoringStockRTW
    /// </summary>
    public class SubAktivitasFormInputLogbMonitoringStockRtw : DbTable
    {
        ...
        public readonly DbField<SqlDbType> NoTangki;

        public readonly DbField<SqlDbType> Produk;

        public readonly DbField<SqlDbType> Aktivitas2;

        public readonly DbField<SqlDbType> LevelTangki;
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtw()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasFormInputLogbMonitoringStockRTW";
            Name = "SubAktivitasFormInputLogbMonitoringStockRTW";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasFormInputLogbMonitoringStockRTW"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            // NoTangki
            NoTangki = new(this, "x_NoTangki", 3, SqlDbType.Int) {
                Name = "NoTangki",
                Expression = "[NoTangki]",
                BasicSearchExpression = "CAST([NoTangki] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[NoTangki]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "NoTangki", "CustomMsg"),
                IsUpload = false
            };
            NoTangki.Raw = true;
            Fields.Add("NoTangki", NoTangki);
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            Aktivitas2 = new(this, "x_Aktivitas2", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "Aktivitas2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Aktivitas", Aktivitas2);

            // LevelTangki
            LevelTangki = new(this, "x_LevelTangki", 202, SqlDbType.NVarChar) {
                Name = "LevelTangki",
                Expression = "[LevelTangki]",
                UseBasicSearch = true,
                BasicSearchExpression = "[LevelTangki]",
                DateTimeFormat = -1,
                VirtualExpression = "[LevelTangki]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "LevelTangki", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LevelTangki", LevelTangki);
            ...
            Volume = new(this, "x_Volume", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "Volume", "CustomMsg"),
                IsUpload = false
            };
            ...
            Flowrate = new(this, "x_Flowrate", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "Flowrate", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbMonitoringStockRTW", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasFormInputLogbMonitoringStockRTW";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasFormInputLogbMonitoringStockRtw type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                NoTangki.DbValue = row["NoTangki"]; // Set DB value only
                Produk.DbValue = row["Produk"]; // Set DB value only
                Aktivitas2.DbValue = row["Aktivitas"]; // Set DB value only
                LevelTangki.DbValue = row["LevelTangki"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasFormInputLogbMonitoringStockRtwList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasFormInputLogbMonitoringStockRtwView" => Language.Phrase("View"),
                "SubAktivitasFormInputLogbMonitoringStockRtwEdit" => Language.Phrase("Edit"),
                "SubAktivitasFormInputLogbMonitoringStockRtwAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasFormInputLogbMonitoringStockRtwView",
                Config.ApiAddAction => "SubAktivitasFormInputLogbMonitoringStockRtwAdd",
                Config.ApiEditAction => "SubAktivitasFormInputLogbMonitoringStockRtwEdit",
                Config.ApiDeleteAction => "SubAktivitasFormInputLogbMonitoringStockRtwDelete",
                Config.ApiListAction => "SubAktivitasFormInputLogbMonitoringStockRtwList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasFormInputLogbMonitoringStockRtwList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasFormInputLogbMonitoringStockRtwView", parm);
            else
                url = KeyUrl("SubAktivitasFormInputLogbMonitoringStockRtwView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasFormInputLogbMonitoringStockRtwAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasFormInputLogbMonitoringStockRtwAdd?" + parm;
            else
                url = "SubAktivitasFormInputLogbMonitoringStockRtwAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputLogbMonitoringStockRtwEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputLogbMonitoringStockRtwList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputLogbMonitoringStockRtwAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputLogbMonitoringStockRtwList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasFormInputLogbMonitoringStockRtwDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasFormInputLogbMonitoringStockRtwList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // NoTangki
            NoTangki.SetupEditAttributes();
            NoTangki.EditValue = NoTangki.CurrentValue;
            NoTangki.PlaceHolder = RemoveHtml(NoTangki.Caption);
            if (!Empty(NoTangki.EditValue) && IsNumeric(NoTangki.EditValue))
                NoTangki.EditValue = FormatNumber(NoTangki.EditValue, null);
            ...
            // LevelTangki
            LevelTangki.SetupEditAttributes();
            if (!LevelTangki.Raw)
                LevelTangki.CurrentValue = HtmlDecode(LevelTangki.CurrentValue);
            LevelTangki.EditValue = LevelTangki.CurrentValue;
            LevelTangki.PlaceHolder = RemoveHtml(LevelTangki.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(NoTangki);
                        doc.ExportCaption(Produk);
                        doc.ExportCaption(Aktivitas2);
                        doc.ExportCaption(LevelTangki);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(NoTangki);
                            await doc.ExportField(Produk);
                            await doc.ExportField(Aktivitas2);
                            await doc.ExportField(LevelTangki);
