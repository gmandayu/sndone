...
public partial class SnDOne {
    ...
    public class SubaktivitasInputLogbookPenyaluranPipaBackupListBase : SubaktivitasInputLogbookPenyaluranPipaBackup
    {
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field LO
            if (filter.TryGetValue("x_LO", out sv)) {
                RestoreFieldFilter(LO, filter, "LO", sv);
            }
            ...
            // Field BayNumber
            if (filter.TryGetValue("x_BayNumber", out sv)) {
                RestoreFieldFilter(BayNumber, filter, "BayNumber", sv);
            }
