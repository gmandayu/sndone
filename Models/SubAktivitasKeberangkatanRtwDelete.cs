...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasKeberangkatanRtwDelete
    /// </summary>
    public static SubAktivitasKeberangkatanRtwDelete subAktivitasKeberangkatanRtwDelete
    {
        get => HttpData.Get<SubAktivitasKeberangkatanRtwDelete>("subAktivitasKeberangkatanRtwDelete")!;
        set => HttpData["subAktivitasKeberangkatanRtwDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasKeberangkatanRTW
    /// </summary>
    public class SubAktivitasKeberangkatanRtwDelete : SubAktivitasKeberangkatanRtwDeleteBase
    {
        // Constructor
        public SubAktivitasKeberangkatanRtwDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasKeberangkatanRtwDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasKeberangkatanRtwDeleteBase : SubAktivitasKeberangkatanRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasKeberangkatanRtwDelete";
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasKeberangkatanRtwDelete";
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasKeberangkatanRtwList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasKeberangkatanRtwList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasKeberangkatanRtwDelete?.PageRender();
            }
            return PageResult();
        }
