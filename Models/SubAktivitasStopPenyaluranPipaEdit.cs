...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasStopPenyaluranPipaEdit
    /// </summary>
    public static SubAktivitasStopPenyaluranPipaEdit subAktivitasStopPenyaluranPipaEdit
    {
        get => HttpData.Get<SubAktivitasStopPenyaluranPipaEdit>("subAktivitasStopPenyaluranPipaEdit")!;
        set => HttpData["subAktivitasStopPenyaluranPipaEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasStopPenyaluranPipa
    /// </summary>
    public class SubAktivitasStopPenyaluranPipaEdit : SubAktivitasStopPenyaluranPipaEditBase
    {
        // Constructor
        public SubAktivitasStopPenyaluranPipaEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasStopPenyaluranPipaEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasStopPenyaluranPipaEditBase : SubAktivitasStopPenyaluranPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasStopPenyaluranPipaEdit";
        ...
        // Constructor
        public SubAktivitasStopPenyaluranPipaEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasStopPenyaluranPipaEdit";
        ...
        // Constructor
        public SubAktivitasStopPenyaluranPipaEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasStopPenyaluranPipaList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasStopPenyaluranPipaList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasStopPenyaluranPipaList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasStopPenyaluranPipaEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasStopPenyaluranPipaList")), "", TableVar, true);
            string pageId = "edit";
