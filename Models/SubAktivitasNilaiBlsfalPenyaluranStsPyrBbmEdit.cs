...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEditBase : SubAktivitasNilaiBlsfalPenyaluranStsPyrBbm
    {
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmList") {
                        ...
                        returnUrl = "SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
