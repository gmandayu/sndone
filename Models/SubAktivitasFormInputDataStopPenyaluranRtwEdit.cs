...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputDataStopPenyaluranRtwEditBase : SubAktivitasFormInputDataStopPenyaluranRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPenyaluranRtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPenyaluranRtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputDataStopPenyaluranRtwList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputDataStopPenyaluranRtwList") {
                                ...
                                returnUrl = "SubAktivitasFormInputDataStopPenyaluranRtwList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
