...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasRencanaPenyaluranPipaEdit
    /// </summary>
    public static SubaktivitasRencanaPenyaluranPipaEdit subaktivitasRencanaPenyaluranPipaEdit
    {
        get => HttpData.Get<SubaktivitasRencanaPenyaluranPipaEdit>("subaktivitasRencanaPenyaluranPipaEdit")!;
        set => HttpData["subaktivitasRencanaPenyaluranPipaEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasRencanaPenyaluranPipa
    /// </summary>
    public class SubaktivitasRencanaPenyaluranPipaEdit : SubaktivitasRencanaPenyaluranPipaEditBase
    {
        // Constructor
        public SubaktivitasRencanaPenyaluranPipaEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasRencanaPenyaluranPipaEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasRencanaPenyaluranPipaEditBase : SubaktivitasRencanaPenyaluranPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasRencanaPenyaluranPipaEdit";
        ...
        // Constructor
        public SubaktivitasRencanaPenyaluranPipaEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasRencanaPenyaluranPipaEdit";
        ...
        // Constructor
        public SubaktivitasRencanaPenyaluranPipaEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasRencanaPenyaluranPipaList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasRencanaPenyaluranPipaList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasRencanaPenyaluranPipaList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasRencanaPenyaluranPipaEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'RencanaPenyaluran2'
            RencanaPenyaluran2.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(RencanaPenyaluran2, "RencanaPenyaluran", "x_RencanaPenyaluran2");
        ...
        public void RestoreFormValues()
        {
            ...
            RencanaPenyaluran2.CurrentValue = RencanaPenyaluran2.FormValue;
        ...
        public async Task RenderRow()
        {
            ...
            // RencanaPenyaluran
            RencanaPenyaluran2.RowCssClass = "row";
            ...
            if (RowType == RowType.View) {
                ...
                // RencanaPenyaluran
                RencanaPenyaluran2.SetupEditAttributes();
                if (!RencanaPenyaluran2.Raw)
                    RencanaPenyaluran2.CurrentValue = HtmlDecode(RencanaPenyaluran2.CurrentValue);
                RencanaPenyaluran2.EditValue = HtmlEncode(RencanaPenyaluran2.CurrentValue);
                RencanaPenyaluran2.PlaceHolder = RemoveHtml(RencanaPenyaluran2.Caption);
        ...
        private void ValidateCustomTanggalJam() {
            if (TanggalJam.Visible && TanggalJam.Required) {
                if (!TanggalJam.IsDetailKey && Empty(TanggalJam.FormValue)) {
                    TanggalJam.AddErrorMessage(ConvertToString(NoReferensi.RequiredErrorMessage).Replace("%s", NoReferensi.Caption));
                }
            }
        }
        ...
        private void ValidateCustomRencanaPenyaluran2() {
            if (RencanaPenyaluran2.Visible && RencanaPenyaluran2.Required) {
                if (!RencanaPenyaluran2.IsDetailKey && Empty(RencanaPenyaluran2.FormValue)) {
                    RencanaPenyaluran2.AddErrorMessage(ConvertToString(NoReferensi.RequiredErrorMessage).Replace("%s", NoReferensi.Caption));
                }
            }
        }
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ...
                ValidateCustomRencanaPenyaluran2();
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // RencanaPenyaluran
            RencanaPenyaluran2.SetDbValue(rsnew, RencanaPenyaluran2.CurrentValue, RencanaPenyaluran2.ReadOnly);
        ...
        protected void RestoreEditFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("RencanaPenyaluran", out value)) // RencanaPenyaluran
                RencanaPenyaluran2.CurrentValue = value;
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasRencanaPenyaluranPipaList")), "", TableVar, true);
            string pageId = "edit";
