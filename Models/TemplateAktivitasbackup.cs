...
public partial class SnDOne {
    /// <summary>
    /// templateAktivitasbackup
    /// </summary>
    [MaybeNull]
    public static TemplateAktivitasbackup templateAktivitasbackup
    {
        get => HttpData.Resolve<TemplateAktivitasbackup>("TemplateAktivitasbackup");
        set => HttpData["TemplateAktivitasbackup"] = value;
    }

    /// <summary>
    /// Table class for TemplateAktivitasbackup
    /// </summary>
    public class TemplateAktivitasbackup : DbTable
    {
        ...
        // Constructor
        public TemplateAktivitasbackup()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "TemplateAktivitasbackup";
            Name = "TemplateAktivitasbackup";
            Type = "TABLE";
            UpdateTable = "dbo.TemplateAktivitasbackup"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdTemplateAktivitas = new(this, "x_IdTemplateAktivitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitasbackup", "IdTemplateAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdTemplateProses = new(this, "x_IdTemplateProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitasbackup", "IdTemplateProses", "CustomMsg"),
                IsUpload = false
            };
            ...
            UrutanAktivitas = new(this, "x_UrutanAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitasbackup", "UrutanAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NamaAktivitas = new(this, "x_NamaAktivitas", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitasbackup", "NamaAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdPIC = new(this, "x_IdPIC", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitasbackup", "IdPIC", "CustomMsg"),
                IsUpload = false
            };
            IdPIC.Raw = true;
            ...
            Keterangan = new(this, "x_Keterangan", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitasbackup", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitasbackup", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                BasicSearchExpression = CastDateFieldForLike("[TanggalDibuat]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitasbackup", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitasbackup", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                BasicSearchExpression = CastDateFieldForLike("[TanggalDiperbarui]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitasbackup", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.TemplateAktivitasbackup";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.TemplateAktivitasbackup type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "TemplateAktivitasbackupList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "TemplateAktivitasbackupView" => Language.Phrase("View"),
                "TemplateAktivitasbackupEdit" => Language.Phrase("Edit"),
                "TemplateAktivitasbackupAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TemplateAktivitasbackupView",
                Config.ApiAddAction => "TemplateAktivitasbackupAdd",
                Config.ApiEditAction => "TemplateAktivitasbackupEdit",
                Config.ApiDeleteAction => "TemplateAktivitasbackupDelete",
                Config.ApiListAction => "TemplateAktivitasbackupList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TemplateAktivitasbackupList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TemplateAktivitasbackupView", parm);
            else
                url = KeyUrl("TemplateAktivitasbackupView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TemplateAktivitasbackupAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "TemplateAktivitasbackupAdd?" + parm;
            else
                url = "TemplateAktivitasbackupAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TemplateAktivitasbackupEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TemplateAktivitasbackupList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TemplateAktivitasbackupAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TemplateAktivitasbackupList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("TemplateAktivitasbackupDelete", parm)); // DN
        }
        ...
        {
            string pageName = "TemplateAktivitasbackupList";
        ...
        public async Task RenderListRow()
        {
            ...
            IdPIC.ViewValue = FormatNumber(IdPIC.ViewValue, IdPIC.FormatPattern);
        ...
        public async Task RenderEditRow()
        {
            ...
            IdPIC.EditValue = IdPIC.CurrentValue;
