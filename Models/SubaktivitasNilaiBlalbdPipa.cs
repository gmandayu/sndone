...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiBlalbdPipa
    /// </summary>
    [MaybeNull]
    public static SubaktivitasNilaiBlalbdPipa subaktivitasNilaiBlalbdPipa
    {
        get => HttpData.Resolve<SubaktivitasNilaiBlalbdPipa>("SubaktivitasNilaiBLALBDPipa");
        set => HttpData["SubaktivitasNilaiBLALBDPipa"] = value;
    }

    /// <summary>
    /// Table class for SubaktivitasNilaiBLALBDPipa
    /// </summary>
    public class SubaktivitasNilaiBlalbdPipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> BL_klobs;

        public readonly DbField<SqlDbType> BL_kl15;
        ...
        public readonly DbField<SqlDbType> AL_klobs;

        public readonly DbField<SqlDbType> AL_kl15;
        ...
        public readonly DbField<SqlDbType> BD_klobs;

        public readonly DbField<SqlDbType> BD_kl15;

        public readonly DbField<SqlDbType> BD_barrels;

        public readonly DbField<SqlDbType> BD_lt;

        public readonly DbField<SqlDbType> BD_mt;
        ...
        // Constructor
        public SubaktivitasNilaiBlalbdPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubaktivitasNilaiBLALBDPipa";
            Name = "SubaktivitasNilaiBLALBDPipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubaktivitasNilaiBLALBDPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            // BL_klobs
            BL_klobs = new(this, "x_BL_klobs", 202, SqlDbType.NVarChar) {
                Name = "BL_klobs",
                Expression = "[BL_klobs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[BL_klobs]",
                DateTimeFormat = -1,
                VirtualExpression = "[BL_klobs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "BL_klobs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("BL_klobs", BL_klobs);

            // BL_kl15
            BL_kl15 = new(this, "x_BL_kl15", 202, SqlDbType.NVarChar) {
                Name = "BL_kl15",
                Expression = "[BL_kl15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[BL_kl15]",
                DateTimeFormat = -1,
                VirtualExpression = "[BL_kl15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "BL_kl15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("BL_kl15", BL_kl15);
            ...
            BL_barrels = new(this, "x_BL_barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "BL_barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            BL_lt = new(this, "x_BL_lt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "BL_lt", "CustomMsg"),
                IsUpload = false
            };
            ...
            BL_mt = new(this, "x_BL_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "BL_mt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("BL_mt", BL_mt);

            // AL_klobs
            AL_klobs = new(this, "x_AL_klobs", 202, SqlDbType.NVarChar) {
                Name = "AL_klobs",
                Expression = "[AL_klobs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AL_klobs]",
                DateTimeFormat = -1,
                VirtualExpression = "[AL_klobs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "AL_klobs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AL_klobs", AL_klobs);

            // AL_kl15
            AL_kl15 = new(this, "x_AL_kl15", 202, SqlDbType.NVarChar) {
                Name = "AL_kl15",
                Expression = "[AL_kl15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AL_kl15]",
                DateTimeFormat = -1,
                VirtualExpression = "[AL_kl15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "AL_kl15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AL_kl15", AL_kl15);
            ...
            AL_barrels = new(this, "x_AL_barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "AL_barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            AL_lt = new(this, "x_AL_lt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "AL_lt", "CustomMsg"),
                IsUpload = false
            };
            ...
            AL_mt = new(this, "x_AL_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "AL_mt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AL_mt", AL_mt);

            // BD_klobs
            BD_klobs = new(this, "x_BD_klobs", 202, SqlDbType.NVarChar) {
                Name = "BD_klobs",
                Expression = "[BD_klobs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[BD_klobs]",
                DateTimeFormat = -1,
                VirtualExpression = "[BD_klobs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "BD_klobs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("BD_klobs", BD_klobs);

            // BD_kl15
            BD_kl15 = new(this, "x_BD_kl15", 202, SqlDbType.NVarChar) {
                Name = "BD_kl15",
                Expression = "[BD_kl15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[BD_kl15]",
                DateTimeFormat = -1,
                VirtualExpression = "[BD_kl15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "BD_kl15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("BD_kl15", BD_kl15);

            // BD_barrels
            BD_barrels = new(this, "x_BD_barrels", 202, SqlDbType.NVarChar) {
                Name = "BD_barrels",
                Expression = "[BD_barrels]",
                UseBasicSearch = true,
                BasicSearchExpression = "[BD_barrels]",
                DateTimeFormat = -1,
                VirtualExpression = "[BD_barrels]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "BD_barrels", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("BD_barrels", BD_barrels);

            // BD_lt
            BD_lt = new(this, "x_BD_lt", 202, SqlDbType.NVarChar) {
                Name = "BD_lt",
                Expression = "[BD_lt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[BD_lt]",
                DateTimeFormat = -1,
                VirtualExpression = "[BD_lt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "BD_lt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("BD_lt", BD_lt);

            // BD_mt
            BD_mt = new(this, "x_BD_mt", 202, SqlDbType.NVarChar) {
                Name = "BD_mt",
                Expression = "[BD_mt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[BD_mt]",
                DateTimeFormat = -1,
                VirtualExpression = "[BD_mt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "BD_mt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("BD_mt", BD_mt);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiBLALBDPipa", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubaktivitasNilaiBLALBDPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubaktivitasNilaiBlalbdpipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                BL_klobs.DbValue = row["BL_klobs"]; // Set DB value only
                BL_kl15.DbValue = row["BL_kl15"]; // Set DB value only
                ...
                AL_klobs.DbValue = row["AL_klobs"]; // Set DB value only
                AL_kl15.DbValue = row["AL_kl15"]; // Set DB value only
                ...
                BD_klobs.DbValue = row["BD_klobs"]; // Set DB value only
                BD_kl15.DbValue = row["BD_kl15"]; // Set DB value only
                BD_barrels.DbValue = row["BD_barrels"]; // Set DB value only
                BD_lt.DbValue = row["BD_lt"]; // Set DB value only
                BD_mt.DbValue = row["BD_mt"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubaktivitasNilaiBlalbdPipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubaktivitasNilaiBlalbdPipaView" => Language.Phrase("View"),
                "SubaktivitasNilaiBlalbdPipaEdit" => Language.Phrase("Edit"),
                "SubaktivitasNilaiBlalbdPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubaktivitasNilaiBlalbdPipaView",
                Config.ApiAddAction => "SubaktivitasNilaiBlalbdPipaAdd",
                Config.ApiEditAction => "SubaktivitasNilaiBlalbdPipaEdit",
                Config.ApiDeleteAction => "SubaktivitasNilaiBlalbdPipaDelete",
                Config.ApiListAction => "SubaktivitasNilaiBlalbdPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubaktivitasNilaiBlalbdPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubaktivitasNilaiBlalbdPipaView", parm);
            else
                url = KeyUrl("SubaktivitasNilaiBlalbdPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubaktivitasNilaiBlalbdPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubaktivitasNilaiBlalbdPipaAdd?" + parm;
            else
                url = "SubaktivitasNilaiBlalbdPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasNilaiBlalbdPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasNilaiBlalbdPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasNilaiBlalbdPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasNilaiBlalbdPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubaktivitasNilaiBlalbdPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubaktivitasNilaiBlalbdPipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            BL_klobs.EditValue = BL_klobs.CurrentValue;
            ...
            BL_kl15.EditValue = BL_kl15.CurrentValue;
            ...
            AL_klobs.EditValue = AL_klobs.CurrentValue;
            ...
            AL_kl15.EditValue = AL_kl15.CurrentValue;
            ...
            BD_klobs.EditValue = BD_klobs.CurrentValue;
            ...
            BD_kl15.EditValue = BD_kl15.CurrentValue;
            ...
            BD_barrels.EditValue = BD_barrels.CurrentValue;
            ...
            BD_lt.EditValue = BD_lt.CurrentValue;
            ...
            BD_mt.EditValue = BD_mt.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(BL_klobs);
                        doc.ExportCaption(BL_kl15);
                        doc.ExportCaption(BL_barrels);
                        doc.ExportCaption(BL_lt);
                        doc.ExportCaption(BL_mt);
                        doc.ExportCaption(AL_klobs);
                        doc.ExportCaption(AL_kl15);
                        doc.ExportCaption(AL_barrels);
                        doc.ExportCaption(AL_lt);
                        doc.ExportCaption(AL_mt);
                        doc.ExportCaption(BD_klobs);
                        doc.ExportCaption(BD_kl15);
                        doc.ExportCaption(BD_barrels);
                        doc.ExportCaption(BD_lt);
                        doc.ExportCaption(BD_mt);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(BL_klobs);
                            await doc.ExportField(BL_kl15);
                            await doc.ExportField(BL_barrels);
                            await doc.ExportField(BL_lt);
                            await doc.ExportField(BL_mt);
                            await doc.ExportField(AL_klobs);
                            await doc.ExportField(AL_kl15);
                            await doc.ExportField(AL_barrels);
                            await doc.ExportField(AL_lt);
                            await doc.ExportField(AL_mt);
                            await doc.ExportField(BD_klobs);
                            await doc.ExportField(BD_kl15);
                            await doc.ExportField(BD_barrels);
                            await doc.ExportField(BD_lt);
                            await doc.ExportField(BD_mt);
