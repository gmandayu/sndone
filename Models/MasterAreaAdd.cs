...
public partial class SnDOne {
    ...
    public class MasterAreaAddBase : MasterArea
    {
        ...
        // Constructor
        public MasterAreaAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MasterAreaList"); // No matching record, return to List page // DN
                    }
                    break;
                    ...
                    if (res) { // Add successful
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MasterAreaList") {
                                ...
                                returnUrl = "MasterAreaList"; // Return list page content
                            }
                        }
