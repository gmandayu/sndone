...
public partial class SnDOne {
    ...
    public class SubaktivitasNilaiSfbdstsPnrBbmEditBase : SubaktivitasNilaiSfbdstsPnrBbm
    {
        ...
        // Constructor
        public SubaktivitasNilaiSfbdstsPnrBbmEditBase()
        {
        ...
        // Constructor
        public SubaktivitasNilaiSfbdstsPnrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasNilaiSfbdstsPnrBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasNilaiSfbdstsPnrBbmList") {
                                ...
                                returnUrl = "SubaktivitasNilaiSfbdstsPnrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
