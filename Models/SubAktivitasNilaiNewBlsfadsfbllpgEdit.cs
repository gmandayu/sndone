...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiNewBlsfadsfbllpgEditBase : SubAktivitasNilaiNewBlsfadsfbllpg
    {
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfbllpgEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfbllpgEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiNewBlsfadsfbllpgList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiNewBlsfadsfbllpgList") {
                        ...
                        returnUrl = "SubAktivitasNilaiNewBlsfadsfbllpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
