...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStartPembongkaranDelete
    /// </summary>
    public static SubAktivitasFormInputDataStartPembongkaranDelete subAktivitasFormInputDataStartPembongkaranDelete
    {
        get => HttpData.Get<SubAktivitasFormInputDataStartPembongkaranDelete>("subAktivitasFormInputDataStartPembongkaranDelete")!;
        set => HttpData["subAktivitasFormInputDataStartPembongkaranDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStartPembongkaran
    /// </summary>
    public class SubAktivitasFormInputDataStartPembongkaranDelete : SubAktivitasFormInputDataStartPembongkaranDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStartPembongkaranDeleteBase : SubAktivitasFormInputDataStartPembongkaran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStartPembongkaranDelete";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStartPembongkaranDelete";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputDataStartPembongkaranList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputDataStartPembongkaranList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputDataStartPembongkaranDelete?.PageRender();
            }
            return PageResult();
        }
