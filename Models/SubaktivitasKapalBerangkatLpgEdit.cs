...
public partial class SnDOne {
    ...
    public class SubaktivitasKapalBerangkatLpgEditBase : SubaktivitasKapalBerangkatLpg
    {
        ...
        // Constructor
        public SubaktivitasKapalBerangkatLpgEditBase()
        {
        ...
        // Constructor
        public SubaktivitasKapalBerangkatLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasKapalBerangkatLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasKapalBerangkatLpgList") {
                                ...
                                returnUrl = "SubaktivitasKapalBerangkatLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
