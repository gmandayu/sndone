...
public partial class SnDOne {
    ...
    /// penyaluranEdit
    /// </summary>
    public static PenyaluranEdit penyaluranEdit
    {
        get => HttpData.Get<PenyaluranEdit>("penyaluranEdit")!;
        set => HttpData["penyaluranEdit"] = value;
    }

    /// <summary>
    /// Page class for Penyaluran
    /// </summary>
    public class PenyaluranEdit : PenyaluranEditBase
    {
        // Constructor
        public PenyaluranEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenyaluranEdit() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PenyaluranEditBase : Penyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penyaluranEdit";
        ...
        // Page name
        public string PageName => "PenyaluranEdit";
        ...
        // Constructor
        public PenyaluranEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            SetVisibility();
            NomorPenyaluran.Required = false;
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("IdPenyaluran", out rv)) { // DN
                    IdPenyaluran.FormValue = UrlDecode(rv); // DN
                    IdPenyaluran.OldValue = IdPenyaluran.FormValue;
                } else if (CurrentForm.HasValue("x_IdPenyaluran")) {
                    IdPenyaluran.FormValue = CurrentForm.GetValue("x_IdPenyaluran");
                    IdPenyaluran.OldValue = IdPenyaluran.FormValue;
                } else if (!Empty(keyValues)) {
                    IdPenyaluran.OldValue = ConvertToString(keyValues[0]);
                } else {
                ...
                if (!Empty(Post("action"))) {
                    ...
                    if (RouteValues.TryGetValue("IdPenyaluran", out rv)) { // DN
                        ...
                        IdPenyaluran.CurrentValue = DbNullValue;
                    }
                }
        ...
        if (postBack) {
            ...
            if (IsApi() && RouteValues.TryGetValue("key", out object? k)) {
                ...
                IdPenyaluran.FormValue = ConvertToString(keyValues[0]);
            }
        }
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("PenyaluranList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = "PenyaluranList";
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'NomorPenyaluran' before field var 'x_NomorPenyaluran'
            val = CurrentForm.HasValue("NomorPenyaluran") ? CurrentForm.GetValue("NomorPenyaluran") : CurrentForm.GetValue("x_NomorPenyaluran");
            if (!NomorPenyaluran.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("NomorPenyaluran") && !CurrentForm.HasValue("x_NomorPenyaluran")) // DN
                    NomorPenyaluran.Visible = false; // Disable update for API request
                else
                    NomorPenyaluran.SetFormValue(val);
            }
            ...
            if (!TanggalSandar.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("TanggalSandar") && !CurrentForm.HasValue("x_TanggalSandar")) // DN
                    ...
                    TanggalSandar.SetFormValue(val);
        ...
        public void RestoreFormValues()
        {
            ...
            NomorPenyaluran.CurrentValue = NomorPenyaluran.FormValue;
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                if (NomorPenyaluran.Visible && NomorPenyaluran.Required) {
                    if (!NomorPenyaluran.IsDetailKey && Empty(NomorPenyaluran.FormValue)) {
                        NomorPenyaluran.AddErrorMessage(ConvertToString(NomorPenyaluran.RequiredErrorMessage).Replace("%s", NomorPenyaluran.Caption));
                    }
                }
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // NoShipment
            NoShipment.SetDbValue(rsnew, NoShipment.CurrentValue, NoShipment.ReadOnly);
