...
public partial class SnDOne {
    ...
    /// masterDermagaList
    /// </summary>
    public static MasterDermagaList masterDermagaList
    {
        get => HttpData.Get<MasterDermagaList>("masterDermagaList")!;
        set => HttpData["masterDermagaList"] = value;
    }

    /// <summary>
    /// Page class for MasterDermaga
    /// </summary>
    public class MasterDermagaList : MasterDermagaListBase
    {
        // Constructor
        public MasterDermagaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterDermagaList() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class MasterDermagaListBase : MasterDermaga
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterDermagaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fMasterDermagalist";
        ...
        // Constructor
        public MasterDermagaListBase(Controller? controller)
        {
        ...
        if (controller != null)
            ...
            MultiDeleteUrl = "MasterDermagaDelete";
            MultiUpdateUrl = "MasterDermagaUpdate";
        ...
        // Page name
        public string PageName => "MasterDermagaList";
        ...
        // Constructor
        public MasterDermagaListBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            if (!Security.CanSearch)
                return "";
            BuildSearchSql(ref where, Region, def, true); // Region
            BuildSearchSql(ref where, Id_Plant, def, true); // Id_Plant
            BuildSearchSql(ref where, Plant, def, true); // Plant
            BuildSearchSql(ref where, TBBM, def, true); // TBBM
            BuildSearchSql(ref where, Equipment_ID, def, true); // Equipment_ID
            BuildSearchSql(ref where, Fungsi, def, true); // Fungsi
            BuildSearchSql(ref where, Kapasitas_DWT, def, true); // Kapasitas_DWT
            BuildSearchSql(ref where, Kategori_Kapasitas, def, true); // Kategori_Kapasitas
            BuildSearchSql(ref where, Jenis_Sartam, def, true); // Jenis_Sartam
            BuildSearchSql(ref where, Type_Sartam, def, true); // Type_Sartam
            BuildSearchSql(ref where, Tahun_Pembuatan, def, true); // Tahun_Pembuatan
            BuildSearchSql(ref where, Kategori_Port, def, true); // Kategori_Port
        ...
        {
            string filterList = "";
            filterList += ProcessFieldFilter("Region", Region, true, config);
            filterList += ProcessFieldFilter("Id_Plant", Id_Plant, true, config);
            filterList += ProcessFieldFilter("TBBM", TBBM, true, config);
            filterList += ProcessFieldFilter("Equipment_ID", Equipment_ID, true, config);
            filterList += ProcessFieldFilter("Fungsi", Fungsi, true, config);
            filterList += ProcessFieldFilter("Kapasitas_DWT", Kapasitas_DWT, true, config);
            filterList += ProcessFieldFilter("Kategori_Kapasitas", Kategori_Kapasitas, true, config);
            filterList += ProcessFieldFilter("Jenis_Sartam", Jenis_Sartam, true, config);
            filterList += ProcessFieldFilter("Type_Sartam", Type_Sartam, true, config);
            filterList += ProcessFieldFilter("Tahun_Pembuatan", Tahun_Pembuatan, true, config);
            filterList += ProcessFieldFilter("Kategori_Port", Kategori_Port, true, config);
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(Region);
            searchFlds.Add(Id_Plant);
            searchFlds.Add(Plant);
            searchFlds.Add(TBBM);
            searchFlds.Add(Equipment_ID);
            searchFlds.Add(Fungsi);
            searchFlds.Add(Kapasitas_DWT);
            searchFlds.Add(Kategori_Kapasitas);
            searchFlds.Add(Jenis_Sartam);
            searchFlds.Add(Type_Sartam);
            searchFlds.Add(Tahun_Pembuatan);
            searchFlds.Add(Kategori_Port);
        ...
        protected bool CheckSearchParms() {
            ...
            if (BasicSearch.IssetSession)
                return true;
            if (Region.AdvancedSearch.IssetSession)
                return true;
            if (Id_Plant.AdvancedSearch.IssetSession)
                return true;
            if (Plant.AdvancedSearch.IssetSession)
                return true;
            if (TBBM.AdvancedSearch.IssetSession)
                return true;
            if (Equipment_ID.AdvancedSearch.IssetSession)
                return true;
            if (Fungsi.AdvancedSearch.IssetSession)
                return true;
            if (Kapasitas_DWT.AdvancedSearch.IssetSession)
                return true;
            if (Kategori_Kapasitas.AdvancedSearch.IssetSession)
                return true;
            if (Jenis_Sartam.AdvancedSearch.IssetSession)
                return true;
            if (Type_Sartam.AdvancedSearch.IssetSession)
                return true;
            if (Tahun_Pembuatan.AdvancedSearch.IssetSession)
                return true;
            if (Kategori_Port.AdvancedSearch.IssetSession)
                return true;
        ...
        protected void ResetAdvancedSearchParms() {
            Region.AdvancedSearch.UnsetSession();
            Id_Plant.AdvancedSearch.UnsetSession();
            Plant.AdvancedSearch.UnsetSession();
            TBBM.AdvancedSearch.UnsetSession();
            Equipment_ID.AdvancedSearch.UnsetSession();
            Fungsi.AdvancedSearch.UnsetSession();
            Kapasitas_DWT.AdvancedSearch.UnsetSession();
            Kategori_Kapasitas.AdvancedSearch.UnsetSession();
            Jenis_Sartam.AdvancedSearch.UnsetSession();
            Type_Sartam.AdvancedSearch.UnsetSession();
            Tahun_Pembuatan.AdvancedSearch.UnsetSession();
            Kategori_Port.AdvancedSearch.UnsetSession();
        ...
        protected void RestoreSearchParms() {
            ...
            Region.AdvancedSearch.Load();
            Id_Plant.AdvancedSearch.Load();
            Plant.AdvancedSearch.Load();
            TBBM.AdvancedSearch.Load();
            Equipment_ID.AdvancedSearch.Load();
            Fungsi.AdvancedSearch.Load();
            Kapasitas_DWT.AdvancedSearch.Load();
            Kategori_Kapasitas.AdvancedSearch.Load();
            Jenis_Sartam.AdvancedSearch.Load();
            Type_Sartam.AdvancedSearch.Load();
            Tahun_Pembuatan.AdvancedSearch.Load();
            Kategori_Port.AdvancedSearch.Load();
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(Region, ctrl); // Region
                UpdateSort(Id_Plant, ctrl); // Id_Plant
                UpdateSort(TBBM, ctrl); // TBBM
                UpdateSort(Equipment_ID, ctrl); // Equipment_ID
                UpdateSort(Fungsi, ctrl); // Fungsi
                UpdateSort(Kapasitas_DWT, ctrl); // Kapasitas_DWT
                UpdateSort(Kategori_Kapasitas, ctrl); // Kategori_Kapasitas
                UpdateSort(Jenis_Sartam, ctrl); // Jenis_Sartam
                UpdateSort(Type_Sartam, ctrl); // Type_Sartam
                UpdateSort(Tahun_Pembuatan, ctrl); // Tahun_Pembuatan
                UpdateSort(Kategori_Port, ctrl); // Kategori_Port
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    Fungsi.Sort = "";
                    Kapasitas_DWT.Sort = "";
                    Kategori_Kapasitas.Sort = "";
                    Jenis_Sartam.Sort = "";
                    Type_Sartam.Sort = "";
                    Tahun_Pembuatan.Sort = "";
                    Kategori_Port.Sort = "";
                    DibuatOleh.Sort = "";
                    TanggalDibuat.Sort = "";
                    DiperbaruiOleh.Sort = "";
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""MasterDermaga"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""MasterDermaga"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalAdd && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-copy"" title=""{copycaption}"" data-table=""MasterDermaga"" data-caption=""{copycaption}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(CopyUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("CopyLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fMasterDermagalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fMasterDermagalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
            ...
            listOption?.SetBody("<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" + RowCount + "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" + HtmlEncode(IdDermaga.CurrentValue) + "\" data-ew-action=\"select-key\"></div>");
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""MasterDermaga"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            item.Body = $@"<button type=""button"" class=""ew-action ew-multi-delete"" title=""{deleteTitle}"" data-caption=""{deleteTitle}"" form=""fMasterDermagalist""" +
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("Region")); // DN
                CreateColumnOption(option.Add("Id_Plant")); // DN
                CreateColumnOption(option.Add("TBBM")); // DN
                CreateColumnOption(option.Add("Equipment_ID")); // DN
                CreateColumnOption(option.Add("Fungsi")); // DN
                CreateColumnOption(option.Add("Kapasitas_DWT")); // DN
                CreateColumnOption(option.Add("Kategori_Kapasitas")); // DN
                CreateColumnOption(option.Add("Jenis_Sartam")); // DN
                CreateColumnOption(option.Add("Type_Sartam")); // DN
                CreateColumnOption(option.Add("Tahun_Pembuatan")); // DN
                CreateColumnOption(option.Add("Kategori_Port")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fMasterDermagasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fMasterDermagasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fMasterDermagalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        private async Task<bool> HandleTemplateRow()
        {
            if ((IsGridAdd || IsGridEdit) && SameString(RowIndex, "$rowindex$")) { // Render template row first
                ...
                RowAttrs.Add("id", "r0_MasterDermaga");
        ...
        private void SetupRowCountsAndAttributes()
        {
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(masterDermagaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(masterDermagaList.RowCount) + "_MasterDermaga");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(masterDermagaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && masterDermagaList.RowType == RowType.Add || IsEdit && masterDermagaList.RowType == RowType.Edit) // Inline-Add/Edit row
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        {
            LoadFieldRegionSearchValues();
            LoadFieldId_PlantSearchValues();
            LoadFieldPlantSearchValues();
            LoadFieldTBBMSearchValues();
            LoadFieldEquipment_IDSearchValues();
            LoadFieldFungsiSearchValues();
            LoadFieldKapasitas_DWTSearchValues();
            LoadFieldKategori_KapasitasSearchValues();
            LoadFieldJenis_SartamSearchValues();
            LoadFieldType_SartamSearchValues();
            LoadFieldTahun_PembuatanSearchValues();
            LoadFieldKategori_PortSearchValues();
        ...
        private void LoadFieldRegionSearchValues()
        {
            // Region
            LoadPrimarySearchValueRegion();
            LoadSearchOperatorRegion();
        }

        private void LoadPrimarySearchValueRegion()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Region[]")) {
                Region.AdvancedSearch.SearchValue = Get("x_Region[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                Region.AdvancedSearch.SearchValue = Get("Region"); // Default Value // DN
            }
            if (!Empty(Region.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorRegion()
        {
            if (Query.ContainsKey("z_Region"))
                Region.AdvancedSearch.SearchOperator = Get("z_Region", Config.FilterOptionSeparator);
        }

        private void LoadFieldId_PlantSearchValues()
        {
            // Id_Plant
            LoadPrimarySearchValueId_Plant();
            LoadSearchOperatorId_Plant();
        }

        private void LoadPrimarySearchValueId_Plant()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Id_Plant[]")) {
                Id_Plant.AdvancedSearch.SearchValue = Get("x_Id_Plant[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                Id_Plant.AdvancedSearch.SearchValue = Get("Id_Plant"); // Default Value // DN
            }
            if (!Empty(Id_Plant.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorId_Plant()
        {
            if (Query.ContainsKey("z_Id_Plant"))
                Id_Plant.AdvancedSearch.SearchOperator = Get("z_Id_Plant", Config.FilterOptionSeparator);
        }
        ...
        private void LoadFieldTBBMSearchValues()
        {
            // TBBM
            LoadPrimarySearchValueTBBM();
            LoadSearchOperatorTBBM();
        }

        private void LoadPrimarySearchValueTBBM()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_TBBM[]")) {
                TBBM.AdvancedSearch.SearchValue = Get("x_TBBM[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                TBBM.AdvancedSearch.SearchValue = Get("TBBM"); // Default Value // DN
            }
            if (!Empty(TBBM.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorTBBM()
        {
            if (Query.ContainsKey("z_TBBM"))
                TBBM.AdvancedSearch.SearchOperator = Get("z_TBBM", Config.FilterOptionSeparator);
        }

        private void LoadFieldEquipment_IDSearchValues()
        {
            // Equipment_ID
            LoadPrimarySearchValueEquipment_ID();
            LoadSearchOperatorEquipment_ID();
        }

        private void LoadPrimarySearchValueEquipment_ID()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Equipment_ID[]")) {
                Equipment_ID.AdvancedSearch.SearchValue = Get("x_Equipment_ID[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                Equipment_ID.AdvancedSearch.SearchValue = Get("Equipment_ID"); // Default Value // DN
            }
            if (!Empty(Equipment_ID.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorEquipment_ID()
        {
            if (Query.ContainsKey("z_Equipment_ID"))
                Equipment_ID.AdvancedSearch.SearchOperator = Get("z_Equipment_ID", Config.FilterOptionSeparator);
        }

        private void LoadFieldFungsiSearchValues()
        {
            // Fungsi
            LoadPrimarySearchValueFungsi();
            LoadSearchOperatorFungsi();
        }

        private void LoadPrimarySearchValueFungsi()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Fungsi[]")) {
                Fungsi.AdvancedSearch.SearchValue = Get("x_Fungsi[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                Fungsi.AdvancedSearch.SearchValue = Get("Fungsi"); // Default Value // DN
            }
            if (!Empty(Fungsi.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorFungsi()
        {
            if (Query.ContainsKey("z_Fungsi"))
                Fungsi.AdvancedSearch.SearchOperator = Get("z_Fungsi", Config.FilterOptionSeparator);
        }

        private void LoadFieldKapasitas_DWTSearchValues()
        {
            // Kapasitas_DWT
            LoadPrimarySearchValueKapasitas_DWT();
            LoadSearchOperatorKapasitas_DWT();
        }

        private void LoadPrimarySearchValueKapasitas_DWT()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Kapasitas_DWT[]")) {
                Kapasitas_DWT.AdvancedSearch.SearchValue = Get("x_Kapasitas_DWT[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                Kapasitas_DWT.AdvancedSearch.SearchValue = Get("Kapasitas_DWT"); // Default Value // DN
            }
            if (!Empty(Kapasitas_DWT.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorKapasitas_DWT()
        {
            if (Query.ContainsKey("z_Kapasitas_DWT"))
                Kapasitas_DWT.AdvancedSearch.SearchOperator = Get("z_Kapasitas_DWT", Config.FilterOptionSeparator);
        }

        private void LoadFieldKategori_KapasitasSearchValues()
        {
            // Kategori_Kapasitas
            LoadPrimarySearchValueKategori_Kapasitas();
            LoadSearchOperatorKategori_Kapasitas();
        }

        private void LoadPrimarySearchValueKategori_Kapasitas()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Kategori_Kapasitas[]")) {
                Kategori_Kapasitas.AdvancedSearch.SearchValue = Get("x_Kategori_Kapasitas[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                Kategori_Kapasitas.AdvancedSearch.SearchValue = Get("Kategori_Kapasitas"); // Default Value // DN
            }
            if (!Empty(Kategori_Kapasitas.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorKategori_Kapasitas()
        {
            if (Query.ContainsKey("z_Kategori_Kapasitas"))
                Kategori_Kapasitas.AdvancedSearch.SearchOperator = Get("z_Kategori_Kapasitas", Config.FilterOptionSeparator);
        }

        private void LoadFieldJenis_SartamSearchValues()
        {
            // Jenis_Sartam
            LoadPrimarySearchValueJenis_Sartam();
            LoadSearchOperatorJenis_Sartam();
        }

        private void LoadPrimarySearchValueJenis_Sartam()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Jenis_Sartam[]")) {
                Jenis_Sartam.AdvancedSearch.SearchValue = Get("x_Jenis_Sartam[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                Jenis_Sartam.AdvancedSearch.SearchValue = Get("Jenis_Sartam"); // Default Value // DN
            }
            if (!Empty(Jenis_Sartam.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorJenis_Sartam()
        {
            if (Query.ContainsKey("z_Jenis_Sartam"))
                Jenis_Sartam.AdvancedSearch.SearchOperator = Get("z_Jenis_Sartam", Config.FilterOptionSeparator);
        }

        private void LoadFieldType_SartamSearchValues()
        {
            // Type_Sartam
            LoadPrimarySearchValueType_Sartam();
            LoadSearchOperatorType_Sartam();
        }

        private void LoadPrimarySearchValueType_Sartam()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Type_Sartam[]")) {
                Type_Sartam.AdvancedSearch.SearchValue = Get("x_Type_Sartam[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                Type_Sartam.AdvancedSearch.SearchValue = Get("Type_Sartam"); // Default Value // DN
            }
            if (!Empty(Type_Sartam.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorType_Sartam()
        {
            if (Query.ContainsKey("z_Type_Sartam"))
                Type_Sartam.AdvancedSearch.SearchOperator = Get("z_Type_Sartam", Config.FilterOptionSeparator);
        }

        private void LoadFieldTahun_PembuatanSearchValues()
        {
            // Tahun_Pembuatan
            LoadPrimarySearchValueTahun_Pembuatan();
            LoadSearchOperatorTahun_Pembuatan();
        }

        private void LoadPrimarySearchValueTahun_Pembuatan()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Tahun_Pembuatan[]")) {
                Tahun_Pembuatan.AdvancedSearch.SearchValue = Get("x_Tahun_Pembuatan[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                Tahun_Pembuatan.AdvancedSearch.SearchValue = Get("Tahun_Pembuatan"); // Default Value // DN
            }
            if (!Empty(Tahun_Pembuatan.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorTahun_Pembuatan()
        {
            if (Query.ContainsKey("z_Tahun_Pembuatan"))
                Tahun_Pembuatan.AdvancedSearch.SearchOperator = Get("z_Tahun_Pembuatan", Config.FilterOptionSeparator);
        }

        private void LoadFieldKategori_PortSearchValues()
        {
            // Kategori_Port
            LoadPrimarySearchValueKategori_Port();
            LoadSearchOperatorKategori_Port();
        }

        private void LoadPrimarySearchValueKategori_Port()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Kategori_Port[]")) {
                Kategori_Port.AdvancedSearch.SearchValue = Get("x_Kategori_Port[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                Kategori_Port.AdvancedSearch.SearchValue = Get("Kategori_Port"); // Default Value // DN
            }
            if (!Empty(Kategori_Port.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorKategori_Port()
        {
            if (Query.ContainsKey("z_Kategori_Port"))
                Kategori_Port.AdvancedSearch.SearchOperator = Get("z_Kategori_Port", Config.FilterOptionSeparator);
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // Region
                if (Region.UseFilter && !Empty(Region.AdvancedSearch.SearchValue)) {
                    Region.EditValue = ConvertToString(Region.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // Id_Plant
                if (Id_Plant.UseFilter && !Empty(Id_Plant.AdvancedSearch.SearchValue)) {
                    Id_Plant.EditValue = ConvertToString(Id_Plant.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // TBBM
                if (TBBM.UseFilter && !Empty(TBBM.AdvancedSearch.SearchValue)) {
                    TBBM.EditValue = ConvertToString(TBBM.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // Equipment_ID
                if (Equipment_ID.UseFilter && !Empty(Equipment_ID.AdvancedSearch.SearchValue)) {
                    Equipment_ID.EditValue = ConvertToString(Equipment_ID.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // Fungsi
                if (Fungsi.UseFilter && !Empty(Fungsi.AdvancedSearch.SearchValue)) {
                    Fungsi.EditValue = ConvertToString(Fungsi.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // Kapasitas_DWT
                if (Kapasitas_DWT.UseFilter && !Empty(Kapasitas_DWT.AdvancedSearch.SearchValue)) {
                    Kapasitas_DWT.EditValue = ConvertToString(Kapasitas_DWT.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // Kategori_Kapasitas
                if (Kategori_Kapasitas.UseFilter && !Empty(Kategori_Kapasitas.AdvancedSearch.SearchValue)) {
                    Kategori_Kapasitas.EditValue = ConvertToString(Kategori_Kapasitas.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // Jenis_Sartam
                if (Jenis_Sartam.UseFilter && !Empty(Jenis_Sartam.AdvancedSearch.SearchValue)) {
                    Jenis_Sartam.EditValue = ConvertToString(Jenis_Sartam.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // Type_Sartam
                if (Type_Sartam.UseFilter && !Empty(Type_Sartam.AdvancedSearch.SearchValue)) {
                    Type_Sartam.EditValue = ConvertToString(Type_Sartam.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // Tahun_Pembuatan
                if (Tahun_Pembuatan.UseFilter && !Empty(Tahun_Pembuatan.AdvancedSearch.SearchValue)) {
                    Tahun_Pembuatan.EditValue = ConvertToString(Tahun_Pembuatan.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // Kategori_Port
                if (Kategori_Port.UseFilter && !Empty(Kategori_Port.AdvancedSearch.SearchValue)) {
                    Kategori_Port.EditValue = ConvertToString(Kategori_Port.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }
...
protected void SetupExportOptions() {
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fMasterDermagasrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
