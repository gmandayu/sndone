...
public partial class SnDOne {
    ...
    public class SubAktivitasDataMobilTangkiMtGateOutLpgEditBase : SubAktivitasDataMobilTangkiMtGateOutLpg
    {
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataMobilTangkiMtGateOutLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataMobilTangkiMtGateOutLpgList") {
                                ...
                                returnUrl = "SubAktivitasDataMobilTangkiMtGateOutLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'WaktuGateOut' before field var 'x_WaktuGateOut'
            val = CurrentForm.HasValue("WaktuGateOut") ? CurrentForm.GetValue("WaktuGateOut") : CurrentForm.GetValue("x_WaktuGateOut");
            if (!WaktuGateOut.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("WaktuGateOut") && !CurrentForm.HasValue("x_WaktuGateOut")) // DN
                    WaktuGateOut.Visible = false; // Disable update for API request
                else
                    WaktuGateOut.SetFormValue(val, true, validate);
