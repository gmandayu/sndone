...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit
    /// </summary>
    public static SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit subAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit>("subAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit")!;
        set => HttpData["subAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG
    /// </summary>
    public class SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit : SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEditBase : SubAktivitasNilaiAgreementPenyaluranStsPyrLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList")), "", TableVar, true);
            string pageId = "edit";
