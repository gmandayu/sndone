...
public partial class SnDOne {
    ...
    /// penyaluranView
    /// </summary>
    public static PenyaluranView penyaluranView
    {
        get => HttpData.Get<PenyaluranView>("penyaluranView")!;
        set => HttpData["penyaluranView"] = value;
    }

    /// <summary>
    /// Page class for Penyaluran
    /// </summary>
    public class PenyaluranView : PenyaluranViewBase
    {
        // Constructor
        public PenyaluranView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenyaluranView() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PenyaluranViewBase : Penyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penyaluranView";
        ...
        public PenyaluranViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdPenyaluran"] = keys[0];
            } else {
                RecordKeys["IdPenyaluran"] = RouteValues.TryGetValue("IdPenyaluran", out obj) && obj != null ? UrlDecode(obj) : Get("IdPenyaluran"); // DN
            }
        ...
        // Page name
        public string PageName => "PenyaluranView";
        ...
        public void SetVisibility()
        {
            ...
            TujuanKonsinyasi2.SetVisibility();
            Volume2.SetVisibility();
            TujuanKonsinyasi3.SetVisibility();
        ...
        // Constructor
        public PenyaluranViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdPenyaluran", out v) && !Empty(v)) { // DN
                IdPenyaluran.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdPenyaluran"] = IdPenyaluran.QueryValue;
            } else if (Get("IdPenyaluran", out sv)) {
                IdPenyaluran.QueryValue = sv.ToString();
                RecordKeys["IdPenyaluran"] = IdPenyaluran.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdPenyaluran.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdPenyaluran"] = IdPenyaluran.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "PenyaluranList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("PenyaluranList"); // Return to list page
                            }
                        }
                    break;
            }
