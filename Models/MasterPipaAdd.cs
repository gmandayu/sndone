...
public partial class SnDOne {
    ...
    public class MasterPipaAddBase : MasterPipa
    {
        ...
        // Constructor
        public MasterPipaAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MasterPipaList"); // No matching record, return to List page // DN
                    }
                    break;
