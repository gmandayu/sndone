...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbookPenerimaanStsPymLpgAddBase : SubAktivitasFormInputLogbookPenerimaanStsPymLpg
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgAddBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasFormInputLogbookPenerimaanStsPymLpgList"); // No matching record, return to List page // DN
                    }
                    break;
                    ...
                    if (res) { // Add successful
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputLogbookPenerimaanStsPymLpgList") {
                                ...
                                returnUrl = "SubAktivitasFormInputLogbookPenerimaanStsPymLpgList"; // Return list page content
                            }
                        }
