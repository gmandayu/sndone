...
public partial class SnDOne {
    /// <summary>
    /// templateAktivitasDokumenView
    /// </summary>
    public static TemplateAktivitasDokumenView templateAktivitasDokumenView
    {
        get => HttpData.Get<TemplateAktivitasDokumenView>("templateAktivitasDokumenView")!;
        set => HttpData["templateAktivitasDokumenView"] = value;
    }

    /// <summary>
    /// Page class for TemplateAktivitasDokumen
    /// </summary>
    public class TemplateAktivitasDokumenView : TemplateAktivitasDokumenViewBase
    {
        // Constructor
        public TemplateAktivitasDokumenView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TemplateAktivitasDokumenView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TemplateAktivitasDokumenViewBase : TemplateAktivitasDokumen
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "templateAktivitasDokumenView";
        ...
        // Constructor
        public TemplateAktivitasDokumenViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdTemplateAktivitasDokumen"] = keys[0];
            } else {
                RecordKeys["IdTemplateAktivitasDokumen"] = RouteValues.TryGetValue("IdTemplateAktivitasDokumen", out obj) && obj != null ? UrlDecode(obj) : Get("IdTemplateAktivitasDokumen"); // DN
            }
        ...
        // Page name
        public string PageName => "TemplateAktivitasDokumenView";
        ...
        {
            IdTemplateAktivitasDokumen.SetVisibility();
        ...
        // Constructor
        public TemplateAktivitasDokumenViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdTemplateAktivitasDokumen", out v) && !Empty(v)) { // DN
                IdTemplateAktivitasDokumen.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdTemplateAktivitasDokumen"] = IdTemplateAktivitasDokumen.QueryValue;
            } else if (Get("IdTemplateAktivitasDokumen", out sv)) {
                IdTemplateAktivitasDokumen.QueryValue = sv.ToString();
                RecordKeys["IdTemplateAktivitasDokumen"] = IdTemplateAktivitasDokumen.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdTemplateAktivitasDokumen.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdTemplateAktivitasDokumen"] = IdTemplateAktivitasDokumen.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "TemplateAktivitasDokumenList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("TemplateAktivitasDokumenList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                templateAktivitasDokumenView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fTemplateAktivitasDokumenview\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fTemplateAktivitasDokumenview\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fTemplateAktivitasDokumenview\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        public async Task ExportData(dynamic? doc, string[] keys)
        {
            ...
            StartRecord = 1;
            if (keys.Length >= 1) {
                IdTemplateAktivitasDokumen.OldValue = keys[0];
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("TemplateAktivitasDokumenList")), "", TableVar, true);
            string pageId = "view";
