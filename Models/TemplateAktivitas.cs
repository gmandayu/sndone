...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static TemplateAktivitas templateAktivitas
    {
        get => HttpData.Resolve<TemplateAktivitas>("TemplateAktivitas");
        set => HttpData["TemplateAktivitas"] = value;
    }

    /// <summary>
    /// Table class for TemplateAktivitas
    /// </summary>
    public class TemplateAktivitas : DbTable
    {
        public override Dictionary<string, string> KeyFields { get; set; } = new() { // DN
            { "IdTemplateAktivitas", "IdTemplateAktivitas" },
        };
        ...
        public readonly DbField<SqlDbType> UrutanAktivitas;
        ...
        // Constructor
        public TemplateAktivitas()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "TemplateAktivitas";
            Name = "TemplateAktivitas";
            Type = "TABLE";
            UpdateTable = "dbo.TemplateAktivitas"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdTemplateAktivitas = new(this, "x_IdTemplateAktivitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "IdTemplateAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdTemplateProses = new(this, "x_IdTemplateProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "IdTemplateProses", "CustomMsg"),
                IsUpload = false
            };
            IdTemplateProses.Raw = true;
            IdTemplateProses.Lookup = new Lookup<DbField>(IdTemplateProses, "TemplateProses", true, "IdTemplateProses", new List<string> {"NamaProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[NamaProses]");
            Fields.Add("IdTemplateProses", IdTemplateProses);

            // UrutanAktivitas
            UrutanAktivitas = new(this, "x_UrutanAktivitas", 3, SqlDbType.Int) {
                Name = "UrutanAktivitas",
                Expression = "[UrutanAktivitas]",
                UseBasicSearch = true,
                BasicSearchExpression = "CAST([UrutanAktivitas] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[UrutanAktivitas]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "UrutanAktivitas", "CustomMsg"),
                IsUpload = false
            };
            UrutanAktivitas.Raw = true;
            UrutanAktivitas.Lookup = new Lookup<DbField>(UrutanAktivitas, "TemplateAktivitas", true, "UrutanAktivitas", new List<string> {"UrutanAktivitas", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("UrutanAktivitas", UrutanAktivitas);

            // NamaAktivitas
            NamaAktivitas = new(this, "x_NamaAktivitas", 200, SqlDbType.VarChar) {
                Name = "NamaAktivitas",
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "NamaAktivitas", "CustomMsg"),
                IsUpload = false
            };
            NamaAktivitas.Lookup = new Lookup<DbField>(NamaAktivitas, "TemplateAktivitas", true, "NamaAktivitas", new List<string> {"NamaAktivitas", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NamaAktivitas", NamaAktivitas);

            // IdPIC
            IdPIC = new(this, "x_IdPIC", 202, SqlDbType.NVarChar) {
                Name = "IdPIC",
                Expression = "[IdPIC]",
                UseBasicSearch = true,
                BasicSearchExpression = "[IdPIC]",
                DateTimeFormat = -1,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "IdPIC", "CustomMsg"),
                IsUpload = false
            };
            ...
            Keterangan = new(this, "x_Keterangan", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            Keterangan.Lookup = new Lookup<DbField>(Keterangan, "TemplateAktivitas", true, "Keterangan", new List<string> {"Keterangan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            DibuatOleh.Lookup = new Lookup<DbField>(DibuatOleh, "TemplateAktivitas", true, "DibuatOleh", new List<string> {"DibuatOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            TanggalDibuat.Raw = true;
            TanggalDibuat.Lookup = new Lookup<DbField>(TanggalDibuat, "TemplateAktivitas", true, "TanggalDibuat", new List<string> {"TanggalDibuat", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            DiperbaruiOleh.Lookup = new Lookup<DbField>(DiperbaruiOleh, "TemplateAktivitas", true, "DiperbaruiOleh", new List<string> {"DiperbaruiOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiperbarui.Raw = true;
            TanggalDiperbarui.Lookup = new Lookup<DbField>(TanggalDiperbarui, "TemplateAktivitas", true, "TanggalDiperbarui", new List<string> {"TanggalDiperbarui", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TipeAktivitas = new(this, "x_TipeAktivitas", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "TipeAktivitas", "CustomMsg"),
                IsUpload = false
            };
            TipeAktivitas.Lookup = new Lookup<DbField>(TipeAktivitas, "TemplateAktivitas", true, "TipeAktivitas", new List<string> {"TipeAktivitas", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            _URL = new(this, "x__URL", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitas", "_URL", "CustomMsg"),
                IsUpload = false
            };
            _URL.Lookup = new Lookup<DbField>(_URL, "TemplateAktivitas", true, "URL", new List<string> {"URL", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("URL", _URL);
        ...
        public string MasterFilterFromSession
        {
            get { // Master filter
                string masterFilter = "";
            if (CurrentMasterTable == "TemplateProses") {
                dynamic masterTable = Resolve("TemplateProses")!;
                if (!Empty(IdTemplateProses.SessionValue))
                    masterFilter += "" + KeyFilter(masterTable.IdTemplateProses, IdTemplateProses.SessionValue, masterTable.IdTemplateProses.DataType, masterTable.DbId);
                else
                    return "";
            }
                return masterFilter;
        ...
        public string DetailFilterFromSession
        {
            get { // Detail filter
                ...
                if (CurrentMasterTable == "TemplateProses") {
                    dynamic masterTable = Resolve("TemplateProses")!;
                    if (!Empty(IdTemplateProses.SessionValue))
                        detailFilter += "" + KeyFilter(IdTemplateProses, IdTemplateProses.SessionValue, masterTable.IdTemplateProses.DataType, DbId);
                    else
                        return "";
                }
                return detailFilter;
        ...
        public string? MasterFilter(dynamic? masterTable, Dictionary<string, object?> keys) // DN
        {
            ...
            case "TemplateProses":
                key = keys["IdTemplateProses"] ?? "";
                if (Empty(key)) {
                    if (masterTable.IdTemplateProses.Required) // Required field and empty value
                ...
                if (validKeys) {
                    return KeyFilter(masterTable.IdTemplateProses, keys["IdTemplateProses"], IdTemplateProses.DataType, DbId);
                }
                break;
            }
        ...
        public string DetailFilter(dynamic masterTable) // DN
        {
            return masterTable.TableVar switch {
                "TemplateProses" => KeyFilter(IdTemplateProses, masterTable.IdTemplateProses.DbValue, masterTable.IdTemplateProses.DataType, masterTable.DbId),
                _ => ""
            };
        }
        ...
        public string DetailUrl
        {
            get {
                string detailUrl = "";
                if (CurrentDetailTable == "TemplateAktivitasDokumen" && templateAktivitasDokumen != null) {
                    detailUrl = templateAktivitasDokumen.ListUrl + "?" + Config.TableShowMaster + "=" + TableVar;
                    detailUrl += "&" + ForeignKeyUrl("fk_IdTemplateAktivitas", IdTemplateAktivitas.CurrentValue);
                }
                if (Empty(detailUrl))
                    detailUrl = "TemplateAktivitasList";
                return detailUrl;
            }
        }
        ...
        {
            get => _sqlFrom ?? "dbo.TemplateAktivitas";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.TemplateAktivita type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdTemplateAktivitas"))
                    row["IdTemplateAktivitas"] = lastInsertedId;
                else
                    row.Add("IdTemplateAktivitas", lastInsertedId);
                IdTemplateAktivitas.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                UrutanAktivitas.DbValue = row["UrutanAktivitas"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[IdTemplateAktivitas] = @IdTemplateAktivitas@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "TemplateAktivitasView" => Language.Phrase("View"),
                "TemplateAktivitasEdit" => Language.Phrase("Edit"),
                "TemplateAktivitasAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TemplateAktivitasView",
                Config.ApiAddAction => "TemplateAktivitasAdd",
                Config.ApiEditAction => "TemplateAktivitasEdit",
                Config.ApiDeleteAction => "TemplateAktivitasDelete",
                Config.ApiListAction => "TemplateAktivitasList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TemplateAktivitasList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TemplateAktivitasView", parm);
            else
                url = KeyUrl("TemplateAktivitasView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TemplateAktivitasAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "TemplateAktivitasAdd?" + parm;
            else
                url = "TemplateAktivitasAdd";
        ...
        public string GetEditUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TemplateAktivitasEdit", parm);
            else
                url = KeyUrl("TemplateAktivitasEdit", Config.TableShowDetail + "=");
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TemplateAktivitasList", "action=edit"))); // DN
        ...
        public string GetCopyUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TemplateAktivitasAdd", parm);
            else
                url = KeyUrl("TemplateAktivitasAdd", Config.TableShowDetail + "=");
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TemplateAktivitasList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("TemplateAktivitasDelete", parm)); // DN
        }
        ...
        {
            if (CurrentMasterTable == "TemplateProses" && !url.Contains(Config.TableShowMaster + "=")) {
                url += (url.Contains("?") ? "&" : "?") + Config.TableShowMaster + "=" + CurrentMasterTable;
                url += "&" + ForeignKeyUrl("fk_IdTemplateProses", IdTemplateProses.SessionValue); // Use Session Value
            }
            return url;
        }
        ...
        {
            string json = "";
            json += "\"IdTemplateAktivitas\":" + ConvertToJson(IdTemplateAktivitas.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdTemplateAktivitas.CurrentValue)) {
                url += "/" + IdTemplateAktivitas.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdTemplateAktivitas", out object? v0)) { // IdTemplateAktivitas // DN
                    key = UrlDecode(v0); // DN
                } else if (IsApi() && !Empty(keyValues)) {
                    key = keyValues[0];
                } else {
                    key = Param("IdTemplateAktivitas");
                }
                keysList.Add(key);
            }
            // Check keys
            foreach (var keys in keysList) {
                if (KeyFields.Count > 1 && (!IsArray(keys) || keys.Length != KeyFields.Count))
                    continue;
                if (!IsNumeric(keys)) // IdTemplateAktivitas
                    continue;
                result.Add(keys);
            }
            return result;
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdTemplateAktivitas.CurrentValue = keys;
                else
                    IdTemplateAktivitas.OldValue = keys;
        ...
        {
            string pageName = "TemplateAktivitasList";
        ...
        public async Task RenderEditRow()
        {
            ...
            IdTemplateAktivitas.EditValue = IdTemplateAktivitas.CurrentValue;
            IdTemplateAktivitas.ViewCustomAttributes = "";
            ...
            _URL.EditValue = _URL.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(UrutanAktivitas);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(UrutanAktivitas);
