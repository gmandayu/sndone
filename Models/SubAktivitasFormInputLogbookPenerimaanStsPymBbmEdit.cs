...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbookPenerimaanStsPymBbmEdit
    /// </summary>
    public static SubAktivitasFormInputLogbookPenerimaanStsPymBbmEdit subAktivitasFormInputLogbookPenerimaanStsPymBbmEdit
    {
        get => HttpData.Get<SubAktivitasFormInputLogbookPenerimaanStsPymBbmEdit>("subAktivitasFormInputLogbookPenerimaanStsPymBbmEdit")!;
        set => HttpData["subAktivitasFormInputLogbookPenerimaanStsPymBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbookPenerimaanSTSPymBBM
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanStsPymBbmEdit : SubAktivitasFormInputLogbookPenerimaanStsPymBbmEditBase
    {
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanStsPymBbmEditBase : SubAktivitasFormInputLogbookPenerimaanStsPymBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbookPenerimaanStsPymBbmEdit";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymBbmEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbookPenerimaanStsPymBbmEdit";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymBbmEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputLogbookPenerimaanStsPymBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputLogbookPenerimaanStsPymBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputLogbookPenerimaanStsPymBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputLogbookPenerimaanStsPymBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputLogbookPenerimaanStsPymBbmList")), "", TableVar, true);
            string pageId = "edit";
