...
public partial class SnDOne {
    ...
    public class GoodHouseKeepingViewBase : GoodHouseKeeping
    {
        ...
        // Constructor
        public GoodHouseKeepingViewBase(Controller? controller)
        {
        ...
        // Constructor
        public GoodHouseKeepingViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdGoodHouseKeeping", out v) && !Empty(v))
                {
                IdGoodHouseKeeping.QueryValue = UrlDecode(v);
                RecordKeys["IdGoodHouseKeeping"] = IdGoodHouseKeeping.QueryValue;
                return;
                }
                if (Get("IdGoodHouseKeeping", out sv))
                {
