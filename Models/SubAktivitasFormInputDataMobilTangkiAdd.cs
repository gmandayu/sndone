...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataMobilTangkiAdd
    /// </summary>
    public static SubAktivitasFormInputDataMobilTangkiAdd subAktivitasFormInputDataMobilTangkiAdd
    {
        get => HttpData.Get<SubAktivitasFormInputDataMobilTangkiAdd>("subAktivitasFormInputDataMobilTangkiAdd")!;
        set => HttpData["subAktivitasFormInputDataMobilTangkiAdd"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataMobilTangki
    /// </summary>
    public class SubAktivitasFormInputDataMobilTangkiAdd : SubAktivitasFormInputDataMobilTangkiAddBase
    {
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataMobilTangkiAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataMobilTangkiAddBase : SubAktivitasFormInputDataMobilTangki
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataMobilTangkiAdd";
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiAddBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataMobilTangkiAdd";
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiAddBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private string DetermineReturnUrl()
        {
            ...
            else if (GetPageName(returnUrl) == "SubAktivitasFormInputDataMobilTangkiView")
                returnUrl = ViewUrl;
            return returnUrl;
        }
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputDataMobilTangkiAdd?.PageRender();
                    }
        }
        ...
        private void ValidateCustomJenisProduk() {
            if (JenisProduk.Visible && JenisProduk.Required) {
                if (!JenisProduk.IsDetailKey && Empty(JenisProduk.FormValue)) {
                    JenisProduk.AddErrorMessage(ConvertToString(etlDate.RequiredErrorMessage).Replace("%s", etlDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustomShipment() {
            if (Shipment.Visible && Shipment.Required) {
                if (!Shipment.IsDetailKey && Empty(Shipment.FormValue)) {
                    Shipment.AddErrorMessage(ConvertToString(etlDate.RequiredErrorMessage).Replace("%s", etlDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNomorPolisi() {
            if (NomorPolisi.Visible && NomorPolisi.Required) {
                if (!NomorPolisi.IsDetailKey && Empty(NomorPolisi.FormValue)) {
                    NomorPolisi.AddErrorMessage(ConvertToString(etlDate.RequiredErrorMessage).Replace("%s", etlDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNominasi() {
            if (Nominasi.Visible && Nominasi.Required) {
                if (!Nominasi.IsDetailKey && Empty(Nominasi.FormValue)) {
                    Nominasi.AddErrorMessage(ConvertToString(etlDate.RequiredErrorMessage).Replace("%s", etlDate.Caption));
                }
            }
        }
