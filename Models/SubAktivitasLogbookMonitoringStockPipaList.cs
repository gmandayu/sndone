...
public partial class SnDOne {
    ...
    public class SubAktivitasLogbookMonitoringStockPipaListBase : SubAktivitasLogbookMonitoringStockPipa
    {
        ...
        // Constructor
        public SubAktivitasLogbookMonitoringStockPipaListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasLogbookMonitoringStockPipaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field Nomor_Tangki
            if (filter.TryGetValue("x_Nomor_Tangki", out sv)) {
                RestoreFieldFilter(Nomor_Tangki, filter, "Nomor_Tangki", sv);
            }
            ...
            // Field Level_Tangki
            if (filter.TryGetValue("x_Level_Tangki", out sv)) {
                RestoreFieldFilter(Level_Tangki, filter, "Level_Tangki", sv);
            }

            // Field Volume_KL
            if (filter.TryGetValue("x_Volume_KL", out sv)) {
                RestoreFieldFilter(Volume_KL, filter, "Volume_KL", sv);
            }
