...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static BukuTamuDetail bukuTamuDetail
    {
        get => HttpData.Resolve<BukuTamuDetail>("BukuTamuDetail");
        set => HttpData["BukuTamuDetail"] = value;
    }

    /// <summary>
    /// Table class for BukuTamuDetail
    /// </summary>
    public class BukuTamuDetail : DbTable
    {
        ...
        public readonly DbField<SqlDbType> AreaId;
        ...
        // Constructor
        public BukuTamuDetail()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "BukuTamuDetail";
            Name = "BukuTamuDetail";
            Type = "TABLE";
            UpdateTable = "dbo.BukuTamuDetail"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new(this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("BukuTamuDetail", "Id", "CustomMsg"),
                IsUpload = false
            };
            Id.Raw = true;
            Fields.Add("Id", Id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("BukuTamuDetail", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NoReferensi", NoReferensi);

            // Area
            Area = new(this, "x_Area", 202, SqlDbType.NVarChar) {
                Name = "Area",
                Expression = "[Area]",
                UseBasicSearch = true,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("BukuTamuDetail", "Area", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Area", Area);

            // AreaId
            AreaId = new(this, "x_AreaId", 202, SqlDbType.NVarChar) {
                Name = "AreaId",
                Expression = "[AreaId]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AreaId]",
                DateTimeFormat = -1,
                VirtualExpression = "[AreaId]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("BukuTamuDetail", "AreaId", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AreaId", AreaId);
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("BukuTamuDetail", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            ...
            Foto = new(this, "x_Foto", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("BukuTamuDetail", "Foto", "CustomMsg"),
                IsUpload = false
            };
            ...
            UserInput = new(this, "x_UserInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("BukuTamuDetail", "UserInput", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.BukuTamuDetail";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.BukuTamuDetail type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Area.DbValue = row["Area"]; // Set DB value only
                AreaId.DbValue = row["AreaId"]; // Set DB value only
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "BukuTamuDetailView" => Language.Phrase("View"),
                "BukuTamuDetailEdit" => Language.Phrase("Edit"),
                "BukuTamuDetailAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "BukuTamuDetailView",
                Config.ApiAddAction => "BukuTamuDetailAdd",
                Config.ApiEditAction => "BukuTamuDetailEdit",
                Config.ApiDeleteAction => "BukuTamuDetailDelete",
                Config.ApiListAction => "BukuTamuDetailList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "BukuTamuDetailList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("BukuTamuDetailView", parm);
            else
                url = KeyUrl("BukuTamuDetailView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "BukuTamuDetailAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "BukuTamuDetailAdd?" + parm;
            else
                url = "BukuTamuDetailAdd";
        ...
        {
            string url = "";
            url = KeyUrl("BukuTamuDetailEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("BukuTamuDetailList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("BukuTamuDetailAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("BukuTamuDetailList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("BukuTamuDetailDelete", parm)); // DN
        }
        ...
        {
            string pageName = "BukuTamuDetailList";
        ...
        public async Task RenderListRow()
        {
            ...
            // AreaId
            AreaId.ViewValue = ConvertToString(AreaId.CurrentValue); // DN
            AreaId.ViewCustomAttributes = "";
            ...
            // Foto
            Foto.ViewValue = ConvertToString(Foto.CurrentValue); // DN
        ...
        public async Task RenderEditRow()
        {
            ...
            Area.EditValue = Area.CurrentValue;
            Area.PlaceHolder = RemoveHtml(Area.Caption);

            // AreaId
            AreaId.SetupEditAttributes();
            if (!AreaId.Raw)
                AreaId.CurrentValue = HtmlDecode(AreaId.CurrentValue);
            AreaId.EditValue = AreaId.CurrentValue;
            AreaId.PlaceHolder = RemoveHtml(AreaId.Caption);
            ...
            if (!Foto.Raw)
                Foto.CurrentValue = HtmlDecode(Foto.CurrentValue);
