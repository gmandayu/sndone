...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiLoadedFigurePipaEdit
    /// </summary>
    public static SubaktivitasNilaiLoadedFigurePipaEdit subaktivitasNilaiLoadedFigurePipaEdit
    {
        get => HttpData.Get<SubaktivitasNilaiLoadedFigurePipaEdit>("subaktivitasNilaiLoadedFigurePipaEdit")!;
        set => HttpData["subaktivitasNilaiLoadedFigurePipaEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasNilaiLoadedFigurePipa
    /// </summary>
    public class SubaktivitasNilaiLoadedFigurePipaEdit : SubaktivitasNilaiLoadedFigurePipaEditBase
    {
        // Constructor
        public SubaktivitasNilaiLoadedFigurePipaEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasNilaiLoadedFigurePipaEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasNilaiLoadedFigurePipaEditBase : SubaktivitasNilaiLoadedFigurePipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasNilaiLoadedFigurePipaEdit";
        ...
        // Constructor
        public SubaktivitasNilaiLoadedFigurePipaEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasNilaiLoadedFigurePipaEdit";
        ...
        // Constructor
        public SubaktivitasNilaiLoadedFigurePipaEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasNilaiLoadedFigurePipaList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasNilaiLoadedFigurePipaList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasNilaiLoadedFigurePipaList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasNilaiLoadedFigurePipaEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void ValidateCustomklobs() {
            if (klobs.Visible && klobs.Required) {
                if (!klobs.IsDetailKey && Empty(klobs.FormValue)) {
                    klobs.AddErrorMessage(ConvertToString(StatusAktivitas.RequiredErrorMessage).Replace("%s", StatusAktivitas.Caption));
                }
            }
        }
        ...
        private void ValidateCustomkl15() {
            if (kl15.Visible && kl15.Required) {
                if (!kl15.IsDetailKey && Empty(kl15.FormValue)) {
                    kl15.AddErrorMessage(ConvertToString(StatusAktivitas.RequiredErrorMessage).Replace("%s", StatusAktivitas.Caption));
                }
            }
        }
        ...
        private void ValidateCustombarrels() {
            if (barrels.Visible && barrels.Required) {
                if (!barrels.IsDetailKey && Empty(barrels.FormValue)) {
                    barrels.AddErrorMessage(ConvertToString(StatusAktivitas.RequiredErrorMessage).Replace("%s", StatusAktivitas.Caption));
                }
            }
        }
        ...
        private void ValidateCustomlt() {
            if (lt.Visible && lt.Required) {
                if (!lt.IsDetailKey && Empty(lt.FormValue)) {
                    lt.AddErrorMessage(ConvertToString(StatusAktivitas.RequiredErrorMessage).Replace("%s", StatusAktivitas.Caption));
                }
            }
        }
        ...
        private void ValidateCustommt() {
            if (mt.Visible && mt.Required) {
                if (!mt.IsDetailKey && Empty(mt.FormValue)) {
                    mt.AddErrorMessage(ConvertToString(StatusAktivitas.RequiredErrorMessage).Replace("%s", StatusAktivitas.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasNilaiLoadedFigurePipaList")), "", TableVar, true);
            string pageId = "edit";
