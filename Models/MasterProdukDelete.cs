...
public partial class SnDOne {
    ...
    /// masterProdukDelete
    /// </summary>
    public static MasterProdukDelete masterProdukDelete
    {
        get => HttpData.Get<MasterProdukDelete>("masterProdukDelete")!;
        set => HttpData["masterProdukDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterProduk
    /// </summary>
    public class MasterProdukDelete : MasterProdukDeleteBase
    {
        // Constructor
        public MasterProdukDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterProdukDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterProdukDeleteBase : MasterProduk
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterProdukDelete";
        ...
        // Page name
        public string PageName => "MasterProdukDelete";
        ...
        // Constructor
        public MasterProdukDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterProdukList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterProdukList"); // Return to list
                }
            }
