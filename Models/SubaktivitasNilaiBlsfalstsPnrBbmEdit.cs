...
public partial class SnDOne {
    ...
    public class SubaktivitasNilaiBlsfalstsPnrBbmEditBase : SubaktivitasNilaiBlsfalstsPnrBbm
    {
        ...
        // Constructor
        public SubaktivitasNilaiBlsfalstsPnrBbmEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubaktivitasNilaiBlsfalstsPnrBbmEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasNilaiBlsfalstsPnrBbmList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubaktivitasNilaiBlsfalstsPnrBbmList") {
                        ...
                        returnUrl = "SubaktivitasNilaiBlsfalstsPnrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
