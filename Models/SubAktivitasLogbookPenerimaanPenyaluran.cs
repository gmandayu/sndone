...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static SubAktivitasLogbookPenerimaanPenyaluran subAktivitasLogbookPenerimaanPenyaluran
    {
        get => HttpData.Resolve<SubAktivitasLogbookPenerimaanPenyaluran>("SubAktivitasLogbookPenerimaanPenyaluran");
        set => HttpData["SubAktivitasLogbookPenerimaanPenyaluran"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasLogbookPenerimaanPenyaluran
    /// </summary>
    public class SubAktivitasLogbookPenerimaanPenyaluran : DbTable
    {
        ...
        public readonly DbField<SqlDbType> BayNumber;

        public readonly DbField<SqlDbType> userInput;

        public readonly DbField<SqlDbType> etlDate;

        public readonly DbField<SqlDbType> NomorKompartment;

        public readonly DbField<SqlDbType> InLineBlending;

        public readonly DbField<SqlDbType> NomorTangki2;

        public readonly DbField<SqlDbType> NoMeter;

        // Constructor
        public SubAktivitasLogbookPenerimaanPenyaluran()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasLogbookPenerimaanPenyaluran";
            Name = "SubAktivitasLogbookPenerimaanPenyaluran";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasLogbookPenerimaanPenyaluran"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            // Produk
            Produk = new(this, "x_Produk", 200, SqlDbType.VarChar) {
                Name = "Produk",
                Expression = "[Produk]",
                UseBasicSearch = true,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            LO = new(this, "x_LO", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "LO", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LO", LO);
            ...
            NomorTangki = new(this, "x_NomorTangki", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "NomorTangki", "CustomMsg"),
                IsUpload = false
            };
            ...
            MeterAwal = new(this, "x_MeterAwal", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "MeterAwal", "CustomMsg"),
                IsUpload = false
            };
            ...
            MeterAkhir = new(this, "x_MeterAkhir", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "MeterAkhir", "CustomMsg"),
                IsUpload = false
            };
            ...
            Volume = new(this, "x_Volume", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "Volume", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Volume", Volume);

            // BayNumber
            BayNumber = new(this, "x_BayNumber", 202, SqlDbType.NVarChar) {
                Name = "BayNumber",
                Expression = "[BayNumber]",
                UseBasicSearch = true,
                BasicSearchExpression = "[BayNumber]",
                DateTimeFormat = -1,
                VirtualExpression = "[BayNumber]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "BayNumber", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("BayNumber", BayNumber);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            // NomorKompartment
            NomorKompartment = new(this, "x_NomorKompartment", 202, SqlDbType.NVarChar) {
                Name = "NomorKompartment",
                Expression = "[NomorKompartment]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NomorKompartment]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorKompartment]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "NomorKompartment", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NomorKompartment", NomorKompartment);

            // InLineBlending
            InLineBlending = new(this, "x_InLineBlending", 11, SqlDbType.Bit) {
                Name = "InLineBlending",
                Expression = "[InLineBlending]",
                BasicSearchExpression = "[InLineBlending]",
                DateTimeFormat = -1,
                VirtualExpression = "[InLineBlending]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "InLineBlending", "CustomMsg"),
                IsUpload = false
            };
            InLineBlending.Raw = true;
            InLineBlending.Lookup = new Lookup<DbField>(InLineBlending, "SubAktivitasLogbookPenerimaanPenyaluran", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            InLineBlending.UserValues = ["1"];
            Fields.Add("InLineBlending", InLineBlending);

            // NomorTangki2
            NomorTangki2 = new(this, "x_NomorTangki2", 202, SqlDbType.NVarChar) {
                Name = "NomorTangki2",
                Expression = "[NomorTangki2]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NomorTangki2]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorTangki2]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "NomorTangki2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NomorTangki2", NomorTangki2);
            ...
            NoMeter = new(this, "x_NoMeter", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaanPenyaluran", "NoMeter", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasLogbookPenerimaanPenyaluran";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasLogbookPenerimaanPenyaluran type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                BayNumber.DbValue = row["BayNumber"]; // Set DB value only
                userInput.DbValue = row["userInput"]; // Set DB value only
                etlDate.DbValue = row["etlDate"]; // Set DB value only
                NomorKompartment.DbValue = row["NomorKompartment"]; // Set DB value only
                InLineBlending.DbValue = (ConvertToBool(row["InLineBlending"]) ? "1" : "0"); // Set DB value only
                NomorTangki2.DbValue = row["NomorTangki2"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasLogbookPenerimaanPenyaluranList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasLogbookPenerimaanPenyaluranView" => Language.Phrase("View"),
                "SubAktivitasLogbookPenerimaanPenyaluranEdit" => Language.Phrase("Edit"),
                "SubAktivitasLogbookPenerimaanPenyaluranAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasLogbookPenerimaanPenyaluranView",
                Config.ApiAddAction => "SubAktivitasLogbookPenerimaanPenyaluranAdd",
                Config.ApiEditAction => "SubAktivitasLogbookPenerimaanPenyaluranEdit",
                Config.ApiDeleteAction => "SubAktivitasLogbookPenerimaanPenyaluranDelete",
                Config.ApiListAction => "SubAktivitasLogbookPenerimaanPenyaluranList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasLogbookPenerimaanPenyaluranList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasLogbookPenerimaanPenyaluranView", parm);
            else
                url = KeyUrl("SubAktivitasLogbookPenerimaanPenyaluranView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasLogbookPenerimaanPenyaluranAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasLogbookPenerimaanPenyaluranAdd?" + parm;
            else
                url = "SubAktivitasLogbookPenerimaanPenyaluranAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLogbookPenerimaanPenyaluranEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLogbookPenerimaanPenyaluranList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLogbookPenerimaanPenyaluranAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLogbookPenerimaanPenyaluranList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasLogbookPenerimaanPenyaluranDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasLogbookPenerimaanPenyaluranList";
        ...
        public async Task RenderListRow()
        {
            ...
            NomorKompartment.TooltipValue = "";

            // InLineBlending
            InLineBlending.HrefValue = "";
            InLineBlending.TooltipValue = "";

            // NomorTangki2
            NomorTangki2.HrefValue = "";
            NomorTangki2.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            BayNumber.EditValue = BayNumber.CurrentValue;
            ...
            NomorKompartment.EditValue = NomorKompartment.CurrentValue;
            ...
            NomorTangki2.EditValue = NomorTangki2.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(BayNumber);
                        doc.ExportCaption(userInput);
                        doc.ExportCaption(etlDate);
                        doc.ExportCaption(NomorKompartment);
                        doc.ExportCaption(InLineBlending);
                        doc.ExportCaption(NomorTangki2);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(BayNumber);
                            await doc.ExportField(userInput);
                            await doc.ExportField(etlDate);
                            await doc.ExportField(NomorKompartment);
                            await doc.ExportField(InLineBlending);
                            await doc.ExportField(NomorTangki2);
