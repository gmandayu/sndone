...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStopPenyaluranStsPyrLpgEdit
    /// </summary>
    public static SubAktivitasDataStopPenyaluranStsPyrLpgEdit subAktivitasDataStopPenyaluranStsPyrLpgEdit
    {
        get => HttpData.Get<SubAktivitasDataStopPenyaluranStsPyrLpgEdit>("subAktivitasDataStopPenyaluranStsPyrLpgEdit")!;
        set => HttpData["subAktivitasDataStopPenyaluranStsPyrLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStopPenyaluranSTSPyrLPG
    /// </summary>
    public class SubAktivitasDataStopPenyaluranStsPyrLpgEdit : SubAktivitasDataStopPenyaluranStsPyrLpgEditBase
    {
        // Constructor
        public SubAktivitasDataStopPenyaluranStsPyrLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStopPenyaluranStsPyrLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStopPenyaluranStsPyrLpgEditBase : SubAktivitasDataStopPenyaluranStsPyrLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStopPenyaluranStsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranStsPyrLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStopPenyaluranStsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranStsPyrLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataStopPenyaluranStsPyrLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataStopPenyaluranStsPyrLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataStopPenyaluranStsPyrLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStopPenyaluranStsPyrLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataStopPenyaluranStsPyrLpgList")), "", TableVar, true);
            string pageId = "edit";
