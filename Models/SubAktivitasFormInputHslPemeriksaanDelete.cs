...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputHslPemeriksaanDelete
    /// </summary>
    public static SubAktivitasFormInputHslPemeriksaanDelete subAktivitasFormInputHslPemeriksaanDelete
    {
        get => HttpData.Get<SubAktivitasFormInputHslPemeriksaanDelete>("subAktivitasFormInputHslPemeriksaanDelete")!;
        set => HttpData["subAktivitasFormInputHslPemeriksaanDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputHslPemeriksaan
    /// </summary>
    public class SubAktivitasFormInputHslPemeriksaanDelete : SubAktivitasFormInputHslPemeriksaanDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputHslPemeriksaanDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputHslPemeriksaanDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputHslPemeriksaanDeleteBase : SubAktivitasFormInputHslPemeriksaan
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputHslPemeriksaanDelete";
        ...
        // Constructor
        public SubAktivitasFormInputHslPemeriksaanDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputHslPemeriksaanDelete";
        ...
        // Constructor
        public SubAktivitasFormInputHslPemeriksaanDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputHslPemeriksaanList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputHslPemeriksaanList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputHslPemeriksaanDelete?.PageRender();
            }
            return PageResult();
        }
