...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStartPembongkaranEdit
    /// </summary>
    public static SubAktivitasFormInputDataStartPembongkaranEdit subAktivitasFormInputDataStartPembongkaranEdit
    {
        get => HttpData.Get<SubAktivitasFormInputDataStartPembongkaranEdit>("subAktivitasFormInputDataStartPembongkaranEdit")!;
        set => HttpData["subAktivitasFormInputDataStartPembongkaranEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStartPembongkaran
    /// </summary>
    public class SubAktivitasFormInputDataStartPembongkaranEdit : SubAktivitasFormInputDataStartPembongkaranEditBase
    {
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStartPembongkaranEditBase : SubAktivitasFormInputDataStartPembongkaran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStartPembongkaranEdit";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStartPembongkaranEdit";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputDataStartPembongkaranList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputDataStartPembongkaranList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputDataStartPembongkaranList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputDataStartPembongkaranEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputDataStartPembongkaranList")), "", TableVar, true);
            string pageId = "edit";
