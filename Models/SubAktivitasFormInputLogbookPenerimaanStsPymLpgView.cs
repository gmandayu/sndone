...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbookPenerimaanStsPymLpgViewBase : SubAktivitasFormInputLogbookPenerimaanStsPymLpg
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgViewBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputLogbookPenerimaanStsPymLpgList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputLogbookPenerimaanStsPymLpgList"); // Return to list page
                            }
                        }
                    break;
            }
