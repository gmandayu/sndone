...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiBLsesuaiCqlTruck
    /// </summary>
    [MaybeNull]
    public static SubAktivitasFormInputNilaiBLsesuaiCqlTruck subAktivitasFormInputNilaiBLsesuaiCqlTruck
    {
        get => HttpData.Resolve<SubAktivitasFormInputNilaiBLsesuaiCqlTruck>("SubAktivitasFormInputNilaiBLsesuaiCQLTruck");
        set => HttpData["SubAktivitasFormInputNilaiBLsesuaiCQLTruck"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasFormInputNilaiBLsesuaiCQLTruck
    /// </summary>
    public class SubAktivitasFormInputNilaiBLsesuaiCqlTruck : DbTable
    {
        ...
        public readonly DbField<SqlDbType> TotalPenyaluran;

        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruck()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasFormInputNilaiBLsesuaiCQLTruck";
            Name = "SubAktivitasFormInputNilaiBLsesuaiCQLTruck";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasFormInputNilaiBLsesuaiCQLTruck"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            KL_Obs = new(this, "x_KL_Obs", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "KL_Obs", "CustomMsg"),
                IsUpload = false
            };
            ...
            KL_15 = new(this, "x_KL_15", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "KL_15", "CustomMsg"),
                IsUpload = false
            };
            ...
            Barrels = new(this, "x_Barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "Barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            LT = new(this, "x_LT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "LT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LT", LT);
            ...
            MT = new(this, "x_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "MT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("MT", MT);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            // TotalPenyaluran
            TotalPenyaluran = new(this, "x_TotalPenyaluran", 202, SqlDbType.NVarChar) {
                Name = "TotalPenyaluran",
                Expression = "[TotalPenyaluran]",
                UseBasicSearch = true,
                BasicSearchExpression = "[TotalPenyaluran]",
                DateTimeFormat = -1,
                VirtualExpression = "[TotalPenyaluran]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLTruck", "TotalPenyaluran", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("TotalPenyaluran", TotalPenyaluran);
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasFormInputNilaiBLsesuaiCQLTruck";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasFormInputNilaiBlsesuaiCqltruck type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                TotalPenyaluran.DbValue = row["TotalPenyaluran"]; // Set DB value only
            } catch {}
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasFormInputNilaiBLsesuaiCqlTruckList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasFormInputNilaiBLsesuaiCqlTruckView" => Language.Phrase("View"),
                "SubAktivitasFormInputNilaiBLsesuaiCqlTruckEdit" => Language.Phrase("Edit"),
                "SubAktivitasFormInputNilaiBLsesuaiCqlTruckAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasFormInputNilaiBLsesuaiCqlTruckView",
                Config.ApiAddAction => "SubAktivitasFormInputNilaiBLsesuaiCqlTruckAdd",
                Config.ApiEditAction => "SubAktivitasFormInputNilaiBLsesuaiCqlTruckEdit",
                Config.ApiDeleteAction => "SubAktivitasFormInputNilaiBLsesuaiCqlTruckDelete",
                Config.ApiListAction => "SubAktivitasFormInputNilaiBLsesuaiCqlTruckList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasFormInputNilaiBLsesuaiCqlTruckList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlTruckView", parm);
            else
                url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlTruckView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasFormInputNilaiBLsesuaiCqlTruckAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasFormInputNilaiBLsesuaiCqlTruckAdd?" + parm;
            else
                url = "SubAktivitasFormInputNilaiBLsesuaiCqlTruckAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlTruckEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlTruckList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlTruckAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlTruckList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlTruckDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasFormInputNilaiBLsesuaiCqlTruckList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // TotalPenyaluran
            TotalPenyaluran.SetupEditAttributes();
            if (!TotalPenyaluran.Raw)
                TotalPenyaluran.CurrentValue = HtmlDecode(TotalPenyaluran.CurrentValue);
            TotalPenyaluran.EditValue = TotalPenyaluran.CurrentValue;
            TotalPenyaluran.PlaceHolder = RemoveHtml(TotalPenyaluran.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(TotalPenyaluran);
                    } else {
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(TotalPenyaluran);
                        } else {
