...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasRealisasiPenyaluranPerProduk
    /// </summary>
    [MaybeNull]
    public static SubAktivitasRealisasiPenyaluranPerProduk subAktivitasRealisasiPenyaluranPerProduk
    {
        get => HttpData.Resolve<SubAktivitasRealisasiPenyaluranPerProduk>("SubAktivitasRealisasiPenyaluranPerProduk");
        set => HttpData["SubAktivitasRealisasiPenyaluranPerProduk"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasRealisasiPenyaluranPerProduk
    /// </summary>
    public class SubAktivitasRealisasiPenyaluranPerProduk : DbTable
    {
        ...
        public readonly DbField<SqlDbType> Shift1;

        public readonly DbField<SqlDbType> Shift2;

        public readonly DbField<SqlDbType> Shift3;

        public readonly DbField<SqlDbType> Shift4;
        ...
        // Constructor
        public SubAktivitasRealisasiPenyaluranPerProduk()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasRealisasiPenyaluranPerProduk";
            Name = "SubAktivitasRealisasiPenyaluranPerProduk";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasRealisasiPenyaluranPerProduk"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "Produk", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Produk", Produk);

            // Shift1
            Shift1 = new(this, "x_Shift1", 202, SqlDbType.NVarChar) {
                Name = "Shift1",
                Expression = "[Shift1]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Shift1]",
                DateTimeFormat = -1,
                VirtualExpression = "[Shift1]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "Shift1", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Shift1", Shift1);

            // Shift2
            Shift2 = new(this, "x_Shift2", 202, SqlDbType.NVarChar) {
                Name = "Shift2",
                Expression = "[Shift2]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Shift2]",
                DateTimeFormat = -1,
                VirtualExpression = "[Shift2]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "Shift2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Shift2", Shift2);

            // Shift3
            Shift3 = new(this, "x_Shift3", 202, SqlDbType.NVarChar) {
                Name = "Shift3",
                Expression = "[Shift3]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Shift3]",
                DateTimeFormat = -1,
                VirtualExpression = "[Shift3]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "Shift3", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Shift3", Shift3);

            // Shift4
            Shift4 = new(this, "x_Shift4", 202, SqlDbType.NVarChar) {
                Name = "Shift4",
                Expression = "[Shift4]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Shift4]",
                DateTimeFormat = -1,
                VirtualExpression = "[Shift4]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "Shift4", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Shift4", Shift4);
            ...
            Total = new(this, "x_Total", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "Total", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRealisasiPenyaluranPerProduk", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasRealisasiPenyaluranPerProduk";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasRealisasiPenyaluranPerProduk type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Shift1.DbValue = row["Shift1"]; // Set DB value only
                Shift2.DbValue = row["Shift2"]; // Set DB value only
                Shift3.DbValue = row["Shift3"]; // Set DB value only
                Shift4.DbValue = row["Shift4"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasRealisasiPenyaluranPerProdukList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasRealisasiPenyaluranPerProdukView" => Language.Phrase("View"),
                "SubAktivitasRealisasiPenyaluranPerProdukEdit" => Language.Phrase("Edit"),
                "SubAktivitasRealisasiPenyaluranPerProdukAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasRealisasiPenyaluranPerProdukView",
                Config.ApiAddAction => "SubAktivitasRealisasiPenyaluranPerProdukAdd",
                Config.ApiEditAction => "SubAktivitasRealisasiPenyaluranPerProdukEdit",
                Config.ApiDeleteAction => "SubAktivitasRealisasiPenyaluranPerProdukDelete",
                Config.ApiListAction => "SubAktivitasRealisasiPenyaluranPerProdukList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasRealisasiPenyaluranPerProdukList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasRealisasiPenyaluranPerProdukView", parm);
            else
                url = KeyUrl("SubAktivitasRealisasiPenyaluranPerProdukView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasRealisasiPenyaluranPerProdukAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasRealisasiPenyaluranPerProdukAdd?" + parm;
            else
                url = "SubAktivitasRealisasiPenyaluranPerProdukAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasRealisasiPenyaluranPerProdukEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasRealisasiPenyaluranPerProdukList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasRealisasiPenyaluranPerProdukAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasRealisasiPenyaluranPerProdukList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasRealisasiPenyaluranPerProdukDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasRealisasiPenyaluranPerProdukList";
        ...
        public async Task RenderEditRow()
        {
            ...
            Shift1.EditValue = Shift1.CurrentValue;
            ...
            Shift2.EditValue = Shift2.CurrentValue;
            ...
            Shift3.EditValue = Shift3.CurrentValue;
            ...
            Shift4.EditValue = Shift4.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(Shift1);
                        doc.ExportCaption(Shift2);
                        doc.ExportCaption(Shift3);
                        doc.ExportCaption(Shift4);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(Shift1);
                            await doc.ExportField(Shift2);
                            await doc.ExportField(Shift3);
                            await doc.ExportField(Shift4);
