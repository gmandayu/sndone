...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasSfadNewBlstslpgEdit
    /// </summary>
    public static SubAktivitasSfadNewBlstslpgEdit subAktivitasSfadNewBlstslpgEdit
    {
        get => HttpData.Get<SubAktivitasSfadNewBlstslpgEdit>("subAktivitasSfadNewBlstslpgEdit")!;
        set => HttpData["subAktivitasSfadNewBlstslpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasSFADNewBLSTSLPG
    /// </summary>
    public class SubAktivitasSfadNewBlstslpgEdit : SubAktivitasSfadNewBlstslpgEditBase
    {
        // Constructor
        public SubAktivitasSfadNewBlstslpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasSfadNewBlstslpgEdit() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasSfadNewBlstslpgEditBase : SubAktivitasSfadNewBlstslpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasSfadNewBlstslpgEdit";
        ...
        // Constructor
        public SubAktivitasSfadNewBlstslpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasSfadNewBlstslpgEdit";
        ...
        // Constructor
        public SubAktivitasSfadNewBlstslpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasSfadNewBlstslpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasSfadNewBlstslpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasSfadNewBlstslpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasSfadNewBlstslpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasSfadNewBlstslpgList")), "", TableVar, true);
            string pageId = "edit";
