...
public partial class SnDOne {
    ...
    public class MasterTangkiAddBase : MasterTangki
    {
        ...
        // Constructor
        public MasterTangkiAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MasterTangkiList"); // No matching record, return to List page // DN
                    }
                    break;
