...
public partial class SnDOne {
    ...
    public class SubAktivitasInputDataPenyaluranKonsinyasiPipaEditBase : SubAktivitasInputDataPenyaluranKonsinyasiPipa
    {
        ...
        // Constructor
        public SubAktivitasInputDataPenyaluranKonsinyasiPipaEditBase()
        {
        ...
        // Constructor
        public SubAktivitasInputDataPenyaluranKonsinyasiPipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasInputDataPenyaluranKonsinyasiPipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasInputDataPenyaluranKonsinyasiPipaList") {
                                ...
                                returnUrl = "SubAktivitasInputDataPenyaluranKonsinyasiPipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'NoUrut' before field var 'x_NoUrut'
            val = CurrentForm.HasValue("NoUrut") ? CurrentForm.GetValue("NoUrut") : CurrentForm.GetValue("x_NoUrut");
            if (!NoUrut.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("NoUrut") && !CurrentForm.HasValue("x_NoUrut")) // DN
                    NoUrut.Visible = false; // Disable update for API request
                else
                    NoUrut.SetFormValue(val);
            }
