...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiSfbdstslpgEdit
    /// </summary>
    public static SubAktivitasNilaiSfbdstslpgEdit subAktivitasNilaiSfbdstslpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiSfbdstslpgEdit>("subAktivitasNilaiSfbdstslpgEdit")!;
        set => HttpData["subAktivitasNilaiSfbdstslpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiSFBDSTSLPG
    /// </summary>
    public class SubAktivitasNilaiSfbdstslpgEdit : SubAktivitasNilaiSfbdstslpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiSfbdstslpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiSfbdstslpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiSfbdstslpgEditBase : SubAktivitasNilaiSfbdstslpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiSfbdstslpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiSfbdstslpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiSfbdstslpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiSfbdstslpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiSfbdstslpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiSfbdstslpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiSfbdstslpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiSfbdstslpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiSfbdstslpgList")), "", TableVar, true);
            string pageId = "edit";
