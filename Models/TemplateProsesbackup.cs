...
public partial class SnDOne {
    /// <summary>
    /// templateProsesbackup
    /// </summary>
    [MaybeNull]
    public static TemplateProsesbackup templateProsesbackup
    {
        get => HttpData.Resolve<TemplateProsesbackup>("TemplateProsesbackup");
        set => HttpData["TemplateProsesbackup"] = value;
    }

    /// <summary>
    /// Table class for TemplateProsesbackup
    /// </summary>
    public class TemplateProsesbackup : DbTable
    {
        ...
        // Constructor
        public TemplateProsesbackup()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "TemplateProsesbackup";
            Name = "TemplateProsesbackup";
            Type = "TABLE";
            UpdateTable = "dbo.TemplateProsesbackup"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdTemplateProses = new(this, "x_IdTemplateProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateProsesbackup", "IdTemplateProses", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdTemplate = new(this, "x_IdTemplate", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("TemplateProsesbackup", "IdTemplate", "CustomMsg"),
                IsUpload = false
            };
            IdTemplate.Raw = true;
            ...
            UrutanProses = new(this, "x_UrutanProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("TemplateProsesbackup", "UrutanProses", "CustomMsg"),
                IsUpload = false
            };
            ...
            NamaProses = new(this, "x_NamaProses", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateProsesbackup", "NamaProses", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdPIC = new(this, "x_IdPIC", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("TemplateProsesbackup", "IdPIC", "CustomMsg"),
                IsUpload = false
            };
            IdPIC.Raw = true;
            ...
            IdTools = new(this, "x_IdTools", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("TemplateProsesbackup", "IdTools", "CustomMsg"),
                IsUpload = false
            };
            IdTools.Raw = true;
            ...
            Keterangan = new(this, "x_Keterangan", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateProsesbackup", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateProsesbackup", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateProsesbackup", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateProsesbackup", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateProsesbackup", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.TemplateProsesbackup";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.TemplateProsesbackup type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "TemplateProsesbackupList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "TemplateProsesbackupView" => Language.Phrase("View"),
                "TemplateProsesbackupEdit" => Language.Phrase("Edit"),
                "TemplateProsesbackupAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TemplateProsesbackupView",
                Config.ApiAddAction => "TemplateProsesbackupAdd",
                Config.ApiEditAction => "TemplateProsesbackupEdit",
                Config.ApiDeleteAction => "TemplateProsesbackupDelete",
                Config.ApiListAction => "TemplateProsesbackupList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TemplateProsesbackupList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TemplateProsesbackupView", parm);
            else
                url = KeyUrl("TemplateProsesbackupView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TemplateProsesbackupAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "TemplateProsesbackupAdd?" + parm;
            else
                url = "TemplateProsesbackupAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TemplateProsesbackupEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TemplateProsesbackupList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TemplateProsesbackupAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TemplateProsesbackupList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("TemplateProsesbackupDelete", parm)); // DN
        }
        ...
        {
            string pageName = "TemplateProsesbackupList";
        ...
        public async Task RenderListRow()
        {
            ...
            IdTools.ViewValue = FormatNumber(IdTools.ViewValue, IdTools.FormatPattern);
        ...
        public async Task RenderEditRow()
        {
            ...
            IdTools.EditValue = IdTools.CurrentValue;
