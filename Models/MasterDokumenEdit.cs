...
public partial class SnDOne {
    ...
    public class MasterDokumenEditBase : MasterDokumen
    {
        ...
        // Constructor
        public MasterDokumenEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("IdDokumen", out rv)) { // DN
                    IdDokumen.FormValue = UrlDecode(rv); // DN
                ...
                if (!Empty(Post("action"))) {
                    ...
                    if (RouteValues.TryGetValue("IdDokumen", out rv)) { // DN
                        IdDokumen.QueryValue = UrlDecode(rv); // DN
                        loadByQuery = true;
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MasterDokumenList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MasterDokumenList") {
                                ...
                                returnUrl = "MasterDokumenList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
