...
public partial class SnDOne {
    ...
    public class SubAktivitasLogbookPenerimaanPenyaluranLpgEditBase : SubAktivitasLogbookPenerimaanPenyaluranLpg
    {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanPenyaluranLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanPenyaluranLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasLogbookPenerimaanPenyaluranLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasLogbookPenerimaanPenyaluranLpgList") {
                                ...
                                returnUrl = "SubAktivitasLogbookPenerimaanPenyaluranLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
