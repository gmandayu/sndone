...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiAgreementPenyaluranEditBase : SubAktivitasNilaiAgreementPenyaluran
    {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranEditBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiAgreementPenyaluranList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiAgreementPenyaluranList") {
                                ...
                                returnUrl = "SubAktivitasNilaiAgreementPenyaluranList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
