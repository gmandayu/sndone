...
public partial class SnDOne {
    /// <summary>
    /// controlRutinSecurityDelete
    /// </summary>
    public static ControlRutinSecurityDelete controlRutinSecurityDelete
    {
        get => HttpData.Get<ControlRutinSecurityDelete>("controlRutinSecurityDelete")!;
        set => HttpData["controlRutinSecurityDelete"] = value;
    }

    /// <summary>
    /// Page class for ControlRutinSecurity
    /// </summary>
    public class ControlRutinSecurityDelete : ControlRutinSecurityDeleteBase
    {
        // Constructor
        public ControlRutinSecurityDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ControlRutinSecurityDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ControlRutinSecurityDeleteBase : ControlRutinSecurity
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "controlRutinSecurityDelete";
        ...
        // Constructor
        public ControlRutinSecurityDeleteBase()
        {
        ...
        // Page name
        public string PageName => "ControlRutinSecurityDelete";
        ...
        // Constructor
        public ControlRutinSecurityDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("ControlRutinSecurityList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("ControlRutinSecurityList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                controlRutinSecurityDelete?.PageRender();
            }
            return PageResult();
        }
