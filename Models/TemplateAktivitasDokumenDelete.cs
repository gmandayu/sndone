...
public partial class SnDOne {
    /// <summary>
    /// templateAktivitasDokumenDelete
    /// </summary>
    public static TemplateAktivitasDokumenDelete templateAktivitasDokumenDelete
    {
        get => HttpData.Get<TemplateAktivitasDokumenDelete>("templateAktivitasDokumenDelete")!;
        set => HttpData["templateAktivitasDokumenDelete"] = value;
    }

    /// <summary>
    /// Page class for TemplateAktivitasDokumen
    /// </summary>
    public class TemplateAktivitasDokumenDelete : TemplateAktivitasDokumenDeleteBase
    {
        // Constructor
        public TemplateAktivitasDokumenDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TemplateAktivitasDokumenDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TemplateAktivitasDokumenDeleteBase : TemplateAktivitasDokumen
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "templateAktivitasDokumenDelete";
        ...
        // Constructor
        public TemplateAktivitasDokumenDeleteBase()
        {
        ...
        // Page name
        public string PageName => "TemplateAktivitasDokumenDelete";
        ...
        // Constructor
        public TemplateAktivitasDokumenDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("TemplateAktivitasDokumenList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("TemplateAktivitasDokumenList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                templateAktivitasDokumenDelete?.PageRender();
            }
            return PageResult();
        }
