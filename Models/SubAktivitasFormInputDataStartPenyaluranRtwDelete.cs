...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStartPenyaluranRtwDelete
    /// </summary>
    public static SubAktivitasFormInputDataStartPenyaluranRtwDelete subAktivitasFormInputDataStartPenyaluranRtwDelete
    {
        get => HttpData.Get<SubAktivitasFormInputDataStartPenyaluranRtwDelete>("subAktivitasFormInputDataStartPenyaluranRtwDelete")!;
        set => HttpData["subAktivitasFormInputDataStartPenyaluranRtwDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStartPenyaluranRTW
    /// </summary>
    public class SubAktivitasFormInputDataStartPenyaluranRtwDelete : SubAktivitasFormInputDataStartPenyaluranRtwDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputDataStartPenyaluranRtwDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStartPenyaluranRtwDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStartPenyaluranRtwDeleteBase : SubAktivitasFormInputDataStartPenyaluranRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStartPenyaluranRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPenyaluranRtwDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStartPenyaluranRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPenyaluranRtwDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputDataStartPenyaluranRtwList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputDataStartPenyaluranRtwList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputDataStartPenyaluranRtwDelete?.PageRender();
            }
            return PageResult();
        }
