...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputLogbookPenerimaanPipa
    /// </summary>
    [MaybeNull]
    public static SubAktivitasInputLogbookPenerimaanPipa subAktivitasInputLogbookPenerimaanPipa
    {
        get => HttpData.Resolve<SubAktivitasInputLogbookPenerimaanPipa>("SubAktivitasInputLogbookPenerimaanPipa");
        set => HttpData["SubAktivitasInputLogbookPenerimaanPipa"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasInputLogbookPenerimaanPipa
    /// </summary>
    public class SubAktivitasInputLogbookPenerimaanPipa : DbTable
    {
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasInputLogbookPenerimaanPipa";
            Name = "SubAktivitasInputLogbookPenerimaanPipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasInputLogbookPenerimaanPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NamaBatch = new(this, "x_NamaBatch", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "NamaBatch", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalJam = new(this, "x_TanggalJam", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "TanggalJam", "CustomMsg"),
                IsUpload = false
            };
            TanggalJam.Raw = true;
            ...
            NamaKegiatan = new(this, "x_NamaKegiatan", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "NamaKegiatan", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            Density = new(this, "x_Density", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "Density", "CustomMsg"),
                IsUpload = false
            };
            ...
            Temperature = new(this, "x_Temperature", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "Temperature", "CustomMsg"),
                IsUpload = false
            };
            ...
            Keterangan = new(this, "x_Keterangan", 203, SqlDbType.NText) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            SubAktivitasHasilPemeriksaanId = new(this, "x_SubAktivitasHasilPemeriksaanId", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPipa", "SubAktivitasHasilPemeriksaanId", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasInputLogbookPenerimaanPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasInputLogbookPenerimaanPipa type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasInputLogbookPenerimaanPipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasInputLogbookPenerimaanPipaView" => Language.Phrase("View"),
                "SubAktivitasInputLogbookPenerimaanPipaEdit" => Language.Phrase("Edit"),
                "SubAktivitasInputLogbookPenerimaanPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasInputLogbookPenerimaanPipaView",
                Config.ApiAddAction => "SubAktivitasInputLogbookPenerimaanPipaAdd",
                Config.ApiEditAction => "SubAktivitasInputLogbookPenerimaanPipaEdit",
                Config.ApiDeleteAction => "SubAktivitasInputLogbookPenerimaanPipaDelete",
                Config.ApiListAction => "SubAktivitasInputLogbookPenerimaanPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasInputLogbookPenerimaanPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasInputLogbookPenerimaanPipaView", parm);
            else
                url = KeyUrl("SubAktivitasInputLogbookPenerimaanPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasInputLogbookPenerimaanPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasInputLogbookPenerimaanPipaAdd?" + parm;
            else
                url = "SubAktivitasInputLogbookPenerimaanPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasInputLogbookPenerimaanPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasInputLogbookPenerimaanPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasInputLogbookPenerimaanPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasInputLogbookPenerimaanPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasInputLogbookPenerimaanPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasInputLogbookPenerimaanPipaList";
