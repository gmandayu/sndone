...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStartPembongkaranRtwEdit
    /// </summary>
    public static SubAktivitasDataStartPembongkaranRtwEdit subAktivitasDataStartPembongkaranRtwEdit
    {
        get => HttpData.Get<SubAktivitasDataStartPembongkaranRtwEdit>("subAktivitasDataStartPembongkaranRtwEdit")!;
        set => HttpData["subAktivitasDataStartPembongkaranRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStartPembongkaranRTW
    /// </summary>
    public class SubAktivitasDataStartPembongkaranRtwEdit : SubAktivitasDataStartPembongkaranRtwEditBase
    {
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStartPembongkaranRtwEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStartPembongkaranRtwEditBase : SubAktivitasDataStartPembongkaranRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStartPembongkaranRtwEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStartPembongkaranRtwEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataStartPembongkaranRtwList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataStartPembongkaranRtwList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataStartPembongkaranRtwList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStartPembongkaranRtwEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataStartPembongkaranRtwList")), "", TableVar, true);
            string pageId = "edit";
