...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataGerbongKetelRtwEdit
    /// </summary>
    public static SubAktivitasFormInputDataGerbongKetelRtwEdit subAktivitasFormInputDataGerbongKetelRtwEdit
    {
        get => HttpData.Get<SubAktivitasFormInputDataGerbongKetelRtwEdit>("subAktivitasFormInputDataGerbongKetelRtwEdit")!;
        set => HttpData["subAktivitasFormInputDataGerbongKetelRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataGerbongKetelRTW
    /// </summary>
    public class SubAktivitasFormInputDataGerbongKetelRtwEdit : SubAktivitasFormInputDataGerbongKetelRtwEditBase
    {
        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwEdit() : base()
        {
        }
        ...
        public override void PageLoad() {
            //Log("Page Load");
            Jns_Produk.DisplayValueSeparator = " - ";
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataGerbongKetelRtwEditBase : SubAktivitasFormInputDataGerbongKetelRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataGerbongKetelRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataGerbongKetelRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputDataGerbongKetelRtwList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputDataGerbongKetelRtwList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputDataGerbongKetelRtwList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputDataGerbongKetelRtwEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'Jns_Produk'
            Jns_Produk.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(Jns_Produk, "Jns_Produk", "x_Jns_Produk");
        ...
        public void RestoreFormValues()
        {
            ...
            Jns_Produk.CurrentValue = Jns_Produk.FormValue;
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // DetailQuantity
                    ...
                    // awallookupbung
                    // Jns_Produk (jaga leading zero)
                    ResolveLookupView(Jns_Produk, "NoProduk", "string");
                    // akhirlookupbung
        ...
        private void ValidateCustomJns_Produk() {
            if (Jns_Produk.Visible && Jns_Produk.Required) {
                if (!Jns_Produk.IsDetailKey && Empty(Jns_Produk.FormValue)) {
                    Jns_Produk.AddErrorMessage(ConvertToString(DetailQuantity.RequiredErrorMessage).Replace("%s", DetailQuantity.Caption));
                }
            }
        }
        ...
        private void ValidateCustomTanggal() {
            if (Tanggal.Visible && Tanggal.Required) {
                if (!Tanggal.IsDetailKey && Empty(Tanggal.FormValue)) {
                    Tanggal.AddErrorMessage(ConvertToString(DetailQuantity.RequiredErrorMessage).Replace("%s", DetailQuantity.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputDataGerbongKetelRtwList")), "", TableVar, true);
            string pageId = "edit";
