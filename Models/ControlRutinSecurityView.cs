...
public partial class SnDOne {
    /// <summary>
    /// controlRutinSecurityView
    /// </summary>
    public static ControlRutinSecurityView controlRutinSecurityView
    {
        get => HttpData.Get<ControlRutinSecurityView>("controlRutinSecurityView")!;
        set => HttpData["controlRutinSecurityView"] = value;
    }

    /// <summary>
    /// Page class for ControlRutinSecurity
    /// </summary>
    public class ControlRutinSecurityView : ControlRutinSecurityViewBase
    {
        // Constructor
        public ControlRutinSecurityView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ControlRutinSecurityView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ControlRutinSecurityViewBase : ControlRutinSecurity
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "controlRutinSecurityView";
        ...
        // Constructor
        public ControlRutinSecurityViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdCRS"] = keys[0];
            } else {
                RecordKeys["IdCRS"] = RouteValues.TryGetValue("IdCRS", out obj) && obj != null ? UrlDecode(obj) : Get("IdCRS"); // DN
            }
        ...
        // Page name
        public string PageName => "ControlRutinSecurityView";
        ...
        // Constructor
        public ControlRutinSecurityViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdCRS", out v) && !Empty(v)) { // DN
                IdCRS.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdCRS"] = IdCRS.QueryValue;
            } else if (Get("IdCRS", out sv)) {
                IdCRS.QueryValue = sv.ToString();
                RecordKeys["IdCRS"] = IdCRS.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdCRS.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdCRS"] = IdCRS.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "ControlRutinSecurityList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("ControlRutinSecurityList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                controlRutinSecurityView?.PageRender();
            }
            return PageResult();
        }
