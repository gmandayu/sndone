...
public partial class SnDOne {
    ...
    public class SubaktivitasNilaiSfbdEditBase : SubaktivitasNilaiSfbd
    {
        ...
        // Constructor
        public SubaktivitasNilaiSfbdEditBase()
        {
        ...
        // Constructor
        public SubaktivitasNilaiSfbdEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasNilaiSfbdList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasNilaiSfbdList") {
                                ...
                                returnUrl = "SubaktivitasNilaiSfbdList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
