...
public partial class SnDOne {
    /// <summary>
    /// vAktifitasWithDokumenList
    /// </summary>
    public static VAktifitasWithDokumenList vAktifitasWithDokumenList
    {
        get => HttpData.Get<VAktifitasWithDokumenList>("vAktifitasWithDokumenList")!;
        set => HttpData["vAktifitasWithDokumenList"] = value;
    }

    /// <summary>
    /// Page class for v_aktifitas_with_dokumen
    /// </summary>
    public class VAktifitasWithDokumenList : VAktifitasWithDokumenListBase
    {
        // Constructor
        public VAktifitasWithDokumenList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public VAktifitasWithDokumenList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class VAktifitasWithDokumenListBase : VAktifitasWithDokumen
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "vAktifitasWithDokumenList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fv_aktifitas_with_dokumenlist";
        ...
        // Constructor
        public VAktifitasWithDokumenListBase()
        {
            TableName = "v_aktifitas_with_dokumen";

            // CSS class name as context
            TableVar = "v_aktifitas_with_dokumen";
            ...
            // Table object (vAktifitasWithDokumen)
            if (vAktifitasWithDokumen == null || vAktifitasWithDokumen is VAktifitasWithDokumen)
                vAktifitasWithDokumen = this;

            // Initialize URLs
            AddUrl = "VAktifitasWithDokumenAdd";
            ...
            MultiDeleteUrl = "VAktifitasWithDokumenDelete";
            MultiUpdateUrl = "VAktifitasWithDokumenUpdate";
        ...
        // Page name
        public string PageName => "VAktifitasWithDokumenList";
        ...
        // Constructor
        public VAktifitasWithDokumenListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "VAktifitasWithDokumenView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fv_aktifitas_with_dokumengrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                vAktifitasWithDokumenList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(PathFile, ctrl); // PathFile
                UpdateSort(TanggalUploadDok, ctrl); // TanggalUploadDok
                UpdateSort(UserUploadDok, ctrl); // UserUploadDok
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""v_aktifitas_with_dokumen"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fv_aktifitas_with_dokumenlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fv_aktifitas_with_dokumenlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("PathFile")); // DN
                CreateColumnOption(option.Add("TanggalUploadDok")); // DN
                CreateColumnOption(option.Add("UserUploadDok")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fv_aktifitas_with_dokumensrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fv_aktifitas_with_dokumensrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fv_aktifitas_with_dokumenlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_v_aktifitas_with_dokumen");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(vAktifitasWithDokumenList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(vAktifitasWithDokumenList.RowCount) + "_v_aktifitas_with_dokumen");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(vAktifitasWithDokumenList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && vAktifitasWithDokumenList.RowType == RowType.Add || IsEdit && vAktifitasWithDokumenList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fv_aktifitas_with_dokumenlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fv_aktifitas_with_dokumenlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fv_aktifitas_with_dokumenlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fv_aktifitas_with_dokumensrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
