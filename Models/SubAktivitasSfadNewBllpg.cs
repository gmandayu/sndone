...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasSfadNewBllpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasSfadNewBllpg subAktivitasSfadNewBllpg
    {
        get => HttpData.Resolve<SubAktivitasSfadNewBllpg>("SubAktivitasSFADNewBLLPG");
        set => HttpData["SubAktivitasSFADNewBLLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasSFADNewBLLPG
    /// </summary>
    public class SubAktivitasSfadNewBllpg : DbTable
    {
        ...
        // Constructor
        public SubAktivitasSfadNewBllpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasSFADNewBLLPG";
            Name = "SubAktivitasSFADNewBLLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasSFADNewBLLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            ApakahAdaROB = new(this, "x_ApakahAdaROB", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "ApakahAdaROB", "CustomMsg"),
                IsUpload = false
            };
            ...
            Import = new(this, "x_Import", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "Import", "CustomMsg"),
                IsUpload = false
            };
            Import.Raw = true;
            Import.Lookup = new Lookup<DbField>(Import, "SubAktivitasSFADNewBLLPG", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Import.UserValues = ["1"];
            ...
            ApakahTerdapatROB = new(this, "x_ApakahTerdapatROB", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "ApakahTerdapatROB", "CustomMsg"),
                IsUpload = false
            };
            ApakahTerdapatROB.Raw = true;
            ApakahTerdapatROB.Lookup = new Lookup<DbField>(ApakahTerdapatROB, "SubAktivitasSFADNewBLLPG", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Tujuan = new(this, "x_Tujuan", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "Tujuan", "CustomMsg"),
                IsUpload = false
            };
            Tujuan.Raw = true;
            ...
            SFAD_mt = new(this, "x_SFAD_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "SFAD_mt", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBl_mt = new(this, "x_NewBl_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "NewBl_mt", "CustomMsg"),
                IsUpload = false
            };
            ...
            AR45B_mt = new(this, "x_AR45B_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "AR45B_mt", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasSFADNewBLLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasSfadnewBllpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasSfadNewBllpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasSfadNewBllpgView" => Language.Phrase("View"),
                "SubAktivitasSfadNewBllpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasSfadNewBllpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasSfadNewBllpgView",
                Config.ApiAddAction => "SubAktivitasSfadNewBllpgAdd",
                Config.ApiEditAction => "SubAktivitasSfadNewBllpgEdit",
                Config.ApiDeleteAction => "SubAktivitasSfadNewBllpgDelete",
                Config.ApiListAction => "SubAktivitasSfadNewBllpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasSfadNewBllpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasSfadNewBllpgView", parm);
            else
                url = KeyUrl("SubAktivitasSfadNewBllpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasSfadNewBllpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasSfadNewBllpgAdd?" + parm;
            else
                url = "SubAktivitasSfadNewBllpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasSfadNewBllpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasSfadNewBllpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasSfadNewBllpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasSfadNewBllpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasSfadNewBllpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasSfadNewBllpgList";
        ...
        public async Task RenderListRow()
        {
            ...
            Tujuan.ViewValue = Empty(curVal7) ? DbNullValue : FormatNumber(Tujuan.CurrentValue, Tujuan.FormatPattern);
            if (!Empty(curVal7)) {
