...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiARsesuaiCqdTruckEdit
    /// </summary>
    public static SubAktivitasFormInputNilaiARsesuaiCqdTruckEdit subAktivitasFormInputNilaiARsesuaiCqdTruckEdit
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiARsesuaiCqdTruckEdit>("subAktivitasFormInputNilaiARsesuaiCqdTruckEdit")!;
        set => HttpData["subAktivitasFormInputNilaiARsesuaiCqdTruckEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiARsesuaiCQDTruck
    /// </summary>
    public class SubAktivitasFormInputNilaiARsesuaiCqdTruckEdit : SubAktivitasFormInputNilaiARsesuaiCqdTruckEditBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiARsesuaiCqdTruckEditBase : SubAktivitasFormInputNilaiARsesuaiCqdTruck
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiARsesuaiCqdTruckEdit";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiARsesuaiCqdTruckEdit";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputNilaiARsesuaiCqdTruckEdit?.PageRender();
                    }
        }
