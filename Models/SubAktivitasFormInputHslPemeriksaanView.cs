...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputHslPemeriksaanView
    /// </summary>
    public static SubAktivitasFormInputHslPemeriksaanView subAktivitasFormInputHslPemeriksaanView
    {
        get => HttpData.Get<SubAktivitasFormInputHslPemeriksaanView>("subAktivitasFormInputHslPemeriksaanView")!;
        set => HttpData["subAktivitasFormInputHslPemeriksaanView"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputHslPemeriksaan
    /// </summary>
    public class SubAktivitasFormInputHslPemeriksaanView : SubAktivitasFormInputHslPemeriksaanViewBase
    {
        // Constructor
        public SubAktivitasFormInputHslPemeriksaanView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputHslPemeriksaanView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputHslPemeriksaanViewBase : SubAktivitasFormInputHslPemeriksaan
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputHslPemeriksaanView";
        ...
        // Constructor
        public SubAktivitasFormInputHslPemeriksaanViewBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputHslPemeriksaanView";
        ...
        // Constructor
        public SubAktivitasFormInputHslPemeriksaanViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputHslPemeriksaanList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputHslPemeriksaanList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputHslPemeriksaanView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasFormInputHslPemeriksaanview\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasFormInputHslPemeriksaanview\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasFormInputHslPemeriksaanview\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
