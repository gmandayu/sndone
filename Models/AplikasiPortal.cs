...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static AplikasiPortal aplikasiPortal
    {
        get => HttpData.Resolve<AplikasiPortal>("AplikasiPortal");
        set => HttpData["AplikasiPortal"] = value;
    }

    /// <summary>
    /// Table class for AplikasiPortal
    /// </summary>
    public class AplikasiPortal : DbTable
    {
        ...
        public readonly DbField<SqlDbType> NamaAplikasi;

        public readonly DbField<SqlDbType> LinkUrl;

        public readonly DbField<SqlDbType> DeskripsiAplikasi;

        public readonly DbField<SqlDbType> Ikon;

        // Constructor
        public AplikasiPortal()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "AplikasiPortal";
            Name = "AplikasiPortal";
            Type = "TABLE";
            UpdateTable = "dbo.AplikasiPortal"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new(this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("AplikasiPortal", "Id", "CustomMsg"),
                IsUpload = false
            };
            Id.Raw = true;
            Fields.Add("Id", Id);
            ...
            // NamaAplikasi
            NamaAplikasi = new(this, "x_NamaAplikasi", 202, SqlDbType.NVarChar) {
                Name = "NamaAplikasi",
                Expression = "[NamaAplikasi]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NamaAplikasi]",
                DateTimeFormat = -1,
                VirtualExpression = "[NamaAplikasi]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("AplikasiPortal", "NamaAplikasi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NamaAplikasi", NamaAplikasi);

            // LinkUrl
            LinkUrl = new(this, "x_LinkUrl", 203, SqlDbType.NText) {
                Name = "LinkUrl",
                Expression = "[LinkUrl]",
                BasicSearchExpression = "[LinkUrl]",
                DateTimeFormat = -1,
                VirtualExpression = "[LinkUrl]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("AplikasiPortal", "LinkUrl", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LinkUrl", LinkUrl);

            // DeskripsiAplikasi
            DeskripsiAplikasi = new(this, "x_DeskripsiAplikasi", 203, SqlDbType.NText) {
                Name = "DeskripsiAplikasi",
                Expression = "[DeskripsiAplikasi]",
                BasicSearchExpression = "[DeskripsiAplikasi]",
                DateTimeFormat = -1,
                VirtualExpression = "[DeskripsiAplikasi]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("AplikasiPortal", "DeskripsiAplikasi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("DeskripsiAplikasi", DeskripsiAplikasi);

            // Ikon
            Ikon = new(this, "x_Ikon", 202, SqlDbType.NVarChar) {
                Name = "Ikon",
                Expression = "[Ikon]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Ikon]",
                DateTimeFormat = -1,
                VirtualExpression = "[Ikon]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("AplikasiPortal", "Ikon", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Ikon", Ikon);
        ...
        {
            get => _sqlFrom ?? "dbo.AplikasiPortal";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.AplikasiPortal type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                NamaAplikasi.DbValue = row["NamaAplikasi"]; // Set DB value only
                LinkUrl.DbValue = row["LinkUrl"]; // Set DB value only
                DeskripsiAplikasi.DbValue = row["DeskripsiAplikasi"]; // Set DB value only
                Ikon.DbValue = row["Ikon"]; // Set DB value only
            } catch {}
        }
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "AplikasiPortalView" => Language.Phrase("View"),
                "AplikasiPortalEdit" => Language.Phrase("Edit"),
                "AplikasiPortalAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "AplikasiPortalView",
                Config.ApiAddAction => "AplikasiPortalAdd",
                Config.ApiEditAction => "AplikasiPortalEdit",
                Config.ApiDeleteAction => "AplikasiPortalDelete",
                Config.ApiListAction => "AplikasiPortalList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "AplikasiPortalList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("AplikasiPortalView", parm);
            else
                url = KeyUrl("AplikasiPortalView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "AplikasiPortalAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "AplikasiPortalAdd?" + parm;
            else
                url = "AplikasiPortalAdd";
        ...
        {
            string url = "";
            url = KeyUrl("AplikasiPortalEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("AplikasiPortalList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("AplikasiPortalAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("AplikasiPortalList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("AplikasiPortalDelete", parm)); // DN
        }
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            ...
            NamaAplikasi.SetDbValue(row["NamaAplikasi"]);
            LinkUrl.SetDbValue(row["LinkUrl"]);
            DeskripsiAplikasi.SetDbValue(row["DeskripsiAplikasi"]);
            Ikon.SetDbValue(row["Ikon"]);
        }
        ...
        {
            string pageName = "AplikasiPortalList";
        ...
        public async Task RenderListRow()
        {
            ...
            // NamaAplikasi
            NamaAplikasi.ViewValue = ConvertToString(NamaAplikasi.CurrentValue); // DN
            NamaAplikasi.ViewCustomAttributes = "";

            // LinkUrl
            LinkUrl.ViewValue = LinkUrl.CurrentValue;
            LinkUrl.ViewCustomAttributes = "";

            // DeskripsiAplikasi
            DeskripsiAplikasi.ViewValue = DeskripsiAplikasi.CurrentValue;
            DeskripsiAplikasi.ViewCustomAttributes = "";

            // Ikon
            Ikon.ViewValue = ConvertToString(Ikon.CurrentValue); // DN
            Ikon.ViewCustomAttributes = "";
            ...
            // NamaAplikasi
            NamaAplikasi.HrefValue = "";
            NamaAplikasi.TooltipValue = "";

            // LinkUrl
            LinkUrl.HrefValue = "";
            LinkUrl.TooltipValue = "";

            // DeskripsiAplikasi
            DeskripsiAplikasi.HrefValue = "";
            DeskripsiAplikasi.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // NamaAplikasi
            NamaAplikasi.SetupEditAttributes();
            if (!NamaAplikasi.Raw)
                NamaAplikasi.CurrentValue = HtmlDecode(NamaAplikasi.CurrentValue);
            NamaAplikasi.EditValue = NamaAplikasi.CurrentValue;
            NamaAplikasi.PlaceHolder = RemoveHtml(NamaAplikasi.Caption);

            // LinkUrl
            LinkUrl.SetupEditAttributes();
            LinkUrl.EditValue = LinkUrl.CurrentValue; // DN
            LinkUrl.PlaceHolder = RemoveHtml(LinkUrl.Caption);

            // DeskripsiAplikasi
            DeskripsiAplikasi.SetupEditAttributes();
            DeskripsiAplikasi.EditValue = DeskripsiAplikasi.CurrentValue; // DN
            DeskripsiAplikasi.PlaceHolder = RemoveHtml(DeskripsiAplikasi.Caption);

            // Ikon
            Ikon.SetupEditAttributes();
            if (!Ikon.Raw)
                Ikon.CurrentValue = HtmlDecode(Ikon.CurrentValue);
            Ikon.EditValue = Ikon.CurrentValue;
            Ikon.PlaceHolder = RemoveHtml(Ikon.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(NamaAplikasi);
                        doc.ExportCaption(LinkUrl);
                        doc.ExportCaption(DeskripsiAplikasi);
                        doc.ExportCaption(Ikon);
                    } else {
                        doc.ExportCaption(Id);
                        doc.ExportCaption(NamaAplikasi);
                        doc.ExportCaption(Ikon);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(NamaAplikasi);
                            await doc.ExportField(LinkUrl);
                            await doc.ExportField(DeskripsiAplikasi);
                            await doc.ExportField(Ikon);
                        } else {
                            await doc.ExportField(Id);
                            await doc.ExportField(NamaAplikasi);
                            await doc.ExportField(Ikon);
