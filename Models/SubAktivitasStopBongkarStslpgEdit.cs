...
public partial class SnDOne {
    ...
    public class SubAktivitasStopBongkarStslpgEditBase : SubAktivitasStopBongkarStslpg
    {
        ...
        // Constructor
        public SubAktivitasStopBongkarStslpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasStopBongkarStslpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasStopBongkarStslpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasStopBongkarStslpgList") {
                                ...
                                returnUrl = "SubAktivitasStopBongkarStslpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
