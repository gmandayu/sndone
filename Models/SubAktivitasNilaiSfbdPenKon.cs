...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiSfbdPenKon
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiSfbdPenKon subAktivitasNilaiSfbdPenKon
    {
        get => HttpData.Resolve<SubAktivitasNilaiSfbdPenKon>("SubAktivitasNilaiSFBDPenKon");
        set => HttpData["SubAktivitasNilaiSFBDPenKon"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiSFBDPenKon
    /// </summary>
    public class SubAktivitasNilaiSfbdPenKon : DbTable
    {
        ...
        public readonly DbField<SqlDbType> SFBD_KLObs;

        public readonly DbField<SqlDbType> SFBD_KL15;

        public readonly DbField<SqlDbType> SFBD_Barrels;

        public readonly DbField<SqlDbType> SFBD_LT;

        public readonly DbField<SqlDbType> SFBD_MT;
        ...
        // Constructor
        public SubAktivitasNilaiSfbdPenKon()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiSFBDPenKon";
            Name = "SubAktivitasNilaiSFBDPenKon";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiSFBDPenKon"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            // SFBD_KLObs
            SFBD_KLObs = new(this, "x_SFBD_KLObs", 202, SqlDbType.NVarChar) {
                Name = "SFBD_KLObs",
                Expression = "[SFBD_KLObs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBD_KLObs]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBD_KLObs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "SFBD_KLObs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBD_KLObs", SFBD_KLObs);

            // SFBD_KL15
            SFBD_KL15 = new(this, "x_SFBD_KL15", 202, SqlDbType.NVarChar) {
                Name = "SFBD_KL15",
                Expression = "[SFBD_KL15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBD_KL15]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBD_KL15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "SFBD_KL15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBD_KL15", SFBD_KL15);

            // SFBD_Barrels
            SFBD_Barrels = new(this, "x_SFBD_Barrels", 202, SqlDbType.NVarChar) {
                Name = "SFBD_Barrels",
                Expression = "[SFBD_Barrels]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBD_Barrels]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBD_Barrels]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "SFBD_Barrels", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBD_Barrels", SFBD_Barrels);

            // SFBD_LT
            SFBD_LT = new(this, "x_SFBD_LT", 202, SqlDbType.NVarChar) {
                Name = "SFBD_LT",
                Expression = "[SFBD_LT]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBD_LT]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBD_LT]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "SFBD_LT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBD_LT", SFBD_LT);

            // SFBD_MT
            SFBD_MT = new(this, "x_SFBD_MT", 202, SqlDbType.NVarChar) {
                Name = "SFBD_MT",
                Expression = "[SFBD_MT]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBD_MT]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBD_MT]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "SFBD_MT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBD_MT", SFBD_MT);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDPenKon", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiSFBDPenKon";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiSfbdpenKon type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                SFBD_KLObs.DbValue = row["SFBD_KLObs"]; // Set DB value only
                SFBD_KL15.DbValue = row["SFBD_KL15"]; // Set DB value only
                SFBD_Barrels.DbValue = row["SFBD_Barrels"]; // Set DB value only
                SFBD_LT.DbValue = row["SFBD_LT"]; // Set DB value only
                SFBD_MT.DbValue = row["SFBD_MT"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiSfbdPenKonList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiSfbdPenKonView" => Language.Phrase("View"),
                "SubAktivitasNilaiSfbdPenKonEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiSfbdPenKonAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiSfbdPenKonView",
                Config.ApiAddAction => "SubAktivitasNilaiSfbdPenKonAdd",
                Config.ApiEditAction => "SubAktivitasNilaiSfbdPenKonEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiSfbdPenKonDelete",
                Config.ApiListAction => "SubAktivitasNilaiSfbdPenKonList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiSfbdPenKonList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiSfbdPenKonView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiSfbdPenKonView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiSfbdPenKonAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiSfbdPenKonAdd?" + parm;
            else
                url = "SubAktivitasNilaiSfbdPenKonAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiSfbdPenKonEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiSfbdPenKonList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiSfbdPenKonAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiSfbdPenKonList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiSfbdPenKonDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiSfbdPenKonList";
        ...
        public async Task RenderListRow()
        {
            ...
            SFBD_KLObs.TooltipValue = "";

            // SFBD_KL15
            SFBD_KL15.HrefValue = "";
            SFBD_KL15.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            SFBD_KLObs.EditValue = SFBD_KLObs.CurrentValue;
            ...
            SFBD_KL15.EditValue = SFBD_KL15.CurrentValue;
            ...
            SFBD_Barrels.EditValue = SFBD_Barrels.CurrentValue;
            ...
            SFBD_LT.EditValue = SFBD_LT.CurrentValue;
            ...
            SFBD_MT.EditValue = SFBD_MT.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(SFBD_KLObs);
                        doc.ExportCaption(SFBD_KL15);
                        doc.ExportCaption(SFBD_Barrels);
                        doc.ExportCaption(SFBD_LT);
                        doc.ExportCaption(SFBD_MT);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(SFBD_KLObs);
                            await doc.ExportField(SFBD_KL15);
                            await doc.ExportField(SFBD_Barrels);
                            await doc.ExportField(SFBD_LT);
                            await doc.ExportField(SFBD_MT);
