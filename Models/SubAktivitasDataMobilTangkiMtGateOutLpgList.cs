...
public partial class SnDOne {
    ...
    public class SubAktivitasDataMobilTangkiMtGateOutLpgListBase : SubAktivitasDataMobilTangkiMtGateOutLpg
    {
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field WaktuGateOut
            if (filter.TryGetValue("x_WaktuGateOut", out sv)) {
                RestoreFieldFilter(WaktuGateOut, filter, "WaktuGateOut", sv);
            }
