...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStopPembongkaranEdit
    /// </summary>
    public static SubAktivitasFormInputDataStopPembongkaranEdit subAktivitasFormInputDataStopPembongkaranEdit
    {
        get => HttpData.Get<SubAktivitasFormInputDataStopPembongkaranEdit>("subAktivitasFormInputDataStopPembongkaranEdit")!;
        set => HttpData["subAktivitasFormInputDataStopPembongkaranEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStopPembongkaran
    /// </summary>
    public class SubAktivitasFormInputDataStopPembongkaranEdit : SubAktivitasFormInputDataStopPembongkaranEditBase
    {
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStopPembongkaranEditBase : SubAktivitasFormInputDataStopPembongkaran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStopPembongkaranEdit";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStopPembongkaranEdit";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputDataStopPembongkaranList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputDataStopPembongkaranList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputDataStopPembongkaranList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputDataStopPembongkaranEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputDataStopPembongkaranList")), "", TableVar, true);
            string pageId = "edit";
