...
public partial class SnDOne {
    ...
    public class SubaktivitasStopBongkarEditBase : SubaktivitasStopBongkar
    {
        ...
        // Constructor
        public SubaktivitasStopBongkarEditBase()
        {
        ...
        // Constructor
        public SubaktivitasStopBongkarEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasStopBongkarList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasStopBongkarList") {
                                ...
                                returnUrl = "SubaktivitasStopBongkarList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
