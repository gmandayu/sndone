...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbookPenerimaanRtwListBase : SubAktivitasFormInputLogbookPenerimaanRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field NamaKegiatan
            if (filter.TryGetValue("x_NamaKegiatan", out sv)) {
                RestoreFieldFilter(NamaKegiatan, filter, "NamaKegiatan", sv);
            }
            ...
            // Field Level
            if (filter.TryGetValue("x_Level", out sv)) {
                RestoreFieldFilter(Level, filter, "Level", sv);
            }
            ...
            if (filter.TryGetValue("x_SubAktivitasFormInputHslPemeriksaanRTWId", out sv)) {
                RestoreFieldFilter(SubAktivitasFormInputHslPemeriksaanRTWId, filter, "SubAktivitasFormInputHslPemeriksaanRTWId", sv);
            }

            // Field TanggalJamSOP
            if (filter.TryGetValue("x_TanggalJamSOP", out sv)) {
                RestoreFieldFilter(TanggalJamSOP, filter, "TanggalJamSOP", sv);
            }

            // Field SelisihWaktu
            if (filter.TryGetValue("x_SelisihWaktu", out sv)) {
                RestoreFieldFilter(SelisihWaktu, filter, "SelisihWaktu", sv);
            }

            // Field IsQualityActive
            if (filter.TryGetValue("x_IsQualityActive", out sv)) {
                RestoreFieldFilter(IsQualityActive, filter, "IsQualityActive", sv);
            }
        }
