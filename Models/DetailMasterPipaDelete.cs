...
public partial class SnDOne {
    /// <summary>
    /// detailMasterPipaDelete
    /// </summary>
    public static DetailMasterPipaDelete detailMasterPipaDelete
    {
        get => HttpData.Get<DetailMasterPipaDelete>("detailMasterPipaDelete")!;
        set => HttpData["detailMasterPipaDelete"] = value;
    }

    /// <summary>
    /// Page class for DetailMasterPipa
    /// </summary>
    public class DetailMasterPipaDelete : DetailMasterPipaDeleteBase
    {
        // Constructor
        public DetailMasterPipaDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public DetailMasterPipaDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class DetailMasterPipaDeleteBase : DetailMasterPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "detailMasterPipaDelete";
        ...
        // Constructor
        public DetailMasterPipaDeleteBase()
        {
        ...
        // Page name
        public string PageName => "DetailMasterPipaDelete";
        ...
        // Constructor
        public DetailMasterPipaDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("DetailMasterPipaList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("DetailMasterPipaList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                detailMasterPipaDelete?.PageRender();
            }
            return PageResult();
        }
