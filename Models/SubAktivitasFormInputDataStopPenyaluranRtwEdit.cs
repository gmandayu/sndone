...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStopPenyaluranRtwEdit
    /// </summary>
    public static SubAktivitasFormInputDataStopPenyaluranRtwEdit subAktivitasFormInputDataStopPenyaluranRtwEdit
    {
        get => HttpData.Get<SubAktivitasFormInputDataStopPenyaluranRtwEdit>("subAktivitasFormInputDataStopPenyaluranRtwEdit")!;
        set => HttpData["subAktivitasFormInputDataStopPenyaluranRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStopPenyaluranRTW
    /// </summary>
    public class SubAktivitasFormInputDataStopPenyaluranRtwEdit : SubAktivitasFormInputDataStopPenyaluranRtwEditBase
    {
        // Constructor
        public SubAktivitasFormInputDataStopPenyaluranRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStopPenyaluranRtwEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStopPenyaluranRtwEditBase : SubAktivitasFormInputDataStopPenyaluranRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStopPenyaluranRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPenyaluranRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStopPenyaluranRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPenyaluranRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputDataStopPenyaluranRtwList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputDataStopPenyaluranRtwList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputDataStopPenyaluranRtwList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputDataStopPenyaluranRtwEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputDataStopPenyaluranRtwList")), "", TableVar, true);
            string pageId = "edit";
