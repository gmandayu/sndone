...
public partial class SnDOne {
    ...
    /// penimbunanList
    /// </summary>
    public static PenimbunanList penimbunanList
    {
        get => HttpData.Get<PenimbunanList>("penimbunanList")!;
        set => HttpData["penimbunanList"] = value;
    }

    /// <summary>
    /// Page class for Penimbunan
    /// </summary>
    public class PenimbunanList : PenimbunanListBase
    {
        // Constructor
        public PenimbunanList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenimbunanList() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PenimbunanListBase : Penimbunan
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penimbunanList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fPenimbunanlist";
        ...
        // Constructor
        public PenimbunanListBase(Controller? controller)
        {
        ...
        if (controller != null)
            ...
            MultiDeleteUrl = "PenimbunanDelete";
            MultiUpdateUrl = "PenimbunanUpdate";
        ...
        // Page name
        public string PageName => "PenimbunanList";
        ...
        public void SetVisibility()
        {
            ...
            LookupPenerimaan.Visible = false;
        ...
        // Constructor
        public PenimbunanListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(LookupPenerimaan.AdvancedSearch.ToJson())); // Field LookupPenerimaan
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field LookupPenerimaan
            if (filter.TryGetValue("x_LookupPenerimaan", out sv)) {
                RestoreFieldFilter(LookupPenerimaan, filter, "LookupPenerimaan", sv);
            }
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            BuildSearchSql(ref where, NomorPenimbunan, def, true); // NomorPenimbunan
            BuildSearchSql(ref where, Plant, def, true); // Plant
            BuildSearchSql(ref where, LookupPenerimaan, def, false); // LookupPenerimaan
            BuildSearchSql(ref where, IdPenerimaan, def, true); // IdPenerimaan
            ...
            if (!def && Command == "search") {
                LookupPenerimaan.AdvancedSearch.Save(); // LookupPenerimaan
        ...
        private string BuildFieldFilters(FilterConfiguration config)
        {
            ...
            filterList += ProcessFieldFilter("IdPenerimaan", IdPenerimaan, true, config);
        ...
        protected bool CheckSearchParms() {
            ...
            if (Proses2.AdvancedSearch.IssetSession)
                return true;
            if (NomorPenimbunan.AdvancedSearch.IssetSession)
                return true;
            if (Plant.AdvancedSearch.IssetSession)
                return true;
            if (LookupPenerimaan.AdvancedSearch.IssetSession)
                return true;
            if (IdPenerimaan.AdvancedSearch.IssetSession)
                return true;
        ...
        protected void ResetAdvancedSearchParms() {
            ...
            NomorPenimbunan.AdvancedSearch.UnsetSession();
            Plant.AdvancedSearch.UnsetSession();
            LookupPenerimaan.AdvancedSearch.UnsetSession();
            IdPenerimaan.AdvancedSearch.UnsetSession();
        ...
        protected void RestoreSearchParms() {
            ...
            NomorPenimbunan.AdvancedSearch.Load();
            Plant.AdvancedSearch.Load();
            LookupPenerimaan.AdvancedSearch.Load();
            IdPenerimaan.AdvancedSearch.Load();
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(IdPenerimaan, ctrl); // IdPenerimaan
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    IdPenimbunan.Sort = "";
                    Proses2.Sort = "";
                    NomorPenimbunan.Sort = "";
                    IdTemplate.Sort = "";
                    LookupPlant.Sort = "";
                    Plant.Sort = "";
                    TipeProdukSTS.Sort = "";
                    LookupPenerimaan.Sort = "";
                    IdPenerimaan.Sort = "";
                    IdTangki.Sort = "";
                    StatusProses.Sort = "";
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""Penimbunan"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""Penimbunan"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalAdd && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-copy"" title=""{copycaption}"" data-table=""Penimbunan"" data-caption=""{copycaption}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(CopyUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("CopyLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fPenimbunanlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fPenimbunanlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
            ...
            listOption?.SetBody("<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" + RowCount + "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" + HtmlEncode(IdPenimbunan.CurrentValue) + "\" data-ew-action=\"select-key\"></div>");
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""Penimbunan"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            item.Body = $@"<button type=""button"" class=""ew-action ew-multi-delete"" title=""{deleteTitle}"" data-caption=""{deleteTitle}"" form=""fPenimbunanlist""" +
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("IdPenerimaan")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fPenimbunansrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fPenimbunansrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fPenimbunanlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        private void SetupRowCountsAndAttributes()
        {
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(penimbunanList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(penimbunanList.RowCount) + "_Penimbunan");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(penimbunanList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && penimbunanList.RowType == RowType.Add || IsEdit && penimbunanList.RowType == RowType.Edit) // Inline-Add/Edit row
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void LoadFieldSearchValues()
        {
            ...
            LoadFieldNomorPenimbunanSearchValues();
            LoadFieldPlantSearchValues();
            LoadFieldLookupPenerimaanSearchValues();
            LoadFieldIdPenerimaanSearchValues();
        ...
        private void LoadFieldNomorPenimbunanSearchValues()
        {
            // NomorPenimbunan
            LoadPrimarySearchValueNomorPenimbunan();
            LoadSearchOperatorNomorPenimbunan();
        }

        private void LoadPrimarySearchValueNomorPenimbunan()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_NomorPenimbunan[]")) {
                NomorPenimbunan.AdvancedSearch.SearchValue = Get("x_NomorPenimbunan[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                NomorPenimbunan.AdvancedSearch.SearchValue = Get("NomorPenimbunan"); // Default Value // DN
            }
            if (!Empty(NomorPenimbunan.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorNomorPenimbunan()
        {
            if (Query.ContainsKey("z_NomorPenimbunan"))
                NomorPenimbunan.AdvancedSearch.SearchOperator = Get("z_NomorPenimbunan", Config.FilterOptionSeparator);
        }
        ...
        private void LoadFieldLookupPenerimaanSearchValues()
        {
            // LookupPenerimaan
            LoadPrimarySearchValueLookupPenerimaan();
            LoadSearchOperatorLookupPenerimaan();
        }

        private void LoadPrimarySearchValueLookupPenerimaan()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_LookupPenerimaan")) {
                LookupPenerimaan.AdvancedSearch.SearchValue = Get("x_LookupPenerimaan");
            }
            else if (!IsAddOrEdit) {
                LookupPenerimaan.AdvancedSearch.SearchValue = Get("LookupPenerimaan"); // Default Value // DN
            }
            if (!Empty(LookupPenerimaan.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorLookupPenerimaan()
        {
            if (Query.ContainsKey("z_LookupPenerimaan"))
                LookupPenerimaan.AdvancedSearch.SearchOperator = Get("z_LookupPenerimaan");
        }

        private void LoadFieldIdPenerimaanSearchValues()
        {
            // IdPenerimaan
            LoadPrimarySearchValueIdPenerimaan();
            LoadSearchOperatorIdPenerimaan();
        }

        private void LoadPrimarySearchValueIdPenerimaan()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_IdPenerimaan[]")) {
                IdPenerimaan.AdvancedSearch.SearchValue = Get("x_IdPenerimaan[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                IdPenerimaan.AdvancedSearch.SearchValue = Get("IdPenerimaan"); // Default Value // DN
            }
            if (!Empty(IdPenerimaan.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorIdPenerimaan()
        {
            if (Query.ContainsKey("z_IdPenerimaan"))
                IdPenerimaan.AdvancedSearch.SearchOperator = Get("z_IdPenerimaan", Config.FilterOptionSeparator);
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // IdPenerimaan
                if (IdPenerimaan.UseFilter && !Empty(IdPenerimaan.AdvancedSearch.SearchValue)) {
                    IdPenerimaan.EditValue = ConvertToString(IdPenerimaan.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }
...
protected void SetupExportOptions() {
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fPenimbunansrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
            ...
            if (ModalSearch && !IsMobile())
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-table=\"Penimbunan\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-ew-action=\"modal\" data-url=\"" + AppPath("PenimbunanSearch") + "\" data-btn=\"SearchBtn\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            else
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" href=\"" + AppPath("PenimbunanSearch") + "\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            item.Visible = true;
