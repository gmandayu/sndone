...
public partial class SnDOne {
    ...
    public class PenimbunanPenyaluranEditBase : PenimbunanPenyaluran
    {
        ...
        // Constructor
        public PenimbunanPenyaluranEditBase(Controller? controller)
        {
        ...
        // Constructor
        public PenimbunanPenyaluranEditBase() : this(null) { }
        ...
        private async Task<ActionSetupResult> SetupCurrentAction()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("IdPenimbunanPenyaluran", out rv)) {
                    IdPenimbunanPenyaluran.FormValue = UrlDecode(rv);
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            if (!IdPenimbunanPenyaluran.IsDetailKey) {
                SetNormalField(IdPenimbunanPenyaluran, "IdPenimbunanPenyaluran", "x_IdPenimbunanPenyaluran");
            }
        }
        #pragma warning restore 1998
