    ...
    public class ExportHtml : AbstractExport
    {
        ...
        public override object ExportFieldValue(DbField fld)
        {
            ...
            if (fld.ExportFieldImage && fld.ViewTag == "IMAGE") {
                ...
                exportValue = GetFileImgTag([ImageFileToBase64Url(ConvertToString(fld.ExportHrefValue)).GetAwaiter().GetResult()]);
            }
            return exportValue;
        }
        ...
        public override void AddImage(string imageFile, string breakType = "")
        {
            ...
            string html = "<div class=\"" + classes + "\">" + GetFileImgTag([ImageFileToBase64Url(imageFile).GetAwaiter().GetResult()]) + "</div>";
