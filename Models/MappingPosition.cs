...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static MappingPosition mappingPosition
    {
        get => HttpData.Resolve<MappingPosition>("MappingPosition");
        set => HttpData["MappingPosition"] = value;
    }

    /// <summary>
    /// Table class for MappingPosition
    /// </summary>
    public class MappingPosition : DbTable
    {
        ...
        public readonly DbField<SqlDbType> IdRegion;

        public readonly DbField<SqlDbType> NamaRegion;

        public readonly DbField<SqlDbType> IdPlant;

        public readonly DbField<SqlDbType> NamaPlant;
        ...
        public MappingPosition()
        {
            ...
            Name = "MappingPosition";
            Type = "TABLE";
            UpdateTable = "dbo.MappingPosition"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new(this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MappingPosition", "Id", "CustomMsg"),
                IsUpload = false
            };
            Id.Raw = true;
            Id.Lookup = new Lookup<DbField>(Id, "MappingPosition", true, "Id", new List<string> {"Id", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Id", Id);
            ...
            IdPosition = new(this, "x_IdPosition", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MappingPosition", "IdPosition", "CustomMsg"),
                IsUpload = false
            };
            IdPosition.Raw = true;
            ...
            // IdRegion
            IdRegion = new(this, "x_IdRegion", 3, SqlDbType.Int) {
                Name = "IdRegion",
                Expression = "[IdRegion]",
                BasicSearchExpression = "CAST([IdRegion] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[IdRegion]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MappingPosition", "IdRegion", "CustomMsg"),
                IsUpload = false
            };
            IdRegion.Raw = true;
            IdRegion.Lookup = new Lookup<DbField>(IdRegion, "MasterRegion", true, "IdRegion", new List<string> {"Region", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[Region]");
            Fields.Add("IdRegion", IdRegion);

            // NamaRegion
            NamaRegion = new(this, "x_NamaRegion", 202, SqlDbType.NVarChar) {
                Name = "NamaRegion",
                Expression = "[NamaRegion]",
                BasicSearchExpression = "[NamaRegion]",
                DateTimeFormat = -1,
                VirtualExpression = "[NamaRegion]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MappingPosition", "NamaRegion", "CustomMsg"),
                IsUpload = false
            };
            NamaRegion.Lookup = new Lookup<DbField>(NamaRegion, "MappingPosition", true, "NamaRegion", new List<string> {"NamaRegion", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NamaRegion", NamaRegion);
            ...
            IdPlant = new(this, "x_IdPlant", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("MappingPosition", "IdPlant", "CustomMsg"),
                IsUpload = false
            };
            IdPlant.Raw = true;
            ...
            // NamaPlant
            NamaPlant = new(this, "x_NamaPlant", 202, SqlDbType.NVarChar) {
                Name = "NamaPlant",
                Expression = "[NamaPlant]",
                BasicSearchExpression = "[NamaPlant]",
                DateTimeFormat = -1,
                VirtualExpression = "[NamaPlant]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MappingPosition", "NamaPlant", "CustomMsg"),
                IsUpload = false
            };
            NamaPlant.Lookup = new Lookup<DbField>(NamaPlant, "MappingPosition", true, "NamaPlant", new List<string> {"NamaPlant", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NamaPlant", NamaPlant);
        ...
        {
            get => _sqlFrom ?? "dbo.MappingPosition";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MappingPosition type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                IdRegion.DbValue = row["IdRegion"]; // Set DB value only
                NamaRegion.DbValue = row["NamaRegion"]; // Set DB value only
                IdPlant.DbValue = row["IdPlant"]; // Set DB value only
                NamaPlant.DbValue = row["NamaPlant"]; // Set DB value only
            } catch {}
        }
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MappingPositionView" => Language.Phrase("View"),
                "MappingPositionEdit" => Language.Phrase("Edit"),
                "MappingPositionAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MappingPositionView",
                Config.ApiAddAction => "MappingPositionAdd",
                Config.ApiEditAction => "MappingPositionEdit",
                Config.ApiDeleteAction => "MappingPositionDelete",
                Config.ApiListAction => "MappingPositionList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MappingPositionList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MappingPositionView", parm);
            else
                url = KeyUrl("MappingPositionView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MappingPositionAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MappingPositionAdd?" + parm;
            else
                url = "MappingPositionAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MappingPositionEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MappingPositionList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MappingPositionAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MappingPositionList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MappingPositionDelete", parm)); // DN
        }
        ...
        {
            string pageName = "MappingPositionList";
        ...
        public async Task RenderListRow()
        {
            ...
            IdRegion.ViewValue = Empty(curVal2) ? DbNullValue : FormatNumber(IdRegion.CurrentValue, IdRegion.FormatPattern);
            if (!Empty(curVal2)) {
            ...
            // NamaRegion
            NamaRegion.HrefValue = "";
            NamaRegion.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // IdRegion
            IdRegion.SetupEditAttributes();
            IdRegion.PlaceHolder = RemoveHtml(IdRegion.Caption);
            if (!Empty(IdRegion.EditValue) && IsNumeric(IdRegion.EditValue))
                IdRegion.EditValue = FormatNumber(IdRegion.EditValue, null);

            // NamaRegion
            NamaRegion.SetupEditAttributes();
            if (!NamaRegion.Raw)
                NamaRegion.CurrentValue = HtmlDecode(NamaRegion.CurrentValue);
            NamaRegion.EditValue = NamaRegion.CurrentValue;
            NamaRegion.PlaceHolder = RemoveHtml(NamaRegion.Caption);
            ...
            // NamaPlant
            NamaPlant.SetupEditAttributes();
            if (!NamaPlant.Raw)
                NamaPlant.CurrentValue = HtmlDecode(NamaPlant.CurrentValue);
            NamaPlant.EditValue = NamaPlant.CurrentValue;
            NamaPlant.PlaceHolder = RemoveHtml(NamaPlant.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(IdRegion);
                        doc.ExportCaption(IdPlant);
                    } else {
                        doc.ExportCaption(Id);
                        doc.ExportCaption(IdPosition);
                        doc.ExportCaption(IdRegion);
                        doc.ExportCaption(NamaRegion);
                        doc.ExportCaption(IdPlant);
                        doc.ExportCaption(NamaPlant);
                    }
                    doc.EndExportRow();
                }
            }
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(IdRegion);
                            await doc.ExportField(IdPlant);
                        } else {
                            await doc.ExportField(Id);
                            await doc.ExportField(IdPosition);
                            await doc.ExportField(IdRegion);
                            await doc.ExportField(NamaRegion);
                            await doc.ExportField(IdPlant);
                            await doc.ExportField(NamaPlant);
                        }
