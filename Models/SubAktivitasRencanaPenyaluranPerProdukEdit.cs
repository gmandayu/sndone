...
public partial class SnDOne {
    ...
    public class SubAktivitasRencanaPenyaluranPerProdukEditBase : SubAktivitasRencanaPenyaluranPerProduk
    {
        ...
        // Constructor
        public SubAktivitasRencanaPenyaluranPerProdukEditBase()
        {
        ...
        // Constructor
        public SubAktivitasRencanaPenyaluranPerProdukEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasRencanaPenyaluranPerProdukList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasRencanaPenyaluranPerProdukList") {
                                ...
                                returnUrl = "SubAktivitasRencanaPenyaluranPerProdukList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
