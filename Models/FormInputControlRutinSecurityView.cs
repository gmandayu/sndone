...
public partial class SnDOne {
    /// <summary>
    /// formInputControlRutinSecurityView
    /// </summary>
    public static FormInputControlRutinSecurityView formInputControlRutinSecurityView
    {
        get => HttpData.Get<FormInputControlRutinSecurityView>("formInputControlRutinSecurityView")!;
        set => HttpData["formInputControlRutinSecurityView"] = value;
    }

    /// <summary>
    /// Page class for FormInputControlRutinSecurity
    /// </summary>
    public class FormInputControlRutinSecurityView : FormInputControlRutinSecurityViewBase
    {
        // Constructor
        public FormInputControlRutinSecurityView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public FormInputControlRutinSecurityView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class FormInputControlRutinSecurityViewBase : FormInputControlRutinSecurity
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "formInputControlRutinSecurityView";
        ...
        // Constructor
        public FormInputControlRutinSecurityViewBase()
        {
        ...
        // Page name
        public string PageName => "FormInputControlRutinSecurityView";
        ...
        // Constructor
        public FormInputControlRutinSecurityViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("Id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "FormInputControlRutinSecurityList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("FormInputControlRutinSecurityList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                formInputControlRutinSecurityView?.PageRender();
            }
            return PageResult();
        }
