...
public partial class SnDOne {
    /// <summary>
    /// templateProsesDelete
    /// </summary>
    public static TemplateProsesDelete templateProsesDelete
    {
        get => HttpData.Get<TemplateProsesDelete>("templateProsesDelete")!;
        set => HttpData["templateProsesDelete"] = value;
    }

    /// <summary>
    /// Page class for TemplateProses
    /// </summary>
    public class TemplateProsesDelete : TemplateProsesDeleteBase
    {
        // Constructor
        public TemplateProsesDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TemplateProsesDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TemplateProsesDeleteBase : TemplateProses
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "templateProsesDelete";
        ...
        // Constructor
        public TemplateProsesDeleteBase()
        {
        ...
        // Page name
        public string PageName => "TemplateProsesDelete";
        ...
        // Constructor
        public TemplateProsesDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("TemplateProsesList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("TemplateProsesList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                templateProsesDelete?.PageRender();
            }
            return PageResult();
        }
