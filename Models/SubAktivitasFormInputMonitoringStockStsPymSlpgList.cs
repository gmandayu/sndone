...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputMonitoringStockStsPymSlpgList
    /// </summary>
    public static SubAktivitasFormInputMonitoringStockStsPymSlpgList subAktivitasFormInputMonitoringStockStsPymSlpgList
    {
        get => HttpData.Get<SubAktivitasFormInputMonitoringStockStsPymSlpgList>("subAktivitasFormInputMonitoringStockStsPymSlpgList")!;
        set => HttpData["subAktivitasFormInputMonitoringStockStsPymSlpgList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputMonitoringStockSTSPymSLPG
    /// </summary>
    public class SubAktivitasFormInputMonitoringStockStsPymSlpgList : SubAktivitasFormInputMonitoringStockStsPymSlpgListBase
    {
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSlpgList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSlpgList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputMonitoringStockStsPymSlpgListBase : SubAktivitasFormInputMonitoringStockStsPymSlpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputMonitoringStockStsPymSlpgList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasFormInputMonitoringStockSTSPymSLPGlist";
        ...
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSlpgListBase()
        {
            TableName = "SubAktivitasFormInputMonitoringStockSTSPymSLPG";

            // CSS class name as context
            TableVar = "SubAktivitasFormInputMonitoringStockSTSPymSLPG";
            ...
            // Table object (subAktivitasFormInputMonitoringStockStsPymSlpg)
            if (subAktivitasFormInputMonitoringStockStsPymSlpg == null || subAktivitasFormInputMonitoringStockStsPymSlpg is SubAktivitasFormInputMonitoringStockStsPymSlpg)
                subAktivitasFormInputMonitoringStockStsPymSlpg = this;

            // Initialize URLs
            AddUrl = "SubAktivitasFormInputMonitoringStockStsPymSlpgAdd";
            ...
            MultiDeleteUrl = "SubAktivitasFormInputMonitoringStockStsPymSlpgDelete";
            MultiUpdateUrl = "SubAktivitasFormInputMonitoringStockStsPymSlpgUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputMonitoringStockStsPymSlpgList";
        ...
        public void SetVisibility()
        {
            ...
            NomorTangki.SetVisibility();
            Produk.SetVisibility();
            Aktivitas2.SetVisibility();
            QuantityAwal.SetVisibility();
            QuantityAkhir.SetVisibility();
            ...
            TanggalQuantityAwal.SetVisibility();
            TanggalQuantityAkhir.SetVisibility();
        }

        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSlpgListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasFormInputMonitoringStockStsPymSlpgView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasFormInputMonitoringStockSTSPymSLPGgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputMonitoringStockStsPymSlpgList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(NomorTangki.AdvancedSearch.ToJson())); // Field NomorTangki
            ...
            filters.Merge(JObject.Parse(QuantityAwal.AdvancedSearch.ToJson())); // Field QuantityAwal
            filters.Merge(JObject.Parse(QuantityAkhir.AdvancedSearch.ToJson())); // Field QuantityAkhir
            ...
            filters.Merge(JObject.Parse(TanggalQuantityAwal.AdvancedSearch.ToJson())); // Field TanggalQuantityAwal
            filters.Merge(JObject.Parse(TanggalQuantityAkhir.AdvancedSearch.ToJson())); // Field TanggalQuantityAkhir
        ...
        protected bool RestoreFilterList() {
            ...
            // Field NomorTangki
            if (filter?.TryGetValue("x_NomorTangki", out sv) ?? false) {
                NomorTangki.AdvancedSearch.SearchValue = sv;
                NomorTangki.AdvancedSearch.SearchOperator = filter["z_NomorTangki"];
                NomorTangki.AdvancedSearch.SearchCondition = filter["v_NomorTangki"];
                NomorTangki.AdvancedSearch.SearchValue2 = filter["y_NomorTangki"];
                NomorTangki.AdvancedSearch.SearchOperator2 = filter["w_NomorTangki"];
                NomorTangki.AdvancedSearch.Save();
            }
            ...
            // Field Aktivitas
            if (filter?.TryGetValue("x_Aktivitas2", out sv) ?? false) {
                Aktivitas2.AdvancedSearch.SearchValue = sv;
                Aktivitas2.AdvancedSearch.SearchOperator = filter["z_Aktivitas2"];
                Aktivitas2.AdvancedSearch.SearchCondition = filter["v_Aktivitas2"];
                Aktivitas2.AdvancedSearch.SearchValue2 = filter["y_Aktivitas2"];
                Aktivitas2.AdvancedSearch.SearchOperator2 = filter["w_Aktivitas2"];
                Aktivitas2.AdvancedSearch.Save();
            }

            // Field QuantityAwal
            if (filter?.TryGetValue("x_QuantityAwal", out sv) ?? false) {
                QuantityAwal.AdvancedSearch.SearchValue = sv;
                QuantityAwal.AdvancedSearch.SearchOperator = filter["z_QuantityAwal"];
                QuantityAwal.AdvancedSearch.SearchCondition = filter["v_QuantityAwal"];
                QuantityAwal.AdvancedSearch.SearchValue2 = filter["y_QuantityAwal"];
                QuantityAwal.AdvancedSearch.SearchOperator2 = filter["w_QuantityAwal"];
                QuantityAwal.AdvancedSearch.Save();
            }

            // Field QuantityAkhir
            if (filter?.TryGetValue("x_QuantityAkhir", out sv) ?? false) {
                QuantityAkhir.AdvancedSearch.SearchValue = sv;
                QuantityAkhir.AdvancedSearch.SearchOperator = filter["z_QuantityAkhir"];
                QuantityAkhir.AdvancedSearch.SearchCondition = filter["v_QuantityAkhir"];
                QuantityAkhir.AdvancedSearch.SearchValue2 = filter["y_QuantityAkhir"];
                QuantityAkhir.AdvancedSearch.SearchOperator2 = filter["w_QuantityAkhir"];
                QuantityAkhir.AdvancedSearch.Save();
            }
            ...
            // Field TanggalQuantityAwal
            if (filter?.TryGetValue("x_TanggalQuantityAwal", out sv) ?? false) {
                TanggalQuantityAwal.AdvancedSearch.SearchValue = sv;
                TanggalQuantityAwal.AdvancedSearch.SearchOperator = filter["z_TanggalQuantityAwal"];
                TanggalQuantityAwal.AdvancedSearch.SearchCondition = filter["v_TanggalQuantityAwal"];
                TanggalQuantityAwal.AdvancedSearch.SearchValue2 = filter["y_TanggalQuantityAwal"];
                TanggalQuantityAwal.AdvancedSearch.SearchOperator2 = filter["w_TanggalQuantityAwal"];
                TanggalQuantityAwal.AdvancedSearch.Save();
            }

            // Field TanggalQuantityAkhir
            if (filter?.TryGetValue("x_TanggalQuantityAkhir", out sv) ?? false) {
                TanggalQuantityAkhir.AdvancedSearch.SearchValue = sv;
                TanggalQuantityAkhir.AdvancedSearch.SearchOperator = filter["z_TanggalQuantityAkhir"];
                TanggalQuantityAkhir.AdvancedSearch.SearchCondition = filter["v_TanggalQuantityAkhir"];
                TanggalQuantityAkhir.AdvancedSearch.SearchValue2 = filter["y_TanggalQuantityAkhir"];
                TanggalQuantityAkhir.AdvancedSearch.SearchOperator2 = filter["w_TanggalQuantityAkhir"];
                TanggalQuantityAkhir.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(NomorTangki);
            searchFlds.Add(Produk);
            searchFlds.Add(Aktivitas2);
            searchFlds.Add(QuantityAwal);
            searchFlds.Add(QuantityAkhir);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(NomorTangki, ctrl); // NomorTangki
                UpdateSort(Produk, ctrl); // Produk
                UpdateSort(Aktivitas2, ctrl); // Aktivitas
                UpdateSort(QuantityAwal, ctrl); // QuantityAwal
                UpdateSort(QuantityAkhir, ctrl); // QuantityAkhir
                ...
                UpdateSort(TanggalQuantityAwal, ctrl); // TanggalQuantityAwal
                UpdateSort(TanggalQuantityAkhir, ctrl); // TanggalQuantityAkhir
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    TanggalQuantityAwal.Sort = "";
                    TanggalQuantityAkhir.Sort = "";
                }
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasFormInputMonitoringStockSTSPymSLPG"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputMonitoringStockSTSPymSLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputMonitoringStockSTSPymSLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("NomorTangki")); // DN
                CreateColumnOption(option.Add("Produk")); // DN
                CreateColumnOption(option.Add("Aktivitas")); // DN
                CreateColumnOption(option.Add("QuantityAwal")); // DN
                CreateColumnOption(option.Add("QuantityAkhir")); // DN
                ...
                CreateColumnOption(option.Add("TanggalQuantityAwal")); // DN
                CreateColumnOption(option.Add("TanggalQuantityAkhir")); // DN
            }
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasFormInputMonitoringStockSTSPymSLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasFormInputMonitoringStockSTSPymSLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputMonitoringStockSTSPymSLPGlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasFormInputMonitoringStockSTSPymSLPG");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasFormInputMonitoringStockStsPymSlpgList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasFormInputMonitoringStockStsPymSlpgList.RowCount) + "_SubAktivitasFormInputMonitoringStockSTSPymSLPG");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasFormInputMonitoringStockStsPymSlpgList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasFormInputMonitoringStockStsPymSlpgList.RowType == RowType.Add || IsEdit && subAktivitasFormInputMonitoringStockStsPymSlpgList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            QuantityAwal.SetDbValue(row["QuantityAwal"]);
            QuantityAkhir.SetDbValue(row["QuantityAkhir"]);
            ...
            TanggalQuantityAwal.SetDbValue(row["TanggalQuantityAwal"]);
            TanggalQuantityAkhir.SetDbValue(row["TanggalQuantityAkhir"]);
        }
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("NomorTangki", NomorTangki.DefaultValue ?? DbNullValue); // DN
            row.Add("Produk", Produk.DefaultValue ?? DbNullValue); // DN
            row.Add("Aktivitas", Aktivitas2.DefaultValue ?? DbNullValue); // DN
            row.Add("QuantityAwal", QuantityAwal.DefaultValue ?? DbNullValue); // DN
            row.Add("QuantityAkhir", QuantityAkhir.DefaultValue ?? DbNullValue); // DN
            ...
            row.Add("TanggalQuantityAwal", TanggalQuantityAwal.DefaultValue ?? DbNullValue); // DN
            row.Add("TanggalQuantityAkhir", TanggalQuantityAkhir.DefaultValue ?? DbNullValue); // DN
            return row;
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // QuantityAwal
                QuantityAwal.ViewValue = ConvertToString(QuantityAwal.CurrentValue); // DN
                QuantityAwal.ViewCustomAttributes = "";

                // QuantityAkhir
                QuantityAkhir.ViewValue = ConvertToString(QuantityAkhir.CurrentValue); // DN
                QuantityAkhir.ViewCustomAttributes = "";
                ...
                // TanggalQuantityAwal
                TanggalQuantityAwal.ViewValue = TanggalQuantityAwal.CurrentValue;
                TanggalQuantityAwal.ViewValue = FormatDateTime(TanggalQuantityAwal.ViewValue, TanggalQuantityAwal.FormatPattern);
                TanggalQuantityAwal.ViewCustomAttributes = "";

                // TanggalQuantityAkhir
                TanggalQuantityAkhir.ViewValue = TanggalQuantityAkhir.CurrentValue;
                TanggalQuantityAkhir.ViewValue = FormatDateTime(TanggalQuantityAkhir.ViewValue, TanggalQuantityAkhir.FormatPattern);
                TanggalQuantityAkhir.ViewCustomAttributes = "";
                ...
                // QuantityAwal
                QuantityAwal.HrefValue = "";
                QuantityAwal.TooltipValue = "";

                // QuantityAkhir
                QuantityAkhir.HrefValue = "";
                QuantityAkhir.TooltipValue = "";
                ...
                // TanggalQuantityAwal
                TanggalQuantityAwal.HrefValue = "";
                TanggalQuantityAwal.TooltipValue = "";

                // TanggalQuantityAkhir
                TanggalQuantityAkhir.HrefValue = "";
                TanggalQuantityAkhir.TooltipValue = "";
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasFormInputMonitoringStockSTSPymSLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasFormInputMonitoringStockSTSPymSLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasFormInputMonitoringStockSTSPymSLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasFormInputMonitoringStockSTSPymSLPGsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
