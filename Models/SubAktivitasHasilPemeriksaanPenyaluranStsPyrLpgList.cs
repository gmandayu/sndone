...
public partial class SnDOne {
    ...
    public class SubAktivitasHasilPemeriksaanPenyaluranStsPyrLpgListBase : SubAktivitasHasilPemeriksaanPenyaluranStsPyrLpg
    {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranStsPyrLpgListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranStsPyrLpgListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field NamaKapal
            if (filter.TryGetValue("x_NamaKapal", out sv)) {
                RestoreFieldFilter(NamaKapal, filter, "NamaKapal", sv);
            }
