...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputFlowrateRtwListBase : SubAktivitasFormInputFlowrateRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateRtwListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateRtwListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field StrippingTime
            if (filter.TryGetValue("x_StrippingTime", out sv)) {
                RestoreFieldFilter(StrippingTime, filter, "StrippingTime", sv);
            }

            // Field Pressuren
            if (filter.TryGetValue("x_Pressuren", out sv)) {
                RestoreFieldFilter(Pressuren, filter, "Pressuren", sv);
            }

            // Field LamaPembongkaran
            if (filter.TryGetValue("x_LamaPembongkaran", out sv)) {
                RestoreFieldFilter(LamaPembongkaran, filter, "LamaPembongkaran", sv);
            }
