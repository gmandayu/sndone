...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiSfblstsPymBbmList
    /// </summary>
    public static SubaktivitasNilaiSfblstsPymBbmList subaktivitasNilaiSfblstsPymBbmList
    {
        get => HttpData.Get<SubaktivitasNilaiSfblstsPymBbmList>("subaktivitasNilaiSfblstsPymBbmList")!;
        set => HttpData["subaktivitasNilaiSfblstsPymBbmList"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasNilaiSFBLSTSPymBBM
    /// </summary>
    public class SubaktivitasNilaiSfblstsPymBbmList : SubaktivitasNilaiSfblstsPymBbmListBase
    {
        // Constructor
        public SubaktivitasNilaiSfblstsPymBbmList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasNilaiSfblstsPymBbmList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasNilaiSfblstsPymBbmListBase : SubaktivitasNilaiSfblstsPymBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasNilaiSfblstsPymBbmList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubaktivitasNilaiSFBLSTSPymBBMlist";
        ...
        // Constructor
        public SubaktivitasNilaiSfblstsPymBbmListBase()
        {
            ...
            // Initialize URLs
            AddUrl = "SubaktivitasNilaiSfblstsPymBbmAdd";
            ...
            MultiDeleteUrl = "SubaktivitasNilaiSfblstsPymBbmDelete";
            MultiUpdateUrl = "SubaktivitasNilaiSfblstsPymBbmUpdate";
        ...
        // Page name
        public string PageName => "SubaktivitasNilaiSfblstsPymBbmList";
        ...
        // Constructor
        public SubaktivitasNilaiSfblstsPymBbmListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubaktivitasNilaiSFBLSTSPymBBMgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subaktivitasNilaiSfblstsPymBbmList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubaktivitasNilaiSFBLSTSPymBBM"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubaktivitasNilaiSFBLSTSPymBBMlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasNilaiSFBLSTSPymBBMlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubaktivitasNilaiSFBLSTSPymBBMsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubaktivitasNilaiSFBLSTSPymBBMsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasNilaiSFBLSTSPymBBMlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubaktivitasNilaiSFBLSTSPymBBM");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subaktivitasNilaiSfblstsPymBbmList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subaktivitasNilaiSfblstsPymBbmList.RowCount) + "_SubaktivitasNilaiSFBLSTSPymBBM");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subaktivitasNilaiSfblstsPymBbmList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subaktivitasNilaiSfblstsPymBbmList.RowType == RowType.Add || IsEdit && subaktivitasNilaiSfblstsPymBbmList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubaktivitasNilaiSFBLSTSPymBBMsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
