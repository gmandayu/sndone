...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiNewBlsfadsfblstsPyrBbm
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiNewBlsfadsfblstsPyrBbm subAktivitasNilaiNewBlsfadsfblstsPyrBbm
    {
        get => HttpData.Resolve<SubAktivitasNilaiNewBlsfadsfblstsPyrBbm>("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM");
        set => HttpData["SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfblstsPyrBbm : DbTable
    {
        ...
        public readonly DbField<SqlDbType> SFBL_KLObs;

        public readonly DbField<SqlDbType> SFBL_KL15;

        public readonly DbField<SqlDbType> SFBL_Barrels;

        public readonly DbField<SqlDbType> SFBL_LT;

        public readonly DbField<SqlDbType> SFBL_MT;
        ...
        public readonly DbField<SqlDbType> ExROB;

        public readonly DbField<SqlDbType> NoPenerimaan;

        public readonly DbField<SqlDbType> StatusAktivitas;

        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrBbm()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM";
            Name = "SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_KLObs = new(this, "x_NewBL_KLObs", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "NewBL_KLObs", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_KL15 = new(this, "x_NewBL_KL15", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "NewBL_KL15", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_Barrels = new(this, "x_NewBL_Barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "NewBL_Barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_LT = new(this, "x_NewBL_LT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "NewBL_LT", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_MT = new(this, "x_NewBL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "NewBL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_KLObs = new(this, "x_SFAD_KLObs", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "SFAD_KLObs", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_KL15 = new(this, "x_SFAD_KL15", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "SFAD_KL15", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_Barrels = new(this, "x_SFAD_Barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "SFAD_Barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_LT = new(this, "x_SFAD_LT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "SFAD_LT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_MT = new(this, "x_SFAD_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "SFAD_MT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAD_MT", SFAD_MT);

            // SFBL_KLObs
            SFBL_KLObs = new(this, "x_SFBL_KLObs", 202, SqlDbType.NVarChar) {
                Name = "SFBL_KLObs",
                Expression = "[SFBL_KLObs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBL_KLObs]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBL_KLObs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "SFBL_KLObs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBL_KLObs", SFBL_KLObs);

            // SFBL_KL15
            SFBL_KL15 = new(this, "x_SFBL_KL15", 202, SqlDbType.NVarChar) {
                Name = "SFBL_KL15",
                Expression = "[SFBL_KL15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBL_KL15]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBL_KL15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "SFBL_KL15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBL_KL15", SFBL_KL15);

            // SFBL_Barrels
            SFBL_Barrels = new(this, "x_SFBL_Barrels", 202, SqlDbType.NVarChar) {
                Name = "SFBL_Barrels",
                Expression = "[SFBL_Barrels]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBL_Barrels]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBL_Barrels]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "SFBL_Barrels", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBL_Barrels", SFBL_Barrels);

            // SFBL_LT
            SFBL_LT = new(this, "x_SFBL_LT", 202, SqlDbType.NVarChar) {
                Name = "SFBL_LT",
                Expression = "[SFBL_LT]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBL_LT]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBL_LT]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "SFBL_LT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBL_LT", SFBL_LT);

            // SFBL_MT
            SFBL_MT = new(this, "x_SFBL_MT", 202, SqlDbType.NVarChar) {
                Name = "SFBL_MT",
                Expression = "[SFBL_MT]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBL_MT]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBL_MT]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "SFBL_MT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBL_MT", SFBL_MT);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            // ExROB
            ExROB = new(this, "x_ExROB", 11, SqlDbType.Bit) {
                Name = "ExROB",
                Expression = "[ExROB]",
                BasicSearchExpression = "[ExROB]",
                DateTimeFormat = -1,
                VirtualExpression = "[ExROB]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "ExROB", "CustomMsg"),
                IsUpload = false
            };
            ExROB.Raw = true;
            ExROB.Lookup = new Lookup<DbField>(ExROB, "SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ExROB.UserValues = ["1"];
            Fields.Add("ExROB", ExROB);

            // NoPenerimaan
            NoPenerimaan = new(this, "x_NoPenerimaan", 202, SqlDbType.NVarChar) {
                Name = "NoPenerimaan",
                Expression = "[NoPenerimaan]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NoPenerimaan]",
                DateTimeFormat = -1,
                VirtualExpression = "[NoPenerimaan]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "NoPenerimaan", "CustomMsg"),
                IsUpload = false
            };
            NoPenerimaan.Lookup = new Lookup<DbField>(NoPenerimaan, "Penerimaan", false, "NomorPenerimaan", new List<string> {"NomorPenerimaan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "[TanggalDibuat] DESC", "", "[NomorPenerimaan]");
            NoPenerimaan.GetSelectFilter = () => "NomorPenerimaan IN (SELECT NoReferensi FROM SubAktivitasSFADNewBLSTSPnrBBM WHERE ApakahTerdapatROB = 1 UNION SELECT NoReferensi FROM SubAktivitasSFADNewBL WHERE ApakahTerdapatROB = 1)";
            Fields.Add("NoPenerimaan", NoPenerimaan);
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiNewBlsfadsfblstspyrBbm type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                SFBL_KLObs.DbValue = row["SFBL_KLObs"]; // Set DB value only
                SFBL_KL15.DbValue = row["SFBL_KL15"]; // Set DB value only
                SFBL_Barrels.DbValue = row["SFBL_Barrels"]; // Set DB value only
                SFBL_LT.DbValue = row["SFBL_LT"]; // Set DB value only
                SFBL_MT.DbValue = row["SFBL_MT"]; // Set DB value only
                ...
                ExROB.DbValue = (ConvertToBool(row["ExROB"]) ? "1" : "0"); // Set DB value only
                NoPenerimaan.DbValue = row["NoPenerimaan"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmView" => Language.Phrase("View"),
                "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmView",
                Config.ApiAddAction => "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmAdd",
                Config.ApiEditAction => "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmDelete",
                Config.ApiListAction => "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrBbmView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrBbmView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmAdd?" + parm;
            else
                url = "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrBbmAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrBbmDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList";
        ...
        public async Task RenderListRow()
        {
            ...
            StatusAktivitas.ViewValue = Empty(curVal5) ? DbNullValue : FormatNumber(StatusAktivitas.CurrentValue, StatusAktivitas.FormatPattern);
            if (!Empty(curVal5)) {
            ...
            SFBL_KLObs.TooltipValue = "";

            // SFBL_KL15
            SFBL_KL15.HrefValue = "";
            SFBL_KL15.TooltipValue = "";

            // SFBL_Barrels
            SFBL_Barrels.HrefValue = "";
            SFBL_Barrels.TooltipValue = "";

            // SFBL_LT
            SFBL_LT.HrefValue = "";
            SFBL_LT.TooltipValue = "";

            // SFBL_MT
            SFBL_MT.HrefValue = "";
            SFBL_MT.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            SFBL_KLObs.EditValue = SFBL_KLObs.CurrentValue;
            ...
            SFBL_KL15.EditValue = SFBL_KL15.CurrentValue;
            ...
            SFBL_Barrels.EditValue = SFBL_Barrels.CurrentValue;
            ...
            SFBL_LT.EditValue = SFBL_LT.CurrentValue;
            ...
            SFBL_MT.EditValue = SFBL_MT.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(SFBL_KLObs);
                        doc.ExportCaption(SFBL_KL15);
                        doc.ExportCaption(SFBL_Barrels);
                        doc.ExportCaption(SFBL_LT);
                        doc.ExportCaption(SFBL_MT);
                        doc.ExportCaption(userInput);
                        doc.ExportCaption(etlDate);
                        doc.ExportCaption(LastUpdatedBy);
                        doc.ExportCaption(lastUpdatedDate);
                        doc.ExportCaption(ExROB);
                        doc.ExportCaption(NoPenerimaan);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(SFBL_KLObs);
                            await doc.ExportField(SFBL_KL15);
                            await doc.ExportField(SFBL_Barrels);
                            await doc.ExportField(SFBL_LT);
                            await doc.ExportField(SFBL_MT);
                            ...
                            await doc.ExportField(ExROB);
                            await doc.ExportField(NoPenerimaan);
