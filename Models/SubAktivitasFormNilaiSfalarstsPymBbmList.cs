...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormNilaiSfalarstsPymBbmList
    /// </summary>
    public static SubAktivitasFormNilaiSfalarstsPymBbmList subAktivitasFormNilaiSfalarstsPymBbmList
    {
        get => HttpData.Get<SubAktivitasFormNilaiSfalarstsPymBbmList>("subAktivitasFormNilaiSfalarstsPymBbmList")!;
        set => HttpData["subAktivitasFormNilaiSfalarstsPymBbmList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormNilaiSFALARSTSPymBBM
    /// </summary>
    public class SubAktivitasFormNilaiSfalarstsPymBbmList : SubAktivitasFormNilaiSfalarstsPymBbmListBase
    {
        // Constructor
        public SubAktivitasFormNilaiSfalarstsPymBbmList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormNilaiSfalarstsPymBbmList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormNilaiSfalarstsPymBbmListBase : SubAktivitasFormNilaiSfalarstsPymBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormNilaiSfalarstsPymBbmList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasFormNilaiSFALARSTSPymBBMlist";
        ...
        // Constructor
        public SubAktivitasFormNilaiSfalarstsPymBbmListBase()
        {
            ...
            // Initialize URLs
            AddUrl = "SubAktivitasFormNilaiSfalarstsPymBbmAdd";
            ...
            MultiDeleteUrl = "SubAktivitasFormNilaiSfalarstsPymBbmDelete";
            MultiUpdateUrl = "SubAktivitasFormNilaiSfalarstsPymBbmUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasFormNilaiSfalarstsPymBbmList";
        ...
        // Constructor
        public SubAktivitasFormNilaiSfalarstsPymBbmListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasFormNilaiSFALARSTSPymBBMgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormNilaiSfalarstsPymBbmList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(AR_klobs);
            searchFlds.Add(AR_kl15);
            searchFlds.Add(AR_barrels);
            searchFlds.Add(AR_lt);
            searchFlds.Add(AR_mt);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(AR_klobs, ctrl); // AR_klobs
                UpdateSort(AR_kl15, ctrl); // AR_kl15
                UpdateSort(AR_barrels, ctrl); // AR_barrels
                UpdateSort(AR_lt, ctrl); // AR_lt
                UpdateSort(AR_mt, ctrl); // AR_mt
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasFormNilaiSFALARSTSPymBBM"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormNilaiSFALARSTSPymBBMlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormNilaiSFALARSTSPymBBMlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("AR_klobs")); // DN
                CreateColumnOption(option.Add("AR_kl15")); // DN
                CreateColumnOption(option.Add("AR_barrels")); // DN
                CreateColumnOption(option.Add("AR_lt")); // DN
                CreateColumnOption(option.Add("AR_mt")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasFormNilaiSFALARSTSPymBBMsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasFormNilaiSFALARSTSPymBBMsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormNilaiSFALARSTSPymBBMlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasFormNilaiSFALARSTSPymBBM");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasFormNilaiSfalarstsPymBbmList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasFormNilaiSfalarstsPymBbmList.RowCount) + "_SubAktivitasFormNilaiSFALARSTSPymBBM");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasFormNilaiSfalarstsPymBbmList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasFormNilaiSfalarstsPymBbmList.RowType == RowType.Add || IsEdit && subAktivitasFormNilaiSfalarstsPymBbmList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasFormNilaiSFALARSTSPymBBMlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasFormNilaiSFALARSTSPymBBMlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasFormNilaiSFALARSTSPymBBMlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
