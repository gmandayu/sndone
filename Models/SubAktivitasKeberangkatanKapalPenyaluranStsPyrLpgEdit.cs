...
public partial class SnDOne {
    ...
    public class SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEditBase : SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpg
    {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgList") {
                                ...
                                returnUrl = "SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
