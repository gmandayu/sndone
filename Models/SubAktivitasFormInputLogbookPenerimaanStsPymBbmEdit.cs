...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbookPenerimaanStsPymBbmEditBase : SubAktivitasFormInputLogbookPenerimaanStsPymBbm
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymBbmEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputLogbookPenerimaanStsPymBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputLogbookPenerimaanStsPymBbmList") {
                                ...
                                returnUrl = "SubAktivitasFormInputLogbookPenerimaanStsPymBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
