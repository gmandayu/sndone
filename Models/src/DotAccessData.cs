...
public partial class SnDOne {
    ...
    public class DotAccessData
    {
        ...
        public void Append(string key, dynamic? value = null)
        {
            ...
            if (keyPath.Length == 1) {
                ...
                if (!IsList(currentValue[key]))
                    currentValue[key] = (List<dynamic>)[currentValue[key]];
            ...
            if (!IsList(currentValue[endKey])) // Promote this key to a List
                currentValue[endKey] = (List<dynamic>)[currentValue[endKey]];
        ...
        public IDictionary<string, dynamic?> Import(IDictionary<string, dynamic?> data) => _data = Merge(_data, data);

        /// <summary>
        /// Import dictionary
        /// </summary>
        /// <param name="data">Object to be imported</param>
        public IDictionary<string, dynamic?> Import(object data) => _data = Merge(_data, data);
