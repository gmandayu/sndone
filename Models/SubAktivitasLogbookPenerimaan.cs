...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLogbookPenerimaan
    /// </summary>
    [MaybeNull]
    public static SubAktivitasLogbookPenerimaan subAktivitasLogbookPenerimaan
    {
        get => HttpData.Resolve<SubAktivitasLogbookPenerimaan>("SubAktivitasLogbookPenerimaan");
        set => HttpData["SubAktivitasLogbookPenerimaan"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasLogbookPenerimaan
    /// </summary>
    public class SubAktivitasLogbookPenerimaan : DbTable
    {
        ...
        public readonly DbField<SqlDbType> Nama_Kapal;
        ...
        public readonly DbField<SqlDbType> Temperatur;
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaan()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasLogbookPenerimaan";
            Name = "SubAktivitasLogbookPenerimaan";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasLogbookPenerimaan"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NoReferensi", NoReferensi);

            // Nama_Kapal
            Nama_Kapal = new(this, "x_Nama_Kapal", 202, SqlDbType.NVarChar) {
                Name = "Nama_Kapal",
                Expression = "[Nama_Kapal]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Nama_Kapal]",
                DateTimeFormat = -1,
                VirtualExpression = "[Nama_Kapal]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "Nama_Kapal", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Nama_Kapal", Nama_Kapal);

            // TanggalJam
            TanggalJam = new(this, "x_TanggalJam", 135, SqlDbType.DateTime) {
                Name = "TanggalJam",
                Expression = "[TanggalJam]",
                BasicSearchExpression = CastDateFieldForLike("[TanggalJam]", 9, "DB"),
                DateTimeFormat = 9,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "TanggalJam", "CustomMsg"),
                IsUpload = false
            };
            TanggalJam.Raw = true;
            ...
            Nama_Kegiatan = new(this, "x_Nama_Kegiatan", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "Nama_Kegiatan", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            Density = new(this, "x_Density", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "Density", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Density", Density);

            // Temperatur
            Temperatur = new(this, "x_Temperatur", 202, SqlDbType.NVarChar) {
                Name = "Temperatur",
                Expression = "[Temperatur]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Temperatur]",
                DateTimeFormat = -1,
                VirtualExpression = "[Temperatur]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "Temperatur", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Temperatur", Temperatur);
            ...
            Keterangan = new(this, "x_Keterangan", 203, SqlDbType.NText) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            SubAktivitasHasilPemeriksaanId = new(this, "x_SubAktivitasHasilPemeriksaanId", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "SubAktivitasHasilPemeriksaanId", "CustomMsg"),
                IsUpload = false
            };
            ...
            Level = new(this, "x_Level", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "Level", "CustomMsg"),
                IsUpload = false
            };
            ...
            Volume = new(this, "x_Volume", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "Volume", "CustomMsg"),
                IsUpload = false
            };
            ...
            Flowrate = new(this, "x_Flowrate", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "Flowrate", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalJamSOP = new(this, "x_TanggalJamSOP", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "TanggalJamSOP", "CustomMsg"),
                IsUpload = false
            };
            ...
            SelisihWaktu = new(this, "x_SelisihWaktu", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "SelisihWaktu", "CustomMsg"),
                IsUpload = false
            };
            ...
            IsQualityActive = new(this, "x_IsQualityActive", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookPenerimaan", "IsQualityActive", "CustomMsg"),
                IsUpload = false
            };
            IsQualityActive.Raw = true;
            IsQualityActive.Lookup = new Lookup<DbField>(IsQualityActive, "SubAktivitasLogbookPenerimaan", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasLogbookPenerimaan";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasLogbookPenerimaan type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Nama_Kapal.DbValue = row["Nama_Kapal"]; // Set DB value only
                ...
                Temperatur.DbValue = row["Temperatur"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasLogbookPenerimaanList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasLogbookPenerimaanView" => Language.Phrase("View"),
                "SubAktivitasLogbookPenerimaanEdit" => Language.Phrase("Edit"),
                "SubAktivitasLogbookPenerimaanAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasLogbookPenerimaanView",
                Config.ApiAddAction => "SubAktivitasLogbookPenerimaanAdd",
                Config.ApiEditAction => "SubAktivitasLogbookPenerimaanEdit",
                Config.ApiDeleteAction => "SubAktivitasLogbookPenerimaanDelete",
                Config.ApiListAction => "SubAktivitasLogbookPenerimaanList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasLogbookPenerimaanList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasLogbookPenerimaanView", parm);
            else
                url = KeyUrl("SubAktivitasLogbookPenerimaanView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasLogbookPenerimaanAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasLogbookPenerimaanAdd?" + parm;
            else
                url = "SubAktivitasLogbookPenerimaanAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLogbookPenerimaanEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLogbookPenerimaanList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLogbookPenerimaanAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLogbookPenerimaanList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasLogbookPenerimaanDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasLogbookPenerimaanList";
        ...
        public async Task RenderEditRow()
        {
            ...
            Nama_Kapal.EditValue = Nama_Kapal.CurrentValue;
            ...
            Temperatur.EditValue = Temperatur.CurrentValue;
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(Nama_Kapal);
                            ...
                            await doc.ExportField(Temperatur);
