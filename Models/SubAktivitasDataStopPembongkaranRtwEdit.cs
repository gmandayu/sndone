...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStopPembongkaranRtwEdit
    /// </summary>
    public static SubAktivitasDataStopPembongkaranRtwEdit subAktivitasDataStopPembongkaranRtwEdit
    {
        get => HttpData.Get<SubAktivitasDataStopPembongkaranRtwEdit>("subAktivitasDataStopPembongkaranRtwEdit")!;
        set => HttpData["subAktivitasDataStopPembongkaranRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStopPembongkaranRTW
    /// </summary>
    public class SubAktivitasDataStopPembongkaranRtwEdit : SubAktivitasDataStopPembongkaranRtwEditBase
    {
        // Constructor
        public SubAktivitasDataStopPembongkaranRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStopPembongkaranRtwEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStopPembongkaranRtwEditBase : SubAktivitasDataStopPembongkaranRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStopPembongkaranRtwEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStopPembongkaranRtwEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStopPembongkaranRtwEdit?.PageRender();
                    }
        }
