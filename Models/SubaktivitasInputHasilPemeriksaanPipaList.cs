...
public partial class SnDOne {
    ...
    public class SubaktivitasInputHasilPemeriksaanPipaListBase : SubaktivitasInputHasilPemeriksaanPipa
    {
        ...
        // Constructor
        public SubaktivitasInputHasilPemeriksaanPipaListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubaktivitasInputHasilPemeriksaanPipaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            if (filter.TryGetValue("x_QuantityDischarge", out sv)) {
                RestoreFieldFilter(QuantityDischarge, filter, "QuantityDischarge", sv);
            }
