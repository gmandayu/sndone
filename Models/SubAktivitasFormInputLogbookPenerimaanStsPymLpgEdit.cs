...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbookPenerimaanStsPymLpgEdit
    /// </summary>
    public static SubAktivitasFormInputLogbookPenerimaanStsPymLpgEdit subAktivitasFormInputLogbookPenerimaanStsPymLpgEdit
    {
        get => HttpData.Get<SubAktivitasFormInputLogbookPenerimaanStsPymLpgEdit>("subAktivitasFormInputLogbookPenerimaanStsPymLpgEdit")!;
        set => HttpData["subAktivitasFormInputLogbookPenerimaanStsPymLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbookPenerimaanSTSPymLPG
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanStsPymLpgEdit : SubAktivitasFormInputLogbookPenerimaanStsPymLpgEditBase
    {
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanStsPymLpgEditBase : SubAktivitasFormInputLogbookPenerimaanStsPymLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbookPenerimaanStsPymLpgEdit";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbookPenerimaanStsPymLpgEdit";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputLogbookPenerimaanStsPymLpgEdit?.PageRender();
                    }
        }
        ...
        private void ValidateCustomid() {
            if (id.Visible && id.Required) {
                if (!id.IsDetailKey && Empty(id.FormValue)) {
                    id.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
