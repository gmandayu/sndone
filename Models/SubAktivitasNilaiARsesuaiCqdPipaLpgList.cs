...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiARsesuaiCqdPipaLpgList
    /// </summary>
    public static SubAktivitasNilaiARsesuaiCqdPipaLpgList subAktivitasNilaiARsesuaiCqdPipaLpgList
    {
        get => HttpData.Get<SubAktivitasNilaiARsesuaiCqdPipaLpgList>("subAktivitasNilaiARsesuaiCqdPipaLpgList")!;
        set => HttpData["subAktivitasNilaiARsesuaiCqdPipaLpgList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiARsesuaiCQDPipaLPG
    /// </summary>
    public class SubAktivitasNilaiARsesuaiCqdPipaLpgList : SubAktivitasNilaiARsesuaiCqdPipaLpgListBase
    {
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaLpgList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaLpgList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiARsesuaiCqdPipaLpgListBase : SubAktivitasNilaiARsesuaiCqdPipaLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiARsesuaiCqdPipaLpgList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasNilaiARsesuaiCQDPipaLPGlist";
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaLpgListBase()
        {
            TableName = "SubAktivitasNilaiARsesuaiCQDPipaLPG";

            // CSS class name as context
            TableVar = "SubAktivitasNilaiARsesuaiCQDPipaLPG";
            ...
            // Table object (subAktivitasNilaiARsesuaiCqdPipaLpg)
            if (subAktivitasNilaiARsesuaiCqdPipaLpg == null || subAktivitasNilaiARsesuaiCqdPipaLpg is SubAktivitasNilaiARsesuaiCqdPipaLpg)
                subAktivitasNilaiARsesuaiCqdPipaLpg = this;

            // Initialize URLs
            AddUrl = "SubAktivitasNilaiARsesuaiCqdPipaLpgAdd";
            ...
            MultiDeleteUrl = "SubAktivitasNilaiARsesuaiCqdPipaLpgDelete";
            MultiUpdateUrl = "SubAktivitasNilaiARsesuaiCqdPipaLpgUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiARsesuaiCqdPipaLpgList";
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaLpgListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasNilaiARsesuaiCqdPipaLpgView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasNilaiARsesuaiCQDPipaLPGgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiARsesuaiCqdPipaLpgList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasNilaiARsesuaiCQDPipaLPG"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasNilaiARsesuaiCQDPipaLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasNilaiARsesuaiCQDPipaLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasNilaiARsesuaiCQDPipaLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasNilaiARsesuaiCQDPipaLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasNilaiARsesuaiCQDPipaLPGlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasNilaiARsesuaiCQDPipaLPG");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasNilaiARsesuaiCqdPipaLpgList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasNilaiARsesuaiCqdPipaLpgList.RowCount) + "_SubAktivitasNilaiARsesuaiCQDPipaLPG");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasNilaiARsesuaiCqdPipaLpgList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasNilaiARsesuaiCqdPipaLpgList.RowType == RowType.Add || IsEdit && subAktivitasNilaiARsesuaiCqdPipaLpgList.RowType == RowType.Edit) // Inline-Add/Edit row
