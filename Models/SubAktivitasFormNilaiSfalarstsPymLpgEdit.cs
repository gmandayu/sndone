...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormNilaiSfalarstsPymLpgEdit
    /// </summary>
    public static SubAktivitasFormNilaiSfalarstsPymLpgEdit subAktivitasFormNilaiSfalarstsPymLpgEdit
    {
        get => HttpData.Get<SubAktivitasFormNilaiSfalarstsPymLpgEdit>("subAktivitasFormNilaiSfalarstsPymLpgEdit")!;
        set => HttpData["subAktivitasFormNilaiSfalarstsPymLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormNilaiSFALARSTSPymLPG
    /// </summary>
    public class SubAktivitasFormNilaiSfalarstsPymLpgEdit : SubAktivitasFormNilaiSfalarstsPymLpgEditBase
    {
        // Constructor
        public SubAktivitasFormNilaiSfalarstsPymLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormNilaiSfalarstsPymLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormNilaiSfalarstsPymLpgEditBase : SubAktivitasFormNilaiSfalarstsPymLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormNilaiSfalarstsPymLpgEdit";
        ...
        // Constructor
        public SubAktivitasFormNilaiSfalarstsPymLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormNilaiSfalarstsPymLpgEdit";
        ...
        // Constructor
        public SubAktivitasFormNilaiSfalarstsPymLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormNilaiSfalarstsPymLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormNilaiSfalarstsPymLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormNilaiSfalarstsPymLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormNilaiSfalarstsPymLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormNilaiSfalarstsPymLpgList")), "", TableVar, true);
            string pageId = "edit";
