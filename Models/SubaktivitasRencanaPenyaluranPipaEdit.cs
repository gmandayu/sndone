...
public partial class SnDOne {
    ...
    public class SubaktivitasRencanaPenyaluranPipaEditBase : SubaktivitasRencanaPenyaluranPipa
    {
        ...
        // Constructor
        public SubaktivitasRencanaPenyaluranPipaEditBase()
        {
        ...
        // Constructor
        public SubaktivitasRencanaPenyaluranPipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasRencanaPenyaluranPipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasRencanaPenyaluranPipaList") {
                                ...
                                returnUrl = "SubaktivitasRencanaPenyaluranPipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'RencanaPenyaluran' before field var 'x_RencanaPenyaluran2'
            val = CurrentForm.HasValue("RencanaPenyaluran") ? CurrentForm.GetValue("RencanaPenyaluran") : CurrentForm.GetValue("x_RencanaPenyaluran2");
            if (!RencanaPenyaluran2.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("RencanaPenyaluran") && !CurrentForm.HasValue("x_RencanaPenyaluran2")) // DN
                    RencanaPenyaluran2.Visible = false; // Disable update for API request
                else
                    RencanaPenyaluran2.SetFormValue(val);
            }
            ...
            bool validateForm = true;
                ...
                if (RencanaPenyaluran2.Visible && RencanaPenyaluran2.Required) {
                    if (!RencanaPenyaluran2.IsDetailKey && Empty(RencanaPenyaluran2.FormValue)) {
                        RencanaPenyaluran2.AddErrorMessage(ConvertToString(RencanaPenyaluran2.RequiredErrorMessage).Replace("%s", RencanaPenyaluran2.Caption));
                    }
                }
