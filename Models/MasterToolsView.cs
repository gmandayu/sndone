...
public partial class SnDOne {
    ...
    public class MasterToolsViewBase : MasterTools
    {
        ...
        // Constructor
        public MasterToolsViewBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterToolsViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdTools", out v) && !Empty(v))
                {
                IdTools.QueryValue = UrlDecode(v);
                RecordKeys["IdTools"] = IdTools.QueryValue;
                return;
                }
                if (Get("IdTools", out sv))
                {
