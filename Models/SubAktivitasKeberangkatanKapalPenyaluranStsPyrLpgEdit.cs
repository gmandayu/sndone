...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit
    /// </summary>
    public static SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit subAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit
    {
        get => HttpData.Get<SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit>("subAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit")!;
        set => HttpData["subAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasKeberangkatanKapalPenyaluranSTSPyrLPG
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit : SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEditBase
    {
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEditBase : SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasKeberangkatanKapalPenyaluranStsPyrLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void ValidateCustomStatusAktivitas() {
            if (StatusAktivitas.Visible && StatusAktivitas.Required) {
                if (!StatusAktivitas.IsDetailKey && Empty(StatusAktivitas.FormValue)) {
                    StatusAktivitas.AddErrorMessage(ConvertToString(Tanggal.RequiredErrorMessage).Replace("%s", Tanggal.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasKeberangkatanKapalPenyaluranStsPyrLpgList")), "", TableVar, true);
            string pageId = "edit";
