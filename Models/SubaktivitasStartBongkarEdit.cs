...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasStartBongkarEdit
    /// </summary>
    public static SubaktivitasStartBongkarEdit subaktivitasStartBongkarEdit
    {
        get => HttpData.Get<SubaktivitasStartBongkarEdit>("subaktivitasStartBongkarEdit")!;
        set => HttpData["subaktivitasStartBongkarEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasStartBongkar
    /// </summary>
    public class SubaktivitasStartBongkarEdit : SubaktivitasStartBongkarEditBase
    {
        // Constructor
        public SubaktivitasStartBongkarEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasStartBongkarEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasStartBongkarEditBase : SubaktivitasStartBongkar
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasStartBongkarEdit";
        ...
        // Constructor
        public SubaktivitasStartBongkarEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasStartBongkarEdit";
        ...
        // Constructor
        public SubaktivitasStartBongkarEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasStartBongkarList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasStartBongkarList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasStartBongkarList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasStartBongkarEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasStartBongkarList")), "", TableVar, true);
            string pageId = "edit";
