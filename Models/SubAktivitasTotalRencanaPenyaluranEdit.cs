...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasTotalRencanaPenyaluranEdit
    /// </summary>
    public static SubAktivitasTotalRencanaPenyaluranEdit subAktivitasTotalRencanaPenyaluranEdit
    {
        get => HttpData.Get<SubAktivitasTotalRencanaPenyaluranEdit>("subAktivitasTotalRencanaPenyaluranEdit")!;
        set => HttpData["subAktivitasTotalRencanaPenyaluranEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasTotalRencanaPenyaluran
    /// </summary>
    public class SubAktivitasTotalRencanaPenyaluranEdit : SubAktivitasTotalRencanaPenyaluranEditBase
    {
        // Constructor
        public SubAktivitasTotalRencanaPenyaluranEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasTotalRencanaPenyaluranEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasTotalRencanaPenyaluranEditBase : SubAktivitasTotalRencanaPenyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasTotalRencanaPenyaluranEdit";
        ...
        // Constructor
        public SubAktivitasTotalRencanaPenyaluranEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasTotalRencanaPenyaluranEdit";
        ...
        // Constructor
        public SubAktivitasTotalRencanaPenyaluranEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasTotalRencanaPenyaluranList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasTotalRencanaPenyaluranList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasTotalRencanaPenyaluranList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasTotalRencanaPenyaluranEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'RencanaPenyaluranKL'
            RencanaPenyaluranKL.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(RencanaPenyaluranKL, "RencanaPenyaluranKL", "x_RencanaPenyaluranKL");
        ...
        public void RestoreFormValues()
        {
            ...
            RencanaPenyaluranKL.CurrentValue = RencanaPenyaluranKL.FormValue;
        ...
        public async Task RenderRow()
        {
            ...
            // RencanaPenyaluranKL
            RencanaPenyaluranKL.RowCssClass = "row";
            ...
            if (RowType == RowType.View) {
                ...
                RencanaPenyaluranKL.EditValue = HtmlEncode(RencanaPenyaluranKL.CurrentValue);
        ...
        private void ValidateCustomTanggalJam() {
            if (TanggalJam.Visible && TanggalJam.Required) {
                if (!TanggalJam.IsDetailKey && Empty(TanggalJam.FormValue)) {
                    TanggalJam.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustomRencanaPenyaluranKL() {
            if (RencanaPenyaluranKL.Visible && RencanaPenyaluranKL.Required) {
                if (!RencanaPenyaluranKL.IsDetailKey && Empty(RencanaPenyaluranKL.FormValue)) {
                    RencanaPenyaluranKL.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ...
                ValidateCustomRencanaPenyaluranKL();
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // RencanaPenyaluranKL
            RencanaPenyaluranKL.SetDbValue(rsnew, RencanaPenyaluranKL.CurrentValue, RencanaPenyaluranKL.ReadOnly);
        ...
        protected void RestoreEditFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("RencanaPenyaluranKL", out value)) // RencanaPenyaluranKL
                RencanaPenyaluranKL.CurrentValue = value;
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasTotalRencanaPenyaluranList")), "", TableVar, true);
            string pageId = "edit";
