...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasKeberangkatanKapalPenyaluranLpgEdit
    /// </summary>
    public static SubAktivitasKeberangkatanKapalPenyaluranLpgEdit subAktivitasKeberangkatanKapalPenyaluranLpgEdit
    {
        get => HttpData.Get<SubAktivitasKeberangkatanKapalPenyaluranLpgEdit>("subAktivitasKeberangkatanKapalPenyaluranLpgEdit")!;
        set => HttpData["subAktivitasKeberangkatanKapalPenyaluranLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasKeberangkatanKapalPenyaluranLPG
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenyaluranLpgEdit : SubAktivitasKeberangkatanKapalPenyaluranLpgEditBase
    {
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenyaluranLpgEditBase : SubAktivitasKeberangkatanKapalPenyaluranLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasKeberangkatanKapalPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasKeberangkatanKapalPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasKeberangkatanKapalPenyaluranLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanKapalPenyaluranLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasKeberangkatanKapalPenyaluranLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasKeberangkatanKapalPenyaluranLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasKeberangkatanKapalPenyaluranLpgList")), "", TableVar, true);
            string pageId = "edit";
