...
public partial class SnDOne {
    ...
    public class ProofOfVisitViewBase : ProofOfVisit
    {
        ...
        // Constructor
        public ProofOfVisitViewBase(Controller? controller)
        {
        ...
        // Constructor
        public ProofOfVisitViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdProofOfVisit", out v) && !Empty(v))
                {
                IdProofOfVisit.QueryValue = UrlDecode(v);
                RecordKeys["IdProofOfVisit"] = IdProofOfVisit.QueryValue;
                return;
                }
                if (Get("IdProofOfVisit", out sv))
                {
