...
public partial class SnDOne {
    ...
    public class SubaktivitasNilaiSfblstsPymBbmEditBase : SubaktivitasNilaiSfblstsPymBbm
    {
        ...
        // Constructor
        public SubaktivitasNilaiSfblstsPymBbmEditBase()
        {
        ...
        // Constructor
        public SubaktivitasNilaiSfblstsPymBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasNilaiSfblstsPymBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasNilaiSfblstsPymBbmList") {
                                ...
                                returnUrl = "SubaktivitasNilaiSfblstsPymBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
