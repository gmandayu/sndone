...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputBLsesuaiCqlrtwListBase : SubAktivitasFormInputBLsesuaiCqlrtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputBLsesuaiCqlrtwListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasFormInputBLsesuaiCqlrtwListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field ML
            if (filter.TryGetValue("x_ML", out sv)) {
                RestoreFieldFilter(ML, filter, "ML", sv);
            }
