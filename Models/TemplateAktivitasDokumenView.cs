...
public partial class SnDOne {
    ...
    public class TemplateAktivitasDokumenViewBase : TemplateAktivitasDokumen
    {
        ...
        // Constructor
        public TemplateAktivitasDokumenViewBase(Controller? controller)
        {
        ...
        // Constructor
        public TemplateAktivitasDokumenViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdTemplateAktivitasDokumen", out v) && !Empty(v))
                {
                IdTemplateAktivitasDokumen.QueryValue = UrlDecode(v);
                RecordKeys["IdTemplateAktivitasDokumen"] = IdTemplateAktivitasDokumen.QueryValue;
                return;
                }
                if (Get("IdTemplateAktivitasDokumen", out sv))
                {
            ...
            if (!loadCurrentRecord)
                returnUrl = "TemplateAktivitasDokumenList";
        }
