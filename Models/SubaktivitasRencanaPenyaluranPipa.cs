...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasRencanaPenyaluranPipa
    /// </summary>
    [MaybeNull]
    public static SubaktivitasRencanaPenyaluranPipa subaktivitasRencanaPenyaluranPipa
    {
        get => HttpData.Resolve<SubaktivitasRencanaPenyaluranPipa>("SubaktivitasRencanaPenyaluranPipa");
        set => HttpData["SubaktivitasRencanaPenyaluranPipa"] = value;
    }

    /// <summary>
    /// Table class for SubaktivitasRencanaPenyaluranPipa
    /// </summary>
    public class SubaktivitasRencanaPenyaluranPipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> RencanaPenyaluran2;
        ...
        // Constructor
        public SubaktivitasRencanaPenyaluranPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubaktivitasRencanaPenyaluranPipa";
            Name = "SubaktivitasRencanaPenyaluranPipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubaktivitasRencanaPenyaluranPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasRencanaPenyaluranPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasRencanaPenyaluranPipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalJam = new(this, "x_TanggalJam", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasRencanaPenyaluranPipa", "TanggalJam", "CustomMsg"),
                IsUpload = false
            };
            TanggalJam.Raw = true;
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasRencanaPenyaluranPipa", "Produk", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Produk", Produk);

            // RencanaPenyaluran
            RencanaPenyaluran2 = new(this, "x_RencanaPenyaluran2", 202, SqlDbType.NVarChar) {
                Name = "RencanaPenyaluran",
                Expression = "[RencanaPenyaluran]",
                UseBasicSearch = true,
                BasicSearchExpression = "[RencanaPenyaluran]",
                DateTimeFormat = -1,
                VirtualExpression = "[RencanaPenyaluran]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasRencanaPenyaluranPipa", "RencanaPenyaluran2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("RencanaPenyaluran", RencanaPenyaluran2);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasRencanaPenyaluranPipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasRencanaPenyaluranPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasRencanaPenyaluranPipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasRencanaPenyaluranPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasRencanaPenyaluranPipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasRencanaPenyaluranPipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubaktivitasRencanaPenyaluranPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubaktivitasRencanaPenyaluranPipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                RencanaPenyaluran2.DbValue = row["RencanaPenyaluran"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubaktivitasRencanaPenyaluranPipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubaktivitasRencanaPenyaluranPipaView" => Language.Phrase("View"),
                "SubaktivitasRencanaPenyaluranPipaEdit" => Language.Phrase("Edit"),
                "SubaktivitasRencanaPenyaluranPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubaktivitasRencanaPenyaluranPipaView",
                Config.ApiAddAction => "SubaktivitasRencanaPenyaluranPipaAdd",
                Config.ApiEditAction => "SubaktivitasRencanaPenyaluranPipaEdit",
                Config.ApiDeleteAction => "SubaktivitasRencanaPenyaluranPipaDelete",
                Config.ApiListAction => "SubaktivitasRencanaPenyaluranPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubaktivitasRencanaPenyaluranPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubaktivitasRencanaPenyaluranPipaView", parm);
            else
                url = KeyUrl("SubaktivitasRencanaPenyaluranPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubaktivitasRencanaPenyaluranPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubaktivitasRencanaPenyaluranPipaAdd?" + parm;
            else
                url = "SubaktivitasRencanaPenyaluranPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasRencanaPenyaluranPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasRencanaPenyaluranPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasRencanaPenyaluranPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasRencanaPenyaluranPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubaktivitasRencanaPenyaluranPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubaktivitasRencanaPenyaluranPipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            RencanaPenyaluran2.EditValue = RencanaPenyaluran2.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(RencanaPenyaluran2);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(RencanaPenyaluran2);
