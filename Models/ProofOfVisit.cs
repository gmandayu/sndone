...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static ProofOfVisit proofOfVisit
    {
        get => HttpData.Resolve<ProofOfVisit>("ProofOfVisit");
        set => HttpData["ProofOfVisit"] = value;
    }

    /// <summary>
    /// Table class for ProofOfVisit
    /// </summary>
    public class ProofOfVisit : DbTable
    {
        public override Dictionary<string, string> KeyFields { get; set; } = new() { // DN
            { "IdProofOfVisit", "IdProofOfVisit" },
        };
        ...
        public readonly DbField<SqlDbType> IdProofOfVisit;

        public readonly DbField<SqlDbType> NomorProofOfVisit;
        ...
        public readonly DbField<SqlDbType> JumlahKetidaksesuaiaan;

        public readonly DbField<SqlDbType> TotalPengisian;
        ...
        public ProofOfVisit()
        {
            ...
            TableVar = "ProofOfVisit";
            Name = "ProofOfVisit";
            Type = "TABLE";
            UpdateTable = "dbo.ProofOfVisit"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // IdProofOfVisit
            IdProofOfVisit = new(this, "x_IdProofOfVisit", 3, SqlDbType.Int) {
                Name = "IdProofOfVisit",
                Expression = "[IdProofOfVisit]",
                BasicSearchExpression = "CAST([IdProofOfVisit] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[IdProofOfVisit]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "IdProofOfVisit", "CustomMsg"),
                IsUpload = false
            };
            IdProofOfVisit.Raw = true;
            Fields.Add("IdProofOfVisit", IdProofOfVisit);

            // NomorProofOfVisit
            NomorProofOfVisit = new(this, "x_NomorProofOfVisit", 202, SqlDbType.NVarChar) {
                Name = "NomorProofOfVisit",
                Expression = "[NomorProofOfVisit]",
                BasicSearchExpression = "[NomorProofOfVisit]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorProofOfVisit]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "NomorProofOfVisit", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NomorProofOfVisit", NomorProofOfVisit);

            // LinkRedirect
            LinkRedirect = new(this, "x_LinkRedirect", 202, SqlDbType.NVarChar) {
                Name = "LinkRedirect",
                Expression = "'<a href=FormInputProofOfVisitList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorProofOfVisit AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorProofOfVisit AS NVARCHAR(50))+'</a>'",
                UseBasicSearch = true,
                BasicSearchExpression = "'<a href=FormInputProofOfVisitList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorProofOfVisit AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorProofOfVisit AS NVARCHAR(50))+'</a>'",
                DateTimeFormat = -1,
                VirtualExpression = "'<a href=FormInputProofOfVisitList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorProofOfVisit AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorProofOfVisit AS NVARCHAR(50))+'</a>'",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "LinkRedirect", "CustomMsg"),
                IsUpload = false
            };
            LinkRedirect.Lookup = new Lookup<DbField>(LinkRedirect, "ProofOfVisit", true, "LinkRedirect", new List<string> {"LinkRedirect", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LookupPlant = new(this, "x_LookupPlant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "LookupPlant", "CustomMsg"),
                IsUpload = false
            };
            LookupPlant.Raw = true;
            LookupPlant.Lookup = new Lookup<DbField>(LookupPlant, "ProofOfVisit", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Plant = new(this, "x_Plant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "Plant", "CustomMsg"),
                IsUpload = false
            };
            Plant.Raw = true;
            ...
            JumlahKetidaksesuaiaan = new(this, "x_JumlahKetidaksesuaiaan", 202, SqlDbType.NVarChar) {
                Name = "JumlahKetidaksesuaiaan",
                Expression = "[JumlahKetidaksesuaiaan]",
                UseBasicSearch = true,
                BasicSearchExpression = "[JumlahKetidaksesuaiaan]",
                DateTimeFormat = -1,
                VirtualExpression = "[JumlahKetidaksesuaiaan]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "JumlahKetidaksesuaiaan", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("JumlahKetidaksesuaiaan", JumlahKetidaksesuaiaan);

            // TotalPengisian
            TotalPengisian = new(this, "x_TotalPengisian", 202, SqlDbType.NVarChar) {
                Name = "TotalPengisian",
                Expression = "[TotalPengisian]",
                UseBasicSearch = true,
                BasicSearchExpression = "[TotalPengisian]",
                DateTimeFormat = -1,
                VirtualExpression = "[TotalPengisian]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "TotalPengisian", "CustomMsg"),
                IsUpload = false
            };
            TotalPengisian.Lookup = new Lookup<DbField>(TotalPengisian, "ProofOfVisit", true, "TotalPengisian", new List<string> {"TotalPengisian", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("TotalPengisian", TotalPengisian);

            // Catatan
            Catatan = new(this, "x_Catatan", 203, SqlDbType.NText) {
                Name = "Catatan",
                Expression = "[Catatan]",
                UseBasicSearch = true,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "Catatan", "CustomMsg"),
                IsUpload = false
            };
            Catatan.Lookup = new Lookup<DbField>(Catatan, "ProofOfVisit", true, "Catatan", new List<string> {"Catatan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            DibuatOleh.Lookup = new Lookup<DbField>(DibuatOleh, "ProofOfVisit", true, "DibuatOleh", new List<string> {"DibuatOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                UseBasicSearch = true,
                BasicSearchExpression = CastDateFieldForLike("[TanggalDibuat]", 109, "DB"),
                DateTimeFormat = 109,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            DiperbaruiOleh.Lookup = new Lookup<DbField>(DiperbaruiOleh, "ProofOfVisit", true, "DiperbaruiOleh", new List<string> {"DiperbaruiOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            DiperbaruiOleh.GetAutoUpdateValue = () => CurrentUserName();
            DiperbaruiOleh.GetDefault = () => CurrentUserName();
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                UseBasicSearch = true,
                BasicSearchExpression = CastDateFieldForLike("[TanggalDiperbarui]", 109, "DB"),
                DateTimeFormat = 109,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ProofOfVisit", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiperbarui.Raw = true;
            TanggalDiperbarui.Lookup = new Lookup<DbField>(TanggalDiperbarui, "ProofOfVisit", true, "TanggalDiperbarui", new List<string> {"TanggalDiperbarui", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        {
            get {
                string select = "*, '<a href=FormInputProofOfVisitList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorProofOfVisit AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorProofOfVisit AS NVARCHAR(50))+'</a>' AS [LinkRedirect]";
                if (select == "*") {
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.ProofOfVisit type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdProofOfVisit"))
                    row["IdProofOfVisit"] = lastInsertedId;
                else
                    row.Add("IdProofOfVisit", lastInsertedId);
                IdProofOfVisit.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                IdProofOfVisit.DbValue = row["IdProofOfVisit"]; // Set DB value only
                NomorProofOfVisit.DbValue = row["NomorProofOfVisit"]; // Set DB value only
                ...
                JumlahKetidaksesuaiaan.DbValue = row["JumlahKetidaksesuaiaan"]; // Set DB value only
                TotalPengisian.DbValue = row["TotalPengisian"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[IdProofOfVisit] = @IdProofOfVisit@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "ProofOfVisitView" => Language.Phrase("View"),
                "ProofOfVisitEdit" => Language.Phrase("Edit"),
                "ProofOfVisitAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "ProofOfVisitView",
                Config.ApiAddAction => "ProofOfVisitAdd",
                Config.ApiEditAction => "ProofOfVisitEdit",
                Config.ApiDeleteAction => "ProofOfVisitDelete",
                Config.ApiListAction => "ProofOfVisitList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "ProofOfVisitList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("ProofOfVisitView", parm);
            else
                url = KeyUrl("ProofOfVisitView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "ProofOfVisitAdd";
        ...
        {
            string url = "";
            url = KeyUrl("ProofOfVisitEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("ProofOfVisitList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("ProofOfVisitAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("ProofOfVisitList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("ProofOfVisitDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdProofOfVisit\":" + ConvertToJson(IdProofOfVisit.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdProofOfVisit.CurrentValue)) {
                url += "/" + IdProofOfVisit.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdProofOfVisit", out object? v0)) { // IdProofOfVisit // DN
                    key = UrlDecode(v0); // DN
                } else if (IsApi() && !Empty(keyValues)) {
                    key = keyValues[0];
                } else {
                    key = Param("IdProofOfVisit");
                }
                keysList.Add(key);
            }
            // Check keys
            foreach (var keys in keysList) {
                if (KeyFields.Count > 1 && (!IsArray(keys) || keys.Length != KeyFields.Count))
                    continue;
                if (!IsNumeric(keys)) // IdProofOfVisit
                    continue;
                result.Add(keys);
            }
            return result;
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdProofOfVisit.CurrentValue = keys;
                else
                    IdProofOfVisit.OldValue = keys;
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            IdProofOfVisit.SetDbValue(row["IdProofOfVisit"]);
            NomorProofOfVisit.SetDbValue(row["NomorProofOfVisit"]);
            LinkRedirect.SetDbValue(row["LinkRedirect"]);
            LookupPlant.SetDbValue(row["LookupPlant"]);
            Plant.SetDbValue(row["Plant"]);
            JumlahKetidaksesuaiaan.SetDbValue(row["JumlahKetidaksesuaiaan"]);
            TotalPengisian.SetDbValue(row["TotalPengisian"]);
        ...
        {
            string pageName = "ProofOfVisitList";
        ...
        public async Task RenderListRow()
        {
            ...
            // LinkRedirect
            LinkRedirect.CellCssStyle = "white-space: nowrap;";
            ...
            // IdProofOfVisit
            IdProofOfVisit.ViewValue = IdProofOfVisit.CurrentValue;
            IdProofOfVisit.ViewCustomAttributes = "";

            // NomorProofOfVisit
            NomorProofOfVisit.ViewValue = ConvertToString(NomorProofOfVisit.CurrentValue); // DN
            NomorProofOfVisit.ViewCustomAttributes = "";
            ...
            // JumlahKetidaksesuaiaan
            JumlahKetidaksesuaiaan.ViewValue = ConvertToString(JumlahKetidaksesuaiaan.CurrentValue); // DN
            JumlahKetidaksesuaiaan.ViewCustomAttributes = "";

            // TotalPengisian
            TotalPengisian.ViewValue = ConvertToString(TotalPengisian.CurrentValue); // DN
            TotalPengisian.ViewCustomAttributes = "";
            ...
            // IdProofOfVisit
            IdProofOfVisit.HrefValue = "";
            IdProofOfVisit.TooltipValue = "";

            // NomorProofOfVisit
            NomorProofOfVisit.HrefValue = "";
            NomorProofOfVisit.TooltipValue = "";
            ...
            // JumlahKetidaksesuaiaan
            JumlahKetidaksesuaiaan.HrefValue = "";
            JumlahKetidaksesuaiaan.TooltipValue = "";

            // TotalPengisian
            TotalPengisian.HrefValue = "";
            TotalPengisian.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // IdProofOfVisit
            IdProofOfVisit.SetupEditAttributes();
            IdProofOfVisit.EditValue = IdProofOfVisit.CurrentValue;
            IdProofOfVisit.ViewCustomAttributes = "";

            // NomorProofOfVisit
            NomorProofOfVisit.SetupEditAttributes();
            NomorProofOfVisit.EditValue = ConvertToString(NomorProofOfVisit.CurrentValue); // DN
            NomorProofOfVisit.ViewCustomAttributes = "";
            ...
            // JumlahKetidaksesuaiaan
            JumlahKetidaksesuaiaan.SetupEditAttributes();
            if (!JumlahKetidaksesuaiaan.Raw)
                JumlahKetidaksesuaiaan.CurrentValue = HtmlDecode(JumlahKetidaksesuaiaan.CurrentValue);
            JumlahKetidaksesuaiaan.EditValue = JumlahKetidaksesuaiaan.CurrentValue;
            JumlahKetidaksesuaiaan.PlaceHolder = RemoveHtml(JumlahKetidaksesuaiaan.Caption);

            // TotalPengisian
            TotalPengisian.SetupEditAttributes();
            if (!TotalPengisian.Raw)
                TotalPengisian.CurrentValue = HtmlDecode(TotalPengisian.CurrentValue);
            TotalPengisian.EditValue = TotalPengisian.CurrentValue;
            TotalPengisian.PlaceHolder = RemoveHtml(TotalPengisian.Caption);
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(IdProofOfVisit);
                        doc.ExportCaption(NomorProofOfVisit);
                        doc.ExportCaption(LinkRedirect);
                        doc.ExportCaption(LookupPlant);
                        doc.ExportCaption(Plant);
                        doc.ExportCaption(JumlahKetidaksesuaiaan);
                        doc.ExportCaption(TotalPengisian);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(IdProofOfVisit);
                            await doc.ExportField(NomorProofOfVisit);
                            await doc.ExportField(LinkRedirect);
                            await doc.ExportField(LookupPlant);
                            await doc.ExportField(Plant);
                            await doc.ExportField(JumlahKetidaksesuaiaan);
                            await doc.ExportField(TotalPengisian);
        ...
        public void RecordsetSelecting(ref string filter) {
            ...
            Console.WriteLine("User Level: " + currentUser.ToString());
            ...
            if (currentUser == "4")
            {
                ...
                if (!string.IsNullOrEmpty(currentUserName)){
                    ...
                    ) OR NomorProofOfVisit IN (Select Distinct NoReferensi From FormInputProofOfVisit where userInput = '{currentUserName}')
                ";
                }
            ...
            if (!string.IsNullOrEmpty(currentUserName)){
                AddFilter(ref filter, $"Plant IN (SELECT IdPlant FROM MappingPosition WHERE IdPosition = {idPosition}) OR NomorProofOfVisit IN (Select Distinct NoReferensi From FormInputProofOfVisit where userInput = '{currentUserName}')");
            } else {
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew)
        {
            ...
            {
                // ========================
                // 1. Ambil & validasi Plant (field kebenaran)
                // ========================
                object? plantValue = null;
                if (rsnew.ContainsKey("Plant") && !string.IsNullOrWhiteSpace(rsnew["Plant"]?.ToString()))
                    plantValue = rsnew["Plant"];
                else if (rsnew.ContainsKey("LookupPlant") && !string.IsNullOrWhiteSpace(rsnew["LookupPlant"]?.ToString()))
                    plantValue = rsnew["LookupPlant"];
                if (plantValue == null || !int.TryParse(plantValue.ToString(), out int plantId))
                {
                    CancelMessage = "Plant tidak boleh kosong atau tidak valid.";
                    return false;
                }

                // Paksa field asli terisi
                rsnew["Plant"] = plantId;

                // ========================
                // 2. Ambil waktu lokal plant
                // ========================
                DateTime plantTime = DateTime.Now;
                var plantTimeObj = ExecuteScalar(
                    "EXEC dbo.GetPlantDateTime @IdPlant = @IdPlant",
                    new { IdPlant = plantId }
                );
                if (plantTimeObj != null && DateTime.TryParse(plantTimeObj.ToString(), out var parsedPlantTime))
                    plantTime = parsedPlantTime;

                // ========================
                // 3. Validasi duplicate
                //    1 Plant = 1 POV / hari (plant time)
                //    FIELD KEBENARAN: Plant
                // ========================
                ...
                var duplicateCountObj = ExecuteScalar(
                    checkDuplicateSql,
                    new
                    {
                        PlantId = plantId,
                ...
                int duplicateCount = duplicateCountObj != null && duplicateCountObj != DBNull.Value
                    ? Convert.ToInt32(duplicateCountObj)
                    : 0;
                if (duplicateCount > 0)
                {
                    CancelMessage = $"Sudah ada Proof of Visit untuk Plant ini pada tanggal {plantTime:dd-MM-yyyy}.";
                    return false;
                }

                // ========================
                // 4. Generate Nomor POV
                // ========================
                var nomorObj = ExecuteScalar(
                    "EXEC dbo.GenerateNomorProofOfVisit @IdPlant = @IdPlant",
                    new { IdPlant = plantId }
                );
                if (nomorObj == null || string.IsNullOrWhiteSpace(nomorObj.ToString()))
                    throw new Exception("Gagal menghasilkan Nomor Proof Of Visit.");
                rsnew["NomorProofOfVisit"] = nomorObj.ToString();
            ...
            {
                Log("Error in ProofOfVisit Row_Inserting: " + ex);
                CancelMessage = "Gagal menyimpan data Proof of Visit.";
                return false;
            }
        }
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            try {
                // Ambil IdPlant; jika tidak diubah, gunakan nilai lama
                var idPlant = rsnew.ContainsKey("Plant")
                    ? rsnew["Plant"].ToString()
                    : rsold["Plant"].ToString();
                ...
                Log("Error in ProofOfVisit Row_Updating: " + ex.Message);
        ...
        public bool RowDeleting(Dictionary<string, object> rs) {
            string NoReferensi = rs.ContainsKey("NomorProofOfVisit") ? rs["NomorProofOfVisit"].ToString() : "";
            if (string.IsNullOrEmpty(NoReferensi)) {
                SuccessMessage = "Data Proof of Visit berhasil dihapus, namun gagal menghapus data Form Input Proof of Visit";
                return true;
            }
            using (SqlConnection sqlConnection = GetConnection("Db").OpenConnection()) {
                string sqlData = "DELETE FROM FormInputProofOfVisit WHERE NoReferensi = @NoReferensi;";
        ...
        public void RowRendered() {
           // Hanya ubah tampilan jika ada nilai
            // if (!Empty(Plant.CurrentValue))
            // {
            //     // Jalankan query sinkron untuk mendapatkan Nama_Terminal
            //     string sql = "SELECT Nama_Terminal FROM MasterPlant WHERE Plant = @p0";
            //     var conn = Connection; // koneksi default dari ASP.NET Maker
            //     string nama = Convert.ToString(conn.ExecuteScalar(sql, new { p0 = kode }));

            //     // Jika berhasil ditemukan, gabungkan kode dan nama
            //     if (!Empty(nama))
            //         Plant.ViewValue = $"{kode} - {nama}";
            // }
        }
