...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiBLnAlView
    /// </summary>
    public static SubAktivitasFormInputNilaiBLnAlView subAktivitasFormInputNilaiBLnAlView
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiBLnAlView>("subAktivitasFormInputNilaiBLnAlView")!;
        set => HttpData["subAktivitasFormInputNilaiBLnAlView"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiBLnAL
    /// </summary>
    public class SubAktivitasFormInputNilaiBLnAlView : SubAktivitasFormInputNilaiBLnAlViewBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiBLnAlView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiBLnAlView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiBLnAlViewBase : SubAktivitasFormInputNilaiBLnAl
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiBLnAlView";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLnAlViewBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiBLnAlView";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLnAlViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void PageRunEnd()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputNilaiBLnAlView?.PageRender();
            }
        }
