...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbookPenerimaanRtwEditBase : SubAktivitasFormInputLogbookPenerimaanRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputLogbookPenerimaanRtwList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputLogbookPenerimaanRtwList") {
                                ...
                                returnUrl = "SubAktivitasFormInputLogbookPenerimaanRtwList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'SubAktivitasFormInputHslPemeriksaanRTWId' before field var 'x_SubAktivitasFormInputHslPemeriksaanRTWId'
            val = CurrentForm.HasValue("SubAktivitasFormInputHslPemeriksaanRTWId") ? CurrentForm.GetValue("SubAktivitasFormInputHslPemeriksaanRTWId") : CurrentForm.GetValue("x_SubAktivitasFormInputHslPemeriksaanRTWId");
            if (!SubAktivitasFormInputHslPemeriksaanRTWId.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("SubAktivitasFormInputHslPemeriksaanRTWId") && !CurrentForm.HasValue("x_SubAktivitasFormInputHslPemeriksaanRTWId")) // DN
                    SubAktivitasFormInputHslPemeriksaanRTWId.Visible = false; // Disable update for API request
                else
                    SubAktivitasFormInputHslPemeriksaanRTWId.SetFormValue(val, true, validate);
            }
            ...
            bool validateForm = true;
                ...
                if (SubAktivitasFormInputHslPemeriksaanRTWId.Visible && SubAktivitasFormInputHslPemeriksaanRTWId.Required) {
                    if (!SubAktivitasFormInputHslPemeriksaanRTWId.IsDetailKey && Empty(SubAktivitasFormInputHslPemeriksaanRTWId.FormValue)) {
                        SubAktivitasFormInputHslPemeriksaanRTWId.AddErrorMessage(ConvertToString(SubAktivitasFormInputHslPemeriksaanRTWId.RequiredErrorMessage).Replace("%s", SubAktivitasFormInputHslPemeriksaanRTWId.Caption));
                    }
                }
