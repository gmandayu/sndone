...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataMobilTangkiView
    /// </summary>
    public static SubAktivitasFormInputDataMobilTangkiView subAktivitasFormInputDataMobilTangkiView
    {
        get => HttpData.Get<SubAktivitasFormInputDataMobilTangkiView>("subAktivitasFormInputDataMobilTangkiView")!;
        set => HttpData["subAktivitasFormInputDataMobilTangkiView"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataMobilTangki
    /// </summary>
    public class SubAktivitasFormInputDataMobilTangkiView : SubAktivitasFormInputDataMobilTangkiViewBase
    {
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataMobilTangkiView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataMobilTangkiViewBase : SubAktivitasFormInputDataMobilTangki
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataMobilTangkiView";
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiViewBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataMobilTangkiView";
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputDataMobilTangkiList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputDataMobilTangkiList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputDataMobilTangkiView?.PageRender();
            }
            return PageResult();
        }
