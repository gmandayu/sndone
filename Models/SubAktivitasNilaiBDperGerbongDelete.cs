...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiBDperGerbongDelete
    /// </summary>
    public static SubAktivitasNilaiBDperGerbongDelete subAktivitasNilaiBDperGerbongDelete
    {
        get => HttpData.Get<SubAktivitasNilaiBDperGerbongDelete>("subAktivitasNilaiBDperGerbongDelete")!;
        set => HttpData["subAktivitasNilaiBDperGerbongDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiBDperGerbong
    /// </summary>
    public class SubAktivitasNilaiBDperGerbongDelete : SubAktivitasNilaiBDperGerbongDeleteBase
    {
        // Constructor
        public SubAktivitasNilaiBDperGerbongDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiBDperGerbongDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiBDperGerbongDeleteBase : SubAktivitasNilaiBDperGerbong
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiBDperGerbongDelete";
        ...
        // Constructor
        public SubAktivitasNilaiBDperGerbongDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiBDperGerbongDelete";
        ...
        // Constructor
        public SubAktivitasNilaiBDperGerbongDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasNilaiBDperGerbongList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasNilaiBDperGerbongList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiBDperGerbongDelete?.PageRender();
            }
            return PageResult();
        }
