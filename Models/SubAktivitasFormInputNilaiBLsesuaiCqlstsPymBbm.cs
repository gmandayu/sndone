...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiBLsesuaiCqlstsPymBbm
    /// </summary>
    [MaybeNull]
    public static SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbm subAktivitasFormInputNilaiBLsesuaiCqlstsPymBbm
    {
        get => HttpData.Resolve<SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbm>("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM");
        set => HttpData["SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM
    /// </summary>
    public class SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbm : DbTable
    {
        ...
        public readonly DbField<SqlDbType> KL_Obs;

        public readonly DbField<SqlDbType> KL_15;

        public readonly DbField<SqlDbType> Barrels;

        public readonly DbField<SqlDbType> LT;

        public readonly DbField<SqlDbType> MT;

        public readonly DbField<SqlDbType> etlDate;

        public readonly DbField<SqlDbType> userInput;

        public readonly DbField<SqlDbType> SFAL_KL_Obs;

        public readonly DbField<SqlDbType> SFAL_KL_15;
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbm()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM";
            Name = "SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            // KL_Obs
            KL_Obs = new(this, "x_KL_Obs", 202, SqlDbType.NVarChar) {
                Name = "KL_Obs",
                Expression = "[KL_Obs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[KL_Obs]",
                DateTimeFormat = -1,
                VirtualExpression = "[KL_Obs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "KL_Obs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("KL_Obs", KL_Obs);

            // KL_15
            KL_15 = new(this, "x_KL_15", 202, SqlDbType.NVarChar) {
                Name = "KL_15",
                Expression = "[KL_15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[KL_15]",
                DateTimeFormat = -1,
                VirtualExpression = "[KL_15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "KL_15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("KL_15", KL_15);

            // Barrels
            Barrels = new(this, "x_Barrels", 202, SqlDbType.NVarChar) {
                Name = "Barrels",
                Expression = "[Barrels]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Barrels]",
                DateTimeFormat = -1,
                VirtualExpression = "[Barrels]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "Barrels", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Barrels", Barrels);

            // LT
            LT = new(this, "x_LT", 202, SqlDbType.NVarChar) {
                Name = "LT",
                Expression = "[LT]",
                UseBasicSearch = true,
                BasicSearchExpression = "[LT]",
                DateTimeFormat = -1,
                VirtualExpression = "[LT]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "LT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LT", LT);

            // MT
            MT = new(this, "x_MT", 202, SqlDbType.NVarChar) {
                Name = "MT",
                Expression = "[MT]",
                UseBasicSearch = true,
                BasicSearchExpression = "[MT]",
                DateTimeFormat = -1,
                VirtualExpression = "[MT]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "MT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("MT", MT);
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "userInput", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("userInput", userInput);

            // SFAL_KL_Obs
            SFAL_KL_Obs = new(this, "x_SFAL_KL_Obs", 202, SqlDbType.NVarChar) {
                Name = "SFAL_KL_Obs",
                Expression = "[SFAL_KL_Obs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAL_KL_Obs]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAL_KL_Obs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "SFAL_KL_Obs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAL_KL_Obs", SFAL_KL_Obs);

            // SFAL_KL_15
            SFAL_KL_15 = new(this, "x_SFAL_KL_15", 202, SqlDbType.NVarChar) {
                Name = "SFAL_KL_15",
                Expression = "[SFAL_KL_15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAL_KL_15]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAL_KL_15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "SFAL_KL_15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAL_KL_15", SFAL_KL_15);
            ...
            SFAL_Barrels = new(this, "x_SFAL_Barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "SFAL_Barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAL_LT = new(this, "x_SFAL_LT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "SFAL_LT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAL_MT = new(this, "x_SFAL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM", "SFAL_MT", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymBBM";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasFormInputNilaiBlsesuaiCqlstspymBbm type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                KL_Obs.DbValue = row["KL_Obs"]; // Set DB value only
                KL_15.DbValue = row["KL_15"]; // Set DB value only
                Barrels.DbValue = row["Barrels"]; // Set DB value only
                LT.DbValue = row["LT"]; // Set DB value only
                MT.DbValue = row["MT"]; // Set DB value only
                etlDate.DbValue = row["etlDate"]; // Set DB value only
                userInput.DbValue = row["userInput"]; // Set DB value only
                SFAL_KL_Obs.DbValue = row["SFAL_KL_Obs"]; // Set DB value only
                SFAL_KL_15.DbValue = row["SFAL_KL_15"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmView" => Language.Phrase("View"),
                "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmEdit" => Language.Phrase("Edit"),
                "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmView",
                Config.ApiAddAction => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmAdd",
                Config.ApiEditAction => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmEdit",
                Config.ApiDeleteAction => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmDelete",
                Config.ApiListAction => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmView", parm);
            else
                url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmAdd?" + parm;
            else
                url = "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmDelete", parm)); // DN
        }
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            ...
            SFAL_KL_Obs.SetDbValue(row["SFAL_KL_Obs"]);
            SFAL_KL_15.SetDbValue(row["SFAL_KL_15"]);
        ...
        {
            string pageName = "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymBbmList";
        ...
        public async Task RenderListRow()
        {
            ...
            // SFAL_KL_Obs
            SFAL_KL_Obs.ViewValue = ConvertToString(SFAL_KL_Obs.CurrentValue); // DN
            SFAL_KL_Obs.ViewCustomAttributes = "";

            // SFAL_KL_15
            SFAL_KL_15.ViewValue = ConvertToString(SFAL_KL_15.CurrentValue); // DN
            SFAL_KL_15.ViewCustomAttributes = "";
            ...
            // SFAL_KL_Obs
            SFAL_KL_Obs.HrefValue = "";
            SFAL_KL_Obs.TooltipValue = "";

            // SFAL_KL_15
            SFAL_KL_15.HrefValue = "";
            SFAL_KL_15.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            KL_Obs.EditValue = KL_Obs.CurrentValue;
            ...
            KL_15.EditValue = KL_15.CurrentValue;
            ...
            Barrels.EditValue = Barrels.CurrentValue;
            ...
            // SFAL_KL_Obs
            SFAL_KL_Obs.SetupEditAttributes();
            if (!SFAL_KL_Obs.Raw)
                SFAL_KL_Obs.CurrentValue = HtmlDecode(SFAL_KL_Obs.CurrentValue);
            SFAL_KL_Obs.EditValue = SFAL_KL_Obs.CurrentValue;
            SFAL_KL_Obs.PlaceHolder = RemoveHtml(SFAL_KL_Obs.Caption);

            // SFAL_KL_15
            SFAL_KL_15.SetupEditAttributes();
            if (!SFAL_KL_15.Raw)
                SFAL_KL_15.CurrentValue = HtmlDecode(SFAL_KL_15.CurrentValue);
            SFAL_KL_15.EditValue = SFAL_KL_15.CurrentValue;
            SFAL_KL_15.PlaceHolder = RemoveHtml(SFAL_KL_15.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(KL_Obs);
                        doc.ExportCaption(KL_15);
                        doc.ExportCaption(Barrels);
                        doc.ExportCaption(LT);
                        doc.ExportCaption(MT);
                        doc.ExportCaption(etlDate);
                        doc.ExportCaption(userInput);
                        doc.ExportCaption(SFAL_KL_Obs);
                        doc.ExportCaption(SFAL_KL_15);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(KL_Obs);
                            await doc.ExportField(KL_15);
                            await doc.ExportField(Barrels);
                            await doc.ExportField(LT);
                            await doc.ExportField(MT);
                            await doc.ExportField(etlDate);
                            await doc.ExportField(userInput);
                            await doc.ExportField(SFAL_KL_Obs);
                            await doc.ExportField(SFAL_KL_15);
