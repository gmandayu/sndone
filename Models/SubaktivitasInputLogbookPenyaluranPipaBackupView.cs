...
public partial class SnDOne {
    ...
    public class SubaktivitasInputLogbookPenyaluranPipaBackupViewBase : SubaktivitasInputLogbookPenyaluranPipaBackup
    {
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupViewBase()
        {
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubaktivitasInputLogbookPenyaluranPipaBackupList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubaktivitasInputLogbookPenyaluranPipaBackupList"); // Return to list page
                            }
                        }
                    break;
            }
