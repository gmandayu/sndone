...
public partial class SnDOne {
    ...
    public class MasterPositionAddBase : MasterPosition
    {
        ...
        // Constructor
        public MasterPositionAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MasterPositionList"); // No matching record, return to List page // DN
                    }
                    break;
