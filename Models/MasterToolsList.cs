...
public partial class SnDOne {
    ...
    public class MasterToolsListBase : MasterTools
    {
        ...
        // Constructor
        public MasterToolsListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public void ShowFilterList()
        {
            ...
            // Field NamaTools
            filter = QueryBuilderWhere("NamaTools");
            if (Empty(filter))
                BuildSearchSql(ref filter, NamaTools, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + NamaTools.Caption + "</span>" + captionSuffix + filter + "</div>";
            if (!Empty(BasicSearch.Keyword))
        ...
        protected void LoadSearchValues() {
            ...
            // NamaTools
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_NamaTools[]"))
