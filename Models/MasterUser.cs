...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static MasterUser masterUser
    {
        get => HttpData.Resolve<MasterUser>("MasterUser");
        set => HttpData["MasterUser"] = value;
    }

    /// <summary>
    /// Table class for MasterUser
    /// </summary>
    public class MasterUser : DbTable
    {
        ...
        public readonly DbField<SqlDbType> PasswordHash;

        public readonly DbField<SqlDbType> NamaLengkap;

        public readonly DbField<SqlDbType> _UserLevel;

        public readonly DbField<SqlDbType> Rule;
        ...
        public readonly DbField<SqlDbType> StatusAktif;
        ...
        public readonly DbField<SqlDbType> IsResetable;

        public readonly DbField<SqlDbType> IsVerify;
        ...
        public readonly DbField<SqlDbType> IdIdaman;

        public readonly DbField<SqlDbType> exception;
        ...
        public MasterUser()
        {
            ...
            Name = "MasterUser";
            Type = "TABLE";
            UpdateTable = "dbo.MasterUser"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdUser = new(this, "x_IdUser", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterUser", "IdUser", "CustomMsg"),
                IsUpload = false
            };
            IdUser.Raw = true;
            ...
            _Email = new(this, "x__Email", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MasterUser", "_Email", "CustomMsg"),
                IsUpload = false
            };
            _Email.Lookup = new Lookup<DbField>(_Email, "MasterUser", true, "Email", new List<string> {"Email", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            _Username = new(this, "x__Username", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MasterUser", "_Username", "CustomMsg"),
                IsUpload = false
            };
            _Username.Raw = true;
            _Username.Lookup = new Lookup<DbField>(_Username, "MasterUser", true, "Username", new List<string> {"Username", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Username", _Username);

            // PasswordHash
            PasswordHash = new(this, "x_PasswordHash", 200, SqlDbType.VarChar) {
                Name = "PasswordHash",
                Expression = "[PasswordHash]",
                BasicSearchExpression = "[PasswordHash]",
                DateTimeFormat = -1,
                VirtualExpression = "[PasswordHash]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MasterUser", "PasswordHash", "CustomMsg"),
                IsUpload = false
            };
            ...
            NamaLengkap = new(this, "x_NamaLengkap", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "NamaLengkap", "CustomMsg"),
                IsUpload = false
            };
            NamaLengkap.Lookup = new Lookup<DbField>(NamaLengkap, "MasterUser", true, "NamaLengkap", new List<string> {"NamaLengkap", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NamaLengkap", NamaLengkap);

            // UserLevel
            _UserLevel = new(this, "x__UserLevel", 3, SqlDbType.Int) {
                Name = "UserLevel",
                Expression = "[UserLevel]",
                UseBasicSearch = true,
                BasicSearchExpression = "CAST([UserLevel] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[UserLevel]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MasterUser", "_UserLevel", "CustomMsg"),
                IsUpload = false
            };
            _UserLevel.Raw = true;
            _UserLevel.Lookup = new Lookup<DbField>(_UserLevel, "UserLevels", true, "UserLevelID", new List<string> {"UserLevelName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[UserLevelName]");
            Fields.Add("UserLevel", _UserLevel);

            // Rule
            Rule = new(this, "x_Rule", 202, SqlDbType.NVarChar) {
                Name = "Rule",
                Expression = "[Rule]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Rule]",
                DateTimeFormat = -1,
                VirtualExpression = "[Rule]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "Rule", "CustomMsg"),
                IsUpload = false
            };
            Rule.Lookup = new Lookup<DbField>(Rule, "MasterPIC", true, "IdPIC", new List<string> {"NamaPIC", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[NamaPIC]");
            Fields.Add("Rule", Rule);
            ...
            IdPosition = new(this, "x_IdPosition", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterUser", "IdPosition", "CustomMsg"),
                IsUpload = false
            };
            IdPosition.Raw = true;
            ...
            Region = new(this, "x_Region", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterUser", "Region", "CustomMsg"),
                IsUpload = false
            };
            Region.Raw = true;
            Region.Lookup = new Lookup<DbField>(Region, "MasterRegion", true, "IdRegion", new List<string> {"Region", "", "", ""}, "", "", new List<string> {}, new List<string> {"x_Plant"}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[Region]");
            ...
            Plant = new(this, "x_Plant", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "Plant", "CustomMsg"),
                IsUpload = false
            };
            Plant.Raw = true;
            Plant.Lookup = new Lookup<DbField>(Plant, "MasterPlant", true, "IdPlant", new List<string> {"Plant", "Nama_Terminal", "", ""}, "", "", new List<string> {"x_Region"}, new List<string> {}, new List<string> {"Region"}, new List<string> {"x_Region"}, new List<string> {}, new List<string> {}, false, "", "", "CONCAT([Plant],'" + ValueSeparator(1, Plant) + "',[Nama_Terminal])");
            ...
            LookupPosition = new(this, "x_LookupPosition", 200, SqlDbType.VarChar) {
                ...
                OptionCount = 1,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "LookupPosition", "CustomMsg"),
                IsUpload = false
            };
            LookupPosition.Lookup = new Lookup<DbField>(LookupPosition, "MasterUser", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("LookupPosition", LookupPosition);

            // StatusAktif
            StatusAktif = new(this, "x_StatusAktif", 11, SqlDbType.Bit) {
                Name = "StatusAktif",
                Expression = "[StatusAktif]",
                BasicSearchExpression = "[StatusAktif]",
                DateTimeFormat = -1,
                VirtualExpression = "[StatusAktif]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "StatusAktif", "CustomMsg"),
                IsUpload = false
            };
            StatusAktif.Raw = true;
            StatusAktif.Lookup = new Lookup<DbField>(StatusAktif, "MasterUser", true, "StatusAktif", new List<string> {"StatusAktif", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            StatusAktif.UserValues = ["1"];
            StatusAktif.GetDefault = () => 1;
            Fields.Add("StatusAktif", StatusAktif);
            ...
            Keterangan = new(this, "x_Keterangan", 203, SqlDbType.NText) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            Keterangan.Lookup = new Lookup<DbField>(Keterangan, "MasterUser", true, "Keterangan", new List<string> {"Keterangan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            DibuatOleh.Lookup = new Lookup<DbField>(DibuatOleh, "MasterUser", true, "DibuatOleh", new List<string> {"DibuatOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            TanggalDibuat.Raw = true;
            TanggalDibuat.Lookup = new Lookup<DbField>(TanggalDibuat, "MasterUser", true, "TanggalDibuat", new List<string> {"TanggalDibuat", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            DiperbaruiOleh.Lookup = new Lookup<DbField>(DiperbaruiOleh, "MasterUser", true, "DiperbaruiOleh", new List<string> {"DiperbaruiOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiperbarui.Raw = true;
            TanggalDiperbarui.Lookup = new Lookup<DbField>(TanggalDiperbarui, "MasterUser", true, "TanggalDiperbarui", new List<string> {"TanggalDiperbarui", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("TanggalDiperbarui", TanggalDiperbarui);

            // IsResetable
            IsResetable = new(this, "x_IsResetable", 11, SqlDbType.Bit) {
                Name = "IsResetable",
                Expression = "[IsResetable]",
                BasicSearchExpression = "[IsResetable]",
                DateTimeFormat = -1,
                VirtualExpression = "[IsResetable]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "IsResetable", "CustomMsg"),
                IsUpload = false
            };
            IsResetable.Raw = true;
            IsResetable.Lookup = new Lookup<DbField>(IsResetable, "MasterUser", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            IsResetable.UserValues = ["1"];
            Fields.Add("IsResetable", IsResetable);

            // IsVerify
            IsVerify = new(this, "x_IsVerify", 11, SqlDbType.Bit) {
                Name = "IsVerify",
                Expression = "[IsVerify]",
                BasicSearchExpression = "[IsVerify]",
                DateTimeFormat = -1,
                VirtualExpression = "[IsVerify]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "IsVerify", "CustomMsg"),
                IsUpload = false
            };
            IsVerify.Raw = true;
            IsVerify.Lookup = new Lookup<DbField>(IsVerify, "MasterUser", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            IsVerify.UserValues = ["1"];
            Fields.Add("IsVerify", IsVerify);
            ...
            Face = new(this, "x_Face", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "Face", "CustomMsg"),
                IsUpload = false
            };
            ...
            AzurePersonId = new(this, "x_AzurePersonId", 72, SqlDbType.UniqueIdentifier) {
                ...
                CustomMessage = Language.FieldPhrase("MasterUser", "AzurePersonId", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalInputFace = new(this, "x_TanggalInputFace", 135, SqlDbType.DateTime) {
                ...
                BasicSearchExpression = CastDateFieldForLike("[TanggalInputFace]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "TanggalInputFace", "CustomMsg"),
                IsUpload = false
            };
            ...
            UserInputFace = new(this, "x_UserInputFace", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "UserInputFace", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("UserInputFace", UserInputFace);

            // IdIdaman
            IdIdaman = new(this, "x_IdIdaman", 202, SqlDbType.NVarChar) {
                Name = "IdIdaman",
                Expression = "[IdIdaman]",
                BasicSearchExpression = "[IdIdaman]",
                DateTimeFormat = -1,
                VirtualExpression = "[IdIdaman]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "IdIdaman", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("IdIdaman", IdIdaman);

            // exception 
            exception = new(this, "x_exception", 11, SqlDbType.Bit) {
                Name = "exception ",
                Expression = "[exception ]",
                BasicSearchExpression = "[exception ]",
                DateTimeFormat = -1,
                VirtualExpression = "[exception ]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterUser", "exception", "CustomMsg"),
                IsUpload = false
            };
            exception.Raw = true;
            exception.Lookup = new Lookup<DbField>(exception, "MasterUser", true, "exception ", new List<string> {"exception ", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            exception.UserValues = ["1"];
        ...
        {
            get {
                string select = "*, '' AS [LookupPosition]";
                if (select == "*") {
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MasterUser type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdUser"))
                    row["IdUser"] = lastInsertedId;
                else
                    row.Add("IdUser", lastInsertedId);
                IdUser.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                _UserLevel.DbValue = row["UserLevel"]; // Set DB value only
                Rule.DbValue = row["Rule"]; // Set DB value only
                ...
                StatusAktif.DbValue = (ConvertToBool(row["StatusAktif"]) ? "1" : "0"); // Set DB value only
                ...
                IsResetable.DbValue = (ConvertToBool(row["IsResetable"]) ? "1" : "0"); // Set DB value only
                IsVerify.DbValue = (ConvertToBool(row["IsVerify"]) ? "1" : "0"); // Set DB value only
                ...
                IdIdaman.DbValue = row["IdIdaman"]; // Set DB value only
                exception.DbValue = (ConvertToBool(row["exception "]) ? "1" : "0"); // Set DB value only
            } catch {}
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MasterUserView",
                Config.ApiAddAction => "MasterUserAdd",
                Config.ApiEditAction => "MasterUserEdit",
                Config.ApiDeleteAction => "MasterUserDelete",
                Config.ApiListAction => "MasterUserList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MasterUserList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MasterUserView", parm);
            else
                url = KeyUrl("MasterUserView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MasterUserAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MasterUserEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterUserList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MasterUserAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterUserList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MasterUserDelete", parm)); // DN
        }
        ...
        {
            string pageName = "MasterUserList";
        ...
        public async Task RenderListRow()
        {
            ...
            // IsResetable
            IsResetable.HrefValue = "";
            IsResetable.TooltipValue = "";

            // IsVerify
            IsVerify.HrefValue = "";
            IsVerify.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            PasswordHash.EditValue = Config.EncryptedPassword ? Language.Phrase("PasswordMask") : PasswordHash.CurrentValue; // DN
            ...
            NamaLengkap.EditValue = NamaLengkap.CurrentValue;
            ...
            // IsResetable
            IsResetable.EditValue = IsResetable.Options(false);
            IsResetable.PlaceHolder = RemoveHtml(IsResetable.Caption);

            // IsVerify
            IsVerify.EditValue = IsVerify.Options(false);
            IsVerify.PlaceHolder = RemoveHtml(IsVerify.Caption);
            ...
            IdIdaman.EditValue = IdIdaman.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(_UserLevel);
                        doc.ExportCaption(Rule);
                        doc.ExportCaption(IdPosition);
                        doc.ExportCaption(Region);
                        doc.ExportCaption(Plant);
                        doc.ExportCaption(StatusAktif);
                        ...
                        doc.ExportCaption(IdIdaman);
                        doc.ExportCaption(exception);
                    } else {
                        ...
                        doc.ExportCaption(DiperbaruiOleh);
                        doc.ExportCaption(TanggalDiperbarui);
                        doc.ExportCaption(IsResetable);
                        doc.ExportCaption(IsVerify);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(_UserLevel);
                            await doc.ExportField(Rule);
                            await doc.ExportField(IdPosition);
                            await doc.ExportField(Region);
                            await doc.ExportField(Plant);
                            await doc.ExportField(StatusAktif);
                            ...
                            await doc.ExportField(IdIdaman);
                            await doc.ExportField(exception);
                        } else {
                            ...
                            await doc.ExportField(DiperbaruiOleh);
                            await doc.ExportField(TanggalDiperbarui);
                            await doc.ExportField(IsResetable);
                            await doc.ExportField(IsVerify);
