...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataGerbongKetelRtwList
    /// </summary>
    public static SubAktivitasFormInputDataGerbongKetelRtwList subAktivitasFormInputDataGerbongKetelRtwList
    {
        get => HttpData.Get<SubAktivitasFormInputDataGerbongKetelRtwList>("subAktivitasFormInputDataGerbongKetelRtwList")!;
        set => HttpData["subAktivitasFormInputDataGerbongKetelRtwList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataGerbongKetelRTW
    /// </summary>
    public class SubAktivitasFormInputDataGerbongKetelRtwList : SubAktivitasFormInputDataGerbongKetelRtwListBase
    {
        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataGerbongKetelRtwListBase : SubAktivitasFormInputDataGerbongKetelRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataGerbongKetelRtwList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasFormInputDataGerbongKetelRTWlist";
        ...
        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwListBase()
        {
            TableName = "SubAktivitasFormInputDataGerbongKetelRTW";

            // CSS class name as context
            TableVar = "SubAktivitasFormInputDataGerbongKetelRTW";
            ...
            // Table object (subAktivitasFormInputDataGerbongKetelRtw)
            if (subAktivitasFormInputDataGerbongKetelRtw == null || subAktivitasFormInputDataGerbongKetelRtw is SubAktivitasFormInputDataGerbongKetelRtw)
                subAktivitasFormInputDataGerbongKetelRtw = this;

            // Initialize URLs
            AddUrl = "SubAktivitasFormInputDataGerbongKetelRtwAdd";
            ...
            MultiDeleteUrl = "SubAktivitasFormInputDataGerbongKetelRtwDelete";
            MultiUpdateUrl = "SubAktivitasFormInputDataGerbongKetelRtwUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataGerbongKetelRtwList";
        ...
        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasFormInputDataGerbongKetelRtwView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            await SetupLookupOptions(Jns_Produk);

            // Update form name to avoid conflict
            if (IsModal)
                FormName = "fSubAktivitasFormInputDataGerbongKetelRTWgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputDataGerbongKetelRtwList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(Jns_Produk.AdvancedSearch.ToJson())); // Field Jns_Produk
        ...
        protected bool RestoreFilterList() {
            ...
            // Field Jns_Produk
            if (filter?.TryGetValue("x_Jns_Produk", out sv) ?? false) {
                Jns_Produk.AdvancedSearch.SearchValue = sv;
                Jns_Produk.AdvancedSearch.SearchOperator = filter["z_Jns_Produk"];
                Jns_Produk.AdvancedSearch.SearchCondition = filter["v_Jns_Produk"];
                Jns_Produk.AdvancedSearch.SearchValue2 = filter["y_Jns_Produk"];
                Jns_Produk.AdvancedSearch.SearchOperator2 = filter["w_Jns_Produk"];
                Jns_Produk.AdvancedSearch.Save();
            }
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(Jns_Produk, ctrl); // Jns_Produk
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasFormInputDataGerbongKetelRTW"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputDataGerbongKetelRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputDataGerbongKetelRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("Jns_Produk")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasFormInputDataGerbongKetelRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasFormInputDataGerbongKetelRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputDataGerbongKetelRTWlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasFormInputDataGerbongKetelRTW");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasFormInputDataGerbongKetelRtwList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasFormInputDataGerbongKetelRtwList.RowCount) + "_SubAktivitasFormInputDataGerbongKetelRTW");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasFormInputDataGerbongKetelRtwList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasFormInputDataGerbongKetelRtwList.RowType == RowType.Add || IsEdit && subAktivitasFormInputDataGerbongKetelRtwList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            Jns_Produk.SetDbValue(row["Jns_Produk"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("Jns_Produk", Jns_Produk.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // Jns_Produk
                Jns_Produk.ViewValue = ConvertToString(Jns_Produk.CurrentValue); // DN
                string curVal4 = ConvertToString(Jns_Produk.CurrentValue);
                if (!Empty(curVal4)) {
                    if (Jns_Produk.Lookup != null && IsDictionary(Jns_Produk.Lookup?.Options) && Jns_Produk.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                        Jns_Produk.ViewValue = Jns_Produk.LookupCacheOption(curVal4);
                    } else { // Lookup from database // DN
                        string filterWrk4 = SearchFilter(Jns_Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchExpression, "=", Jns_Produk.CurrentValue, Jns_Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchDataType, "");
                        string? sqlWrk4 = Jns_Produk.Lookup?.GetSql(false, filterWrk4, null, this, true, true);
                        ...
                        if (rswrk4?.Count > 0 && Jns_Produk.Lookup != null) { // Lookup values found
                            var listwrk = Jns_Produk.Lookup?.RenderViewRow(rswrk4[0]);
                            Jns_Produk.ViewValue = Jns_Produk.DisplayValue(listwrk);
                        } else {
                            Jns_Produk.ViewValue = Jns_Produk.CurrentValue;
                        }
                    }
                } else {
                    Jns_Produk.ViewValue = DbNullValue;
                }
                Jns_Produk.ViewCustomAttributes = "";
                ...
                // Jns_Produk
                Jns_Produk.HrefValue = "";
                Jns_Produk.TooltipValue = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasFormInputDataGerbongKetelRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasFormInputDataGerbongKetelRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasFormInputDataGerbongKetelRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
