...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputDataKapalEdit
    /// </summary>
    public static SubAktivitasInputDataKapalEdit subAktivitasInputDataKapalEdit
    {
        get => HttpData.Get<SubAktivitasInputDataKapalEdit>("subAktivitasInputDataKapalEdit")!;
        set => HttpData["subAktivitasInputDataKapalEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasInputDataKapal
    /// </summary>
    public class SubAktivitasInputDataKapalEdit : SubAktivitasInputDataKapalEditBase
    {
        // Constructor
        public SubAktivitasInputDataKapalEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasInputDataKapalEdit() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasInputDataKapalEditBase : SubAktivitasInputDataKapal
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasInputDataKapalEdit";
        ...
        // Constructor
        public SubAktivitasInputDataKapalEditBase(Controller? controller)
        {
            TableName = "SubAktivitasInputDataKapal";
        ...
        if (controller != null)
            ...
            // Table object (subAktivitasInputDataKapal)
            if (subAktivitasInputDataKapal == null || subAktivitasInputDataKapal is SubAktivitasInputDataKapal)
                subAktivitasInputDataKapal = this;
        ...
        // Page name
        public string PageName => "SubAktivitasInputDataKapalEdit";
        ...
        // Constructor
        public SubAktivitasInputDataKapalEditBase() : this(null) { }
            ...
            string pageName = GetPageName(url);
                ...
                // List / View / Master View page
                    if (!SameString(pageName, ListUrl))
                    {
                        ...
                        result.Add("view", pageName == "SubAktivitasInputDataKapalView" ? "1" : "0"); // If View page, no primary button
                    }
                    else
                    {
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasInputDataKapalList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasInputDataKapalList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasInputDataKapalList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasInputDataKapalEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasInputDataKapalList")), "", TableVar, true);
            string pageId = "edit";
