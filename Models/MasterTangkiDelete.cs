...
public partial class SnDOne {
    ...
    /// masterTangkiDelete
    /// </summary>
    public static MasterTangkiDelete masterTangkiDelete
    {
        get => HttpData.Get<MasterTangkiDelete>("masterTangkiDelete")!;
        set => HttpData["masterTangkiDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterTangki
    /// </summary>
    public class MasterTangkiDelete : MasterTangkiDeleteBase
    {
        // Constructor
        public MasterTangkiDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterTangkiDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class MasterTangkiDeleteBase : MasterTangki
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterTangkiDelete";
        ...
        // Page name
        public string PageName => "MasterTangkiDelete";
        ...
        // Constructor
        public MasterTangkiDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterTangkiList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterTangkiList"); // Return to list
                }
            }
