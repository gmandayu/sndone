...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbookPenerimaanPipaEdit
    /// </summary>
    public static SubAktivitasFormInputLogbookPenerimaanPipaEdit subAktivitasFormInputLogbookPenerimaanPipaEdit
    {
        get => HttpData.Get<SubAktivitasFormInputLogbookPenerimaanPipaEdit>("subAktivitasFormInputLogbookPenerimaanPipaEdit")!;
        set => HttpData["subAktivitasFormInputLogbookPenerimaanPipaEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbookPenerimaanPipa
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanPipaEdit : SubAktivitasFormInputLogbookPenerimaanPipaEditBase
    {
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanPipaEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanPipaEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanPipaEditBase : SubAktivitasFormInputLogbookPenerimaanPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbookPenerimaanPipaEdit";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanPipaEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbookPenerimaanPipaEdit";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanPipaEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputLogbookPenerimaanPipaList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputLogbookPenerimaanPipaList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputLogbookPenerimaanPipaList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputLogbookPenerimaanPipaEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void ValidateCustomNamaBatch() {
            if (NamaBatch.Visible && NamaBatch.Required) {
                if (!NamaBatch.IsDetailKey && Empty(NamaBatch.FormValue)) {
                    NamaBatch.AddErrorMessage(ConvertToString(IsQualityActive.RequiredErrorMessage).Replace("%s", IsQualityActive.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputLogbookPenerimaanPipaList")), "", TableVar, true);
            string pageId = "edit";
