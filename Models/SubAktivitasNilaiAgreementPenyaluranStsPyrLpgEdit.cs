...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEditBase : SubAktivitasNilaiAgreementPenyaluranStsPyrLpg
    {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList") {
                                ...
                                returnUrl = "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
