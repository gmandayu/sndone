...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasRencanaPenyaluranPerProduk
    /// </summary>
    [MaybeNull]
    public static SubAktivitasRencanaPenyaluranPerProduk subAktivitasRencanaPenyaluranPerProduk
    {
        get => HttpData.Resolve<SubAktivitasRencanaPenyaluranPerProduk>("SubAktivitasRencanaPenyaluranPerProduk");
        set => HttpData["SubAktivitasRencanaPenyaluranPerProduk"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasRencanaPenyaluranPerProduk
    /// </summary>
    public class SubAktivitasRencanaPenyaluranPerProduk : DbTable
    {
        ...
        // Constructor
        public SubAktivitasRencanaPenyaluranPerProduk()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasRencanaPenyaluranPerProduk";
            Name = "SubAktivitasRencanaPenyaluranPerProduk";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasRencanaPenyaluranPerProduk"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            Shift1 = new(this, "x_Shift1", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "Shift1", "CustomMsg"),
                IsUpload = false
            };
            ...
            Shift2 = new(this, "x_Shift2", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "Shift2", "CustomMsg"),
                IsUpload = false
            };
            ...
            Shift3 = new(this, "x_Shift3", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "Shift3", "CustomMsg"),
                IsUpload = false
            };
            ...
            Shift4 = new(this, "x_Shift4", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "Shift4", "CustomMsg"),
                IsUpload = false
            };
            ...
            Total = new(this, "x_Total", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "Total", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasRencanaPenyaluranPerProduk", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasRencanaPenyaluranPerProduk";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasRencanaPenyaluranPerProduk type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasRencanaPenyaluranPerProdukList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasRencanaPenyaluranPerProdukView" => Language.Phrase("View"),
                "SubAktivitasRencanaPenyaluranPerProdukEdit" => Language.Phrase("Edit"),
                "SubAktivitasRencanaPenyaluranPerProdukAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasRencanaPenyaluranPerProdukView",
                Config.ApiAddAction => "SubAktivitasRencanaPenyaluranPerProdukAdd",
                Config.ApiEditAction => "SubAktivitasRencanaPenyaluranPerProdukEdit",
                Config.ApiDeleteAction => "SubAktivitasRencanaPenyaluranPerProdukDelete",
                Config.ApiListAction => "SubAktivitasRencanaPenyaluranPerProdukList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasRencanaPenyaluranPerProdukList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasRencanaPenyaluranPerProdukView", parm);
            else
                url = KeyUrl("SubAktivitasRencanaPenyaluranPerProdukView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasRencanaPenyaluranPerProdukAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasRencanaPenyaluranPerProdukAdd?" + parm;
            else
                url = "SubAktivitasRencanaPenyaluranPerProdukAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasRencanaPenyaluranPerProdukEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasRencanaPenyaluranPerProdukList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasRencanaPenyaluranPerProdukAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasRencanaPenyaluranPerProdukList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasRencanaPenyaluranPerProdukDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasRencanaPenyaluranPerProdukList";
