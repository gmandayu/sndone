...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static DetailUploadCrs detailUploadCrs
    {
        get => HttpData.Resolve<DetailUploadCrs>("DetailUploadCRS");
        set => HttpData["DetailUploadCRS"] = value;
    }

    /// <summary>
    /// Table class for DetailUploadCRS
    /// </summary>
    public class DetailUploadCrs : DbTable
    {
        ...
        // Constructor
        public DetailUploadCrs()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "DetailUploadCRS";
            Name = "DetailUploadCRS";
            Type = "TABLE";
            UpdateTable = "dbo.DetailUploadCRS"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new(this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("DetailUploadCRS", "Id", "CustomMsg"),
                IsUpload = false
            };
            Id.Raw = true;
            Fields.Add("Id", Id);
            ...
            IdCRS = new(this, "x_IdCRS", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("DetailUploadCRS", "IdCRS", "CustomMsg"),
                IsUpload = false
            };
            IdCRS.Raw = true;
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("DetailUploadCRS", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            FileName = new(this, "x_FileName", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadCRS", "FileName", "CustomMsg"),
                IsUpload = false
            };
            ...
            UserInput = new(this, "x_UserInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadCRS", "UserInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            EtlDate = new(this, "x_EtlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("DetailUploadCRS", "EtlDate", "CustomMsg"),
                IsUpload = false
            };
            EtlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadCRS", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDate = new(this, "x_LastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadCRS", "LastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.DetailUploadCRS";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.DetailUploadCr type", "data");
            row = row.Where(kvp => {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "DetailUploadCrsView" => Language.Phrase("View"),
                "DetailUploadCrsEdit" => Language.Phrase("Edit"),
                "DetailUploadCrsAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "DetailUploadCrsView",
                Config.ApiAddAction => "DetailUploadCrsAdd",
                Config.ApiEditAction => "DetailUploadCrsEdit",
                Config.ApiDeleteAction => "DetailUploadCrsDelete",
                Config.ApiListAction => "DetailUploadCrsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "DetailUploadCrsList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("DetailUploadCrsView", parm);
            else
                url = KeyUrl("DetailUploadCrsView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "DetailUploadCrsAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "DetailUploadCrsAdd?" + parm;
            else
                url = "DetailUploadCrsAdd";
        ...
        {
            string url = "";
            url = KeyUrl("DetailUploadCrsEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("DetailUploadCrsList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("DetailUploadCrsAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("DetailUploadCrsList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("DetailUploadCrsDelete", parm)); // DN
        }
        ...
        {
            string pageName = "DetailUploadCrsList";
        ...
        public async Task RenderListRow()
        {
            ...
            IdCRS.ViewValue = FormatNumber(IdCRS.ViewValue, IdCRS.FormatPattern);
        ...
        public async Task RenderEditRow()
        {
            ...
            IdCRS.PlaceHolder = RemoveHtml(IdCRS.Caption);
            if (!Empty(IdCRS.EditValue) && IsNumeric(IdCRS.EditValue))
                IdCRS.EditValue = FormatNumber(IdCRS.EditValue, null);
