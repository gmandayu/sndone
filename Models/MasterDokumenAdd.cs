...
public partial class SnDOne {
    ...
    /// masterDokumenAdd
    /// </summary>
    public static MasterDokumenAdd masterDokumenAdd
    {
        get => HttpData.Get<MasterDokumenAdd>("masterDokumenAdd")!;
        set => HttpData["masterDokumenAdd"] = value;
    }

    /// <summary>
    /// Page class for MasterDokumen
    /// </summary>
    public class MasterDokumenAdd : MasterDokumenAddBase
    {
        // Constructor
        public MasterDokumenAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterDokumenAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterDokumenAddBase : MasterDokumen
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterDokumenAdd";
        ...
        // Page name
        public string PageName => "MasterDokumenAdd";
        ...
        // Constructor
        public MasterDokumenAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MasterDokumenList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "MasterDokumenView")
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            if (insertRow) {
                try {
                    ...
                    rsnew["IdDokumen"] = IdDokumen.CurrentValue!;
                } catch (Exception e) {
                    if (Config.Debug)
                        throw;
