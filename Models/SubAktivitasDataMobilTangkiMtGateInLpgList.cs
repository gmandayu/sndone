...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataMobilTangkiMtGateInLpgList
    /// </summary>
    public static SubAktivitasDataMobilTangkiMtGateInLpgList subAktivitasDataMobilTangkiMtGateInLpgList
    {
        get => HttpData.Get<SubAktivitasDataMobilTangkiMtGateInLpgList>("subAktivitasDataMobilTangkiMtGateInLpgList")!;
        set => HttpData["subAktivitasDataMobilTangkiMtGateInLpgList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataMobilTangkiMTGateInLPG
    /// </summary>
    public class SubAktivitasDataMobilTangkiMtGateInLpgList : SubAktivitasDataMobilTangkiMtGateInLpgListBase
    {
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInLpgList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInLpgList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataMobilTangkiMtGateInLpgListBase : SubAktivitasDataMobilTangkiMtGateInLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataMobilTangkiMtGateInLpgList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasDataMobilTangkiMTGateInLPGlist";
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInLpgListBase()
        {
            TableName = "SubAktivitasDataMobilTangkiMTGateInLPG";

            // CSS class name as context
            TableVar = "SubAktivitasDataMobilTangkiMTGateInLPG";
            ...
            // Initialize URLs
            AddUrl = "SubAktivitasDataMobilTangkiMtGateInLpgAdd";
            ...
            MultiDeleteUrl = "SubAktivitasDataMobilTangkiMtGateInLpgDelete";
            MultiUpdateUrl = "SubAktivitasDataMobilTangkiMtGateInLpgUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasDataMobilTangkiMtGateInLpgList";
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInLpgListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasDataMobilTangkiMTGateInLPGgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasDataMobilTangkiMtGateInLpgList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(WaktuGateIn.AdvancedSearch.ToJson())); // Field WaktuGateIn
        ...
        protected bool RestoreFilterList() {
            ...
            // Field WaktuGateIn
            if (filter?.TryGetValue("x_WaktuGateIn", out sv) ?? false) {
                WaktuGateIn.AdvancedSearch.SearchValue = sv;
                WaktuGateIn.AdvancedSearch.SearchOperator = filter["z_WaktuGateIn"];
                WaktuGateIn.AdvancedSearch.SearchCondition = filter["v_WaktuGateIn"];
                WaktuGateIn.AdvancedSearch.SearchValue2 = filter["y_WaktuGateIn"];
                WaktuGateIn.AdvancedSearch.SearchOperator2 = filter["w_WaktuGateIn"];
                WaktuGateIn.AdvancedSearch.Save();
            }
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(AMT, ctrl); // AMT
                UpdateSort(WaktuGateIn, ctrl); // WaktuGateIn
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasDataMobilTangkiMTGateInLPG"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataMobilTangkiMTGateInLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataMobilTangkiMTGateInLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("AMT")); // DN
                CreateColumnOption(option.Add("WaktuGateIn")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasDataMobilTangkiMTGateInLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasDataMobilTangkiMTGateInLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataMobilTangkiMTGateInLPGlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasDataMobilTangkiMTGateInLPG");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasDataMobilTangkiMtGateInLpgList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasDataMobilTangkiMtGateInLpgList.RowCount) + "_SubAktivitasDataMobilTangkiMTGateInLPG");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasDataMobilTangkiMtGateInLpgList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasDataMobilTangkiMtGateInLpgList.RowType == RowType.Add || IsEdit && subAktivitasDataMobilTangkiMtGateInLpgList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasDataMobilTangkiMTGateInLPGsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
