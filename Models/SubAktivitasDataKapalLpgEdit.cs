...
public partial class SnDOne {
    ...
    public class SubAktivitasDataKapalLpgEditBase : SubAktivitasDataKapalLpg
    {
        ...
        // Constructor
        public SubAktivitasDataKapalLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataKapalLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataKapalLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataKapalLpgList") {
                                ...
                                returnUrl = "SubAktivitasDataKapalLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
