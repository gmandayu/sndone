...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLogbookMonitoringStockPipa
    /// </summary>
    [MaybeNull]
    public static SubAktivitasLogbookMonitoringStockPipa subAktivitasLogbookMonitoringStockPipa
    {
        get => HttpData.Resolve<SubAktivitasLogbookMonitoringStockPipa>("SubAktivitasLogbookMonitoringStockPipa");
        set => HttpData["SubAktivitasLogbookMonitoringStockPipa"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasLogbookMonitoringStockPipa
    /// </summary>
    public class SubAktivitasLogbookMonitoringStockPipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> Volume_KL;
        ...
        // Constructor
        public SubAktivitasLogbookMonitoringStockPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasLogbookMonitoringStockPipa";
            Name = "SubAktivitasLogbookMonitoringStockPipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasLogbookMonitoringStockPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            Nomor_Tangki = new(this, "x_Nomor_Tangki", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "Nomor_Tangki", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            Aktivitas2 = new(this, "x_Aktivitas2", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "Aktivitas2", "CustomMsg"),
                IsUpload = false
            };
            ...
            Level_Tangki = new(this, "x_Level_Tangki", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "Level_Tangki", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Level_Tangki", Level_Tangki);

            // Volume_KL
            Volume_KL = new(this, "x_Volume_KL", 202, SqlDbType.NVarChar) {
                Name = "Volume_KL",
                Expression = "[Volume_KL]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Volume_KL]",
                DateTimeFormat = -1,
                VirtualExpression = "[Volume_KL]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "Volume_KL", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Volume_KL", Volume_KL);
            ...
            Flowrate = new(this, "x_Flowrate", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "Flowrate", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdPlant = new(this, "x_IdPlant", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStockPipa", "IdPlant", "CustomMsg"),
                IsUpload = false
            };
            IdPlant.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasLogbookMonitoringStockPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasLogbookMonitoringStockPipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Volume_KL.DbValue = row["Volume_KL"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasLogbookMonitoringStockPipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasLogbookMonitoringStockPipaView" => Language.Phrase("View"),
                "SubAktivitasLogbookMonitoringStockPipaEdit" => Language.Phrase("Edit"),
                "SubAktivitasLogbookMonitoringStockPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasLogbookMonitoringStockPipaView",
                Config.ApiAddAction => "SubAktivitasLogbookMonitoringStockPipaAdd",
                Config.ApiEditAction => "SubAktivitasLogbookMonitoringStockPipaEdit",
                Config.ApiDeleteAction => "SubAktivitasLogbookMonitoringStockPipaDelete",
                Config.ApiListAction => "SubAktivitasLogbookMonitoringStockPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasLogbookMonitoringStockPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasLogbookMonitoringStockPipaView", parm);
            else
                url = KeyUrl("SubAktivitasLogbookMonitoringStockPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasLogbookMonitoringStockPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasLogbookMonitoringStockPipaAdd?" + parm;
            else
                url = "SubAktivitasLogbookMonitoringStockPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLogbookMonitoringStockPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLogbookMonitoringStockPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLogbookMonitoringStockPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLogbookMonitoringStockPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasLogbookMonitoringStockPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasLogbookMonitoringStockPipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            Volume_KL.EditValue = Volume_KL.CurrentValue;
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(Volume_KL);
