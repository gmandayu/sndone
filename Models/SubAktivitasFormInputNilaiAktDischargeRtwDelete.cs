...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiAktDischargeRtwDelete
    /// </summary>
    public static SubAktivitasFormInputNilaiAktDischargeRtwDelete subAktivitasFormInputNilaiAktDischargeRtwDelete
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiAktDischargeRtwDelete>("subAktivitasFormInputNilaiAktDischargeRtwDelete")!;
        set => HttpData["subAktivitasFormInputNilaiAktDischargeRtwDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiAktDischargeRTW
    /// </summary>
    public class SubAktivitasFormInputNilaiAktDischargeRtwDelete : SubAktivitasFormInputNilaiAktDischargeRtwDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiAktDischargeRtwDeleteBase : SubAktivitasFormInputNilaiAktDischargeRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiAktDischargeRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiAktDischargeRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputNilaiAktDischargeRtwList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputNilaiAktDischargeRtwList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputNilaiAktDischargeRtwDelete?.PageRender();
            }
            return PageResult();
        }
