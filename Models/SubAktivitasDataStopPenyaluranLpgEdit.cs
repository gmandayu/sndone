...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStopPenyaluranLpgEditBase : SubAktivitasDataStopPenyaluranLpg
    {
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStopPenyaluranLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStopPenyaluranLpgList") {
                                ...
                                returnUrl = "SubAktivitasDataStopPenyaluranLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
