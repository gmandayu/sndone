...
public partial class SnDOne {
    ...
    public class SubAktivitasInputLogbookPenerimaanPenKonLpgEditBase : SubAktivitasInputLogbookPenerimaanPenKonLpg
    {
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasInputLogbookPenerimaanPenKonLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasInputLogbookPenerimaanPenKonLpgList") {
                                ...
                                returnUrl = "SubAktivitasInputLogbookPenerimaanPenKonLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
