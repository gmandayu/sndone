...
public partial class SnDOne {
    ...
    /// masterPositionAdd
    /// </summary>
    public static MasterPositionAdd masterPositionAdd
    {
        get => HttpData.Get<MasterPositionAdd>("masterPositionAdd")!;
        set => HttpData["masterPositionAdd"] = value;
    }

    /// <summary>
    /// Page class for MasterPosition
    /// </summary>
    public class MasterPositionAdd : MasterPositionAddBase
    {
        // Constructor
        public MasterPositionAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterPositionAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterPositionAddBase : MasterPosition
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterPositionAdd";
        ...
        // Constructor
        public MasterPositionAddBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "MasterPositionAdd";
        ...
        // Constructor
        public MasterPositionAddBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private string DetermineReturnUrl()
        {
            ...
            else if (GetPageName(returnUrl) == "MasterPositionView")
                returnUrl = ViewUrl;
            return returnUrl;
        }
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            if (!Empty(IdPosition.CurrentValue)) { // Check field with unique index
                var filter = "(IdPosition = " + AdjustSql(IdPosition.CurrentValue, DbId) + ")";
                if (await GetQueryBuilder().WhereRaw(filter).ExistsAsync()) { // DN
                    FailureMessage = Language.Phrase("DupIndex").Replace("%f", IdPosition.Caption).Replace("%v", ConvertToString(IdPosition.CurrentValue));
                    return JsonBoolResult.FalseResult;
                }
            }
            ...
            if (insertRow && ValidateKey && Empty(rsnew["IdPosition"])) {
        ...
        protected Dictionary<string, object> GetAddRow()
        {
            try {
                ...
                // NamaPosition
                NamaPosition.SetDbValue(rsnew, NamaPosition.CurrentValue);
                ...
                // Role
                Role.SetDbValue(rsnew, Role.CurrentValue);
                return rsnew;
            } catch (Exception e) {
                if (Config.Debug)
                    throw;
        ...
        private void RestoreAddFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("NamaPosition", out value)) // NamaPosition
                NamaPosition.SetFormValue(ConvertToString(value));
            if (row.TryGetValue("Location", out value)) // Location
                Location.SetFormValue(ConvertToString(value));
            ...
            if (row.TryGetValue("Role", out value)) // Role
                Role.SetFormValue(ConvertToString(value));
        }
