...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiBlsfalPenyaluranLpgEdit
    /// </summary>
    public static SubAktivitasNilaiBlsfalPenyaluranLpgEdit subAktivitasNilaiBlsfalPenyaluranLpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiBlsfalPenyaluranLpgEdit>("subAktivitasNilaiBlsfalPenyaluranLpgEdit")!;
        set => HttpData["subAktivitasNilaiBlsfalPenyaluranLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiBLSFALPenyaluranLPG
    /// </summary>
    public class SubAktivitasNilaiBlsfalPenyaluranLpgEdit : SubAktivitasNilaiBlsfalPenyaluranLpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiBlsfalPenyaluranLpgEditBase : SubAktivitasNilaiBlsfalPenyaluranLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiBlsfalPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiBlsfalPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiBlsfalPenyaluranLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiBlsfalPenyaluranLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiBlsfalPenyaluranLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiBlsfalPenyaluranLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiBlsfalPenyaluranLpgList")), "", TableVar, true);
            string pageId = "edit";
