...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataGerbongKetelRtwEdit
    /// </summary>
    public static SubAktivitasDataGerbongKetelRtwEdit subAktivitasDataGerbongKetelRtwEdit
    {
        get => HttpData.Get<SubAktivitasDataGerbongKetelRtwEdit>("subAktivitasDataGerbongKetelRtwEdit")!;
        set => HttpData["subAktivitasDataGerbongKetelRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataGerbongKetelRTW
    /// </summary>
    public class SubAktivitasDataGerbongKetelRtwEdit : SubAktivitasDataGerbongKetelRtwEditBase
    {
        // Constructor
        public SubAktivitasDataGerbongKetelRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataGerbongKetelRtwEdit() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataGerbongKetelRtwEditBase : SubAktivitasDataGerbongKetelRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataGerbongKetelRtwEdit";
        ...
        // Constructor
        public SubAktivitasDataGerbongKetelRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataGerbongKetelRtwEdit";
        ...
        // Constructor
        public SubAktivitasDataGerbongKetelRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataGerbongKetelRtwEdit?.PageRender();
                    }
        }
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                JenisProduk.EditValue = ConvertToString(JenisProduk.CurrentValue); // DN

                // awallookupbung
                string curVal4 = ConvertToString(JenisProduk.CurrentValue);
                JenisProduk.EditValue = Empty(curVal4) ? DbNullValue : JenisProduk.CurrentValue;
                if (!Empty(curVal4)) {
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // TanggalTiba
            TanggalTiba.SetDbValue(rsnew, ConvertToDateTime(TanggalTiba.CurrentValue, TanggalTiba.FormatPattern), TanggalTiba.ReadOnly);

            // Nominasi
            Nominasi.SetDbValue(rsnew, Nominasi.CurrentValue, Nominasi.ReadOnly);

            // DetailGerbong
            DetailGerbong.SetDbValue(rsnew, DetailGerbong.CurrentValue, DetailGerbong.ReadOnly);

            // DetailQuantity
            DetailQuantity.SetDbValue(rsnew, DetailQuantity.CurrentValue, DetailQuantity.ReadOnly);
            return rsnew;
        }
