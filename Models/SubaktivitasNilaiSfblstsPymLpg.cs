...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiSfblstsPymLpg
    /// </summary>
    [MaybeNull]
    public static SubaktivitasNilaiSfblstsPymLpg subaktivitasNilaiSfblstsPymLpg
    {
        get => HttpData.Resolve<SubaktivitasNilaiSfblstsPymLpg>("SubaktivitasNilaiSFBLSTSPymLPG");
        set => HttpData["SubaktivitasNilaiSFBLSTSPymLPG"] = value;
    }

    /// <summary>
    /// Table class for SubaktivitasNilaiSFBLSTSPymLPG
    /// </summary>
    public class SubaktivitasNilaiSfblstsPymLpg : DbTable
    {
        ...
        // Constructor
        public SubaktivitasNilaiSfblstsPymLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubaktivitasNilaiSFBLSTSPymLPG";
            Name = "SubaktivitasNilaiSFBLSTSPymLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubaktivitasNilaiSFBLSTSPymLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiSFBLSTSPymLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiSFBLSTSPymLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiSFBLSTSPymLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiSFBLSTSPymLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiSFBLSTSPymLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiSFBLSTSPymLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiSFBLSTSPymLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            mt = new(this, "x_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiSFBLSTSPymLPG", "mt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("mt", mt);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiSFBLSTSPymLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasNilaiSFBLSTSPymLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubaktivitasNilaiSFBLSTSPymLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubaktivitasNilaiSfblstspymLpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubaktivitasNilaiSfblstsPymLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubaktivitasNilaiSfblstsPymLpgView" => Language.Phrase("View"),
                "SubaktivitasNilaiSfblstsPymLpgEdit" => Language.Phrase("Edit"),
                "SubaktivitasNilaiSfblstsPymLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubaktivitasNilaiSfblstsPymLpgView",
                Config.ApiAddAction => "SubaktivitasNilaiSfblstsPymLpgAdd",
                Config.ApiEditAction => "SubaktivitasNilaiSfblstsPymLpgEdit",
                Config.ApiDeleteAction => "SubaktivitasNilaiSfblstsPymLpgDelete",
                Config.ApiListAction => "SubaktivitasNilaiSfblstsPymLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubaktivitasNilaiSfblstsPymLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubaktivitasNilaiSfblstsPymLpgView", parm);
            else
                url = KeyUrl("SubaktivitasNilaiSfblstsPymLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubaktivitasNilaiSfblstsPymLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubaktivitasNilaiSfblstsPymLpgAdd?" + parm;
            else
                url = "SubaktivitasNilaiSfblstsPymLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasNilaiSfblstsPymLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasNilaiSfblstsPymLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasNilaiSfblstsPymLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasNilaiSfblstsPymLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubaktivitasNilaiSfblstsPymLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubaktivitasNilaiSfblstsPymLpgList";
