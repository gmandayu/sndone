...
public partial class SnDOne {
    ...
    public class MasterTemplateViewBase : MasterTemplate
    {
        ...
        // Constructor
        public MasterTemplateViewBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterTemplateViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdTemplate", out v) && !Empty(v))
                {
                IdTemplate.QueryValue = UrlDecode(v);
                RecordKeys["IdTemplate"] = IdTemplate.QueryValue;
                return;
                }
                if (Get("IdTemplate", out sv))
                {
