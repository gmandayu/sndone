...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasTotalRencanaPenyaluran
    /// </summary>
    [MaybeNull]
    public static SubAktivitasTotalRencanaPenyaluran subAktivitasTotalRencanaPenyaluran
    {
        get => HttpData.Resolve<SubAktivitasTotalRencanaPenyaluran>("SubAktivitasTotalRencanaPenyaluran");
        set => HttpData["SubAktivitasTotalRencanaPenyaluran"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasTotalRencanaPenyaluran
    /// </summary>
    public class SubAktivitasTotalRencanaPenyaluran : DbTable
    {
        ...
        public readonly DbField<SqlDbType> RencanaPenyaluranKL;
        ...
        // Constructor
        public SubAktivitasTotalRencanaPenyaluran()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasTotalRencanaPenyaluran";
            Name = "SubAktivitasTotalRencanaPenyaluran";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasTotalRencanaPenyaluran"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasTotalRencanaPenyaluran", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasTotalRencanaPenyaluran", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasTotalRencanaPenyaluran", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasTotalRencanaPenyaluran", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalJam = new(this, "x_TanggalJam", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasTotalRencanaPenyaluran", "TanggalJam", "CustomMsg"),
                IsUpload = false
            };
            TanggalJam.Raw = true;
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasTotalRencanaPenyaluran", "Produk", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Produk", Produk);

            // RencanaPenyaluranKL
            RencanaPenyaluranKL = new(this, "x_RencanaPenyaluranKL", 202, SqlDbType.NVarChar) {
                Name = "RencanaPenyaluranKL",
                Expression = "[RencanaPenyaluranKL]",
                UseBasicSearch = true,
                BasicSearchExpression = "[RencanaPenyaluranKL]",
                DateTimeFormat = -1,
                VirtualExpression = "[RencanaPenyaluranKL]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasTotalRencanaPenyaluran", "RencanaPenyaluranKL", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("RencanaPenyaluranKL", RencanaPenyaluranKL);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasTotalRencanaPenyaluran", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasTotalRencanaPenyaluran", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasTotalRencanaPenyaluran", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasTotalRencanaPenyaluran", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasTotalRencanaPenyaluran";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasTotalRencanaPenyaluran type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                RencanaPenyaluranKL.DbValue = row["RencanaPenyaluranKL"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasTotalRencanaPenyaluranList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasTotalRencanaPenyaluranView" => Language.Phrase("View"),
                "SubAktivitasTotalRencanaPenyaluranEdit" => Language.Phrase("Edit"),
                "SubAktivitasTotalRencanaPenyaluranAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasTotalRencanaPenyaluranView",
                Config.ApiAddAction => "SubAktivitasTotalRencanaPenyaluranAdd",
                Config.ApiEditAction => "SubAktivitasTotalRencanaPenyaluranEdit",
                Config.ApiDeleteAction => "SubAktivitasTotalRencanaPenyaluranDelete",
                Config.ApiListAction => "SubAktivitasTotalRencanaPenyaluranList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasTotalRencanaPenyaluranList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasTotalRencanaPenyaluranView", parm);
            else
                url = KeyUrl("SubAktivitasTotalRencanaPenyaluranView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasTotalRencanaPenyaluranAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasTotalRencanaPenyaluranAdd?" + parm;
            else
                url = "SubAktivitasTotalRencanaPenyaluranAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasTotalRencanaPenyaluranEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasTotalRencanaPenyaluranList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasTotalRencanaPenyaluranAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasTotalRencanaPenyaluranList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasTotalRencanaPenyaluranDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasTotalRencanaPenyaluranList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // RencanaPenyaluranKL
            RencanaPenyaluranKL.SetupEditAttributes();
            if (!RencanaPenyaluranKL.Raw)
                RencanaPenyaluranKL.CurrentValue = HtmlDecode(RencanaPenyaluranKL.CurrentValue);
            RencanaPenyaluranKL.EditValue = RencanaPenyaluranKL.CurrentValue;
            RencanaPenyaluranKL.PlaceHolder = RemoveHtml(RencanaPenyaluranKL.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(RencanaPenyaluranKL);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(RencanaPenyaluranKL);
