...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasKeberangkatanKapalPenyaluranStsPyrBbm
    /// </summary>
    [MaybeNull]
    public static SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbm subAktivitasKeberangkatanKapalPenyaluranStsPyrBbm
    {
        get => HttpData.Resolve<SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbm>("SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM");
        set => HttpData["SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbm : DbTable
    {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbm()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM";
            Name = "SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasKeberangkatanKapalPenyaluranStspyrBbm type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmView" => Language.Phrase("View"),
                "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit" => Language.Phrase("Edit"),
                "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmView",
                Config.ApiAddAction => "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmAdd",
                Config.ApiEditAction => "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit",
                Config.ApiDeleteAction => "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmDelete",
                Config.ApiListAction => "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmView", parm);
            else
                url = KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmAdd?" + parm;
            else
                url = "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList";
