...
public partial class SnDOne {
    ...
    public class SubAktivitasInputLogbookPenerimaanPenKonEditBase : SubAktivitasInputLogbookPenerimaanPenKon
    {
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonEditBase()
        {
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasInputLogbookPenerimaanPenKonList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasInputLogbookPenerimaanPenKonList") {
                                ...
                                returnUrl = "SubAktivitasInputLogbookPenerimaanPenKonList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
