...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLogbookJembatanTimbangLpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasLogbookJembatanTimbangLpg subAktivitasLogbookJembatanTimbangLpg
    {
        get => HttpData.Resolve<SubAktivitasLogbookJembatanTimbangLpg>("SubAktivitasLogbookJembatanTimbangLPG");
        set => HttpData["SubAktivitasLogbookJembatanTimbangLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasLogbookJembatanTimbangLPG
    /// </summary>
    public class SubAktivitasLogbookJembatanTimbangLpg : DbTable
    {
        ...
        public readonly DbField<SqlDbType> SPA;

        public readonly DbField<SqlDbType> TimbanganAwal;

        public readonly DbField<SqlDbType> TimbanganAkhir;

        public readonly DbField<SqlDbType> NetWight;

        public readonly DbField<SqlDbType> PresentaseLevelRotoGauge;
        ...
        // Constructor
        public SubAktivitasLogbookJembatanTimbangLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasLogbookJembatanTimbangLPG";
            Name = "SubAktivitasLogbookJembatanTimbangLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasLogbookJembatanTimbangLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomorTangki = new(this, "x_NomorTangki", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "NomorTangki", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "Produk", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Produk", Produk);

            // SPA
            SPA = new(this, "x_SPA", 202, SqlDbType.NVarChar) {
                Name = "SPA",
                Expression = "[SPA]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SPA]",
                DateTimeFormat = -1,
                VirtualExpression = "[SPA]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "SPA", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SPA", SPA);

            // TimbanganAwal
            TimbanganAwal = new(this, "x_TimbanganAwal", 202, SqlDbType.NVarChar) {
                Name = "TimbanganAwal",
                Expression = "[TimbanganAwal]",
                UseBasicSearch = true,
                BasicSearchExpression = "[TimbanganAwal]",
                DateTimeFormat = -1,
                VirtualExpression = "[TimbanganAwal]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "TimbanganAwal", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("TimbanganAwal", TimbanganAwal);

            // TimbanganAkhir
            TimbanganAkhir = new(this, "x_TimbanganAkhir", 202, SqlDbType.NVarChar) {
                Name = "TimbanganAkhir",
                Expression = "[TimbanganAkhir]",
                UseBasicSearch = true,
                BasicSearchExpression = "[TimbanganAkhir]",
                DateTimeFormat = -1,
                VirtualExpression = "[TimbanganAkhir]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "TimbanganAkhir", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("TimbanganAkhir", TimbanganAkhir);

            // NetWight
            NetWight = new(this, "x_NetWight", 202, SqlDbType.NVarChar) {
                Name = "NetWight",
                Expression = "[NetWight]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NetWight]",
                DateTimeFormat = -1,
                VirtualExpression = "[NetWight]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "NetWight", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NetWight", NetWight);

            // PresentaseLevelRotoGauge
            PresentaseLevelRotoGauge = new(this, "x_PresentaseLevelRotoGauge", 202, SqlDbType.NVarChar) {
                Name = "PresentaseLevelRotoGauge",
                Expression = "[PresentaseLevelRotoGauge]",
                UseBasicSearch = true,
                BasicSearchExpression = "[PresentaseLevelRotoGauge]",
                DateTimeFormat = -1,
                VirtualExpression = "[PresentaseLevelRotoGauge]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "PresentaseLevelRotoGauge", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("PresentaseLevelRotoGauge", PresentaseLevelRotoGauge);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookJembatanTimbangLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasLogbookJembatanTimbangLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasLogbookJembatanTimbangLpg type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                SPA.DbValue = row["SPA"]; // Set DB value only
                TimbanganAwal.DbValue = row["TimbanganAwal"]; // Set DB value only
                TimbanganAkhir.DbValue = row["TimbanganAkhir"]; // Set DB value only
                NetWight.DbValue = row["NetWight"]; // Set DB value only
                PresentaseLevelRotoGauge.DbValue = row["PresentaseLevelRotoGauge"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasLogbookJembatanTimbangLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasLogbookJembatanTimbangLpgView" => Language.Phrase("View"),
                "SubAktivitasLogbookJembatanTimbangLpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasLogbookJembatanTimbangLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasLogbookJembatanTimbangLpgView",
                Config.ApiAddAction => "SubAktivitasLogbookJembatanTimbangLpgAdd",
                Config.ApiEditAction => "SubAktivitasLogbookJembatanTimbangLpgEdit",
                Config.ApiDeleteAction => "SubAktivitasLogbookJembatanTimbangLpgDelete",
                Config.ApiListAction => "SubAktivitasLogbookJembatanTimbangLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasLogbookJembatanTimbangLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasLogbookJembatanTimbangLpgView", parm);
            else
                url = KeyUrl("SubAktivitasLogbookJembatanTimbangLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasLogbookJembatanTimbangLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasLogbookJembatanTimbangLpgAdd?" + parm;
            else
                url = "SubAktivitasLogbookJembatanTimbangLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLogbookJembatanTimbangLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLogbookJembatanTimbangLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLogbookJembatanTimbangLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLogbookJembatanTimbangLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasLogbookJembatanTimbangLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasLogbookJembatanTimbangLpgList";
        ...
        public async Task RenderListRow()
        {
            ...
            TimbanganAwal.TooltipValue = "";

            // TimbanganAkhir
            TimbanganAkhir.HrefValue = "";
            TimbanganAkhir.TooltipValue = "";

            // NetWight
            NetWight.HrefValue = "";
            NetWight.TooltipValue = "";

            // PresentaseLevelRotoGauge
            PresentaseLevelRotoGauge.HrefValue = "";
            PresentaseLevelRotoGauge.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            SPA.EditValue = SPA.CurrentValue;
            ...
            TimbanganAwal.EditValue = TimbanganAwal.CurrentValue;
            ...
            TimbanganAkhir.EditValue = TimbanganAkhir.CurrentValue;
            ...
            NetWight.EditValue = NetWight.CurrentValue;
            ...
            PresentaseLevelRotoGauge.EditValue = PresentaseLevelRotoGauge.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(SPA);
                        doc.ExportCaption(TimbanganAwal);
                        doc.ExportCaption(TimbanganAkhir);
                        doc.ExportCaption(NetWight);
                        doc.ExportCaption(PresentaseLevelRotoGauge);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(SPA);
                            await doc.ExportField(TimbanganAwal);
                            await doc.ExportField(TimbanganAkhir);
                            await doc.ExportField(NetWight);
                            await doc.ExportField(PresentaseLevelRotoGauge);
