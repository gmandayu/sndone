...
public partial class SnDOne {
    ...
    public class SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEditBase : SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbm
    {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEditBase()
        {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList") {
                                ...
                                returnUrl = "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
