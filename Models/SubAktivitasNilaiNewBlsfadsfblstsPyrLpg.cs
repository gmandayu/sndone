...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiNewBlsfadsfblstsPyrLpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiNewBlsfadsfblstsPyrLpg subAktivitasNilaiNewBlsfadsfblstsPyrLpg
    {
        get => HttpData.Resolve<SubAktivitasNilaiNewBlsfadsfblstsPyrLpg>("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG");
        set => HttpData["SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfblstsPyrLpg : DbTable
    {
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG";
            Name = "SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedBy.Lookup = new Lookup<DbField>(LastUpdatedBy, "SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_MT = new(this, "x_NewBL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "NewBL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_MT = new(this, "x_SFAD_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "SFAD_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFBL_MT = new(this, "x_SFBL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "SFBL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            ExROB = new(this, "x_ExROB", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "ExROB", "CustomMsg"),
                IsUpload = false
            };
            ExROB.Raw = true;
            ExROB.Lookup = new Lookup<DbField>(ExROB, "SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ExROB.UserValues = ["1"];
            ...
            NoPenerimaan = new(this, "x_NoPenerimaan", 202, SqlDbType.NVarChar) {
                ...
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "NoPenerimaan", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoPenerimaan.GetSelectFilter = () => "NomorPenerimaan IN (SELECT NoReferensi FROM SubAktivitasSFADNewBLSTSLPG WHERE ApakahTerdapatROB = 1 UNION SELECT NoReferensi FROM SubAktivitasSFADNewBLLPG WHERE ApakahTerdapatROB = 1)";
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiNewBlsfadsfblstspyrLpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgView" => Language.Phrase("View"),
                "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgView",
                Config.ApiAddAction => "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgAdd",
                Config.ApiEditAction => "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgDelete",
                Config.ApiListAction => "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrLpgView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgAdd?" + parm;
            else
                url = "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList";
        ...
        public async Task RenderListRow()
        {
            ...
            // LastUpdatedBy
            if (!Empty(LastUpdatedBy.CurrentValue)) {
                var arWrk = ConvertToString(LastUpdatedBy.CurrentValue).Split(Config.MultipleOptionSeparator);
                var optionsWrk = new OptionValues(arWrk.Select(v => LastUpdatedBy.OptionCaption(v.Trim())));
                LastUpdatedBy.ViewValue = optionsWrk.ToString(); // DN
            } else {
                LastUpdatedBy.ViewValue = DbNullValue;
            }
            ...
            // NoPenerimaan
            List<object?>? listWrk5 = [ // DN
                NoPenerimaan.CurrentValue,
                NoPenerimaan.CurrentValue,
            ];
            listWrk5 = NoPenerimaan.Lookup?.RenderViewRow(listWrk5, this);
            string? dispVal5 = NoPenerimaan.DisplayValue(listWrk5);
            if (!Empty(dispVal5))
                NoPenerimaan.ViewValue = dispVal5;
            ...
            StatusAktivitas.ViewValue = Empty(curVal6) ? DbNullValue : FormatNumber(StatusAktivitas.CurrentValue, StatusAktivitas.FormatPattern);
            if (!Empty(curVal6)) {
        ...
        public async Task RenderEditRow()
        {
            ...
            if (!Empty(LastUpdatedBy.CurrentValue)) {
                var arWrk = ConvertToString(LastUpdatedBy.CurrentValue).Split(Config.MultipleOptionSeparator);
                var optionsWrk = new OptionValues(arWrk.Select(v => LastUpdatedBy.OptionCaption(v.Trim())));
                LastUpdatedBy.EditValue = optionsWrk.ToString(); // DN
            } else {
                LastUpdatedBy.EditValue = DbNullValue;
            }
            LastUpdatedBy.ViewCustomAttributes = "";
            ...
            // awallookupbung
            string curVal6 = ConvertToString(StatusAktivitas.CurrentValue);
            StatusAktivitas.EditValue = Empty(curVal6) ? DbNullValue : FormatNumber(StatusAktivitas.CurrentValue, StatusAktivitas.FormatPattern);
            if (!Empty(curVal6)) {
                if (StatusAktivitas.Lookup != null && IsDictionary(StatusAktivitas.Lookup?.Options) && StatusAktivitas.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    StatusAktivitas.EditValue = StatusAktivitas.LookupCacheOption(curVal6);
                } else { // Lookup from database // DN
                    string filterWrk6 = SearchFilter(StatusAktivitas.Lookup?.GetTable()?.Fields["IdAktivitas"].SearchExpression, "=", StatusAktivitas.CurrentValue, StatusAktivitas.Lookup?.GetTable()?.Fields["IdAktivitas"].SearchDataType, "");
                    string? sqlWrk6 = StatusAktivitas.Lookup?.GetSql(false, filterWrk6, null, this, true, true);
                    List<Dictionary<string, object>>? rswrk6 = sqlWrk6 != null ? Connection.GetRows(sqlWrk6) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
