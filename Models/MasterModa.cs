...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static MasterModa masterModa
    {
        get => HttpData.Resolve<MasterModa>("MasterModa");
        set => HttpData["MasterModa"] = value;
    }

    /// <summary>
    /// Table class for MasterModa
    /// </summary>
    public class MasterModa : DbTable
    {
        ...
        public MasterModa()
        {
            ...
            Name = "MasterModa";
            Type = "TABLE";
            UpdateTable = "dbo.MasterModa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdModa = new(this, "x_IdModa", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterModa", "IdModa", "CustomMsg"),
                IsUpload = false
            };
            IdModa.Raw = true;
            IdModa.Lookup = new Lookup<DbField>(IdModa, "MasterModa", true, "IdModa", new List<string> {"IdModa", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("IdModa", IdModa);

            // NamaModa
            NamaModa = new(this, "x_NamaModa", 200, SqlDbType.VarChar) {
                Name = "NamaModa",
                Expression = "[NamaModa]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NamaModa]",
                DateTimeFormat = -1,
                VirtualExpression = "[NamaModa]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MasterModa", "NamaModa", "CustomMsg"),
                IsUpload = false
            };
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MasterModa type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdModa"))
                    row["IdModa"] = lastInsertedId;
                else
                    row.Add("IdModa", lastInsertedId);
                IdModa.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        private string _sqlKeyFilter => "[IdModa] = @IdModa@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MasterModaView" => Language.Phrase("View"),
                "MasterModaEdit" => Language.Phrase("Edit"),
                "MasterModaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MasterModaView",
                Config.ApiAddAction => "MasterModaAdd",
                Config.ApiEditAction => "MasterModaEdit",
                Config.ApiDeleteAction => "MasterModaDelete",
                Config.ApiListAction => "MasterModaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MasterModaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MasterModaView", parm);
            else
                url = KeyUrl("MasterModaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MasterModaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MasterModaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterModaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MasterModaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterModaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MasterModaDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdModa\":" + ConvertToJson(IdModa.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdModa.CurrentValue)) {
                url += "/" + IdModa.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdModa", out object? v0)) { // IdModa // DN
                    key = UrlDecode(v0); // DN
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdModa.CurrentValue = keys;
                else
                    IdModa.OldValue = keys;
        ...
        {
            string pageName = "MasterModaList";
