...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbMonitoringStockRtwAdd
    /// </summary>
    public static SubAktivitasFormInputLogbMonitoringStockRtwAdd subAktivitasFormInputLogbMonitoringStockRtwAdd
    {
        get => HttpData.Get<SubAktivitasFormInputLogbMonitoringStockRtwAdd>("subAktivitasFormInputLogbMonitoringStockRtwAdd")!;
        set => HttpData["subAktivitasFormInputLogbMonitoringStockRtwAdd"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbMonitoringStockRTW
    /// </summary>
    public class SubAktivitasFormInputLogbMonitoringStockRtwAdd : SubAktivitasFormInputLogbMonitoringStockRtwAddBase
    {
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbMonitoringStockRtwAddBase : SubAktivitasFormInputLogbMonitoringStockRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbMonitoringStockRtwAdd";
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwAddBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbMonitoringStockRtwAdd";
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwAddBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private IActionResult? HandleCopyAction(Dictionary<string, object>? rsold)
        {
            if (rsold == null) {
                ...
                return Terminate("SubAktivitasFormInputLogbMonitoringStockRtwList");
            }
            return null;
        }
        ...
        private string DetermineReturnUrl()
        {
            string returnUrl = "";
            returnUrl = ReturnUrl;
            if (GetPageName(returnUrl) == "SubAktivitasFormInputLogbMonitoringStockRtwList")
                returnUrl = AddMasterUrl(ListUrl);
            else if (GetPageName(returnUrl) == "SubAktivitasFormInputLogbMonitoringStockRtwView")
                returnUrl = ViewUrl;
            return returnUrl;
        }
        ...
        private void HandleAjaxActions(ref string returnUrl)
        {
            if (IsModal && UseAjaxActions) {
                ...
                if (GetPageName(returnUrl) != "SubAktivitasFormInputLogbMonitoringStockRtwList") {
                    ...
                    returnUrl = "SubAktivitasFormInputLogbMonitoringStockRtwList";
                }
            }
        }
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputLogbMonitoringStockRtwAdd?.PageRender();
                    }
        }
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'NoTangki'
            NoTangki.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(NoTangki, "NoTangki", "x_NoTangki", true, validate, false);
            ...
            // Standard handling for 'LevelTangki'
            LevelTangki.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(LevelTangki, "LevelTangki", "x_LevelTangki");
        ...
        public void RestoreFormValues()
        {
            ...
            NoTangki.CurrentValue = NoTangki.FormValue;
            Produk.CurrentValue = Produk.FormValue;
            Aktivitas2.CurrentValue = Aktivitas2.FormValue;
            LevelTangki.CurrentValue = LevelTangki.FormValue;
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                LevelTangki.EditValue = HtmlEncode(LevelTangki.CurrentValue);
        ...
        private void ValidateCustomNoTangki() {
            if (NoTangki.Visible && NoTangki.Required) {
                if (!NoTangki.IsDetailKey && Empty(NoTangki.FormValue)) {
                    NoTangki.AddErrorMessage(ConvertToString(NoReferensi.RequiredErrorMessage).Replace("%s", NoReferensi.Caption));
                }
            }
        }
        ...
        private void ValidateCustomAktivitas2() {
            if (Aktivitas2.Visible && Aktivitas2.Required) {
                if (!Aktivitas2.IsDetailKey && Empty(Aktivitas2.FormValue)) {
                    Aktivitas2.AddErrorMessage(ConvertToString(NoReferensi.RequiredErrorMessage).Replace("%s", NoReferensi.Caption));
                }
            }
        }

        private void ValidateCustomLevelTangki() {
            if (LevelTangki.Visible && LevelTangki.Required) {
                if (!LevelTangki.IsDetailKey && Empty(LevelTangki.FormValue)) {
                    LevelTangki.AddErrorMessage(ConvertToString(NoReferensi.RequiredErrorMessage).Replace("%s", NoReferensi.Caption));
                }
            }
        }
        ...
        private void ValidateCustomVolume() {
            if (Volume.Visible && Volume.Required) {
                if (!Volume.IsDetailKey && Empty(Volume.FormValue)) {
                    Volume.AddErrorMessage(ConvertToString(NoReferensi.RequiredErrorMessage).Replace("%s", NoReferensi.Caption));
                }
            }
        }
        ...
        private void ValidateCustomFlowrate() {
            if (Flowrate.Visible && Flowrate.Required) {
                if (!Flowrate.IsDetailKey && Empty(Flowrate.FormValue)) {
                    Flowrate.AddErrorMessage(ConvertToString(NoReferensi.RequiredErrorMessage).Replace("%s", NoReferensi.Caption));
                }
            }
        }
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ...
                ValidateCustomNoTangki();
                if (!CheckInteger(NoTangki.FormValue)) {
                    NoTangki.AddErrorMessage(NoTangki.GetErrorMessage(false));
                }
                ValidateCustomProduk();
                ValidateCustomAktivitas2();
                ValidateCustomLevelTangki();
        ...
        protected Dictionary<string, object> GetAddRow()
        {
            try {
                ...
                // NoTangki
                NoTangki.SetDbValue(rsnew, NoTangki.CurrentValue);

                // Produk
                Produk.SetDbValue(rsnew, Produk.CurrentValue);

                // Aktivitas
                Aktivitas2.SetDbValue(rsnew, Aktivitas2.CurrentValue);

                // LevelTangki
                LevelTangki.SetDbValue(rsnew, LevelTangki.CurrentValue);
        ...
        private void RestoreAddFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("NoTangki", out value)) // NoTangki
                NoTangki.SetFormValue(ConvertToString(value));
            ...
            if (row.TryGetValue("Aktivitas", out value)) // Aktivitas
                Aktivitas2.SetFormValue(ConvertToString(value));
            if (row.TryGetValue("LevelTangki", out value)) // LevelTangki
                LevelTangki.SetFormValue(ConvertToString(value));
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputLogbMonitoringStockRtwList")), "", TableVar, true);
