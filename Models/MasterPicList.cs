...
public partial class SnDOne {
    ...
    public class MasterPicListBase : MasterPic
    {
        ...
        // Constructor
        public MasterPicListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public void ShowFilterList()
        {
            ...
            // Field NamaPIC
            filter = QueryBuilderWhere("NamaPIC");
            if (Empty(filter))
                BuildSearchSql(ref filter, NamaPIC, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + NamaPIC.Caption + "</span>" + captionSuffix + filter + "</div>";
            if (!Empty(BasicSearch.Keyword))
        ...
        protected void LoadSearchValues() {
            ...
            // NamaPIC
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_NamaPIC[]"))
