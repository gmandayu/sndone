...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbookPenerimaanStsPymLpgAdd
    /// </summary>
    public static SubAktivitasFormInputLogbookPenerimaanStsPymLpgAdd subAktivitasFormInputLogbookPenerimaanStsPymLpgAdd
    {
        get => HttpData.Get<SubAktivitasFormInputLogbookPenerimaanStsPymLpgAdd>("subAktivitasFormInputLogbookPenerimaanStsPymLpgAdd")!;
        set => HttpData["subAktivitasFormInputLogbookPenerimaanStsPymLpgAdd"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbookPenerimaanSTSPymLPG
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanStsPymLpgAdd : SubAktivitasFormInputLogbookPenerimaanStsPymLpgAddBase
    {
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanStsPymLpgAddBase : SubAktivitasFormInputLogbookPenerimaanStsPymLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbookPenerimaanStsPymLpgAdd";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgAddBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbookPenerimaanStsPymLpgAdd";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgAddBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private IActionResult? HandleCopyAction(Dictionary<string, object>? rsold)
        {
            if (rsold == null) {
                ...
                return Terminate("SubAktivitasFormInputLogbookPenerimaanStsPymLpgList");
            }
            return null;
        }
        ...
        private string DetermineReturnUrl()
        {
            string returnUrl = "";
            returnUrl = ReturnUrl;
            if (GetPageName(returnUrl) == "SubAktivitasFormInputLogbookPenerimaanStsPymLpgList")
                returnUrl = AddMasterUrl(ListUrl);
            else if (GetPageName(returnUrl) == "SubAktivitasFormInputLogbookPenerimaanStsPymLpgView")
                returnUrl = ViewUrl;
            return returnUrl;
        }
        ...
        private void HandleAjaxActions(ref string returnUrl)
        {
            if (IsModal && UseAjaxActions) {
                ...
                if (GetPageName(returnUrl) != "SubAktivitasFormInputLogbookPenerimaanStsPymLpgList") {
                    ...
                    returnUrl = "SubAktivitasFormInputLogbookPenerimaanStsPymLpgList";
                }
            }
        }
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputLogbookPenerimaanStsPymLpgAdd?.PageRender();
                    }
        }
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'Nama_Kapal'
            Nama_Kapal.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(Nama_Kapal, "Nama_Kapal", "x_Nama_Kapal");
            ...
            // Standard handling for 'Temperatur'
            Temperatur.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(Temperatur, "Temperatur", "x_Temperatur");
        ...
        private void ValidateCustomidProses() {
            if (idProses.Visible && idProses.Required) {
                if (!idProses.IsDetailKey && Empty(idProses.FormValue)) {
                    idProses.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidAktifitas() {
            if (idAktifitas.Visible && idAktifitas.Required) {
                if (!idAktifitas.IsDetailKey && Empty(idAktifitas.FormValue)) {
                    idAktifitas.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNoReferensi() {
            if (NoReferensi.Visible && NoReferensi.Required) {
                if (!NoReferensi.IsDetailKey && Empty(NoReferensi.FormValue)) {
                    NoReferensi.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }

        private void ValidateCustomNama_Kapal() {
            if (Nama_Kapal.Visible && Nama_Kapal.Required) {
                if (!Nama_Kapal.IsDetailKey && Empty(Nama_Kapal.FormValue)) {
                    Nama_Kapal.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        private void ValidateCustomTanggal() {
            if (Tanggal.Visible && Tanggal.Required) {
                if (!Tanggal.IsDetailKey && Empty(Tanggal.FormValue)) {
                    Tanggal.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNama_Kegiatan() {
            if (Nama_Kegiatan.Visible && Nama_Kegiatan.Required) {
                if (!Nama_Kegiatan.IsDetailKey && Empty(Nama_Kegiatan.FormValue)) {
                    Nama_Kegiatan.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        private void ValidateCustomProduk() {
            if (Produk.Visible && Produk.Required) {
                if (!Produk.IsDetailKey && Empty(Produk.FormValue)) {
                    Produk.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        private void ValidateCustomDensity() {
            if (Density.Visible && Density.Required) {
                if (!Density.IsDetailKey && Empty(Density.FormValue)) {
                    Density.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }

        private void ValidateCustomTemperatur() {
            if (Temperatur.Visible && Temperatur.Required) {
                if (!Temperatur.IsDetailKey && Empty(Temperatur.FormValue)) {
                    Temperatur.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        private void ValidateCustomKeterangan() {
            if (Keterangan.Visible && Keterangan.Required) {
                if (!Keterangan.IsDetailKey && Empty(Keterangan.FormValue)) {
                    Keterangan.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        private void ValidateCustomuserInput() {
            if (userInput.Visible && userInput.Required) {
                if (!userInput.IsDetailKey && Empty(userInput.FormValue)) {
                    userInput.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        private void ValidateCustometlDate() {
            if (etlDate.Visible && etlDate.Required) {
                if (!etlDate.IsDetailKey && Empty(etlDate.FormValue)) {
                    etlDate.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLastUpdatedBy() {
            if (LastUpdatedBy.Visible && LastUpdatedBy.Required) {
                if (!LastUpdatedBy.IsDetailKey && Empty(LastUpdatedBy.FormValue)) {
                    LastUpdatedBy.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        private void ValidateCustomlastUpdatedDate() {
            if (lastUpdatedDate.Visible && lastUpdatedDate.Required) {
                if (!lastUpdatedDate.IsDetailKey && Empty(lastUpdatedDate.FormValue)) {
                    lastUpdatedDate.AddErrorMessage(ConvertToString(SubAktivitasHasilPemeriksaanId.RequiredErrorMessage).Replace("%s", SubAktivitasHasilPemeriksaanId.Caption));
                }
            }
        }
        ...
        protected Dictionary<string, object> GetAddRow()
        {
            try {
                ...
                // Nama_Kapal
                Nama_Kapal.SetDbValue(rsnew, Nama_Kapal.CurrentValue);

                // Tanggal
                Tanggal.SetDbValue(rsnew, ConvertToDateTime(Tanggal.CurrentValue, Tanggal.FormatPattern));

                // Nama_Kegiatan
                Nama_Kegiatan.SetDbValue(rsnew, Nama_Kegiatan.CurrentValue);
                ...
                // Temperatur
                Temperatur.SetDbValue(rsnew, Temperatur.CurrentValue);
                ...
                // SubAktivitasHasilPemeriksaanId
                SubAktivitasHasilPemeriksaanId.SetDbValue(rsnew, SubAktivitasHasilPemeriksaanId.CurrentValue);
                return rsnew;
            } catch (Exception e) {
                if (Config.Debug)
                    throw;
        ...
        private void RestoreAddFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("Nama_Kapal", out value)) // Nama_Kapal
                Nama_Kapal.SetFormValue(ConvertToString(value));
            ...
            if (row.TryGetValue("Nama_Kegiatan", out value)) // Nama_Kegiatan
                Nama_Kegiatan.SetFormValue(ConvertToString(value));
            ...
            if (row.TryGetValue("Temperatur", out value)) // Temperatur
                Temperatur.SetFormValue(ConvertToString(value));
            ...
            if (row.TryGetValue("SubAktivitasHasilPemeriksaanId", out value)) // SubAktivitasHasilPemeriksaanId
                SubAktivitasHasilPemeriksaanId.SetFormValue(ConvertToString(value));
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputLogbookPenerimaanStsPymLpgList")), "", TableVar, true);
