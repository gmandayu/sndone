...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static MasterArea masterArea
    {
        get => HttpData.Resolve<MasterArea>("MasterArea");
        set => HttpData["MasterArea"] = value;
    }

    /// <summary>
    /// Table class for MasterArea
    /// </summary>
    public class MasterArea : DbTable
    {
        ...
        public MasterArea()
        {
            ...
            Name = "MasterArea";
            Type = "TABLE";
            UpdateTable = "dbo.MasterArea"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new(this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterArea", "ID", "CustomMsg"),
                IsUpload = false
            };
            ID.Raw = true;
            Fields.Add("ID", ID);
            ...
            Area = new(this, "x_Area", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MasterArea", "Area", "CustomMsg"),
                IsUpload = false
            };
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MasterArea type", "data");
            row = row.Where(kvp => {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MasterAreaView" => Language.Phrase("View"),
                "MasterAreaEdit" => Language.Phrase("Edit"),
                "MasterAreaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MasterAreaView",
                Config.ApiAddAction => "MasterAreaAdd",
                Config.ApiEditAction => "MasterAreaEdit",
                Config.ApiDeleteAction => "MasterAreaDelete",
                Config.ApiListAction => "MasterAreaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MasterAreaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MasterAreaView", parm);
            else
                url = KeyUrl("MasterAreaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MasterAreaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MasterAreaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterAreaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MasterAreaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterAreaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MasterAreaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "MasterAreaList";
