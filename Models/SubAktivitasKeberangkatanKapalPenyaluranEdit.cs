...
public partial class SnDOne {
    ...
    public class SubAktivitasKeberangkatanKapalPenyaluranEditBase : SubAktivitasKeberangkatanKapalPenyaluran
    {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranEditBase()
        {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasKeberangkatanKapalPenyaluranList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanKapalPenyaluranList") {
                                ...
                                returnUrl = "SubAktivitasKeberangkatanKapalPenyaluranList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
