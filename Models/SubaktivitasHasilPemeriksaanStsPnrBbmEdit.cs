...
public partial class SnDOne {
    ...
    public class SubaktivitasHasilPemeriksaanStsPnrBbmEditBase : SubaktivitasHasilPemeriksaanStsPnrBbm
    {
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanStsPnrBbmEditBase()
        {
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanStsPnrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasHasilPemeriksaanStsPnrBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasHasilPemeriksaanStsPnrBbmList") {
                                ...
                                returnUrl = "SubaktivitasHasilPemeriksaanStsPnrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
