...
public partial class SnDOne {
    /// <summary>
    /// subAkivitasNilaiAktualDischargePipa
    /// </summary>
    [MaybeNull]
    public static SubAkivitasNilaiAktualDischargePipa subAkivitasNilaiAktualDischargePipa
    {
        get => HttpData.Resolve<SubAkivitasNilaiAktualDischargePipa>("SubAkivitasNilaiAktualDischargePipa");
        set => HttpData["SubAkivitasNilaiAktualDischargePipa"] = value;
    }

    /// <summary>
    /// Table class for SubAkivitasNilaiAktualDischargePipa
    /// </summary>
    public class SubAkivitasNilaiAktualDischargePipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> AktualDischarge_klobs;

        public readonly DbField<SqlDbType> AktualDischarge_kl15;

        public readonly DbField<SqlDbType> AktualDischarge_barrels;

        public readonly DbField<SqlDbType> AktualDischarge_lt;

        public readonly DbField<SqlDbType> AktualDischarge_mt;
        ...
        // Constructor
        public SubAkivitasNilaiAktualDischargePipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAkivitasNilaiAktualDischargePipa";
            Name = "SubAkivitasNilaiAktualDischargePipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubAkivitasNilaiAktualDischargePipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            AktualDischarge_klobs = new(this, "x_AktualDischarge_klobs", 202, SqlDbType.NVarChar) {
                Name = "AktualDischarge_klobs",
                Expression = "[AktualDischarge_klobs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AktualDischarge_klobs]",
                DateTimeFormat = -1,
                VirtualExpression = "[AktualDischarge_klobs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "AktualDischarge_klobs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AktualDischarge_klobs", AktualDischarge_klobs);

            // AktualDischarge_kl15
            AktualDischarge_kl15 = new(this, "x_AktualDischarge_kl15", 202, SqlDbType.NVarChar) {
                Name = "AktualDischarge_kl15",
                Expression = "[AktualDischarge_kl15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AktualDischarge_kl15]",
                DateTimeFormat = -1,
                VirtualExpression = "[AktualDischarge_kl15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "AktualDischarge_kl15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AktualDischarge_kl15", AktualDischarge_kl15);

            // AktualDischarge_barrels
            AktualDischarge_barrels = new(this, "x_AktualDischarge_barrels", 202, SqlDbType.NVarChar) {
                Name = "AktualDischarge_barrels",
                Expression = "[AktualDischarge_barrels]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AktualDischarge_barrels]",
                DateTimeFormat = -1,
                VirtualExpression = "[AktualDischarge_barrels]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "AktualDischarge_barrels", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AktualDischarge_barrels", AktualDischarge_barrels);

            // AktualDischarge_lt
            AktualDischarge_lt = new(this, "x_AktualDischarge_lt", 202, SqlDbType.NVarChar) {
                Name = "AktualDischarge_lt",
                Expression = "[AktualDischarge_lt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AktualDischarge_lt]",
                DateTimeFormat = -1,
                VirtualExpression = "[AktualDischarge_lt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "AktualDischarge_lt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AktualDischarge_lt", AktualDischarge_lt);

            // AktualDischarge_mt
            AktualDischarge_mt = new(this, "x_AktualDischarge_mt", 202, SqlDbType.NVarChar) {
                Name = "AktualDischarge_mt",
                Expression = "[AktualDischarge_mt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AktualDischarge_mt]",
                DateTimeFormat = -1,
                VirtualExpression = "[AktualDischarge_mt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "AktualDischarge_mt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AktualDischarge_mt", AktualDischarge_mt);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipa", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAkivitasNilaiAktualDischargePipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAkivitasNilaiAktualDischargePipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                AktualDischarge_klobs.DbValue = row["AktualDischarge_klobs"]; // Set DB value only
                AktualDischarge_kl15.DbValue = row["AktualDischarge_kl15"]; // Set DB value only
                AktualDischarge_barrels.DbValue = row["AktualDischarge_barrels"]; // Set DB value only
                AktualDischarge_lt.DbValue = row["AktualDischarge_lt"]; // Set DB value only
                AktualDischarge_mt.DbValue = row["AktualDischarge_mt"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAkivitasNilaiAktualDischargePipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAkivitasNilaiAktualDischargePipaView" => Language.Phrase("View"),
                "SubAkivitasNilaiAktualDischargePipaEdit" => Language.Phrase("Edit"),
                "SubAkivitasNilaiAktualDischargePipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAkivitasNilaiAktualDischargePipaView",
                Config.ApiAddAction => "SubAkivitasNilaiAktualDischargePipaAdd",
                Config.ApiEditAction => "SubAkivitasNilaiAktualDischargePipaEdit",
                Config.ApiDeleteAction => "SubAkivitasNilaiAktualDischargePipaDelete",
                Config.ApiListAction => "SubAkivitasNilaiAktualDischargePipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAkivitasNilaiAktualDischargePipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAkivitasNilaiAktualDischargePipaView", parm);
            else
                url = KeyUrl("SubAkivitasNilaiAktualDischargePipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAkivitasNilaiAktualDischargePipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAkivitasNilaiAktualDischargePipaAdd?" + parm;
            else
                url = "SubAkivitasNilaiAktualDischargePipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAkivitasNilaiAktualDischargePipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAkivitasNilaiAktualDischargePipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAkivitasNilaiAktualDischargePipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAkivitasNilaiAktualDischargePipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAkivitasNilaiAktualDischargePipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAkivitasNilaiAktualDischargePipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            AktualDischarge_klobs.EditValue = AktualDischarge_klobs.CurrentValue;
            ...
            AktualDischarge_kl15.EditValue = AktualDischarge_kl15.CurrentValue;
            ...
            AktualDischarge_barrels.EditValue = AktualDischarge_barrels.CurrentValue;
            ...
            AktualDischarge_lt.EditValue = AktualDischarge_lt.CurrentValue;
            ...
            AktualDischarge_mt.EditValue = AktualDischarge_mt.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(AktualDischarge_klobs);
                        doc.ExportCaption(AktualDischarge_kl15);
                        doc.ExportCaption(AktualDischarge_barrels);
                        doc.ExportCaption(AktualDischarge_lt);
                        doc.ExportCaption(AktualDischarge_mt);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(AktualDischarge_klobs);
                            await doc.ExportField(AktualDischarge_kl15);
                            await doc.ExportField(AktualDischarge_barrels);
                            await doc.ExportField(AktualDischarge_lt);
                            await doc.ExportField(AktualDischarge_mt);
