...
public partial class SnDOne {
    ...
    public class UserLevelsListBase : UserLevels
    {
        ...
        public void ShowFilterList()
        {
            ...
            // Field UserLevelName
            filter = QueryBuilderWhere("UserLevelName");
            if (Empty(filter))
                BuildSearchSql(ref filter, UserLevelName, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + UserLevelName.Caption + "</span>" + captionSuffix + filter + "</div>";
            if (!Empty(BasicSearch.Keyword))
        ...
        protected void LoadSearchValues() {
            ...
            // UserLevelName
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_UserLevelName[]"))
