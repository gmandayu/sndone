...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStopPembongkaranPipa
    /// </summary>
    [MaybeNull]
    public static SubAktivitasDataStopPembongkaranPipa subAktivitasDataStopPembongkaranPipa
    {
        get => HttpData.Resolve<SubAktivitasDataStopPembongkaranPipa>("SubAktivitasDataStopPembongkaranPipa");
        set => HttpData["SubAktivitasDataStopPembongkaranPipa"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasDataStopPembongkaranPipa
    /// </summary>
    public class SubAktivitasDataStopPembongkaranPipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> tglStopBongkar;
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasDataStopPembongkaranPipa";
            Name = "SubAktivitasDataStopPembongkaranPipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasDataStopPembongkaranPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStopPembongkaranPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStopPembongkaranPipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStopPembongkaranPipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStopPembongkaranPipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStopPembongkaranPipa", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStopPembongkaranPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStopPembongkaranPipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            // tglStopBongkar
            tglStopBongkar = new(this, "x_tglStopBongkar", 135, SqlDbType.DateTime) {
                Name = "tglStopBongkar",
                Expression = "[tglStopBongkar]",
                BasicSearchExpression = CastDateFieldForLike("[tglStopBongkar]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[tglStopBongkar]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStopPembongkaranPipa", "tglStopBongkar", "CustomMsg"),
                IsUpload = false
            };
            tglStopBongkar.Raw = true;
            Fields.Add("tglStopBongkar", tglStopBongkar);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStopPembongkaranPipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStopPembongkaranPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasDataStopPembongkaranPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasDataStopPembongkaranPipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                tglStopBongkar.DbValue = row["tglStopBongkar"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasDataStopPembongkaranPipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasDataStopPembongkaranPipaView" => Language.Phrase("View"),
                "SubAktivitasDataStopPembongkaranPipaEdit" => Language.Phrase("Edit"),
                "SubAktivitasDataStopPembongkaranPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasDataStopPembongkaranPipaView",
                Config.ApiAddAction => "SubAktivitasDataStopPembongkaranPipaAdd",
                Config.ApiEditAction => "SubAktivitasDataStopPembongkaranPipaEdit",
                Config.ApiDeleteAction => "SubAktivitasDataStopPembongkaranPipaDelete",
                Config.ApiListAction => "SubAktivitasDataStopPembongkaranPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasDataStopPembongkaranPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasDataStopPembongkaranPipaView", parm);
            else
                url = KeyUrl("SubAktivitasDataStopPembongkaranPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasDataStopPembongkaranPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasDataStopPembongkaranPipaAdd?" + parm;
            else
                url = "SubAktivitasDataStopPembongkaranPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataStopPembongkaranPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataStopPembongkaranPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataStopPembongkaranPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataStopPembongkaranPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasDataStopPembongkaranPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasDataStopPembongkaranPipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // tglStopBongkar
            tglStopBongkar.SetupEditAttributes();
            tglStopBongkar.EditValue = FormatDateTime(tglStopBongkar.CurrentValue, tglStopBongkar.FormatPattern);
            tglStopBongkar.PlaceHolder = RemoveHtml(tglStopBongkar.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(tglStopBongkar);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(tglStopBongkar);
