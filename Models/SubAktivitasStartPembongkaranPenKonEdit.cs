...
public partial class SnDOne {
    ...
    public class SubAktivitasStartPembongkaranPenKonEditBase : SubAktivitasStartPembongkaranPenKon
    {
        ...
        // Constructor
        public SubAktivitasStartPembongkaranPenKonEditBase()
        {
        ...
        // Constructor
        public SubAktivitasStartPembongkaranPenKonEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasStartPembongkaranPenKonList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasStartPembongkaranPenKonList") {
                                ...
                                returnUrl = "SubAktivitasStartPembongkaranPenKonList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
