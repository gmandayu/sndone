...
public partial class SnDOne {
    /// <summary>
    /// formInputGoodHouseKeepingDelete
    /// </summary>
    public static FormInputGoodHouseKeepingDelete formInputGoodHouseKeepingDelete
    {
        get => HttpData.Get<FormInputGoodHouseKeepingDelete>("formInputGoodHouseKeepingDelete")!;
        set => HttpData["formInputGoodHouseKeepingDelete"] = value;
    }

    /// <summary>
    /// Page class for FormInputGoodHouseKeeping
    /// </summary>
    public class FormInputGoodHouseKeepingDelete : FormInputGoodHouseKeepingDeleteBase
    {
        // Constructor
        public FormInputGoodHouseKeepingDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public FormInputGoodHouseKeepingDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class FormInputGoodHouseKeepingDeleteBase : FormInputGoodHouseKeeping
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "formInputGoodHouseKeepingDelete";
        ...
        // Constructor
        public FormInputGoodHouseKeepingDeleteBase()
        {
        ...
        // Page name
        public string PageName => "FormInputGoodHouseKeepingDelete";
        ...
        // Constructor
        public FormInputGoodHouseKeepingDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("FormInputGoodHouseKeepingList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("FormInputGoodHouseKeepingList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                formInputGoodHouseKeepingDelete?.PageRender();
            }
            return PageResult();
        }
