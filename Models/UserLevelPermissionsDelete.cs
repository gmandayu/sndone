...
public partial class SnDOne {
    /// <summary>
    /// userLevelPermissionsDelete
    /// </summary>
    public static UserLevelPermissionsDelete userLevelPermissionsDelete
    {
        get => HttpData.Get<UserLevelPermissionsDelete>("userLevelPermissionsDelete")!;
        set => HttpData["userLevelPermissionsDelete"] = value;
    }

    /// <summary>
    /// Page class for UserLevelPermissions
    /// </summary>
    public class UserLevelPermissionsDelete : UserLevelPermissionsDeleteBase
    {
        // Constructor
        public UserLevelPermissionsDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public UserLevelPermissionsDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class UserLevelPermissionsDeleteBase : UserLevelPermissions
    {
        // Page ID
        ...
        // Constructor
        public UserLevelPermissionsDeleteBase()
        {
        ...
        // Constructor
        public UserLevelPermissionsDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("UserLevelPermissionsList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("UserLevelPermissionsList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                userLevelPermissionsDelete?.PageRender();
            }
            return PageResult();
        }
