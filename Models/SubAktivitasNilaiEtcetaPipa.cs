...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiEtcetaPipa
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiEtcetaPipa subAktivitasNilaiEtcetaPipa
    {
        get => HttpData.Resolve<SubAktivitasNilaiEtcetaPipa>("SubAktivitasNilaiETCETAPipa");
        set => HttpData["SubAktivitasNilaiETCETAPipa"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiETCETAPipa
    /// </summary>
    public class SubAktivitasNilaiEtcetaPipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> IsiPipa;

        public readonly DbField<SqlDbType> IsiPipa2;

        public readonly DbField<SqlDbType> IsiPipa3;

        public readonly DbField<SqlDbType> Flowrate;

        public readonly DbField<SqlDbType> LamaPengisian;

        public readonly DbField<SqlDbType> LamaPengiriman;

        public readonly DbField<SqlDbType> LamaPengiriman2;

        public readonly DbField<SqlDbType> LamaPengiriman3;

        public readonly DbField<SqlDbType> ETC;

        public readonly DbField<SqlDbType> ETA;

        public readonly DbField<SqlDbType> ETA2;

        public readonly DbField<SqlDbType> ETA3;
        ...
        // Constructor
        public SubAktivitasNilaiEtcetaPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiETCETAPipa";
            Name = "SubAktivitasNilaiETCETAPipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiETCETAPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            // IsiPipa
            IsiPipa = new(this, "x_IsiPipa", 202, SqlDbType.NVarChar) {
                Name = "IsiPipa",
                Expression = "[IsiPipa]",
                UseBasicSearch = true,
                BasicSearchExpression = "[IsiPipa]",
                DateTimeFormat = -1,
                VirtualExpression = "[IsiPipa]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "IsiPipa", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("IsiPipa", IsiPipa);

            // IsiPipa2
            IsiPipa2 = new(this, "x_IsiPipa2", 202, SqlDbType.NVarChar) {
                Name = "IsiPipa2",
                Expression = "[IsiPipa2]",
                UseBasicSearch = true,
                BasicSearchExpression = "[IsiPipa2]",
                DateTimeFormat = -1,
                VirtualExpression = "[IsiPipa2]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "IsiPipa2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("IsiPipa2", IsiPipa2);

            // IsiPipa3
            IsiPipa3 = new(this, "x_IsiPipa3", 202, SqlDbType.NVarChar) {
                Name = "IsiPipa3",
                Expression = "[IsiPipa3]",
                UseBasicSearch = true,
                BasicSearchExpression = "[IsiPipa3]",
                DateTimeFormat = -1,
                VirtualExpression = "[IsiPipa3]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "IsiPipa3", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("IsiPipa3", IsiPipa3);
            ...
            Flowrate = new(this, "x_Flowrate", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "Flowrate", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Flowrate", Flowrate);

            // LamaPengisian
            LamaPengisian = new(this, "x_LamaPengisian", 202, SqlDbType.NVarChar) {
                Name = "LamaPengisian",
                Expression = "[LamaPengisian]",
                UseBasicSearch = true,
                BasicSearchExpression = "[LamaPengisian]",
                DateTimeFormat = -1,
                VirtualExpression = "[LamaPengisian]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "LamaPengisian", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LamaPengisian", LamaPengisian);

            // LamaPengiriman
            LamaPengiriman = new(this, "x_LamaPengiriman", 202, SqlDbType.NVarChar) {
                Name = "LamaPengiriman",
                Expression = "[LamaPengiriman]",
                UseBasicSearch = true,
                BasicSearchExpression = "[LamaPengiriman]",
                DateTimeFormat = -1,
                VirtualExpression = "[LamaPengiriman]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "LamaPengiriman", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LamaPengiriman", LamaPengiriman);

            // LamaPengiriman2
            LamaPengiriman2 = new(this, "x_LamaPengiriman2", 202, SqlDbType.NVarChar) {
                Name = "LamaPengiriman2",
                Expression = "[LamaPengiriman2]",
                UseBasicSearch = true,
                BasicSearchExpression = "[LamaPengiriman2]",
                DateTimeFormat = -1,
                VirtualExpression = "[LamaPengiriman2]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "LamaPengiriman2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LamaPengiriman2", LamaPengiriman2);

            // LamaPengiriman3
            LamaPengiriman3 = new(this, "x_LamaPengiriman3", 202, SqlDbType.NVarChar) {
                Name = "LamaPengiriman3",
                Expression = "[LamaPengiriman3]",
                UseBasicSearch = true,
                BasicSearchExpression = "[LamaPengiriman3]",
                DateTimeFormat = -1,
                VirtualExpression = "[LamaPengiriman3]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "LamaPengiriman3", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LamaPengiriman3", LamaPengiriman3);

            // ETC
            ETC = new(this, "x_ETC", 135, SqlDbType.DateTime) {
                Name = "ETC",
                Expression = "[ETC]",
                BasicSearchExpression = CastDateFieldForLike("[ETC]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[ETC]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "ETC", "CustomMsg"),
                IsUpload = false
            };
            ETC.Raw = true;
            Fields.Add("ETC", ETC);
            ...
            // ETA
            ETA = new(this, "x_ETA", 135, SqlDbType.DateTime) {
                Name = "ETA",
                Expression = "[ETA]",
                BasicSearchExpression = CastDateFieldForLike("[ETA]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[ETA]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "ETA", "CustomMsg"),
                IsUpload = false
            };
            ETA.Raw = true;
            Fields.Add("ETA", ETA);
            ...
            // ETA2
            ETA2 = new(this, "x_ETA2", 135, SqlDbType.DateTime) {
                Name = "ETA2",
                Expression = "[ETA2]",
                BasicSearchExpression = CastDateFieldForLike("[ETA2]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[ETA2]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "ETA2", "CustomMsg"),
                IsUpload = false
            };
            ETA2.Raw = true;
            Fields.Add("ETA2", ETA2);

            // ETA3
            ETA3 = new(this, "x_ETA3", 135, SqlDbType.DateTime) {
                Name = "ETA3",
                Expression = "[ETA3]",
                BasicSearchExpression = CastDateFieldForLike("[ETA3]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[ETA3]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "ETA3", "CustomMsg"),
                IsUpload = false
            };
            ETA3.Raw = true;
            Fields.Add("ETA3", ETA3);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiETCETAPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiETCETAPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiEtcetapipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                IsiPipa.DbValue = row["IsiPipa"]; // Set DB value only
                IsiPipa2.DbValue = row["IsiPipa2"]; // Set DB value only
                IsiPipa3.DbValue = row["IsiPipa3"]; // Set DB value only
                Flowrate.DbValue = row["Flowrate"]; // Set DB value only
                LamaPengisian.DbValue = row["LamaPengisian"]; // Set DB value only
                LamaPengiriman.DbValue = row["LamaPengiriman"]; // Set DB value only
                LamaPengiriman2.DbValue = row["LamaPengiriman2"]; // Set DB value only
                LamaPengiriman3.DbValue = row["LamaPengiriman3"]; // Set DB value only
                ETC.DbValue = row["ETC"]; // Set DB value only
                ETA.DbValue = row["ETA"]; // Set DB value only
                ETA2.DbValue = row["ETA2"]; // Set DB value only
                ETA3.DbValue = row["ETA3"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiEtcetaPipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiEtcetaPipaView" => Language.Phrase("View"),
                "SubAktivitasNilaiEtcetaPipaEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiEtcetaPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiEtcetaPipaView",
                Config.ApiAddAction => "SubAktivitasNilaiEtcetaPipaAdd",
                Config.ApiEditAction => "SubAktivitasNilaiEtcetaPipaEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiEtcetaPipaDelete",
                Config.ApiListAction => "SubAktivitasNilaiEtcetaPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiEtcetaPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiEtcetaPipaView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiEtcetaPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiEtcetaPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiEtcetaPipaAdd?" + parm;
            else
                url = "SubAktivitasNilaiEtcetaPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiEtcetaPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiEtcetaPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiEtcetaPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiEtcetaPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiEtcetaPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiEtcetaPipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            IsiPipa.EditValue = IsiPipa.CurrentValue;
            ...
            IsiPipa2.EditValue = IsiPipa2.CurrentValue;
            ...
            IsiPipa3.EditValue = IsiPipa3.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(IsiPipa);
                        doc.ExportCaption(IsiPipa2);
                        doc.ExportCaption(IsiPipa3);
                        doc.ExportCaption(Flowrate);
                        doc.ExportCaption(LamaPengisian);
                        doc.ExportCaption(LamaPengiriman);
                        doc.ExportCaption(LamaPengiriman2);
                        doc.ExportCaption(LamaPengiriman3);
                        doc.ExportCaption(ETC);
                        doc.ExportCaption(ETA);
                        doc.ExportCaption(ETA2);
                        doc.ExportCaption(ETA3);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(IsiPipa);
                            await doc.ExportField(IsiPipa2);
                            await doc.ExportField(IsiPipa3);
                            await doc.ExportField(Flowrate);
                            await doc.ExportField(LamaPengisian);
                            await doc.ExportField(LamaPengiriman);
                            await doc.ExportField(LamaPengiriman2);
                            await doc.ExportField(LamaPengiriman3);
                            await doc.ExportField(ETC);
                            await doc.ExportField(ETA);
                            await doc.ExportField(ETA2);
                            await doc.ExportField(ETA3);
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            try {
                ...
                var anakList = new List<(int index, string id, string isiPipa)>();
                foreach (var key in HttpContext.Request.Form.Keys)
                {
                    if (key.StartsWith("anak[") && key.EndsWith("].IsiPipa"))
                    {
                        ...
                        if (start > 0 && end > start)
                        {
                            ...
                            {
                                string isiPipa = HttpContext.Request.Form[key].ToString();
                                string idKey = $"anak[{idx}].id";
                                string id = HttpContext.Request.Form.ContainsKey(idKey)
                                    ? HttpContext.Request.Form[idKey].ToString()
                                    : "";
                                anakList.Add((idx, id, isiPipa));
                            }
                        }
                    }
                }
                anakList = anakList.OrderBy(x => x.index).ToList();
                string updateQuery = @"
                ...
                using (SqlConnection sqlConnection = GetConnection("Db").OpenConnection())
                {
                    foreach (var item in anakList)
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(updateQuery, sqlConnection))
                        {
                            ...
                            if (decimal.TryParse(item.isiPipa, out decimal isiPipaDecimal))
                                cmd.Parameters.AddWithValue("@IsiPipa", isiPipaDecimal);
                            else
                                cmd.Parameters.AddWithValue("@IsiPipa", DBNull.Value);
                            cmd.ExecuteNonQuery();
                        }
                    }
                }
