...
public partial class SnDOne {
    ...
    public class MasterPlantListBase : MasterPlant
    {
        ...
        // Constructor
        public MasterPlantListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public void ShowFilterList()
        {
            ...
            // Field Terminal_Manager
            filter = QueryBuilderWhere("Terminal_Manager");
            if (Empty(filter))
                BuildSearchSql(ref filter, Terminal_Manager, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + Terminal_Manager.Caption + "</span>" + captionSuffix + filter + "</div>";

            // Field PRL
            filter = QueryBuilderWhere("PRL");
            if (Empty(filter))
                BuildSearchSql(ref filter, PRL, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + PRL.Caption + "</span>" + captionSuffix + filter + "</div>";
            ...
            // Field Terminal_Induk
            filter = QueryBuilderWhere("Terminal_Induk");
            if (Empty(filter))
                BuildSearchSql(ref filter, Terminal_Induk, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + Terminal_Induk.Caption + "</span>" + captionSuffix + filter + "</div>";

            // Field Nama_Terminal
            filter = QueryBuilderWhere("Nama_Terminal");
            if (Empty(filter))
                BuildSearchSql(ref filter, Nama_Terminal, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + Nama_Terminal.Caption + "</span>" + captionSuffix + filter + "</div>";
            ...
            // Field Cost_Center
            filter = QueryBuilderWhere("Cost_Center");
            if (Empty(filter))
                BuildSearchSql(ref filter, Cost_Center, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + Cost_Center.Caption + "</span>" + captionSuffix + filter + "</div>";

            // Field Jenis
            filter = QueryBuilderWhere("Jenis");
            if (Empty(filter))
                BuildSearchSql(ref filter, Jenis, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + Jenis.Caption + "</span>" + captionSuffix + filter + "</div>";
            ...
            // Field UTC
            filter = QueryBuilderWhere("UTC");
            if (Empty(filter))
                BuildSearchSql(ref filter, UTC, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + UTC.Caption + "</span>" + captionSuffix + filter + "</div>";

            // Field TipeProduk
            filter = QueryBuilderWhere("TipeProduk");
            if (Empty(filter))
                BuildSearchSql(ref filter, TipeProduk, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + TipeProduk.Caption + "</span>" + captionSuffix + filter + "</div>";
        ...
        protected void LoadSearchValues() {
            ...
            // Terminal_Manager
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_Terminal_Manager[]"))
            ...
            // Terminal_Induk
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_Terminal_Induk[]"))
            ...
            // Nama_Terminal
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_Nama_Terminal[]"))
            ...
            // Cost_Center
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_Cost_Center[]"))
            ...
            // TipeProduk
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_TipeProduk[]"))
