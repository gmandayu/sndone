...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputDataKapalStsPyrBbmEdit
    /// </summary>
    public static SubAktivitasInputDataKapalStsPyrBbmEdit subAktivitasInputDataKapalStsPyrBbmEdit
    {
        get => HttpData.Get<SubAktivitasInputDataKapalStsPyrBbmEdit>("subAktivitasInputDataKapalStsPyrBbmEdit")!;
        set => HttpData["subAktivitasInputDataKapalStsPyrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasInputDataKapalSTSPyrBBM
    /// </summary>
    public class SubAktivitasInputDataKapalStsPyrBbmEdit : SubAktivitasInputDataKapalStsPyrBbmEditBase
    {
        // Constructor
        public SubAktivitasInputDataKapalStsPyrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasInputDataKapalStsPyrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasInputDataKapalStsPyrBbmEditBase : SubAktivitasInputDataKapalStsPyrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasInputDataKapalStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasInputDataKapalStsPyrBbmEditBase(Controller? controller)
        {
            TableName = "SubAktivitasInputDataKapalSTSPyrBBM";
        ...
        if (controller != null)
            ...
            // Table object (subAktivitasInputDataKapalStsPyrBbm)
            if (subAktivitasInputDataKapalStsPyrBbm == null || subAktivitasInputDataKapalStsPyrBbm is SubAktivitasInputDataKapalStsPyrBbm)
                subAktivitasInputDataKapalStsPyrBbm = this;
        ...
        // Page name
        public string PageName => "SubAktivitasInputDataKapalStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasInputDataKapalStsPyrBbmEditBase() : this(null) { }
            ...
            string pageName = GetPageName(url);
                ...
                // List / View / Master View page
                    if (!SameString(pageName, ListUrl))
                    {
                        ...
                        result.Add("view", pageName == "SubAktivitasInputDataKapalStsPyrBbmView" ? "1" : "0"); // If View page, no primary button
                    }
                    else
                    {
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasInputDataKapalStsPyrBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasInputDataKapalStsPyrBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasInputDataKapalStsPyrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasInputDataKapalStsPyrBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void ValidateCustomNoReferensi() {
            if (NoReferensi.Visible && NoReferensi.Required) {
                if (!NoReferensi.IsDetailKey && Empty(NoReferensi.FormValue)) {
                    NoReferensi.AddErrorMessage(ConvertToString(TanggalTiba.RequiredErrorMessage).Replace("%s", TanggalTiba.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidProses() {
            if (idProses.Visible && idProses.Required) {
                if (!idProses.IsDetailKey && Empty(idProses.FormValue)) {
                    idProses.AddErrorMessage(ConvertToString(TanggalTiba.RequiredErrorMessage).Replace("%s", TanggalTiba.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidAktifitas() {
            if (idAktifitas.Visible && idAktifitas.Required) {
                if (!idAktifitas.IsDetailKey && Empty(idAktifitas.FormValue)) {
                    idAktifitas.AddErrorMessage(ConvertToString(TanggalTiba.RequiredErrorMessage).Replace("%s", TanggalTiba.Caption));
                }
            }
        }
        ...
        private void ValidateCustomStatusAktivitas() {
            if (StatusAktivitas.Visible && StatusAktivitas.Required) {
                if (!StatusAktivitas.IsDetailKey && Empty(StatusAktivitas.FormValue)) {
                    StatusAktivitas.AddErrorMessage(ConvertToString(TanggalTiba.RequiredErrorMessage).Replace("%s", TanggalTiba.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLastUpdatedBy() {
            if (LastUpdatedBy.Visible && LastUpdatedBy.Required) {
                if (!LastUpdatedBy.IsDetailKey && Empty(LastUpdatedBy.FormValue)) {
                    LastUpdatedBy.AddErrorMessage(ConvertToString(TanggalTiba.RequiredErrorMessage).Replace("%s", TanggalTiba.Caption));
                }
            }
        }
        ...
        private void ValidateCustomlastUpdatedDate() {
            if (lastUpdatedDate.Visible && lastUpdatedDate.Required) {
                if (!lastUpdatedDate.IsDetailKey && Empty(lastUpdatedDate.FormValue)) {
                    lastUpdatedDate.AddErrorMessage(ConvertToString(TanggalTiba.RequiredErrorMessage).Replace("%s", TanggalTiba.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNamaKapal() {
            if (NamaKapal.Visible && NamaKapal.Required) {
                if (!NamaKapal.IsDetailKey && Empty(NamaKapal.FormValue)) {
                    NamaKapal.AddErrorMessage(ConvertToString(TanggalTiba.RequiredErrorMessage).Replace("%s", TanggalTiba.Caption));
                }
            }
        }
        ...
        private void ValidateCustomJenisProduk() {
            if (JenisProduk.Visible && JenisProduk.Required) {
                if (!JenisProduk.IsDetailKey && Empty(JenisProduk.FormValue)) {
                    JenisProduk.AddErrorMessage(ConvertToString(TanggalTiba.RequiredErrorMessage).Replace("%s", TanggalTiba.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNominasi() {
            if (Nominasi.Visible && Nominasi.Required) {
                if (!Nominasi.IsDetailKey && Empty(Nominasi.FormValue)) {
                    Nominasi.AddErrorMessage(ConvertToString(TanggalTiba.RequiredErrorMessage).Replace("%s", TanggalTiba.Caption));
                }
            }
        }
        ...
        private void ValidateCustomVoyageNumber() {
            if (VoyageNumber.Visible && VoyageNumber.Required) {
                if (!VoyageNumber.IsDetailKey && Empty(VoyageNumber.FormValue)) {
                    VoyageNumber.AddErrorMessage(ConvertToString(TanggalTiba.RequiredErrorMessage).Replace("%s", TanggalTiba.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasInputDataKapalStsPyrBbmList")), "", TableVar, true);
            string pageId = "edit";
