...
public partial class SnDOne {
    ...
    public class TemplateAktivitasViewBase : TemplateAktivitas
    {
        ...
        // Constructor
        public TemplateAktivitasViewBase(Controller? controller)
        {
        ...
        // Constructor
        public TemplateAktivitasViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdTemplateAktivitas", out v) && !Empty(v))
                {
                IdTemplateAktivitas.QueryValue = UrlDecode(v);
                RecordKeys["IdTemplateAktivitas"] = IdTemplateAktivitas.QueryValue;
                return;
                }
                if (Get("IdTemplateAktivitas", out sv))
                {
