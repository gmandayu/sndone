...
public partial class SnDOne {
    ...
    /// goodHouseKeepingAdd
    /// </summary>
    public static GoodHouseKeepingAdd goodHouseKeepingAdd
    {
        get => HttpData.Get<GoodHouseKeepingAdd>("goodHouseKeepingAdd")!;
        set => HttpData["goodHouseKeepingAdd"] = value;
    }

    /// <summary>
    /// Page class for GoodHouseKeeping
    /// </summary>
    public class GoodHouseKeepingAdd : GoodHouseKeepingAddBase
    {
        // Constructor
        public GoodHouseKeepingAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public GoodHouseKeepingAdd() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class GoodHouseKeepingAddBase : GoodHouseKeeping
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "goodHouseKeepingAdd";
        ...
        // Constructor
        public GoodHouseKeepingAddBase()
        {
        ...
        // Page name
        public string PageName => "GoodHouseKeepingAdd";
        ...
        // Constructor
        public GoodHouseKeepingAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("GoodHouseKeepingList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "GoodHouseKeepingView")
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                goodHouseKeepingAdd?.PageRender();
            }
            return PageResult();
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                if (!NomorGoodHouseKeeping.Raw)
                    NomorGoodHouseKeeping.CurrentValue = HtmlDecode(NomorGoodHouseKeeping.CurrentValue);
                NomorGoodHouseKeeping.EditValue = HtmlEncode(NomorGoodHouseKeeping.CurrentValue);
                NomorGoodHouseKeeping.PlaceHolder = RemoveHtml(NomorGoodHouseKeeping.Caption);
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            if (insertRow) {
                try {
                    ...
                    rsnew["IdGoodHouseKeeping"] = IdGoodHouseKeeping.CurrentValue!;
                } catch (Exception e) {
                    if (Config.Debug)
                        throw;
        ...
        protected Dictionary<string, object> GetAddRow()
        {
            try {
                ...
                // NomorGoodHouseKeeping
                NomorGoodHouseKeeping.SetDbValue(rsnew, NomorGoodHouseKeeping.CurrentValue);
        ...
        {
            object? value;
            if (row.TryGetValue("NomorGoodHouseKeeping", out value)) // NomorGoodHouseKeeping
                NomorGoodHouseKeeping.SetFormValue(ConvertToString(value));
