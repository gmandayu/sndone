...
public partial class SnDOne {
    ...
    public class MasterPositionViewBase : MasterPosition
    {
        ...
        // Constructor
        public MasterPositionViewBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterPositionViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdPosition", out v) && !Empty(v))
                {
                IdPosition.QueryValue = UrlDecode(v);
                RecordKeys["IdPosition"] = IdPosition.QueryValue;
                return;
                }
                if (Get("IdPosition", out sv))
                {
