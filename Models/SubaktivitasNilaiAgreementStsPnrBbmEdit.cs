...
public partial class SnDOne {
    ...
    public class SubaktivitasNilaiAgreementStsPnrBbmEditBase : SubaktivitasNilaiAgreementStsPnrBbm
    {
        ...
        // Constructor
        public SubaktivitasNilaiAgreementStsPnrBbmEditBase()
        {
        ...
        // Constructor
        public SubaktivitasNilaiAgreementStsPnrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasNilaiAgreementStsPnrBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasNilaiAgreementStsPnrBbmList") {
                                ...
                                returnUrl = "SubaktivitasNilaiAgreementStsPnrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
