...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static RencanaPenyaluran rencanaPenyaluran
    {
        get => HttpData.Resolve<RencanaPenyaluran>("RencanaPenyaluran");
        set => HttpData["RencanaPenyaluran"] = value;
    }

    /// <summary>
    /// Table class for RencanaPenyaluran
    /// </summary>
    public class RencanaPenyaluran : DbTable
    {
        public override Dictionary<string, string> KeyFields { get; set; } = new() { // DN
            { "IdRencanaPenyaluran", "IdRencanaPenyaluran" },
        };
        ...
        public readonly DbField<SqlDbType> IdRencanaPenyaluran;

        public readonly DbField<SqlDbType> NomorRencanaPenyaluran;
        ...
        // Constructor
        public RencanaPenyaluran()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "RencanaPenyaluran";
            Name = "RencanaPenyaluran";
            Type = "TABLE";
            UpdateTable = "dbo.RencanaPenyaluran"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // IdRencanaPenyaluran
            IdRencanaPenyaluran = new(this, "x_IdRencanaPenyaluran", 3, SqlDbType.Int) {
                Name = "IdRencanaPenyaluran",
                Expression = "[IdRencanaPenyaluran]",
                BasicSearchExpression = "CAST([IdRencanaPenyaluran] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[IdRencanaPenyaluran]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "IdRencanaPenyaluran", "CustomMsg"),
                IsUpload = false
            };
            IdRencanaPenyaluran.Raw = true;
            Fields.Add("IdRencanaPenyaluran", IdRencanaPenyaluran);

            // NomorRencanaPenyaluran
            NomorRencanaPenyaluran = new(this, "x_NomorRencanaPenyaluran", 200, SqlDbType.VarChar) {
                Name = "NomorRencanaPenyaluran",
                Expression = "[NomorRencanaPenyaluran]",
                BasicSearchExpression = "[NomorRencanaPenyaluran]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorRencanaPenyaluran]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "NomorRencanaPenyaluran", "CustomMsg"),
                IsUpload = false
            };
            NomorRencanaPenyaluran.Lookup = new Lookup<DbField>(NomorRencanaPenyaluran, "RencanaPenyaluran", true, "NomorRencanaPenyaluran", new List<string> {"NomorRencanaPenyaluran", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NomorRencanaPenyaluran", NomorRencanaPenyaluran);

            // LinkProses
            LinkProses = new(this, "x_LinkProses", 202, SqlDbType.NVarChar) {
                Name = "LinkProses",
                Expression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorRencanaPenyaluran AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorRencanaPenyaluran AS NVARCHAR(50))+'</a>'",
                UseBasicSearch = true,
                BasicSearchExpression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorRencanaPenyaluran AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorRencanaPenyaluran AS NVARCHAR(50))+'</a>'",
                DateTimeFormat = -1,
                VirtualExpression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorRencanaPenyaluran AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorRencanaPenyaluran AS NVARCHAR(50))+'</a>'",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "LinkProses", "CustomMsg"),
                IsUpload = false
            };
            LinkProses.Lookup = new Lookup<DbField>(LinkProses, "RencanaPenyaluran", true, "LinkProses", new List<string> {"LinkProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            IdPenimbunan = new(this, "x_IdPenimbunan", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "IdPenimbunan", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdTemplate = new(this, "x_IdTemplate", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "IdTemplate", "CustomMsg"),
                IsUpload = false
            };
            IdTemplate.Raw = true;
            ...
            StatusProses = new(this, "x_StatusProses", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "StatusProses", "CustomMsg"),
                IsUpload = false
            };
            StatusProses.Lookup = new Lookup<DbField>(StatusProses, "RencanaPenyaluran", true, "StatusProses", new List<string> {"StatusProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            PersentaseProgress = new(this, "x_PersentaseProgress", 131, SqlDbType.Decimal) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "PersentaseProgress", "CustomMsg"),
                IsUpload = false
            };
            PersentaseProgress.Raw = true;
            PersentaseProgress.Lookup = new Lookup<DbField>(PersentaseProgress, "RencanaPenyaluran", true, "PersentaseProgress", new List<string> {"PersentaseProgress", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LookupPlant = new(this, "x_LookupPlant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "LookupPlant", "CustomMsg"),
                IsUpload = false
            };
            LookupPlant.Raw = true;
            LookupPlant.Lookup = new Lookup<DbField>(LookupPlant, "RencanaPenyaluran", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            IdPlant = new(this, "x_IdPlant", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "IdPlant", "CustomMsg"),
                IsUpload = false
            };
            IdPlant.Raw = true;
            IdPlant.Lookup = new Lookup<DbField>(IdPlant, "MasterPlant", true, "IdPlant", new List<string> {"Plant", "Nama_Terminal", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {"JenisPlant"}, new List<string> {"x_LookupJenisPlant"}, false, "", "", "CONCAT([Plant],'" + ValueSeparator(1, IdPlant) + "',[Nama_Terminal])");
            ...
            TipeProdukSTS = new(this, "x_TipeProdukSTS", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "TipeProdukSTS", "CustomMsg"),
                IsUpload = false
            };
            ...
            // IdModa
            IdModa = new(this, "x_IdModa", 202, SqlDbType.NVarChar) {
                Name = "IdModa",
                Expression = "[IdModa]",
                UseBasicSearch = true,
                BasicSearchExpression = "[IdModa]",
                DateTimeFormat = -1,
            ...
            TipePenyaluran = new(this, "x_TipePenyaluran", 202, SqlDbType.NVarChar) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "TipePenyaluran", "CustomMsg"),
                IsUpload = false
            };
            TipePenyaluran.Lookup = new Lookup<DbField>(TipePenyaluran, "RencanaPenyaluran", true, "TipePenyaluran", new List<string> {"TipePenyaluran", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            KategoriPenyaluran = new(this, "x_KategoriPenyaluran", 202, SqlDbType.NVarChar) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "KategoriPenyaluran", "CustomMsg"),
                IsUpload = false
            };
            KategoriPenyaluran.Lookup = new Lookup<DbField>(KategoriPenyaluran, "RencanaPenyaluran", true, "KategoriPenyaluran", new List<string> {"KategoriPenyaluran", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Tujuan = new(this, "x_Tujuan", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "Tujuan", "CustomMsg"),
                IsUpload = false
            };
            Tujuan.Lookup = new Lookup<DbField>(Tujuan, "RencanaPenyaluran", true, "Tujuan", new List<string> {"Tujuan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Catatan = new(this, "x_Catatan", 201, SqlDbType.Text) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "Catatan", "CustomMsg"),
                IsUpload = false
            };
            Catatan.Lookup = new Lookup<DbField>(Catatan, "RencanaPenyaluran", true, "Catatan", new List<string> {"Catatan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            DibuatOleh.Lookup = new Lookup<DbField>(DibuatOleh, "RencanaPenyaluran", true, "DibuatOleh", new List<string> {"DibuatOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            TanggalDibuat.Raw = true;
            TanggalDibuat.Lookup = new Lookup<DbField>(TanggalDibuat, "RencanaPenyaluran", true, "TanggalDibuat", new List<string> {"TanggalDibuat", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            DiperbaruiOleh.Lookup = new Lookup<DbField>(DiperbaruiOleh, "RencanaPenyaluran", true, "DiperbaruiOleh", new List<string> {"DiperbaruiOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiperbarui.Raw = true;
            TanggalDiperbarui.Lookup = new Lookup<DbField>(TanggalDiperbarui, "RencanaPenyaluran", true, "TanggalDiperbarui", new List<string> {"TanggalDiperbarui", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LookupJenisPlant = new(this, "x_LookupJenisPlant", 200, SqlDbType.VarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("RencanaPenyaluran", "LookupJenisPlant", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.RencanaPenyaluran";
            set => _sqlFrom = value;
        }
        ...
        {
            get {
                string select = "*, '<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorRencanaPenyaluran AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorRencanaPenyaluran AS NVARCHAR(50))+'</a>' AS [LinkProses], '' AS [LookupJenisPlant]";
                if (select == "*") {
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.RencanaPenyaluran type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdRencanaPenyaluran"))
                    row["IdRencanaPenyaluran"] = lastInsertedId;
                else
                    row.Add("IdRencanaPenyaluran", lastInsertedId);
                IdRencanaPenyaluran.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                IdRencanaPenyaluran.DbValue = row["IdRencanaPenyaluran"]; // Set DB value only
                NomorRencanaPenyaluran.DbValue = row["NomorRencanaPenyaluran"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[IdRencanaPenyaluran] = @IdRencanaPenyaluran@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "RencanaPenyaluranView" => Language.Phrase("View"),
                "RencanaPenyaluranEdit" => Language.Phrase("Edit"),
                "RencanaPenyaluranAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "RencanaPenyaluranView",
                Config.ApiAddAction => "RencanaPenyaluranAdd",
                Config.ApiEditAction => "RencanaPenyaluranEdit",
                Config.ApiDeleteAction => "RencanaPenyaluranDelete",
                Config.ApiListAction => "RencanaPenyaluranList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "RencanaPenyaluranList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("RencanaPenyaluranView", parm);
            else
                url = KeyUrl("RencanaPenyaluranView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "RencanaPenyaluranAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "RencanaPenyaluranAdd?" + parm;
            else
                url = "RencanaPenyaluranAdd";
        ...
        {
            string url = "";
            url = KeyUrl("RencanaPenyaluranEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("RencanaPenyaluranList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("RencanaPenyaluranAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("RencanaPenyaluranList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("RencanaPenyaluranDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdRencanaPenyaluran\":" + ConvertToJson(IdRencanaPenyaluran.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdRencanaPenyaluran.CurrentValue)) {
                url += "/" + IdRencanaPenyaluran.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdRencanaPenyaluran", out object? v0)) { // IdRencanaPenyaluran // DN
                    key = UrlDecode(v0); // DN
                } else if (IsApi() && !Empty(keyValues)) {
                    key = keyValues[0];
                } else {
                    key = Param("IdRencanaPenyaluran");
                }
                keysList.Add(key);
            }
            // Check keys
            foreach (var keys in keysList) {
                if (KeyFields.Count > 1 && (!IsArray(keys) || keys.Length != KeyFields.Count))
                    continue;
                if (!IsNumeric(keys)) // IdRencanaPenyaluran
                    continue;
                result.Add(keys);
            }
            return result;
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdRencanaPenyaluran.CurrentValue = keys;
                else
                    IdRencanaPenyaluran.OldValue = keys;
        ...
        {
            string pageName = "RencanaPenyaluranList";
        ...
        public async Task RenderListRow()
        {
            ...
            IdPenimbunan.ViewValue = Empty(curVal) ? DbNullValue : FormatNumber(IdPenimbunan.CurrentValue, IdPenimbunan.FormatPattern);
            if (!Empty(curVal)) {
            ...
            IdPlant.ViewValue = Empty(curVal3) ? DbNullValue : FormatNumber(IdPlant.CurrentValue, IdPlant.FormatPattern);
            if (!Empty(curVal3)) {
            ...
            IdModa.ViewValue = Empty(curVal5) ? DbNullValue : IdModa.CurrentValue;
            if (!Empty(curVal5)) {
        ...
        public async Task RenderEditRow()
        {
            ...
            // IdRencanaPenyaluran
            IdRencanaPenyaluran.SetupEditAttributes();
            IdRencanaPenyaluran.EditValue = IdRencanaPenyaluran.CurrentValue;
            IdRencanaPenyaluran.ViewCustomAttributes = "";

            // NomorRencanaPenyaluran
            NomorRencanaPenyaluran.SetupEditAttributes();
            NomorRencanaPenyaluran.EditValue = ConvertToString(NomorRencanaPenyaluran.CurrentValue); // DN
            NomorRencanaPenyaluran.ViewCustomAttributes = "";
            ...
            // awallookupbung
            string curVal3 = ConvertToString(IdPlant.CurrentValue);
            IdPlant.EditValue = Empty(curVal3) ? DbNullValue : FormatNumber(IdPlant.CurrentValue, IdPlant.FormatPattern);
            if (!Empty(curVal3)) {
                if (IdPlant.Lookup != null && IsDictionary(IdPlant.Lookup?.Options) && IdPlant.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
            ...
            // awallookupbung
            string curVal5 = ConvertToString(IdModa.CurrentValue);
            IdModa.EditValue = Empty(curVal5) ? DbNullValue : IdModa.CurrentValue;
            if (!Empty(curVal5)) {
                if (IdModa.Lookup != null && IsDictionary(IdModa.Lookup?.Options) && IdModa.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    IdModa.EditValue = IdModa.LookupCacheOption(curVal5);
                } else { // Lookup from database // DN
                    string filterWrk5 = SearchFilter(IdModa.Lookup?.GetTable()?.Fields["IdModa"].SearchExpression, "=", IdModa.CurrentValue, IdModa.Lookup?.GetTable()?.Fields["IdModa"].SearchDataType, "");
                    string? sqlWrk5 = IdModa.Lookup?.GetSql(false, filterWrk5, null, this, true, true);
                    List<Dictionary<string, object>>? rswrk5 = sqlWrk5 != null ? Connection.GetRows(sqlWrk5) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(IdRencanaPenyaluran);
                        doc.ExportCaption(NomorRencanaPenyaluran);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(IdRencanaPenyaluran);
                            await doc.ExportField(NomorRencanaPenyaluran);
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            try {
                // Ambil parameter untuk GenerateNomorReferensi
                var idPlant = rsnew["IdPlant"].ToString();

                // Jalankan SP untuk mendapatkan nomor referensi
                string sql = $"EXEC GenerateNomorReferensiPenyaluran 'Rencana Penyaluran', {idPlant}";
                ...
                rsnew["NomorRencanaPenyaluran"] = nomorReferensi;

                // Dapatkan waktu plant lewat SP GetPlantDateTime
                DateTime plantTime = DateTime.Now; // fallback
                var plantTimeObj = ExecuteScalar($"EXEC dbo.GetPlantDateTime @IdPlant = {idPlant}");
                if (plantTimeObj != null && DateTime.TryParse(plantTimeObj.ToString(), out var tmp))
                    plantTime = tmp;

                // Isi kolom waktu dengan plantTime
        ...
        public void RowInserted(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            try {
                string nomorReferensi = rsnew.ContainsKey("NomorRencanaPenyaluran") ? rsnew["NomorRencanaPenyaluran"]?.ToString() : "";
                int idPlant = Convert.ToInt32(rsnew["IdPlant"]);
                string tipePenyaluran = rsnew.ContainsKey("TipePenyaluran") ? rsnew["TipePenyaluran"]?.ToString() : "";
                string kategoriPenyaluran = rsnew.ContainsKey("KategoriPenyaluran") ? rsnew["KategoriPenyaluran"]?.ToString() : "";
                int idModa = Convert.ToInt32(rsnew["IdModa"]);
                string tipeProduk = rsnew.ContainsKey("TipeProdukSTS") ? rsnew["TipeProdukSTS"]?.ToString() : "";
                string dibuatOleh = CurrentUserName();
                string sql = $"EXEC GenerateProsesAktifitas_RencanaPenyaluran '{nomorReferensi}', {idPlant}, '{tipePenyaluran}', '{kategoriPenyaluran}', {idModa}, '{tipeProduk}', '{dibuatOleh}'";
                ExecuteScalar(sql);
            } catch (Exception ex) {
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            try {
                // Ambil IdPlant dari data baru atau lama
                string idPlant = rsnew.ContainsKey("IdPlant")
                    ? rsnew["IdPlant"].ToString()
                    : rsold["IdPlant"].ToString();

                // Ambil waktu plant via GetPlantDateTime
                DateTime plantTime = DateTime.Now; // fallback
                var plantTimeObj = ExecuteScalar($"EXEC dbo.GetPlantDateTime @IdPlant = {idPlant}");
                if (plantTimeObj != null && DateTime.TryParse(plantTimeObj.ToString(), out var dt))
                    plantTime = dt;
