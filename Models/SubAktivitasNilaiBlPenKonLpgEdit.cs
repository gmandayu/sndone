...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiBlPenKonLpgEdit
    /// </summary>
    public static SubAktivitasNilaiBlPenKonLpgEdit subAktivitasNilaiBlPenKonLpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiBlPenKonLpgEdit>("subAktivitasNilaiBlPenKonLpgEdit")!;
        set => HttpData["subAktivitasNilaiBlPenKonLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiBLPenKonLPG
    /// </summary>
    public class SubAktivitasNilaiBlPenKonLpgEdit : SubAktivitasNilaiBlPenKonLpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiBlPenKonLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiBlPenKonLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiBlPenKonLpgEditBase : SubAktivitasNilaiBlPenKonLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiBlPenKonLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlPenKonLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiBlPenKonLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlPenKonLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiBlPenKonLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiBlPenKonLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiBlPenKonLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiBlPenKonLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiBlPenKonLpgList")), "", TableVar, true);
            string pageId = "edit";
