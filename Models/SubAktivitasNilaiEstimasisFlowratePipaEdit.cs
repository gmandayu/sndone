...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiEstimasisFlowratePipaEditBase : SubAktivitasNilaiEstimasisFlowratePipa
    {
        ...
        // Constructor
        public SubAktivitasNilaiEstimasisFlowratePipaEditBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiEstimasisFlowratePipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiEstimasisFlowratePipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiEstimasisFlowratePipaList") {
                                ...
                                returnUrl = "SubAktivitasNilaiEstimasisFlowratePipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
