...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataMobilTangkiMtGateOutLpgList
    /// </summary>
    public static SubAktivitasDataMobilTangkiMtGateOutLpgList subAktivitasDataMobilTangkiMtGateOutLpgList
    {
        get => HttpData.Get<SubAktivitasDataMobilTangkiMtGateOutLpgList>("subAktivitasDataMobilTangkiMtGateOutLpgList")!;
        set => HttpData["subAktivitasDataMobilTangkiMtGateOutLpgList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataMobilTangkiMTGateOutLPG
    /// </summary>
    public class SubAktivitasDataMobilTangkiMtGateOutLpgList : SubAktivitasDataMobilTangkiMtGateOutLpgListBase
    {
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataMobilTangkiMtGateOutLpgListBase : SubAktivitasDataMobilTangkiMtGateOutLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataMobilTangkiMtGateOutLpgList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasDataMobilTangkiMTGateOutLPGlist";
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgListBase()
        {
            TableName = "SubAktivitasDataMobilTangkiMTGateOutLPG";

            // CSS class name as context
            TableVar = "SubAktivitasDataMobilTangkiMTGateOutLPG";
            ...
            // Table object (subAktivitasDataMobilTangkiMtGateOutLpg)
            if (subAktivitasDataMobilTangkiMtGateOutLpg == null || subAktivitasDataMobilTangkiMtGateOutLpg is SubAktivitasDataMobilTangkiMtGateOutLpg)
                subAktivitasDataMobilTangkiMtGateOutLpg = this;

            // Initialize URLs
            AddUrl = "SubAktivitasDataMobilTangkiMtGateOutLpgAdd";
            ...
            MultiDeleteUrl = "SubAktivitasDataMobilTangkiMtGateOutLpgDelete";
            MultiUpdateUrl = "SubAktivitasDataMobilTangkiMtGateOutLpgUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasDataMobilTangkiMtGateOutLpgList";
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasDataMobilTangkiMtGateOutLpgView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasDataMobilTangkiMTGateOutLPGgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasDataMobilTangkiMtGateOutLpgList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(WaktuGateOut.AdvancedSearch.ToJson())); // Field WaktuGateOut
        ...
        protected bool RestoreFilterList() {
            ...
            // Field WaktuGateOut
            if (filter?.TryGetValue("x_WaktuGateOut", out sv) ?? false) {
                WaktuGateOut.AdvancedSearch.SearchValue = sv;
                WaktuGateOut.AdvancedSearch.SearchOperator = filter["z_WaktuGateOut"];
                WaktuGateOut.AdvancedSearch.SearchCondition = filter["v_WaktuGateOut"];
                WaktuGateOut.AdvancedSearch.SearchValue2 = filter["y_WaktuGateOut"];
                WaktuGateOut.AdvancedSearch.SearchOperator2 = filter["w_WaktuGateOut"];
                WaktuGateOut.AdvancedSearch.Save();
            }
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(WaktuGateOut, ctrl); // WaktuGateOut
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasDataMobilTangkiMTGateOutLPG"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataMobilTangkiMTGateOutLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataMobilTangkiMTGateOutLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("WaktuGateOut")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasDataMobilTangkiMTGateOutLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasDataMobilTangkiMTGateOutLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataMobilTangkiMTGateOutLPGlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasDataMobilTangkiMTGateOutLPG");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasDataMobilTangkiMtGateOutLpgList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasDataMobilTangkiMtGateOutLpgList.RowCount) + "_SubAktivitasDataMobilTangkiMTGateOutLPG");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasDataMobilTangkiMtGateOutLpgList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasDataMobilTangkiMtGateOutLpgList.RowType == RowType.Add || IsEdit && subAktivitasDataMobilTangkiMtGateOutLpgList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            WaktuGateOut.SetDbValue(row["WaktuGateOut"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("WaktuGateOut", WaktuGateOut.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // WaktuGateOut
                WaktuGateOut.ViewValue = WaktuGateOut.CurrentValue;
                WaktuGateOut.ViewValue = FormatDateTime(WaktuGateOut.ViewValue, WaktuGateOut.FormatPattern);
                WaktuGateOut.ViewCustomAttributes = "";
                ...
                // WaktuGateOut
                WaktuGateOut.HrefValue = "";
                WaktuGateOut.TooltipValue = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasDataMobilTangkiMTGateOutLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasDataMobilTangkiMTGateOutLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasDataMobilTangkiMTGateOutLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasDataMobilTangkiMTGateOutLPGsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
