...
public partial class SnDOne {
    ...
    /// penimbunanSearch
    /// </summary>
    public static PenimbunanSearch penimbunanSearch
    {
        get => HttpData.Get<PenimbunanSearch>("penimbunanSearch")!;
        set => HttpData["penimbunanSearch"] = value;
    }

    /// <summary>
    /// Page class for Penimbunan
    /// </summary>
    public class PenimbunanSearch : PenimbunanSearchBase
    {
        // Constructor
        public PenimbunanSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenimbunanSearch() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PenimbunanSearchBase : Penimbunan
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penimbunanSearch";
        ...
        // Constructor
        public PenimbunanSearchBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "PenimbunanSearch";
        ...
        // Constructor
        public PenimbunanSearchBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "PenimbunanList?" + srchStr;
        ...
        protected string BuildAdvancedSearch() {
            string srchUrl = "";
            BuildSearchUrl(ref srchUrl, LookupPenerimaan); // LookupPenerimaan
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        {
            if (!IsAddOrEdit && Form.ContainsKey("x_NomorPenimbunan")) {
                NomorPenimbunan.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_NomorPenimbunan", Config.FilterOptionSeparator);
            }
        }

        private void LoadSearchOperatorNomorPenimbunan()
        {
            if (Form.ContainsKey("z_NomorPenimbunan"))
                NomorPenimbunan.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_NomorPenimbunan", Config.FilterOptionSeparator);
        }
        ...
        {
            if (!IsAddOrEdit && Form.ContainsKey("x_Plant")) {
        ...
        {
            if (!IsAddOrEdit && Form.ContainsKey("x_LookupPenerimaan")) {
                LookupPenerimaan.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_LookupPenerimaan");
            }
        }

        private void LoadSearchOperatorLookupPenerimaan()
        {
            if (Form.ContainsKey("z_LookupPenerimaan"))
                LookupPenerimaan.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_LookupPenerimaan");
        }
        ...
        {
            if (!IsAddOrEdit && Form.ContainsKey("x_IdPenerimaan")) {
                IdPenerimaan.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_IdPenerimaan", Config.FilterOptionSeparator);
            }
        }

        private void LoadSearchOperatorIdPenerimaan()
        {
            if (Form.ContainsKey("z_IdPenerimaan"))
                IdPenerimaan.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_IdPenerimaan", Config.FilterOptionSeparator);
        }
        ...
        {
            if (!IsAddOrEdit && Form.ContainsKey("x_IdTangki")) {
