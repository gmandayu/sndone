...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static MasterPic masterPic
    {
        get => HttpData.Resolve<MasterPic>("MasterPIC");
        set => HttpData["MasterPIC"] = value;
    }

    /// <summary>
    /// Table class for MasterPIC
    /// </summary>
    public class MasterPic : DbTable
    {
        ...
        public readonly DbField<SqlDbType> NamaPIC;
        ...
        public MasterPic()
        {
            ...
            Name = "MasterPIC";
            Type = "TABLE";
            UpdateTable = "dbo.MasterPIC"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdPIC = new(this, "x_IdPIC", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterPIC", "IdPIC", "CustomMsg"),
                IsUpload = false
            };
            IdPIC.Raw = true;
            IdPIC.Lookup = new Lookup<DbField>(IdPIC, "MasterPIC", true, "IdPIC", new List<string> {"IdPIC", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("IdPIC", IdPIC);

            // NamaPIC
            NamaPIC = new(this, "x_NamaPIC", 200, SqlDbType.VarChar) {
                Name = "NamaPIC",
                Expression = "[NamaPIC]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NamaPIC]",
                DateTimeFormat = -1,
                VirtualExpression = "[NamaPIC]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MasterPIC", "NamaPIC", "CustomMsg"),
                IsUpload = false
            };
            NamaPIC.Lookup = new Lookup<DbField>(NamaPIC, "MasterPIC", true, "NamaPIC", new List<string> {"NamaPIC", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NamaPIC", NamaPIC);
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MasterPic type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdPIC"))
                    row["IdPIC"] = lastInsertedId;
                else
                    row.Add("IdPIC", lastInsertedId);
                IdPIC.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                NamaPIC.DbValue = row["NamaPIC"]; // Set DB value only
            } catch {}
        }
        ...
        private string _sqlKeyFilter => "[IdPIC] = @IdPIC@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MasterPicView" => Language.Phrase("View"),
                "MasterPicEdit" => Language.Phrase("Edit"),
                "MasterPicAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MasterPicView",
                Config.ApiAddAction => "MasterPicAdd",
                Config.ApiEditAction => "MasterPicEdit",
                Config.ApiDeleteAction => "MasterPicDelete",
                Config.ApiListAction => "MasterPicList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MasterPicList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MasterPicView", parm);
            else
                url = KeyUrl("MasterPicView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MasterPicAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MasterPicEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterPicList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MasterPicAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterPicList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MasterPicDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdPIC\":" + ConvertToJson(IdPIC.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdPIC.CurrentValue)) {
                url += "/" + IdPIC.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdPIC", out object? v0)) { // IdPIC // DN
                    key = UrlDecode(v0); // DN
        ...
        public async Task RenderEditRow()
        {
            ...
            // NamaPIC
            NamaPIC.SetupEditAttributes();
            if (!NamaPIC.Raw)
                NamaPIC.CurrentValue = HtmlDecode(NamaPIC.CurrentValue);
            NamaPIC.EditValue = NamaPIC.CurrentValue;
            NamaPIC.PlaceHolder = RemoveHtml(NamaPIC.Caption);
