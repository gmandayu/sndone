...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputDataKapalStsPyrLpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasInputDataKapalStsPyrLpg subAktivitasInputDataKapalStsPyrLpg
    {
        get => HttpData.Resolve<SubAktivitasInputDataKapalStsPyrLpg>("SubAktivitasInputDataKapalSTSPyrLPG");
        set => HttpData["SubAktivitasInputDataKapalSTSPyrLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasInputDataKapalSTSPyrLPG
    /// </summary>
    public class SubAktivitasInputDataKapalStsPyrLpg : DbTable
    {
        ...
        public readonly DbField<SqlDbType> VoyageNumber;

        public readonly DbField<SqlDbType> TanggalTiba;

        public readonly DbField<SqlDbType> Nominasi;
        ...
        // Constructor
        public SubAktivitasInputDataKapalStsPyrLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasInputDataKapalSTSPyrLPG";
            Name = "SubAktivitasInputDataKapalSTSPyrLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasInputDataKapalSTSPyrLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            NoReferensi.Lookup = new Lookup<DbField>(NoReferensi, "Proses", false, "IdProses", new List<string> {"NamaProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[NamaProses]");
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NamaKapal = new(this, "x_NamaKapal", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "NamaKapal", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NamaKapal", NamaKapal);

            // VoyageNumber
            VoyageNumber = new(this, "x_VoyageNumber", 202, SqlDbType.NVarChar) {
                Name = "VoyageNumber",
                Expression = "[VoyageNumber]",
                UseBasicSearch = true,
                BasicSearchExpression = "[VoyageNumber]",
                DateTimeFormat = -1,
                VirtualExpression = "[VoyageNumber]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "VoyageNumber", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("VoyageNumber", VoyageNumber);

            // TanggalTiba
            TanggalTiba = new(this, "x_TanggalTiba", 135, SqlDbType.DateTime) {
                Name = "TanggalTiba",
                Expression = "[TanggalTiba]",
                BasicSearchExpression = CastDateFieldForLike("[TanggalTiba]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[TanggalTiba]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "TanggalTiba", "CustomMsg"),
                IsUpload = false
            };
            TanggalTiba.Raw = true;
            Fields.Add("TanggalTiba", TanggalTiba);

            // Nominasi
            Nominasi = new(this, "x_Nominasi", 202, SqlDbType.NVarChar) {
                Name = "Nominasi",
                Expression = "[Nominasi]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Nominasi]",
                DateTimeFormat = -1,
                VirtualExpression = "[Nominasi]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "Nominasi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Nominasi", Nominasi);
            ...
            JenisProduk = new(this, "x_JenisProduk", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "JenisProduk", "CustomMsg"),
                IsUpload = false
            };
            JenisProduk.Lookup = new Lookup<DbField>(JenisProduk, "MasterProduk", false, "NoProduk", new List<string> {"NoProduk", "NamaProduk", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "CONCAT([NoProduk],'" + ValueSeparator(1, JenisProduk) + "',[NamaProduk])");
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataKapalSTSPyrLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasInputDataKapalSTSPyrLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasInputDataKapalStspyrLpg type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                VoyageNumber.DbValue = row["VoyageNumber"]; // Set DB value only
                TanggalTiba.DbValue = row["TanggalTiba"]; // Set DB value only
                Nominasi.DbValue = row["Nominasi"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasInputDataKapalStsPyrLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasInputDataKapalStsPyrLpgView" => Language.Phrase("View"),
                "SubAktivitasInputDataKapalStsPyrLpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasInputDataKapalStsPyrLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasInputDataKapalStsPyrLpgView",
                Config.ApiAddAction => "SubAktivitasInputDataKapalStsPyrLpgAdd",
                Config.ApiEditAction => "SubAktivitasInputDataKapalStsPyrLpgEdit",
                Config.ApiDeleteAction => "SubAktivitasInputDataKapalStsPyrLpgDelete",
                Config.ApiListAction => "SubAktivitasInputDataKapalStsPyrLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasInputDataKapalStsPyrLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasInputDataKapalStsPyrLpgView", parm);
            else
                url = KeyUrl("SubAktivitasInputDataKapalStsPyrLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasInputDataKapalStsPyrLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasInputDataKapalStsPyrLpgAdd?" + parm;
            else
                url = "SubAktivitasInputDataKapalStsPyrLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasInputDataKapalStsPyrLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasInputDataKapalStsPyrLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasInputDataKapalStsPyrLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasInputDataKapalStsPyrLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasInputDataKapalStsPyrLpgDelete", parm)); // DN
        }
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            ...
            VoyageNumber.SetDbValue(row["VoyageNumber"]);
        ...
        {
            string pageName = "SubAktivitasInputDataKapalStsPyrLpgList";
        ...
        public async Task RenderListRow()
        {
            ...
            // awallookupbung
            string curVal = ConvertToString(NoReferensi.CurrentValue);
            NoReferensi.ViewValue = Empty(curVal) ? DbNullValue : NoReferensi.CurrentValue;
            if (!Empty(curVal)) {
                if (NoReferensi.Lookup != null && IsDictionary(NoReferensi.Lookup?.Options) && NoReferensi.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    NoReferensi.ViewValue = NoReferensi.LookupCacheOption(curVal);
                } else { // Lookup from database // DN
                    string filterWrk = SearchFilter(NoReferensi.Lookup?.GetTable()?.Fields["IdProses"].SearchExpression, "=", NoReferensi.CurrentValue, NoReferensi.Lookup?.GetTable()?.Fields["IdProses"].SearchDataType, "");
                    string? sqlWrk = NoReferensi.Lookup?.GetSql(false, filterWrk, null, this, true, true);
                    List<Dictionary<string, object>>? rswrk = sqlWrk != null ? Connection.GetRows(sqlWrk) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
                    if (rswrk?.Count > 0 && NoReferensi.Lookup != null) { // Lookup values found
                        var listwrk = NoReferensi.Lookup?.RenderViewRow(rswrk[0]);
                        NoReferensi.ViewValue = NoReferensi.DisplayValue(listwrk);
                    }
                }
            }
            ...
            // awallookupbung
            string curVal3 = ConvertToString(idAktifitas.CurrentValue);
            idAktifitas.ViewValue = Empty(curVal3) ? DbNullValue : FormatNumber(idAktifitas.CurrentValue, idAktifitas.FormatPattern);
            if (!Empty(curVal3)) {
                if (idAktifitas.Lookup != null && IsDictionary(idAktifitas.Lookup?.Options) && idAktifitas.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    idAktifitas.ViewValue = idAktifitas.LookupCacheOption(curVal3);
                } else { // Lookup from database // DN
                    string filterWrk3 = SearchFilter(idAktifitas.Lookup?.GetTable()?.Fields["IdAktivitas"].SearchExpression, "=", idAktifitas.CurrentValue, idAktifitas.Lookup?.GetTable()?.Fields["IdAktivitas"].SearchDataType, "");
                    string? sqlWrk3 = idAktifitas.Lookup?.GetSql(false, filterWrk3, null, this, true, true);
                    ...
                    if (rswrk3?.Count > 0 && idAktifitas.Lookup != null) { // Lookup values found
                        var listwrk = idAktifitas.Lookup?.RenderViewRow(rswrk3[0]);
            ...
            // awallookupbung
            string curVal4 = ConvertToString(StatusAktivitas.CurrentValue);
            StatusAktivitas.ViewValue = Empty(curVal4) ? DbNullValue : FormatNumber(StatusAktivitas.CurrentValue, StatusAktivitas.FormatPattern);
            if (!Empty(curVal4)) {
                if (StatusAktivitas.Lookup != null && IsDictionary(StatusAktivitas.Lookup?.Options) && StatusAktivitas.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    StatusAktivitas.ViewValue = StatusAktivitas.LookupCacheOption(curVal4);
                } else { // Lookup from database // DN
                    string filterWrk4 = SearchFilter(StatusAktivitas.Lookup?.GetTable()?.Fields["IdAktivitas"].SearchExpression, "=", StatusAktivitas.CurrentValue, StatusAktivitas.Lookup?.GetTable()?.Fields["IdAktivitas"].SearchDataType, "");
                    string? sqlWrk4 = StatusAktivitas.Lookup?.GetSql(false, filterWrk4, null, this, true, true);
                    ...
                    if (rswrk4?.Count > 0 && StatusAktivitas.Lookup != null) { // Lookup values found
                        var listwrk = StatusAktivitas.Lookup?.RenderViewRow(rswrk4[0]);
            ...
            // VoyageNumber
            VoyageNumber.ViewValue = ConvertToString(VoyageNumber.CurrentValue); // DN
            VoyageNumber.ViewCustomAttributes = "";
            ...
            // VoyageNumber
            VoyageNumber.HrefValue = "";
            VoyageNumber.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // awallookupbung
            string curVal = ConvertToString(NoReferensi.CurrentValue);
            NoReferensi.EditValue = Empty(curVal) ? DbNullValue : NoReferensi.CurrentValue;
            if (!Empty(curVal)) {
                if (NoReferensi.Lookup != null && IsDictionary(NoReferensi.Lookup?.Options) && NoReferensi.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    NoReferensi.EditValue = NoReferensi.LookupCacheOption(curVal);
                } else { // Lookup from database // DN
                    string filterWrk = SearchFilter(NoReferensi.Lookup?.GetTable()?.Fields["IdProses"].SearchExpression, "=", NoReferensi.CurrentValue, NoReferensi.Lookup?.GetTable()?.Fields["IdProses"].SearchDataType, "");
                    string? sqlWrk = NoReferensi.Lookup?.GetSql(false, filterWrk, null, this, true, true);
                    List<Dictionary<string, object>>? rswrk = sqlWrk != null ? Connection.GetRows(sqlWrk) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
                    if (rswrk?.Count > 0 && NoReferensi.Lookup != null) { // Lookup values found
                        var listwrk = NoReferensi.Lookup?.RenderViewRow(rswrk[0]);
                        NoReferensi.EditValue = NoReferensi.DisplayValue(listwrk);
                    }
                }
            }
            ...
            // awallookupbung
            string curVal3 = ConvertToString(idAktifitas.CurrentValue);
            idAktifitas.EditValue = Empty(curVal3) ? DbNullValue : FormatNumber(idAktifitas.CurrentValue, idAktifitas.FormatPattern);
            if (!Empty(curVal3)) {
                if (idAktifitas.Lookup != null && IsDictionary(idAktifitas.Lookup?.Options) && idAktifitas.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    idAktifitas.EditValue = idAktifitas.LookupCacheOption(curVal3);
                } else { // Lookup from database // DN
                    string filterWrk3 = SearchFilter(idAktifitas.Lookup?.GetTable()?.Fields["IdAktivitas"].SearchExpression, "=", idAktifitas.CurrentValue, idAktifitas.Lookup?.GetTable()?.Fields["IdAktivitas"].SearchDataType, "");
                    string? sqlWrk3 = idAktifitas.Lookup?.GetSql(false, filterWrk3, null, this, true, true);
                    List<Dictionary<string, object>>? rswrk3 = sqlWrk3 != null ? Connection.GetRows(sqlWrk3) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
            ...
            // awallookupbung
            string curVal4 = ConvertToString(StatusAktivitas.CurrentValue);
            StatusAktivitas.EditValue = Empty(curVal4) ? DbNullValue : FormatNumber(StatusAktivitas.CurrentValue, StatusAktivitas.FormatPattern);
            if (!Empty(curVal4)) {
                if (StatusAktivitas.Lookup != null && IsDictionary(StatusAktivitas.Lookup?.Options) && StatusAktivitas.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    StatusAktivitas.EditValue = StatusAktivitas.LookupCacheOption(curVal4);
                } else { // Lookup from database // DN
                    string filterWrk4 = SearchFilter(StatusAktivitas.Lookup?.GetTable()?.Fields["IdAktivitas"].SearchExpression, "=", StatusAktivitas.CurrentValue, StatusAktivitas.Lookup?.GetTable()?.Fields["IdAktivitas"].SearchDataType, "");
                    string? sqlWrk4 = StatusAktivitas.Lookup?.GetSql(false, filterWrk4, null, this, true, true);
                    List<Dictionary<string, object>>? rswrk4 = sqlWrk4 != null ? Connection.GetRows(sqlWrk4) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
            ...
            // VoyageNumber
            VoyageNumber.SetupEditAttributes();
            if (!VoyageNumber.Raw)
                VoyageNumber.CurrentValue = HtmlDecode(VoyageNumber.CurrentValue);
            VoyageNumber.EditValue = VoyageNumber.CurrentValue;
            VoyageNumber.PlaceHolder = RemoveHtml(VoyageNumber.Caption);

            // TanggalTiba
            TanggalTiba.SetupEditAttributes();
            TanggalTiba.EditValue = FormatDateTime(TanggalTiba.CurrentValue, TanggalTiba.FormatPattern);
            TanggalTiba.PlaceHolder = RemoveHtml(TanggalTiba.Caption);

            // Nominasi
            Nominasi.SetupEditAttributes();
            Nominasi.EditValue = ConvertToString(Nominasi.CurrentValue); // DN
            Nominasi.ViewCustomAttributes = "";
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(VoyageNumber);
                        doc.ExportCaption(TanggalTiba);
                        doc.ExportCaption(Nominasi);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(VoyageNumber);
                            await doc.ExportField(TanggalTiba);
                            await doc.ExportField(Nominasi);
