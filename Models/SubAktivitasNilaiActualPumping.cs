...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiActualPumping
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiActualPumping subAktivitasNilaiActualPumping
    {
        get => HttpData.Resolve<SubAktivitasNilaiActualPumping>("SubAktivitasNilaiActualPumping");
        set => HttpData["SubAktivitasNilaiActualPumping"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiActualPumping
    /// </summary>
    public class SubAktivitasNilaiActualPumping : DbTable
    {
        ...
        public readonly DbField<SqlDbType> ActualFlowrate;

        public readonly DbField<SqlDbType> ActualPressure;
        ...
        // Constructor
        public SubAktivitasNilaiActualPumping()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiActualPumping";
            Name = "SubAktivitasNilaiActualPumping";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiActualPumping"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiActualPumping", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiActualPumping", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiActualPumping", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiActualPumping", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiActualPumping", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            // ActualFlowrate
            ActualFlowrate = new(this, "x_ActualFlowrate", 202, SqlDbType.NVarChar) {
                Name = "ActualFlowrate",
                Expression = "[ActualFlowrate]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ActualFlowrate]",
                DateTimeFormat = -1,
                VirtualExpression = "[ActualFlowrate]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiActualPumping", "ActualFlowrate", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ActualFlowrate", ActualFlowrate);

            // ActualPressure
            ActualPressure = new(this, "x_ActualPressure", 202, SqlDbType.NVarChar) {
                Name = "ActualPressure",
                Expression = "[ActualPressure]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ActualPressure]",
                DateTimeFormat = -1,
                VirtualExpression = "[ActualPressure]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiActualPumping", "ActualPressure", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ActualPressure", ActualPressure);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiActualPumping", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiActualPumping", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiActualPumping", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiActualPumping", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiActualPumping";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiActualPumping type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                ActualFlowrate.DbValue = row["ActualFlowrate"]; // Set DB value only
                ActualPressure.DbValue = row["ActualPressure"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiActualPumpingList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiActualPumpingView" => Language.Phrase("View"),
                "SubAktivitasNilaiActualPumpingEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiActualPumpingAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiActualPumpingView",
                Config.ApiAddAction => "SubAktivitasNilaiActualPumpingAdd",
                Config.ApiEditAction => "SubAktivitasNilaiActualPumpingEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiActualPumpingDelete",
                Config.ApiListAction => "SubAktivitasNilaiActualPumpingList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiActualPumpingList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiActualPumpingView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiActualPumpingView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiActualPumpingAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiActualPumpingAdd?" + parm;
            else
                url = "SubAktivitasNilaiActualPumpingAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiActualPumpingEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiActualPumpingList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiActualPumpingAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiActualPumpingList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiActualPumpingDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiActualPumpingList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // ActualFlowrate
            ActualFlowrate.SetupEditAttributes();
            if (!ActualFlowrate.Raw)
                ActualFlowrate.CurrentValue = HtmlDecode(ActualFlowrate.CurrentValue);
            ActualFlowrate.EditValue = ActualFlowrate.CurrentValue;
            ActualFlowrate.PlaceHolder = RemoveHtml(ActualFlowrate.Caption);

            // ActualPressure
            ActualPressure.SetupEditAttributes();
            if (!ActualPressure.Raw)
                ActualPressure.CurrentValue = HtmlDecode(ActualPressure.CurrentValue);
            ActualPressure.EditValue = ActualPressure.CurrentValue;
            ActualPressure.PlaceHolder = RemoveHtml(ActualPressure.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(ActualFlowrate);
                        doc.ExportCaption(ActualPressure);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(ActualFlowrate);
                            await doc.ExportField(ActualPressure);
