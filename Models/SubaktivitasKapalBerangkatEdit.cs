...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasKapalBerangkatEdit
    /// </summary>
    public static SubaktivitasKapalBerangkatEdit subaktivitasKapalBerangkatEdit
    {
        get => HttpData.Get<SubaktivitasKapalBerangkatEdit>("subaktivitasKapalBerangkatEdit")!;
        set => HttpData["subaktivitasKapalBerangkatEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasKapalBerangkat
    /// </summary>
    public class SubaktivitasKapalBerangkatEdit : SubaktivitasKapalBerangkatEditBase
    {
        // Constructor
        public SubaktivitasKapalBerangkatEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasKapalBerangkatEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasKapalBerangkatEditBase : SubaktivitasKapalBerangkat
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasKapalBerangkatEdit";
        ...
        // Constructor
        public SubaktivitasKapalBerangkatEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasKapalBerangkatEdit";
        ...
        // Constructor
        public SubaktivitasKapalBerangkatEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasKapalBerangkatList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasKapalBerangkatList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasKapalBerangkatList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasKapalBerangkatEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasKapalBerangkatList")), "", TableVar, true);
            string pageId = "edit";
