...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiNewBlsfadsfbllpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiNewBlsfadsfbllpg subAktivitasNilaiNewBlsfadsfbllpg
    {
        get => HttpData.Resolve<SubAktivitasNilaiNewBlsfadsfbllpg>("SubAktivitasNilaiNewBLSFADSFBLLPG");
        set => HttpData["SubAktivitasNilaiNewBLSFADSFBLLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiNewBLSFADSFBLLPG
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfbllpg : DbTable
    {
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfbllpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiNewBLSFADSFBLLPG";
            Name = "SubAktivitasNilaiNewBLSFADSFBLLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiNewBLSFADSFBLLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBL_MT = new(this, "x_NewBL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "NewBL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_MT = new(this, "x_SFAD_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "SFAD_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFBL_MT = new(this, "x_SFBL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "SFBL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            ExROB = new(this, "x_ExROB", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "ExROB", "CustomMsg"),
                IsUpload = false
            };
            ExROB.Raw = true;
            ExROB.Lookup = new Lookup<DbField>(ExROB, "SubAktivitasNilaiNewBLSFADSFBLLPG", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ExROB.UserValues = ["1"];
            ...
            NoPenerimaan = new(this, "x_NoPenerimaan", 202, SqlDbType.NVarChar) {
                ...
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "NoPenerimaan", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoPenerimaan.GetSelectFilter = () => "NomorPenerimaan IN (SELECT NoReferensi FROM SubAktivitasSFADNewBLLPG WHERE ApakahTerdapatROB = 1 UNION SELECT NoReferensi FROM SubAktivitasSFADNewBLSTSLPG WHERE ApakahTerdapatROB = 1)";
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiNewBLSFADSFBLLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiNewBLSFADSFBLLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiNewBlsfadsfbllpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiNewBlsfadsfbllpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiNewBlsfadsfbllpgView" => Language.Phrase("View"),
                "SubAktivitasNilaiNewBlsfadsfbllpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiNewBlsfadsfbllpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiNewBlsfadsfbllpgView",
                Config.ApiAddAction => "SubAktivitasNilaiNewBlsfadsfbllpgAdd",
                Config.ApiEditAction => "SubAktivitasNilaiNewBlsfadsfbllpgEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiNewBlsfadsfbllpgDelete",
                Config.ApiListAction => "SubAktivitasNilaiNewBlsfadsfbllpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiNewBlsfadsfbllpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiNewBlsfadsfbllpgView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiNewBlsfadsfbllpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiNewBlsfadsfbllpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiNewBlsfadsfbllpgAdd?" + parm;
            else
                url = "SubAktivitasNilaiNewBlsfadsfbllpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiNewBlsfadsfbllpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiNewBlsfadsfbllpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiNewBlsfadsfbllpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiNewBlsfadsfbllpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiNewBlsfadsfbllpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiNewBlsfadsfbllpgList";
