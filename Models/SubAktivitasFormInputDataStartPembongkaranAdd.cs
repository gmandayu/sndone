...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStartPembongkaranAdd
    /// </summary>
    public static SubAktivitasFormInputDataStartPembongkaranAdd subAktivitasFormInputDataStartPembongkaranAdd
    {
        get => HttpData.Get<SubAktivitasFormInputDataStartPembongkaranAdd>("subAktivitasFormInputDataStartPembongkaranAdd")!;
        set => HttpData["subAktivitasFormInputDataStartPembongkaranAdd"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStartPembongkaran
    /// </summary>
    public class SubAktivitasFormInputDataStartPembongkaranAdd : SubAktivitasFormInputDataStartPembongkaranAddBase
    {
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStartPembongkaranAddBase : SubAktivitasFormInputDataStartPembongkaran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStartPembongkaranAdd";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranAddBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStartPembongkaranAdd";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasFormInputDataStartPembongkaranList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "SubAktivitasFormInputDataStartPembongkaranView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputDataStartPembongkaranList") {
                                ...
                                returnUrl = "SubAktivitasFormInputDataStartPembongkaranList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputDataStartPembongkaranAdd?.PageRender();
            }
            return PageResult();
        }
