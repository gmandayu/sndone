...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasHasilPemeriksaanStslpgEdit
    /// </summary>
    public static SubAktivitasHasilPemeriksaanStslpgEdit subAktivitasHasilPemeriksaanStslpgEdit
    {
        get => HttpData.Get<SubAktivitasHasilPemeriksaanStslpgEdit>("subAktivitasHasilPemeriksaanStslpgEdit")!;
        set => HttpData["subAktivitasHasilPemeriksaanStslpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasHasilPemeriksaanSTSLPG
    /// </summary>
    public class SubAktivitasHasilPemeriksaanStslpgEdit : SubAktivitasHasilPemeriksaanStslpgEditBase
    {
        // Constructor
        public SubAktivitasHasilPemeriksaanStslpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasHasilPemeriksaanStslpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasHasilPemeriksaanStslpgEditBase : SubAktivitasHasilPemeriksaanStslpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasHasilPemeriksaanStslpgEdit";
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanStslpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasHasilPemeriksaanStslpgEdit";
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanStslpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasHasilPemeriksaanStslpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasHasilPemeriksaanStslpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasHasilPemeriksaanStslpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasHasilPemeriksaanStslpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasHasilPemeriksaanStslpgList")), "", TableVar, true);
            string pageId = "edit";
