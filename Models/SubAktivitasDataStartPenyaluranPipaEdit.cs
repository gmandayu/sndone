...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStartPenyaluranPipaEdit
    /// </summary>
    public static SubAktivitasDataStartPenyaluranPipaEdit subAktivitasDataStartPenyaluranPipaEdit
    {
        get => HttpData.Get<SubAktivitasDataStartPenyaluranPipaEdit>("subAktivitasDataStartPenyaluranPipaEdit")!;
        set => HttpData["subAktivitasDataStartPenyaluranPipaEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStartPenyaluranPipa
    /// </summary>
    public class SubAktivitasDataStartPenyaluranPipaEdit : SubAktivitasDataStartPenyaluranPipaEditBase
    {
        // Constructor
        public SubAktivitasDataStartPenyaluranPipaEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStartPenyaluranPipaEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStartPenyaluranPipaEditBase : SubAktivitasDataStartPenyaluranPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStartPenyaluranPipaEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranPipaEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStartPenyaluranPipaEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranPipaEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataStartPenyaluranPipaList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataStartPenyaluranPipaList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataStartPenyaluranPipaList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStartPenyaluranPipaEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataStartPenyaluranPipaList")), "", TableVar, true);
            string pageId = "edit";
