...
public partial class SnDOne {
    ...
    public class SubAktivitasSfadNewBlEditBase : SubAktivitasSfadNewBl
    {
        ...
        // Constructor
        public SubAktivitasSfadNewBlEditBase()
        {
        ...
        // Constructor
        public SubAktivitasSfadNewBlEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasSfadNewBlList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasSfadNewBlList") {
                                ...
                                returnUrl = "SubAktivitasSfadNewBlList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
