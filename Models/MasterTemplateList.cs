...
public partial class SnDOne {
    ...
    public class MasterTemplateListBase : MasterTemplate
    {
        ...
        // Constructor
        public MasterTemplateListBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterTemplateListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        {
            string filterList = "";
            filterList += ProcessFieldFilter("NamaTemplate", NamaTemplate, true, config);
            filterList += ProcessFieldFilter("IdModa", IdModa, true, config);
            filterList += ProcessFieldFilter("JenisProses", JenisProses, true, config);
            ...
            filterList += ProcessFieldFilter("TipePenimbunan", TipePenimbunan, true, config);
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        {
            LoadFieldNamaTemplateSearchValues();
            LoadFieldIdModaSearchValues();
            LoadFieldJenisProsesSearchValues();
            ...
            LoadFieldTipePenimbunanSearchValues();
            LoadFieldTipePenyaluranSearchValues();
            LoadFieldKategoriPenyaluranSearchValues();
            LoadFieldNamaDokumenSearchValues();
        }

        private void LoadFieldNamaTemplateSearchValues()
        {
            // NamaTemplate
            LoadPrimarySearchValueNamaTemplate();
            LoadSearchOperatorNamaTemplate();
        }

        private void LoadPrimarySearchValueNamaTemplate()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_NamaTemplate[]")) {
        ...
        private void LoadSearchOperatorNamaTemplate()
        {
        ...
        private void LoadFieldJenisProsesSearchValues()
        {
            // JenisProses
            LoadPrimarySearchValueJenisProses();
            LoadSearchOperatorJenisProses();
        }

        private void LoadPrimarySearchValueJenisProses()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_JenisProses[]")) {
        ...
        private void LoadSearchOperatorJenisProses()
        {
        ...
        private void LoadFieldTipePenimbunanSearchValues()
        {
            // TipePenimbunan
            LoadPrimarySearchValueTipePenimbunan();
            LoadSearchOperatorTipePenimbunan();
        }

        private void LoadPrimarySearchValueTipePenimbunan()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_TipePenimbunan[]")) {
        ...
        private void LoadSearchOperatorTipePenimbunan()
        {
