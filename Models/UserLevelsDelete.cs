...
public partial class SnDOne {
    ...
    /// userLevelsDelete
    /// </summary>
    public static UserLevelsDelete userLevelsDelete
    {
        get => HttpData.Get<UserLevelsDelete>("userLevelsDelete")!;
        set => HttpData["userLevelsDelete"] = value;
    }

    /// <summary>
    /// Page class for UserLevels
    /// </summary>
    public class UserLevelsDelete : UserLevelsDeleteBase
    {
        // Constructor
        public UserLevelsDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public UserLevelsDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class UserLevelsDeleteBase : UserLevels
    {
        // Page ID
        ...
        // Page name
        public string PageName => "UserLevelsDelete";
        ...
        // Constructor
        public UserLevelsDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("UserLevelsList"); // Prevent SQL injection, return to List page
                ...
                if (result) {
                    foreach (var row in oldRows) {
                        ...
                        if (!result) {
                            ...
                            if (!Empty(row["UserLevelID"]))
                                await Resolve(Config.UserLevelPrivTableName)?.DeleteAsync(null, new Dictionary<string, object> { { Config.UserLevelPrivUserLevelIdField, ConvertToInt(row["UserLevelID"]) } }); // Delete user level permissions (Use main connection)
                        }
                    }
                }
