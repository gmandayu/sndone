...
public partial class SnDOne {
    ...
    public class SubAktivitasLogbookPenerimaanPenyaluranListBase : SubAktivitasLogbookPenerimaanPenyaluran
    {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanPenyaluranListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanPenyaluranListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            if (filter.TryGetValue("x_InLineBlending", out sv)) {
                RestoreFieldFilter(InLineBlending, filter, "InLineBlending", sv);
            }

            // Field NomorTangki2
            if (filter.TryGetValue("x_NomorTangki2", out sv)) {
                RestoreFieldFilter(NomorTangki2, filter, "NomorTangki2", sv);
            }
