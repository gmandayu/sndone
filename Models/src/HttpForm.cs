...
public partial class SnDOne {
    ...
    public class HttpForm
    {
        ...
        public string GetValue(string name, char? sep = null) => TryGetValue(name, out StringValues sv) ? String.Join(sep ?? Config.MultipleOptionSeparator, sv.ToArray()) : String.Empty;
