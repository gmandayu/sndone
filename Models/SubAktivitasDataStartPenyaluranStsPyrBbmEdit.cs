...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStartPenyaluranStsPyrBbmEdit
    /// </summary>
    public static SubAktivitasDataStartPenyaluranStsPyrBbmEdit subAktivitasDataStartPenyaluranStsPyrBbmEdit
    {
        get => HttpData.Get<SubAktivitasDataStartPenyaluranStsPyrBbmEdit>("subAktivitasDataStartPenyaluranStsPyrBbmEdit")!;
        set => HttpData["subAktivitasDataStartPenyaluranStsPyrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStartPenyaluranSTSPyrBBM
    /// </summary>
    public class SubAktivitasDataStartPenyaluranStsPyrBbmEdit : SubAktivitasDataStartPenyaluranStsPyrBbmEditBase
    {
        // Constructor
        public SubAktivitasDataStartPenyaluranStsPyrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStartPenyaluranStsPyrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStartPenyaluranStsPyrBbmEditBase : SubAktivitasDataStartPenyaluranStsPyrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStartPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranStsPyrBbmEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStartPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranStsPyrBbmEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataStartPenyaluranStsPyrBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataStartPenyaluranStsPyrBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataStartPenyaluranStsPyrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStartPenyaluranStsPyrBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataStartPenyaluranStsPyrBbmList")), "", TableVar, true);
            string pageId = "edit";
