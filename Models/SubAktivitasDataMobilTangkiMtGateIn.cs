...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataMobilTangkiMtGateIn
    /// </summary>
    [MaybeNull]
    public static SubAktivitasDataMobilTangkiMtGateIn subAktivitasDataMobilTangkiMtGateIn
    {
        get => HttpData.Resolve<SubAktivitasDataMobilTangkiMtGateIn>("SubAktivitasDataMobilTangkiMTGateIn");
        set => HttpData["SubAktivitasDataMobilTangkiMTGateIn"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasDataMobilTangkiMTGateIn
    /// </summary>
    public class SubAktivitasDataMobilTangkiMtGateIn : DbTable
    {
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateIn()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasDataMobilTangkiMTGateIn";
            Name = "SubAktivitasDataMobilTangkiMTGateIn";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasDataMobilTangkiMTGateIn"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomorPolisi = new(this, "x_NomorPolisi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "NomorPolisi", "CustomMsg"),
                IsUpload = false
            };
            ...
            AMT = new(this, "x_AMT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "AMT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AMT", AMT);
            ...
            WaktuGateIn = new(this, "x_WaktuGateIn", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "WaktuGateIn", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateIn", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasDataMobilTangkiMTGateIn";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasDataMobilTangkiMtgateIn type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasDataMobilTangkiMtGateInList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasDataMobilTangkiMtGateInView" => Language.Phrase("View"),
                "SubAktivitasDataMobilTangkiMtGateInEdit" => Language.Phrase("Edit"),
                "SubAktivitasDataMobilTangkiMtGateInAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasDataMobilTangkiMtGateInView",
                Config.ApiAddAction => "SubAktivitasDataMobilTangkiMtGateInAdd",
                Config.ApiEditAction => "SubAktivitasDataMobilTangkiMtGateInEdit",
                Config.ApiDeleteAction => "SubAktivitasDataMobilTangkiMtGateInDelete",
                Config.ApiListAction => "SubAktivitasDataMobilTangkiMtGateInList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasDataMobilTangkiMtGateInList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasDataMobilTangkiMtGateInView", parm);
            else
                url = KeyUrl("SubAktivitasDataMobilTangkiMtGateInView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasDataMobilTangkiMtGateInAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasDataMobilTangkiMtGateInAdd?" + parm;
            else
                url = "SubAktivitasDataMobilTangkiMtGateInAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataMobilTangkiMtGateInEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataMobilTangkiMtGateInList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataMobilTangkiMtGateInAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataMobilTangkiMtGateInList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasDataMobilTangkiMtGateInDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasDataMobilTangkiMtGateInList";
