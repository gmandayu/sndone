...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputMonitoringStockStsPymSlpgListBase : SubAktivitasFormInputMonitoringStockStsPymSlpg
    {
        ...
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSlpgListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSlpgListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field NomorTangki
            if (filter.TryGetValue("x_NomorTangki", out sv)) {
                RestoreFieldFilter(NomorTangki, filter, "NomorTangki", sv);
            }
            ...
            // Field QuantityAwal
            if (filter.TryGetValue("x_QuantityAwal", out sv)) {
                RestoreFieldFilter(QuantityAwal, filter, "QuantityAwal", sv);
            }

            // Field QuantityAkhir
            if (filter.TryGetValue("x_QuantityAkhir", out sv)) {
                RestoreFieldFilter(QuantityAkhir, filter, "QuantityAkhir", sv);
            }
            ...
            if (filter.TryGetValue("x_TanggalQuantityAwal", out sv)) {
                RestoreFieldFilter(TanggalQuantityAwal, filter, "TanggalQuantityAwal", sv);
            }

            // Field TanggalQuantityAkhir
            if (filter.TryGetValue("x_TanggalQuantityAkhir", out sv)) {
                RestoreFieldFilter(TanggalQuantityAkhir, filter, "TanggalQuantityAkhir", sv);
            }
        }
