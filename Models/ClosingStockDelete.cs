...
public partial class SnDOne {
    ...
    /// closingStockDelete
    /// </summary>
    public static ClosingStockDelete closingStockDelete
    {
        get => HttpData.Get<ClosingStockDelete>("closingStockDelete")!;
        set => HttpData["closingStockDelete"] = value;
    }

    /// <summary>
    /// Page class for ClosingStock
    /// </summary>
    public class ClosingStockDelete : ClosingStockDeleteBase
    {
        // Constructor
        public ClosingStockDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ClosingStockDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class ClosingStockDeleteBase : ClosingStock
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "closingStockDelete";
        ...
        // Page name
        public string PageName => "ClosingStockDelete";
        ...
        // Constructor
        public ClosingStockDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("ClosingStockList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("ClosingStockList"); // Return to list
                }
            }
