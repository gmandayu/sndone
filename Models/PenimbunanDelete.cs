...
public partial class SnDOne {
    ...
    /// penimbunanDelete
    /// </summary>
    public static PenimbunanDelete penimbunanDelete
    {
        get => HttpData.Get<PenimbunanDelete>("penimbunanDelete")!;
        set => HttpData["penimbunanDelete"] = value;
    }

    /// <summary>
    /// Page class for Penimbunan
    /// </summary>
    public class PenimbunanDelete : PenimbunanDeleteBase
    {
        // Constructor
        public PenimbunanDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenimbunanDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PenimbunanDeleteBase : Penimbunan
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penimbunanDelete";
        ...
        // Page name
        public string PageName => "PenimbunanDelete";
        ...
        // Constructor
        public PenimbunanDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("PenimbunanList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("PenimbunanList"); // Return to list
                }
            }
