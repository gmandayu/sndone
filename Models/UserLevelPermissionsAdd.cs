...
public partial class SnDOne {
    /// <summary>
    /// userLevelPermissionsAdd
    /// </summary>
    public static UserLevelPermissionsAdd userLevelPermissionsAdd
    {
        get => HttpData.Get<UserLevelPermissionsAdd>("userLevelPermissionsAdd")!;
        set => HttpData["userLevelPermissionsAdd"] = value;
    }

    /// <summary>
    /// Page class for UserLevelPermissions
    /// </summary>
    public class UserLevelPermissionsAdd : UserLevelPermissionsAddBase
    {
        // Constructor
        public UserLevelPermissionsAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public UserLevelPermissionsAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class UserLevelPermissionsAddBase : UserLevelPermissions
    {
        // Page ID
        ...
        // Constructor
        public UserLevelPermissionsAddBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "UserLevelPermissionsAdd";
        ...
        // Constructor
        public UserLevelPermissionsAddBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private string DetermineReturnUrl()
        {
            ...
            else if (GetPageName(returnUrl) == "UserLevelPermissionsView")
                returnUrl = ViewUrl;
            return returnUrl;
        }
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        userLevelPermissionsAdd?.PageRender();
                    }
        }
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            // Check if key value entered
            if (insertRow && ValidateKey && Empty(rsnew["TableName"])) {
                FailureMessage = Language.Phrase("InvalidKeyValue");
                insertRow = false;
            }
        ...
        protected Dictionary<string, object> GetAddRow()
        {
            try {
                ...
                // TableName
                _TableName.SetDbValue(rsnew, _TableName.CurrentValue);

                // Permission
                Permission.SetDbValue(rsnew, Permission.CurrentValue);
                return rsnew;
            } catch (Exception e) {
                if (Config.Debug)
                    throw;
        ...
        private void RestoreAddFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("TableName", out value)) // TableName
                _TableName.SetFormValue(ConvertToString(value));
            if (row.TryGetValue("Permission", out value)) // Permission
                Permission.SetFormValue(ConvertToString(value));
        }
