...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputFlowrateAddBase : SubAktivitasFormInputFlowrate
    {
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateAddBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateAddBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private IActionResult? HandleCopyAction(Dictionary<string, object>? rsold)
        {
            if (rsold == null) {
                ...
                return Terminate("SubAktivitasFormInputFlowrateList");
            }
            return null;
        }
        ...
        private void HandleAjaxActions(ref string returnUrl)
        {
            if (IsModal && UseAjaxActions) {
                ...
                if (GetPageName(returnUrl) != "SubAktivitasFormInputFlowrateList") {
                    ...
                    returnUrl = "SubAktivitasFormInputFlowrateList";
                }
            }
        }
        ...
        private void ValidateCustomPressure() {
            if (Pressure.Visible && Pressure.Required) {
                if (!Pressure.IsDetailKey && Empty(Pressure.FormValue)) {
                    Pressure.AddErrorMessage(ConvertToString(etlDate.RequiredErrorMessage).Replace("%s", etlDate.Caption));
                }
            }
        }
