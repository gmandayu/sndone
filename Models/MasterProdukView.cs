...
public partial class SnDOne {
    ...
    /// masterProdukView
    /// </summary>
    public static MasterProdukView masterProdukView
    {
        get => HttpData.Get<MasterProdukView>("masterProdukView")!;
        set => HttpData["masterProdukView"] = value;
    }

    /// <summary>
    /// Page class for MasterProduk
    /// </summary>
    public class MasterProdukView : MasterProdukViewBase
    {
        // Constructor
        public MasterProdukView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterProdukView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterProdukViewBase : MasterProduk
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterProdukView";
        ...
        public MasterProdukViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["NoProduk"] = keys[0];
            } else {
                RecordKeys["NoProduk"] = RouteValues.TryGetValue("NoProduk", out obj) && obj != null ? UrlDecode(obj) : Get("NoProduk"); // DN
            }
        ...
        // Page name
        public string PageName => "MasterProdukView";
        ...
        // Constructor
        public MasterProdukViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("NoProduk", out v) && !Empty(v)) { // DN
                NoProduk.QueryValue = UrlDecode(v); // DN
                RecordKeys["NoProduk"] = NoProduk.QueryValue;
            } else if (Get("NoProduk", out sv)) {
                NoProduk.QueryValue = sv.ToString();
                RecordKeys["NoProduk"] = NoProduk.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                NoProduk.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["NoProduk"] = NoProduk.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "MasterProdukList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterProdukList"); // Return to list page
                            }
                        }
                    break;
            }
