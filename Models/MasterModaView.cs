...
public partial class SnDOne {
    ...
    public class MasterModaViewBase : MasterModa
    {
        ...
        // Constructor
        public MasterModaViewBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterModaViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdModa", out v) && !Empty(v))
                {
                IdModa.QueryValue = UrlDecode(v);
                RecordKeys["IdModa"] = IdModa.QueryValue;
                return;
                }
                if (Get("IdModa", out sv))
                {
        ...
        private IActionResult NoRecordResult()
        {
            ...
            return Terminate("MasterModaList");
        }
