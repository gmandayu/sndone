...
public partial class SnDOne {
    ...
    public class PengujianSampleLainnyaListBase : PengujianSampleLainnya
    {
        ...
        // Constructor
        public PengujianSampleLainnyaListBase(Controller? controller)
        {
        ...
        // Constructor
        public PengujianSampleLainnyaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            if (filter.TryGetValue("x_NomorPengujianSampelLainnya", out sv)) {
                RestoreFieldFilter(NomorPengujianSampelLainnya, filter, "NomorPengujianSampelLainnya", sv);
            }
        ...
        {
            string filterList = "";
            filterList += ProcessFieldFilter("NomorPengujianSampelLainnya", NomorPengujianSampelLainnya, true, config);
            filterList += ProcessFieldFilter("idPlant", idPlant, true, config);
            filterList += ProcessFieldFilter("Tanggal", Tanggal, false, config);
            filterList += ProcessFieldFilter("Produk", Produk, true, config);
            filterList += ProcessFieldFilter("Keterangan", Keterangan, false, config);
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        {
            LoadFieldNomorPengujianSampelLainnyaSearchValues();
        ...
        private void LoadFieldNomorPengujianSampelLainnyaSearchValues()
        {
            // NomorPengujianSampelLainnya
            LoadPrimarySearchValueNomorPengujianSampelLainnya();
            LoadSearchOperatorNomorPengujianSampelLainnya();
        }

        private void LoadPrimarySearchValueNomorPengujianSampelLainnya()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_NomorPengujianSampelLainnya[]")) {
        ...
        private void LoadSearchOperatorNomorPengujianSampelLainnya()
        {
        ...
        private void LoadPrimarySearchValueTanggal()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Tanggal")) {
                Tanggal.AdvancedSearch.SearchValue = Get("x_Tanggal");
            }
            else if (!IsAddOrEdit) {
        ...
        private void LoadSearchOperatorTanggal()
        {
            if (Query.ContainsKey("z_Tanggal"))
                Tanggal.AdvancedSearch.SearchOperator = Get("z_Tanggal");
        }
        ...
        private void LoadPrimarySearchValueKeterangan()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Keterangan")) {
                Keterangan.AdvancedSearch.SearchValue = Get("x_Keterangan");
            }
            else if (!IsAddOrEdit) {
        ...
        private void LoadSearchOperatorKeterangan()
        {
            if (Query.ContainsKey("z_Keterangan"))
                Keterangan.AdvancedSearch.SearchOperator = Get("z_Keterangan");
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // TanggalDiperbarui
                    ...
                    // awallookupbung
                    // Produk (jaga leading zero)
                    ResolveLookupView(Produk, "NoProduk", "string");
                    // akhirlookupbung
