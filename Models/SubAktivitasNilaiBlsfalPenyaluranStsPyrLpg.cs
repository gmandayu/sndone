...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiBlsfalPenyaluranStsPyrLpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiBlsfalPenyaluranStsPyrLpg subAktivitasNilaiBlsfalPenyaluranStsPyrLpg
    {
        get => HttpData.Resolve<SubAktivitasNilaiBlsfalPenyaluranStsPyrLpg>("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG");
        set => HttpData["SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG
    /// </summary>
    public class SubAktivitasNilaiBlsfalPenyaluranStsPyrLpg : DbTable
    {
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranStsPyrLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG";
            Name = "SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            BL_MT = new(this, "x_BL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG", "BL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAL_MT = new(this, "x_SFAL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG", "SFAL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiBlsfalpenyaluranStspyrLpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgView" => Language.Phrase("View"),
                "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgView",
                Config.ApiAddAction => "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgAdd",
                Config.ApiEditAction => "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgDelete",
                Config.ApiListAction => "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgAdd?" + parm;
            else
                url = "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgList";
