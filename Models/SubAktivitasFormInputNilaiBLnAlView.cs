...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputNilaiBLnAlViewBase : SubAktivitasFormInputNilaiBLnAl
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLnAlViewBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLnAlViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputNilaiBLnAlList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputNilaiBLnAlList"); // Return to list page
                            }
                        }
                    break;
            }
