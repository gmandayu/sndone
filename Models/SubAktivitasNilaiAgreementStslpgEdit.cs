...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiAgreementStslpgEdit
    /// </summary>
    public static SubAktivitasNilaiAgreementStslpgEdit subAktivitasNilaiAgreementStslpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiAgreementStslpgEdit>("subAktivitasNilaiAgreementStslpgEdit")!;
        set => HttpData["subAktivitasNilaiAgreementStslpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiAgreementSTSLPG
    /// </summary>
    public class SubAktivitasNilaiAgreementStslpgEdit : SubAktivitasNilaiAgreementStslpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiAgreementStslpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiAgreementStslpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiAgreementStslpgEditBase : SubAktivitasNilaiAgreementStslpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiAgreementStslpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementStslpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiAgreementStslpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementStslpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiAgreementStslpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiAgreementStslpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiAgreementStslpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiAgreementStslpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiAgreementStslpgList")), "", TableVar, true);
            string pageId = "edit";
