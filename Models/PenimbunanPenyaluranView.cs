...
public partial class SnDOne {
    /// <summary>
    /// penimbunanPenyaluranView
    /// </summary>
    public static PenimbunanPenyaluranView penimbunanPenyaluranView
    {
        get => HttpData.Get<PenimbunanPenyaluranView>("penimbunanPenyaluranView")!;
        set => HttpData["penimbunanPenyaluranView"] = value;
    }

    /// <summary>
    /// Page class for PenimbunanPenyaluran
    /// </summary>
    public class PenimbunanPenyaluranView : PenimbunanPenyaluranViewBase
    {
        // Constructor
        public PenimbunanPenyaluranView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenimbunanPenyaluranView() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PenimbunanPenyaluranViewBase : PenimbunanPenyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penimbunanPenyaluranView";
        ...
        // Constructor
        public PenimbunanPenyaluranViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdPenimbunanPenyaluran"] = keys[0];
            } else {
                RecordKeys["IdPenimbunanPenyaluran"] = RouteValues.TryGetValue("IdPenimbunanPenyaluran", out obj) && obj != null ? UrlDecode(obj) : Get("IdPenimbunanPenyaluran"); // DN
            }
        ...
        // Page name
        public string PageName => "PenimbunanPenyaluranView";
        ...
        {
            IdPenimbunanPenyaluran.SetVisibility();
        ...
        // Constructor
        public PenimbunanPenyaluranViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdPenimbunanPenyaluran", out v) && !Empty(v)) { // DN
                IdPenimbunanPenyaluran.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdPenimbunanPenyaluran"] = IdPenimbunanPenyaluran.QueryValue;
            } else if (Get("IdPenimbunanPenyaluran", out sv)) {
                IdPenimbunanPenyaluran.QueryValue = sv.ToString();
                RecordKeys["IdPenimbunanPenyaluran"] = IdPenimbunanPenyaluran.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdPenimbunanPenyaluran.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdPenimbunanPenyaluran"] = IdPenimbunanPenyaluran.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "PenimbunanPenyaluranList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("PenimbunanPenyaluranList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                penimbunanPenyaluranView?.PageRender();
            }
            return PageResult();
        }
        ...
        public async Task ExportData(dynamic? doc, string[] keys)
        {
            ...
            StartRecord = 1;
            if (keys.Length >= 1) {
                IdPenimbunanPenyaluran.OldValue = keys[0];
