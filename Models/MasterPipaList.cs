...
public partial class SnDOne {
    ...
    public class MasterPipaListBase : MasterPipa
    {
        ...
        // Constructor
        public MasterPipaListBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterPipaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            if (filter.TryGetValue("x_KeteranganPipa", out sv)) {
                RestoreFieldFilter(KeteranganPipa, filter, "KeteranganPipa", sv);
            }

            // Field idPlantAsal
            if (filter.TryGetValue("x_idPlantAsal", out sv)) {
                RestoreFieldFilter(idPlantAsal, filter, "idPlantAsal", sv);
            }

            // Field idPlantTujuan
            if (filter.TryGetValue("x_idPlantTujuan", out sv)) {
                RestoreFieldFilter(idPlantTujuan, filter, "idPlantTujuan", sv);
            }

            // Field Panjang
            if (filter.TryGetValue("x_Panjang", out sv)) {
                RestoreFieldFilter(Panjang, filter, "Panjang", sv);
            }

            // Field Diameter
            if (filter.TryGetValue("x_Diameter", out sv)) {
                RestoreFieldFilter(Diameter, filter, "Diameter", sv);
            }
            ...
            if (filter.TryGetValue("x_idPlantTujuan2", out sv)) {
                RestoreFieldFilter(idPlantTujuan2, filter, "idPlantTujuan2", sv);
            }

            // Field Panjang2
            if (filter.TryGetValue("x_Panjang2", out sv)) {
                RestoreFieldFilter(Panjang2, filter, "Panjang2", sv);
            }

            // Field Diameter2
            if (filter.TryGetValue("x_Diameter2", out sv)) {
                RestoreFieldFilter(Diameter2, filter, "Diameter2", sv);
            }

            // Field Volume2
            if (filter.TryGetValue("x_Volume2", out sv)) {
                RestoreFieldFilter(Volume2, filter, "Volume2", sv);
            }

            // Field Flowrate2
            if (filter.TryGetValue("x_Flowrate2", out sv)) {
                RestoreFieldFilter(Flowrate2, filter, "Flowrate2", sv);
            }

            // Field idPlantTujuan3
            if (filter.TryGetValue("x_idPlantTujuan3", out sv)) {
                RestoreFieldFilter(idPlantTujuan3, filter, "idPlantTujuan3", sv);
            }

            // Field Panjang3
            if (filter.TryGetValue("x_Panjang3", out sv)) {
                RestoreFieldFilter(Panjang3, filter, "Panjang3", sv);
            }

            // Field Diameter3
            if (filter.TryGetValue("x_Diameter3", out sv)) {
                RestoreFieldFilter(Diameter3, filter, "Diameter3", sv);
            }

            // Field Volume3
            if (filter.TryGetValue("x_Volume3", out sv)) {
                RestoreFieldFilter(Volume3, filter, "Volume3", sv);
            }

            // Field Flowrate3
            if (filter.TryGetValue("x_Flowrate3", out sv)) {
                RestoreFieldFilter(Flowrate3, filter, "Flowrate3", sv);
            }

            // Field BiayaProject
            if (filter.TryGetValue("x_BiayaProject", out sv)) {
                RestoreFieldFilter(BiayaProject, filter, "BiayaProject", sv);
            }

            // Field PlantAsal
            if (filter.TryGetValue("x_PlantAsal", out sv)) {
                RestoreFieldFilter(PlantAsal, filter, "PlantAsal", sv);
            }

            // Field NamaPlantAsal
            if (filter.TryGetValue("x_NamaPlantAsal", out sv)) {
                RestoreFieldFilter(NamaPlantAsal, filter, "NamaPlantAsal", sv);
            }

            // Field PlantTujuan
            if (filter.TryGetValue("x_PlantTujuan", out sv)) {
                RestoreFieldFilter(PlantTujuan, filter, "PlantTujuan", sv);
            }

            // Field NamaPlantTujuan
            if (filter.TryGetValue("x_NamaPlantTujuan", out sv)) {
                RestoreFieldFilter(NamaPlantTujuan, filter, "NamaPlantTujuan", sv);
            }

            // Field PlantTujuan2
            if (filter.TryGetValue("x_PlantTujuan2", out sv)) {
                RestoreFieldFilter(PlantTujuan2, filter, "PlantTujuan2", sv);
            }

            // Field NamaPlantTujuan2
            if (filter.TryGetValue("x_NamaPlantTujuan2", out sv)) {
                RestoreFieldFilter(NamaPlantTujuan2, filter, "NamaPlantTujuan2", sv);
            }

            // Field PlantTujuan3
            if (filter.TryGetValue("x_PlantTujuan3", out sv)) {
                RestoreFieldFilter(PlantTujuan3, filter, "PlantTujuan3", sv);
            }

            // Field NamaPlantTujuan3
            if (filter.TryGetValue("x_NamaPlantTujuan3", out sv)) {
                RestoreFieldFilter(NamaPlantTujuan3, filter, "NamaPlantTujuan3", sv);
            }

            // Field CreatedBy
            if (filter.TryGetValue("x_CreatedBy", out sv)) {
                RestoreFieldFilter(CreatedBy, filter, "CreatedBy", sv);
            }
        ...
        {
            string filterList = "";
            filterList += ProcessFieldFilter("KeteranganPipa", KeteranganPipa, true, config);
            filterList += ProcessFieldFilter("idPlantAsal", idPlantAsal, true, config);
            filterList += ProcessFieldFilter("Flowrate", Flowrate, true, config);
            filterList += ProcessFieldFilter("BiayaProject", BiayaProject, true, config);
            filterList += ProcessFieldFilter("PlantAsal", PlantAsal, true, config);
            filterList += ProcessFieldFilter("NamaPlantAsal", NamaPlantAsal, true, config);
            filterList += ProcessFieldFilter("CreatedBy", CreatedBy, true, config);
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        {
            LoadFieldidSearchValues();
            LoadFieldKeteranganPipaSearchValues();
            LoadFieldidPlantAsalSearchValues();
            LoadFieldidPlantTujuanSearchValues();
            LoadFieldPanjangSearchValues();
            LoadFieldDiameterSearchValues();
            LoadFieldVolumeSearchValues();
            LoadFieldFlowrateSearchValues();
            LoadFieldidPlantTujuan2SearchValues();
            LoadFieldPanjang2SearchValues();
            LoadFieldDiameter2SearchValues();
            LoadFieldVolume2SearchValues();
            LoadFieldFlowrate2SearchValues();
            LoadFieldidPlantTujuan3SearchValues();
            LoadFieldPanjang3SearchValues();
            LoadFieldDiameter3SearchValues();
            LoadFieldVolume3SearchValues();
            LoadFieldFlowrate3SearchValues();
            LoadFieldBiayaProjectSearchValues();
            LoadFieldPlantAsalSearchValues();
            LoadFieldNamaPlantAsalSearchValues();
            LoadFieldPlantTujuanSearchValues();
            LoadFieldNamaPlantTujuanSearchValues();
            LoadFieldPlantTujuan2SearchValues();
            LoadFieldNamaPlantTujuan2SearchValues();
            LoadFieldPlantTujuan3SearchValues();
            LoadFieldNamaPlantTujuan3SearchValues();
            LoadFieldCreatedBySearchValues();
            LoadFieldetlDateSearchValues();
            LoadFieldLastUpdatedBySearchValues();
            LoadFieldLastUpdatedDateSearchValues();
        }

        private void LoadFieldidSearchValues()
        {
            // id
            LoadPrimarySearchValueid();
            LoadSearchOperatorid();
        }

        private void LoadPrimarySearchValueid()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_id")) {
        ...
        private void LoadSearchOperatorid()
        {
            if (Query.ContainsKey("z_id"))
                id.AdvancedSearch.SearchOperator = Get("z_id");
        }

        private void LoadFieldKeteranganPipaSearchValues()
        {
            // KeteranganPipa
            LoadPrimarySearchValueKeteranganPipa();
            LoadSearchOperatorKeteranganPipa();
        }

        private void LoadPrimarySearchValueKeteranganPipa()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_KeteranganPipa[]")) {
        ...
        private void LoadSearchOperatorKeteranganPipa()
        {
        ...
        private void LoadFieldidPlantAsalSearchValues()
        {
            // idPlantAsal
            LoadPrimarySearchValueidPlantAsal();
            LoadSearchOperatoridPlantAsal();
        }

        private void LoadPrimarySearchValueidPlantAsal()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_idPlantAsal[]")) {
        ...
        private void LoadSearchOperatoridPlantAsal()
        {
        ...
        private void LoadFieldidPlantTujuanSearchValues()
        {
            // idPlantTujuan
            LoadPrimarySearchValueidPlantTujuan();
            LoadSearchOperatoridPlantTujuan();
        }

        private void LoadPrimarySearchValueidPlantTujuan()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_idPlantTujuan[]")) {
        ...
        private void LoadSearchOperatoridPlantTujuan()
        {
        ...
        private void LoadFieldPanjangSearchValues()
        {
            // Panjang
            LoadPrimarySearchValuePanjang();
            LoadSearchOperatorPanjang();
        }

        private void LoadPrimarySearchValuePanjang()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Panjang[]")) {
        ...
        private void LoadSearchOperatorPanjang()
        {
            if (Query.ContainsKey("z_Panjang"))
                Panjang.AdvancedSearch.SearchOperator = Get("z_Panjang", Config.FilterOptionSeparator);
        }

        private void LoadFieldDiameterSearchValues()
        {
            // Diameter
            LoadPrimarySearchValueDiameter();
            LoadSearchOperatorDiameter();
        }

        private void LoadPrimarySearchValueDiameter()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Diameter[]")) {
        ...
        private void LoadSearchOperatorDiameter()
        {
        ...
        private void LoadFieldFlowrateSearchValues()
        {
            // Flowrate
            LoadPrimarySearchValueFlowrate();
            LoadSearchOperatorFlowrate();
        }

        private void LoadPrimarySearchValueFlowrate()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Flowrate[]")) {
        ...
        private void LoadSearchOperatorFlowrate()
        {
            if (Query.ContainsKey("z_Flowrate"))
                Flowrate.AdvancedSearch.SearchOperator = Get("z_Flowrate", Config.FilterOptionSeparator);
        }

        private void LoadFieldidPlantTujuan2SearchValues()
        {
            // idPlantTujuan2
            LoadPrimarySearchValueidPlantTujuan2();
            LoadSearchOperatoridPlantTujuan2();
        }

        private void LoadPrimarySearchValueidPlantTujuan2()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_idPlantTujuan2[]")) {
        ...
        private void LoadSearchOperatoridPlantTujuan2()
        {
        ...
        private void LoadFieldPanjang2SearchValues()
        {
            // Panjang2
            LoadPrimarySearchValuePanjang2();
            LoadSearchOperatorPanjang2();
        }

        private void LoadPrimarySearchValuePanjang2()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Panjang2[]")) {
        ...
        private void LoadSearchOperatorPanjang2()
        {
            if (Query.ContainsKey("z_Panjang2"))
                Panjang2.AdvancedSearch.SearchOperator = Get("z_Panjang2", Config.FilterOptionSeparator);
        }

        private void LoadFieldDiameter2SearchValues()
        {
            // Diameter2
            LoadPrimarySearchValueDiameter2();
            LoadSearchOperatorDiameter2();
        }

        private void LoadPrimarySearchValueDiameter2()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Diameter2[]")) {
        ...
        private void LoadSearchOperatorDiameter2()
        {
        ...
        private void LoadFieldFlowrate2SearchValues()
        {
            // Flowrate2
            LoadPrimarySearchValueFlowrate2();
            LoadSearchOperatorFlowrate2();
        }

        private void LoadPrimarySearchValueFlowrate2()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Flowrate2[]")) {
        ...
        private void LoadSearchOperatorFlowrate2()
        {
            if (Query.ContainsKey("z_Flowrate2"))
                Flowrate2.AdvancedSearch.SearchOperator = Get("z_Flowrate2", Config.FilterOptionSeparator);
        }

        private void LoadFieldidPlantTujuan3SearchValues()
        {
            // idPlantTujuan3
            LoadPrimarySearchValueidPlantTujuan3();
            LoadSearchOperatoridPlantTujuan3();
        }

        private void LoadPrimarySearchValueidPlantTujuan3()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_idPlantTujuan3[]")) {
        ...
        private void LoadSearchOperatoridPlantTujuan3()
        {
        ...
        private void LoadFieldPanjang3SearchValues()
        {
            // Panjang3
            LoadPrimarySearchValuePanjang3();
            LoadSearchOperatorPanjang3();
        }

        private void LoadPrimarySearchValuePanjang3()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Panjang3[]")) {
        ...
        private void LoadSearchOperatorPanjang3()
        {
            if (Query.ContainsKey("z_Panjang3"))
                Panjang3.AdvancedSearch.SearchOperator = Get("z_Panjang3", Config.FilterOptionSeparator);
        }

        private void LoadFieldDiameter3SearchValues()
        {
            // Diameter3
            LoadPrimarySearchValueDiameter3();
            LoadSearchOperatorDiameter3();
        }

        private void LoadPrimarySearchValueDiameter3()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Diameter3[]")) {
        ...
        private void LoadSearchOperatorDiameter3()
        {
        ...
        private void LoadFieldFlowrate3SearchValues()
        {
            // Flowrate3
            LoadPrimarySearchValueFlowrate3();
            LoadSearchOperatorFlowrate3();
        }

        private void LoadPrimarySearchValueFlowrate3()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_Flowrate3[]")) {
        ...
        private void LoadSearchOperatorFlowrate3()
        {
            if (Query.ContainsKey("z_Flowrate3"))
                Flowrate3.AdvancedSearch.SearchOperator = Get("z_Flowrate3", Config.FilterOptionSeparator);
        }

        private void LoadFieldBiayaProjectSearchValues()
        {
            // BiayaProject
            LoadPrimarySearchValueBiayaProject();
            LoadSearchOperatorBiayaProject();
        }

        private void LoadPrimarySearchValueBiayaProject()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_BiayaProject[]")) {
        ...
        private void LoadSearchOperatorBiayaProject()
        {
        ...
        private void LoadFieldPlantAsalSearchValues()
        {
            // PlantAsal
            LoadPrimarySearchValuePlantAsal();
            LoadSearchOperatorPlantAsal();
        }

        private void LoadPrimarySearchValuePlantAsal()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_PlantAsal[]")) {
        ...
        private void LoadSearchOperatorPlantAsal()
        {
            if (Query.ContainsKey("z_PlantAsal"))
                PlantAsal.AdvancedSearch.SearchOperator = Get("z_PlantAsal", Config.FilterOptionSeparator);
        }

        private void LoadFieldNamaPlantAsalSearchValues()
        {
            // NamaPlantAsal
            LoadPrimarySearchValueNamaPlantAsal();
            LoadSearchOperatorNamaPlantAsal();
        }

        private void LoadPrimarySearchValueNamaPlantAsal()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_NamaPlantAsal[]")) {
        ...
        private void LoadSearchOperatorNamaPlantAsal()
        {
        ...
        private void LoadFieldPlantTujuanSearchValues()
        {
            // PlantTujuan
            LoadPrimarySearchValuePlantTujuan();
            LoadSearchOperatorPlantTujuan();
        }

        private void LoadPrimarySearchValuePlantTujuan()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_PlantTujuan[]")) {
        ...
        private void LoadSearchOperatorPlantTujuan()
        {
        ...
        private void LoadFieldNamaPlantTujuanSearchValues()
        {
            // NamaPlantTujuan
            LoadPrimarySearchValueNamaPlantTujuan();
            LoadSearchOperatorNamaPlantTujuan();
        }

        private void LoadPrimarySearchValueNamaPlantTujuan()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_NamaPlantTujuan[]")) {
        ...
        private void LoadSearchOperatorNamaPlantTujuan()
        {
        ...
        private void LoadFieldPlantTujuan2SearchValues()
        {
            // PlantTujuan2
            LoadPrimarySearchValuePlantTujuan2();
            LoadSearchOperatorPlantTujuan2();
        }

        private void LoadPrimarySearchValuePlantTujuan2()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_PlantTujuan2[]")) {
        ...
        private void LoadSearchOperatorPlantTujuan2()
        {
        ...
        private void LoadFieldNamaPlantTujuan2SearchValues()
        {
            // NamaPlantTujuan2
            LoadPrimarySearchValueNamaPlantTujuan2();
            LoadSearchOperatorNamaPlantTujuan2();
        }

        private void LoadPrimarySearchValueNamaPlantTujuan2()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_NamaPlantTujuan2[]")) {
        ...
        private void LoadSearchOperatorNamaPlantTujuan2()
        {
        ...
        private void LoadFieldPlantTujuan3SearchValues()
        {
            // PlantTujuan3
            LoadPrimarySearchValuePlantTujuan3();
            LoadSearchOperatorPlantTujuan3();
        }

        private void LoadPrimarySearchValuePlantTujuan3()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_PlantTujuan3[]")) {
        ...
        private void LoadSearchOperatorPlantTujuan3()
        {
        ...
        private void LoadFieldNamaPlantTujuan3SearchValues()
        {
            // NamaPlantTujuan3
            LoadPrimarySearchValueNamaPlantTujuan3();
            LoadSearchOperatorNamaPlantTujuan3();
        }

        private void LoadPrimarySearchValueNamaPlantTujuan3()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_NamaPlantTujuan3[]")) {
        ...
        private void LoadSearchOperatorNamaPlantTujuan3()
        {
        ...
        private void LoadFieldCreatedBySearchValues()
        {
            // CreatedBy
            LoadPrimarySearchValueCreatedBy();
            LoadSearchOperatorCreatedBy();
        }

        private void LoadPrimarySearchValueCreatedBy()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_CreatedBy[]")) {
        ...
        private void LoadSearchOperatorCreatedBy()
        {
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // LastUpdatedDate
                    ...
                    // awallookupbung
                    // idPlantAsal
                    ResolveLookupView(idPlantAsal, "IdPlant", "number");
                    // akhirlookupbung
                    ...
                    // awallookupbung
                    // idPlantTujuan
                    ResolveLookupView(idPlantTujuan, "IdPlant", "number");
                    // akhirlookupbung
                    ...
                    // awallookupbung
                    // idPlantTujuan2
                    ResolveLookupView(idPlantTujuan2, "IdPlant", "number");
                    // akhirlookupbung
                    ...
                    // awallookupbung
                    // idPlantTujuan3
                    ResolveLookupView(idPlantTujuan3, "IdPlant", "number");
                    // akhirlookupbung
