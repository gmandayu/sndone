...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static MwtOnlineDetail mwtOnlineDetail
    {
        get => HttpData.Resolve<MwtOnlineDetail>("MWTOnlineDetail");
        set => HttpData["MWTOnlineDetail"] = value;
    }

    /// <summary>
    /// Table class for MWTOnlineDetail
    /// </summary>
    public class MwtOnlineDetail : DbTable
    {
        ...
        public readonly DbField<SqlDbType> Penjelasan;

        public readonly DbField<SqlDbType> UploadEvidence;
        ...
        public readonly DbField<SqlDbType> OriginalFileName;

        public readonly DbField<SqlDbType> Flag;

        // Constructor
        public MwtOnlineDetail()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MWTOnlineDetail";
            Name = "MWTOnlineDetail";
            Type = "TABLE";
            UpdateTable = "dbo.MWTOnlineDetail"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new(this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "Id", "CustomMsg"),
                IsUpload = false
            };
            Id.Raw = true;
            Fields.Add("Id", Id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NoReferensi", NoReferensi);

            // Penjelasan
            Penjelasan = new(this, "x_Penjelasan", 203, SqlDbType.NText) {
                Name = "Penjelasan",
                Expression = "[Penjelasan]",
                BasicSearchExpression = "[Penjelasan]",
                DateTimeFormat = -1,
                VirtualExpression = "[Penjelasan]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "Penjelasan", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Penjelasan", Penjelasan);

            // UploadEvidence
            UploadEvidence = new(this, "x_UploadEvidence", 202, SqlDbType.NVarChar) {
                Name = "UploadEvidence",
                Expression = "[UploadEvidence]",
                UseBasicSearch = true,
                BasicSearchExpression = "[UploadEvidence]",
                DateTimeFormat = -1,
                VirtualExpression = "[UploadEvidence]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "UploadEvidence", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("UploadEvidence", UploadEvidence);

            // CreatedDate
            CreatedDate = new(this, "x_CreatedDate", 135, SqlDbType.DateTime) {
                Name = "CreatedDate",
                Expression = "[CreatedDate]",
                BasicSearchExpression = CastDateFieldForLike("[CreatedDate]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "CreatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedBy = new(this, "x_CreatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "CreatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedDate = new(this, "x_LastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "LastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusEmail = new(this, "x_StatusEmail", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "StatusEmail", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("StatusEmail", StatusEmail);

            // FileType
            FileType = new(this, "x_FileType", 202, SqlDbType.NVarChar) {
                Name = "FileType",
                Expression = "[FileType]",
                UseBasicSearch = true,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "FileType", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("FileType", FileType);

            // OriginalFileName
            OriginalFileName = new(this, "x_OriginalFileName", 202, SqlDbType.NVarChar) {
                Name = "OriginalFileName",
                Expression = "[OriginalFileName]",
                UseBasicSearch = true,
                BasicSearchExpression = "[OriginalFileName]",
                DateTimeFormat = -1,
                VirtualExpression = "[OriginalFileName]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "OriginalFileName", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("OriginalFileName", OriginalFileName);

            // Flag
            Flag = new(this, "x_Flag", 202, SqlDbType.NVarChar) {
                Name = "Flag",
                Expression = "[Flag]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Flag]",
                DateTimeFormat = -1,
                VirtualExpression = "[Flag]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnlineDetail", "Flag", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Flag", Flag);
        ...
        {
            get => _sqlFrom ?? "dbo.MWTOnlineDetail";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MwtonlineDetail type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Penjelasan.DbValue = row["Penjelasan"]; // Set DB value only
                UploadEvidence.DbValue = row["UploadEvidence"]; // Set DB value only
                ...
                FileType.DbValue = row["FileType"]; // Set DB value only
                OriginalFileName.DbValue = row["OriginalFileName"]; // Set DB value only
                Flag.DbValue = row["Flag"]; // Set DB value only
            } catch {}
        }
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MwtOnlineDetailView" => Language.Phrase("View"),
                "MwtOnlineDetailEdit" => Language.Phrase("Edit"),
                "MwtOnlineDetailAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MwtOnlineDetailView",
                Config.ApiAddAction => "MwtOnlineDetailAdd",
                Config.ApiEditAction => "MwtOnlineDetailEdit",
                Config.ApiDeleteAction => "MwtOnlineDetailDelete",
                Config.ApiListAction => "MwtOnlineDetailList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MwtOnlineDetailList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MwtOnlineDetailView", parm);
            else
                url = KeyUrl("MwtOnlineDetailView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MwtOnlineDetailAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MwtOnlineDetailAdd?" + parm;
            else
                url = "MwtOnlineDetailAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MwtOnlineDetailEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MwtOnlineDetailList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MwtOnlineDetailAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MwtOnlineDetailList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MwtOnlineDetailDelete", parm)); // DN
        }
        ...
        {
            string pageName = "MwtOnlineDetailList";
        ...
        public async Task RenderEditRow()
        {
            ...
            UploadEvidence.EditValue = UploadEvidence.CurrentValue;
            ...
            StatusEmail.EditValue = StatusEmail.CurrentValue;
            ...
            FileType.EditValue = FileType.CurrentValue;
            ...
            OriginalFileName.EditValue = OriginalFileName.CurrentValue;
            ...
            Flag.EditValue = Flag.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(Penjelasan);
                        doc.ExportCaption(UploadEvidence);
                        ...
                        doc.ExportCaption(OriginalFileName);
                        doc.ExportCaption(Flag);
                    } else {
                        doc.ExportCaption(Id);
                        doc.ExportCaption(NoReferensi);
                        doc.ExportCaption(UploadEvidence);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(Penjelasan);
                            await doc.ExportField(UploadEvidence);
                            ...
                            await doc.ExportField(OriginalFileName);
                            await doc.ExportField(Flag);
                        } else {
                            await doc.ExportField(Id);
                            await doc.ExportField(NoReferensi);
                            await doc.ExportField(UploadEvidence);
