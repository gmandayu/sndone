...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStopPenyaluranPipaEdit
    /// </summary>
    public static SubAktivitasDataStopPenyaluranPipaEdit subAktivitasDataStopPenyaluranPipaEdit
    {
        get => HttpData.Get<SubAktivitasDataStopPenyaluranPipaEdit>("subAktivitasDataStopPenyaluranPipaEdit")!;
        set => HttpData["subAktivitasDataStopPenyaluranPipaEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStopPenyaluranPipa
    /// </summary>
    public class SubAktivitasDataStopPenyaluranPipaEdit : SubAktivitasDataStopPenyaluranPipaEditBase
    {
        // Constructor
        public SubAktivitasDataStopPenyaluranPipaEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStopPenyaluranPipaEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStopPenyaluranPipaEditBase : SubAktivitasDataStopPenyaluranPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStopPenyaluranPipaEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranPipaEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStopPenyaluranPipaEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranPipaEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataStopPenyaluranPipaList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataStopPenyaluranPipaList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataStopPenyaluranPipaList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStopPenyaluranPipaEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataStopPenyaluranPipaList")), "", TableVar, true);
            string pageId = "edit";
