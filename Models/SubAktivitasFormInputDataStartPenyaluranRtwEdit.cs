...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStartPenyaluranRtwEdit
    /// </summary>
    public static SubAktivitasFormInputDataStartPenyaluranRtwEdit subAktivitasFormInputDataStartPenyaluranRtwEdit
    {
        get => HttpData.Get<SubAktivitasFormInputDataStartPenyaluranRtwEdit>("subAktivitasFormInputDataStartPenyaluranRtwEdit")!;
        set => HttpData["subAktivitasFormInputDataStartPenyaluranRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStartPenyaluranRTW
    /// </summary>
    public class SubAktivitasFormInputDataStartPenyaluranRtwEdit : SubAktivitasFormInputDataStartPenyaluranRtwEditBase
    {
        // Constructor
        public SubAktivitasFormInputDataStartPenyaluranRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStartPenyaluranRtwEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStartPenyaluranRtwEditBase : SubAktivitasFormInputDataStartPenyaluranRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStartPenyaluranRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPenyaluranRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStartPenyaluranRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPenyaluranRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputDataStartPenyaluranRtwList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputDataStartPenyaluranRtwList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputDataStartPenyaluranRtwList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputDataStartPenyaluranRtwEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputDataStartPenyaluranRtwList")), "", TableVar, true);
            string pageId = "edit";
