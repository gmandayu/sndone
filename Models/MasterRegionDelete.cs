...
public partial class SnDOne {
    ...
    /// masterRegionDelete
    /// </summary>
    public static MasterRegionDelete masterRegionDelete
    {
        get => HttpData.Get<MasterRegionDelete>("masterRegionDelete")!;
        set => HttpData["masterRegionDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterRegion
    /// </summary>
    public class MasterRegionDelete : MasterRegionDeleteBase
    {
        // Constructor
        public MasterRegionDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterRegionDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterRegionDeleteBase : MasterRegion
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterRegionDelete";
        ...
        // Page name
        public string PageName => "MasterRegionDelete";
        ...
        // Constructor
        public MasterRegionDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterRegionList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterRegionList"); // Return to list
                }
            }
