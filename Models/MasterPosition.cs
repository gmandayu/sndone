...
public partial class SnDOne {
    ...
    {
        get => HttpData.Resolve<MasterPosition>("MasterPosition");
        set => HttpData["MasterPosition"] = value;
    }

    /// <summary>
    /// Table class for MasterPosition
    /// </summary>
    public class MasterPosition : DbTable
    {
        ...
        public MasterPosition()
        {
            ...
            Name = "MasterPosition";
            Type = "TABLE";
            UpdateTable = "dbo.MasterPosition"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdPosition = new(this, "x_IdPosition", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterPosition", "IdPosition", "CustomMsg"),
                IsUpload = false
            };
            IdPosition.Raw = true;
            IdPosition.Lookup = new Lookup<DbField>(IdPosition, "MasterPosition", true, "IdPosition", new List<string> {"IdPosition", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("IdPosition", IdPosition);

            // NamaPosition
            NamaPosition = new(this, "x_NamaPosition", 202, SqlDbType.NVarChar) {
                Name = "NamaPosition",
                Expression = "[NamaPosition]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NamaPosition]",
                DateTimeFormat = -1,
                VirtualExpression = "[NamaPosition]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MasterPosition", "NamaPosition", "CustomMsg"),
                IsUpload = false
            };
            NamaPosition.Lookup = new Lookup<DbField>(NamaPosition, "MasterPosition", true, "NamaPosition", new List<string> {"NamaPosition", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NamaPosition", NamaPosition);
            ...
            Location = new(this, "x_Location", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MasterPosition", "Location", "CustomMsg"),
                IsUpload = false
            };
            Location.Lookup = new Lookup<DbField>(Location, "MasterPosition", true, "Location", new List<string> {"Location", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            _UserLevel = new(this, "x__UserLevel", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterPosition", "_UserLevel", "CustomMsg"),
                IsUpload = false
            };
            _UserLevel.Raw = true;
            ...
            // Role
            Role = new(this, "x_Role", 3, SqlDbType.Int) {
                Name = "Role",
                Expression = "[Role]",
                UseBasicSearch = true,
                BasicSearchExpression = "CAST([Role] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[Role]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterPosition", "Role", "CustomMsg"),
                IsUpload = false
            };
            Role.Raw = true;
            Role.Lookup = new Lookup<DbField>(Role, "MasterPIC", true, "IdPIC", new List<string> {"NamaPIC", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[NamaPIC]");
        ...
        {
            get => _sqlFrom ?? "dbo.MasterPosition";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MasterPosition type", "data");
            row = row.Where(kvp => {
        ...
        private string _sqlKeyFilter => "[IdPosition] = @IdPosition@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MasterPositionView" => Language.Phrase("View"),
                "MasterPositionEdit" => Language.Phrase("Edit"),
                "MasterPositionAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MasterPositionView",
                Config.ApiAddAction => "MasterPositionAdd",
                Config.ApiEditAction => "MasterPositionEdit",
                Config.ApiDeleteAction => "MasterPositionDelete",
                Config.ApiListAction => "MasterPositionList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MasterPositionList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MasterPositionView", parm);
            else
                url = KeyUrl("MasterPositionView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MasterPositionAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MasterPositionAdd?" + parm;
            else
                url = "MasterPositionAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MasterPositionEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterPositionList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MasterPositionAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterPositionList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MasterPositionDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdPosition\":" + ConvertToJson(IdPosition.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdPosition.CurrentValue)) {
                url += "/" + IdPosition.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdPosition", out object? v0)) { // IdPosition // DN
                    key = UrlDecode(v0); // DN
                } else if (IsApi() && !Empty(keyValues)) {
                    key = keyValues[0];
                } else {
                    key = Param("IdPosition");
                }
                keysList.Add(key);
            }
            // Check keys
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdPosition.CurrentValue = keys;
                else
                    IdPosition.OldValue = keys;
        ...
        {
            string pageName = "MasterPositionList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // NamaPosition
            NamaPosition.SetupEditAttributes();
            if (!NamaPosition.Raw)
                NamaPosition.CurrentValue = HtmlDecode(NamaPosition.CurrentValue);
            NamaPosition.EditValue = NamaPosition.CurrentValue;
            NamaPosition.PlaceHolder = RemoveHtml(NamaPosition.Caption);

            // Location
            Location.SetupEditAttributes();
            if (!Location.Raw)
                Location.CurrentValue = HtmlDecode(Location.CurrentValue);
            Location.EditValue = Location.CurrentValue;
            ...
            // Role
            Role.SetupEditAttributes();
            Role.PlaceHolder = RemoveHtml(Role.Caption);
            if (!Empty(Role.EditValue) && IsNumeric(Role.EditValue))
                Role.EditValue = FormatNumber(Role.EditValue, null);
        ...
        public void RowRendered() {
            ...
            if (IdPosition.CurrentValue != null) {
                // ubah ke long lalu ToString dengan format "0" (tanpa grouping)
                IdPosition.ViewValue = Convert.ToInt64(IdPosition.CurrentValue).ToString("0");
            } else {
                IdPosition.ViewValue = string.Empty;
            }
        }
