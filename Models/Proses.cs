...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static Proses proses
    {
        get => HttpData.Resolve<Proses>("Proses");
        set => HttpData["Proses"] = value;
    }

    /// <summary>
    /// Table class for Proses
    /// </summary>
    public class Proses : DbTable
    {
        ...
        public Proses()
        {
            ...
            Name = "Proses";
            Type = "TABLE";
            UpdateTable = "dbo.Proses"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdProses = new(this, "x_IdProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Proses", "IdProses", "CustomMsg"),
                IsUpload = false
            };
            IdProses.Raw = true;
            ...
            // IdReferensi
            IdReferensi = new(this, "x_IdReferensi", 200, SqlDbType.VarChar) {
                Name = "IdReferensi",
                ...
                CustomMessage = Language.FieldPhrase("Proses", "IdReferensi", "CustomMsg"),
                IsUpload = false
            };
            IdReferensi.Lookup = new Lookup<DbField>(IdReferensi, "Proses", true, "IdReferensi", new List<string> {"IdReferensi", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            IdTemplateProses = new(this, "x_IdTemplateProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Proses", "IdTemplateProses", "CustomMsg"),
                IsUpload = false
            };
            IdTemplateProses.Raw = true;
            IdTemplateProses.Lookup = new Lookup<DbField>(IdTemplateProses, "Proses", true, "IdTemplateProses", new List<string> {"IdTemplateProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            NamaProses = new(this, "x_NamaProses", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Proses", "NamaProses", "CustomMsg"),
                IsUpload = false
            };
            NamaProses.Lookup = new Lookup<DbField>(NamaProses, "Proses", true, "NamaProses", new List<string> {"NamaProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NamaProses", NamaProses);

            // Aktivitas
            Aktivitas2 = new(this, "x_Aktivitas2", 203, SqlDbType.NText) {
                Name = "Aktivitas",
                Expression = "'<a href=AktivitasList?cmd=search&x_IdProses%5B%5D='+ CAST(IdProses AS NVARCHAR(255)) +'&search=&searchtype=>'+ CAST(NamaProses AS NVARCHAR(255))+'</a>'",
                UseBasicSearch = true,
                BasicSearchExpression = "'<a href=AktivitasList?cmd=search&x_IdProses%5B%5D='+ CAST(IdProses AS NVARCHAR(255)) +'&search=&searchtype=>'+ CAST(NamaProses AS NVARCHAR(255))+'</a>'",
                DateTimeFormat = -1,
                VirtualExpression = "'<a href=AktivitasList?cmd=search&x_IdProses%5B%5D='+ CAST(IdProses AS NVARCHAR(255)) +'&search=&searchtype=>'+ CAST(NamaProses AS NVARCHAR(255))+'</a>'",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Proses", "Aktivitas2", "CustomMsg"),
                IsUpload = false
            };
            Aktivitas2.Lookup = new Lookup<DbField>(Aktivitas2, "Proses", true, "Aktivitas", new List<string> {"Aktivitas", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalMulai = new(this, "x_TanggalMulai", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Proses", "TanggalMulai", "CustomMsg"),
                IsUpload = false
            };
            TanggalMulai.Raw = true;
            TanggalMulai.Lookup = new Lookup<DbField>(TanggalMulai, "Proses", true, "TanggalMulai", new List<string> {"TanggalMulai", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalSelesai = new(this, "x_TanggalSelesai", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Proses", "TanggalSelesai", "CustomMsg"),
                IsUpload = false
            };
            TanggalSelesai.Raw = true;
            TanggalSelesai.Lookup = new Lookup<DbField>(TanggalSelesai, "Proses", true, "TanggalSelesai", new List<string> {"TanggalSelesai", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            StatusProses = new(this, "x_StatusProses", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Proses", "StatusProses", "CustomMsg"),
                IsUpload = false
            };
            StatusProses.Lookup = new Lookup<DbField>(StatusProses, "Proses", true, "StatusProses", new List<string> {"StatusProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("StatusProses", StatusProses);

            // TipeProses
            TipeProses = new(this, "x_TipeProses", 200, SqlDbType.VarChar) {
                Name = "TipeProses",
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Proses", "TipeProses", "CustomMsg"),
                IsUpload = false
            };
            TipeProses.Lookup = new Lookup<DbField>(TipeProses, "Proses", true, "TipeProses", new List<string> {"TipeProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Catatan = new(this, "x_Catatan", 201, SqlDbType.Text) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Proses", "Catatan", "CustomMsg"),
                IsUpload = false
            };
            Catatan.Lookup = new Lookup<DbField>(Catatan, "Proses", true, "Catatan", new List<string> {"Catatan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Proses", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            DibuatOleh.Lookup = new Lookup<DbField>(DibuatOleh, "Proses", true, "DibuatOleh", new List<string> {"DibuatOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Proses", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            TanggalDibuat.Raw = true;
            TanggalDibuat.Lookup = new Lookup<DbField>(TanggalDibuat, "Proses", true, "TanggalDibuat", new List<string> {"TanggalDibuat", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Proses", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            DiperbaruiOleh.Lookup = new Lookup<DbField>(DiperbaruiOleh, "Proses", true, "DiperbaruiOleh", new List<string> {"DiperbaruiOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Proses", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiperbarui.Raw = true;
            TanggalDiperbarui.Lookup = new Lookup<DbField>(TanggalDiperbarui, "Proses", true, "TanggalDiperbarui", new List<string> {"TanggalDiperbarui", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        {
            get {
                string select = "*, '<a href=AktivitasList?cmd=search&x_IdProses%5B%5D='+ CAST(IdProses AS NVARCHAR(255)) +'&search=&searchtype=>'+ CAST(NamaProses AS NVARCHAR(255))+'</a>' AS [Aktivitas]";
                if (select == "*") {
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.Prose type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdProses"))
                    row["IdProses"] = lastInsertedId;
                else
                    row.Add("IdProses", lastInsertedId);
                IdProses.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        private string _sqlKeyFilter => "[IdProses] = @IdProses@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "ProsesView" => Language.Phrase("View"),
                "ProsesEdit" => Language.Phrase("Edit"),
                "ProsesAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "ProsesView",
                Config.ApiAddAction => "ProsesAdd",
                Config.ApiEditAction => "ProsesEdit",
                Config.ApiDeleteAction => "ProsesDelete",
                Config.ApiListAction => "ProsesList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "ProsesList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("ProsesView", parm);
            else
                url = KeyUrl("ProsesView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "ProsesAdd";
        ...
        {
            string url = "";
            url = KeyUrl("ProsesEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("ProsesList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("ProsesAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("ProsesList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("ProsesDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdProses\":" + ConvertToJson(IdProses.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdProses.CurrentValue)) {
                url += "/" + IdProses.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdProses", out object? v0)) { // IdProses // DN
                    key = UrlDecode(v0); // DN
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdProses.CurrentValue = keys;
                else
                    IdProses.OldValue = keys;
        ...
        public async Task RenderEditRow()
        {
            ...
            if (!IdReferensi.Raw)
                IdReferensi.CurrentValue = HtmlDecode(IdReferensi.CurrentValue);
            IdReferensi.EditValue = IdReferensi.CurrentValue;
            ...
            if (!StatusProses.Raw)
                StatusProses.CurrentValue = HtmlDecode(StatusProses.CurrentValue);
            StatusProses.EditValue = StatusProses.CurrentValue;
            StatusProses.PlaceHolder = RemoveHtml(StatusProses.Caption);
