...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStartPembongkaranRtwAdd
    /// </summary>
    public static SubAktivitasDataStartPembongkaranRtwAdd subAktivitasDataStartPembongkaranRtwAdd
    {
        get => HttpData.Get<SubAktivitasDataStartPembongkaranRtwAdd>("subAktivitasDataStartPembongkaranRtwAdd")!;
        set => HttpData["subAktivitasDataStartPembongkaranRtwAdd"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStartPembongkaranRTW
    /// </summary>
    public class SubAktivitasDataStartPembongkaranRtwAdd : SubAktivitasDataStartPembongkaranRtwAddBase
    {
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStartPembongkaranRtwAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStartPembongkaranRtwAddBase : SubAktivitasDataStartPembongkaranRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStartPembongkaranRtwAdd";
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwAddBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStartPembongkaranRtwAdd";
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasDataStartPembongkaranRtwList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "SubAktivitasDataStartPembongkaranRtwView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStartPembongkaranRtwList") {
                                ...
                                returnUrl = "SubAktivitasDataStartPembongkaranRtwList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasDataStartPembongkaranRtwAdd?.PageRender();
            }
            return PageResult();
        }
