...
public partial class SnDOne {
    ...
    public class MasterProdukViewBase : MasterProduk
    {
        ...
        // Constructor
        public MasterProdukViewBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterProdukViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("NoProduk", out v) && !Empty(v))
                {
                NoProduk.QueryValue = UrlDecode(v);
                RecordKeys["NoProduk"] = NoProduk.QueryValue;
                return;
                }
                if (Get("NoProduk", out sv))
                {
