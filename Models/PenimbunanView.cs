...
public partial class SnDOne {
    ...
    public class PenimbunanViewBase : Penimbunan
    {
        ...
        // Constructor
        public PenimbunanViewBase(Controller? controller)
        {
        ...
        // Constructor
        public PenimbunanViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdPenimbunan", out v) && !Empty(v))
                {
                IdPenimbunan.QueryValue = UrlDecode(v);
                RecordKeys["IdPenimbunan"] = IdPenimbunan.QueryValue;
                return;
                }
                if (Get("IdPenimbunan", out sv))
                {
