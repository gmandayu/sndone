...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputNilaiARsesuaiCqdTruckAddBase : SubAktivitasFormInputNilaiARsesuaiCqdTruck
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckAddBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasFormInputNilaiARsesuaiCqdTruckList"); // No matching record, return to List page // DN
                    }
                    break;
