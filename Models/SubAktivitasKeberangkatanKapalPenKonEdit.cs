...
public partial class SnDOne {
    ...
    public class SubAktivitasKeberangkatanKapalPenKonEditBase : SubAktivitasKeberangkatanKapalPenKon
    {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenKonEditBase()
        {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenKonEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasKeberangkatanKapalPenKonList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanKapalPenKonList") {
                                ...
                                returnUrl = "SubAktivitasKeberangkatanKapalPenKonList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
