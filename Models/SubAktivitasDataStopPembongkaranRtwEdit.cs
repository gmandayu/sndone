...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStopPembongkaranRtwEditBase : SubAktivitasDataStopPembongkaranRtw
    {
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranRtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranRtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStopPembongkaranRtwList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStopPembongkaranRtwList") {
                                ...
                                returnUrl = "SubAktivitasDataStopPembongkaranRtwList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
