...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputKeberangkatanMobilTangkiEditBase : SubAktivitasFormInputKeberangkatanMobilTangki
    {
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputKeberangkatanMobilTangkiList"); // No matching record, return to list
                        }
                    break;
