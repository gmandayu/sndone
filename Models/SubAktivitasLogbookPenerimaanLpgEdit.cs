...
public partial class SnDOne {
    ...
    public class SubAktivitasLogbookPenerimaanLpgEditBase : SubAktivitasLogbookPenerimaanLpg
    {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasLogbookPenerimaanLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasLogbookPenerimaanLpgList") {
                                ...
                                returnUrl = "SubAktivitasLogbookPenerimaanLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
