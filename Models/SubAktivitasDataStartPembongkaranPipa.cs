...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStartPembongkaranPipa
    /// </summary>
    [MaybeNull]
    public static SubAktivitasDataStartPembongkaranPipa subAktivitasDataStartPembongkaranPipa
    {
        get => HttpData.Resolve<SubAktivitasDataStartPembongkaranPipa>("SubAktivitasDataStartPembongkaranPipa");
        set => HttpData["SubAktivitasDataStartPembongkaranPipa"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasDataStartPembongkaranPipa
    /// </summary>
    public class SubAktivitasDataStartPembongkaranPipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> tglStartBongkar;
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasDataStartPembongkaranPipa";
            Name = "SubAktivitasDataStartPembongkaranPipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasDataStartPembongkaranPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPembongkaranPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPembongkaranPipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPembongkaranPipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPembongkaranPipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPembongkaranPipa", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPembongkaranPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPembongkaranPipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            // tglStartBongkar
            tglStartBongkar = new(this, "x_tglStartBongkar", 135, SqlDbType.DateTime) {
                Name = "tglStartBongkar",
                Expression = "[tglStartBongkar]",
                BasicSearchExpression = CastDateFieldForLike("[tglStartBongkar]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[tglStartBongkar]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPembongkaranPipa", "tglStartBongkar", "CustomMsg"),
                IsUpload = false
            };
            tglStartBongkar.Raw = true;
            Fields.Add("tglStartBongkar", tglStartBongkar);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPembongkaranPipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPembongkaranPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasDataStartPembongkaranPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasDataStartPembongkaranPipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                tglStartBongkar.DbValue = row["tglStartBongkar"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasDataStartPembongkaranPipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasDataStartPembongkaranPipaView" => Language.Phrase("View"),
                "SubAktivitasDataStartPembongkaranPipaEdit" => Language.Phrase("Edit"),
                "SubAktivitasDataStartPembongkaranPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasDataStartPembongkaranPipaView",
                Config.ApiAddAction => "SubAktivitasDataStartPembongkaranPipaAdd",
                Config.ApiEditAction => "SubAktivitasDataStartPembongkaranPipaEdit",
                Config.ApiDeleteAction => "SubAktivitasDataStartPembongkaranPipaDelete",
                Config.ApiListAction => "SubAktivitasDataStartPembongkaranPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasDataStartPembongkaranPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasDataStartPembongkaranPipaView", parm);
            else
                url = KeyUrl("SubAktivitasDataStartPembongkaranPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasDataStartPembongkaranPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasDataStartPembongkaranPipaAdd?" + parm;
            else
                url = "SubAktivitasDataStartPembongkaranPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataStartPembongkaranPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataStartPembongkaranPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataStartPembongkaranPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataStartPembongkaranPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasDataStartPembongkaranPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasDataStartPembongkaranPipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // tglStartBongkar
            tglStartBongkar.SetupEditAttributes();
            tglStartBongkar.EditValue = FormatDateTime(tglStartBongkar.CurrentValue, tglStartBongkar.FormatPattern);
            tglStartBongkar.PlaceHolder = RemoveHtml(tglStartBongkar.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(tglStartBongkar);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(tglStartBongkar);
