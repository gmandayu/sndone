...
public partial class SnDOne {
    ...
    /// setPjsDelete
    /// </summary>
    public static SetPjsDelete setPjsDelete
    {
        get => HttpData.Get<SetPjsDelete>("setPjsDelete")!;
        set => HttpData["setPjsDelete"] = value;
    }

    /// <summary>
    /// Page class for SetPjs
    /// </summary>
    public class SetPjsDelete : SetPjsDeleteBase
    {
        // Constructor
        public SetPjsDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SetPjsDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class SetPjsDeleteBase : SetPjs
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "setPjsDelete";
        ...
        // Page name
        public string PageName => "SetPjsDelete";
        ...
        // Constructor
        public SetPjsDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SetPjsList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SetPjsList"); // Return to list
                }
            }
