...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbookPenerimaanPipaListBase : SubAktivitasFormInputLogbookPenerimaanPipa
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanPipaListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanPipaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field NamaBatch
            if (filter.TryGetValue("x_NamaBatch", out sv)) {
                RestoreFieldFilter(NamaBatch, filter, "NamaBatch", sv);
            }

            // Field TanggalJam
            if (filter.TryGetValue("x_TanggalJam", out sv)) {
                RestoreFieldFilter(TanggalJam, filter, "TanggalJam", sv);
            }
