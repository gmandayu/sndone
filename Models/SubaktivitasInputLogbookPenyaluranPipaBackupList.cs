...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasInputLogbookPenyaluranPipaBackupList
    /// </summary>
    public static SubaktivitasInputLogbookPenyaluranPipaBackupList subaktivitasInputLogbookPenyaluranPipaBackupList
    {
        get => HttpData.Get<SubaktivitasInputLogbookPenyaluranPipaBackupList>("subaktivitasInputLogbookPenyaluranPipaBackupList")!;
        set => HttpData["subaktivitasInputLogbookPenyaluranPipaBackupList"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasInputLogbookPenyaluranPipa_Backup
    /// </summary>
    public class SubaktivitasInputLogbookPenyaluranPipaBackupList : SubaktivitasInputLogbookPenyaluranPipaBackupListBase
    {
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasInputLogbookPenyaluranPipaBackupListBase : SubaktivitasInputLogbookPenyaluranPipaBackup
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasInputLogbookPenyaluranPipaBackupList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubaktivitasInputLogbookPenyaluranPipa_Backuplist";
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupListBase()
        {
            TableName = "SubaktivitasInputLogbookPenyaluranPipa_Backup";

            // CSS class name as context
            TableVar = "SubaktivitasInputLogbookPenyaluranPipa_Backup";
            ...
            // Table object (subaktivitasInputLogbookPenyaluranPipaBackup)
            if (subaktivitasInputLogbookPenyaluranPipaBackup == null || subaktivitasInputLogbookPenyaluranPipaBackup is SubaktivitasInputLogbookPenyaluranPipaBackup)
                subaktivitasInputLogbookPenyaluranPipaBackup = this;

            // Initialize URLs
            AddUrl = "SubaktivitasInputLogbookPenyaluranPipaBackupAdd";
            ...
            MultiDeleteUrl = "SubaktivitasInputLogbookPenyaluranPipaBackupDelete";
            MultiUpdateUrl = "SubaktivitasInputLogbookPenyaluranPipaBackupUpdate";
        ...
        // Page name
        public string PageName => "SubaktivitasInputLogbookPenyaluranPipaBackupList";
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubaktivitasInputLogbookPenyaluranPipaBackupView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubaktivitasInputLogbookPenyaluranPipa_Backupgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subaktivitasInputLogbookPenyaluranPipaBackupList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(LO.AdvancedSearch.ToJson())); // Field LO
            ...
            filters.Merge(JObject.Parse(BayNumber.AdvancedSearch.ToJson())); // Field BayNumber
        ...
        protected bool RestoreFilterList() {
            ...
            // Field LO
            if (filter?.TryGetValue("x_LO", out sv) ?? false) {
                LO.AdvancedSearch.SearchValue = sv;
                LO.AdvancedSearch.SearchOperator = filter["z_LO"];
                LO.AdvancedSearch.SearchCondition = filter["v_LO"];
                LO.AdvancedSearch.SearchValue2 = filter["y_LO"];
                LO.AdvancedSearch.SearchOperator2 = filter["w_LO"];
                LO.AdvancedSearch.Save();
            }
            ...
            // Field BayNumber
            if (filter?.TryGetValue("x_BayNumber", out sv) ?? false) {
                BayNumber.AdvancedSearch.SearchValue = sv;
                BayNumber.AdvancedSearch.SearchOperator = filter["z_BayNumber"];
                BayNumber.AdvancedSearch.SearchCondition = filter["v_BayNumber"];
                BayNumber.AdvancedSearch.SearchValue2 = filter["y_BayNumber"];
                BayNumber.AdvancedSearch.SearchOperator2 = filter["w_BayNumber"];
                BayNumber.AdvancedSearch.Save();
            }
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(BayNumber, ctrl); // BayNumber
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""SubaktivitasInputLogbookPenyaluranPipa_Backup"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubaktivitasInputLogbookPenyaluranPipa_Backup"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalAdd && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-copy"" title=""{copycaption}"" data-table=""SubaktivitasInputLogbookPenyaluranPipa_Backup"" data-caption=""{copycaption}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(CopyUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("CopyLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubaktivitasInputLogbookPenyaluranPipa_Backuplist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasInputLogbookPenyaluranPipa_Backuplist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""SubaktivitasInputLogbookPenyaluranPipa_Backup"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            item.Body = $@"<button type=""button"" class=""ew-action ew-multi-delete"" title=""{deleteTitle}"" data-caption=""{deleteTitle}"" form=""fSubaktivitasInputLogbookPenyaluranPipa_Backuplist""" +
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("LO")); // DN
                ...
                CreateColumnOption(option.Add("BayNumber")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubaktivitasInputLogbookPenyaluranPipa_Backupsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubaktivitasInputLogbookPenyaluranPipa_Backupsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasInputLogbookPenyaluranPipa_Backuplist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubaktivitasInputLogbookPenyaluranPipa_Backup");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subaktivitasInputLogbookPenyaluranPipaBackupList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subaktivitasInputLogbookPenyaluranPipaBackupList.RowCount) + "_SubaktivitasInputLogbookPenyaluranPipa_Backup");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subaktivitasInputLogbookPenyaluranPipaBackupList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subaktivitasInputLogbookPenyaluranPipaBackupList.RowType == RowType.Add || IsEdit && subaktivitasInputLogbookPenyaluranPipaBackupList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            BayNumber.SetDbValue(row["BayNumber"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("LO", LO.DefaultValue ?? DbNullValue); // DN
            ...
            row.Add("BayNumber", BayNumber.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // BayNumber
                BayNumber.ViewValue = ConvertToString(BayNumber.CurrentValue); // DN
                BayNumber.ViewCustomAttributes = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubaktivitasInputLogbookPenyaluranPipa_Backuplist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubaktivitasInputLogbookPenyaluranPipa_Backuplist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubaktivitasInputLogbookPenyaluranPipa_Backuplist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
