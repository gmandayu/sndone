...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiSfbdrtw
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiSfbdrtw subAktivitasNilaiSfbdrtw
    {
        get => HttpData.Resolve<SubAktivitasNilaiSfbdrtw>("SubAktivitasNilaiSFBDRTW");
        set => HttpData["SubAktivitasNilaiSFBDRTW"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiSFBDRTW
    /// </summary>
    public class SubAktivitasNilaiSfbdrtw : DbTable
    {
        ...
        public readonly DbField<SqlDbType> SFBD_KL_Obs;

        public readonly DbField<SqlDbType> SFBD_KL_15;
        ...
        // Constructor
        public SubAktivitasNilaiSfbdrtw()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiSFBDRTW";
            Name = "SubAktivitasNilaiSFBDRTW";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiSFBDRTW"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            // SFBD_KL_Obs
            SFBD_KL_Obs = new(this, "x_SFBD_KL_Obs", 202, SqlDbType.NVarChar) {
                Name = "SFBD_KL_Obs",
                Expression = "[SFBD_KL_Obs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBD_KL_Obs]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBD_KL_Obs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "SFBD_KL_Obs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBD_KL_Obs", SFBD_KL_Obs);

            // SFBD_KL_15
            SFBD_KL_15 = new(this, "x_SFBD_KL_15", 202, SqlDbType.NVarChar) {
                Name = "SFBD_KL_15",
                Expression = "[SFBD_KL_15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFBD_KL_15]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFBD_KL_15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "SFBD_KL_15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFBD_KL_15", SFBD_KL_15);
            ...
            SFBD_Barrels = new(this, "x_SFBD_Barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "SFBD_Barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFBD_LT = new(this, "x_SFBD_LT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "SFBD_LT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFBD_MT = new(this, "x_SFBD_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "SFBD_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiSFBDRTW", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiSFBDRTW";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiSfbdrtw type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                SFBD_KL_Obs.DbValue = row["SFBD_KL_Obs"]; // Set DB value only
                SFBD_KL_15.DbValue = row["SFBD_KL_15"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiSfbdrtwList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiSfbdrtwView" => Language.Phrase("View"),
                "SubAktivitasNilaiSfbdrtwEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiSfbdrtwAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiSfbdrtwView",
                Config.ApiAddAction => "SubAktivitasNilaiSfbdrtwAdd",
                Config.ApiEditAction => "SubAktivitasNilaiSfbdrtwEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiSfbdrtwDelete",
                Config.ApiListAction => "SubAktivitasNilaiSfbdrtwList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiSfbdrtwList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiSfbdrtwView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiSfbdrtwView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiSfbdrtwAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiSfbdrtwAdd?" + parm;
            else
                url = "SubAktivitasNilaiSfbdrtwAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiSfbdrtwEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiSfbdrtwList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiSfbdrtwAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiSfbdrtwList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiSfbdrtwDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiSfbdrtwList";
        ...
        public async Task RenderEditRow()
        {
            ...
            SFBD_KL_Obs.EditValue = SFBD_KL_Obs.CurrentValue;
            ...
            SFBD_KL_15.EditValue = SFBD_KL_15.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(SFBD_KL_Obs);
                        doc.ExportCaption(SFBD_KL_15);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(SFBD_KL_Obs);
                            await doc.ExportField(SFBD_KL_15);
