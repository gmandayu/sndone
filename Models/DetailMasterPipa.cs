...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static DetailMasterPipa detailMasterPipa
    {
        get => HttpData.Resolve<DetailMasterPipa>("DetailMasterPipa");
        set => HttpData["DetailMasterPipa"] = value;
    }

    /// <summary>
    /// Table class for DetailMasterPipa
    /// </summary>
    public class DetailMasterPipa : DbTable
    {
        ...
        // Constructor
        public DetailMasterPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "DetailMasterPipa";
            Name = "DetailMasterPipa";
            Type = "TABLE";
            UpdateTable = "dbo.DetailMasterPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("DetailMasterPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idPipa = new(this, "x_idPipa", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("DetailMasterPipa", "idPipa", "CustomMsg"),
                IsUpload = false
            };
            idPipa.Raw = true;
            idPipa.Lookup = new Lookup<DbField>(idPipa, "MasterPipa", true, "id", new List<string> {"KeteranganPipa", "PlantAsal", "NamaPlantAsal", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "CONCAT([KeteranganPipa],'" + ValueSeparator(1, idPipa) + "',[PlantAsal],'" + ValueSeparator(2, idPipa) + "',[NamaPlantAsal])");
            ...
            idPlantTujuan = new(this, "x_idPlantTujuan", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailMasterPipa", "idPlantTujuan", "CustomMsg"),
                IsUpload = false
            };
            idPlantTujuan.Raw = true;
            idPlantTujuan.Lookup = new Lookup<DbField>(idPlantTujuan, "MasterPlant", true, "IdPlant", new List<string> {"Plant", "Nama_Terminal", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "CONCAT([Plant],'" + ValueSeparator(1, idPlantTujuan) + "',[Nama_Terminal])");
            Fields.Add("idPlantTujuan", idPlantTujuan);

            // Panjang
            Panjang = new(this, "x_Panjang", 202, SqlDbType.NVarChar) {
                Name = "Panjang",
                Expression = "[Panjang]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Panjang]",
                DateTimeFormat = -1,
                ...
                CustomMessage = Language.FieldPhrase("DetailMasterPipa", "Panjang", "CustomMsg"),
                IsUpload = false
            };
            Panjang.Lookup = new Lookup<DbField>(Panjang, "DetailMasterPipa", true, "Panjang", new List<string> {"Panjang", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Panjang", Panjang);

            // Diameter
            Diameter = new(this, "x_Diameter", 202, SqlDbType.NVarChar) {
                Name = "Diameter",
                Expression = "[Diameter]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Diameter]",
                DateTimeFormat = -1,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailMasterPipa", "Diameter", "CustomMsg"),
                IsUpload = false
            };
            Diameter.Lookup = new Lookup<DbField>(Diameter, "DetailMasterPipa", true, "Diameter", new List<string> {"Diameter", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Volume = new(this, "x_Volume", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailMasterPipa", "Volume", "CustomMsg"),
                IsUpload = false
            };
            Volume.Lookup = new Lookup<DbField>(Volume, "DetailMasterPipa", true, "Volume", new List<string> {"Volume", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            CreatedBy = new(this, "x_CreatedBy", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailMasterPipa", "CreatedBy", "CustomMsg"),
                IsUpload = false
            };
            CreatedBy.Lookup = new Lookup<DbField>(CreatedBy, "DetailMasterPipa", true, "CreatedBy", new List<string> {"CreatedBy", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("DetailMasterPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            etlDate.Lookup = new Lookup<DbField>(etlDate, "DetailMasterPipa", true, "etlDate", new List<string> {"etlDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailMasterPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedBy.Lookup = new Lookup<DbField>(LastUpdatedBy, "DetailMasterPipa", true, "LastUpdatedBy", new List<string> {"LastUpdatedBy", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LastUpdatedDate = new(this, "x_LastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailMasterPipa", "LastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDate.Raw = true;
            LastUpdatedDate.Lookup = new Lookup<DbField>(LastUpdatedDate, "DetailMasterPipa", true, "LastUpdatedDate", new List<string> {"LastUpdatedDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        {
            get => _sqlFrom ?? "dbo.DetailMasterPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.DetailMasterPipa type", "data");
            row = row.Where(kvp => {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "DetailMasterPipaView" => Language.Phrase("View"),
                "DetailMasterPipaEdit" => Language.Phrase("Edit"),
                "DetailMasterPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "DetailMasterPipaView",
                Config.ApiAddAction => "DetailMasterPipaAdd",
                Config.ApiEditAction => "DetailMasterPipaEdit",
                Config.ApiDeleteAction => "DetailMasterPipaDelete",
                Config.ApiListAction => "DetailMasterPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "DetailMasterPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("DetailMasterPipaView", parm);
            else
                url = KeyUrl("DetailMasterPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "DetailMasterPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "DetailMasterPipaAdd?" + parm;
            else
                url = "DetailMasterPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("DetailMasterPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("DetailMasterPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("DetailMasterPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("DetailMasterPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("DetailMasterPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "DetailMasterPipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            if (!Panjang.Raw)
                Panjang.CurrentValue = HtmlDecode(Panjang.CurrentValue);
            ...
            if (!Diameter.Raw)
                Diameter.CurrentValue = HtmlDecode(Diameter.CurrentValue);
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            var idPlant     = rsnew["idPlantTujuan"].ToString();
