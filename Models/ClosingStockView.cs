...
public partial class SnDOne {
    ...
    public class ClosingStockViewBase : ClosingStock
    {
        ...
        // Constructor
        public ClosingStockViewBase(Controller? controller)
        {
        ...
        // Constructor
        public ClosingStockViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdClosingStock", out v) && !Empty(v))
                {
                IdClosingStock.QueryValue = UrlDecode(v);
                RecordKeys["IdClosingStock"] = IdClosingStock.QueryValue;
                return;
                }
                if (Get("IdClosingStock", out sv))
                {
