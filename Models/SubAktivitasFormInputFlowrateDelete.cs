...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputFlowrateDelete
    /// </summary>
    public static SubAktivitasFormInputFlowrateDelete subAktivitasFormInputFlowrateDelete
    {
        get => HttpData.Get<SubAktivitasFormInputFlowrateDelete>("subAktivitasFormInputFlowrateDelete")!;
        set => HttpData["subAktivitasFormInputFlowrateDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputFlowrate
    /// </summary>
    public class SubAktivitasFormInputFlowrateDelete : SubAktivitasFormInputFlowrateDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputFlowrateDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputFlowrateDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputFlowrateDeleteBase : SubAktivitasFormInputFlowrate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputFlowrateDelete";
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputFlowrateDelete";
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputFlowrateList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputFlowrateList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputFlowrateDelete?.PageRender();
            }
            return PageResult();
        }
