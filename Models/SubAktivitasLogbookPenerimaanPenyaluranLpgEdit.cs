...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLogbookPenerimaanPenyaluranLpgEdit
    /// </summary>
    public static SubAktivitasLogbookPenerimaanPenyaluranLpgEdit subAktivitasLogbookPenerimaanPenyaluranLpgEdit
    {
        get => HttpData.Get<SubAktivitasLogbookPenerimaanPenyaluranLpgEdit>("subAktivitasLogbookPenerimaanPenyaluranLpgEdit")!;
        set => HttpData["subAktivitasLogbookPenerimaanPenyaluranLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasLogbookPenerimaanPenyaluranLPG
    /// </summary>
    public class SubAktivitasLogbookPenerimaanPenyaluranLpgEdit : SubAktivitasLogbookPenerimaanPenyaluranLpgEditBase
    {
        // Constructor
        public SubAktivitasLogbookPenerimaanPenyaluranLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasLogbookPenerimaanPenyaluranLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasLogbookPenerimaanPenyaluranLpgEditBase : SubAktivitasLogbookPenerimaanPenyaluranLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasLogbookPenerimaanPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanPenyaluranLpgEditBase(Controller? controller)
        {
            TableName = "SubAktivitasLogbookPenerimaanPenyaluranLPG";
        ...
        if (controller != null)
            ...
            // Table object (subAktivitasLogbookPenerimaanPenyaluranLpg)
            if (subAktivitasLogbookPenerimaanPenyaluranLpg == null || subAktivitasLogbookPenerimaanPenyaluranLpg is SubAktivitasLogbookPenerimaanPenyaluranLpg)
                subAktivitasLogbookPenerimaanPenyaluranLpg = this;
        ...
        // Page name
        public string PageName => "SubAktivitasLogbookPenerimaanPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanPenyaluranLpgEditBase() : this(null) { }
            ...
            string pageName = GetPageName(url);
                ...
                // List / View / Master View page
                    if (!SameString(pageName, ListUrl))
                    {
                        ...
                        result.Add("view", pageName == "SubAktivitasLogbookPenerimaanPenyaluranLpgView" ? "1" : "0"); // If View page, no primary button
                    }
                    else
                    {
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasLogbookPenerimaanPenyaluranLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasLogbookPenerimaanPenyaluranLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasLogbookPenerimaanPenyaluranLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasLogbookPenerimaanPenyaluranLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void ValidateCustomBayNumber() {
            if (BayNumber.Visible && BayNumber.Required) {
                if (!BayNumber.IsDetailKey && Empty(BayNumber.FormValue)) {
                    BayNumber.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustomQuantity() {
            if (Quantity.Visible && Quantity.Required) {
                if (!Quantity.IsDetailKey && Empty(Quantity.FormValue)) {
                    Quantity.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustomMeterAwal() {
            if (MeterAwal.Visible && MeterAwal.Required) {
                if (!MeterAwal.IsDetailKey && Empty(MeterAwal.FormValue)) {
                    MeterAwal.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustomMeterAkhir() {
            if (MeterAkhir.Visible && MeterAkhir.Required) {
                if (!MeterAkhir.IsDetailKey && Empty(MeterAkhir.FormValue)) {
                    MeterAkhir.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasLogbookPenerimaanPenyaluranLpgList")), "", TableVar, true);
            string pageId = "edit";
