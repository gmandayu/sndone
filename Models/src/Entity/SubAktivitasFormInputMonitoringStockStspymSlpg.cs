...
/**
 * Entity class for "SubAktivitasFormInputMonitoringStockSTSPymSLPG" table
 */
[Table("SubAktivitasFormInputMonitoringStockSTSPymSLPG")]
public class SubAktivitasFormInputMonitoringStockStspymSlpg
{
    [Key("id")]
