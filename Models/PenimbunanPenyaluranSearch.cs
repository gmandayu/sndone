...
public partial class SnDOne {
    ...
    public class PenimbunanPenyaluranSearchBase : PenimbunanPenyaluran
    {
        ...
        // Constructor
        public PenimbunanPenyaluranSearchBase()
        {
        ...
        // Constructor
        public PenimbunanPenyaluranSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected void LoadSearchValues() {
            ...
            // LookupNoPenyaluran
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_LookupNoPenyaluran"))
                    LookupNoPenyaluran.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_LookupNoPenyaluran", Config.FilterOptionSeparator);
            if (Form.ContainsKey("z_LookupNoPenyaluran"))
                LookupNoPenyaluran.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_LookupNoPenyaluran", Config.FilterOptionSeparator);

            // NoPenyaluran
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_NoPenyaluran"))
