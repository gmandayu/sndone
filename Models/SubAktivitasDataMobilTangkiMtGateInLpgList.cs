...
public partial class SnDOne {
    ...
    public class SubAktivitasDataMobilTangkiMtGateInLpgListBase : SubAktivitasDataMobilTangkiMtGateInLpg
    {
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInLpgListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInLpgListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field WaktuGateIn
            if (filter.TryGetValue("x_WaktuGateIn", out sv)) {
                RestoreFieldFilter(WaktuGateIn, filter, "WaktuGateIn", sv);
            }
