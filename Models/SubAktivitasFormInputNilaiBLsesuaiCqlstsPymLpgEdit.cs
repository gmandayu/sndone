...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEditBase : SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpg
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList") {
                                ...
                                returnUrl = "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
