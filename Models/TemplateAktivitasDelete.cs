...
public partial class SnDOne {
    /// <summary>
    /// templateAktivitasDelete
    /// </summary>
    public static TemplateAktivitasDelete templateAktivitasDelete
    {
        get => HttpData.Get<TemplateAktivitasDelete>("templateAktivitasDelete")!;
        set => HttpData["templateAktivitasDelete"] = value;
    }

    /// <summary>
    /// Page class for TemplateAktivitas
    /// </summary>
    public class TemplateAktivitasDelete : TemplateAktivitasDeleteBase
    {
        // Constructor
        public TemplateAktivitasDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TemplateAktivitasDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TemplateAktivitasDeleteBase : TemplateAktivitas
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "templateAktivitasDelete";
        ...
        // Constructor
        public TemplateAktivitasDeleteBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "TemplateAktivitasDelete";
        ...
        // Constructor
        public TemplateAktivitasDeleteBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void PageRunEnd()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                templateAktivitasDelete?.PageRender();
            }
        }
