...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStartPenyaluranEdit
    /// </summary>
    public static SubAktivitasDataStartPenyaluranEdit subAktivitasDataStartPenyaluranEdit
    {
        get => HttpData.Get<SubAktivitasDataStartPenyaluranEdit>("subAktivitasDataStartPenyaluranEdit")!;
        set => HttpData["subAktivitasDataStartPenyaluranEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStartPenyaluran
    /// </summary>
    public class SubAktivitasDataStartPenyaluranEdit : SubAktivitasDataStartPenyaluranEditBase
    {
        // Constructor
        public SubAktivitasDataStartPenyaluranEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStartPenyaluranEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStartPenyaluranEditBase : SubAktivitasDataStartPenyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStartPenyaluranEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStartPenyaluranEdit";
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataStartPenyaluranList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataStartPenyaluranList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataStartPenyaluranList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStartPenyaluranEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataStartPenyaluranList")), "", TableVar, true);
            string pageId = "edit";
