...
public partial class SnDOne {
    ...
    /// masterModaAdd
    /// </summary>
    public static MasterModaAdd masterModaAdd
    {
        get => HttpData.Get<MasterModaAdd>("masterModaAdd")!;
        set => HttpData["masterModaAdd"] = value;
    }

    /// <summary>
    /// Page class for MasterModa
    /// </summary>
    public class MasterModaAdd : MasterModaAddBase
    {
        // Constructor
        public MasterModaAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterModaAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterModaAddBase : MasterModa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterModaAdd";
        ...
        // Page name
        public string PageName => "MasterModaAdd";
        ...
        // Constructor
        public MasterModaAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MasterModaList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "MasterModaView")
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            if (insertRow) {
                try {
                    ...
                    rsnew["IdModa"] = IdModa.CurrentValue!;
                } catch (Exception e) {
                    if (Config.Debug)
                        throw;
