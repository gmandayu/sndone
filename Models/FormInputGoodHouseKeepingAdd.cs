...
public partial class SnDOne {
    ...
    public class FormInputGoodHouseKeepingAddBase : FormInputGoodHouseKeeping
    {
        ...
        // Constructor
        public FormInputGoodHouseKeepingAddBase()
        {
        ...
        // Constructor
        public FormInputGoodHouseKeepingAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("FormInputGoodHouseKeepingList"); // No matching record, return to List page // DN
                    }
                    break;
                    ...
                    if (res) { // Add successful
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "FormInputGoodHouseKeepingList") {
                                ...
                                returnUrl = "FormInputGoodHouseKeepingList"; // Return list page content
                            }
                        }
