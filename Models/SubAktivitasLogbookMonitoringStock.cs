...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLogbookMonitoringStock
    /// </summary>
    [MaybeNull]
    public static SubAktivitasLogbookMonitoringStock subAktivitasLogbookMonitoringStock
    {
        get => HttpData.Resolve<SubAktivitasLogbookMonitoringStock>("SubAktivitasLogbookMonitoringStock");
        set => HttpData["SubAktivitasLogbookMonitoringStock"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasLogbookMonitoringStock
    /// </summary>
    public class SubAktivitasLogbookMonitoringStock : DbTable
    {
        ...
        public readonly DbField<SqlDbType> Nomor_Tangki;
        ...
        public readonly DbField<SqlDbType> Level_Tangki;

        public readonly DbField<SqlDbType> Volume_KLObs;
        ...
        // Constructor
        public SubAktivitasLogbookMonitoringStock()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasLogbookMonitoringStock";
            Name = "SubAktivitasLogbookMonitoringStock";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasLogbookMonitoringStock"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NoReferensi", NoReferensi);

            // Nomor_Tangki
            Nomor_Tangki = new(this, "x_Nomor_Tangki", 202, SqlDbType.NVarChar) {
                Name = "Nomor_Tangki",
                Expression = "[Nomor_Tangki]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Nomor_Tangki]",
                DateTimeFormat = -1,
                VirtualExpression = "[Nomor_Tangki]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "Nomor_Tangki", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Nomor_Tangki", Nomor_Tangki);
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            Aktivitas2 = new(this, "x_Aktivitas2", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "Aktivitas2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Aktivitas", Aktivitas2);

            // Level_Tangki
            Level_Tangki = new(this, "x_Level_Tangki", 202, SqlDbType.NVarChar) {
                Name = "Level_Tangki",
                Expression = "[Level_Tangki]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Level_Tangki]",
                DateTimeFormat = -1,
                VirtualExpression = "[Level_Tangki]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "Level_Tangki", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Level_Tangki", Level_Tangki);

            // Volume_KLObs
            Volume_KLObs = new(this, "x_Volume_KLObs", 202, SqlDbType.NVarChar) {
                Name = "Volume_KLObs",
                Expression = "[Volume_KLObs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Volume_KLObs]",
                DateTimeFormat = -1,
                VirtualExpression = "[Volume_KLObs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "Volume_KLObs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Volume_KLObs", Volume_KLObs);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdPlant = new(this, "x_IdPlant", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLogbookMonitoringStock", "IdPlant", "CustomMsg"),
                IsUpload = false
            };
            IdPlant.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasLogbookMonitoringStock";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasLogbookMonitoringStock type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Nomor_Tangki.DbValue = row["Nomor_Tangki"]; // Set DB value only
                ...
                Level_Tangki.DbValue = row["Level_Tangki"]; // Set DB value only
                Volume_KLObs.DbValue = row["Volume_KLObs"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasLogbookMonitoringStockList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasLogbookMonitoringStockView" => Language.Phrase("View"),
                "SubAktivitasLogbookMonitoringStockEdit" => Language.Phrase("Edit"),
                "SubAktivitasLogbookMonitoringStockAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasLogbookMonitoringStockView",
                Config.ApiAddAction => "SubAktivitasLogbookMonitoringStockAdd",
                Config.ApiEditAction => "SubAktivitasLogbookMonitoringStockEdit",
                Config.ApiDeleteAction => "SubAktivitasLogbookMonitoringStockDelete",
                Config.ApiListAction => "SubAktivitasLogbookMonitoringStockList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasLogbookMonitoringStockList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasLogbookMonitoringStockView", parm);
            else
                url = KeyUrl("SubAktivitasLogbookMonitoringStockView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasLogbookMonitoringStockAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasLogbookMonitoringStockAdd?" + parm;
            else
                url = "SubAktivitasLogbookMonitoringStockAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLogbookMonitoringStockEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLogbookMonitoringStockList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLogbookMonitoringStockAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLogbookMonitoringStockList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasLogbookMonitoringStockDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasLogbookMonitoringStockList";
        ...
        public async Task RenderListRow()
        {
            ...
            StatusAktivitas.ViewValue = Empty(curVal) ? DbNullValue : FormatNumber(StatusAktivitas.CurrentValue, StatusAktivitas.FormatPattern);
            if (!Empty(curVal)) {
        ...
        public async Task RenderEditRow()
        {
            ...
            Nomor_Tangki.EditValue = Nomor_Tangki.CurrentValue;
            ...
            Level_Tangki.EditValue = Level_Tangki.CurrentValue;
            ...
            Volume_KLObs.EditValue = Volume_KLObs.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(Nomor_Tangki);
                        doc.ExportCaption(Produk);
                        doc.ExportCaption(StatusAktivitas);
                        doc.ExportCaption(Aktivitas2);
                        doc.ExportCaption(Level_Tangki);
                        doc.ExportCaption(Volume_KLObs);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(Nomor_Tangki);
                            await doc.ExportField(Produk);
                            await doc.ExportField(StatusAktivitas);
                            await doc.ExportField(Aktivitas2);
                            await doc.ExportField(Level_Tangki);
                            await doc.ExportField(Volume_KLObs);
