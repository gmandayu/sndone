...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLaporanStock
    /// </summary>
    [MaybeNull]
    public static SubAktivitasLaporanStock subAktivitasLaporanStock
    {
        get => HttpData.Resolve<SubAktivitasLaporanStock>("SubAktivitasLaporanStock");
        set => HttpData["SubAktivitasLaporanStock"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasLaporanStock
    /// </summary>
    public class SubAktivitasLaporanStock : DbTable
    {
        ...
        // Constructor
        public SubAktivitasLaporanStock()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasLaporanStock";
            Name = "SubAktivitasLaporanStock";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasLaporanStock"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            StockAwal = new(this, "x_StockAwal", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "StockAwal", "CustomMsg"),
                IsUpload = false
            };
            ...
            Penerimaan2 = new(this, "x_Penerimaan2", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "Penerimaan2", "CustomMsg"),
                IsUpload = false
            };
            ...
            Penyaluran2 = new(this, "x_Penyaluran2", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "Penyaluran2", "CustomMsg"),
                IsUpload = false
            };
            ...
            StockAkhir = new(this, "x_StockAkhir", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "StockAkhir", "CustomMsg"),
                IsUpload = false
            };
            ...
            WorkingLoss = new(this, "x_WorkingLoss", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "WorkingLoss", "CustomMsg"),
                IsUpload = false
            };
            ...
            Presentase = new(this, "x_Presentase", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "Presentase", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            Tangki = new(this, "x_Tangki", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "Tangki", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStock", "Produk", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasLaporanStock";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasLaporanStock type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasLaporanStockList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasLaporanStockView" => Language.Phrase("View"),
                "SubAktivitasLaporanStockEdit" => Language.Phrase("Edit"),
                "SubAktivitasLaporanStockAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasLaporanStockView",
                Config.ApiAddAction => "SubAktivitasLaporanStockAdd",
                Config.ApiEditAction => "SubAktivitasLaporanStockEdit",
                Config.ApiDeleteAction => "SubAktivitasLaporanStockDelete",
                Config.ApiListAction => "SubAktivitasLaporanStockList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasLaporanStockList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasLaporanStockView", parm);
            else
                url = KeyUrl("SubAktivitasLaporanStockView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasLaporanStockAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasLaporanStockAdd?" + parm;
            else
                url = "SubAktivitasLaporanStockAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLaporanStockEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLaporanStockList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLaporanStockAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLaporanStockList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasLaporanStockDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasLaporanStockList";
        ...
        public async Task RenderListRow()
        {
            ...
            idProses.ViewValue = Empty(curVal) ? DbNullValue : idProses.CurrentValue;
            if (!Empty(curVal)) {
            ...
            idAktifitas.ViewValue = Empty(curVal2) ? DbNullValue : idAktifitas.CurrentValue;
            if (!Empty(curVal2)) {
        ...
        // Row Updating event untuk SubAktivitasLaporanStock
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            try {
                ...
                double stockAwal   = rsnew.ContainsKey("StockAwal")  && rsnew["StockAwal"]  != null ? Convert.ToDouble(rsnew["StockAwal"])  : 0;
                double penerimaan  = rsnew.ContainsKey("Penerimaan") && rsnew["Penerimaan"] != null ? Convert.ToDouble(rsnew["Penerimaan"]) : 0;
                double penyaluran  = rsnew.ContainsKey("Penyaluran") && rsnew["Penyaluran"] != null ? Convert.ToDouble(rsnew["Penyaluran"]) : 0;
                double stockAkhir  = rsnew.ContainsKey("StockAkhir") && rsnew["StockAkhir"]  != null ? Convert.ToDouble(rsnew["StockAkhir"])  : 0;
                double workingLoss = stockAkhir - (stockAwal + penerimaan - penyaluran);
                double persentase  = (stockAwal + penerimaan) != 0 ? workingLoss / (stockAwal + penerimaan) * 100 : 0;
                rsnew["WorkingLoss"] = workingLoss.ToString("F2");
                rsnew["Presentase"]  = persentase.ToString("F2") + "%";
            } catch (Exception ex) {
                Log("Error in Row_Updating (SubAktivitasLaporanStock): " + ex.Message);
