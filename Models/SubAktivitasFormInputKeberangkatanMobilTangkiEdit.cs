...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputKeberangkatanMobilTangkiEdit
    /// </summary>
    public static SubAktivitasFormInputKeberangkatanMobilTangkiEdit subAktivitasFormInputKeberangkatanMobilTangkiEdit
    {
        get => HttpData.Get<SubAktivitasFormInputKeberangkatanMobilTangkiEdit>("subAktivitasFormInputKeberangkatanMobilTangkiEdit")!;
        set => HttpData["subAktivitasFormInputKeberangkatanMobilTangkiEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputKeberangkatanMobilTangki
    /// </summary>
    public class SubAktivitasFormInputKeberangkatanMobilTangkiEdit : SubAktivitasFormInputKeberangkatanMobilTangkiEditBase
    {
        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputKeberangkatanMobilTangkiEditBase : SubAktivitasFormInputKeberangkatanMobilTangki
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputKeberangkatanMobilTangkiEdit";
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputKeberangkatanMobilTangkiEdit";
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputKeberangkatanMobilTangkiList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputKeberangkatanMobilTangkiList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputKeberangkatanMobilTangkiList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputKeberangkatanMobilTangkiEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputKeberangkatanMobilTangkiList")), "", TableVar, true);
            string pageId = "edit";
