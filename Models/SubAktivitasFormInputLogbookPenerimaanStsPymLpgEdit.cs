...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbookPenerimaanStsPymLpgEditBase : SubAktivitasFormInputLogbookPenerimaanStsPymLpg
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputLogbookPenerimaanStsPymLpgList"); // No matching record, return to list
                        }
                    break;
