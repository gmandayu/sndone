...
public partial class SnDOne {
    /// <summary>
    /// goodHouseKeepingView
    /// </summary>
    public static GoodHouseKeepingView goodHouseKeepingView
    {
        get => HttpData.Get<GoodHouseKeepingView>("goodHouseKeepingView")!;
        set => HttpData["goodHouseKeepingView"] = value;
    }

    /// <summary>
    /// Page class for GoodHouseKeeping
    /// </summary>
    public class GoodHouseKeepingView : GoodHouseKeepingViewBase
    {
        // Constructor
        public GoodHouseKeepingView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public GoodHouseKeepingView() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class GoodHouseKeepingViewBase : GoodHouseKeeping
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "goodHouseKeepingView";
        ...
        // Constructor
        public GoodHouseKeepingViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdGoodHouseKeeping"] = keys[0];
            } else {
                RecordKeys["IdGoodHouseKeeping"] = RouteValues.TryGetValue("IdGoodHouseKeeping", out obj) && obj != null ? UrlDecode(obj) : Get("IdGoodHouseKeeping"); // DN
            }
        ...
        // Page name
        public string PageName => "GoodHouseKeepingView";
        ...
        // Constructor
        public GoodHouseKeepingViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdGoodHouseKeeping", out v) && !Empty(v)) { // DN
                IdGoodHouseKeeping.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdGoodHouseKeeping"] = IdGoodHouseKeeping.QueryValue;
            } else if (Get("IdGoodHouseKeeping", out sv)) {
                IdGoodHouseKeeping.QueryValue = sv.ToString();
                RecordKeys["IdGoodHouseKeeping"] = IdGoodHouseKeeping.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdGoodHouseKeeping.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdGoodHouseKeeping"] = IdGoodHouseKeeping.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "GoodHouseKeepingList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("GoodHouseKeepingList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                goodHouseKeepingView?.PageRender();
            }
            return PageResult();
        }
        ...
        public async Task ExportData(dynamic? doc, string[] keys)
        {
            ...
            StartRecord = 1;
            if (keys.Length >= 1) {
                IdGoodHouseKeeping.OldValue = keys[0];
