...
public partial class SnDOne {
    /// <summary>
    /// rencanaPenyaluranDelete
    /// </summary>
    public static RencanaPenyaluranDelete rencanaPenyaluranDelete
    {
        get => HttpData.Get<RencanaPenyaluranDelete>("rencanaPenyaluranDelete")!;
        set => HttpData["rencanaPenyaluranDelete"] = value;
    }

    /// <summary>
    /// Page class for RencanaPenyaluran
    /// </summary>
    public class RencanaPenyaluranDelete : RencanaPenyaluranDeleteBase
    {
        // Constructor
        public RencanaPenyaluranDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public RencanaPenyaluranDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class RencanaPenyaluranDeleteBase : RencanaPenyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "rencanaPenyaluranDelete";
        ...
        // Constructor
        public RencanaPenyaluranDeleteBase()
        {
        ...
        // Page name
        public string PageName => "RencanaPenyaluranDelete";
        ...
        // Constructor
        public RencanaPenyaluranDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("RencanaPenyaluranList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("RencanaPenyaluranList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                rencanaPenyaluranDelete?.PageRender();
            }
            return PageResult();
        }
