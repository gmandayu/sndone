...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasHasilPemeriksaanPipaList
    /// </summary>
    public static SubAktivitasHasilPemeriksaanPipaList subAktivitasHasilPemeriksaanPipaList
    {
        get => HttpData.Get<SubAktivitasHasilPemeriksaanPipaList>("subAktivitasHasilPemeriksaanPipaList")!;
        set => HttpData["subAktivitasHasilPemeriksaanPipaList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasHasilPemeriksaanPipa
    /// </summary>
    public class SubAktivitasHasilPemeriksaanPipaList : SubAktivitasHasilPemeriksaanPipaListBase
    {
        // Constructor
        public SubAktivitasHasilPemeriksaanPipaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasHasilPemeriksaanPipaList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasHasilPemeriksaanPipaListBase : SubAktivitasHasilPemeriksaanPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasHasilPemeriksaanPipaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasHasilPemeriksaanPipalist";
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPipaListBase()
        {
            TableName = "SubAktivitasHasilPemeriksaanPipa";

            // CSS class name as context
            TableVar = "SubAktivitasHasilPemeriksaanPipa";
            ...
            // Table object (subAktivitasHasilPemeriksaanPipa)
            if (subAktivitasHasilPemeriksaanPipa == null || subAktivitasHasilPemeriksaanPipa is SubAktivitasHasilPemeriksaanPipa)
                subAktivitasHasilPemeriksaanPipa = this;

            // Initialize URLs
            AddUrl = "SubAktivitasHasilPemeriksaanPipaAdd";
            ...
            MultiDeleteUrl = "SubAktivitasHasilPemeriksaanPipaDelete";
            MultiUpdateUrl = "SubAktivitasHasilPemeriksaanPipaUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasHasilPemeriksaanPipaList";
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPipaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasHasilPemeriksaanPipaView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasHasilPemeriksaanPipagrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasHasilPemeriksaanPipaList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(NoBatch.AdvancedSearch.ToJson())); // Field NoBatch
            filters.Merge(JObject.Parse(Tanggal.AdvancedSearch.ToJson())); // Field Tanggal
            filters.Merge(JObject.Parse(Nama_Kegiatan.AdvancedSearch.ToJson())); // Field Nama_Kegiatan
            filters.Merge(JObject.Parse(Produk.AdvancedSearch.ToJson())); // Field Produk
            filters.Merge(JObject.Parse(Density.AdvancedSearch.ToJson())); // Field Density
            filters.Merge(JObject.Parse(Temperature.AdvancedSearch.ToJson())); // Field Temperature
            filters.Merge(JObject.Parse(Pressure.AdvancedSearch.ToJson())); // Field Pressure
            filters.Merge(JObject.Parse(VolumeDischarge.AdvancedSearch.ToJson())); // Field VolumeDischarge
            ...
            filters.Merge(JObject.Parse(SubAktivitasHasilPemeriksaanId.AdvancedSearch.ToJson())); // Field SubAktivitasHasilPemeriksaanId
            filters.Merge(JObject.Parse(TotalTerima.AdvancedSearch.ToJson())); // Field TotalTerima
            filters.Merge(JObject.Parse(ETC.AdvancedSearch.ToJson())); // Field ETC
            filters.Merge(JObject.Parse(ETA.AdvancedSearch.ToJson())); // Field ETA
            filters.Merge(JObject.Parse(ETA2.AdvancedSearch.ToJson())); // Field ETA2
            filters.Merge(JObject.Parse(ETA3.AdvancedSearch.ToJson())); // Field ETA3
        ...
        protected bool RestoreFilterList() {
            ...
            // Field NoBatch
            if (filter?.TryGetValue("x_NoBatch", out sv) ?? false) {
                NoBatch.AdvancedSearch.SearchValue = sv;
                NoBatch.AdvancedSearch.SearchOperator = filter["z_NoBatch"];
                NoBatch.AdvancedSearch.SearchCondition = filter["v_NoBatch"];
                NoBatch.AdvancedSearch.SearchValue2 = filter["y_NoBatch"];
                NoBatch.AdvancedSearch.SearchOperator2 = filter["w_NoBatch"];
                NoBatch.AdvancedSearch.Save();
            }
            ...
            // Field Nama_Kegiatan
            if (filter?.TryGetValue("x_Nama_Kegiatan", out sv) ?? false) {
                Nama_Kegiatan.AdvancedSearch.SearchValue = sv;
                Nama_Kegiatan.AdvancedSearch.SearchOperator = filter["z_Nama_Kegiatan"];
                Nama_Kegiatan.AdvancedSearch.SearchCondition = filter["v_Nama_Kegiatan"];
                Nama_Kegiatan.AdvancedSearch.SearchValue2 = filter["y_Nama_Kegiatan"];
                Nama_Kegiatan.AdvancedSearch.SearchOperator2 = filter["w_Nama_Kegiatan"];
                Nama_Kegiatan.AdvancedSearch.Save();
            }

            // Field Produk
            if (filter?.TryGetValue("x_Produk", out sv) ?? false) {
                Produk.AdvancedSearch.SearchValue = sv;
                Produk.AdvancedSearch.SearchOperator = filter["z_Produk"];
                Produk.AdvancedSearch.SearchCondition = filter["v_Produk"];
                Produk.AdvancedSearch.SearchValue2 = filter["y_Produk"];
                Produk.AdvancedSearch.SearchOperator2 = filter["w_Produk"];
                Produk.AdvancedSearch.Save();
            }

            // Field Density
            if (filter?.TryGetValue("x_Density", out sv) ?? false) {
                Density.AdvancedSearch.SearchValue = sv;
                Density.AdvancedSearch.SearchOperator = filter["z_Density"];
                Density.AdvancedSearch.SearchCondition = filter["v_Density"];
                Density.AdvancedSearch.SearchValue2 = filter["y_Density"];
                Density.AdvancedSearch.SearchOperator2 = filter["w_Density"];
                Density.AdvancedSearch.Save();
            }

            // Field Temperature
            if (filter?.TryGetValue("x_Temperature", out sv) ?? false) {
                Temperature.AdvancedSearch.SearchValue = sv;
                Temperature.AdvancedSearch.SearchOperator = filter["z_Temperature"];
                Temperature.AdvancedSearch.SearchCondition = filter["v_Temperature"];
                Temperature.AdvancedSearch.SearchValue2 = filter["y_Temperature"];
                Temperature.AdvancedSearch.SearchOperator2 = filter["w_Temperature"];
                Temperature.AdvancedSearch.Save();
            }

            // Field Pressure
            if (filter?.TryGetValue("x_Pressure", out sv) ?? false) {
                Pressure.AdvancedSearch.SearchValue = sv;
                Pressure.AdvancedSearch.SearchOperator = filter["z_Pressure"];
                Pressure.AdvancedSearch.SearchCondition = filter["v_Pressure"];
                Pressure.AdvancedSearch.SearchValue2 = filter["y_Pressure"];
                Pressure.AdvancedSearch.SearchOperator2 = filter["w_Pressure"];
                Pressure.AdvancedSearch.Save();
            }

            // Field VolumeDischarge
            if (filter?.TryGetValue("x_VolumeDischarge", out sv) ?? false) {
                VolumeDischarge.AdvancedSearch.SearchValue = sv;
                VolumeDischarge.AdvancedSearch.SearchOperator = filter["z_VolumeDischarge"];
                VolumeDischarge.AdvancedSearch.SearchCondition = filter["v_VolumeDischarge"];
                VolumeDischarge.AdvancedSearch.SearchValue2 = filter["y_VolumeDischarge"];
                VolumeDischarge.AdvancedSearch.SearchOperator2 = filter["w_VolumeDischarge"];
                VolumeDischarge.AdvancedSearch.Save();
            }
            ...
            // Field SubAktivitasHasilPemeriksaanId
            if (filter?.TryGetValue("x_SubAktivitasHasilPemeriksaanId", out sv) ?? false) {
                SubAktivitasHasilPemeriksaanId.AdvancedSearch.SearchValue = sv;
                SubAktivitasHasilPemeriksaanId.AdvancedSearch.SearchOperator = filter["z_SubAktivitasHasilPemeriksaanId"];
                SubAktivitasHasilPemeriksaanId.AdvancedSearch.SearchCondition = filter["v_SubAktivitasHasilPemeriksaanId"];
                SubAktivitasHasilPemeriksaanId.AdvancedSearch.SearchValue2 = filter["y_SubAktivitasHasilPemeriksaanId"];
                SubAktivitasHasilPemeriksaanId.AdvancedSearch.SearchOperator2 = filter["w_SubAktivitasHasilPemeriksaanId"];
                SubAktivitasHasilPemeriksaanId.AdvancedSearch.Save();
            }

            // Field TotalTerima
            if (filter?.TryGetValue("x_TotalTerima", out sv) ?? false) {
                TotalTerima.AdvancedSearch.SearchValue = sv;
                TotalTerima.AdvancedSearch.SearchOperator = filter["z_TotalTerima"];
                TotalTerima.AdvancedSearch.SearchCondition = filter["v_TotalTerima"];
                TotalTerima.AdvancedSearch.SearchValue2 = filter["y_TotalTerima"];
                TotalTerima.AdvancedSearch.SearchOperator2 = filter["w_TotalTerima"];
                TotalTerima.AdvancedSearch.Save();
            }

            // Field ETC
            if (filter?.TryGetValue("x_ETC", out sv) ?? false) {
                ETC.AdvancedSearch.SearchValue = sv;
                ETC.AdvancedSearch.SearchOperator = filter["z_ETC"];
                ETC.AdvancedSearch.SearchCondition = filter["v_ETC"];
                ETC.AdvancedSearch.SearchValue2 = filter["y_ETC"];
                ETC.AdvancedSearch.SearchOperator2 = filter["w_ETC"];
                ETC.AdvancedSearch.Save();
            }

            // Field ETA
            if (filter?.TryGetValue("x_ETA", out sv) ?? false) {
                ETA.AdvancedSearch.SearchValue = sv;
                ETA.AdvancedSearch.SearchOperator = filter["z_ETA"];
                ETA.AdvancedSearch.SearchCondition = filter["v_ETA"];
                ETA.AdvancedSearch.SearchValue2 = filter["y_ETA"];
                ETA.AdvancedSearch.SearchOperator2 = filter["w_ETA"];
                ETA.AdvancedSearch.Save();
            }

            // Field ETA2
            if (filter?.TryGetValue("x_ETA2", out sv) ?? false) {
                ETA2.AdvancedSearch.SearchValue = sv;
                ETA2.AdvancedSearch.SearchOperator = filter["z_ETA2"];
                ETA2.AdvancedSearch.SearchCondition = filter["v_ETA2"];
                ETA2.AdvancedSearch.SearchValue2 = filter["y_ETA2"];
                ETA2.AdvancedSearch.SearchOperator2 = filter["w_ETA2"];
                ETA2.AdvancedSearch.Save();
            }

            // Field ETA3
            if (filter?.TryGetValue("x_ETA3", out sv) ?? false) {
                ETA3.AdvancedSearch.SearchValue = sv;
                ETA3.AdvancedSearch.SearchOperator = filter["z_ETA3"];
                ETA3.AdvancedSearch.SearchCondition = filter["v_ETA3"];
                ETA3.AdvancedSearch.SearchValue2 = filter["y_ETA3"];
                ETA3.AdvancedSearch.SearchOperator2 = filter["w_ETA3"];
                ETA3.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(NoBatch);
            searchFlds.Add(Nama_Kegiatan);
            searchFlds.Add(Produk);
            searchFlds.Add(Density);
            searchFlds.Add(Temperature);
            searchFlds.Add(Pressure);
            searchFlds.Add(VolumeDischarge);
            searchFlds.Add(Flowrate);
            searchFlds.Add(Keterangan);
            searchFlds.Add(userInput);
            searchFlds.Add(LastUpdatedBy);
            searchFlds.Add(TotalTerima);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(NoBatch, ctrl); // NoBatch
                UpdateSort(Tanggal, ctrl); // Tanggal
                UpdateSort(Nama_Kegiatan, ctrl); // Nama_Kegiatan
                UpdateSort(Produk, ctrl); // Produk
                UpdateSort(Density, ctrl); // Density
                UpdateSort(Temperature, ctrl); // Temperature
                UpdateSort(Pressure, ctrl); // Pressure
                UpdateSort(VolumeDischarge, ctrl); // VolumeDischarge
                ...
                UpdateSort(SubAktivitasHasilPemeriksaanId, ctrl); // SubAktivitasHasilPemeriksaanId
                UpdateSort(TotalTerima, ctrl); // TotalTerima
                UpdateSort(ETC, ctrl); // ETC
                UpdateSort(ETA, ctrl); // ETA
                UpdateSort(ETA2, ctrl); // ETA2
                UpdateSort(ETA3, ctrl); // ETA3
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    SubAktivitasHasilPemeriksaanId.Sort = "";
                    TotalTerima.Sort = "";
                    ETC.Sort = "";
                    ETA.Sort = "";
                    ETA2.Sort = "";
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasHasilPemeriksaanPipa"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasHasilPemeriksaanPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasHasilPemeriksaanPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("NoBatch")); // DN
                CreateColumnOption(option.Add("Tanggal")); // DN
                CreateColumnOption(option.Add("Nama_Kegiatan")); // DN
                CreateColumnOption(option.Add("Produk")); // DN
                CreateColumnOption(option.Add("Density")); // DN
                CreateColumnOption(option.Add("Temperature")); // DN
                CreateColumnOption(option.Add("Pressure")); // DN
                CreateColumnOption(option.Add("VolumeDischarge")); // DN
                ...
                CreateColumnOption(option.Add("SubAktivitasHasilPemeriksaanId")); // DN
                CreateColumnOption(option.Add("TotalTerima")); // DN
                CreateColumnOption(option.Add("ETC")); // DN
                CreateColumnOption(option.Add("ETA")); // DN
                CreateColumnOption(option.Add("ETA2")); // DN
                CreateColumnOption(option.Add("ETA3")); // DN
            }
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasHasilPemeriksaanPipasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasHasilPemeriksaanPipasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasHasilPemeriksaanPipalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasHasilPemeriksaanPipa");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasHasilPemeriksaanPipaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasHasilPemeriksaanPipaList.RowCount) + "_SubAktivitasHasilPemeriksaanPipa");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasHasilPemeriksaanPipaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasHasilPemeriksaanPipaList.RowType == RowType.Add || IsEdit && subAktivitasHasilPemeriksaanPipaList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            NoBatch.SetDbValue(row["NoBatch"]);
            ...
            VolumeDischarge.SetDbValue(row["VolumeDischarge"]);
            ...
            TotalTerima.SetDbValue(row["TotalTerima"]);
            ETC.SetDbValue(row["ETC"]);
            ETA.SetDbValue(row["ETA"]);
            ETA2.SetDbValue(row["ETA2"]);
            ETA3.SetDbValue(row["ETA3"]);
        }
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("NoBatch", NoBatch.DefaultValue ?? DbNullValue); // DN
            ...
            row.Add("VolumeDischarge", VolumeDischarge.DefaultValue ?? DbNullValue); // DN
            ...
            row.Add("TotalTerima", TotalTerima.DefaultValue ?? DbNullValue); // DN
            row.Add("ETC", ETC.DefaultValue ?? DbNullValue); // DN
            row.Add("ETA", ETA.DefaultValue ?? DbNullValue); // DN
            row.Add("ETA2", ETA2.DefaultValue ?? DbNullValue); // DN
            row.Add("ETA3", ETA3.DefaultValue ?? DbNullValue); // DN
            return row;
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // NoBatch
                NoBatch.ViewValue = ConvertToString(NoBatch.CurrentValue); // DN
                NoBatch.ViewCustomAttributes = "";
                ...
                // VolumeDischarge
                VolumeDischarge.ViewValue = ConvertToString(VolumeDischarge.CurrentValue); // DN
                VolumeDischarge.ViewCustomAttributes = "";
                ...
                // TotalTerima
                TotalTerima.ViewValue = ConvertToString(TotalTerima.CurrentValue); // DN
                TotalTerima.ViewCustomAttributes = "";

                // ETC
                ETC.ViewValue = ETC.CurrentValue;
                ETC.ViewValue = FormatDateTime(ETC.ViewValue, ETC.FormatPattern);
                ETC.ViewCustomAttributes = "";

                // ETA
                ETA.ViewValue = ETA.CurrentValue;
                ETA.ViewValue = FormatDateTime(ETA.ViewValue, ETA.FormatPattern);
                ETA.ViewCustomAttributes = "";

                // ETA2
                ETA2.ViewValue = ETA2.CurrentValue;
                ETA2.ViewValue = FormatDateTime(ETA2.ViewValue, ETA2.FormatPattern);
                ETA2.ViewCustomAttributes = "";

                // ETA3
                ETA3.ViewValue = ETA3.CurrentValue;
                ETA3.ViewValue = FormatDateTime(ETA3.ViewValue, ETA3.FormatPattern);
                ETA3.ViewCustomAttributes = "";
                ...
                // Pressure
                Pressure.HrefValue = "";
                Pressure.TooltipValue = "";

                // VolumeDischarge
                VolumeDischarge.HrefValue = "";
                VolumeDischarge.TooltipValue = "";
                ...
                // TotalTerima
                TotalTerima.HrefValue = "";
                TotalTerima.TooltipValue = "";
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasHasilPemeriksaanPipasrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
