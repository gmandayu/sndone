...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputKeberangkatanMobilTangkiAdd
    /// </summary>
    public static SubAktivitasFormInputKeberangkatanMobilTangkiAdd subAktivitasFormInputKeberangkatanMobilTangkiAdd
    {
        get => HttpData.Get<SubAktivitasFormInputKeberangkatanMobilTangkiAdd>("subAktivitasFormInputKeberangkatanMobilTangkiAdd")!;
        set => HttpData["subAktivitasFormInputKeberangkatanMobilTangkiAdd"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputKeberangkatanMobilTangki
    /// </summary>
    public class SubAktivitasFormInputKeberangkatanMobilTangkiAdd : SubAktivitasFormInputKeberangkatanMobilTangkiAddBase
    {
        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputKeberangkatanMobilTangkiAddBase : SubAktivitasFormInputKeberangkatanMobilTangki
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputKeberangkatanMobilTangkiAdd";
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiAddBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputKeberangkatanMobilTangkiAdd";
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanMobilTangkiAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasFormInputKeberangkatanMobilTangkiList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "SubAktivitasFormInputKeberangkatanMobilTangkiView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputKeberangkatanMobilTangkiList") {
                                ...
                                returnUrl = "SubAktivitasFormInputKeberangkatanMobilTangkiList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputKeberangkatanMobilTangkiAdd?.PageRender();
            }
            return PageResult();
        }
