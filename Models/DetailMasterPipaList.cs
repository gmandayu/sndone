...
public partial class SnDOne {
    ...
    public class DetailMasterPipaListBase : DetailMasterPipa
    {
        ...
        // Constructor
        public DetailMasterPipaListBase(Controller? controller)
        {
        ...
        // Constructor
        public DetailMasterPipaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private string BuildFieldFilters(FilterConfiguration config)
        {
            ...
            filterList += ProcessFieldFilter("idPlantTujuan", idPlantTujuan, true, config);
            filterList += ProcessFieldFilter("Panjang", Panjang, true, config);
            filterList += ProcessFieldFilter("Diameter", Diameter, true, config);
