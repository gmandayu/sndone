...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbMonitoringStockRtwEditBase : SubAktivitasFormInputLogbMonitoringStockRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputLogbMonitoringStockRtwList"); // No matching record, return to list
                        }
                    break;
