...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static MasterVariabel masterVariabel
    {
        get => HttpData.Resolve<MasterVariabel>("MasterVariabel");
        set => HttpData["MasterVariabel"] = value;
    }

    /// <summary>
    /// Table class for MasterVariabel
    /// </summary>
    public class MasterVariabel : DbTable
    {
        ...
        public readonly DbField<SqlDbType> NamaSetting;

        public readonly DbField<SqlDbType> ValueSetting;
        ...
        // Constructor
        public MasterVariabel()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "MasterVariabel";
            Name = "MasterVariabel";
            Type = "TABLE";
            UpdateTable = "dbo.MasterVariabel"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterVariabel", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            // NamaSetting
            NamaSetting = new(this, "x_NamaSetting", 202, SqlDbType.NVarChar) {
                Name = "NamaSetting",
                Expression = "[NamaSetting]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NamaSetting]",
                DateTimeFormat = -1,
                VirtualExpression = "[NamaSetting]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MasterVariabel", "NamaSetting", "CustomMsg"),
                IsUpload = false
            };
            NamaSetting.Lookup = new Lookup<DbField>(NamaSetting, "MasterVariabel", true, "NamaSetting", new List<string> {"NamaSetting", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NamaSetting", NamaSetting);

            // ValueSetting
            ValueSetting = new(this, "x_ValueSetting", 202, SqlDbType.NVarChar) {
                Name = "ValueSetting",
                Expression = "[ValueSetting]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ValueSetting]",
                DateTimeFormat = -1,
                VirtualExpression = "[ValueSetting]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterVariabel", "ValueSetting", "CustomMsg"),
                IsUpload = false
            };
            ValueSetting.Lookup = new Lookup<DbField>(ValueSetting, "MasterVariabel", true, "ValueSetting", new List<string> {"ValueSetting", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("ValueSetting", ValueSetting);
            ...
            UserInput = new(this, "x_UserInput", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterVariabel", "UserInput", "CustomMsg"),
                IsUpload = false
            };
            UserInput.Lookup = new Lookup<DbField>(UserInput, "MasterVariabel", true, "UserInput", new List<string> {"UserInput", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            EtlDate = new(this, "x_EtlDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("MasterVariabel", "EtlDate", "CustomMsg"),
                IsUpload = false
            };
            EtlDate.Raw = true;
            EtlDate.Lookup = new Lookup<DbField>(EtlDate, "MasterVariabel", true, "EtlDate", new List<string> {"EtlDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterVariabel", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedBy.Lookup = new Lookup<DbField>(LastUpdatedBy, "MasterVariabel", true, "LastUpdatedBy", new List<string> {"LastUpdatedBy", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LastUpdatedDate = new(this, "x_LastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterVariabel", "LastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDate.Raw = true;
            LastUpdatedDate.Lookup = new Lookup<DbField>(LastUpdatedDate, "MasterVariabel", true, "LastUpdatedDate", new List<string> {"LastUpdatedDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        {
            get => _sqlFrom ?? "dbo.MasterVariabel";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MasterVariabel type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                NamaSetting.DbValue = row["NamaSetting"]; // Set DB value only
                ValueSetting.DbValue = row["ValueSetting"]; // Set DB value only
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MasterVariabelView" => Language.Phrase("View"),
                "MasterVariabelEdit" => Language.Phrase("Edit"),
                "MasterVariabelAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MasterVariabelView",
                Config.ApiAddAction => "MasterVariabelAdd",
                Config.ApiEditAction => "MasterVariabelEdit",
                Config.ApiDeleteAction => "MasterVariabelDelete",
                Config.ApiListAction => "MasterVariabelList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MasterVariabelList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MasterVariabelView", parm);
            else
                url = KeyUrl("MasterVariabelView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MasterVariabelAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MasterVariabelAdd?" + parm;
            else
                url = "MasterVariabelAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MasterVariabelEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterVariabelList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MasterVariabelAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterVariabelList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MasterVariabelDelete", parm)); // DN
        }
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            ...
            NamaSetting.SetDbValue(row["NamaSetting"]);
            ValueSetting.SetDbValue(row["ValueSetting"]);
        ...
        {
            string pageName = "MasterVariabelList";
        ...
        public async Task RenderListRow()
        {
            ...
            // NamaSetting
            NamaSetting.ViewValue = ConvertToString(NamaSetting.CurrentValue); // DN
            NamaSetting.ViewCustomAttributes = "";

            // ValueSetting
            ValueSetting.ViewValue = ConvertToString(ValueSetting.CurrentValue); // DN
            ValueSetting.ViewCustomAttributes = "";
            ...
            // NamaSetting
            NamaSetting.HrefValue = "";
            NamaSetting.TooltipValue = "";

            // ValueSetting
            ValueSetting.HrefValue = "";
            ValueSetting.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // NamaSetting
            NamaSetting.SetupEditAttributes();
            if (!NamaSetting.Raw)
                NamaSetting.CurrentValue = HtmlDecode(NamaSetting.CurrentValue);
            NamaSetting.EditValue = NamaSetting.CurrentValue;
            NamaSetting.PlaceHolder = RemoveHtml(NamaSetting.Caption);

            // ValueSetting
            ValueSetting.SetupEditAttributes();
            if (!ValueSetting.Raw)
                ValueSetting.CurrentValue = HtmlDecode(ValueSetting.CurrentValue);
            ValueSetting.EditValue = ValueSetting.CurrentValue;
            ValueSetting.PlaceHolder = RemoveHtml(ValueSetting.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(NamaSetting);
                        doc.ExportCaption(ValueSetting);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(NamaSetting);
                            await doc.ExportField(ValueSetting);
