...
public partial class SnDOne {
    ...
    /// proofOfVisitView
    /// </summary>
    public static ProofOfVisitView proofOfVisitView
    {
        get => HttpData.Get<ProofOfVisitView>("proofOfVisitView")!;
        set => HttpData["proofOfVisitView"] = value;
    }

    /// <summary>
    /// Page class for ProofOfVisit
    /// </summary>
    public class ProofOfVisitView : ProofOfVisitViewBase
    {
        // Constructor
        public ProofOfVisitView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ProofOfVisitView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ProofOfVisitViewBase : ProofOfVisit
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "proofOfVisitView";
        ...
        public ProofOfVisitViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdProofOfVisit"] = keys[0];
            } else {
                RecordKeys["IdProofOfVisit"] = RouteValues.TryGetValue("IdProofOfVisit", out obj) && obj != null ? UrlDecode(obj) : Get("IdProofOfVisit"); // DN
            }
        ...
        // Page name
        public string PageName => "ProofOfVisitView";
        ...
        // Constructor
        public ProofOfVisitViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdProofOfVisit", out v) && !Empty(v)) { // DN
                IdProofOfVisit.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdProofOfVisit"] = IdProofOfVisit.QueryValue;
            } else if (Get("IdProofOfVisit", out sv)) {
                IdProofOfVisit.QueryValue = sv.ToString();
                RecordKeys["IdProofOfVisit"] = IdProofOfVisit.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdProofOfVisit.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdProofOfVisit"] = IdProofOfVisit.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "ProofOfVisitList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("ProofOfVisitList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        public async Task ExportData(dynamic? doc, string[] keys)
        {
            ...
            StartRecord = 1;
            if (keys.Length >= 1) {
                IdProofOfVisit.OldValue = keys[0];
