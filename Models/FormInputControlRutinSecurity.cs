...
public partial class SnDOne {
    /// <summary>
    /// formInputControlRutinSecurity
    /// </summary>
    [MaybeNull]
    public static FormInputControlRutinSecurity formInputControlRutinSecurity
    {
        get => HttpData.Resolve<FormInputControlRutinSecurity>("FormInputControlRutinSecurity");
        set => HttpData["FormInputControlRutinSecurity"] = value;
    }

    /// <summary>
    /// Table class for FormInputControlRutinSecurity
    /// </summary>
    public class FormInputControlRutinSecurity : DbTable
    {
        ...
        public readonly DbField<SqlDbType> NamaSecurity;
        ...
        // Constructor
        public FormInputControlRutinSecurity()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "FormInputControlRutinSecurity";
            Name = "FormInputControlRutinSecurity";
            Type = "TABLE";
            UpdateTable = "dbo.FormInputControlRutinSecurity"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new(this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "Id", "CustomMsg"),
                IsUpload = false
            };
            Id.Raw = true;
            Fields.Add("Id", Id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            NoReferensi.Lookup = new Lookup<DbField>(NoReferensi, "FormInputControlRutinSecurity", true, "NoReferensi", new List<string> {"NoReferensi", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NoReferensi", NoReferensi);

            // NamaSecurity
            NamaSecurity = new(this, "x_NamaSecurity", 202, SqlDbType.NVarChar) {
                Name = "NamaSecurity",
                Expression = "[NamaSecurity]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NamaSecurity]",
                DateTimeFormat = -1,
                VirtualExpression = "[NamaSecurity]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "NamaSecurity", "CustomMsg"),
                IsUpload = false
            };
            NamaSecurity.Lookup = new Lookup<DbField>(NamaSecurity, "FormInputControlRutinSecurity", true, "NamaSecurity", new List<string> {"NamaSecurity", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NamaSecurity", NamaSecurity);
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            Tanggal.Lookup = new Lookup<DbField>(Tanggal, "FormInputControlRutinSecurity", true, "Tanggal", new List<string> {"Tanggal", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Lokasi = new(this, "x_Lokasi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "Lokasi", "CustomMsg"),
                IsUpload = false
            };
            ...
            DownloadDokumen = new(this, "x_DownloadDokumen", 203, SqlDbType.NText) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "DownloadDokumen", "CustomMsg"),
                IsUpload = false
            };
            ...
            UploadFoto = new(this, "x_UploadFoto", 203, SqlDbType.NText) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "UploadFoto", "CustomMsg"),
                IsUpload = false
            };
            ...
            Ketidaksesuaiaan = new(this, "x_Ketidaksesuaiaan", 202, SqlDbType.NVarChar) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "Ketidaksesuaiaan", "CustomMsg"),
                IsUpload = false
            };
            Ketidaksesuaiaan.Lookup = new Lookup<DbField>(Ketidaksesuaiaan, "FormInputControlRutinSecurity", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Keterangan = new(this, "x_Keterangan", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            Keterangan.Lookup = new Lookup<DbField>(Keterangan, "FormInputControlRutinSecurity", true, "Keterangan", new List<string> {"Keterangan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            IdPosition = new(this, "x_IdPosition", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "IdPosition", "CustomMsg"),
                IsUpload = false
            };
            IdPosition.Raw = true;
            IdPosition.Lookup = new Lookup<DbField>(IdPosition, "FormInputControlRutinSecurity", true, "IdPosition", new List<string> {"IdPosition", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            UserInput = new(this, "x_UserInput", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "UserInput", "CustomMsg"),
                IsUpload = false
            };
            UserInput.Lookup = new Lookup<DbField>(UserInput, "FormInputControlRutinSecurity", true, "UserInput", new List<string> {"UserInput", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            EtlDate = new(this, "x_EtlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "EtlDate", "CustomMsg"),
                IsUpload = false
            };
            EtlDate.Raw = true;
            EtlDate.Lookup = new Lookup<DbField>(EtlDate, "FormInputControlRutinSecurity", true, "EtlDate", new List<string> {"EtlDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedBy.Lookup = new Lookup<DbField>(LastUpdatedBy, "FormInputControlRutinSecurity", true, "LastUpdatedBy", new List<string> {"LastUpdatedBy", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LastUpdatedDate = new(this, "x_LastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputControlRutinSecurity", "LastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.FormInputControlRutinSecurity";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.FormInputControlRutinSecurity type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                NamaSecurity.DbValue = row["NamaSecurity"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "FormInputControlRutinSecurityList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "FormInputControlRutinSecurityView" => Language.Phrase("View"),
                "FormInputControlRutinSecurityEdit" => Language.Phrase("Edit"),
                "FormInputControlRutinSecurityAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "FormInputControlRutinSecurityView",
                Config.ApiAddAction => "FormInputControlRutinSecurityAdd",
                Config.ApiEditAction => "FormInputControlRutinSecurityEdit",
                Config.ApiDeleteAction => "FormInputControlRutinSecurityDelete",
                Config.ApiListAction => "FormInputControlRutinSecurityList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "FormInputControlRutinSecurityList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("FormInputControlRutinSecurityView", parm);
            else
                url = KeyUrl("FormInputControlRutinSecurityView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "FormInputControlRutinSecurityAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "FormInputControlRutinSecurityAdd?" + parm;
            else
                url = "FormInputControlRutinSecurityAdd";
        ...
        {
            string url = "";
            url = KeyUrl("FormInputControlRutinSecurityEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("FormInputControlRutinSecurityList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("FormInputControlRutinSecurityAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("FormInputControlRutinSecurityList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("FormInputControlRutinSecurityDelete", parm)); // DN
        }
        ...
        {
            string pageName = "FormInputControlRutinSecurityList";
        ...
        public async Task RenderEditRow()
        {
            ...
            NamaSecurity.EditValue = NamaSecurity.CurrentValue;
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            ...
            {
                Log("Error in FormInputCRS Row_Inserting: " + ex.Message);
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            ...
            {
                Log("Error in FormInputCRS Row_Updating: " + ex.Message);
