...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasHasilPemeriksaanPenyaluranLpgEdit
    /// </summary>
    public static SubAktivitasHasilPemeriksaanPenyaluranLpgEdit subAktivitasHasilPemeriksaanPenyaluranLpgEdit
    {
        get => HttpData.Get<SubAktivitasHasilPemeriksaanPenyaluranLpgEdit>("subAktivitasHasilPemeriksaanPenyaluranLpgEdit")!;
        set => HttpData["subAktivitasHasilPemeriksaanPenyaluranLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasHasilPemeriksaanPenyaluranLPG
    /// </summary>
    public class SubAktivitasHasilPemeriksaanPenyaluranLpgEdit : SubAktivitasHasilPemeriksaanPenyaluranLpgEditBase
    {
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasHasilPemeriksaanPenyaluranLpgEditBase : SubAktivitasHasilPemeriksaanPenyaluranLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasHasilPemeriksaanPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasHasilPemeriksaanPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasHasilPemeriksaanPenyaluranLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasHasilPemeriksaanPenyaluranLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasHasilPemeriksaanPenyaluranLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasHasilPemeriksaanPenyaluranLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasHasilPemeriksaanPenyaluranLpgList")), "", TableVar, true);
            string pageId = "edit";
