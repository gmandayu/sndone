...
public partial class SnDOne {
    ...
    public class SubAktivitasSfadNewBllpgEditBase : SubAktivitasSfadNewBllpg
    {
        ...
        // Constructor
        public SubAktivitasSfadNewBllpgEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasSfadNewBllpgEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasSfadNewBllpgList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubAktivitasSfadNewBllpgList") {
                        ...
                        returnUrl = "SubAktivitasSfadNewBllpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
