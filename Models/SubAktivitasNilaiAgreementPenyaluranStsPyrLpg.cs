...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiAgreementPenyaluranStsPyrLpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiAgreementPenyaluranStsPyrLpg subAktivitasNilaiAgreementPenyaluranStsPyrLpg
    {
        get => HttpData.Resolve<SubAktivitasNilaiAgreementPenyaluranStsPyrLpg>("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG");
        set => HttpData["SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG
    /// </summary>
    public class SubAktivitasNilaiAgreementPenyaluranStsPyrLpg : DbTable
    {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG";
            Name = "SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Flowrate = new(this, "x_Flowrate", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "Flowrate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Pressure = new(this, "x_Pressure", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "Pressure", "CustomMsg"),
                IsUpload = false
            };
            ...
            LamaPembongkaran = new(this, "x_LamaPembongkaran", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "LamaPembongkaran", "CustomMsg"),
                IsUpload = false
            };
            ...
            ETC = new(this, "x_ETC", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "ETC", "CustomMsg"),
                IsUpload = false
            };
            ETC.Raw = true;
            Fields.Add("ETC", ETC);
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiAgreementPenyaluranSTSPyrLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiAgreementPenyaluranStspyrLpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgView" => Language.Phrase("View"),
                "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgView",
                Config.ApiAddAction => "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgAdd",
                Config.ApiEditAction => "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgDelete",
                Config.ApiListAction => "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiAgreementPenyaluranStsPyrLpgView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiAgreementPenyaluranStsPyrLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgAdd?" + parm;
            else
                url = "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiAgreementPenyaluranStsPyrLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiAgreementPenyaluranStsPyrLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiAgreementPenyaluranStsPyrLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiAgreementPenyaluranStsPyrLpgList";
