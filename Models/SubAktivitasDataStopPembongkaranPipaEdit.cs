...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStopPembongkaranPipaEditBase : SubAktivitasDataStopPembongkaranPipa
    {
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranPipaEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranPipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStopPembongkaranPipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStopPembongkaranPipaList") {
                                ...
                                returnUrl = "SubAktivitasDataStopPembongkaranPipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'tglStopBongkar' before field var 'x_tglStopBongkar'
            val = CurrentForm.HasValue("tglStopBongkar") ? CurrentForm.GetValue("tglStopBongkar") : CurrentForm.GetValue("x_tglStopBongkar");
            if (!tglStopBongkar.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("tglStopBongkar") && !CurrentForm.HasValue("x_tglStopBongkar")) // DN
                    tglStopBongkar.Visible = false; // Disable update for API request
                else
                    tglStopBongkar.SetFormValue(val, true, validate);
