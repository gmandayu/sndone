...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLaporanStockStscslpgList
    /// </summary>
    public static SubAktivitasLaporanStockStscslpgList subAktivitasLaporanStockStscslpgList
    {
        get => HttpData.Get<SubAktivitasLaporanStockStscslpgList>("subAktivitasLaporanStockStscslpgList")!;
        set => HttpData["subAktivitasLaporanStockStscslpgList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasLaporanStockSTSCSLPG
    /// </summary>
    public class SubAktivitasLaporanStockStscslpgList : SubAktivitasLaporanStockStscslpgListBase
    {
        // Constructor
        public SubAktivitasLaporanStockStscslpgList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasLaporanStockStscslpgList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasLaporanStockStscslpgListBase : SubAktivitasLaporanStockStscslpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasLaporanStockStscslpgList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasLaporanStockSTSCSLPGlist";
        ...
        // Constructor
        public SubAktivitasLaporanStockStscslpgListBase()
        {
            ...
            // Initialize URLs
            AddUrl = "SubAktivitasLaporanStockStscslpgAdd";
            ...
            MultiDeleteUrl = "SubAktivitasLaporanStockStscslpgDelete";
            MultiUpdateUrl = "SubAktivitasLaporanStockStscslpgUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasLaporanStockStscslpgList";
        ...
        public void SetVisibility()
        {
            ...
            Tangki.SetVisibility();
            Produk.SetVisibility();
        }

        // Constructor
        public SubAktivitasLaporanStockStscslpgListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasLaporanStockSTSCSLPGgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasLaporanStockStscslpgList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(Tangki.AdvancedSearch.ToJson())); // Field Tangki
        ...
        protected bool RestoreFilterList() {
            ...
            // Field Tangki
            if (filter?.TryGetValue("x_Tangki", out sv) ?? false) {
                Tangki.AdvancedSearch.SearchValue = sv;
                Tangki.AdvancedSearch.SearchOperator = filter["z_Tangki"];
                Tangki.AdvancedSearch.SearchCondition = filter["v_Tangki"];
                Tangki.AdvancedSearch.SearchValue2 = filter["y_Tangki"];
                Tangki.AdvancedSearch.SearchOperator2 = filter["w_Tangki"];
                Tangki.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(StockAwal);
            searchFlds.Add(Penerimaan2);
            searchFlds.Add(Penyaluran2);
            searchFlds.Add(StockAkhir);
            searchFlds.Add(WorkingLoss);
            searchFlds.Add(Presentase);
            searchFlds.Add(userInput);
            searchFlds.Add(Tangki);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(StockAwal, ctrl); // StockAwal
                UpdateSort(Penerimaan2, ctrl); // Penerimaan
                UpdateSort(Penyaluran2, ctrl); // Penyaluran
                UpdateSort(StockAkhir, ctrl); // StockAkhir
                UpdateSort(WorkingLoss, ctrl); // WorkingLoss
                UpdateSort(Presentase, ctrl); // Presentase
                UpdateSort(userInput, ctrl); // userInput
                UpdateSort(Tangki, ctrl); // Tangki
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasLaporanStockSTSCSLPG"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasLaporanStockSTSCSLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasLaporanStockSTSCSLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("StockAwal")); // DN
                CreateColumnOption(option.Add("Penerimaan")); // DN
                CreateColumnOption(option.Add("Penyaluran")); // DN
                CreateColumnOption(option.Add("StockAkhir")); // DN
                CreateColumnOption(option.Add("WorkingLoss")); // DN
                CreateColumnOption(option.Add("Presentase")); // DN
                CreateColumnOption(option.Add("userInput")); // DN
                CreateColumnOption(option.Add("Tangki")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasLaporanStockSTSCSLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasLaporanStockSTSCSLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasLaporanStockSTSCSLPGlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasLaporanStockSTSCSLPG");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasLaporanStockStscslpgList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasLaporanStockStscslpgList.RowCount) + "_SubAktivitasLaporanStockSTSCSLPG");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasLaporanStockStscslpgList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasLaporanStockStscslpgList.RowType == RowType.Add || IsEdit && subAktivitasLaporanStockStscslpgList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasLaporanStockSTSCSLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasLaporanStockSTSCSLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasLaporanStockSTSCSLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
