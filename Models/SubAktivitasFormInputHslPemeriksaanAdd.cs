...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputHslPemeriksaanAddBase : SubAktivitasFormInputHslPemeriksaan
    {
        ...
        // Constructor
        public SubAktivitasFormInputHslPemeriksaanAddBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputHslPemeriksaanAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasFormInputHslPemeriksaanList"); // No matching record, return to List page // DN
                    }
                    break;
