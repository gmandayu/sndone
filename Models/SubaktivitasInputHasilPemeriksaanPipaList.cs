...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasInputHasilPemeriksaanPipaList
    /// </summary>
    public static SubaktivitasInputHasilPemeriksaanPipaList subaktivitasInputHasilPemeriksaanPipaList
    {
        get => HttpData.Get<SubaktivitasInputHasilPemeriksaanPipaList>("subaktivitasInputHasilPemeriksaanPipaList")!;
        set => HttpData["subaktivitasInputHasilPemeriksaanPipaList"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasInputHasilPemeriksaanPipa
    /// </summary>
    public class SubaktivitasInputHasilPemeriksaanPipaList : SubaktivitasInputHasilPemeriksaanPipaListBase
    {
        // Constructor
        public SubaktivitasInputHasilPemeriksaanPipaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasInputHasilPemeriksaanPipaList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasInputHasilPemeriksaanPipaListBase : SubaktivitasInputHasilPemeriksaanPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasInputHasilPemeriksaanPipaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubaktivitasInputHasilPemeriksaanPipalist";
        ...
        // Constructor
        public SubaktivitasInputHasilPemeriksaanPipaListBase()
        {
            TableName = "SubaktivitasInputHasilPemeriksaanPipa";

            // CSS class name as context
            TableVar = "SubaktivitasInputHasilPemeriksaanPipa";
            ...
            // Initialize URLs
            AddUrl = "SubaktivitasInputHasilPemeriksaanPipaAdd";
            ...
            MultiDeleteUrl = "SubaktivitasInputHasilPemeriksaanPipaDelete";
            MultiUpdateUrl = "SubaktivitasInputHasilPemeriksaanPipaUpdate";
        ...
        // Page name
        public string PageName => "SubaktivitasInputHasilPemeriksaanPipaList";
        ...
        // Constructor
        public SubaktivitasInputHasilPemeriksaanPipaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubaktivitasInputHasilPemeriksaanPipagrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subaktivitasInputHasilPemeriksaanPipaList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(QuantityDischarge.AdvancedSearch.ToJson())); // Field QuantityDischarge
        ...
        protected bool RestoreFilterList() {
            ...
            // Field QuantityDischarge
            if (filter?.TryGetValue("x_QuantityDischarge", out sv) ?? false) {
                QuantityDischarge.AdvancedSearch.SearchValue = sv;
                QuantityDischarge.AdvancedSearch.SearchOperator = filter["z_QuantityDischarge"];
                QuantityDischarge.AdvancedSearch.SearchCondition = filter["v_QuantityDischarge"];
                QuantityDischarge.AdvancedSearch.SearchValue2 = filter["y_QuantityDischarge"];
                QuantityDischarge.AdvancedSearch.SearchOperator2 = filter["w_QuantityDischarge"];
                QuantityDischarge.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(QuantityDischarge);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(QuantityDischarge, ctrl); // QuantityDischarge
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubaktivitasInputHasilPemeriksaanPipa"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubaktivitasInputHasilPemeriksaanPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasInputHasilPemeriksaanPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("QuantityDischarge")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubaktivitasInputHasilPemeriksaanPipasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubaktivitasInputHasilPemeriksaanPipasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasInputHasilPemeriksaanPipalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubaktivitasInputHasilPemeriksaanPipa");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subaktivitasInputHasilPemeriksaanPipaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subaktivitasInputHasilPemeriksaanPipaList.RowCount) + "_SubaktivitasInputHasilPemeriksaanPipa");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subaktivitasInputHasilPemeriksaanPipaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subaktivitasInputHasilPemeriksaanPipaList.RowType == RowType.Add || IsEdit && subaktivitasInputHasilPemeriksaanPipaList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                QuantityDischarge.TooltipValue = "";
