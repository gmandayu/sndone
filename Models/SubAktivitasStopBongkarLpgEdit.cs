...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasStopBongkarLpgEdit
    /// </summary>
    public static SubAktivitasStopBongkarLpgEdit subAktivitasStopBongkarLpgEdit
    {
        get => HttpData.Get<SubAktivitasStopBongkarLpgEdit>("subAktivitasStopBongkarLpgEdit")!;
        set => HttpData["subAktivitasStopBongkarLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasStopBongkarLPG
    /// </summary>
    public class SubAktivitasStopBongkarLpgEdit : SubAktivitasStopBongkarLpgEditBase
    {
        // Constructor
        public SubAktivitasStopBongkarLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasStopBongkarLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasStopBongkarLpgEditBase : SubAktivitasStopBongkarLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasStopBongkarLpgEdit";
        ...
        // Constructor
        public SubAktivitasStopBongkarLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasStopBongkarLpgEdit";
        ...
        // Constructor
        public SubAktivitasStopBongkarLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasStopBongkarLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasStopBongkarLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasStopBongkarLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasStopBongkarLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasStopBongkarLpgList")), "", TableVar, true);
            string pageId = "edit";
