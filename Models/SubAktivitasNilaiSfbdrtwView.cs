...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiSfbdrtwView
    /// </summary>
    public static SubAktivitasNilaiSfbdrtwView subAktivitasNilaiSfbdrtwView
    {
        get => HttpData.Get<SubAktivitasNilaiSfbdrtwView>("subAktivitasNilaiSfbdrtwView")!;
        set => HttpData["subAktivitasNilaiSfbdrtwView"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiSFBDRTW
    /// </summary>
    public class SubAktivitasNilaiSfbdrtwView : SubAktivitasNilaiSfbdrtwViewBase
    {
        // Constructor
        public SubAktivitasNilaiSfbdrtwView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiSfbdrtwView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiSfbdrtwViewBase : SubAktivitasNilaiSfbdrtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiSfbdrtwView";
        ...
        // Constructor
        public SubAktivitasNilaiSfbdrtwViewBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiSfbdrtwView";
        ...
        // Constructor
        public SubAktivitasNilaiSfbdrtwViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void PageRunEnd()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiSfbdrtwView?.PageRender();
            }
        }
