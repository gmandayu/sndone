...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasStopPembongkaranPenKonEdit
    /// </summary>
    public static SubAktivitasStopPembongkaranPenKonEdit subAktivitasStopPembongkaranPenKonEdit
    {
        get => HttpData.Get<SubAktivitasStopPembongkaranPenKonEdit>("subAktivitasStopPembongkaranPenKonEdit")!;
        set => HttpData["subAktivitasStopPembongkaranPenKonEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasStopPembongkaranPenKon
    /// </summary>
    public class SubAktivitasStopPembongkaranPenKonEdit : SubAktivitasStopPembongkaranPenKonEditBase
    {
        // Constructor
        public SubAktivitasStopPembongkaranPenKonEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasStopPembongkaranPenKonEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasStopPembongkaranPenKonEditBase : SubAktivitasStopPembongkaranPenKon
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasStopPembongkaranPenKonEdit";
        ...
        // Constructor
        public SubAktivitasStopPembongkaranPenKonEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasStopPembongkaranPenKonEdit";
        ...
        // Constructor
        public SubAktivitasStopPembongkaranPenKonEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasStopPembongkaranPenKonList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasStopPembongkaranPenKonList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasStopPembongkaranPenKonList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasStopPembongkaranPenKonEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasStopPembongkaranPenKonList")), "", TableVar, true);
            string pageId = "edit";
