...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static VAktifitas vAktifitas
    {
        get => HttpData.Resolve<VAktifitas>("v_aktifitas");
        set => HttpData["v_aktifitas"] = value;
    }

    /// <summary>
    /// Table class for v_aktifitas
    /// </summary>
    public class VAktifitas : DbTable
    {
        ...
        public VAktifitas()
        {
            ...
            Name = "v_aktifitas";
            Type = "VIEW";
            UpdateTable = "dbo.v_aktifitas"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdAktivitas = new(this, "x_IdAktivitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("v_aktifitas", "IdAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NamaAktivitas = new(this, "x_NamaAktivitas", 203, SqlDbType.NText) {
                ...
                CustomMessage = Language.FieldPhrase("v_aktifitas", "NamaAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            Nama_Proses = new(this, "x_Nama_Proses", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas", "Nama_Proses", "CustomMsg"),
                IsUpload = false
            };
            ...
            No_referensi = new(this, "x_No_referensi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas", "No_referensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            Shipment = new(this, "x_Shipment", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas", "Shipment", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdProses = new(this, "x_IdProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("v_aktifitas", "IdProses", "CustomMsg"),
                IsUpload = false
            };
            IdProses.Raw = true;
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.VAktifita type", "data");
            row = row.Where(kvp => {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "VAktifitasView" => Language.Phrase("View"),
                "VAktifitasEdit" => Language.Phrase("Edit"),
                "VAktifitasAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "VAktifitasView",
                Config.ApiAddAction => "VAktifitasAdd",
                Config.ApiEditAction => "VAktifitasEdit",
                Config.ApiDeleteAction => "VAktifitasDelete",
                Config.ApiListAction => "VAktifitasList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "VAktifitasList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("VAktifitasView", parm);
            else
                url = KeyUrl("VAktifitasView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "VAktifitasAdd";
        ...
        {
            string url = "";
            url = KeyUrl("VAktifitasEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("VAktifitasList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("VAktifitasAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("VAktifitasList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("VAktifitasDelete", parm)); // DN
        }
        ...
        {
            string pageName = "VAktifitasList";
        ...
        public async Task RenderEditRow()
        {
            ...
            NamaAktivitas.EditValue = NamaAktivitas.CurrentValue; // DN
