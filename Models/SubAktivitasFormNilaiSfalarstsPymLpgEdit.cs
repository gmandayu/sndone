...
public partial class SnDOne {
    ...
    public class SubAktivitasFormNilaiSfalarstsPymLpgEditBase : SubAktivitasFormNilaiSfalarstsPymLpg
    {
        ...
        // Constructor
        public SubAktivitasFormNilaiSfalarstsPymLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormNilaiSfalarstsPymLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormNilaiSfalarstsPymLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormNilaiSfalarstsPymLpgList") {
                                ...
                                returnUrl = "SubAktivitasFormNilaiSfalarstsPymLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
