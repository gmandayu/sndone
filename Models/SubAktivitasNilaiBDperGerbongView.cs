...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiBDperGerbongViewBase : SubAktivitasNilaiBDperGerbong
    {
        ...
        // Constructor
        public SubAktivitasNilaiBDperGerbongViewBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiBDperGerbongViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasNilaiBDperGerbongList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasNilaiBDperGerbongList"); // Return to list page
                            }
                        }
                    break;
            }
