...
public partial class SnDOne {
    ...
    public class VAktifitasWithDokumenEditBase : VAktifitasWithDokumen
    {
        ...
        // Constructor
        public VAktifitasWithDokumenEditBase()
        {
        ...
        // Constructor
        public VAktifitasWithDokumenEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("VAktifitasWithDokumenList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "VAktifitasWithDokumenList") {
                                ...
                                returnUrl = "VAktifitasWithDokumenList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
