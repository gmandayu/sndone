...
public partial class SnDOne {
    ...
    /// masterAreaDelete
    /// </summary>
    public static MasterAreaDelete masterAreaDelete
    {
        get => HttpData.Get<MasterAreaDelete>("masterAreaDelete")!;
        set => HttpData["masterAreaDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterArea
    /// </summary>
    public class MasterAreaDelete : MasterAreaDeleteBase
    {
        // Constructor
        public MasterAreaDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterAreaDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterAreaDeleteBase : MasterArea
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterAreaDelete";
        ...
        // Page name
        public string PageName => "MasterAreaDelete";
        ...
        // Constructor
        public MasterAreaDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterAreaList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterAreaList"); // Return to list
                }
            }
