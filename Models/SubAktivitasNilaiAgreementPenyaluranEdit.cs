...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiAgreementPenyaluranEdit
    /// </summary>
    public static SubAktivitasNilaiAgreementPenyaluranEdit subAktivitasNilaiAgreementPenyaluranEdit
    {
        get => HttpData.Get<SubAktivitasNilaiAgreementPenyaluranEdit>("subAktivitasNilaiAgreementPenyaluranEdit")!;
        set => HttpData["subAktivitasNilaiAgreementPenyaluranEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiAgreementPenyaluran
    /// </summary>
    public class SubAktivitasNilaiAgreementPenyaluranEdit : SubAktivitasNilaiAgreementPenyaluranEditBase
    {
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiAgreementPenyaluranEditBase : SubAktivitasNilaiAgreementPenyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiAgreementPenyaluranEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiAgreementPenyaluranEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiAgreementPenyaluranList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiAgreementPenyaluranList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiAgreementPenyaluranList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiAgreementPenyaluranEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiAgreementPenyaluranList")), "", TableVar, true);
            string pageId = "edit";
