...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasInputLogbookPenyaluranPipaBackupDelete
    /// </summary>
    public static SubaktivitasInputLogbookPenyaluranPipaBackupDelete subaktivitasInputLogbookPenyaluranPipaBackupDelete
    {
        get => HttpData.Get<SubaktivitasInputLogbookPenyaluranPipaBackupDelete>("subaktivitasInputLogbookPenyaluranPipaBackupDelete")!;
        set => HttpData["subaktivitasInputLogbookPenyaluranPipaBackupDelete"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasInputLogbookPenyaluranPipa_Backup
    /// </summary>
    public class SubaktivitasInputLogbookPenyaluranPipaBackupDelete : SubaktivitasInputLogbookPenyaluranPipaBackupDeleteBase
    {
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasInputLogbookPenyaluranPipaBackupDeleteBase : SubaktivitasInputLogbookPenyaluranPipaBackup
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasInputLogbookPenyaluranPipaBackupDelete";
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubaktivitasInputLogbookPenyaluranPipaBackupDelete";
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubaktivitasInputLogbookPenyaluranPipaBackupList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubaktivitasInputLogbookPenyaluranPipaBackupList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subaktivitasInputLogbookPenyaluranPipaBackupDelete?.PageRender();
            }
            return PageResult();
        }
