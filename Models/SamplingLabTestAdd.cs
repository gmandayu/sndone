...
public partial class SnDOne {
    ...
    public class SamplingLabTestAddBase : SamplingLabTest
    {
        ...
        // Constructor
        public SamplingLabTestAddBase(Controller? controller)
        {
        ...
        // Constructor
        public SamplingLabTestAddBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'LookupIdReferensi'
            LookupIdReferensi.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(LookupIdReferensi, "LookupIdReferensi", "x_LookupIdReferensi");
        ...
        private void ValidateCustomLookupIdReferensi() {
            if (LookupIdReferensi.Visible && LookupIdReferensi.Required) {
                if (!LookupIdReferensi.IsDetailKey && Empty(LookupIdReferensi.FormValue)) {
                    LookupIdReferensi.AddErrorMessage(ConvertToString(LookupJenisPlant.RequiredErrorMessage).Replace("%s", LookupJenisPlant.Caption));
                }
            }
        }
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ...
                ValidateCustomLookupIdReferensi();
