...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasStopBongkarStsPnrBbmEdit
    /// </summary>
    public static SubaktivitasStopBongkarStsPnrBbmEdit subaktivitasStopBongkarStsPnrBbmEdit
    {
        get => HttpData.Get<SubaktivitasStopBongkarStsPnrBbmEdit>("subaktivitasStopBongkarStsPnrBbmEdit")!;
        set => HttpData["subaktivitasStopBongkarStsPnrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasStopBongkarSTSPnrBBM
    /// </summary>
    public class SubaktivitasStopBongkarStsPnrBbmEdit : SubaktivitasStopBongkarStsPnrBbmEditBase
    {
        // Constructor
        public SubaktivitasStopBongkarStsPnrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasStopBongkarStsPnrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasStopBongkarStsPnrBbmEditBase : SubaktivitasStopBongkarStsPnrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasStopBongkarStsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasStopBongkarStsPnrBbmEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasStopBongkarStsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasStopBongkarStsPnrBbmEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasStopBongkarStsPnrBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasStopBongkarStsPnrBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasStopBongkarStsPnrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasStopBongkarStsPnrBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasStopBongkarStsPnrBbmList")), "", TableVar, true);
            string pageId = "edit";
