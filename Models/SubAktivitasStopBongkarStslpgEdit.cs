...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasStopBongkarStslpgEdit
    /// </summary>
    public static SubAktivitasStopBongkarStslpgEdit subAktivitasStopBongkarStslpgEdit
    {
        get => HttpData.Get<SubAktivitasStopBongkarStslpgEdit>("subAktivitasStopBongkarStslpgEdit")!;
        set => HttpData["subAktivitasStopBongkarStslpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasStopBongkarSTSLPG
    /// </summary>
    public class SubAktivitasStopBongkarStslpgEdit : SubAktivitasStopBongkarStslpgEditBase
    {
        // Constructor
        public SubAktivitasStopBongkarStslpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasStopBongkarStslpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasStopBongkarStslpgEditBase : SubAktivitasStopBongkarStslpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasStopBongkarStslpgEdit";
        ...
        // Constructor
        public SubAktivitasStopBongkarStslpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasStopBongkarStslpgEdit";
        ...
        // Constructor
        public SubAktivitasStopBongkarStslpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasStopBongkarStslpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasStopBongkarStslpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasStopBongkarStslpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasStopBongkarStslpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasStopBongkarStslpgList")), "", TableVar, true);
            string pageId = "edit";
