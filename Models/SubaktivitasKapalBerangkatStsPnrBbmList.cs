...
public partial class SnDOne {
    ...
    public class SubaktivitasKapalBerangkatStsPnrBbmListBase : SubaktivitasKapalBerangkatStsPnrBbm
    {
        ...
        // Constructor
        public SubaktivitasKapalBerangkatStsPnrBbmListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubaktivitasKapalBerangkatStsPnrBbmListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field tglBerangkat
            if (filter.TryGetValue("x_tglBerangkat", out sv)) {
                RestoreFieldFilter(tglBerangkat, filter, "tglBerangkat", sv);
            }
