...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiAgreementEdit
    /// </summary>
    public static SubaktivitasNilaiAgreementEdit subaktivitasNilaiAgreementEdit
    {
        get => HttpData.Get<SubaktivitasNilaiAgreementEdit>("subaktivitasNilaiAgreementEdit")!;
        set => HttpData["subaktivitasNilaiAgreementEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasNilaiAgreement
    /// </summary>
    public class SubaktivitasNilaiAgreementEdit : SubaktivitasNilaiAgreementEditBase
    {
        // Constructor
        public SubaktivitasNilaiAgreementEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasNilaiAgreementEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasNilaiAgreementEditBase : SubaktivitasNilaiAgreement
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasNilaiAgreementEdit";
        ...
        // Constructor
        public SubaktivitasNilaiAgreementEditBase(Controller? controller)
        {
            TableName = "SubaktivitasNilaiAgreement";
        ...
        if (controller != null)
            ...
            // Table object (subaktivitasNilaiAgreement)
            if (subaktivitasNilaiAgreement == null || subaktivitasNilaiAgreement is SubaktivitasNilaiAgreement)
                subaktivitasNilaiAgreement = this;
        ...
        // Page name
        public string PageName => "SubaktivitasNilaiAgreementEdit";
        ...
        // Constructor
        public SubaktivitasNilaiAgreementEditBase() : this(null) { }
            ...
            string pageName = GetPageName(url);
                ...
                // List / View / Master View page
                    if (!SameString(pageName, ListUrl))
                    {
                        ...
                        result.Add("view", pageName == "SubaktivitasNilaiAgreementView" ? "1" : "0"); // If View page, no primary button
                    }
                    else
                    {
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasNilaiAgreementList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasNilaiAgreementList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasNilaiAgreementList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasNilaiAgreementEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasNilaiAgreementList")), "", TableVar, true);
            string pageId = "edit";
