...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasHasilPemeriksaanStsPnrBbmEdit
    /// </summary>
    public static SubaktivitasHasilPemeriksaanStsPnrBbmEdit subaktivitasHasilPemeriksaanStsPnrBbmEdit
    {
        get => HttpData.Get<SubaktivitasHasilPemeriksaanStsPnrBbmEdit>("subaktivitasHasilPemeriksaanStsPnrBbmEdit")!;
        set => HttpData["subaktivitasHasilPemeriksaanStsPnrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasHasilPemeriksaanSTSPnrBBM
    /// </summary>
    public class SubaktivitasHasilPemeriksaanStsPnrBbmEdit : SubaktivitasHasilPemeriksaanStsPnrBbmEditBase
    {
        // Constructor
        public SubaktivitasHasilPemeriksaanStsPnrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasHasilPemeriksaanStsPnrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasHasilPemeriksaanStsPnrBbmEditBase : SubaktivitasHasilPemeriksaanStsPnrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasHasilPemeriksaanStsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanStsPnrBbmEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasHasilPemeriksaanStsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanStsPnrBbmEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasHasilPemeriksaanStsPnrBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasHasilPemeriksaanStsPnrBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasHasilPemeriksaanStsPnrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasHasilPemeriksaanStsPnrBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void ValidateCustomNamaKapal() {
            if (NamaKapal.Visible && NamaKapal.Required) {
                if (!NamaKapal.IsDetailKey && Empty(NamaKapal.FormValue)) {
                    NamaKapal.AddErrorMessage(ConvertToString(IsQualityActive.RequiredErrorMessage).Replace("%s", IsQualityActive.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasHasilPemeriksaanStsPnrBbmList")), "", TableVar, true);
            string pageId = "edit";
