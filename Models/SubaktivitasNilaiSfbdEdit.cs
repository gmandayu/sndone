...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiSfbdEdit
    /// </summary>
    public static SubaktivitasNilaiSfbdEdit subaktivitasNilaiSfbdEdit
    {
        get => HttpData.Get<SubaktivitasNilaiSfbdEdit>("subaktivitasNilaiSfbdEdit")!;
        set => HttpData["subaktivitasNilaiSfbdEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasNilaiSFBD
    /// </summary>
    public class SubaktivitasNilaiSfbdEdit : SubaktivitasNilaiSfbdEditBase
    {
        // Constructor
        public SubaktivitasNilaiSfbdEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasNilaiSfbdEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasNilaiSfbdEditBase : SubaktivitasNilaiSfbd
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasNilaiSfbdEdit";
        ...
        // Constructor
        public SubaktivitasNilaiSfbdEditBase(Controller? controller)
        {
            TableName = "SubaktivitasNilaiSFBD";
        ...
        if (controller != null)
            ...
            // Table object (subaktivitasNilaiSfbd)
            if (subaktivitasNilaiSfbd == null || subaktivitasNilaiSfbd is SubaktivitasNilaiSfbd)
                subaktivitasNilaiSfbd = this;
        ...
        // Page name
        public string PageName => "SubaktivitasNilaiSfbdEdit";
        ...
        // Constructor
        public SubaktivitasNilaiSfbdEditBase() : this(null) { }
            ...
            string pageName = GetPageName(url);
                ...
                // List / View / Master View page
                    if (!SameString(pageName, ListUrl))
                    {
                        ...
                        result.Add("view", pageName == "SubaktivitasNilaiSfbdView" ? "1" : "0"); // If View page, no primary button
                    }
                    else
                    {
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasNilaiSfbdList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasNilaiSfbdList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasNilaiSfbdList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasNilaiSfbdEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void ValidateCustomklobs() {
            if (klobs.Visible && klobs.Required) {
                if (!klobs.IsDetailKey && Empty(klobs.FormValue)) {
                    klobs.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustomkl15() {
            if (kl15.Visible && kl15.Required) {
                if (!kl15.IsDetailKey && Empty(kl15.FormValue)) {
                    kl15.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustombarrels() {
            if (barrels.Visible && barrels.Required) {
                if (!barrels.IsDetailKey && Empty(barrels.FormValue)) {
                    barrels.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustomlt() {
            if (lt.Visible && lt.Required) {
                if (!lt.IsDetailKey && Empty(lt.FormValue)) {
                    lt.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        private void ValidateCustommt() {
            if (mt.Visible && mt.Required) {
                if (!mt.IsDetailKey && Empty(mt.FormValue)) {
                    mt.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasNilaiSfbdList")), "", TableVar, true);
            string pageId = "edit";
