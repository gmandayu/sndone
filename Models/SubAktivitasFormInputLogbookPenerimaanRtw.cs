...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbookPenerimaanRtw
    /// </summary>
    [MaybeNull]
    public static SubAktivitasFormInputLogbookPenerimaanRtw subAktivitasFormInputLogbookPenerimaanRtw
    {
        get => HttpData.Resolve<SubAktivitasFormInputLogbookPenerimaanRtw>("SubAktivitasFormInputLogbookPenerimaanRTW");
        set => HttpData["SubAktivitasFormInputLogbookPenerimaanRTW"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasFormInputLogbookPenerimaanRTW
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanRtw : DbTable
    {
        ...
        public readonly DbField<SqlDbType> SubAktivitasFormInputHslPemeriksaanRTWId;
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtw()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasFormInputLogbookPenerimaanRTW";
            Name = "SubAktivitasFormInputLogbookPenerimaanRTW";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasFormInputLogbookPenerimaanRTW"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            ...
            NamaKegiatan = new(this, "x_NamaKegiatan", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "NamaKegiatan", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            Density = new(this, "x_Density", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "Density", "CustomMsg"),
                IsUpload = false
            };
            ...
            Temperature = new(this, "x_Temperature", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "Temperature", "CustomMsg"),
                IsUpload = false
            };
            ...
            Keterangan = new(this, "x_Keterangan", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            ...
            Level = new(this, "x_Level", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "Level", "CustomMsg"),
                IsUpload = false
            };
            ...
            Volume = new(this, "x_Volume", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "Volume", "CustomMsg"),
                IsUpload = false
            };
            ...
            Flowrate = new(this, "x_Flowrate", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "Flowrate", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NoReferensi", NoReferensi);

            // SubAktivitasFormInputHslPemeriksaanRTWId
            SubAktivitasFormInputHslPemeriksaanRTWId = new(this, "x_SubAktivitasFormInputHslPemeriksaanRTWId", 3, SqlDbType.Int) {
                Name = "SubAktivitasFormInputHslPemeriksaanRTWId",
                Expression = "[SubAktivitasFormInputHslPemeriksaanRTWId]",
                BasicSearchExpression = "CAST([SubAktivitasFormInputHslPemeriksaanRTWId] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[SubAktivitasFormInputHslPemeriksaanRTWId]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "SubAktivitasFormInputHslPemeriksaanRTWId", "CustomMsg"),
                IsUpload = false
            };
            SubAktivitasFormInputHslPemeriksaanRTWId.Raw = true;
            Fields.Add("SubAktivitasFormInputHslPemeriksaanRTWId", SubAktivitasFormInputHslPemeriksaanRTWId);
            ...
            TanggalJamSOP = new(this, "x_TanggalJamSOP", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "TanggalJamSOP", "CustomMsg"),
                IsUpload = false
            };
            ...
            SelisihWaktu = new(this, "x_SelisihWaktu", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "SelisihWaktu", "CustomMsg"),
                IsUpload = false
            };
            ...
            IsQualityActive = new(this, "x_IsQualityActive", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputLogbookPenerimaanRTW", "IsQualityActive", "CustomMsg"),
                IsUpload = false
            };
            IsQualityActive.Raw = true;
            IsQualityActive.Lookup = new Lookup<DbField>(IsQualityActive, "SubAktivitasFormInputLogbookPenerimaanRTW", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasFormInputLogbookPenerimaanRTW";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasFormInputLogbookPenerimaanRtw type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                SubAktivitasFormInputHslPemeriksaanRTWId.DbValue = row["SubAktivitasFormInputHslPemeriksaanRTWId"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasFormInputLogbookPenerimaanRtwList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasFormInputLogbookPenerimaanRtwView" => Language.Phrase("View"),
                "SubAktivitasFormInputLogbookPenerimaanRtwEdit" => Language.Phrase("Edit"),
                "SubAktivitasFormInputLogbookPenerimaanRtwAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasFormInputLogbookPenerimaanRtwView",
                Config.ApiAddAction => "SubAktivitasFormInputLogbookPenerimaanRtwAdd",
                Config.ApiEditAction => "SubAktivitasFormInputLogbookPenerimaanRtwEdit",
                Config.ApiDeleteAction => "SubAktivitasFormInputLogbookPenerimaanRtwDelete",
                Config.ApiListAction => "SubAktivitasFormInputLogbookPenerimaanRtwList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasFormInputLogbookPenerimaanRtwList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasFormInputLogbookPenerimaanRtwView", parm);
            else
                url = KeyUrl("SubAktivitasFormInputLogbookPenerimaanRtwView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasFormInputLogbookPenerimaanRtwAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasFormInputLogbookPenerimaanRtwAdd?" + parm;
            else
                url = "SubAktivitasFormInputLogbookPenerimaanRtwAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputLogbookPenerimaanRtwEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputLogbookPenerimaanRtwList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputLogbookPenerimaanRtwAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputLogbookPenerimaanRtwList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasFormInputLogbookPenerimaanRtwDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasFormInputLogbookPenerimaanRtwList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // SubAktivitasFormInputHslPemeriksaanRTWId
            SubAktivitasFormInputHslPemeriksaanRTWId.SetupEditAttributes();
            SubAktivitasFormInputHslPemeriksaanRTWId.EditValue = SubAktivitasFormInputHslPemeriksaanRTWId.CurrentValue;
            SubAktivitasFormInputHslPemeriksaanRTWId.PlaceHolder = RemoveHtml(SubAktivitasFormInputHslPemeriksaanRTWId.Caption);
            if (!Empty(SubAktivitasFormInputHslPemeriksaanRTWId.EditValue) && IsNumeric(SubAktivitasFormInputHslPemeriksaanRTWId.EditValue))
                SubAktivitasFormInputHslPemeriksaanRTWId.EditValue = FormatNumber(SubAktivitasFormInputHslPemeriksaanRTWId.EditValue, null);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(SubAktivitasFormInputHslPemeriksaanRTWId);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(SubAktivitasFormInputHslPemeriksaanRTWId);
