...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLaporanStockStscsbbm
    /// </summary>
    [MaybeNull]
    public static SubAktivitasLaporanStockStscsbbm subAktivitasLaporanStockStscsbbm
    {
        get => HttpData.Resolve<SubAktivitasLaporanStockStscsbbm>("SubAktivitasLaporanStockSTSCSBBM");
        set => HttpData["SubAktivitasLaporanStockSTSCSBBM"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasLaporanStockSTSCSBBM
    /// </summary>
    public class SubAktivitasLaporanStockStscsbbm : DbTable
    {
        ...
        public readonly DbField<SqlDbType> StockAwal;

        public readonly DbField<SqlDbType> Penerimaan2;

        public readonly DbField<SqlDbType> Penyaluran2;

        public readonly DbField<SqlDbType> StockAkhir;

        public readonly DbField<SqlDbType> WorkingLoss;

        public readonly DbField<SqlDbType> Presentase;

        public readonly DbField<SqlDbType> userInput;

        public readonly DbField<SqlDbType> etlDate;

        public readonly DbField<SqlDbType> Tangki;

        public readonly DbField<SqlDbType> Produk;

        // Constructor
        public SubAktivitasLaporanStockStscsbbm()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasLaporanStockSTSCSBBM";
            Name = "SubAktivitasLaporanStockSTSCSBBM";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasLaporanStockSTSCSBBM"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            // StockAwal
            StockAwal = new(this, "x_StockAwal", 202, SqlDbType.NVarChar) {
                Name = "StockAwal",
                Expression = "[StockAwal]",
                UseBasicSearch = true,
                BasicSearchExpression = "[StockAwal]",
                DateTimeFormat = -1,
                VirtualExpression = "[StockAwal]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "StockAwal", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("StockAwal", StockAwal);

            // Penerimaan
            Penerimaan2 = new(this, "x_Penerimaan2", 202, SqlDbType.NVarChar) {
                Name = "Penerimaan",
                Expression = "[Penerimaan]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Penerimaan]",
                DateTimeFormat = -1,
                VirtualExpression = "[Penerimaan]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "Penerimaan2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Penerimaan", Penerimaan2);

            // Penyaluran
            Penyaluran2 = new(this, "x_Penyaluran2", 202, SqlDbType.NVarChar) {
                Name = "Penyaluran",
                Expression = "[Penyaluran]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Penyaluran]",
                DateTimeFormat = -1,
                VirtualExpression = "[Penyaluran]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "Penyaluran2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Penyaluran", Penyaluran2);

            // StockAkhir
            StockAkhir = new(this, "x_StockAkhir", 202, SqlDbType.NVarChar) {
                Name = "StockAkhir",
                Expression = "[StockAkhir]",
                UseBasicSearch = true,
                BasicSearchExpression = "[StockAkhir]",
                DateTimeFormat = -1,
                VirtualExpression = "[StockAkhir]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "StockAkhir", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("StockAkhir", StockAkhir);

            // WorkingLoss
            WorkingLoss = new(this, "x_WorkingLoss", 202, SqlDbType.NVarChar) {
                Name = "WorkingLoss",
                Expression = "[WorkingLoss]",
                UseBasicSearch = true,
                BasicSearchExpression = "[WorkingLoss]",
                DateTimeFormat = -1,
                VirtualExpression = "[WorkingLoss]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "WorkingLoss", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("WorkingLoss", WorkingLoss);

            // Presentase
            Presentase = new(this, "x_Presentase", 202, SqlDbType.NVarChar) {
                Name = "Presentase",
                Expression = "[Presentase]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Presentase]",
                DateTimeFormat = -1,
                VirtualExpression = "[Presentase]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "Presentase", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Presentase", Presentase);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            // Tangki
            Tangki = new(this, "x_Tangki", 202, SqlDbType.NVarChar) {
                Name = "Tangki",
                Expression = "[Tangki]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Tangki]",
                DateTimeFormat = -1,
                VirtualExpression = "[Tangki]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "Tangki", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Tangki", Tangki);
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasLaporanStockSTSCSBBM", "Produk", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasLaporanStockSTSCSBBM";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasLaporanStockStscsbbm type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                StockAwal.DbValue = row["StockAwal"]; // Set DB value only
                Penerimaan2.DbValue = row["Penerimaan"]; // Set DB value only
                Penyaluran2.DbValue = row["Penyaluran"]; // Set DB value only
                StockAkhir.DbValue = row["StockAkhir"]; // Set DB value only
                WorkingLoss.DbValue = row["WorkingLoss"]; // Set DB value only
                Presentase.DbValue = row["Presentase"]; // Set DB value only
                userInput.DbValue = row["userInput"]; // Set DB value only
                etlDate.DbValue = row["etlDate"]; // Set DB value only
                Tangki.DbValue = row["Tangki"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasLaporanStockStscsbbmList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasLaporanStockStscsbbmView" => Language.Phrase("View"),
                "SubAktivitasLaporanStockStscsbbmEdit" => Language.Phrase("Edit"),
                "SubAktivitasLaporanStockStscsbbmAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasLaporanStockStscsbbmView",
                Config.ApiAddAction => "SubAktivitasLaporanStockStscsbbmAdd",
                Config.ApiEditAction => "SubAktivitasLaporanStockStscsbbmEdit",
                Config.ApiDeleteAction => "SubAktivitasLaporanStockStscsbbmDelete",
                Config.ApiListAction => "SubAktivitasLaporanStockStscsbbmList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasLaporanStockStscsbbmList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasLaporanStockStscsbbmView", parm);
            else
                url = KeyUrl("SubAktivitasLaporanStockStscsbbmView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasLaporanStockStscsbbmAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasLaporanStockStscsbbmAdd?" + parm;
            else
                url = "SubAktivitasLaporanStockStscsbbmAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLaporanStockStscsbbmEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLaporanStockStscsbbmList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasLaporanStockStscsbbmAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasLaporanStockStscsbbmList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasLaporanStockStscsbbmDelete", parm)); // DN
        }
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            ...
            StockAwal.SetDbValue(row["StockAwal"]);
            Penerimaan2.SetDbValue(row["Penerimaan"]);
            Penyaluran2.SetDbValue(row["Penyaluran"]);
            StockAkhir.SetDbValue(row["StockAkhir"]);
            WorkingLoss.SetDbValue(row["WorkingLoss"]);
            Presentase.SetDbValue(row["Presentase"]);
            userInput.SetDbValue(row["userInput"]);
            etlDate.SetDbValue(row["etlDate"]);
            Tangki.SetDbValue(row["Tangki"]);
        ...
        {
            string pageName = "SubAktivitasLaporanStockStscsbbmList";
        ...
        public async Task RenderListRow()
        {
            ...
            // StockAwal
            StockAwal.ViewValue = ConvertToString(StockAwal.CurrentValue); // DN
            StockAwal.ViewCustomAttributes = "";

            // Penerimaan
            Penerimaan2.ViewValue = ConvertToString(Penerimaan2.CurrentValue); // DN
            Penerimaan2.ViewCustomAttributes = "";

            // Penyaluran
            Penyaluran2.ViewValue = ConvertToString(Penyaluran2.CurrentValue); // DN
            Penyaluran2.ViewCustomAttributes = "";

            // StockAkhir
            StockAkhir.ViewValue = ConvertToString(StockAkhir.CurrentValue); // DN
            StockAkhir.ViewCustomAttributes = "";

            // WorkingLoss
            WorkingLoss.ViewValue = ConvertToString(WorkingLoss.CurrentValue); // DN
            WorkingLoss.ViewCustomAttributes = "";

            // Presentase
            Presentase.ViewValue = ConvertToString(Presentase.CurrentValue); // DN
            Presentase.ViewCustomAttributes = "";
            ...
            // Tangki
            Tangki.ViewValue = ConvertToString(Tangki.CurrentValue); // DN
            Tangki.ViewCustomAttributes = "";
            ...
            // StockAwal
            StockAwal.HrefValue = "";
            StockAwal.TooltipValue = "";

            // Penerimaan
            Penerimaan2.HrefValue = "";
            Penerimaan2.TooltipValue = "";

            // Penyaluran
            Penyaluran2.HrefValue = "";
            Penyaluran2.TooltipValue = "";

            // StockAkhir
            StockAkhir.HrefValue = "";
            StockAkhir.TooltipValue = "";

            // WorkingLoss
            WorkingLoss.HrefValue = "";
            WorkingLoss.TooltipValue = "";

            // Presentase
            Presentase.HrefValue = "";
            Presentase.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // StockAwal
            StockAwal.SetupEditAttributes();
            if (!StockAwal.Raw)
                StockAwal.CurrentValue = HtmlDecode(StockAwal.CurrentValue);
            StockAwal.EditValue = StockAwal.CurrentValue;
            StockAwal.PlaceHolder = RemoveHtml(StockAwal.Caption);

            // Penerimaan
            Penerimaan2.SetupEditAttributes();
            if (!Penerimaan2.Raw)
                Penerimaan2.CurrentValue = HtmlDecode(Penerimaan2.CurrentValue);
            Penerimaan2.EditValue = Penerimaan2.CurrentValue;
            Penerimaan2.PlaceHolder = RemoveHtml(Penerimaan2.Caption);

            // Penyaluran
            Penyaluran2.SetupEditAttributes();
            if (!Penyaluran2.Raw)
                Penyaluran2.CurrentValue = HtmlDecode(Penyaluran2.CurrentValue);
            Penyaluran2.EditValue = Penyaluran2.CurrentValue;
            Penyaluran2.PlaceHolder = RemoveHtml(Penyaluran2.Caption);

            // StockAkhir
            StockAkhir.SetupEditAttributes();
            if (!StockAkhir.Raw)
                StockAkhir.CurrentValue = HtmlDecode(StockAkhir.CurrentValue);
            StockAkhir.EditValue = StockAkhir.CurrentValue;
            StockAkhir.PlaceHolder = RemoveHtml(StockAkhir.Caption);

            // WorkingLoss
            WorkingLoss.SetupEditAttributes();
            WorkingLoss.EditValue = ConvertToString(WorkingLoss.CurrentValue); // DN
            WorkingLoss.ViewCustomAttributes = "";

            // Presentase
            Presentase.SetupEditAttributes();
            Presentase.EditValue = ConvertToString(Presentase.CurrentValue); // DN
            Presentase.ViewCustomAttributes = "";
            ...
            // Tangki
            Tangki.SetupEditAttributes();
            if (!Tangki.Raw)
                Tangki.CurrentValue = HtmlDecode(Tangki.CurrentValue);
            Tangki.EditValue = Tangki.CurrentValue;
            Tangki.PlaceHolder = RemoveHtml(Tangki.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(StockAwal);
                        doc.ExportCaption(Penerimaan2);
                        doc.ExportCaption(Penyaluran2);
                        doc.ExportCaption(StockAkhir);
                        doc.ExportCaption(WorkingLoss);
                        doc.ExportCaption(Presentase);
                        doc.ExportCaption(userInput);
                        doc.ExportCaption(etlDate);
                        doc.ExportCaption(Tangki);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(StockAwal);
                            await doc.ExportField(Penerimaan2);
                            await doc.ExportField(Penyaluran2);
                            await doc.ExportField(StockAkhir);
                            await doc.ExportField(WorkingLoss);
                            await doc.ExportField(Presentase);
                            await doc.ExportField(userInput);
                            await doc.ExportField(etlDate);
                            await doc.ExportField(Tangki);
        ...
        // Row Updating event untuk SubAktivitasLaporanStockSTSCSBBM
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew)
        {
            try {
                ...
                if (!string.IsNullOrWhiteSpace(noReferensi)) {
                    var plantTimeObj = ExecuteScalar($"EXEC dbo.GetPlantDateTime @NomorReferensi = '{noReferensi}'");
                ...
                double stockAwal  = Convert.ToDouble(rsnew["StockAwal"]  ?? 0);
                double penerimaan = Convert.ToDouble(rsnew["Penerimaan"] ?? 0);
                double penyaluran = Convert.ToDouble(rsnew["Penyaluran"] ?? 0);
                double stockAkhir = Convert.ToDouble(rsnew["StockAkhir"] ?? 0);
                double workingLoss = stockAkhir - (stockAwal + penerimaan - penyaluran);
                double persentase  = (stockAwal + penerimaan) != 0 
                                     ? workingLoss / (stockAwal + penerimaan) * 100 
                                     : 0;
                rsnew["WorkingLoss"] = workingLoss.ToString("F2");
                rsnew["Presentase"]  = persentase.ToString("F2") + "%";
            }
            catch (Exception ex) {
                Log("Error in Row_Updating (SubAktivitasLaporanStockSTSCSBBM): " + ex.Message);
