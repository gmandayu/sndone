...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasKeberangkatanKapalPenKonEdit
    /// </summary>
    public static SubAktivitasKeberangkatanKapalPenKonEdit subAktivitasKeberangkatanKapalPenKonEdit
    {
        get => HttpData.Get<SubAktivitasKeberangkatanKapalPenKonEdit>("subAktivitasKeberangkatanKapalPenKonEdit")!;
        set => HttpData["subAktivitasKeberangkatanKapalPenKonEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasKeberangkatanKapalPenKon
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenKonEdit : SubAktivitasKeberangkatanKapalPenKonEditBase
    {
        // Constructor
        public SubAktivitasKeberangkatanKapalPenKonEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasKeberangkatanKapalPenKonEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenKonEditBase : SubAktivitasKeberangkatanKapalPenKon
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasKeberangkatanKapalPenKonEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenKonEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasKeberangkatanKapalPenKonEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenKonEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasKeberangkatanKapalPenKonList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanKapalPenKonList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasKeberangkatanKapalPenKonList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasKeberangkatanKapalPenKonEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasKeberangkatanKapalPenKonList")), "", TableVar, true);
            string pageId = "edit";
