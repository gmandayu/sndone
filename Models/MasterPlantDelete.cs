...
public partial class SnDOne {
    ...
    /// masterPlantDelete
    /// </summary>
    public static MasterPlantDelete masterPlantDelete
    {
        get => HttpData.Get<MasterPlantDelete>("masterPlantDelete")!;
        set => HttpData["masterPlantDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterPlant
    /// </summary>
    public class MasterPlantDelete : MasterPlantDeleteBase
    {
        // Constructor
        public MasterPlantDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterPlantDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterPlantDeleteBase : MasterPlant
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterPlantDelete";
        ...
        // Page name
        public string PageName => "MasterPlantDelete";
        ...
        // Constructor
        public MasterPlantDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterPlantList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterPlantList"); // Return to list
                }
            }
