...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputDataMobilTangkiListBase : SubAktivitasFormInputDataMobilTangki
    {
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field NomorPolisi
            if (filter.TryGetValue("x_NomorPolisi", out sv)) {
                RestoreFieldFilter(NomorPolisi, filter, "NomorPolisi", sv);
            }
