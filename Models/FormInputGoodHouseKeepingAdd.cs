...
public partial class SnDOne {
    /// <summary>
    /// formInputGoodHouseKeepingAdd
    /// </summary>
    public static FormInputGoodHouseKeepingAdd formInputGoodHouseKeepingAdd
    {
        get => HttpData.Get<FormInputGoodHouseKeepingAdd>("formInputGoodHouseKeepingAdd")!;
        set => HttpData["formInputGoodHouseKeepingAdd"] = value;
    }

    /// <summary>
    /// Page class for FormInputGoodHouseKeeping
    /// </summary>
    public class FormInputGoodHouseKeepingAdd : FormInputGoodHouseKeepingAddBase
    {
        // Constructor
        public FormInputGoodHouseKeepingAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public FormInputGoodHouseKeepingAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class FormInputGoodHouseKeepingAddBase : FormInputGoodHouseKeeping
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "formInputGoodHouseKeepingAdd";
        ...
        // Constructor
        public FormInputGoodHouseKeepingAddBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "FormInputGoodHouseKeepingAdd";
        ...
        // Constructor
        public FormInputGoodHouseKeepingAddBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private IActionResult? HandleCopyAction(Dictionary<string, object>? rsold)
        {
            if (rsold == null) {
                ...
                return Terminate("FormInputGoodHouseKeepingList");
            }
            return null;
        }
        ...
        private string DetermineReturnUrl()
        {
            string returnUrl = "";
            returnUrl = ReturnUrl;
            if (GetPageName(returnUrl) == "FormInputGoodHouseKeepingList")
                returnUrl = AddMasterUrl(ListUrl);
            else if (GetPageName(returnUrl) == "FormInputGoodHouseKeepingView")
                returnUrl = ViewUrl;
            return returnUrl;
        }
        ...
        private void HandleAjaxActions(ref string returnUrl)
        {
            if (IsModal && UseAjaxActions) {
                ...
                if (GetPageName(returnUrl) != "FormInputGoodHouseKeepingList") {
                    ...
                    returnUrl = "FormInputGoodHouseKeepingList";
                }
            }
        }
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        formInputGoodHouseKeepingAdd?.PageRender();
                    }
        }
        ...
        private void ValidateCustomtgltiba() {
            if (tgltiba.Visible && tgltiba.Required) {
                if (!tgltiba.IsDetailKey && Empty(tgltiba.FormValue)) {
                    tgltiba.AddErrorMessage(ConvertToString(Keterangan.RequiredErrorMessage).Replace("%s", Keterangan.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLokasi() {
            if (Lokasi.Visible && Lokasi.Required) {
                if (!Lokasi.IsDetailKey && Empty(Lokasi.FormValue)) {
                    Lokasi.AddErrorMessage(ConvertToString(Keterangan.RequiredErrorMessage).Replace("%s", Keterangan.Caption));
                }
            }
        }
        ...
        protected Dictionary<string, object> GetAddRow()
        {
            try {
                ...
                // tgltiba
                tgltiba.SetDbValue(rsnew, ConvertToDateTime(tgltiba.CurrentValue, tgltiba.FormatPattern));
        ...
        private void RestoreAddFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("tgltiba", out value)) // tgltiba
                tgltiba.SetFormValue(ConvertToString(value));
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("FormInputGoodHouseKeepingList")), "", TableVar, true);
