...
public partial class SnDOne {
    ...
    /// proofOfVisitDelete
    /// </summary>
    public static ProofOfVisitDelete proofOfVisitDelete
    {
        get => HttpData.Get<ProofOfVisitDelete>("proofOfVisitDelete")!;
        set => HttpData["proofOfVisitDelete"] = value;
    }

    /// <summary>
    /// Page class for ProofOfVisit
    /// </summary>
    public class ProofOfVisitDelete : ProofOfVisitDeleteBase
    {
        // Constructor
        public ProofOfVisitDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ProofOfVisitDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ProofOfVisitDeleteBase : ProofOfVisit
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "proofOfVisitDelete";
        ...
        // Page name
        public string PageName => "ProofOfVisitDelete";
        ...
        // Constructor
        public ProofOfVisitDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("ProofOfVisitList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("ProofOfVisitList"); // Return to list
                }
            }
