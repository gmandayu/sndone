...
public partial class SnDOne {
    /// <summary>
    /// penimbunanPenyaluranDelete
    /// </summary>
    public static PenimbunanPenyaluranDelete penimbunanPenyaluranDelete
    {
        get => HttpData.Get<PenimbunanPenyaluranDelete>("penimbunanPenyaluranDelete")!;
        set => HttpData["penimbunanPenyaluranDelete"] = value;
    }

    /// <summary>
    /// Page class for PenimbunanPenyaluran
    /// </summary>
    public class PenimbunanPenyaluranDelete : PenimbunanPenyaluranDeleteBase
    {
        // Constructor
        public PenimbunanPenyaluranDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenimbunanPenyaluranDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PenimbunanPenyaluranDeleteBase : PenimbunanPenyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penimbunanPenyaluranDelete";
        ...
        // Constructor
        public PenimbunanPenyaluranDeleteBase()
        {
        ...
        // Page name
        public string PageName => "PenimbunanPenyaluranDelete";
        ...
        // Constructor
        public PenimbunanPenyaluranDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("PenimbunanPenyaluranList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("PenimbunanPenyaluranList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                penimbunanPenyaluranDelete?.PageRender();
            }
            return PageResult();
        }
