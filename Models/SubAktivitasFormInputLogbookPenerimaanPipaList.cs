...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbookPenerimaanPipaList
    /// </summary>
    public static SubAktivitasFormInputLogbookPenerimaanPipaList subAktivitasFormInputLogbookPenerimaanPipaList
    {
        get => HttpData.Get<SubAktivitasFormInputLogbookPenerimaanPipaList>("subAktivitasFormInputLogbookPenerimaanPipaList")!;
        set => HttpData["subAktivitasFormInputLogbookPenerimaanPipaList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbookPenerimaanPipa
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanPipaList : SubAktivitasFormInputLogbookPenerimaanPipaListBase
    {
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanPipaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanPipaList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanPipaListBase : SubAktivitasFormInputLogbookPenerimaanPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbookPenerimaanPipaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasFormInputLogbookPenerimaanPipalist";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanPipaListBase()
        {
            TableName = "SubAktivitasFormInputLogbookPenerimaanPipa";
            ...
            // Table object (subAktivitasFormInputLogbookPenerimaanPipa)
            if (subAktivitasFormInputLogbookPenerimaanPipa == null || subAktivitasFormInputLogbookPenerimaanPipa is SubAktivitasFormInputLogbookPenerimaanPipa)
                subAktivitasFormInputLogbookPenerimaanPipa = this;

            // Initialize URLs
            AddUrl = "SubAktivitasFormInputLogbookPenerimaanPipaAdd";
            ...
            MultiDeleteUrl = "SubAktivitasFormInputLogbookPenerimaanPipaDelete";
            MultiUpdateUrl = "SubAktivitasFormInputLogbookPenerimaanPipaUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbookPenerimaanPipaList";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanPipaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasFormInputLogbookPenerimaanPipaView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasFormInputLogbookPenerimaanPipagrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputLogbookPenerimaanPipaList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(NamaBatch.AdvancedSearch.ToJson())); // Field NamaBatch
            filters.Merge(JObject.Parse(TanggalJam.AdvancedSearch.ToJson())); // Field TanggalJam
            filters.Merge(JObject.Parse(NamaKegiatan.AdvancedSearch.ToJson())); // Field NamaKegiatan
            ...
            filters.Merge(JObject.Parse(Level.AdvancedSearch.ToJson())); // Field Level
            ...
            filters.Merge(JObject.Parse(TanggalJamSOP.AdvancedSearch.ToJson())); // Field TanggalJamSOP
            filters.Merge(JObject.Parse(SelisihWaktu.AdvancedSearch.ToJson())); // Field SelisihWaktu
            filters.Merge(JObject.Parse(IsQualityActive.AdvancedSearch.ToJson())); // Field IsQualityActive
        ...
        protected bool RestoreFilterList() {
            ...
            // Field NamaBatch
            if (filter?.TryGetValue("x_NamaBatch", out sv) ?? false) {
                NamaBatch.AdvancedSearch.SearchValue = sv;
                NamaBatch.AdvancedSearch.SearchOperator = filter["z_NamaBatch"];
                NamaBatch.AdvancedSearch.SearchCondition = filter["v_NamaBatch"];
                NamaBatch.AdvancedSearch.SearchValue2 = filter["y_NamaBatch"];
                NamaBatch.AdvancedSearch.SearchOperator2 = filter["w_NamaBatch"];
                NamaBatch.AdvancedSearch.Save();
            }

            // Field TanggalJam
            if (filter?.TryGetValue("x_TanggalJam", out sv) ?? false) {
                TanggalJam.AdvancedSearch.SearchValue = sv;
                TanggalJam.AdvancedSearch.SearchOperator = filter["z_TanggalJam"];
                TanggalJam.AdvancedSearch.SearchCondition = filter["v_TanggalJam"];
                TanggalJam.AdvancedSearch.SearchValue2 = filter["y_TanggalJam"];
                TanggalJam.AdvancedSearch.SearchOperator2 = filter["w_TanggalJam"];
                TanggalJam.AdvancedSearch.Save();
            }

            // Field NamaKegiatan
            if (filter?.TryGetValue("x_NamaKegiatan", out sv) ?? false) {
                NamaKegiatan.AdvancedSearch.SearchValue = sv;
                NamaKegiatan.AdvancedSearch.SearchOperator = filter["z_NamaKegiatan"];
                NamaKegiatan.AdvancedSearch.SearchCondition = filter["v_NamaKegiatan"];
                NamaKegiatan.AdvancedSearch.SearchValue2 = filter["y_NamaKegiatan"];
                NamaKegiatan.AdvancedSearch.SearchOperator2 = filter["w_NamaKegiatan"];
                NamaKegiatan.AdvancedSearch.Save();
            }
            ...
            // Field Level
            if (filter?.TryGetValue("x_Level", out sv) ?? false) {
                Level.AdvancedSearch.SearchValue = sv;
                Level.AdvancedSearch.SearchOperator = filter["z_Level"];
                Level.AdvancedSearch.SearchCondition = filter["v_Level"];
                Level.AdvancedSearch.SearchValue2 = filter["y_Level"];
                Level.AdvancedSearch.SearchOperator2 = filter["w_Level"];
                Level.AdvancedSearch.Save();
            }
            ...
            // Field TanggalJamSOP
            if (filter?.TryGetValue("x_TanggalJamSOP", out sv) ?? false) {
                TanggalJamSOP.AdvancedSearch.SearchValue = sv;
                TanggalJamSOP.AdvancedSearch.SearchOperator = filter["z_TanggalJamSOP"];
                TanggalJamSOP.AdvancedSearch.SearchCondition = filter["v_TanggalJamSOP"];
                TanggalJamSOP.AdvancedSearch.SearchValue2 = filter["y_TanggalJamSOP"];
                TanggalJamSOP.AdvancedSearch.SearchOperator2 = filter["w_TanggalJamSOP"];
                TanggalJamSOP.AdvancedSearch.Save();
            }

            // Field SelisihWaktu
            if (filter?.TryGetValue("x_SelisihWaktu", out sv) ?? false) {
                SelisihWaktu.AdvancedSearch.SearchValue = sv;
                SelisihWaktu.AdvancedSearch.SearchOperator = filter["z_SelisihWaktu"];
                SelisihWaktu.AdvancedSearch.SearchCondition = filter["v_SelisihWaktu"];
                SelisihWaktu.AdvancedSearch.SearchValue2 = filter["y_SelisihWaktu"];
                SelisihWaktu.AdvancedSearch.SearchOperator2 = filter["w_SelisihWaktu"];
                SelisihWaktu.AdvancedSearch.Save();
            }

            // Field IsQualityActive
            if (filter?.TryGetValue("x_IsQualityActive", out sv) ?? false) {
                IsQualityActive.AdvancedSearch.SearchValue = sv;
                IsQualityActive.AdvancedSearch.SearchOperator = filter["z_IsQualityActive"];
                IsQualityActive.AdvancedSearch.SearchCondition = filter["v_IsQualityActive"];
                IsQualityActive.AdvancedSearch.SearchValue2 = filter["y_IsQualityActive"];
                IsQualityActive.AdvancedSearch.SearchOperator2 = filter["w_IsQualityActive"];
                IsQualityActive.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(NamaBatch);
            searchFlds.Add(NamaKegiatan);
            searchFlds.Add(Produk);
            searchFlds.Add(Density);
            searchFlds.Add(Temperature);
            searchFlds.Add(Level);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(NamaBatch, ctrl); // NamaBatch
                UpdateSort(TanggalJam, ctrl); // TanggalJam
                UpdateSort(NamaKegiatan, ctrl); // NamaKegiatan
                ...
                UpdateSort(TanggalJamSOP, ctrl); // TanggalJamSOP
                UpdateSort(SelisihWaktu, ctrl); // SelisihWaktu
                UpdateSort(IsQualityActive, ctrl); // IsQualityActive
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasFormInputLogbookPenerimaanPipa"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputLogbookPenerimaanPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputLogbookPenerimaanPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("NamaBatch")); // DN
                CreateColumnOption(option.Add("TanggalJam")); // DN
                CreateColumnOption(option.Add("NamaKegiatan")); // DN
                ...
                CreateColumnOption(option.Add("Level")); // DN
                ...
                CreateColumnOption(option.Add("TanggalJamSOP")); // DN
                CreateColumnOption(option.Add("SelisihWaktu")); // DN
                CreateColumnOption(option.Add("IsQualityActive")); // DN
            }
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasFormInputLogbookPenerimaanPipasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasFormInputLogbookPenerimaanPipasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputLogbookPenerimaanPipalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasFormInputLogbookPenerimaanPipa");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasFormInputLogbookPenerimaanPipaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasFormInputLogbookPenerimaanPipaList.RowCount) + "_SubAktivitasFormInputLogbookPenerimaanPipa");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasFormInputLogbookPenerimaanPipaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasFormInputLogbookPenerimaanPipaList.RowType == RowType.Add || IsEdit && subAktivitasFormInputLogbookPenerimaanPipaList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("NamaBatch", NamaBatch.DefaultValue ?? DbNullValue); // DN
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasFormInputLogbookPenerimaanPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasFormInputLogbookPenerimaanPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasFormInputLogbookPenerimaanPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasFormInputLogbookPenerimaanPipasrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
