...
public partial class SnDOne {
    ...
    public class SubaktivitasHasilPemeriksaanLpgEditBase : SubaktivitasHasilPemeriksaanLpg
    {
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanLpgEditBase()
        {
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasHasilPemeriksaanLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasHasilPemeriksaanLpgList") {
                                ...
                                returnUrl = "SubaktivitasHasilPemeriksaanLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
