...
public partial class SnDOne {
    ...
    public class SubAktivitasHasilPemeriksaanPenyaluranStsPyrLpgEditBase : SubAktivitasHasilPemeriksaanPenyaluranStsPyrLpg
    {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranStsPyrLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranStsPyrLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasHasilPemeriksaanPenyaluranStsPyrLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasHasilPemeriksaanPenyaluranStsPyrLpgList") {
                                ...
                                returnUrl = "SubAktivitasHasilPemeriksaanPenyaluranStsPyrLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
