...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiSfbdstsPnrBbmEdit
    /// </summary>
    public static SubaktivitasNilaiSfbdstsPnrBbmEdit subaktivitasNilaiSfbdstsPnrBbmEdit
    {
        get => HttpData.Get<SubaktivitasNilaiSfbdstsPnrBbmEdit>("subaktivitasNilaiSfbdstsPnrBbmEdit")!;
        set => HttpData["subaktivitasNilaiSfbdstsPnrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasNilaiSFBDSTSPnrBBM
    /// </summary>
    public class SubaktivitasNilaiSfbdstsPnrBbmEdit : SubaktivitasNilaiSfbdstsPnrBbmEditBase
    {
        // Constructor
        public SubaktivitasNilaiSfbdstsPnrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasNilaiSfbdstsPnrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasNilaiSfbdstsPnrBbmEditBase : SubaktivitasNilaiSfbdstsPnrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasNilaiSfbdstsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasNilaiSfbdstsPnrBbmEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasNilaiSfbdstsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasNilaiSfbdstsPnrBbmEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasNilaiSfbdstsPnrBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasNilaiSfbdstsPnrBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasNilaiSfbdstsPnrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasNilaiSfbdstsPnrBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasNilaiSfbdstsPnrBbmList")), "", TableVar, true);
            string pageId = "edit";
