...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiBlsfallpgEdit
    /// </summary>
    public static SubAktivitasNilaiBlsfallpgEdit subAktivitasNilaiBlsfallpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiBlsfallpgEdit>("subAktivitasNilaiBlsfallpgEdit")!;
        set => HttpData["subAktivitasNilaiBlsfallpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiBLSFALLPG
    /// </summary>
    public class SubAktivitasNilaiBlsfallpgEdit : SubAktivitasNilaiBlsfallpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiBlsfallpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiBlsfallpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiBlsfallpgEditBase : SubAktivitasNilaiBlsfallpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiBlsfallpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlsfallpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiBlsfallpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlsfallpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiBlsfallpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiBlsfallpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiBlsfallpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiBlsfallpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiBlsfallpgList")), "", TableVar, true);
            string pageId = "edit";
