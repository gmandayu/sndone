...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasStartBongkarStslpgEdit
    /// </summary>
    public static SubAktivitasStartBongkarStslpgEdit subAktivitasStartBongkarStslpgEdit
    {
        get => HttpData.Get<SubAktivitasStartBongkarStslpgEdit>("subAktivitasStartBongkarStslpgEdit")!;
        set => HttpData["subAktivitasStartBongkarStslpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasStartBongkarSTSLPG
    /// </summary>
    public class SubAktivitasStartBongkarStslpgEdit : SubAktivitasStartBongkarStslpgEditBase
    {
        // Constructor
        public SubAktivitasStartBongkarStslpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasStartBongkarStslpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasStartBongkarStslpgEditBase : SubAktivitasStartBongkarStslpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasStartBongkarStslpgEdit";
        ...
        // Constructor
        public SubAktivitasStartBongkarStslpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasStartBongkarStslpgEdit";
        ...
        // Constructor
        public SubAktivitasStartBongkarStslpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasStartBongkarStslpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasStartBongkarStslpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasStartBongkarStslpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasStartBongkarStslpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasStartBongkarStslpgList")), "", TableVar, true);
            string pageId = "edit";
