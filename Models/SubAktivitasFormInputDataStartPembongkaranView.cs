...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStartPembongkaranView
    /// </summary>
    public static SubAktivitasFormInputDataStartPembongkaranView subAktivitasFormInputDataStartPembongkaranView
    {
        get => HttpData.Get<SubAktivitasFormInputDataStartPembongkaranView>("subAktivitasFormInputDataStartPembongkaranView")!;
        set => HttpData["subAktivitasFormInputDataStartPembongkaranView"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStartPembongkaran
    /// </summary>
    public class SubAktivitasFormInputDataStartPembongkaranView : SubAktivitasFormInputDataStartPembongkaranViewBase
    {
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStartPembongkaranViewBase : SubAktivitasFormInputDataStartPembongkaran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStartPembongkaranView";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranViewBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStartPembongkaranView";
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void PageRunEnd()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputDataStartPembongkaranView?.PageRender();
            }
        }
