...
public partial class SnDOne {
    /// <summary>
    /// formInputGoodHouseKeeping
    /// </summary>
    [MaybeNull]
    public static FormInputGoodHouseKeeping formInputGoodHouseKeeping
    {
        get => HttpData.Resolve<FormInputGoodHouseKeeping>("FormInputGoodHouseKeeping");
        set => HttpData["FormInputGoodHouseKeeping"] = value;
    }

    /// <summary>
    /// Table class for FormInputGoodHouseKeeping
    /// </summary>
    public class FormInputGoodHouseKeeping : DbTable
    {
        ...
        public readonly DbField<SqlDbType> tgltiba;
        ...
        // Constructor
        public FormInputGoodHouseKeeping()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "FormInputGoodHouseKeeping";
            Name = "FormInputGoodHouseKeeping";
            Type = "TABLE";
            UpdateTable = "dbo.FormInputGoodHouseKeeping"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("FormInputGoodHouseKeeping", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("FormInputGoodHouseKeeping", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            NoReferensi.Lookup = new Lookup<DbField>(NoReferensi, "FormInputGoodHouseKeeping", true, "NoReferensi", new List<string> {"NoReferensi", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NoReferensi", NoReferensi);

            // tgltiba
            tgltiba = new(this, "x_tgltiba", 135, SqlDbType.DateTime) {
                Name = "tgltiba",
                Expression = "[tgltiba]",
                UseBasicSearch = true,
                BasicSearchExpression = CastDateFieldForLike("[tgltiba]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[tgltiba]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("FormInputGoodHouseKeeping", "tgltiba", "CustomMsg"),
                IsUpload = false
            };
            tgltiba.Raw = true;
            tgltiba.Lookup = new Lookup<DbField>(tgltiba, "FormInputGoodHouseKeeping", true, "tgltiba", new List<string> {"tgltiba", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("tgltiba", tgltiba);
            ...
            Lokasi = new(this, "x_Lokasi", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputGoodHouseKeeping", "Lokasi", "CustomMsg"),
                IsUpload = false
            };
            Lokasi.Lookup = new Lookup<DbField>(Lokasi, "FormInputGoodHouseKeeping", true, "Lokasi", new List<string> {"Lokasi", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DownloadDokumen = new(this, "x_DownloadDokumen", 203, SqlDbType.NText) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputGoodHouseKeeping", "DownloadDokumen", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("DownloadDokumen", DownloadDokumen);

            // UploadFoto
            UploadFoto = new(this, "x_UploadFoto", 202, SqlDbType.NVarChar) {
                Name = "UploadFoto",
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputGoodHouseKeeping", "UploadFoto", "CustomMsg"),
                IsUpload = false
            };
            ...
            Keterangan = new(this, "x_Keterangan", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputGoodHouseKeeping", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            Keterangan.Lookup = new Lookup<DbField>(Keterangan, "FormInputGoodHouseKeeping", true, "Keterangan", new List<string> {"Keterangan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputGoodHouseKeeping", "userInput", "CustomMsg"),
                IsUpload = false
            };
            userInput.Lookup = new Lookup<DbField>(userInput, "FormInputGoodHouseKeeping", true, "userInput", new List<string> {"userInput", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputGoodHouseKeeping", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            etlDate.Lookup = new Lookup<DbField>(etlDate, "FormInputGoodHouseKeeping", true, "etlDate", new List<string> {"etlDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            lastUpdatedBy = new(this, "x_lastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputGoodHouseKeeping", "lastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            lastUpdatedBy.Lookup = new Lookup<DbField>(lastUpdatedBy, "FormInputGoodHouseKeeping", true, "lastUpdatedBy", new List<string> {"lastUpdatedBy", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("FormInputGoodHouseKeeping", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            lastUpdatedDate.Raw = true;
            lastUpdatedDate.Lookup = new Lookup<DbField>(lastUpdatedDate, "FormInputGoodHouseKeeping", true, "lastUpdatedDate", new List<string> {"lastUpdatedDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        {
            get => _sqlFrom ?? "dbo.FormInputGoodHouseKeeping";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.FormInputGoodHouseKeeping type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                tgltiba.DbValue = row["tgltiba"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "FormInputGoodHouseKeepingList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "FormInputGoodHouseKeepingView" => Language.Phrase("View"),
                "FormInputGoodHouseKeepingEdit" => Language.Phrase("Edit"),
                "FormInputGoodHouseKeepingAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "FormInputGoodHouseKeepingView",
                Config.ApiAddAction => "FormInputGoodHouseKeepingAdd",
                Config.ApiEditAction => "FormInputGoodHouseKeepingEdit",
                Config.ApiDeleteAction => "FormInputGoodHouseKeepingDelete",
                Config.ApiListAction => "FormInputGoodHouseKeepingList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "FormInputGoodHouseKeepingList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("FormInputGoodHouseKeepingView", parm);
            else
                url = KeyUrl("FormInputGoodHouseKeepingView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "FormInputGoodHouseKeepingAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "FormInputGoodHouseKeepingAdd?" + parm;
            else
                url = "FormInputGoodHouseKeepingAdd";
        ...
        {
            string url = "";
            url = KeyUrl("FormInputGoodHouseKeepingEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("FormInputGoodHouseKeepingList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("FormInputGoodHouseKeepingAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("FormInputGoodHouseKeepingList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("FormInputGoodHouseKeepingDelete", parm)); // DN
        }
        ...
        {
            string pageName = "FormInputGoodHouseKeepingList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // tgltiba
            tgltiba.SetupEditAttributes();
            tgltiba.EditValue = FormatDateTime(tgltiba.CurrentValue, tgltiba.FormatPattern);
            tgltiba.PlaceHolder = RemoveHtml(tgltiba.Caption);

            // Lokasi
            Lokasi.SetupEditAttributes();
            if (!Lokasi.Raw)
                Lokasi.CurrentValue = HtmlDecode(Lokasi.CurrentValue);
            Lokasi.EditValue = Lokasi.CurrentValue;
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            ...
            rsnew["LastUpdatedBy"] = CurrentUserName();
            rsnew["LastUpdatedDate"] = DbCurrentDateTime();
            return true;
        }
