...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputDataRtwList
    /// </summary>
    public static SubAktivitasInputDataRtwList subAktivitasInputDataRtwList
    {
        get => HttpData.Get<SubAktivitasInputDataRtwList>("subAktivitasInputDataRtwList")!;
        set => HttpData["subAktivitasInputDataRtwList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasInputDataRTW
    /// </summary>
    public class SubAktivitasInputDataRtwList : SubAktivitasInputDataRtwListBase
    {
        // Constructor
        public SubAktivitasInputDataRtwList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasInputDataRtwList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasInputDataRtwListBase : SubAktivitasInputDataRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasInputDataRtwList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasInputDataRTWlist";
        ...
        // Constructor
        public SubAktivitasInputDataRtwListBase()
        {
            TableName = "SubAktivitasInputDataRTW";

            // CSS class name as context
            TableVar = "SubAktivitasInputDataRTW";
            ...
            // Initialize URLs
            AddUrl = "SubAktivitasInputDataRtwAdd";
            ...
            MultiDeleteUrl = "SubAktivitasInputDataRtwDelete";
            MultiUpdateUrl = "SubAktivitasInputDataRtwUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasInputDataRtwList";
        ...
        // Constructor
        public SubAktivitasInputDataRtwListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasInputDataRTWgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasInputDataRtwList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(NomorGerbongKertel.AdvancedSearch.ToJson())); // Field NomorGerbongKertel
            filters.Merge(JObject.Parse(MeterAwal.AdvancedSearch.ToJson())); // Field MeterAwal
            filters.Merge(JObject.Parse(MeterAkhir.AdvancedSearch.ToJson())); // Field MeterAkhir
            filters.Merge(JObject.Parse(Total.AdvancedSearch.ToJson())); // Field Total
            filters.Merge(JObject.Parse(etlDate.AdvancedSearch.ToJson())); // Field etlDate
            filters.Merge(JObject.Parse(NoMeter.AdvancedSearch.ToJson())); // Field NoMeter
            filters.Merge(JObject.Parse(Quantity.AdvancedSearch.ToJson())); // Field Quantity
            filters.Merge(JObject.Parse(HasilPengukuranT2.AdvancedSearch.ToJson())); // Field HasilPengukuranT2
            filters.Merge(JObject.Parse(PICPengisian.AdvancedSearch.ToJson())); // Field PICPengisian
            filters.Merge(JObject.Parse(NomorGerbongKertel2.AdvancedSearch.ToJson())); // Field NomorGerbongKertel2
            filters.Merge(JObject.Parse(NomorGerbongKertel3.AdvancedSearch.ToJson())); // Field NomorGerbongKertel3
            filters.Merge(JObject.Parse(Quantity2.AdvancedSearch.ToJson())); // Field Quantity2
            filters.Merge(JObject.Parse(Quantity3.AdvancedSearch.ToJson())); // Field Quantity3
            filters.Merge(JObject.Parse(HasilPengukuranT2_2.AdvancedSearch.ToJson())); // Field HasilPengukuranT2_2
            filters.Merge(JObject.Parse(HasilPengukuranT2_3.AdvancedSearch.ToJson())); // Field HasilPengukuranT2_3
            filters.Merge(JObject.Parse(TotalGK.AdvancedSearch.ToJson())); // Field TotalGK
            filters.Merge(JObject.Parse(Selisih.AdvancedSearch.ToJson())); // Field Selisih
        ...
        protected bool RestoreFilterList() {
            ...
            // Field NomorGerbongKertel
            if (filter?.TryGetValue("x_NomorGerbongKertel", out sv) ?? false) {
                NomorGerbongKertel.AdvancedSearch.SearchValue = sv;
                NomorGerbongKertel.AdvancedSearch.SearchOperator = filter["z_NomorGerbongKertel"];
                NomorGerbongKertel.AdvancedSearch.SearchCondition = filter["v_NomorGerbongKertel"];
                NomorGerbongKertel.AdvancedSearch.SearchValue2 = filter["y_NomorGerbongKertel"];
                NomorGerbongKertel.AdvancedSearch.SearchOperator2 = filter["w_NomorGerbongKertel"];
                NomorGerbongKertel.AdvancedSearch.Save();
            }

            // Field MeterAwal
            if (filter?.TryGetValue("x_MeterAwal", out sv) ?? false) {
                MeterAwal.AdvancedSearch.SearchValue = sv;
                MeterAwal.AdvancedSearch.SearchOperator = filter["z_MeterAwal"];
                MeterAwal.AdvancedSearch.SearchCondition = filter["v_MeterAwal"];
                MeterAwal.AdvancedSearch.SearchValue2 = filter["y_MeterAwal"];
                MeterAwal.AdvancedSearch.SearchOperator2 = filter["w_MeterAwal"];
                MeterAwal.AdvancedSearch.Save();
            }

            // Field MeterAkhir
            if (filter?.TryGetValue("x_MeterAkhir", out sv) ?? false) {
                MeterAkhir.AdvancedSearch.SearchValue = sv;
                MeterAkhir.AdvancedSearch.SearchOperator = filter["z_MeterAkhir"];
                MeterAkhir.AdvancedSearch.SearchCondition = filter["v_MeterAkhir"];
                MeterAkhir.AdvancedSearch.SearchValue2 = filter["y_MeterAkhir"];
                MeterAkhir.AdvancedSearch.SearchOperator2 = filter["w_MeterAkhir"];
                MeterAkhir.AdvancedSearch.Save();
            }

            // Field Total
            if (filter?.TryGetValue("x_Total", out sv) ?? false) {
                Total.AdvancedSearch.SearchValue = sv;
                Total.AdvancedSearch.SearchOperator = filter["z_Total"];
                Total.AdvancedSearch.SearchCondition = filter["v_Total"];
                Total.AdvancedSearch.SearchValue2 = filter["y_Total"];
                Total.AdvancedSearch.SearchOperator2 = filter["w_Total"];
                Total.AdvancedSearch.Save();
            }
            ...
            // Field NoMeter
            if (filter?.TryGetValue("x_NoMeter", out sv) ?? false) {
                NoMeter.AdvancedSearch.SearchValue = sv;
                NoMeter.AdvancedSearch.SearchOperator = filter["z_NoMeter"];
                NoMeter.AdvancedSearch.SearchCondition = filter["v_NoMeter"];
                NoMeter.AdvancedSearch.SearchValue2 = filter["y_NoMeter"];
                NoMeter.AdvancedSearch.SearchOperator2 = filter["w_NoMeter"];
                NoMeter.AdvancedSearch.Save();
            }

            // Field Quantity
            if (filter?.TryGetValue("x_Quantity", out sv) ?? false) {
                Quantity.AdvancedSearch.SearchValue = sv;
                Quantity.AdvancedSearch.SearchOperator = filter["z_Quantity"];
                Quantity.AdvancedSearch.SearchCondition = filter["v_Quantity"];
                Quantity.AdvancedSearch.SearchValue2 = filter["y_Quantity"];
                Quantity.AdvancedSearch.SearchOperator2 = filter["w_Quantity"];
                Quantity.AdvancedSearch.Save();
            }

            // Field HasilPengukuranT2
            if (filter?.TryGetValue("x_HasilPengukuranT2", out sv) ?? false) {
                HasilPengukuranT2.AdvancedSearch.SearchValue = sv;
                HasilPengukuranT2.AdvancedSearch.SearchOperator = filter["z_HasilPengukuranT2"];
                HasilPengukuranT2.AdvancedSearch.SearchCondition = filter["v_HasilPengukuranT2"];
                HasilPengukuranT2.AdvancedSearch.SearchValue2 = filter["y_HasilPengukuranT2"];
                HasilPengukuranT2.AdvancedSearch.SearchOperator2 = filter["w_HasilPengukuranT2"];
                HasilPengukuranT2.AdvancedSearch.Save();
            }

            // Field PICPengisian
            if (filter?.TryGetValue("x_PICPengisian", out sv) ?? false) {
                PICPengisian.AdvancedSearch.SearchValue = sv;
                PICPengisian.AdvancedSearch.SearchOperator = filter["z_PICPengisian"];
                PICPengisian.AdvancedSearch.SearchCondition = filter["v_PICPengisian"];
                PICPengisian.AdvancedSearch.SearchValue2 = filter["y_PICPengisian"];
                PICPengisian.AdvancedSearch.SearchOperator2 = filter["w_PICPengisian"];
                PICPengisian.AdvancedSearch.Save();
            }

            // Field NomorGerbongKertel2
            if (filter?.TryGetValue("x_NomorGerbongKertel2", out sv) ?? false) {
                NomorGerbongKertel2.AdvancedSearch.SearchValue = sv;
                NomorGerbongKertel2.AdvancedSearch.SearchOperator = filter["z_NomorGerbongKertel2"];
                NomorGerbongKertel2.AdvancedSearch.SearchCondition = filter["v_NomorGerbongKertel2"];
                NomorGerbongKertel2.AdvancedSearch.SearchValue2 = filter["y_NomorGerbongKertel2"];
                NomorGerbongKertel2.AdvancedSearch.SearchOperator2 = filter["w_NomorGerbongKertel2"];
                NomorGerbongKertel2.AdvancedSearch.Save();
            }

            // Field NomorGerbongKertel3
            if (filter?.TryGetValue("x_NomorGerbongKertel3", out sv) ?? false) {
                NomorGerbongKertel3.AdvancedSearch.SearchValue = sv;
                NomorGerbongKertel3.AdvancedSearch.SearchOperator = filter["z_NomorGerbongKertel3"];
                NomorGerbongKertel3.AdvancedSearch.SearchCondition = filter["v_NomorGerbongKertel3"];
                NomorGerbongKertel3.AdvancedSearch.SearchValue2 = filter["y_NomorGerbongKertel3"];
                NomorGerbongKertel3.AdvancedSearch.SearchOperator2 = filter["w_NomorGerbongKertel3"];
                NomorGerbongKertel3.AdvancedSearch.Save();
            }

            // Field Quantity2
            if (filter?.TryGetValue("x_Quantity2", out sv) ?? false) {
                Quantity2.AdvancedSearch.SearchValue = sv;
                Quantity2.AdvancedSearch.SearchOperator = filter["z_Quantity2"];
                Quantity2.AdvancedSearch.SearchCondition = filter["v_Quantity2"];
                Quantity2.AdvancedSearch.SearchValue2 = filter["y_Quantity2"];
                Quantity2.AdvancedSearch.SearchOperator2 = filter["w_Quantity2"];
                Quantity2.AdvancedSearch.Save();
            }

            // Field Quantity3
            if (filter?.TryGetValue("x_Quantity3", out sv) ?? false) {
                Quantity3.AdvancedSearch.SearchValue = sv;
                Quantity3.AdvancedSearch.SearchOperator = filter["z_Quantity3"];
                Quantity3.AdvancedSearch.SearchCondition = filter["v_Quantity3"];
                Quantity3.AdvancedSearch.SearchValue2 = filter["y_Quantity3"];
                Quantity3.AdvancedSearch.SearchOperator2 = filter["w_Quantity3"];
                Quantity3.AdvancedSearch.Save();
            }

            // Field HasilPengukuranT2_2
            if (filter?.TryGetValue("x_HasilPengukuranT2_2", out sv) ?? false) {
                HasilPengukuranT2_2.AdvancedSearch.SearchValue = sv;
                HasilPengukuranT2_2.AdvancedSearch.SearchOperator = filter["z_HasilPengukuranT2_2"];
                HasilPengukuranT2_2.AdvancedSearch.SearchCondition = filter["v_HasilPengukuranT2_2"];
                HasilPengukuranT2_2.AdvancedSearch.SearchValue2 = filter["y_HasilPengukuranT2_2"];
                HasilPengukuranT2_2.AdvancedSearch.SearchOperator2 = filter["w_HasilPengukuranT2_2"];
                HasilPengukuranT2_2.AdvancedSearch.Save();
            }

            // Field HasilPengukuranT2_3
            if (filter?.TryGetValue("x_HasilPengukuranT2_3", out sv) ?? false) {
                HasilPengukuranT2_3.AdvancedSearch.SearchValue = sv;
                HasilPengukuranT2_3.AdvancedSearch.SearchOperator = filter["z_HasilPengukuranT2_3"];
                HasilPengukuranT2_3.AdvancedSearch.SearchCondition = filter["v_HasilPengukuranT2_3"];
                HasilPengukuranT2_3.AdvancedSearch.SearchValue2 = filter["y_HasilPengukuranT2_3"];
                HasilPengukuranT2_3.AdvancedSearch.SearchOperator2 = filter["w_HasilPengukuranT2_3"];
                HasilPengukuranT2_3.AdvancedSearch.Save();
            }

            // Field TotalGK
            if (filter?.TryGetValue("x_TotalGK", out sv) ?? false) {
                TotalGK.AdvancedSearch.SearchValue = sv;
                TotalGK.AdvancedSearch.SearchOperator = filter["z_TotalGK"];
                TotalGK.AdvancedSearch.SearchCondition = filter["v_TotalGK"];
                TotalGK.AdvancedSearch.SearchValue2 = filter["y_TotalGK"];
                TotalGK.AdvancedSearch.SearchOperator2 = filter["w_TotalGK"];
                TotalGK.AdvancedSearch.Save();
            }

            // Field Selisih
            if (filter?.TryGetValue("x_Selisih", out sv) ?? false) {
                Selisih.AdvancedSearch.SearchValue = sv;
                Selisih.AdvancedSearch.SearchOperator = filter["z_Selisih"];
                Selisih.AdvancedSearch.SearchCondition = filter["v_Selisih"];
                Selisih.AdvancedSearch.SearchValue2 = filter["y_Selisih"];
                Selisih.AdvancedSearch.SearchOperator2 = filter["w_Selisih"];
                Selisih.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(NomorGerbongKertel);
            searchFlds.Add(MeterAwal);
            searchFlds.Add(MeterAkhir);
            searchFlds.Add(Total);
            searchFlds.Add(userInput);
            searchFlds.Add(NoMeter);
            searchFlds.Add(Quantity);
            searchFlds.Add(HasilPengukuranT2);
            searchFlds.Add(PICPengisian);
            searchFlds.Add(NomorGerbongKertel2);
            searchFlds.Add(NomorGerbongKertel3);
            searchFlds.Add(Quantity2);
            searchFlds.Add(Quantity3);
            searchFlds.Add(HasilPengukuranT2_2);
            searchFlds.Add(HasilPengukuranT2_3);
            searchFlds.Add(TotalGK);
            searchFlds.Add(Selisih);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(NomorGerbongKertel, ctrl); // NomorGerbongKertel
                UpdateSort(MeterAwal, ctrl); // MeterAwal
                UpdateSort(MeterAkhir, ctrl); // MeterAkhir
                UpdateSort(Total, ctrl); // Total
                UpdateSort(userInput, ctrl); // userInput
                UpdateSort(NoMeter, ctrl); // NoMeter
                UpdateSort(Quantity, ctrl); // Quantity
                UpdateSort(HasilPengukuranT2, ctrl); // HasilPengukuranT2
                UpdateSort(PICPengisian, ctrl); // PICPengisian
                UpdateSort(NomorGerbongKertel2, ctrl); // NomorGerbongKertel2
                UpdateSort(NomorGerbongKertel3, ctrl); // NomorGerbongKertel3
                UpdateSort(Quantity2, ctrl); // Quantity2
                UpdateSort(Quantity3, ctrl); // Quantity3
                UpdateSort(HasilPengukuranT2_2, ctrl); // HasilPengukuranT2_2
                UpdateSort(HasilPengukuranT2_3, ctrl); // HasilPengukuranT2_3
                UpdateSort(TotalGK, ctrl); // TotalGK
                UpdateSort(Selisih, ctrl); // Selisih
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    NoMeter.Sort = "";
                    Quantity.Sort = "";
                    HasilPengukuranT2.Sort = "";
                    PICPengisian.Sort = "";
                    NomorGerbongKertel2.Sort = "";
                    NomorGerbongKertel3.Sort = "";
                    Quantity2.Sort = "";
                    Quantity3.Sort = "";
                    HasilPengukuranT2_2.Sort = "";
                    HasilPengukuranT2_3.Sort = "";
                    TotalGK.Sort = "";
                    Selisih.Sort = "";
                }
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasInputDataRTW"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasInputDataRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasInputDataRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("NomorGerbongKertel")); // DN
                CreateColumnOption(option.Add("MeterAwal")); // DN
                CreateColumnOption(option.Add("MeterAkhir")); // DN
                CreateColumnOption(option.Add("Total")); // DN
                CreateColumnOption(option.Add("userInput")); // DN
                CreateColumnOption(option.Add("NoMeter")); // DN
                CreateColumnOption(option.Add("Quantity")); // DN
                CreateColumnOption(option.Add("HasilPengukuranT2")); // DN
                CreateColumnOption(option.Add("PICPengisian")); // DN
                CreateColumnOption(option.Add("NomorGerbongKertel2")); // DN
                CreateColumnOption(option.Add("NomorGerbongKertel3")); // DN
                CreateColumnOption(option.Add("Quantity2")); // DN
                CreateColumnOption(option.Add("Quantity3")); // DN
                CreateColumnOption(option.Add("HasilPengukuranT2_2")); // DN
                CreateColumnOption(option.Add("HasilPengukuranT2_3")); // DN
                CreateColumnOption(option.Add("TotalGK")); // DN
                CreateColumnOption(option.Add("Selisih")); // DN
            }
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasInputDataRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasInputDataRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasInputDataRTWlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasInputDataRTW");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasInputDataRtwList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasInputDataRtwList.RowCount) + "_SubAktivitasInputDataRTW");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasInputDataRtwList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasInputDataRtwList.RowType == RowType.Add || IsEdit && subAktivitasInputDataRtwList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                NomorGerbongKertel.TooltipValue = "";
                ...
                HasilPengukuranT2.TooltipValue = "";

                // PICPengisian
                PICPengisian.HrefValue = "";
                PICPengisian.TooltipValue = "";

                // NomorGerbongKertel2
                NomorGerbongKertel2.HrefValue = "";
                NomorGerbongKertel2.TooltipValue = "";

                // NomorGerbongKertel3
                NomorGerbongKertel3.HrefValue = "";
                NomorGerbongKertel3.TooltipValue = "";

                // Quantity2
                Quantity2.HrefValue = "";
                Quantity2.TooltipValue = "";

                // Quantity3
                Quantity3.HrefValue = "";
                Quantity3.TooltipValue = "";

                // HasilPengukuranT2_2
                HasilPengukuranT2_2.HrefValue = "";
                HasilPengukuranT2_2.TooltipValue = "";

                // HasilPengukuranT2_3
                HasilPengukuranT2_3.HrefValue = "";
                HasilPengukuranT2_3.TooltipValue = "";

                // TotalGK
                TotalGK.HrefValue = "";
                TotalGK.TooltipValue = "";

                // Selisih
                Selisih.HrefValue = "";
                Selisih.TooltipValue = "";
            }
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasInputDataRTWsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
