...
public partial class SnDOne {
    ...
    public class ControlRutinSecurityEditBase : ControlRutinSecurity
    {
        ...
        // Constructor
        public ControlRutinSecurityEditBase()
        {
        ...
        // Constructor
        public ControlRutinSecurityEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("IdCRS", out rv)) { // DN
                    IdCRS.FormValue = UrlDecode(rv); // DN
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("ControlRutinSecurityList"); // No matching record, return to list
                        }
                    break;
            ...
            bool validateForm = true;
                if (IdCRS.Visible && IdCRS.Required) {
                    if (!IdCRS.IsDetailKey && Empty(IdCRS.FormValue)) {
                        IdCRS.AddErrorMessage(ConvertToString(IdCRS.RequiredErrorMessage).Replace("%s", IdCRS.Caption));
                    }
                }
