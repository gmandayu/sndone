...
public partial class SnDOne {
    /// <summary>
    /// formInputProofOfVisitView
    /// </summary>
    public static FormInputProofOfVisitView formInputProofOfVisitView
    {
        get => HttpData.Get<FormInputProofOfVisitView>("formInputProofOfVisitView")!;
        set => HttpData["formInputProofOfVisitView"] = value;
    }

    /// <summary>
    /// Page class for FormInputProofOfVisit
    /// </summary>
    public class FormInputProofOfVisitView : FormInputProofOfVisitViewBase
    {
        // Constructor
        public FormInputProofOfVisitView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public FormInputProofOfVisitView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class FormInputProofOfVisitViewBase : FormInputProofOfVisit
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "formInputProofOfVisitView";
        ...
        // Constructor
        public FormInputProofOfVisitViewBase()
        {
        ...
        // Page name
        public string PageName => "FormInputProofOfVisitView";
        ...
        // Constructor
        public FormInputProofOfVisitViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "FormInputProofOfVisitList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("FormInputProofOfVisitList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                formInputProofOfVisitView?.PageRender();
            }
            return PageResult();
        }
