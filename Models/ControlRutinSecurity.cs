...
public partial class SnDOne {
    /// <summary>
    /// controlRutinSecurity
    /// </summary>
    [MaybeNull]
    public static ControlRutinSecurity controlRutinSecurity
    {
        get => HttpData.Resolve<ControlRutinSecurity>("ControlRutinSecurity");
        set => HttpData["ControlRutinSecurity"] = value;
    }

    /// <summary>
    /// Table class for ControlRutinSecurity
    /// </summary>
    public class ControlRutinSecurity : DbTable
    {
        ...
        public readonly DbField<SqlDbType> IdCRS;

        public readonly DbField<SqlDbType> NomorCRS;
        ...
        // Constructor
        public ControlRutinSecurity()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "ControlRutinSecurity";
            Name = "ControlRutinSecurity";
            Type = "TABLE";
            UpdateTable = "dbo.ControlRutinSecurity"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // IdCRS
            IdCRS = new(this, "x_IdCRS", 3, SqlDbType.Int) {
                Name = "IdCRS",
                Expression = "[IdCRS]",
                BasicSearchExpression = "CAST([IdCRS] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[IdCRS]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("ControlRutinSecurity", "IdCRS", "CustomMsg"),
                IsUpload = false
            };
            IdCRS.Raw = true;
            Fields.Add("IdCRS", IdCRS);

            // NomorCRS
            NomorCRS = new(this, "x_NomorCRS", 202, SqlDbType.NVarChar) {
                Name = "NomorCRS",
                Expression = "[NomorCRS]",
                BasicSearchExpression = "[NomorCRS]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorCRS]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("ControlRutinSecurity", "NomorCRS", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NomorCRS", NomorCRS);

            // LinkRedirect
            LinkRedirect = new(this, "x_LinkRedirect", 202, SqlDbType.NVarChar) {
                Name = "LinkRedirect",
                Expression = "'<a href=FormInputControlRutinSecurityList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorCRS AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorCRS AS NVARCHAR(50))+'</a>'",
                UseBasicSearch = true,
                BasicSearchExpression = "'<a href=FormInputControlRutinSecurityList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorCRS AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorCRS AS NVARCHAR(50))+'</a>'",
                DateTimeFormat = -1,
                VirtualExpression = "'<a href=FormInputControlRutinSecurityList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorCRS AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorCRS AS NVARCHAR(50))+'</a>'",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("ControlRutinSecurity", "LinkRedirect", "CustomMsg"),
                IsUpload = false
            };
            ...
            LookupPlant = new(this, "x_LookupPlant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("ControlRutinSecurity", "LookupPlant", "CustomMsg"),
                IsUpload = false
            };
            LookupPlant.Raw = true;
            LookupPlant.Lookup = new Lookup<DbField>(LookupPlant, "ControlRutinSecurity", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Plant = new(this, "x_Plant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("ControlRutinSecurity", "Plant", "CustomMsg"),
                IsUpload = false
            };
            Plant.Raw = true;
            Plant.Lookup = new Lookup<DbField>(Plant, "MasterPlant", false, "IdPlant", new List<string> {"Plant", "Nama_Terminal", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "CONCAT([Plant],'" + ValueSeparator(1, Plant) + "',[Nama_Terminal])");
            Fields.Add("Plant", Plant);

            // JumlahKetidaksesuaiaan
            JumlahKetidaksesuaiaan = new(this, "x_JumlahKetidaksesuaiaan", 3, SqlDbType.Int) {
                Name = "JumlahKetidaksesuaiaan",
                Expression = "[JumlahKetidaksesuaiaan]",
                BasicSearchExpression = "CAST([JumlahKetidaksesuaiaan] AS NVARCHAR)",
                DateTimeFormat = -1,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("ControlRutinSecurity", "JumlahKetidaksesuaiaan", "CustomMsg"),
                IsUpload = false
            };
            JumlahKetidaksesuaiaan.Raw = true;
            ...
            Catatan = new(this, "x_Catatan", 203, SqlDbType.NText) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ControlRutinSecurity", "Catatan", "CustomMsg"),
                IsUpload = false
            };
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 202, SqlDbType.NVarChar) {
                ...
                Required = true, // Required field
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"],
                CustomMessage = Language.FieldPhrase("ControlRutinSecurity", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("ControlRutinSecurity", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ControlRutinSecurity", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ControlRutinSecurity", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.ControlRutinSecurity";
            set => _sqlFrom = value;
        }
        ...
        {
            get {
                string select = "*, '<a href=FormInputControlRutinSecurityList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorCRS AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorCRS AS NVARCHAR(50))+'</a>' AS [LinkRedirect]";
                if (select == "*") {
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.ControlRutinSecurity type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdCRS"))
                    row["IdCRS"] = lastInsertedId;
                else
                    row.Add("IdCRS", lastInsertedId);
                IdCRS.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                IdCRS.DbValue = row["IdCRS"]; // Set DB value only
                NomorCRS.DbValue = row["NomorCRS"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[IdCRS] = @IdCRS@";
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "ControlRutinSecurityList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "ControlRutinSecurityView" => Language.Phrase("View"),
                "ControlRutinSecurityEdit" => Language.Phrase("Edit"),
                "ControlRutinSecurityAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "ControlRutinSecurityView",
                Config.ApiAddAction => "ControlRutinSecurityAdd",
                Config.ApiEditAction => "ControlRutinSecurityEdit",
                Config.ApiDeleteAction => "ControlRutinSecurityDelete",
                Config.ApiListAction => "ControlRutinSecurityList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "ControlRutinSecurityList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("ControlRutinSecurityView", parm);
            else
                url = KeyUrl("ControlRutinSecurityView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "ControlRutinSecurityAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "ControlRutinSecurityAdd?" + parm;
            else
                url = "ControlRutinSecurityAdd";
        ...
        {
            string url = "";
            url = KeyUrl("ControlRutinSecurityEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("ControlRutinSecurityList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("ControlRutinSecurityAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("ControlRutinSecurityList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("ControlRutinSecurityDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdCRS\":" + ConvertToJson(IdCRS.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdCRS.CurrentValue)) {
                url += "/" + IdCRS.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdCRS", out object? v0)) { // IdCRS // DN
                    key = UrlDecode(v0); // DN
        ...
        {
            string pageName = "ControlRutinSecurityList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // IdCRS
            IdCRS.SetupEditAttributes();
            IdCRS.EditValue = IdCRS.CurrentValue;
            IdCRS.ViewCustomAttributes = "";

            // NomorCRS
            NomorCRS.SetupEditAttributes();
            NomorCRS.EditValue = ConvertToString(NomorCRS.CurrentValue); // DN
            NomorCRS.ViewCustomAttributes = "";
            ...
            if (!Empty(JumlahKetidaksesuaiaan.EditValue) && IsNumeric(JumlahKetidaksesuaiaan.EditValue))
                JumlahKetidaksesuaiaan.EditValue = FormatNumber(JumlahKetidaksesuaiaan.EditValue, null);
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(IdCRS);
                        doc.ExportCaption(NomorCRS);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(IdCRS);
                            await doc.ExportField(NomorCRS);
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew)
        {
            try
            {
                ...
                if (duplicateCount > 0)
                {
                    CancelMessage = $"Sudah ada Control Rutin Security untuk Plant ini pada tanggal {plantTime:dd-MM-yyyy}.";
                    return false;
                }
                ...
                var nomorObj = ExecuteScalar(
                    "EXEC dbo.GenerateNomorControlRutinSecurity @IdPlant = @IdPlant",
                    new { IdPlant = plantId }
                );
                if (nomorObj == null || string.IsNullOrWhiteSpace(nomorObj.ToString()))
                    throw new Exception("Gagal menghasilkan Nomor Control rutin Security.");
                rsnew["NomorCRS"] = nomorObj.ToString();
            ...
            {
                Log("Error in CRS Row_Inserting: " + ex);
                CancelMessage = "Gagal menyimpan data CRS.";
                return false;
            }
        }
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            try {
                ...
                Log("Error in CRS Row_Updating: " + ex.Message);
        ...
        public bool RowDeleting(Dictionary<string, object> rs) {
            string NoReferensi = rs.ContainsKey("NomorCRS") ? rs["NomorCRS"].ToString() : "";
            if (string.IsNullOrEmpty(NoReferensi)) {
                SuccessMessage = "Data Control Rutin Security berhasil dihapus, namun gagal menghapus data Form Input Proof of Visit";
                return true;
            }
            using (SqlConnection sqlConnection = GetConnection("Db").OpenConnection()) {
                string sqlData = "DELETE FROM FormInputControlRutinSecurity WHERE NoReferensi = @NoReferensi;";
