...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputLogbookPenerimaanPenKon
    /// </summary>
    [MaybeNull]
    public static SubAktivitasInputLogbookPenerimaanPenKon subAktivitasInputLogbookPenerimaanPenKon
    {
        get => HttpData.Resolve<SubAktivitasInputLogbookPenerimaanPenKon>("SubAktivitasInputLogbookPenerimaanPenKon");
        set => HttpData["SubAktivitasInputLogbookPenerimaanPenKon"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasInputLogbookPenerimaanPenKon
    /// </summary>
    public class SubAktivitasInputLogbookPenerimaanPenKon : DbTable
    {
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKon()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasInputLogbookPenerimaanPenKon";
            Name = "SubAktivitasInputLogbookPenerimaanPenKon";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasInputLogbookPenerimaanPenKon"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            Nama_Kapal = new(this, "x_Nama_Kapal", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "Nama_Kapal", "CustomMsg"),
                IsUpload = false
            };
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            ...
            Nama_Kegiatan = new(this, "x_Nama_Kegiatan", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "Nama_Kegiatan", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            Density = new(this, "x_Density", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "Density", "CustomMsg"),
                IsUpload = false
            };
            ...
            Temperatur = new(this, "x_Temperatur", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "Temperatur", "CustomMsg"),
                IsUpload = false
            };
            ...
            Keterangan = new(this, "x_Keterangan", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            SubAktivitasHasilPemeriksaanId = new(this, "x_SubAktivitasHasilPemeriksaanId", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputLogbookPenerimaanPenKon", "SubAktivitasHasilPemeriksaanId", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasInputLogbookPenerimaanPenKon";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasInputLogbookPenerimaanPenKon type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasInputLogbookPenerimaanPenKonList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasInputLogbookPenerimaanPenKonView" => Language.Phrase("View"),
                "SubAktivitasInputLogbookPenerimaanPenKonEdit" => Language.Phrase("Edit"),
                "SubAktivitasInputLogbookPenerimaanPenKonAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasInputLogbookPenerimaanPenKonView",
                Config.ApiAddAction => "SubAktivitasInputLogbookPenerimaanPenKonAdd",
                Config.ApiEditAction => "SubAktivitasInputLogbookPenerimaanPenKonEdit",
                Config.ApiDeleteAction => "SubAktivitasInputLogbookPenerimaanPenKonDelete",
                Config.ApiListAction => "SubAktivitasInputLogbookPenerimaanPenKonList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasInputLogbookPenerimaanPenKonList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasInputLogbookPenerimaanPenKonView", parm);
            else
                url = KeyUrl("SubAktivitasInputLogbookPenerimaanPenKonView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasInputLogbookPenerimaanPenKonAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasInputLogbookPenerimaanPenKonAdd?" + parm;
            else
                url = "SubAktivitasInputLogbookPenerimaanPenKonAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasInputLogbookPenerimaanPenKonEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasInputLogbookPenerimaanPenKonList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasInputLogbookPenerimaanPenKonAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasInputLogbookPenerimaanPenKonList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasInputLogbookPenerimaanPenKonDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasInputLogbookPenerimaanPenKonList";
