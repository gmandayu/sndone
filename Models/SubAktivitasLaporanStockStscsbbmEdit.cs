...
public partial class SnDOne {
    ...
    public class SubAktivitasLaporanStockStscsbbmEditBase : SubAktivitasLaporanStockStscsbbm
    {
        ...
        // Constructor
        public SubAktivitasLaporanStockStscsbbmEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasLaporanStockStscsbbmEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasLaporanStockStscsbbmList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubAktivitasLaporanStockStscsbbmList") {
                        ...
                        returnUrl = "SubAktivitasLaporanStockStscsbbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
