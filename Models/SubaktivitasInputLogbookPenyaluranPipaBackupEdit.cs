...
public partial class SnDOne {
    ...
    public class SubaktivitasInputLogbookPenyaluranPipaBackupEditBase : SubaktivitasInputLogbookPenyaluranPipaBackup
    {
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupEditBase()
        {
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasInputLogbookPenyaluranPipaBackupList"); // No matching record, return to list
                        }
                    break;
