...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiARsesuaiCqdPipaLpgEdit
    /// </summary>
    public static SubAktivitasNilaiARsesuaiCqdPipaLpgEdit subAktivitasNilaiARsesuaiCqdPipaLpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiARsesuaiCqdPipaLpgEdit>("subAktivitasNilaiARsesuaiCqdPipaLpgEdit")!;
        set => HttpData["subAktivitasNilaiARsesuaiCqdPipaLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiARsesuaiCQDPipaLPG
    /// </summary>
    public class SubAktivitasNilaiARsesuaiCqdPipaLpgEdit : SubAktivitasNilaiARsesuaiCqdPipaLpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiARsesuaiCqdPipaLpgEditBase : SubAktivitasNilaiARsesuaiCqdPipaLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiARsesuaiCqdPipaLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiARsesuaiCqdPipaLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiARsesuaiCqdPipaLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiARsesuaiCqdPipaLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiARsesuaiCqdPipaLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiARsesuaiCqdPipaLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiARsesuaiCqdPipaLpgList")), "", TableVar, true);
            string pageId = "edit";
