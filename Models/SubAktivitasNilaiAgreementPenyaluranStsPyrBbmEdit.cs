...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEditBase : SubAktivitasNilaiAgreementPenyaluranStsPyrBbm
    {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEditBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiAgreementPenyaluranStsPyrBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiAgreementPenyaluranStsPyrBbmList") {
                                ...
                                returnUrl = "SubAktivitasNilaiAgreementPenyaluranStsPyrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
