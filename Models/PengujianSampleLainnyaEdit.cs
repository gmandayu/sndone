...
public partial class SnDOne {
    /// <summary>
    /// pengujianSampleLainnyaEdit
    /// </summary>
    public static PengujianSampleLainnyaEdit pengujianSampleLainnyaEdit
    {
        get => HttpData.Get<PengujianSampleLainnyaEdit>("pengujianSampleLainnyaEdit")!;
        set => HttpData["pengujianSampleLainnyaEdit"] = value;
    }

    /// <summary>
    /// Page class for PengujianSampleLainnya
    /// </summary>
    public class PengujianSampleLainnyaEdit : PengujianSampleLainnyaEditBase
    {
        // Constructor
        public PengujianSampleLainnyaEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PengujianSampleLainnyaEdit() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PengujianSampleLainnyaEditBase : PengujianSampleLainnya
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "pengujianSampleLainnyaEdit";
        ...
        // Constructor
        public PengujianSampleLainnyaEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "PengujianSampleLainnyaEdit";
        ...
        // Constructor
        public PengujianSampleLainnyaEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("PengujianSampleLainnyaList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "PengujianSampleLainnyaList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "PengujianSampleLainnyaList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        pengujianSampleLainnyaEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'NomorPengujianSampelLainnya'
            NomorPengujianSampelLainnya.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(NomorPengujianSampelLainnya, "NomorPengujianSampelLainnya", "x_NomorPengujianSampelLainnya");
        ...
        public void RestoreFormValues()
        {
            ...
            NomorPengujianSampelLainnya.CurrentValue = NomorPengujianSampelLainnya.FormValue;
        ...
        public async Task RenderRow()
        {
            ...
            NomorPengujianSampelLainnya.RowCssClass = "row";
            ...
            // UploadHasil
            UploadHasil.RowCssClass = "row";

            // CF_UploadHasil
            CF_UploadHasil.RowCssClass = "row";
        ...
        private void ValidateCustomNomorPengujianSampelLainnya() {
            if (NomorPengujianSampelLainnya.Visible && NomorPengujianSampelLainnya.Required) {
                if (!NomorPengujianSampelLainnya.IsDetailKey && Empty(NomorPengujianSampelLainnya.FormValue)) {
                    NomorPengujianSampelLainnya.AddErrorMessage(ConvertToString(Keterangan.RequiredErrorMessage).Replace("%s", Keterangan.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidPlant() {
            if (idPlant.Visible && idPlant.Required) {
                if (!idPlant.IsDetailKey && Empty(idPlant.FormValue)) {
                    idPlant.AddErrorMessage(ConvertToString(Keterangan.RequiredErrorMessage).Replace("%s", Keterangan.Caption));
                }
            }
        }
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ValidateCustomNomorPengujianSampelLainnya();
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("PengujianSampleLainnyaList")), "", TableVar, true);
            string pageId = "edit";
