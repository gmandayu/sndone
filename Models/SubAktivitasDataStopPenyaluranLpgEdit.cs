...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStopPenyaluranLpgEdit
    /// </summary>
    public static SubAktivitasDataStopPenyaluranLpgEdit subAktivitasDataStopPenyaluranLpgEdit
    {
        get => HttpData.Get<SubAktivitasDataStopPenyaluranLpgEdit>("subAktivitasDataStopPenyaluranLpgEdit")!;
        set => HttpData["subAktivitasDataStopPenyaluranLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStopPenyaluranLPG
    /// </summary>
    public class SubAktivitasDataStopPenyaluranLpgEdit : SubAktivitasDataStopPenyaluranLpgEditBase
    {
        // Constructor
        public SubAktivitasDataStopPenyaluranLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStopPenyaluranLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStopPenyaluranLpgEditBase : SubAktivitasDataStopPenyaluranLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStopPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStopPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataStopPenyaluranLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataStopPenyaluranLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataStopPenyaluranLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataStopPenyaluranLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataStopPenyaluranLpgList")), "", TableVar, true);
            string pageId = "edit";
