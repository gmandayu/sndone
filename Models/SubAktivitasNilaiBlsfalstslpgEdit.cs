...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiBlsfalstslpgEditBase : SubAktivitasNilaiBlsfalstslpg
    {
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalstslpgEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalstslpgEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiBlsfalstslpgList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiBlsfalstslpgList") {
                        ...
                        returnUrl = "SubAktivitasNilaiBlsfalstslpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
