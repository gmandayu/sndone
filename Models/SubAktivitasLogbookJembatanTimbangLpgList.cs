...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLogbookJembatanTimbangLpgList
    /// </summary>
    public static SubAktivitasLogbookJembatanTimbangLpgList subAktivitasLogbookJembatanTimbangLpgList
    {
        get => HttpData.Get<SubAktivitasLogbookJembatanTimbangLpgList>("subAktivitasLogbookJembatanTimbangLpgList")!;
        set => HttpData["subAktivitasLogbookJembatanTimbangLpgList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasLogbookJembatanTimbangLPG
    /// </summary>
    public class SubAktivitasLogbookJembatanTimbangLpgList : SubAktivitasLogbookJembatanTimbangLpgListBase
    {
        // Constructor
        public SubAktivitasLogbookJembatanTimbangLpgList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasLogbookJembatanTimbangLpgList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasLogbookJembatanTimbangLpgListBase : SubAktivitasLogbookJembatanTimbangLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasLogbookJembatanTimbangLpgList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasLogbookJembatanTimbangLPGlist";
        ...
        // Constructor
        public SubAktivitasLogbookJembatanTimbangLpgListBase()
        {
            ...
            // Initialize URLs
            AddUrl = "SubAktivitasLogbookJembatanTimbangLpgAdd";
            ...
            MultiDeleteUrl = "SubAktivitasLogbookJembatanTimbangLpgDelete";
            MultiUpdateUrl = "SubAktivitasLogbookJembatanTimbangLpgUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasLogbookJembatanTimbangLpgList";
        ...
        // Constructor
        public SubAktivitasLogbookJembatanTimbangLpgListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasLogbookJembatanTimbangLPGgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasLogbookJembatanTimbangLpgList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(SPA);
            searchFlds.Add(TimbanganAwal);
            searchFlds.Add(TimbanganAkhir);
            searchFlds.Add(NetWight);
            searchFlds.Add(PresentaseLevelRotoGauge);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(SPA, ctrl); // SPA
                UpdateSort(TimbanganAwal, ctrl); // TimbanganAwal
                UpdateSort(TimbanganAkhir, ctrl); // TimbanganAkhir
                UpdateSort(NetWight, ctrl); // NetWight
                UpdateSort(PresentaseLevelRotoGauge, ctrl); // PresentaseLevelRotoGauge
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasLogbookJembatanTimbangLPG"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasLogbookJembatanTimbangLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasLogbookJembatanTimbangLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("SPA")); // DN
                CreateColumnOption(option.Add("TimbanganAwal")); // DN
                CreateColumnOption(option.Add("TimbanganAkhir")); // DN
                CreateColumnOption(option.Add("NetWight")); // DN
                CreateColumnOption(option.Add("PresentaseLevelRotoGauge")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasLogbookJembatanTimbangLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasLogbookJembatanTimbangLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasLogbookJembatanTimbangLPGlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasLogbookJembatanTimbangLPG");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasLogbookJembatanTimbangLpgList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasLogbookJembatanTimbangLpgList.RowCount) + "_SubAktivitasLogbookJembatanTimbangLPG");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasLogbookJembatanTimbangLpgList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasLogbookJembatanTimbangLpgList.RowType == RowType.Add || IsEdit && subAktivitasLogbookJembatanTimbangLpgList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasLogbookJembatanTimbangLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasLogbookJembatanTimbangLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasLogbookJembatanTimbangLPGlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasLogbookJembatanTimbangLPGsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
