...
public partial class SnDOne {
    ...
    public class SubAktivitasHasilPemeriksaanPenKonEditBase : SubAktivitasHasilPemeriksaanPenKon
    {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenKonEditBase()
        {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenKonEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasHasilPemeriksaanPenKonList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasHasilPemeriksaanPenKonList") {
                                ...
                                returnUrl = "SubAktivitasHasilPemeriksaanPenKonList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
