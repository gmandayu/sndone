...
public partial class SnDOne {
    ...
    public class ProsesViewBase : Proses
    {
        ...
        // Constructor
        public ProsesViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdProses", out v) && !Empty(v)) { // DN
                IdProses.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdProses"] = IdProses.QueryValue;
            } else if (Get("IdProses", out sv)) {
                ...
                returnUrl = "ProsesList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("ProsesList"); // Return to list page
                            }
                        }
                    break;
            }
