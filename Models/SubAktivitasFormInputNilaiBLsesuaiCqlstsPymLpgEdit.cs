...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit
    /// </summary>
    public static SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit subAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit>("subAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit")!;
        set => HttpData["subAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG
    /// </summary>
    public class SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit : SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEditBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEditBase : SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList")), "", TableVar, true);
            string pageId = "edit";
