...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataMobilTangkiDelete
    /// </summary>
    public static SubAktivitasFormInputDataMobilTangkiDelete subAktivitasFormInputDataMobilTangkiDelete
    {
        get => HttpData.Get<SubAktivitasFormInputDataMobilTangkiDelete>("subAktivitasFormInputDataMobilTangkiDelete")!;
        set => HttpData["subAktivitasFormInputDataMobilTangkiDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataMobilTangki
    /// </summary>
    public class SubAktivitasFormInputDataMobilTangkiDelete : SubAktivitasFormInputDataMobilTangkiDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataMobilTangkiDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataMobilTangkiDeleteBase : SubAktivitasFormInputDataMobilTangki
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataMobilTangkiDelete";
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataMobilTangkiDelete";
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputDataMobilTangkiList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputDataMobilTangkiList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputDataMobilTangkiDelete?.PageRender();
            }
            return PageResult();
        }
