...
public partial class SnDOne {
    ...
    public class MasterFungsiKunjunganViewBase : MasterFungsiKunjungan
    {
        ...
        // Constructor
        public MasterFungsiKunjunganViewBase()
        {
        ...
        // Constructor
        public MasterFungsiKunjunganViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "MasterFungsiKunjunganList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterFungsiKunjunganList"); // Return to list page
                            }
                        }
                    break;
            }
