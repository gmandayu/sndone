...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputFlowrateRtwList
    /// </summary>
    public static SubAktivitasFormInputFlowrateRtwList subAktivitasFormInputFlowrateRtwList
    {
        get => HttpData.Get<SubAktivitasFormInputFlowrateRtwList>("subAktivitasFormInputFlowrateRtwList")!;
        set => HttpData["subAktivitasFormInputFlowrateRtwList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputFlowrateRTW
    /// </summary>
    public class SubAktivitasFormInputFlowrateRtwList : SubAktivitasFormInputFlowrateRtwListBase
    {
        // Constructor
        public SubAktivitasFormInputFlowrateRtwList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputFlowrateRtwList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputFlowrateRtwListBase : SubAktivitasFormInputFlowrateRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputFlowrateRtwList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasFormInputFlowrateRTWlist";
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateRtwListBase()
        {
            TableName = "SubAktivitasFormInputFlowrateRTW";

            // CSS class name as context
            TableVar = "SubAktivitasFormInputFlowrateRTW";
            ...
            // Table object (subAktivitasFormInputFlowrateRtw)
            if (subAktivitasFormInputFlowrateRtw == null || subAktivitasFormInputFlowrateRtw is SubAktivitasFormInputFlowrateRtw)
                subAktivitasFormInputFlowrateRtw = this;

            // Initialize URLs
            AddUrl = "SubAktivitasFormInputFlowrateRtwAdd";
            ...
            MultiDeleteUrl = "SubAktivitasFormInputFlowrateRtwDelete";
            MultiUpdateUrl = "SubAktivitasFormInputFlowrateRtwUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputFlowrateRtwList";
        ...
        public void SetVisibility()
        {
            ...
            StrippingTime.SetVisibility();
            Pressuren.SetVisibility();
            LamaPembongkaran.SetVisibility();
            ETC.SetVisibility();
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateRtwListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasFormInputFlowrateRtwView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasFormInputFlowrateRTWgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputFlowrateRtwList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(StrippingTime.AdvancedSearch.ToJson())); // Field StrippingTime
            filters.Merge(JObject.Parse(Pressuren.AdvancedSearch.ToJson())); // Field Pressuren
            filters.Merge(JObject.Parse(LamaPembongkaran.AdvancedSearch.ToJson())); // Field LamaPembongkaran
        ...
        protected bool RestoreFilterList() {
            ...
            // Field StrippingTime
            if (filter?.TryGetValue("x_StrippingTime", out sv) ?? false) {
                StrippingTime.AdvancedSearch.SearchValue = sv;
                StrippingTime.AdvancedSearch.SearchOperator = filter["z_StrippingTime"];
                StrippingTime.AdvancedSearch.SearchCondition = filter["v_StrippingTime"];
                StrippingTime.AdvancedSearch.SearchValue2 = filter["y_StrippingTime"];
                StrippingTime.AdvancedSearch.SearchOperator2 = filter["w_StrippingTime"];
                StrippingTime.AdvancedSearch.Save();
            }

            // Field Pressuren
            if (filter?.TryGetValue("x_Pressuren", out sv) ?? false) {
                Pressuren.AdvancedSearch.SearchValue = sv;
                Pressuren.AdvancedSearch.SearchOperator = filter["z_Pressuren"];
                Pressuren.AdvancedSearch.SearchCondition = filter["v_Pressuren"];
                Pressuren.AdvancedSearch.SearchValue2 = filter["y_Pressuren"];
                Pressuren.AdvancedSearch.SearchOperator2 = filter["w_Pressuren"];
                Pressuren.AdvancedSearch.Save();
            }

            // Field LamaPembongkaran
            if (filter?.TryGetValue("x_LamaPembongkaran", out sv) ?? false) {
                LamaPembongkaran.AdvancedSearch.SearchValue = sv;
                LamaPembongkaran.AdvancedSearch.SearchOperator = filter["z_LamaPembongkaran"];
                LamaPembongkaran.AdvancedSearch.SearchCondition = filter["v_LamaPembongkaran"];
                LamaPembongkaran.AdvancedSearch.SearchValue2 = filter["y_LamaPembongkaran"];
                LamaPembongkaran.AdvancedSearch.SearchOperator2 = filter["w_LamaPembongkaran"];
                LamaPembongkaran.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(StrippingTime);
            searchFlds.Add(Pressuren);
            searchFlds.Add(LamaPembongkaran);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(StrippingTime, ctrl); // StrippingTime
                UpdateSort(Pressuren, ctrl); // Pressuren
                UpdateSort(LamaPembongkaran, ctrl); // LamaPembongkaran
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""SubAktivitasFormInputFlowrateRTW"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasFormInputFlowrateRTW"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalAdd && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-copy"" title=""{copycaption}"" data-table=""SubAktivitasFormInputFlowrateRTW"" data-caption=""{copycaption}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(CopyUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("CopyLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputFlowrateRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputFlowrateRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""SubAktivitasFormInputFlowrateRTW"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            item.Body = $@"<button type=""button"" class=""ew-action ew-multi-delete"" title=""{deleteTitle}"" data-caption=""{deleteTitle}"" form=""fSubAktivitasFormInputFlowrateRTWlist""" +
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("StrippingTime")); // DN
                CreateColumnOption(option.Add("Pressuren")); // DN
                CreateColumnOption(option.Add("LamaPembongkaran")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasFormInputFlowrateRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasFormInputFlowrateRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputFlowrateRTWlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasFormInputFlowrateRTW");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasFormInputFlowrateRtwList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasFormInputFlowrateRtwList.RowCount) + "_SubAktivitasFormInputFlowrateRTW");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasFormInputFlowrateRtwList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasFormInputFlowrateRtwList.RowType == RowType.Add || IsEdit && subAktivitasFormInputFlowrateRtwList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            StrippingTime.SetDbValue(row["StrippingTime"]);
            Pressuren.SetDbValue(row["Pressuren"]);
            LamaPembongkaran.SetDbValue(row["LamaPembongkaran"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("StrippingTime", StrippingTime.DefaultValue ?? DbNullValue); // DN
            row.Add("Pressuren", Pressuren.DefaultValue ?? DbNullValue); // DN
            row.Add("LamaPembongkaran", LamaPembongkaran.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // StrippingTime
                StrippingTime.ViewValue = ConvertToString(StrippingTime.CurrentValue); // DN
                StrippingTime.ViewCustomAttributes = "";

                // Pressuren
                Pressuren.ViewValue = ConvertToString(Pressuren.CurrentValue); // DN
                Pressuren.ViewCustomAttributes = "";

                // LamaPembongkaran
                LamaPembongkaran.ViewValue = ConvertToString(LamaPembongkaran.CurrentValue); // DN
                LamaPembongkaran.ViewCustomAttributes = "";
                ...
                // StrippingTime
                StrippingTime.HrefValue = "";
                StrippingTime.TooltipValue = "";

                // Pressuren
                Pressuren.HrefValue = "";
                Pressuren.TooltipValue = "";

                // LamaPembongkaran
                LamaPembongkaran.HrefValue = "";
                LamaPembongkaran.TooltipValue = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasFormInputFlowrateRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasFormInputFlowrateRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasFormInputFlowrateRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
