...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataKapalLpgEdit
    /// </summary>
    public static SubAktivitasDataKapalLpgEdit subAktivitasDataKapalLpgEdit
    {
        get => HttpData.Get<SubAktivitasDataKapalLpgEdit>("subAktivitasDataKapalLpgEdit")!;
        set => HttpData["subAktivitasDataKapalLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataKapalLPG
    /// </summary>
    public class SubAktivitasDataKapalLpgEdit : SubAktivitasDataKapalLpgEditBase
    {
        // Constructor
        public SubAktivitasDataKapalLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataKapalLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataKapalLpgEditBase : SubAktivitasDataKapalLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataKapalLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataKapalLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataKapalLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataKapalLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataKapalLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataKapalLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataKapalLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataKapalLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataKapalLpgList")), "", TableVar, true);
            string pageId = "edit";
