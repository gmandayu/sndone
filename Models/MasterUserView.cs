...
public partial class SnDOne {
    ...
    /// masterUserView
    /// </summary>
    public static MasterUserView masterUserView
    {
        get => HttpData.Get<MasterUserView>("masterUserView")!;
        set => HttpData["masterUserView"] = value;
    }

    /// <summary>
    /// Page class for MasterUser
    /// </summary>
    public class MasterUserView : MasterUserViewBase
    {
        // Constructor
        public MasterUserView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterUserView() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class MasterUserViewBase : MasterUser
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterUserView";
        ...
        public MasterUserViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdUser"] = keys[0];
            } else {
                RecordKeys["IdUser"] = RouteValues.TryGetValue("IdUser", out obj) && obj != null ? UrlDecode(obj) : Get("IdUser"); // DN
            }
        ...
        // Page name
        public string PageName => "MasterUserView";
        ...
        public void SetVisibility()
        {
            ...
            IsResetable.SetVisibility();
            IsVerify.SetVisibility();
            Face.SetVisibility();
        ...
        // Constructor
        public MasterUserViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdUser", out v) && !Empty(v)) { // DN
                IdUser.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdUser"] = IdUser.QueryValue;
            } else if (Get("IdUser", out sv)) {
                IdUser.QueryValue = sv.ToString();
                RecordKeys["IdUser"] = IdUser.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdUser.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdUser"] = IdUser.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "MasterUserList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterUserList"); // Return to list page
                            }
                        }
                    break;
            }
