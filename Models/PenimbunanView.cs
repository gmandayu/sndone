...
public partial class SnDOne {
    ...
    /// penimbunanView
    /// </summary>
    public static PenimbunanView penimbunanView
    {
        get => HttpData.Get<PenimbunanView>("penimbunanView")!;
        set => HttpData["penimbunanView"] = value;
    }

    /// <summary>
    /// Page class for Penimbunan
    /// </summary>
    public class PenimbunanView : PenimbunanViewBase
    {
        // Constructor
        public PenimbunanView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenimbunanView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class PenimbunanViewBase : Penimbunan
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penimbunanView";
        ...
        public PenimbunanViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdPenimbunan"] = keys[0];
            } else {
                RecordKeys["IdPenimbunan"] = RouteValues.TryGetValue("IdPenimbunan", out obj) && obj != null ? UrlDecode(obj) : Get("IdPenimbunan"); // DN
            }
        ...
        // Page name
        public string PageName => "PenimbunanView";
        ...
        // Constructor
        public PenimbunanViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdPenimbunan", out v) && !Empty(v)) { // DN
                IdPenimbunan.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdPenimbunan"] = IdPenimbunan.QueryValue;
            } else if (Get("IdPenimbunan", out sv)) {
                IdPenimbunan.QueryValue = sv.ToString();
                RecordKeys["IdPenimbunan"] = IdPenimbunan.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdPenimbunan.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdPenimbunan"] = IdPenimbunan.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "PenimbunanList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("PenimbunanList"); // Return to list page
                            }
                        }
                    break;
            }
