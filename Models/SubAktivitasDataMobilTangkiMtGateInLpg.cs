...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataMobilTangkiMtGateInLpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasDataMobilTangkiMtGateInLpg subAktivitasDataMobilTangkiMtGateInLpg
    {
        get => HttpData.Resolve<SubAktivitasDataMobilTangkiMtGateInLpg>("SubAktivitasDataMobilTangkiMTGateInLPG");
        set => HttpData["SubAktivitasDataMobilTangkiMTGateInLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasDataMobilTangkiMTGateInLPG
    /// </summary>
    public class SubAktivitasDataMobilTangkiMtGateInLpg : DbTable
    {
        ...
        public readonly DbField<SqlDbType> AMT;

        public readonly DbField<SqlDbType> WaktuGateIn;
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasDataMobilTangkiMTGateInLPG";
            Name = "SubAktivitasDataMobilTangkiMTGateInLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasDataMobilTangkiMTGateInLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomorPolisi = new(this, "x_NomorPolisi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "NomorPolisi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NomorPolisi", NomorPolisi);

            // AMT
            AMT = new(this, "x_AMT", 202, SqlDbType.NVarChar) {
                Name = "AMT",
                Expression = "[AMT]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AMT]",
                DateTimeFormat = -1,
                VirtualExpression = "[AMT]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "AMT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AMT", AMT);

            // WaktuGateIn
            WaktuGateIn = new(this, "x_WaktuGateIn", 135, SqlDbType.DateTime) {
                Name = "WaktuGateIn",
                Expression = "[WaktuGateIn]",
                BasicSearchExpression = CastDateFieldForLike("[WaktuGateIn]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[WaktuGateIn]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "WaktuGateIn", "CustomMsg"),
                IsUpload = false
            };
            WaktuGateIn.Raw = true;
            Fields.Add("WaktuGateIn", WaktuGateIn);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            TimbanganAwal = new(this, "x_TimbanganAwal", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateInLPG", "TimbanganAwal", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasDataMobilTangkiMTGateInLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasDataMobilTangkiMtgateInLpg type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                AMT.DbValue = row["AMT"]; // Set DB value only
                WaktuGateIn.DbValue = row["WaktuGateIn"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasDataMobilTangkiMtGateInLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasDataMobilTangkiMtGateInLpgView" => Language.Phrase("View"),
                "SubAktivitasDataMobilTangkiMtGateInLpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasDataMobilTangkiMtGateInLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasDataMobilTangkiMtGateInLpgView",
                Config.ApiAddAction => "SubAktivitasDataMobilTangkiMtGateInLpgAdd",
                Config.ApiEditAction => "SubAktivitasDataMobilTangkiMtGateInLpgEdit",
                Config.ApiDeleteAction => "SubAktivitasDataMobilTangkiMtGateInLpgDelete",
                Config.ApiListAction => "SubAktivitasDataMobilTangkiMtGateInLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasDataMobilTangkiMtGateInLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasDataMobilTangkiMtGateInLpgView", parm);
            else
                url = KeyUrl("SubAktivitasDataMobilTangkiMtGateInLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasDataMobilTangkiMtGateInLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasDataMobilTangkiMtGateInLpgAdd?" + parm;
            else
                url = "SubAktivitasDataMobilTangkiMtGateInLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataMobilTangkiMtGateInLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataMobilTangkiMtGateInLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataMobilTangkiMtGateInLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataMobilTangkiMtGateInLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasDataMobilTangkiMtGateInLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasDataMobilTangkiMtGateInLpgList";
        ...
        public async Task RenderEditRow()
        {
            ...
            AMT.EditValue = AMT.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(AMT);
                        doc.ExportCaption(WaktuGateIn);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(AMT);
                            await doc.ExportField(WaktuGateIn);
