...
public partial class SnDOne {
    ...
    public class SubAktivitasKeberangkatanRtwViewBase : SubAktivitasKeberangkatanRtw
    {
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwViewBase()
        {
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasKeberangkatanRtwList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasKeberangkatanRtwList"); // Return to list page
                            }
                        }
                    break;
            }
