...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataGerbongKetelRtwDelete
    /// </summary>
    public static SubAktivitasDataGerbongKetelRtwDelete subAktivitasDataGerbongKetelRtwDelete
    {
        get => HttpData.Get<SubAktivitasDataGerbongKetelRtwDelete>("subAktivitasDataGerbongKetelRtwDelete")!;
        set => HttpData["subAktivitasDataGerbongKetelRtwDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataGerbongKetelRTW
    /// </summary>
    public class SubAktivitasDataGerbongKetelRtwDelete : SubAktivitasDataGerbongKetelRtwDeleteBase
    {
        // Constructor
        public SubAktivitasDataGerbongKetelRtwDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataGerbongKetelRtwDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataGerbongKetelRtwDeleteBase : SubAktivitasDataGerbongKetelRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataGerbongKetelRtwDelete";
        ...
        // Constructor
        public SubAktivitasDataGerbongKetelRtwDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataGerbongKetelRtwDelete";
        ...
        // Constructor
        public SubAktivitasDataGerbongKetelRtwDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasDataGerbongKetelRtwList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasDataGerbongKetelRtwList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasDataGerbongKetelRtwDelete?.PageRender();
            }
            return PageResult();
        }
