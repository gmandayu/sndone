...
public partial class SnDOne {
    ...
    public class SubAktivitasStartBongkarLpgEditBase : SubAktivitasStartBongkarLpg
    {
        ...
        // Constructor
        public SubAktivitasStartBongkarLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasStartBongkarLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasStartBongkarLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasStartBongkarLpgList") {
                                ...
                                returnUrl = "SubAktivitasStartBongkarLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
