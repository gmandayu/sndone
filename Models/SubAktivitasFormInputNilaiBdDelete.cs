...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiBdDelete
    /// </summary>
    public static SubAktivitasFormInputNilaiBdDelete subAktivitasFormInputNilaiBdDelete
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiBdDelete>("subAktivitasFormInputNilaiBdDelete")!;
        set => HttpData["subAktivitasFormInputNilaiBdDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiBD
    /// </summary>
    public class SubAktivitasFormInputNilaiBdDelete : SubAktivitasFormInputNilaiBdDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiBdDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiBdDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiBdDeleteBase : SubAktivitasFormInputNilaiBd
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiBdDelete";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBdDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiBdDelete";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBdDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputNilaiBdList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputNilaiBdList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputNilaiBdDelete?.PageRender();
            }
            return PageResult();
        }
