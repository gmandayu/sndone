...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiBlsfalstsPnrBbmEdit
    /// </summary>
    public static SubaktivitasNilaiBlsfalstsPnrBbmEdit subaktivitasNilaiBlsfalstsPnrBbmEdit
    {
        get => HttpData.Get<SubaktivitasNilaiBlsfalstsPnrBbmEdit>("subaktivitasNilaiBlsfalstsPnrBbmEdit")!;
        set => HttpData["subaktivitasNilaiBlsfalstsPnrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasNilaiBLSFALSTSPnrBBM
    /// </summary>
    public class SubaktivitasNilaiBlsfalstsPnrBbmEdit : SubaktivitasNilaiBlsfalstsPnrBbmEditBase
    {
        // Constructor
        public SubaktivitasNilaiBlsfalstsPnrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasNilaiBlsfalstsPnrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasNilaiBlsfalstsPnrBbmEditBase : SubaktivitasNilaiBlsfalstsPnrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasNilaiBlsfalstsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasNilaiBlsfalstsPnrBbmEditBase()
        {
        ...
        // Page name
        public string PageName => "SubaktivitasNilaiBlsfalstsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasNilaiBlsfalstsPnrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasNilaiBlsfalstsPnrBbmList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "SubaktivitasNilaiBlsfalstsPnrBbmList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasNilaiBlsfalstsPnrBbmList") {
                                ...
                                returnUrl = "SubaktivitasNilaiBlsfalstsPnrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subaktivitasNilaiBlsfalstsPnrBbmEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasNilaiBlsfalstsPnrBbmList")), "", TableVar, true);
            string pageId = "edit";
