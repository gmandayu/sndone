...
public partial class SnDOne {
    ...
    public class SubAktivitasDataKapalStslpgEditBase : SubAktivitasDataKapalStslpg
    {
        ...
        // Constructor
        public SubAktivitasDataKapalStslpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataKapalStslpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataKapalStslpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataKapalStslpgList") {
                                ...
                                returnUrl = "SubAktivitasDataKapalStslpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
