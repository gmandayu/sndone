...
public partial class SnDOne {
    /// <summary>
    /// templateAktivitasMember
    /// </summary>
    [MaybeNull]
    public static TemplateAktivitasMember templateAktivitasMember
    {
        get => HttpData.Resolve<TemplateAktivitasMember>("TemplateAktivitasMember");
        set => HttpData["TemplateAktivitasMember"] = value;
    }

    /// <summary>
    /// Table class for TemplateAktivitasMember
    /// </summary>
    public class TemplateAktivitasMember : DbTable
    {
        public override Dictionary<string, string> KeyFields { get; set; } = new() { // DN
            { "IdTemplateAktivitasMember", "IdTemplateAktivitasMember" },
        };
        ...
        public readonly DbField<SqlDbType> IdTemplateAktivitasMember;

        public readonly DbField<SqlDbType> IdTemplateAktivitas;

        public readonly DbField<SqlDbType> _Username;

        public readonly DbField<SqlDbType> Peran;
        ...
        // Constructor
        public TemplateAktivitasMember()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "TemplateAktivitasMember";
            Name = "TemplateAktivitasMember";
            Type = "TABLE";
            UpdateTable = "dbo.TemplateAktivitasMember"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // IdTemplateAktivitasMember
            IdTemplateAktivitasMember = new(this, "x_IdTemplateAktivitasMember", 3, SqlDbType.Int) {
                Name = "IdTemplateAktivitasMember",
                Expression = "[IdTemplateAktivitasMember]",
                BasicSearchExpression = "CAST([IdTemplateAktivitasMember] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[IdTemplateAktivitasMember]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitasMember", "IdTemplateAktivitasMember", "CustomMsg"),
                IsUpload = false
            };
            IdTemplateAktivitasMember.Raw = true;
            Fields.Add("IdTemplateAktivitasMember", IdTemplateAktivitasMember);
            ...
            IdTemplateAktivitas = new(this, "x_IdTemplateAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitasMember", "IdTemplateAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            _Username = new(this, "x__Username", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitasMember", "_Username", "CustomMsg"),
                IsUpload = false
            };
            _Username.Lookup = new Lookup<DbField>(_Username, "TemplateAktivitasMember", true, "Username", new List<string> {"Username", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Username", _Username);

            // Peran
            Peran = new(this, "x_Peran", 200, SqlDbType.VarChar) {
                Name = "Peran",
                Expression = "[Peran]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Peran]",
                DateTimeFormat = -1,
                VirtualExpression = "[Peran]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitasMember", "Peran", "CustomMsg"),
                IsUpload = false
            };
            Peran.Lookup = new Lookup<DbField>(Peran, "TemplateAktivitasMember", true, "Peran", new List<string> {"Peran", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Peran", Peran);
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitasMember", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            DibuatOleh.Lookup = new Lookup<DbField>(DibuatOleh, "TemplateAktivitasMember", true, "DibuatOleh", new List<string> {"DibuatOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("TemplateAktivitasMember", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            TanggalDibuat.Raw = true;
            TanggalDibuat.Lookup = new Lookup<DbField>(TanggalDibuat, "TemplateAktivitasMember", true, "TanggalDibuat", new List<string> {"TanggalDibuat", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitasMember", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            DiperbaruiOleh.Lookup = new Lookup<DbField>(DiperbaruiOleh, "TemplateAktivitasMember", true, "DiperbaruiOleh", new List<string> {"DiperbaruiOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("TemplateAktivitasMember", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiperbarui.Raw = true;
            TanggalDiperbarui.Lookup = new Lookup<DbField>(TanggalDiperbarui, "TemplateAktivitasMember", true, "TanggalDiperbarui", new List<string> {"TanggalDiperbarui", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        {
            get => _sqlFrom ?? "dbo.TemplateAktivitasMember";
            set => _sqlFrom = value;
        }
            ...
            where TEntity : class
        {
            ...
            var prop = typeof(TEntity).GetRuntimeProperties().FirstOrDefault(p => p.GetCustomAttribute(typeof(ColumnAttribute)) is ColumnAttribute attr &&
                attr.Name == "IdTemplateAktivitasMember");
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.TemplateAktivitasMember type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdTemplateAktivitasMember"))
                    row["IdTemplateAktivitasMember"] = lastInsertedId;
                else
                    row.Add("IdTemplateAktivitasMember", lastInsertedId);
                IdTemplateAktivitasMember.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                IdTemplateAktivitasMember.DbValue = row["IdTemplateAktivitasMember"]; // Set DB value only
                IdTemplateAktivitas.DbValue = row["IdTemplateAktivitas"]; // Set DB value only
                _Username.DbValue = row["Username"]; // Set DB value only
                Peran.DbValue = row["Peran"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[IdTemplateAktivitasMember] = @IdTemplateAktivitasMember@";
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "TemplateAktivitasMemberList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "TemplateAktivitasMemberView" => Language.Phrase("View"),
                "TemplateAktivitasMemberEdit" => Language.Phrase("Edit"),
                "TemplateAktivitasMemberAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TemplateAktivitasMemberView",
                Config.ApiAddAction => "TemplateAktivitasMemberAdd",
                Config.ApiEditAction => "TemplateAktivitasMemberEdit",
                Config.ApiDeleteAction => "TemplateAktivitasMemberDelete",
                Config.ApiListAction => "TemplateAktivitasMemberList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TemplateAktivitasMemberList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TemplateAktivitasMemberView", parm);
            else
                url = KeyUrl("TemplateAktivitasMemberView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TemplateAktivitasMemberAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "TemplateAktivitasMemberAdd?" + parm;
            else
                url = "TemplateAktivitasMemberAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TemplateAktivitasMemberEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TemplateAktivitasMemberList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TemplateAktivitasMemberAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TemplateAktivitasMemberList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("TemplateAktivitasMemberDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdTemplateAktivitasMember\":" + ConvertToJson(IdTemplateAktivitasMember.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdTemplateAktivitasMember.CurrentValue)) {
                url += "/" + IdTemplateAktivitasMember.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdTemplateAktivitasMember", out object? v0)) { // IdTemplateAktivitasMember // DN
                    key = UrlDecode(v0); // DN
                } else if (IsApi() && !Empty(keyValues)) {
                    key = keyValues[0];
                } else {
                    key = Param("IdTemplateAktivitasMember");
                }
                keysList.Add(key);
            }
            // Check keys
            foreach (var keys in keysList) {
                if (KeyFields.Count > 1 && (!IsArray(keys) || keys.Length != KeyFields.Count))
                    continue;
                if (!IsNumeric(keys)) // IdTemplateAktivitasMember
                    continue;
                result.Add(keys);
            }
            return result;
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdTemplateAktivitasMember.CurrentValue = keys;
                else
                    IdTemplateAktivitasMember.OldValue = keys;
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            IdTemplateAktivitasMember.SetDbValue(row["IdTemplateAktivitasMember"]);
            IdTemplateAktivitas.SetDbValue(row["IdTemplateAktivitas"]);
            _Username.SetDbValue(row["Username"]);
            Peran.SetDbValue(row["Peran"]);
        ...
        {
            string pageName = "TemplateAktivitasMemberList";
        ...
        public async Task RenderListRow()
        {
            ...
            // IdTemplateAktivitasMember
            IdTemplateAktivitasMember.ViewValue = IdTemplateAktivitasMember.CurrentValue;
            IdTemplateAktivitasMember.ViewCustomAttributes = "";
            ...
            if (!Empty(curVal)) {
                if (IdTemplateAktivitas.Lookup != null && IsDictionary(IdTemplateAktivitas.Lookup?.Options) && IdTemplateAktivitas.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    ...
                    string? sqlWrk = IdTemplateAktivitas.Lookup?.GetSql(false, filterWrk, null, this, true, true);
            ...
            // Peran
            Peran.ViewValue = ConvertToString(Peran.CurrentValue); // DN
            Peran.ViewCustomAttributes = "";
            ...
            // IdTemplateAktivitasMember
            IdTemplateAktivitasMember.HrefValue = "";
            IdTemplateAktivitasMember.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // IdTemplateAktivitasMember
            IdTemplateAktivitasMember.SetupEditAttributes();
            IdTemplateAktivitasMember.EditValue = IdTemplateAktivitasMember.CurrentValue;
            IdTemplateAktivitasMember.ViewCustomAttributes = "";
            ...
            // Peran
            Peran.SetupEditAttributes();
            if (!Peran.Raw)
                Peran.CurrentValue = HtmlDecode(Peran.CurrentValue);
            Peran.EditValue = Peran.CurrentValue;
            Peran.PlaceHolder = RemoveHtml(Peran.Caption);
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(IdTemplateAktivitasMember);
                        doc.ExportCaption(IdTemplateAktivitas);
                        doc.ExportCaption(_Username);
                        doc.ExportCaption(Peran);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(IdTemplateAktivitasMember);
                            await doc.ExportField(IdTemplateAktivitas);
                            await doc.ExportField(_Username);
                            await doc.ExportField(Peran);
