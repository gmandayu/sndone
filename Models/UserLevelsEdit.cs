...
public partial class SnDOne {
    ...
    public class UserLevelsEditBase : UserLevels
    {
        ...
        // Constructor
        public UserLevelsEditBase(Controller? controller)
        {
        ...
        // Constructor
        public UserLevelsEditBase() : this(null) { }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            SetNormalField(UserLevelID, "UserLevelID", "x_UserLevelID");
        ...
        protected void RestoreEditFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("UserLevelName", out value)) // UserLevelName
                UserLevelName.CurrentValue = value;
        }
