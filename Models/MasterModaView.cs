...
public partial class SnDOne {
    ...
    /// masterModaView
    /// </summary>
    public static MasterModaView masterModaView
    {
        get => HttpData.Get<MasterModaView>("masterModaView")!;
        set => HttpData["masterModaView"] = value;
    }

    /// <summary>
    /// Page class for MasterModa
    /// </summary>
    public class MasterModaView : MasterModaViewBase
    {
        // Constructor
        public MasterModaView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterModaView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterModaViewBase : MasterModa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterModaView";
        ...
        public MasterModaViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdModa"] = keys[0];
            } else {
                RecordKeys["IdModa"] = RouteValues.TryGetValue("IdModa", out obj) && obj != null ? UrlDecode(obj) : Get("IdModa"); // DN
            }
        ...
        // Page name
        public string PageName => "MasterModaView";
        ...
        // Constructor
        public MasterModaViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdModa", out v) && !Empty(v)) { // DN
                IdModa.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdModa"] = IdModa.QueryValue;
            } else if (Get("IdModa", out sv)) {
                IdModa.QueryValue = sv.ToString();
                RecordKeys["IdModa"] = IdModa.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdModa.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdModa"] = IdModa.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "MasterModaList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterModaList"); // Return to list page
                            }
                        }
                    break;
            }
