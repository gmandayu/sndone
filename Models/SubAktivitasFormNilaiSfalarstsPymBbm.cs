...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormNilaiSfalarstsPymBbm
    /// </summary>
    [MaybeNull]
    public static SubAktivitasFormNilaiSfalarstsPymBbm subAktivitasFormNilaiSfalarstsPymBbm
    {
        get => HttpData.Resolve<SubAktivitasFormNilaiSfalarstsPymBbm>("SubAktivitasFormNilaiSFALARSTSPymBBM");
        set => HttpData["SubAktivitasFormNilaiSFALARSTSPymBBM"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasFormNilaiSFALARSTSPymBBM
    /// </summary>
    public class SubAktivitasFormNilaiSfalarstsPymBbm : DbTable
    {
        ...
        public readonly DbField<SqlDbType> SFAL_klobs;

        public readonly DbField<SqlDbType> SFAL_kl15;

        public readonly DbField<SqlDbType> SFAL_barrels;

        public readonly DbField<SqlDbType> SFAL_lt;

        public readonly DbField<SqlDbType> SFAL_mt;

        public readonly DbField<SqlDbType> AR_klobs;

        public readonly DbField<SqlDbType> AR_kl15;

        public readonly DbField<SqlDbType> AR_barrels;

        public readonly DbField<SqlDbType> AR_lt;

        public readonly DbField<SqlDbType> AR_mt;
        ...
        // Constructor
        public SubAktivitasFormNilaiSfalarstsPymBbm()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasFormNilaiSFALARSTSPymBBM";
            Name = "SubAktivitasFormNilaiSFALARSTSPymBBM";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasFormNilaiSFALARSTSPymBBM"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            // SFAL_klobs
            SFAL_klobs = new(this, "x_SFAL_klobs", 202, SqlDbType.NVarChar) {
                Name = "SFAL_klobs",
                Expression = "[SFAL_klobs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAL_klobs]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAL_klobs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "SFAL_klobs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAL_klobs", SFAL_klobs);

            // SFAL_kl15
            SFAL_kl15 = new(this, "x_SFAL_kl15", 202, SqlDbType.NVarChar) {
                Name = "SFAL_kl15",
                Expression = "[SFAL_kl15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAL_kl15]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAL_kl15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "SFAL_kl15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAL_kl15", SFAL_kl15);

            // SFAL_barrels
            SFAL_barrels = new(this, "x_SFAL_barrels", 202, SqlDbType.NVarChar) {
                Name = "SFAL_barrels",
                Expression = "[SFAL_barrels]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAL_barrels]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAL_barrels]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "SFAL_barrels", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAL_barrels", SFAL_barrels);

            // SFAL_lt
            SFAL_lt = new(this, "x_SFAL_lt", 202, SqlDbType.NVarChar) {
                Name = "SFAL_lt",
                Expression = "[SFAL_lt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAL_lt]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAL_lt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "SFAL_lt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAL_lt", SFAL_lt);

            // SFAL_mt
            SFAL_mt = new(this, "x_SFAL_mt", 202, SqlDbType.NVarChar) {
                Name = "SFAL_mt",
                Expression = "[SFAL_mt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAL_mt]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAL_mt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "SFAL_mt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAL_mt", SFAL_mt);

            // AR_klobs
            AR_klobs = new(this, "x_AR_klobs", 202, SqlDbType.NVarChar) {
                Name = "AR_klobs",
                Expression = "[AR_klobs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AR_klobs]",
                DateTimeFormat = -1,
                VirtualExpression = "[AR_klobs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "AR_klobs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AR_klobs", AR_klobs);

            // AR_kl15
            AR_kl15 = new(this, "x_AR_kl15", 202, SqlDbType.NVarChar) {
                Name = "AR_kl15",
                Expression = "[AR_kl15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AR_kl15]",
                DateTimeFormat = -1,
                VirtualExpression = "[AR_kl15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "AR_kl15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AR_kl15", AR_kl15);

            // AR_barrels
            AR_barrels = new(this, "x_AR_barrels", 202, SqlDbType.NVarChar) {
                Name = "AR_barrels",
                Expression = "[AR_barrels]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AR_barrels]",
                DateTimeFormat = -1,
                VirtualExpression = "[AR_barrels]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "AR_barrels", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AR_barrels", AR_barrels);

            // AR_lt
            AR_lt = new(this, "x_AR_lt", 202, SqlDbType.NVarChar) {
                Name = "AR_lt",
                Expression = "[AR_lt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AR_lt]",
                DateTimeFormat = -1,
                VirtualExpression = "[AR_lt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "AR_lt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AR_lt", AR_lt);

            // AR_mt
            AR_mt = new(this, "x_AR_mt", 202, SqlDbType.NVarChar) {
                Name = "AR_mt",
                Expression = "[AR_mt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AR_mt]",
                DateTimeFormat = -1,
                VirtualExpression = "[AR_mt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "AR_mt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AR_mt", AR_mt);
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormNilaiSFALARSTSPymBBM", "userInput", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasFormNilaiSFALARSTSPymBBM";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasFormNilaiSfalarstspymBbm type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                SFAL_klobs.DbValue = row["SFAL_klobs"]; // Set DB value only
                SFAL_kl15.DbValue = row["SFAL_kl15"]; // Set DB value only
                SFAL_barrels.DbValue = row["SFAL_barrels"]; // Set DB value only
                SFAL_lt.DbValue = row["SFAL_lt"]; // Set DB value only
                SFAL_mt.DbValue = row["SFAL_mt"]; // Set DB value only
                AR_klobs.DbValue = row["AR_klobs"]; // Set DB value only
                AR_kl15.DbValue = row["AR_kl15"]; // Set DB value only
                AR_barrels.DbValue = row["AR_barrels"]; // Set DB value only
                AR_lt.DbValue = row["AR_lt"]; // Set DB value only
                AR_mt.DbValue = row["AR_mt"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasFormNilaiSfalarstsPymBbmList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasFormNilaiSfalarstsPymBbmView" => Language.Phrase("View"),
                "SubAktivitasFormNilaiSfalarstsPymBbmEdit" => Language.Phrase("Edit"),
                "SubAktivitasFormNilaiSfalarstsPymBbmAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasFormNilaiSfalarstsPymBbmView",
                Config.ApiAddAction => "SubAktivitasFormNilaiSfalarstsPymBbmAdd",
                Config.ApiEditAction => "SubAktivitasFormNilaiSfalarstsPymBbmEdit",
                Config.ApiDeleteAction => "SubAktivitasFormNilaiSfalarstsPymBbmDelete",
                Config.ApiListAction => "SubAktivitasFormNilaiSfalarstsPymBbmList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasFormNilaiSfalarstsPymBbmList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasFormNilaiSfalarstsPymBbmView", parm);
            else
                url = KeyUrl("SubAktivitasFormNilaiSfalarstsPymBbmView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasFormNilaiSfalarstsPymBbmAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasFormNilaiSfalarstsPymBbmAdd?" + parm;
            else
                url = "SubAktivitasFormNilaiSfalarstsPymBbmAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormNilaiSfalarstsPymBbmEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormNilaiSfalarstsPymBbmList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormNilaiSfalarstsPymBbmAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormNilaiSfalarstsPymBbmList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasFormNilaiSfalarstsPymBbmDelete", parm)); // DN
        }
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            ...
            AR_klobs.SetDbValue(row["AR_klobs"]);
            AR_kl15.SetDbValue(row["AR_kl15"]);
            AR_barrels.SetDbValue(row["AR_barrels"]);
            AR_lt.SetDbValue(row["AR_lt"]);
            AR_mt.SetDbValue(row["AR_mt"]);
        ...
        {
            string pageName = "SubAktivitasFormNilaiSfalarstsPymBbmList";
        ...
        public async Task RenderListRow()
        {
            ...
            // AR_klobs
            AR_klobs.ViewValue = ConvertToString(AR_klobs.CurrentValue); // DN
            AR_klobs.ViewCustomAttributes = "";

            // AR_kl15
            AR_kl15.ViewValue = ConvertToString(AR_kl15.CurrentValue); // DN
            AR_kl15.ViewCustomAttributes = "";

            // AR_barrels
            AR_barrels.ViewValue = ConvertToString(AR_barrels.CurrentValue); // DN
            AR_barrels.ViewCustomAttributes = "";

            // AR_lt
            AR_lt.ViewValue = ConvertToString(AR_lt.CurrentValue); // DN
            AR_lt.ViewCustomAttributes = "";

            // AR_mt
            AR_mt.ViewValue = ConvertToString(AR_mt.CurrentValue); // DN
            AR_mt.ViewCustomAttributes = "";
            ...
            // AR_klobs
            AR_klobs.HrefValue = "";
            AR_klobs.TooltipValue = "";

            // AR_kl15
            AR_kl15.HrefValue = "";
            AR_kl15.TooltipValue = "";

            // AR_barrels
            AR_barrels.HrefValue = "";
            AR_barrels.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            SFAL_klobs.EditValue = SFAL_klobs.CurrentValue;
            ...
            SFAL_kl15.EditValue = SFAL_kl15.CurrentValue;
            ...
            SFAL_barrels.EditValue = SFAL_barrels.CurrentValue;
            ...
            SFAL_lt.EditValue = SFAL_lt.CurrentValue;
            ...
            SFAL_mt.EditValue = SFAL_mt.CurrentValue;
            SFAL_mt.PlaceHolder = RemoveHtml(SFAL_mt.Caption);

            // AR_klobs
            AR_klobs.SetupEditAttributes();
            if (!AR_klobs.Raw)
                AR_klobs.CurrentValue = HtmlDecode(AR_klobs.CurrentValue);
            AR_klobs.EditValue = AR_klobs.CurrentValue;
            AR_klobs.PlaceHolder = RemoveHtml(AR_klobs.Caption);

            // AR_kl15
            AR_kl15.SetupEditAttributes();
            if (!AR_kl15.Raw)
                AR_kl15.CurrentValue = HtmlDecode(AR_kl15.CurrentValue);
            AR_kl15.EditValue = AR_kl15.CurrentValue;
            AR_kl15.PlaceHolder = RemoveHtml(AR_kl15.Caption);

            // AR_barrels
            AR_barrels.SetupEditAttributes();
            if (!AR_barrels.Raw)
                AR_barrels.CurrentValue = HtmlDecode(AR_barrels.CurrentValue);
            AR_barrels.EditValue = AR_barrels.CurrentValue;
            AR_barrels.PlaceHolder = RemoveHtml(AR_barrels.Caption);

            // AR_lt
            AR_lt.SetupEditAttributes();
            if (!AR_lt.Raw)
                AR_lt.CurrentValue = HtmlDecode(AR_lt.CurrentValue);
            AR_lt.EditValue = AR_lt.CurrentValue;
            AR_lt.PlaceHolder = RemoveHtml(AR_lt.Caption);

            // AR_mt
            AR_mt.SetupEditAttributes();
            if (!AR_mt.Raw)
                AR_mt.CurrentValue = HtmlDecode(AR_mt.CurrentValue);
            AR_mt.EditValue = AR_mt.CurrentValue;
            AR_mt.PlaceHolder = RemoveHtml(AR_mt.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(SFAL_klobs);
                        doc.ExportCaption(SFAL_kl15);
                        doc.ExportCaption(SFAL_barrels);
                        doc.ExportCaption(SFAL_lt);
                        doc.ExportCaption(SFAL_mt);
                        doc.ExportCaption(AR_klobs);
                        doc.ExportCaption(AR_kl15);
                        doc.ExportCaption(AR_barrels);
                        doc.ExportCaption(AR_lt);
                        doc.ExportCaption(AR_mt);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(SFAL_klobs);
                            await doc.ExportField(SFAL_kl15);
                            await doc.ExportField(SFAL_barrels);
                            await doc.ExportField(SFAL_lt);
                            await doc.ExportField(SFAL_mt);
                            await doc.ExportField(AR_klobs);
                            await doc.ExportField(AR_kl15);
                            await doc.ExportField(AR_barrels);
                            await doc.ExportField(AR_lt);
                            await doc.ExportField(AR_mt);
