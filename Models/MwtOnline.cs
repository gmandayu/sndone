...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static MwtOnline mwtOnline
    {
        get => HttpData.Resolve<MwtOnline>("MWTOnline");
        set => HttpData["MWTOnline"] = value;
    }

    /// <summary>
    /// Table class for MWTOnline
    /// </summary>
    public class MwtOnline : DbTable
    {
        ...
        public readonly DbField<SqlDbType> NoMWTOnline;
        ...
        public readonly DbField<SqlDbType> TaskList;

        public readonly DbField<SqlDbType> Status;

        public readonly DbField<SqlDbType> _File;

        public readonly DbField<SqlDbType> DownloadFile;

        public readonly DbField<SqlDbType> KeteranganFile;

        public readonly DbField<SqlDbType> StatusEmail;

        public readonly DbField<SqlDbType> CreatedBy;

        public readonly DbField<SqlDbType> CreatedDate;

        public readonly DbField<SqlDbType> LastUpdatedBy;

        public readonly DbField<SqlDbType> LastUpdatedDate;

        public readonly DbField<SqlDbType> CompletedBy;

        public readonly DbField<SqlDbType> CompletedDate;
        ...
        public MwtOnline()
        {
            ...
            Name = "MWTOnline";
            Type = "TABLE";
            UpdateTable = "dbo.MWTOnline"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new(this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MWTOnline", "Id", "CustomMsg"),
                IsUpload = false
            };
            Id.Raw = true;
            Fields.Add("Id", Id);
            ...
            // NoMWTOnline
            NoMWTOnline = new(this, "x_NoMWTOnline", 202, SqlDbType.NVarChar) {
                Name = "NoMWTOnline",
                Expression = "[NoMWTOnline]",
                BasicSearchExpression = "[NoMWTOnline]",
                DateTimeFormat = -1,
                VirtualExpression = "[NoMWTOnline]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MWTOnline", "NoMWTOnline", "CustomMsg"),
                IsUpload = false
            };
            NoMWTOnline.Lookup = new Lookup<DbField>(NoMWTOnline, "MWTOnline", true, "NoMWTOnline", new List<string> {"NoMWTOnline", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NoMWTOnline", NoMWTOnline);

            // LinkRedirect
            LinkRedirect = new(this, "x_LinkRedirect", 202, SqlDbType.NVarChar) {
                Name = "LinkRedirect",
                Expression = "'<a href=MWTOnlineEdit/' + CAST(Id AS NVARCHAR(50))+'>'+CAST(NoMWTOnline AS NVARCHAR(100))+'</a>'",
                UseBasicSearch = true,
                BasicSearchExpression = "'<a href=MWTOnlineEdit/' + CAST(Id AS NVARCHAR(50))+'>'+CAST(NoMWTOnline AS NVARCHAR(100))+'</a>'",
                DateTimeFormat = -1,
                VirtualExpression = "'<a href=MWTOnlineEdit/' + CAST(Id AS NVARCHAR(50))+'>'+CAST(NoMWTOnline AS NVARCHAR(100))+'</a>'",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "LinkRedirect", "CustomMsg"),
                IsUpload = false
            };
            LinkRedirect.Lookup = new Lookup<DbField>(LinkRedirect, "MWTOnline", true, "LinkRedirect", new List<string> {"LinkRedirect", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("LinkRedirect", LinkRedirect);

            // LookupPlant
            LookupPlant = new(this, "x_LookupPlant", 200, SqlDbType.VarChar) {
                Name = "LookupPlant",
                Expression = "''",
                ...
                CustomMessage = Language.FieldPhrase("MWTOnline", "LookupPlant", "CustomMsg"),
                IsUpload = false
            };
            LookupPlant.Lookup = new Lookup<DbField>(LookupPlant, "MWTOnline", true, "LookupPlant", new List<string> {"LookupPlant", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            IdPlant = new(this, "x_IdPlant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MWTOnline", "IdPlant", "CustomMsg"),
                IsUpload = false
            };
            IdPlant.Raw = true;
            ...
            // TaskList
            TaskList = new(this, "x_TaskList", 203, SqlDbType.NText) {
                Name = "TaskList",
                Expression = "[TaskList]",
                BasicSearchExpression = "[TaskList]",
                DateTimeFormat = -1,
                VirtualExpression = "[TaskList]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "TaskList", "CustomMsg"),
                IsUpload = false
            };
            TaskList.Lookup = new Lookup<DbField>(TaskList, "MWTOnline", true, "TaskList", new List<string> {"TaskList", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("TaskList", TaskList);
            ...
            Status = new(this, "x_Status", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "Status", "CustomMsg"),
                IsUpload = false
            };
            Status.Lookup = new Lookup<DbField>(Status, "MWTOnline", true, "Status", new List<string> {"Status", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Status", Status);

            // File
            _File = new(this, "x__File", 202, SqlDbType.NVarChar) {
                Name = "File",
                Expression = "[File]",
                BasicSearchExpression = "[File]",
                DateTimeFormat = -1,
                VirtualExpression = "[File]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "_File", "CustomMsg"),
                IsUpload = false
            };
            _File.Lookup = new Lookup<DbField>(_File, "MWTOnline", true, "File", new List<string> {"File", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("File", _File);

            // DownloadFile
            DownloadFile = new(this, "x_DownloadFile", 202, SqlDbType.NVarChar) {
                Name = "DownloadFile",
                Expression = "CASE WHEN [File] IS NOT NULL THEN '<a class=' + CHAR(34) + 'btn-download-mwt btn btn-primary' + CHAR(34) + ' data-id=' + CAST(Id AS NVARCHAR(50)) +  ' ><i class='+CHAR(34) + 'fas fa-download me-2' + CHAR(34)+'></i> Download Files</a>' ELSE 'Not Uploaded' END",
                UseBasicSearch = true,
                BasicSearchExpression = "CASE WHEN [File] IS NOT NULL THEN '<a class=' + CHAR(34) + 'btn-download-mwt btn btn-primary' + CHAR(34) + ' data-id=' + CAST(Id AS NVARCHAR(50)) +  ' ><i class='+CHAR(34) + 'fas fa-download me-2' + CHAR(34)+'></i> Download Files</a>' ELSE 'Not Uploaded' END",
                DateTimeFormat = -1,
                VirtualExpression = "CASE WHEN [File] IS NOT NULL THEN '<a class=' + CHAR(34) + 'btn-download-mwt btn btn-primary' + CHAR(34) + ' data-id=' + CAST(Id AS NVARCHAR(50)) +  ' ><i class='+CHAR(34) + 'fas fa-download me-2' + CHAR(34)+'></i> Download Files</a>' ELSE 'Not Uploaded' END",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "DownloadFile", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("DownloadFile", DownloadFile);

            // KeteranganFile
            KeteranganFile = new(this, "x_KeteranganFile", 200, SqlDbType.VarChar) {
                Name = "KeteranganFile",
                Expression = "''",
                BasicSearchExpression = "''",
                DateTimeFormat = -1,
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "KeteranganFile", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("KeteranganFile", KeteranganFile);

            // StatusEmail
            StatusEmail = new(this, "x_StatusEmail", 202, SqlDbType.NVarChar) {
                Name = "StatusEmail",
                Expression = "[StatusEmail]",
                BasicSearchExpression = "[StatusEmail]",
                DateTimeFormat = -1,
                VirtualExpression = "[StatusEmail]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "StatusEmail", "CustomMsg"),
                IsUpload = false
            };
            StatusEmail.Lookup = new Lookup<DbField>(StatusEmail, "MWTOnline", true, "StatusEmail", new List<string> {"StatusEmail", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("StatusEmail", StatusEmail);
            ...
            CreatedBy = new(this, "x_CreatedBy", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "CreatedBy", "CustomMsg"),
                IsUpload = false
            };
            CreatedBy.Lookup = new Lookup<DbField>(CreatedBy, "MWTOnline", true, "CreatedBy", new List<string> {"CreatedBy", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            CreatedBy.GetAutoUpdateValue = () => CurrentUserName();
            Fields.Add("CreatedBy", CreatedBy);

            // CreatedDate
            CreatedDate = new(this, "x_CreatedDate", 135, SqlDbType.DateTime) {
                Name = "CreatedDate",
                Expression = "[CreatedDate]",
                BasicSearchExpression = CastDateFieldForLike("[CreatedDate]", 10, "DB"),
                DateTimeFormat = 10,
                VirtualExpression = "[CreatedDate]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                UseFilter = true, // Table header filter
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(10)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "CreatedDate", "CustomMsg"),
                IsUpload = false
            };
            CreatedDate.Raw = true;
            CreatedDate.Lookup = new Lookup<DbField>(CreatedDate, "MWTOnline", true, "CreatedDate", new List<string> {"CreatedDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            CreatedDate.GetAutoUpdateValue = () => CurrentDateTime();
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedBy.Lookup = new Lookup<DbField>(LastUpdatedBy, "MWTOnline", true, "LastUpdatedBy", new List<string> {"LastUpdatedBy", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LastUpdatedDate = new(this, "x_LastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                BasicSearchExpression = CastDateFieldForLike("[LastUpdatedDate]", 10, "DB"),
                DateTimeFormat = 10,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(10)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "LastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedDate.Raw = true;
            LastUpdatedDate.Lookup = new Lookup<DbField>(LastUpdatedDate, "MWTOnline", true, "LastUpdatedDate", new List<string> {"LastUpdatedDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            LastUpdatedDate.GetAutoUpdateValue = () => CurrentDateTime();
            Fields.Add("LastUpdatedDate", LastUpdatedDate);

            // CompletedBy
            CompletedBy = new(this, "x_CompletedBy", 202, SqlDbType.NVarChar) {
                Name = "CompletedBy",
                Expression = "[CompletedBy]",
                UseBasicSearch = true,
                BasicSearchExpression = "[CompletedBy]",
                DateTimeFormat = -1,
                VirtualExpression = "[CompletedBy]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "CompletedBy", "CustomMsg"),
                IsUpload = false
            };
            CompletedBy.Lookup = new Lookup<DbField>(CompletedBy, "MWTOnline", true, "CompletedBy", new List<string> {"CompletedBy", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("CompletedBy", CompletedBy);

            // CompletedDate
            CompletedDate = new(this, "x_CompletedDate", 135, SqlDbType.DateTime) {
                Name = "CompletedDate",
                Expression = "[CompletedDate]",
                BasicSearchExpression = CastDateFieldForLike("[CompletedDate]", 10, "DB"),
                DateTimeFormat = 10,
                VirtualExpression = "[CompletedDate]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(10)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MWTOnline", "CompletedDate", "CustomMsg"),
                IsUpload = false
            };
            CompletedDate.Raw = true;
            CompletedDate.Lookup = new Lookup<DbField>(CompletedDate, "MWTOnline", true, "CompletedDate", new List<string> {"CompletedDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("CompletedDate", CompletedDate);
        ...
        {
            get {
                string select = "*, '<a href=MWTOnlineEdit/' + CAST(Id AS NVARCHAR(50))+'>'+CAST(NoMWTOnline AS NVARCHAR(100))+'</a>' AS [LinkRedirect], '' AS [LookupPlant], CASE WHEN [File] IS NOT NULL THEN '<a class=' + CHAR(34) + 'btn-download-mwt btn btn-primary' + CHAR(34) + ' data-id=' + CAST(Id AS NVARCHAR(50)) +  ' ><i class='+CHAR(34) + 'fas fa-download me-2' + CHAR(34)+'></i> Download Files</a>' ELSE 'Not Uploaded' END AS [DownloadFile], '' AS [KeteranganFile]";
                if (select == "*") {
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.Mwtonline type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                NoMWTOnline.DbValue = row["NoMWTOnline"]; // Set DB value only
                ...
                TaskList.DbValue = row["TaskList"]; // Set DB value only
                Status.DbValue = row["Status"]; // Set DB value only
                _File.DbValue = row["File"]; // Set DB value only
                DownloadFile.DbValue = row["DownloadFile"]; // Set DB value only
                KeteranganFile.DbValue = row["KeteranganFile"]; // Set DB value only
                StatusEmail.DbValue = row["StatusEmail"]; // Set DB value only
                CreatedBy.DbValue = row["CreatedBy"]; // Set DB value only
                CreatedDate.DbValue = row["CreatedDate"]; // Set DB value only
                LastUpdatedBy.DbValue = row["LastUpdatedBy"]; // Set DB value only
                LastUpdatedDate.DbValue = row["LastUpdatedDate"]; // Set DB value only
                CompletedBy.DbValue = row["CompletedBy"]; // Set DB value only
                CompletedDate.DbValue = row["CompletedDate"]; // Set DB value only
            } catch {}
        }
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MwtOnlineView" => Language.Phrase("View"),
                "MwtOnlineEdit" => Language.Phrase("Edit"),
                "MwtOnlineAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MwtOnlineView",
                Config.ApiAddAction => "MwtOnlineAdd",
                Config.ApiEditAction => "MwtOnlineEdit",
                Config.ApiDeleteAction => "MwtOnlineDelete",
                Config.ApiListAction => "MwtOnlineList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MwtOnlineList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MwtOnlineView", parm);
            else
                url = KeyUrl("MwtOnlineView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MwtOnlineAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MwtOnlineEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MwtOnlineList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MwtOnlineAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MwtOnlineList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MwtOnlineDelete", parm)); // DN
        }
        ...
        public async Task RenderListRow()
        {
            ...
            // KeteranganFile
            KeteranganFile.ViewValue = KeteranganFile.CurrentValue;
            KeteranganFile.ViewCustomAttributes = "";
            ...
            // KeteranganFile
            KeteranganFile.HrefValue = "";
            KeteranganFile.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            _File.EditValue = _File.CurrentValue;
            ...
            DownloadFile.EditValue = DownloadFile.CurrentValue;
            DownloadFile.PlaceHolder = RemoveHtml(DownloadFile.Caption);

            // KeteranganFile
            KeteranganFile.SetupEditAttributes();
            KeteranganFile.EditValue = KeteranganFile.CurrentValue; // DN
            KeteranganFile.PlaceHolder = RemoveHtml(KeteranganFile.Caption);
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(NoMWTOnline);
                        doc.ExportCaption(LookupPlant);
                        doc.ExportCaption(IdPlant);
                        doc.ExportCaption(TaskList);
                        doc.ExportCaption(Status);
                        doc.ExportCaption(DownloadFile);
                        doc.ExportCaption(StatusEmail);
                        doc.ExportCaption(CreatedBy);
                        doc.ExportCaption(CreatedDate);
                        doc.ExportCaption(LastUpdatedBy);
                        doc.ExportCaption(LastUpdatedDate);
                        doc.ExportCaption(CompletedBy);
                        doc.ExportCaption(CompletedDate);
                    } else {
                        doc.ExportCaption(NoMWTOnline);
                        doc.ExportCaption(IdPlant);
                        doc.ExportCaption(TaskList);
                        doc.ExportCaption(Status);
                        doc.ExportCaption(_File);
                        doc.ExportCaption(CreatedBy);
                        doc.ExportCaption(CreatedDate);
                        doc.ExportCaption(LastUpdatedBy);
                        doc.ExportCaption(LastUpdatedDate);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(NoMWTOnline);
                            await doc.ExportField(LookupPlant);
                            await doc.ExportField(IdPlant);
                            await doc.ExportField(TaskList);
                            await doc.ExportField(Status);
                            await doc.ExportField(DownloadFile);
                            await doc.ExportField(StatusEmail);
                            await doc.ExportField(CreatedBy);
                            await doc.ExportField(CreatedDate);
                            await doc.ExportField(LastUpdatedBy);
                            await doc.ExportField(LastUpdatedDate);
                            await doc.ExportField(CompletedBy);
                            await doc.ExportField(CompletedDate);
                        } else {
                            await doc.ExportField(NoMWTOnline);
                            await doc.ExportField(IdPlant);
                            await doc.ExportField(TaskList);
                            await doc.ExportField(Status);
                            await doc.ExportField(_File);
                            await doc.ExportField(CreatedBy);
                            await doc.ExportField(CreatedDate);
                            await doc.ExportField(LastUpdatedBy);
                            await doc.ExportField(LastUpdatedDate);
        ...
        public void RecordsetSelecting(ref string filter) {
            ...
            if (!Empty(idPosition)) {
                string plantFilter = $"IdPlant IN (SELECT IdPlant FROM MappingPosition WHERE IdPosition = {AdjustSql(idPosition)})";
                AddFilter(ref filter, plantFilter);
            } else {
                AddFilter(ref filter, "0=1");
            }
        }
        ...
        public void RowInserted(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            ...
            try {
                ...
                if (serviceProvider != null) {
                    ...
                    if (hubContext != null) {
                        Microsoft.AspNetCore.SignalR.ClientProxyExtensions.SendAsync(
                ...
                if (Config.Debug) Console.WriteLine("SignalR Notification Error: " + ex.Message);
            }
        }
        ...
        public void RowUpdated(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            //Log("Row Updated");
            string oldStatus = rsold != null && rsold.ContainsKey("Status") ? rsold["Status"]?.ToString() : "";
            string newStatus = rsnew.ContainsKey("Status") ? rsnew["Status"]?.ToString() : "";
        ...
        public bool RowDeleting(Dictionary<string, object> rs) {
            string NoReferensi = rs.ContainsKey("NoMWTOnline") ? rs["NoMWTOnline"].ToString() : "";
            if (string.IsNullOrEmpty(NoReferensi)) {
                SuccessMessage = "Data MWT berhasil dihapus, namun gagal menghapus data Detail MWT";
                return true;
            }
            using (SqlConnection sqlConnection = GetConnection("Db").OpenConnection()) {
                string sqlData = "DELETE FROM MWTOnlineDetail WHERE NoReferensi = @NoReferensi;";
