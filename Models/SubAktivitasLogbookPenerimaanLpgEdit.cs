...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLogbookPenerimaanLpgEdit
    /// </summary>
    public static SubAktivitasLogbookPenerimaanLpgEdit subAktivitasLogbookPenerimaanLpgEdit
    {
        get => HttpData.Get<SubAktivitasLogbookPenerimaanLpgEdit>("subAktivitasLogbookPenerimaanLpgEdit")!;
        set => HttpData["subAktivitasLogbookPenerimaanLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasLogbookPenerimaanLPG
    /// </summary>
    public class SubAktivitasLogbookPenerimaanLpgEdit : SubAktivitasLogbookPenerimaanLpgEditBase
    {
        // Constructor
        public SubAktivitasLogbookPenerimaanLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasLogbookPenerimaanLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasLogbookPenerimaanLpgEditBase : SubAktivitasLogbookPenerimaanLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasLogbookPenerimaanLpgEdit";
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasLogbookPenerimaanLpgEdit";
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasLogbookPenerimaanLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasLogbookPenerimaanLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasLogbookPenerimaanLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasLogbookPenerimaanLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasLogbookPenerimaanLpgList")), "", TableVar, true);
            string pageId = "edit";
