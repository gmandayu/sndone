...
public partial class SnDOne {
    ...
    /// masterAreaAdd
    /// </summary>
    public static MasterAreaAdd masterAreaAdd
    {
        get => HttpData.Get<MasterAreaAdd>("masterAreaAdd")!;
        set => HttpData["masterAreaAdd"] = value;
    }

    /// <summary>
    /// Page class for MasterArea
    /// </summary>
    public class MasterAreaAdd : MasterAreaAddBase
    {
        // Constructor
        public MasterAreaAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterAreaAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterAreaAddBase : MasterArea
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterAreaAdd";
        ...
        // Constructor
        public MasterAreaAddBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "MasterAreaAdd";
        ...
        // Constructor
        public MasterAreaAddBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private string DetermineReturnUrl()
        {
            ...
            else if (GetPageName(returnUrl) == "MasterAreaView")
                returnUrl = ViewUrl;
            return returnUrl;
        }
        ...
        private void RestoreAddFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("Area", out value)) // Area
                Area.SetFormValue(ConvertToString(value));
        }
