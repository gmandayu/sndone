...
public partial class SnDOne {
    ...
    public class MasterPlantViewBase : MasterPlant
    {
        ...
        // Constructor
        public MasterPlantViewBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterPlantViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdPlant", out v) && !Empty(v))
                {
                IdPlant.QueryValue = UrlDecode(v);
                RecordKeys["IdPlant"] = IdPlant.QueryValue;
                return;
                }
                if (Get("IdPlant", out sv))
                {
