...
public partial class SnDOne {
    ...
    public class SubAktivitasLogbookPenerimaanStsPymLpgEditBase : SubAktivitasLogbookPenerimaanStsPymLpg
    {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanStsPymLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanStsPymLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasLogbookPenerimaanStsPymLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasLogbookPenerimaanStsPymLpgList") {
                                ...
                                returnUrl = "SubAktivitasLogbookPenerimaanStsPymLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
