...
public partial class SnDOne {
    ...
    public class SubaktivitasStartBongkarEditBase : SubaktivitasStartBongkar
    {
        ...
        // Constructor
        public SubaktivitasStartBongkarEditBase()
        {
        ...
        // Constructor
        public SubaktivitasStartBongkarEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasStartBongkarList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasStartBongkarList") {
                                ...
                                returnUrl = "SubaktivitasStartBongkarList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
