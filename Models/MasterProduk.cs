...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static MasterProduk masterProduk
    {
        get => HttpData.Resolve<MasterProduk>("MasterProduk");
        set => HttpData["MasterProduk"] = value;
    }

    /// <summary>
    /// Table class for MasterProduk
    /// </summary>
    public class MasterProduk : DbTable
    {
        ...
        public readonly DbField<SqlDbType> NoProduk;

        public readonly DbField<SqlDbType> NamaProduk;

        public readonly DbField<SqlDbType> TipeProduk;

        public readonly DbField<SqlDbType> DensityMin;

        public readonly DbField<SqlDbType> DensityMax;
        ...
        public MasterProduk()
        {
            ...
            Name = "MasterProduk";
            Type = "TABLE";
            UpdateTable = "dbo.MasterProduk"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // NoProduk
            NoProduk = new(this, "x_NoProduk", 202, SqlDbType.NVarChar) {
                Name = "NoProduk",
                Expression = "[NoProduk]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NoProduk]",
                DateTimeFormat = -1,
                VirtualExpression = "[NoProduk]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("MasterProduk", "NoProduk", "CustomMsg"),
                IsUpload = false
            };
            NoProduk.Raw = true;
            NoProduk.Lookup = new Lookup<DbField>(NoProduk, "MasterProduk", true, "NoProduk", new List<string> {"NoProduk", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NoProduk", NoProduk);

            // NamaProduk
            NamaProduk = new(this, "x_NamaProduk", 202, SqlDbType.NVarChar) {
                Name = "NamaProduk",
                Expression = "[NamaProduk]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NamaProduk]",
                DateTimeFormat = -1,
                VirtualExpression = "[NamaProduk]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MasterProduk", "NamaProduk", "CustomMsg"),
                IsUpload = false
            };
            NamaProduk.Lookup = new Lookup<DbField>(NamaProduk, "MasterProduk", true, "NamaProduk", new List<string> {"NamaProduk", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NamaProduk", NamaProduk);
            ...
            TipeProduk = new(this, "x_TipeProduk", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MasterProduk", "TipeProduk", "CustomMsg"),
                IsUpload = false
            };
            TipeProduk.Lookup = new Lookup<DbField>(TipeProduk, "MasterProduk", true, "TipeProduk", new List<string> {"TipeProduk", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("TipeProduk", TipeProduk);

            // DensityMin
            DensityMin = new(this, "x_DensityMin", 202, SqlDbType.NVarChar) {
                Name = "DensityMin",
                Expression = "[DensityMin]",
                UseBasicSearch = true,
                BasicSearchExpression = "[DensityMin]",
                DateTimeFormat = -1,
                VirtualExpression = "[DensityMin]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterProduk", "DensityMin", "CustomMsg"),
                IsUpload = false
            };
            DensityMin.Lookup = new Lookup<DbField>(DensityMin, "MasterProduk", true, "DensityMin", new List<string> {"DensityMin", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("DensityMin", DensityMin);

            // DensityMax
            DensityMax = new(this, "x_DensityMax", 202, SqlDbType.NVarChar) {
                Name = "DensityMax",
                Expression = "[DensityMax]",
                UseBasicSearch = true,
                BasicSearchExpression = "[DensityMax]",
                DateTimeFormat = -1,
                VirtualExpression = "[DensityMax]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("MasterProduk", "DensityMax", "CustomMsg"),
                IsUpload = false
            };
            DensityMax.Lookup = new Lookup<DbField>(DensityMax, "MasterProduk", true, "DensityMax", new List<string> {"DensityMax", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("DensityMax", DensityMax);
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MasterProduk type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                NoProduk.DbValue = row["NoProduk"]; // Set DB value only
                NamaProduk.DbValue = row["NamaProduk"]; // Set DB value only
                TipeProduk.DbValue = row["TipeProduk"]; // Set DB value only
                DensityMin.DbValue = row["DensityMin"]; // Set DB value only
                DensityMax.DbValue = row["DensityMax"]; // Set DB value only
            } catch {}
        }
        ...
        private string _sqlKeyFilter => "[NoProduk] = '@NoProduk@'";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MasterProdukView" => Language.Phrase("View"),
                "MasterProdukEdit" => Language.Phrase("Edit"),
                "MasterProdukAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MasterProdukView",
                Config.ApiAddAction => "MasterProdukAdd",
                Config.ApiEditAction => "MasterProdukEdit",
                Config.ApiDeleteAction => "MasterProdukDelete",
                Config.ApiListAction => "MasterProdukList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MasterProdukList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MasterProdukView", parm);
            else
                url = KeyUrl("MasterProdukView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MasterProdukAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MasterProdukEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterProdukList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MasterProdukAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterProdukList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MasterProdukDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"NoProduk\":" + ConvertToJson(NoProduk.CurrentValue, "string", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(NoProduk.CurrentValue)) {
                url += "/" + EncodeKeyValue(ConvertToString(NoProduk.CurrentValue));
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("NoProduk", out object? v0)) { // NoProduk // DN
                    key = UrlDecode(v0); // DN
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    NoProduk.CurrentValue = keys;
                else
                    NoProduk.OldValue = keys;
        ...
        {
            string pageName = "MasterProdukList";
        ...
        public async Task RenderEditRow()
        {
            ...
            NoProduk.EditValue = NoProduk.CurrentValue;
            ...
            NamaProduk.EditValue = NamaProduk.CurrentValue;
            ...
            DensityMin.EditValue = DensityMin.CurrentValue;
            ...
            DensityMax.EditValue = DensityMax.CurrentValue;
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(NoProduk);
                        doc.ExportCaption(NamaProduk);
                        doc.ExportCaption(TipeProduk);
                        doc.ExportCaption(DensityMin);
                        doc.ExportCaption(DensityMax);
                    } else {
                        doc.ExportCaption(NoProduk);
                        doc.ExportCaption(NamaProduk);
                        doc.ExportCaption(TipeProduk);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(NoProduk);
                            await doc.ExportField(NamaProduk);
                            await doc.ExportField(TipeProduk);
                            await doc.ExportField(DensityMin);
                            await doc.ExportField(DensityMax);
                        } else {
                            await doc.ExportField(NoProduk);
                            await doc.ExportField(NamaProduk);
                            await doc.ExportField(TipeProduk);
