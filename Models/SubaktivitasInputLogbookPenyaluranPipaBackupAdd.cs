...
public partial class SnDOne {
    ...
    public class SubaktivitasInputLogbookPenyaluranPipaBackupAddBase : SubaktivitasInputLogbookPenyaluranPipaBackup
    {
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupAddBase()
        {
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubaktivitasInputLogbookPenyaluranPipaBackupList"); // No matching record, return to List page // DN
                    }
                    break;
                    ...
                    if (res) { // Add successful
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasInputLogbookPenyaluranPipaBackupList") {
                                ...
                                returnUrl = "SubaktivitasInputLogbookPenyaluranPipaBackupList"; // Return list page content
                            }
                        }
