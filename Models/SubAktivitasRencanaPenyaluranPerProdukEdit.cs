...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasRencanaPenyaluranPerProdukEdit
    /// </summary>
    public static SubAktivitasRencanaPenyaluranPerProdukEdit subAktivitasRencanaPenyaluranPerProdukEdit
    {
        get => HttpData.Get<SubAktivitasRencanaPenyaluranPerProdukEdit>("subAktivitasRencanaPenyaluranPerProdukEdit")!;
        set => HttpData["subAktivitasRencanaPenyaluranPerProdukEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasRencanaPenyaluranPerProduk
    /// </summary>
    public class SubAktivitasRencanaPenyaluranPerProdukEdit : SubAktivitasRencanaPenyaluranPerProdukEditBase
    {
        // Constructor
        public SubAktivitasRencanaPenyaluranPerProdukEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasRencanaPenyaluranPerProdukEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasRencanaPenyaluranPerProdukEditBase : SubAktivitasRencanaPenyaluranPerProduk
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasRencanaPenyaluranPerProdukEdit";
        ...
        // Constructor
        public SubAktivitasRencanaPenyaluranPerProdukEditBase(Controller? controller)
        {
            TableName = "SubAktivitasRencanaPenyaluranPerProduk";
        ...
        if (controller != null)
            ...
            // Table object (subAktivitasRencanaPenyaluranPerProduk)
            if (subAktivitasRencanaPenyaluranPerProduk == null || subAktivitasRencanaPenyaluranPerProduk is SubAktivitasRencanaPenyaluranPerProduk)
                subAktivitasRencanaPenyaluranPerProduk = this;
        ...
        // Page name
        public string PageName => "SubAktivitasRencanaPenyaluranPerProdukEdit";
        ...
        // Constructor
        public SubAktivitasRencanaPenyaluranPerProdukEditBase() : this(null) { }
            ...
            string pageName = GetPageName(url);
                ...
                // List / View / Master View page
                    if (!SameString(pageName, ListUrl))
                    {
                        ...
                        result.Add("view", pageName == "SubAktivitasRencanaPenyaluranPerProdukView" ? "1" : "0"); // If View page, no primary button
                    }
                    else
                    {
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasRencanaPenyaluranPerProdukList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasRencanaPenyaluranPerProdukList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasRencanaPenyaluranPerProdukList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasRencanaPenyaluranPerProdukEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasRencanaPenyaluranPerProdukList")), "", TableVar, true);
            string pageId = "edit";
