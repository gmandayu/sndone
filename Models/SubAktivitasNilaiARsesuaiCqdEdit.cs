...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiARsesuaiCqdEditBase : SubAktivitasNilaiARsesuaiCqd
    {
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdEditBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiARsesuaiCqdList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiARsesuaiCqdList") {
                                ...
                                returnUrl = "SubAktivitasNilaiARsesuaiCqdList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
