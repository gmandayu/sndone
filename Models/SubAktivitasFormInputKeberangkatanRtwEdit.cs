...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputKeberangkatanRtwEdit
    /// </summary>
    public static SubAktivitasFormInputKeberangkatanRtwEdit subAktivitasFormInputKeberangkatanRtwEdit
    {
        get => HttpData.Get<SubAktivitasFormInputKeberangkatanRtwEdit>("subAktivitasFormInputKeberangkatanRtwEdit")!;
        set => HttpData["subAktivitasFormInputKeberangkatanRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputKeberangkatanRTW
    /// </summary>
    public class SubAktivitasFormInputKeberangkatanRtwEdit : SubAktivitasFormInputKeberangkatanRtwEditBase
    {
        // Constructor
        public SubAktivitasFormInputKeberangkatanRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputKeberangkatanRtwEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputKeberangkatanRtwEditBase : SubAktivitasFormInputKeberangkatanRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputKeberangkatanRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputKeberangkatanRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputKeberangkatanRtwList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputKeberangkatanRtwList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputKeberangkatanRtwList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputKeberangkatanRtwEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputKeberangkatanRtwList")), "", TableVar, true);
            string pageId = "edit";
