...
public partial class SnDOne {
    ...
    public class ControlRutinSecurityViewBase : ControlRutinSecurity
    {
        ...
        // Constructor
        public ControlRutinSecurityViewBase(Controller? controller)
        {
        ...
        // Constructor
        public ControlRutinSecurityViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdCRS", out v) && !Empty(v))
                {
                IdCRS.QueryValue = UrlDecode(v);
