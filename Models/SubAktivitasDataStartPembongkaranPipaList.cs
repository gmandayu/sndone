...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStartPembongkaranPipaListBase : SubAktivitasDataStartPembongkaranPipa
    {
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranPipaListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranPipaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            if (filter.TryGetValue("x_tglStartBongkar", out sv)) {
                RestoreFieldFilter(tglStartBongkar, filter, "tglStartBongkar", sv);
            }
