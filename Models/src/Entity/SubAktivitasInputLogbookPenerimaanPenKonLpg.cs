...
/**
 * Entity class for "SubAktivitasInputLogbookPenerimaanPenKonLPG" table
 */
[Table("SubAktivitasInputLogbookPenerimaanPenKonLPG")]
public class SubAktivitasInputLogbookPenerimaanPenKonLpg
{
    [Key("id")]
