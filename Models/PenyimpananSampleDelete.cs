...
public partial class SnDOne {
    /// <summary>
    /// penyimpananSampleDelete
    /// </summary>
    public static PenyimpananSampleDelete penyimpananSampleDelete
    {
        get => HttpData.Get<PenyimpananSampleDelete>("penyimpananSampleDelete")!;
        set => HttpData["penyimpananSampleDelete"] = value;
    }

    /// <summary>
    /// Page class for PenyimpananSample
    /// </summary>
    public class PenyimpananSampleDelete : PenyimpananSampleDeleteBase
    {
        // Constructor
        public PenyimpananSampleDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenyimpananSampleDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class PenyimpananSampleDeleteBase : PenyimpananSample
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penyimpananSampleDelete";
        ...
        // Constructor
        public PenyimpananSampleDeleteBase()
        {
        ...
        // Page name
        public string PageName => "PenyimpananSampleDelete";
        ...
        // Constructor
        public PenyimpananSampleDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("PenyimpananSampleList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("PenyimpananSampleList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                penyimpananSampleDelete?.PageRender();
            }
            return PageResult();
        }
