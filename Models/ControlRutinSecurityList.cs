...
public partial class SnDOne {
    ...
    public class ControlRutinSecurityListBase : ControlRutinSecurity
    {
        ...
        // Constructor
        public ControlRutinSecurityListBase(Controller? controller)
        {
        ...
        // Constructor
        public ControlRutinSecurityListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field IdCRS
            if (filter.TryGetValue("x_IdCRS", out sv)) {
                RestoreFieldFilter(IdCRS, filter, "IdCRS", sv);
            }

            // Field NomorCRS
            if (filter.TryGetValue("x_NomorCRS", out sv)) {
                RestoreFieldFilter(NomorCRS, filter, "NomorCRS", sv);
            }
            ...
            if (filter.TryGetValue("x_JumlahKetidaksesuaiaan", out sv)) {
                RestoreFieldFilter(JumlahKetidaksesuaiaan, filter, "JumlahKetidaksesuaiaan", sv);
            }

            // Field Catatan
            if (filter.TryGetValue("x_Catatan", out sv)) {
                RestoreFieldFilter(Catatan, filter, "Catatan", sv);
            }

            // Field DibuatOleh
            if (filter.TryGetValue("x_DibuatOleh", out sv)) {
                RestoreFieldFilter(DibuatOleh, filter, "DibuatOleh", sv);
            }
            ...
            if (filter.TryGetValue("x_DiperbaruiOleh", out sv)) {
                RestoreFieldFilter(DiperbaruiOleh, filter, "DiperbaruiOleh", sv);
            }
