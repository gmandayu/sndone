...
public partial class SnDOne {
    ...
    /// setUserModDelete
    /// </summary>
    public static SetUserModDelete setUserModDelete
    {
        get => HttpData.Get<SetUserModDelete>("setUserModDelete")!;
        set => HttpData["setUserModDelete"] = value;
    }

    /// <summary>
    /// Page class for SetUserMOD
    /// </summary>
    public class SetUserModDelete : SetUserModDeleteBase
    {
        // Constructor
        public SetUserModDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SetUserModDelete() : base()
        {
        }
        ...
        public override void PageLoad() {
            ...
            try
            {
                ...
                if (isAllowed)
                    return;
                var msg = "Anda tidak memiliki akses untuk menghapus Set User MOD. " +
            ...
            {
                Log("Guard SetUserMODDelete.Page_Load error: " + ex.Message);
                var listUrl = GetUrl("SetUserMODList");
    ...
    /// Page base class
    /// </summary>
    public class SetUserModDeleteBase : SetUserMod
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "setUserModDelete";
        ...
        // Page name
        public string PageName => "SetUserModDelete";
        ...
        // Constructor
        public SetUserModDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SetUserModList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SetUserModList"); // Return to list
                }
            }
