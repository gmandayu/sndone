...
public partial class SnDOne {
    ...
    /// bukuTamuView
    /// </summary>
    public static BukuTamuView bukuTamuView
    {
        get => HttpData.Get<BukuTamuView>("bukuTamuView")!;
        set => HttpData["bukuTamuView"] = value;
    }

    /// <summary>
    /// Page class for BukuTamu
    /// </summary>
    public class BukuTamuView : BukuTamuViewBase
    {
        // Constructor
        public BukuTamuView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public BukuTamuView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class BukuTamuViewBase : BukuTamu
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "bukuTamuView";
        ...
        // Page name
        public string PageName => "BukuTamuView";
        ...
        // Constructor
        public BukuTamuViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "BukuTamuList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("BukuTamuList"); // Return to list page
                            }
                        }
                    break;
            }
