...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasKapalBerangkatLpgEdit
    /// </summary>
    public static SubaktivitasKapalBerangkatLpgEdit subaktivitasKapalBerangkatLpgEdit
    {
        get => HttpData.Get<SubaktivitasKapalBerangkatLpgEdit>("subaktivitasKapalBerangkatLpgEdit")!;
        set => HttpData["subaktivitasKapalBerangkatLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasKapalBerangkatLPG
    /// </summary>
    public class SubaktivitasKapalBerangkatLpgEdit : SubaktivitasKapalBerangkatLpgEditBase
    {
        // Constructor
        public SubaktivitasKapalBerangkatLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasKapalBerangkatLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasKapalBerangkatLpgEditBase : SubaktivitasKapalBerangkatLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasKapalBerangkatLpgEdit";
        ...
        // Constructor
        public SubaktivitasKapalBerangkatLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasKapalBerangkatLpgEdit";
        ...
        // Constructor
        public SubaktivitasKapalBerangkatLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasKapalBerangkatLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasKapalBerangkatLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasKapalBerangkatLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasKapalBerangkatLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasKapalBerangkatLpgList")), "", TableVar, true);
            string pageId = "edit";
