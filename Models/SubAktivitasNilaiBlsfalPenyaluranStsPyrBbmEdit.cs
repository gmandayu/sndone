...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit
    /// </summary>
    public static SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit subAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit
    {
        get => HttpData.Get<SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit>("subAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit")!;
        set => HttpData["subAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiBLSFALPenyaluranSTSPyrBBM
    /// </summary>
    public class SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit : SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEditBase
    {
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEditBase : SubAktivitasNilaiBlsfalPenyaluranStsPyrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEditBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmList") {
                                ...
                                returnUrl = "SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiBlsfalPenyaluranStsPyrBbmEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiBlsfalPenyaluranStsPyrBbmList")), "", TableVar, true);
            string pageId = "edit";
