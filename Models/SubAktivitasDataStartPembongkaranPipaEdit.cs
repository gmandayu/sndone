...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStartPembongkaranPipaEditBase : SubAktivitasDataStartPembongkaranPipa
    {
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranPipaEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranPipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStartPembongkaranPipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStartPembongkaranPipaList") {
                                ...
                                returnUrl = "SubAktivitasDataStartPembongkaranPipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'tglStartBongkar' before field var 'x_tglStartBongkar'
            val = CurrentForm.HasValue("tglStartBongkar") ? CurrentForm.GetValue("tglStartBongkar") : CurrentForm.GetValue("x_tglStartBongkar");
            if (!tglStartBongkar.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("tglStartBongkar") && !CurrentForm.HasValue("x_tglStartBongkar")) // DN
                    tglStartBongkar.Visible = false; // Disable update for API request
                else
                    tglStartBongkar.SetFormValue(val, true, validate);
