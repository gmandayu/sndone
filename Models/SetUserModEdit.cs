...
public partial class SnDOne {
    ...
    public class SetUserModEditBase : SetUserMod
    {
        ...
        // Constructor
        public SetUserModEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SetUserModList"); // No matching record, return to list
                        }
                    break;
