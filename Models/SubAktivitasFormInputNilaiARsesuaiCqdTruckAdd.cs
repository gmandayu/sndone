...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiARsesuaiCqdTruckAdd
    /// </summary>
    public static SubAktivitasFormInputNilaiARsesuaiCqdTruckAdd subAktivitasFormInputNilaiARsesuaiCqdTruckAdd
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiARsesuaiCqdTruckAdd>("subAktivitasFormInputNilaiARsesuaiCqdTruckAdd")!;
        set => HttpData["subAktivitasFormInputNilaiARsesuaiCqdTruckAdd"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiARsesuaiCQDTruck
    /// </summary>
    public class SubAktivitasFormInputNilaiARsesuaiCqdTruckAdd : SubAktivitasFormInputNilaiARsesuaiCqdTruckAddBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiARsesuaiCqdTruckAddBase : SubAktivitasFormInputNilaiARsesuaiCqdTruck
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiARsesuaiCqdTruckAdd";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckAddBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiARsesuaiCqdTruckAdd";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckAddBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private IActionResult? HandleCopyAction(Dictionary<string, object>? rsold)
        {
            if (rsold == null) {
                ...
                return Terminate("SubAktivitasFormInputNilaiARsesuaiCqdTruckList");
            }
            return null;
        }
        ...
        private string DetermineReturnUrl()
        {
            string returnUrl = "";
            returnUrl = ReturnUrl;
            if (GetPageName(returnUrl) == "SubAktivitasFormInputNilaiARsesuaiCqdTruckList")
                returnUrl = AddMasterUrl(ListUrl);
            else if (GetPageName(returnUrl) == "SubAktivitasFormInputNilaiARsesuaiCqdTruckView")
                returnUrl = ViewUrl;
            return returnUrl;
        }
        ...
        private void HandleAjaxActions(ref string returnUrl)
        {
            if (IsModal && UseAjaxActions) {
                ...
                if (GetPageName(returnUrl) != "SubAktivitasFormInputNilaiARsesuaiCqdTruckList") {
                    ...
                    returnUrl = "SubAktivitasFormInputNilaiARsesuaiCqdTruckList";
                }
            }
        }
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputNilaiARsesuaiCqdTruckAdd?.PageRender();
                    }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputNilaiARsesuaiCqdTruckList")), "", TableVar, true);
