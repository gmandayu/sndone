...
public partial class SnDOne {
    /// <summary>
    /// formInputControlRutinSecurityDelete
    /// </summary>
    public static FormInputControlRutinSecurityDelete formInputControlRutinSecurityDelete
    {
        get => HttpData.Get<FormInputControlRutinSecurityDelete>("formInputControlRutinSecurityDelete")!;
        set => HttpData["formInputControlRutinSecurityDelete"] = value;
    }

    /// <summary>
    /// Page class for FormInputControlRutinSecurity
    /// </summary>
    public class FormInputControlRutinSecurityDelete : FormInputControlRutinSecurityDeleteBase
    {
        // Constructor
        public FormInputControlRutinSecurityDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public FormInputControlRutinSecurityDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class FormInputControlRutinSecurityDeleteBase : FormInputControlRutinSecurity
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "formInputControlRutinSecurityDelete";
        ...
        // Constructor
        public FormInputControlRutinSecurityDeleteBase()
        {
        ...
        // Page name
        public string PageName => "FormInputControlRutinSecurityDelete";
        ...
        // Constructor
        public FormInputControlRutinSecurityDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("FormInputControlRutinSecurityList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("FormInputControlRutinSecurityList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                formInputControlRutinSecurityDelete?.PageRender();
            }
            return PageResult();
        }
