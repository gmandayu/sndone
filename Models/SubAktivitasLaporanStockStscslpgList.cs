...
public partial class SnDOne {
    ...
    public class SubAktivitasLaporanStockStscslpgListBase : SubAktivitasLaporanStockStscslpg
    {
        ...
        // Constructor
        public SubAktivitasLaporanStockStscslpgListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasLaporanStockStscslpgListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field Tangki
            if (filter.TryGetValue("x_Tangki", out sv)) {
                RestoreFieldFilter(Tangki, filter, "Tangki", sv);
            }
        }
