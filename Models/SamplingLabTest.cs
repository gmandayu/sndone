...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static SamplingLabTest samplingLabTest
    {
        get => HttpData.Resolve<SamplingLabTest>("SamplingLabTest");
        set => HttpData["SamplingLabTest"] = value;
    }

    /// <summary>
    /// Table class for SamplingLabTest
    /// </summary>
    public class SamplingLabTest : DbTable
    {
        public override Dictionary<string, string> KeyFields { get; set; } = new() { // DN
            { "IdSamplingLabTest", "IdSamplingLabTest" },
        };
        ...
        public readonly DbField<SqlDbType> IdSamplingLabTest;

        public readonly DbField<SqlDbType> NomorSamplingLabTest;
        ...
        public readonly DbField<SqlDbType> LookupIdReferensi;

        public readonly DbField<SqlDbType> IdReferensi;
        ...
        // Constructor
        public SamplingLabTest()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SamplingLabTest";
            Name = "SamplingLabTest";
            Type = "TABLE";
            UpdateTable = "dbo.SamplingLabTest"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // IdSamplingLabTest
            IdSamplingLabTest = new(this, "x_IdSamplingLabTest", 3, SqlDbType.Int) {
                Name = "IdSamplingLabTest",
                Expression = "[IdSamplingLabTest]",
                BasicSearchExpression = "CAST([IdSamplingLabTest] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[IdSamplingLabTest]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "IdSamplingLabTest", "CustomMsg"),
                IsUpload = false
            };
            IdSamplingLabTest.Raw = true;
            Fields.Add("IdSamplingLabTest", IdSamplingLabTest);

            // NomorSamplingLabTest
            NomorSamplingLabTest = new(this, "x_NomorSamplingLabTest", 200, SqlDbType.VarChar) {
                Name = "NomorSamplingLabTest",
                Expression = "[NomorSamplingLabTest]",
                BasicSearchExpression = "[NomorSamplingLabTest]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorSamplingLabTest]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "NomorSamplingLabTest", "CustomMsg"),
                IsUpload = false
            };
            NomorSamplingLabTest.Lookup = new Lookup<DbField>(NomorSamplingLabTest, "SamplingLabTest", true, "NomorSamplingLabTest", new List<string> {"NomorSamplingLabTest", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NomorSamplingLabTest", NomorSamplingLabTest);

            // LinkProses
            LinkProses = new(this, "x_LinkProses", 202, SqlDbType.NVarChar) {
                Name = "LinkProses",
                Expression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorSamplingLabTest AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorSamplingLabTest AS NVARCHAR(50))+'</a>'",
                UseBasicSearch = true,
                BasicSearchExpression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorSamplingLabTest AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorSamplingLabTest AS NVARCHAR(50))+'</a>'",
                DateTimeFormat = -1,
                VirtualExpression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorSamplingLabTest AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorSamplingLabTest AS NVARCHAR(50))+'</a>'",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "LinkProses", "CustomMsg"),
                IsUpload = false
            };
            LinkProses.Lookup = new Lookup<DbField>(LinkProses, "SamplingLabTest", true, "LinkProses", new List<string> {"LinkProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LookupPlant = new(this, "x_LookupPlant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "LookupPlant", "CustomMsg"),
                IsUpload = false
            };
            LookupPlant.Raw = true;
            LookupPlant.Lookup = new Lookup<DbField>(LookupPlant, "SamplingLabTest", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            IdPlant = new(this, "x_IdPlant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "IdPlant", "CustomMsg"),
                IsUpload = false
            };
            IdPlant.Raw = true;
            IdPlant.Lookup = new Lookup<DbField>(IdPlant, "MasterPlant", true, "IdPlant", new List<string> {"Plant", "Nama_Terminal", "", ""}, "", "", new List<string> {}, new List<string> {"x_IdReferensi"}, new List<string> {}, new List<string> {}, new List<string> {"TipeProduk", "JenisPlant"}, new List<string> {"x_LookupTipeProduk", "x_LookupJenisPlant"}, false, "", "", "CONCAT([Plant],'" + ValueSeparator(1, IdPlant) + "',[Nama_Terminal])");
            Fields.Add("IdPlant", IdPlant);

            // LookupIdReferensi
            LookupIdReferensi = new(this, "x_LookupIdReferensi", 200, SqlDbType.VarChar) {
                Name = "LookupIdReferensi",
                Expression = "''",
                ...
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "LookupIdReferensi", "CustomMsg"),
                IsUpload = false
            };
            LookupIdReferensi.Lookup = new Lookup<DbField>(LookupIdReferensi, "SamplingLabTest", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("LookupIdReferensi", LookupIdReferensi);

            // IdReferensi
            IdReferensi = new(this, "x_IdReferensi", 202, SqlDbType.NVarChar) {
                Name = "IdReferensi",
                Expression = "[IdReferensi]",
                UseBasicSearch = true,
                BasicSearchExpression = "[IdReferensi]",
                DateTimeFormat = -1,
                VirtualExpression = "[IdReferensi]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "IdReferensi", "CustomMsg"),
                IsUpload = false
            };
            IdReferensi.Lookup = new Lookup<DbField>(IdReferensi, "Penyaluran", true, "NomorPenyaluran", new List<string> {"NomorPenyaluran", "", "", ""}, "", "", new List<string> {"x_IdPlant"}, new List<string> {}, new List<string> {"IdPlant"}, new List<string> {"x_IdPlant"}, new List<string> {"IdModa", "TipePenyaluran", "KategoriPenyaluran", "Tujuan", "NomorPolisi"}, new List<string> {"x_IdModa", "x_TipePenyaluran", "x_KategoriPenyaluran", "x_Tujuan", "x_NomorPolisi"}, false, "", "", "[NomorPenyaluran]");
            Fields.Add("IdReferensi", IdReferensi);
            ...
            IdPenimbunan = new(this, "x_IdPenimbunan", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "IdPenimbunan", "CustomMsg"),
                IsUpload = false
            };
            IdPenimbunan.Raw = true;
            IdPenimbunan.Lookup = new Lookup<DbField>(IdPenimbunan, "SamplingLabTest", true, "IdPenimbunan", new List<string> {"IdPenimbunan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            IdTemplate = new(this, "x_IdTemplate", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "IdTemplate", "CustomMsg"),
                IsUpload = false
            };
            IdTemplate.Raw = true;
            ...
            StatusProses = new(this, "x_StatusProses", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "StatusProses", "CustomMsg"),
                IsUpload = false
            };
            StatusProses.Lookup = new Lookup<DbField>(StatusProses, "SamplingLabTest", true, "StatusProses", new List<string> {"StatusProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            PersentaseProgress = new(this, "x_PersentaseProgress", 131, SqlDbType.Decimal) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "PersentaseProgress", "CustomMsg"),
                IsUpload = false
            };
            PersentaseProgress.Raw = true;
            PersentaseProgress.Lookup = new Lookup<DbField>(PersentaseProgress, "SamplingLabTest", true, "PersentaseProgress", new List<string> {"PersentaseProgress", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            IdModa = new(this, "x_IdModa", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "IdModa", "CustomMsg"),
                IsUpload = false
            };
            IdModa.Raw = true;
            IdModa.Lookup = new Lookup<DbField>(IdModa, "MasterModa", true, "IdModa", new List<string> {"NamaModa", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, true, "[Kategori] DESC", "", "[NamaModa]");
            ...
            TipePenyaluran = new(this, "x_TipePenyaluran", 202, SqlDbType.NVarChar) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "TipePenyaluran", "CustomMsg"),
                IsUpload = false
            };
            TipePenyaluran.Lookup = new Lookup<DbField>(TipePenyaluran, "SamplingLabTest", true, "TipePenyaluran", new List<string> {"TipePenyaluran", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, true, "", "", "");
            ...
            KategoriPenyaluran = new(this, "x_KategoriPenyaluran", 202, SqlDbType.NVarChar) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "KategoriPenyaluran", "CustomMsg"),
                IsUpload = false
            };
            KategoriPenyaluran.Lookup = new Lookup<DbField>(KategoriPenyaluran, "SamplingLabTest", true, "KategoriPenyaluran", new List<string> {"KategoriPenyaluran", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, true, "", "", "");
            KategoriPenyaluran.GetDefault = () => "Non TAS/NGS";
            ...
            NomorPolisi = new(this, "x_NomorPolisi", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "NomorPolisi", "CustomMsg"),
                IsUpload = false
            };
            NomorPolisi.Lookup = new Lookup<DbField>(NomorPolisi, "SamplingLabTest", true, "NomorPolisi", new List<string> {"NomorPolisi", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, true, "", "", "");
            ...
            TipeProdukSTS = new(this, "x_TipeProdukSTS", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "TipeProdukSTS", "CustomMsg"),
                IsUpload = false
            };
            ...
            // KodeProduk
            KodeProduk = new(this, "x_KodeProduk", 202, SqlDbType.NVarChar) {
                Name = "KodeProduk",
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "KodeProduk", "CustomMsg"),
                IsUpload = false
            };
            ...
            Tujuan = new(this, "x_Tujuan", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "Tujuan", "CustomMsg"),
                IsUpload = false
            };
            Tujuan.Lookup = new Lookup<DbField>(Tujuan, "SamplingLabTest", true, "Tujuan", new List<string> {"Tujuan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, true, "", "", "");
            ...
            Catatan = new(this, "x_Catatan", 201, SqlDbType.Text) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "Catatan", "CustomMsg"),
                IsUpload = false
            };
            Catatan.Lookup = new Lookup<DbField>(Catatan, "SamplingLabTest", true, "Catatan", new List<string> {"Catatan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            DibuatOleh.Lookup = new Lookup<DbField>(DibuatOleh, "SamplingLabTest", true, "DibuatOleh", new List<string> {"DibuatOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            TanggalDibuat.Raw = true;
            TanggalDibuat.Lookup = new Lookup<DbField>(TanggalDibuat, "SamplingLabTest", true, "TanggalDibuat", new List<string> {"TanggalDibuat", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            DiperbaruiOleh.Lookup = new Lookup<DbField>(DiperbaruiOleh, "SamplingLabTest", true, "DiperbaruiOleh", new List<string> {"DiperbaruiOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiperbarui.Raw = true;
            TanggalDiperbarui.Lookup = new Lookup<DbField>(TanggalDiperbarui, "SamplingLabTest", true, "TanggalDiperbarui", new List<string> {"TanggalDiperbarui", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LookupTipeProduk = new(this, "x_LookupTipeProduk", 200, SqlDbType.VarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "LookupTipeProduk", "CustomMsg"),
                IsUpload = false
            };
            ...
            LookupJenisPlant = new(this, "x_LookupJenisPlant", 200, SqlDbType.VarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SamplingLabTest", "LookupJenisPlant", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SamplingLabTest";
            set => _sqlFrom = value;
        }
        ...
        {
            get {
                string select = "*, '<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorSamplingLabTest AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorSamplingLabTest AS NVARCHAR(50))+'</a>' AS [LinkProses], '' AS [LookupIdReferensi], '' AS [LookupTipeProduk], '' AS [LookupJenisPlant]";
                if (select == "*") {
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SamplingLabTest type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdSamplingLabTest"))
                    row["IdSamplingLabTest"] = lastInsertedId;
                else
                    row.Add("IdSamplingLabTest", lastInsertedId);
                IdSamplingLabTest.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                IdSamplingLabTest.DbValue = row["IdSamplingLabTest"]; // Set DB value only
                NomorSamplingLabTest.DbValue = row["NomorSamplingLabTest"]; // Set DB value only
                ...
                LookupIdReferensi.DbValue = row["LookupIdReferensi"]; // Set DB value only
                IdReferensi.DbValue = row["IdReferensi"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[IdSamplingLabTest] = @IdSamplingLabTest@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SamplingLabTestView" => Language.Phrase("View"),
                "SamplingLabTestEdit" => Language.Phrase("Edit"),
                "SamplingLabTestAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SamplingLabTestView",
                Config.ApiAddAction => "SamplingLabTestAdd",
                Config.ApiEditAction => "SamplingLabTestEdit",
                Config.ApiDeleteAction => "SamplingLabTestDelete",
                Config.ApiListAction => "SamplingLabTestList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SamplingLabTestList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SamplingLabTestView", parm);
            else
                url = KeyUrl("SamplingLabTestView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SamplingLabTestAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SamplingLabTestAdd?" + parm;
            else
                url = "SamplingLabTestAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SamplingLabTestEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SamplingLabTestList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SamplingLabTestAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SamplingLabTestList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SamplingLabTestDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdSamplingLabTest\":" + ConvertToJson(IdSamplingLabTest.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdSamplingLabTest.CurrentValue)) {
                url += "/" + IdSamplingLabTest.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdSamplingLabTest", out object? v0)) { // IdSamplingLabTest // DN
                    key = UrlDecode(v0); // DN
                } else if (IsApi() && !Empty(keyValues)) {
                    key = keyValues[0];
                } else {
                    key = Param("IdSamplingLabTest");
                }
                keysList.Add(key);
            }
            // Check keys
            foreach (var keys in keysList) {
                if (KeyFields.Count > 1 && (!IsArray(keys) || keys.Length != KeyFields.Count))
                    continue;
                if (!IsNumeric(keys)) // IdSamplingLabTest
                    continue;
                result.Add(keys);
            }
            return result;
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdSamplingLabTest.CurrentValue = keys;
                else
                    IdSamplingLabTest.OldValue = keys;
        ...
        {
            string pageName = "SamplingLabTestList";
        ...
        public async Task RenderListRow()
        {
            ...
            IdModa.ViewValue = Empty(curVal4) ? DbNullValue : FormatNumber(IdModa.CurrentValue, IdModa.FormatPattern);
            if (!Empty(curVal4)) {
            ...
            KodeProduk.ViewValue = Empty(curVal8) ? DbNullValue : KodeProduk.CurrentValue;
            if (!Empty(curVal8)) {
            ...
            // IdSamplingLabTest
            IdSamplingLabTest.HrefValue = "";
            IdSamplingLabTest.TooltipValue = "";
            ...
            LookupIdReferensi.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // IdSamplingLabTest
            IdSamplingLabTest.SetupEditAttributes();
            IdSamplingLabTest.EditValue = IdSamplingLabTest.CurrentValue;
            IdSamplingLabTest.ViewCustomAttributes = "";
            ...
            PersentaseProgress.EditValue = PersentaseProgress.CurrentValue;
            PersentaseProgress.PlaceHolder = RemoveHtml(PersentaseProgress.Caption);
            if (!Empty(PersentaseProgress.EditValue) && IsNumeric(PersentaseProgress.EditValue))
                PersentaseProgress.EditValue = FormatNumber(PersentaseProgress.EditValue, null);
            ...
            Tujuan.EditValue = Tujuan.CurrentValue;
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(IdSamplingLabTest);
                        doc.ExportCaption(NomorSamplingLabTest);
                        doc.ExportCaption(LinkProses);
                        doc.ExportCaption(LookupPlant);
                        doc.ExportCaption(IdPlant);
                        doc.ExportCaption(IdReferensi);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(IdSamplingLabTest);
                            await doc.ExportField(NomorSamplingLabTest);
                            await doc.ExportField(LinkProses);
                            await doc.ExportField(LookupPlant);
                            await doc.ExportField(IdPlant);
                            await doc.ExportField(IdReferensi);
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            try {
                // Ambil parameter untuk GenerateNomorReferensiPenyaluran
                var idPlant    = rsnew["IdPlant"].ToString();
                var kodeProduk = rsnew["KodeProduk"].ToString();

                // Jalankan SP untuk mendapatkan nomor referensi sampling
                string sql = $"EXEC GenerateNomorReferensiPenyaluran 'Sampling', {idPlant}, '{kodeProduk}'";
                var nomorReferensiObj = ExecuteScalar(sql);
                ...
                rsnew["NomorSamplingLabTest"] = nomorReferensi;

                // 🔹 Ambil waktu plant berdasarkan IdPlant
        ...
        public void RowInserted(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            //Log("Row Inserted");
            try {
                var nomorReferensi = rsnew["NomorSamplingLabTest"].ToString();
                var jenisProses = "SamplingLabTest";
                var idModa = Convert.ToInt32(rsnew["IdModa"]);
                var dibuatOleh = CurrentUserName();
                var Tipe = rsnew["TipePenyaluran"].ToString();
                var Kategori = rsnew["KategoriPenyaluran"].ToString();
                string sql = $"EXEC GenerateProsesAktivitas_SamplingLabTest '{nomorReferensi}', '{jenisProses}', '{Tipe}', '{Kategori}', {idModa},'NomorSamplingLabTest', '{dibuatOleh}'";
                ExecuteScalar(sql);
            } catch (Exception ex) {
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            try {
                // Ambil IdPlant dari data baru jika berubah; jika tidak, gunakan nilai lama
                string idPlant = rsnew.ContainsKey("IdPlant") 
                    ? rsnew["IdPlant"].ToString() 
                    : rsold["IdPlant"].ToString();

                // Panggil GetPlantDateTime berdasarkan IdPlant
                DateTime plantTime = DateTime.Now;
                var plantObj = ExecuteScalar($"EXEC dbo.GetPlantDateTime @IdPlant = {idPlant}");
                if (plantObj != null && DateTime.TryParse(plantObj.ToString(), out var dt))
                    plantTime = dt;
