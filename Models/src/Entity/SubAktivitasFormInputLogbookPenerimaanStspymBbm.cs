...
/**
 * Entity class for "SubAktivitasFormInputLogbookPenerimaanSTSPymBBM" table
 */
[Table("SubAktivitasFormInputLogbookPenerimaanSTSPymBBM")]
public class SubAktivitasFormInputLogbookPenerimaanStspymBbm
{
    [Key("id")]
