...
public partial class SnDOne {
    ...
    public class SubaktivitasStartBongkarStsPnrBbmEditBase : SubaktivitasStartBongkarStsPnrBbm
    {
        ...
        // Constructor
        public SubaktivitasStartBongkarStsPnrBbmEditBase()
        {
        ...
        // Constructor
        public SubaktivitasStartBongkarStsPnrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasStartBongkarStsPnrBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasStartBongkarStsPnrBbmList") {
                                ...
                                returnUrl = "SubaktivitasStartBongkarStsPnrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
