...
public partial class SnDOne {
    ...
    public class SubAktivitasCatatanKhususListBase : SubAktivitasCatatanKhusus
    {
        ...
        // Constructor
        public SubAktivitasCatatanKhususListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasCatatanKhususListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field Kontaminasi
            if (filter.TryGetValue("x_Kontaminasi", out sv)) {
                RestoreFieldFilter(Kontaminasi, filter, "Kontaminasi", sv);
            }

            // Field Insident
            if (filter.TryGetValue("x_Insident", out sv)) {
                RestoreFieldFilter(Insident, filter, "Insident", sv);
            }

            // Field CuacaBuruk
            if (filter.TryGetValue("x_CuacaBuruk", out sv)) {
                RestoreFieldFilter(CuacaBuruk, filter, "CuacaBuruk", sv);
            }
