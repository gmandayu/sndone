...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiARsesuaiCqdPipaEdit
    /// </summary>
    public static SubAktivitasNilaiARsesuaiCqdPipaEdit subAktivitasNilaiARsesuaiCqdPipaEdit
    {
        get => HttpData.Get<SubAktivitasNilaiARsesuaiCqdPipaEdit>("subAktivitasNilaiARsesuaiCqdPipaEdit")!;
        set => HttpData["subAktivitasNilaiARsesuaiCqdPipaEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiARsesuaiCQDPipa
    /// </summary>
    public class SubAktivitasNilaiARsesuaiCqdPipaEdit : SubAktivitasNilaiARsesuaiCqdPipaEditBase
    {
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiARsesuaiCqdPipaEditBase : SubAktivitasNilaiARsesuaiCqdPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiARsesuaiCqdPipaEdit";
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiARsesuaiCqdPipaEdit";
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiARsesuaiCqdPipaList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiARsesuaiCqdPipaList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiARsesuaiCqdPipaList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiARsesuaiCqdPipaEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiARsesuaiCqdPipaList")), "", TableVar, true);
            string pageId = "edit";
