...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputHslPemeriksaanEdit
    /// </summary>
    public static SubAktivitasFormInputHslPemeriksaanEdit subAktivitasFormInputHslPemeriksaanEdit
    {
        get => HttpData.Get<SubAktivitasFormInputHslPemeriksaanEdit>("subAktivitasFormInputHslPemeriksaanEdit")!;
        set => HttpData["subAktivitasFormInputHslPemeriksaanEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputHslPemeriksaan
    /// </summary>
    public class SubAktivitasFormInputHslPemeriksaanEdit : SubAktivitasFormInputHslPemeriksaanEditBase
    {
        // Constructor
        public SubAktivitasFormInputHslPemeriksaanEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputHslPemeriksaanEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputHslPemeriksaanEditBase : SubAktivitasFormInputHslPemeriksaan
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputHslPemeriksaanEdit";
        ...
        // Constructor
        public SubAktivitasFormInputHslPemeriksaanEditBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputHslPemeriksaanEdit";
        ...
        // Constructor
        public SubAktivitasFormInputHslPemeriksaanEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputHslPemeriksaanList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputHslPemeriksaanList") {
                                ...
                                returnUrl = "SubAktivitasFormInputHslPemeriksaanList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputHslPemeriksaanEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
