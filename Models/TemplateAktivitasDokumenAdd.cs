...
public partial class SnDOne {
    /// <summary>
    /// templateAktivitasDokumenAdd
    /// </summary>
    public static TemplateAktivitasDokumenAdd templateAktivitasDokumenAdd
    {
        get => HttpData.Get<TemplateAktivitasDokumenAdd>("templateAktivitasDokumenAdd")!;
        set => HttpData["templateAktivitasDokumenAdd"] = value;
    }

    /// <summary>
    /// Page class for TemplateAktivitasDokumen
    /// </summary>
    public class TemplateAktivitasDokumenAdd : TemplateAktivitasDokumenAddBase
    {
        // Constructor
        public TemplateAktivitasDokumenAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TemplateAktivitasDokumenAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TemplateAktivitasDokumenAddBase : TemplateAktivitasDokumen
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "templateAktivitasDokumenAdd";
        ...
        // Constructor
        public TemplateAktivitasDokumenAddBase()
        {
        ...
        // Page name
        public string PageName => "TemplateAktivitasDokumenAdd";
        ...
        // Constructor
        public TemplateAktivitasDokumenAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("TemplateAktivitasDokumenList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "TemplateAktivitasDokumenView")
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                templateAktivitasDokumenAdd?.PageRender();
            }
            return PageResult();
        }
