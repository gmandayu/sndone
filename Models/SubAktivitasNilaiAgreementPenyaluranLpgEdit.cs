...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiAgreementPenyaluranLpgEdit
    /// </summary>
    public static SubAktivitasNilaiAgreementPenyaluranLpgEdit subAktivitasNilaiAgreementPenyaluranLpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiAgreementPenyaluranLpgEdit>("subAktivitasNilaiAgreementPenyaluranLpgEdit")!;
        set => HttpData["subAktivitasNilaiAgreementPenyaluranLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiAgreementPenyaluranLPG
    /// </summary>
    public class SubAktivitasNilaiAgreementPenyaluranLpgEdit : SubAktivitasNilaiAgreementPenyaluranLpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiAgreementPenyaluranLpgEditBase : SubAktivitasNilaiAgreementPenyaluranLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiAgreementPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiAgreementPenyaluranLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiAgreementPenyaluranLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiAgreementPenyaluranLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiAgreementPenyaluranLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiAgreementPenyaluranLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiAgreementPenyaluranLpgList")), "", TableVar, true);
            string pageId = "edit";
