...
public partial class SnDOne {
    ...
    /// penyaluranList
    /// </summary>
    public static PenyaluranList penyaluranList
    {
        get => HttpData.Get<PenyaluranList>("penyaluranList")!;
        set => HttpData["penyaluranList"] = value;
    }

    /// <summary>
    /// Page class for Penyaluran
    /// </summary>
    public class PenyaluranList : PenyaluranListBase
    {
        // Constructor
        public PenyaluranList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenyaluranList() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PenyaluranListBase : Penyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penyaluranList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fPenyaluranlist";
        ...
        public PenyaluranListBase()
        {
            ...
            MultiDeleteUrl = "PenyaluranDelete";
            MultiUpdateUrl = "PenyaluranUpdate";
        ...
        // Page name
        public string PageName => "PenyaluranList";
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(NoShipment.AdvancedSearch.ToJson())); // Field NoShipment
            filters.Merge(JObject.Parse(IdPipa.AdvancedSearch.ToJson())); // Field IdPipa
            filters.Merge(JObject.Parse(TujuanKonsinyasiPipa.AdvancedSearch.ToJson())); // Field TujuanKonsinyasiPipa
            filters.Merge(JObject.Parse(QuantityKonsinyasiPipa.AdvancedSearch.ToJson())); // Field QuantityKonsinyasiPipa
            ...
            filters.Merge(JObject.Parse(MultipleTujuanKonsinyasi.AdvancedSearch.ToJson())); // Field MultipleTujuanKonsinyasi
            filters.Merge(JObject.Parse(MultipleTujuanKonsinyasiHidden.AdvancedSearch.ToJson())); // Field MultipleTujuanKonsinyasiHidden
            filters.Merge(JObject.Parse(MultipleQuantity.AdvancedSearch.ToJson())); // Field MultipleQuantity
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            if (!Security.CanSearch)
                return "";
            BuildSearchSql(ref where, NomorPenyaluran, def, true); // NomorPenyaluran
            ...
            BuildSearchSql(ref where, NoShipment, def, false); // NoShipment
            BuildSearchSql(ref where, IdPipa, def, true); // IdPipa
            BuildSearchSql(ref where, NomorPolisi, def, true); // NomorPolisi
            BuildSearchSql(ref where, NamaKapal, def, true); // NamaKapal
            BuildSearchSql(ref where, JenisProduk, def, true); // JenisProduk
            ...
            BuildSearchSql(ref where, TujuanKonsinyasi, def, true); // TujuanKonsinyasi
            BuildSearchSql(ref where, Volume, def, true); // Volume
            BuildSearchSql(ref where, TujuanKonsinyasiPipa, def, true); // TujuanKonsinyasiPipa
            BuildSearchSql(ref where, QuantityKonsinyasiPipa, def, true); // QuantityKonsinyasiPipa
            BuildSearchSql(ref where, TujuanKonsinyasi2, def, true); // TujuanKonsinyasi2
            BuildSearchSql(ref where, Volume2, def, true); // Volume2
            BuildSearchSql(ref where, TujuanKonsinyasi3, def, true); // TujuanKonsinyasi3
            ...
            BuildSearchSql(ref where, MultipleTujuanKonsinyasi, def, false); // MultipleTujuanKonsinyasi
            BuildSearchSql(ref where, MultipleTujuanKonsinyasiHidden, def, false); // MultipleTujuanKonsinyasiHidden
            BuildSearchSql(ref where, MultipleQuantity, def, false); // MultipleQuantity

            // Set up search command
            if (!def && !Empty(where) && (new[] { "", "reset", "resetall" }).Contains(Command))
                Command = "search";
            if (!def && Command == "search") {
                NoShipment.AdvancedSearch.Save(); // NoShipment
                IdPipa.AdvancedSearch.Save(); // IdPipa
                TujuanKonsinyasiPipa.AdvancedSearch.Save(); // TujuanKonsinyasiPipa
                QuantityKonsinyasiPipa.AdvancedSearch.Save(); // QuantityKonsinyasiPipa
                ...
                MultipleTujuanKonsinyasi.AdvancedSearch.Save(); // MultipleTujuanKonsinyasi
                MultipleTujuanKonsinyasiHidden.AdvancedSearch.Save(); // MultipleTujuanKonsinyasiHidden
                MultipleQuantity.AdvancedSearch.Save(); // MultipleQuantity
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(NomorPenyaluran);
            ...
            searchFlds.Add(TujuanKonsinyasi);
            searchFlds.Add(Volume);
            searchFlds.Add(TujuanKonsinyasiPipa);
            searchFlds.Add(QuantityKonsinyasiPipa);
            ...
            searchFlds.Add(MultipleTujuanKonsinyasi);
            searchFlds.Add(MultipleTujuanKonsinyasiHidden);
            searchFlds.Add(MultipleQuantity);
        ...
        protected bool CheckSearchParms() {
            ...
            if (BasicSearch.IssetSession)
                return true;
            if (NomorPenyaluran.AdvancedSearch.IssetSession)
                return true;
            ...
            if (IdModa.AdvancedSearch.IssetSession)
                return true;
            if (NoShipment.AdvancedSearch.IssetSession)
                return true;
            if (IdPipa.AdvancedSearch.IssetSession)
                return true;
            if (NomorPolisi.AdvancedSearch.IssetSession)
                return true;
            if (NamaKapal.AdvancedSearch.IssetSession)
                return true;
            if (JenisProduk.AdvancedSearch.IssetSession)
                return true;
            ...
            if (Tujuan.AdvancedSearch.IssetSession)
                return true;
            if (TujuanKonsinyasi.AdvancedSearch.IssetSession)
                return true;
            if (Volume.AdvancedSearch.IssetSession)
                return true;
            if (TujuanKonsinyasiPipa.AdvancedSearch.IssetSession)
                return true;
            if (QuantityKonsinyasiPipa.AdvancedSearch.IssetSession)
                return true;
            if (TujuanKonsinyasi2.AdvancedSearch.IssetSession)
                return true;
            if (Volume2.AdvancedSearch.IssetSession)
                return true;
            if (TujuanKonsinyasi3.AdvancedSearch.IssetSession)
                return true;
            ...
            if (TanggalDiperbarui.AdvancedSearch.IssetSession)
                return true;
            if (MultipleTujuanKonsinyasi.AdvancedSearch.IssetSession)
                return true;
            if (MultipleTujuanKonsinyasiHidden.AdvancedSearch.IssetSession)
                return true;
            if (MultipleQuantity.AdvancedSearch.IssetSession)
                return true;
            return false;
        }
        ...
        protected void ResetAdvancedSearchParms() {
            NomorPenyaluran.AdvancedSearch.UnsetSession();
            ...
            NoShipment.AdvancedSearch.UnsetSession();
            IdPipa.AdvancedSearch.UnsetSession();
            NomorPolisi.AdvancedSearch.UnsetSession();
            NamaKapal.AdvancedSearch.UnsetSession();
            JenisProduk.AdvancedSearch.UnsetSession();
            ...
            TujuanKonsinyasi.AdvancedSearch.UnsetSession();
            Volume.AdvancedSearch.UnsetSession();
            TujuanKonsinyasiPipa.AdvancedSearch.UnsetSession();
            QuantityKonsinyasiPipa.AdvancedSearch.UnsetSession();
            TujuanKonsinyasi2.AdvancedSearch.UnsetSession();
            Volume2.AdvancedSearch.UnsetSession();
            TujuanKonsinyasi3.AdvancedSearch.UnsetSession();
            ...
            MultipleTujuanKonsinyasi.AdvancedSearch.UnsetSession();
            MultipleTujuanKonsinyasiHidden.AdvancedSearch.UnsetSession();
            MultipleQuantity.AdvancedSearch.UnsetSession();
        }
        ...
        protected void RestoreSearchParms() {
            ...
            NomorPenyaluran.AdvancedSearch.Load();
            ...
            JenisProduk.AdvancedSearch.Load();
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(TujuanKonsinyasi, ctrl); // TujuanKonsinyasi
                UpdateSort(Volume, ctrl); // Volume
                UpdateSort(TujuanKonsinyasiPipa, ctrl); // TujuanKonsinyasiPipa
                UpdateSort(QuantityKonsinyasiPipa, ctrl); // QuantityKonsinyasiPipa
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    Tujuan.Sort = "";
                    TujuanKonsinyasi.Sort = "";
                    Volume.Sort = "";
                    TujuanKonsinyasiPipa.Sort = "";
                    QuantityKonsinyasiPipa.Sort = "";
                    TujuanKonsinyasi2.Sort = "";
                    Volume2.Sort = "";
                    TujuanKonsinyasi3.Sort = "";
                    Volume3.Sort = "";
                    TanggalSandar.Sort = "";
                    Catatan.Sort = "";
                    DibuatOleh.Sort = "";
                    ...
                    MultipleTujuanKonsinyasi.Sort = "";
                    MultipleTujuanKonsinyasiHidden.Sort = "";
                    MultipleQuantity.Sort = "";
                }
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""Penyaluran"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""Penyaluran"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalAdd && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-copy"" title=""{copycaption}"" data-table=""Penyaluran"" data-caption=""{copycaption}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(CopyUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("CopyLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fPenyaluranlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fPenyaluranlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
            ...
            listOption?.SetBody("<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" + RowCount + "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" + HtmlEncode(IdPenyaluran.CurrentValue) + "\" data-ew-action=\"select-key\"></div>");
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""Penyaluran"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            item.Body = $@"<button type=""button"" class=""ew-action ew-multi-delete"" title=""{deleteTitle}"" data-caption=""{deleteTitle}"" form=""fPenyaluranlist""" +
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("IdPipa")); // DN
                ...
                CreateColumnOption(option.Add("TujuanKonsinyasi")); // DN
                CreateColumnOption(option.Add("Volume")); // DN
                CreateColumnOption(option.Add("TujuanKonsinyasiPipa")); // DN
                CreateColumnOption(option.Add("QuantityKonsinyasiPipa")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fPenyaluransrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fPenyaluransrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fPenyaluranlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(penyaluranList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(penyaluranList.RowCount) + "_Penyaluran");
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // IdPipa
                if (IdPipa.UseFilter && !Empty(IdPipa.AdvancedSearch.SearchValue)) {
                    IdPipa.EditValue = ConvertToString(IdPipa.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }
                ...
                // JenisProduk
                if (JenisProduk.UseFilter && !Empty(JenisProduk.AdvancedSearch.SearchValue)) {
                    JenisProduk.EditValue = ConvertToString(JenisProduk.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }
                ...
                // TujuanKonsinyasi
                if (TujuanKonsinyasi.UseFilter && !Empty(TujuanKonsinyasi.AdvancedSearch.SearchValue)) {
                    TujuanKonsinyasi.EditValue = ConvertToString(TujuanKonsinyasi.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // Volume
                if (Volume.UseFilter && !Empty(Volume.AdvancedSearch.SearchValue)) {
                    Volume.EditValue = ConvertToString(Volume.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // TujuanKonsinyasiPipa
                if (TujuanKonsinyasiPipa.UseFilter && !Empty(TujuanKonsinyasiPipa.AdvancedSearch.SearchValue)) {
                    TujuanKonsinyasiPipa.EditValue = ConvertToString(TujuanKonsinyasiPipa.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }

                // QuantityKonsinyasiPipa
                if (QuantityKonsinyasiPipa.UseFilter && !Empty(QuantityKonsinyasiPipa.AdvancedSearch.SearchValue)) {
                    QuantityKonsinyasiPipa.EditValue = ConvertToString(QuantityKonsinyasiPipa.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fPenyaluransrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
            ...
            if (ModalSearch && !IsMobile())
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-table=\"Penyaluran\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-ew-action=\"modal\" data-url=\"" + AppPath("PenyaluranSearch") + "\" data-btn=\"SearchBtn\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            else
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" href=\"" + AppPath("PenyaluranSearch") + "\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            item.Visible = true;
