...
public partial class SnDOne {
    /// <summary>
    /// aktivitasDokumenDetail
    /// </summary>
    [MaybeNull]
    public static AktivitasDokumenDetail aktivitasDokumenDetail
    {
        get => HttpData.Resolve<AktivitasDokumenDetail>("AktivitasDokumenDetail");
        set => HttpData["AktivitasDokumenDetail"] = value;
    }

    /// <summary>
    /// Table class for AktivitasDokumenDetail
    /// </summary>
    public class AktivitasDokumenDetail : DbTable
    {
        ...
        public readonly DbField<SqlDbType> TanggalDiunggah;

        // Constructor
        public AktivitasDokumenDetail()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "AktivitasDokumenDetail";
            Name = "AktivitasDokumenDetail";
            Type = "TABLE";
            UpdateTable = "dbo.AktivitasDokumenDetail"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("AktivitasDokumenDetail", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            IdAktivitasDokumen = new(this, "x_IdAktivitasDokumen", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("AktivitasDokumenDetail", "IdAktivitasDokumen", "CustomMsg"),
                IsUpload = false
            };
            ...
            // FileName
            FileName = new(this, "x_FileName", 202, SqlDbType.NVarChar) {
                Name = "FileName",
                Expression = "[FileName]",
                UseBasicSearch = true,
                ...
                CustomMessage = Language.FieldPhrase("AktivitasDokumenDetail", "FileName", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("FileName", FileName);

            // DiunggahOleh
            DiunggahOleh = new(this, "x_DiunggahOleh", 202, SqlDbType.NVarChar) {
                Name = "DiunggahOleh",
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("AktivitasDokumenDetail", "DiunggahOleh", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("DiunggahOleh", DiunggahOleh);

            // TanggalDiunggah
            TanggalDiunggah = new(this, "x_TanggalDiunggah", 135, SqlDbType.DateTime) {
                Name = "TanggalDiunggah",
                Expression = "[TanggalDiunggah]",
                BasicSearchExpression = CastDateFieldForLike("[TanggalDiunggah]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[TanggalDiunggah]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("AktivitasDokumenDetail", "TanggalDiunggah", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiunggah.Raw = true;
            Fields.Add("TanggalDiunggah", TanggalDiunggah);
        ...
        {
            get => _sqlFrom ?? "dbo.AktivitasDokumenDetail";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.AktivitasDokumenDetail type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                FileName.DbValue = row["FileName"]; // Set DB value only
                DiunggahOleh.DbValue = row["DiunggahOleh"]; // Set DB value only
                TanggalDiunggah.DbValue = row["TanggalDiunggah"]; // Set DB value only
            } catch {}
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "AktivitasDokumenDetailList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "AktivitasDokumenDetailView" => Language.Phrase("View"),
                "AktivitasDokumenDetailEdit" => Language.Phrase("Edit"),
                "AktivitasDokumenDetailAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "AktivitasDokumenDetailView",
                Config.ApiAddAction => "AktivitasDokumenDetailAdd",
                Config.ApiEditAction => "AktivitasDokumenDetailEdit",
                Config.ApiDeleteAction => "AktivitasDokumenDetailDelete",
                Config.ApiListAction => "AktivitasDokumenDetailList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "AktivitasDokumenDetailList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("AktivitasDokumenDetailView", parm);
            else
                url = KeyUrl("AktivitasDokumenDetailView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "AktivitasDokumenDetailAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "AktivitasDokumenDetailAdd?" + parm;
            else
                url = "AktivitasDokumenDetailAdd";
        ...
        {
            string url = "";
            url = KeyUrl("AktivitasDokumenDetailEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("AktivitasDokumenDetailList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("AktivitasDokumenDetailAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("AktivitasDokumenDetailList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("AktivitasDokumenDetailDelete", parm)); // DN
        }
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            ...
            TanggalDiunggah.SetDbValue(row["TanggalDiunggah"]);
        }
        ...
        {
            string pageName = "AktivitasDokumenDetailList";
        ...
        public async Task RenderListRow()
        {
            ...
            // TanggalDiunggah
            TanggalDiunggah.ViewValue = TanggalDiunggah.CurrentValue;
            TanggalDiunggah.ViewValue = FormatDateTime(TanggalDiunggah.ViewValue, TanggalDiunggah.FormatPattern);
            TanggalDiunggah.ViewCustomAttributes = "";
            ...
            // TanggalDiunggah
            TanggalDiunggah.HrefValue = "";
            TanggalDiunggah.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // FileName
            FileName.SetupEditAttributes();
            if (!FileName.Raw)
                FileName.CurrentValue = HtmlDecode(FileName.CurrentValue);
            FileName.EditValue = FileName.CurrentValue;
            ...
            // TanggalDiunggah
            TanggalDiunggah.SetupEditAttributes();
            TanggalDiunggah.EditValue = FormatDateTime(TanggalDiunggah.CurrentValue, TanggalDiunggah.FormatPattern);
            TanggalDiunggah.PlaceHolder = RemoveHtml(TanggalDiunggah.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(TanggalDiunggah);
                    } else {
                        doc.ExportCaption(id);
                        doc.ExportCaption(IdAktivitasDokumen);
                        doc.ExportCaption(FileName);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(TanggalDiunggah);
                        } else {
                            await doc.ExportField(id);
                            await doc.ExportField(IdAktivitasDokumen);
                            await doc.ExportField(FileName);
