...
public partial class SnDOne {
    ...
    public class FormInputGoodHouseKeepingEditBase : FormInputGoodHouseKeeping
    {
        ...
        // Constructor
        public FormInputGoodHouseKeepingEditBase(Controller? controller)
        {
        ...
        // Constructor
        public FormInputGoodHouseKeepingEditBase() : this(null) { }
        ...
        private void ValidateCustomtgltiba() {
            if (tgltiba.Visible && tgltiba.Required) {
                if (!tgltiba.IsDetailKey && Empty(tgltiba.FormValue)) {
                    tgltiba.AddErrorMessage(ConvertToString(lastUpdatedDate.RequiredErrorMessage).Replace("%s", lastUpdatedDate.Caption));
                }
            }
        }
