...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStopPembongkaranRtwView
    /// </summary>
    public static SubAktivitasDataStopPembongkaranRtwView subAktivitasDataStopPembongkaranRtwView
    {
        get => HttpData.Get<SubAktivitasDataStopPembongkaranRtwView>("subAktivitasDataStopPembongkaranRtwView")!;
        set => HttpData["subAktivitasDataStopPembongkaranRtwView"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStopPembongkaranRTW
    /// </summary>
    public class SubAktivitasDataStopPembongkaranRtwView : SubAktivitasDataStopPembongkaranRtwViewBase
    {
        // Constructor
        public SubAktivitasDataStopPembongkaranRtwView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStopPembongkaranRtwView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStopPembongkaranRtwViewBase : SubAktivitasDataStopPembongkaranRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStopPembongkaranRtwView";
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranRtwViewBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStopPembongkaranRtwView";
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranRtwViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasDataStopPembongkaranRtwList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasDataStopPembongkaranRtwList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasDataStopPembongkaranRtwView?.PageRender();
            }
            return PageResult();
        }
