...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputFlowrateViewBase : SubAktivitasFormInputFlowrate
    {
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateViewBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputFlowrateList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputFlowrateList"); // Return to list page
                            }
                        }
                    break;
            }
