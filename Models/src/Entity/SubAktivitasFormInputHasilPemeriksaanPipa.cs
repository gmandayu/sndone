...
/**
 * Entity class for "SubAktivitasFormInputHasilPemeriksaanPipa" table
 */
[Table("SubAktivitasFormInputHasilPemeriksaanPipa")]
public class SubAktivitasFormInputHasilPemeriksaanPipa
{
    [Key("id")]
