...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiAgreementLpgEdit
    /// </summary>
    public static SubAktivitasNilaiAgreementLpgEdit subAktivitasNilaiAgreementLpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiAgreementLpgEdit>("subAktivitasNilaiAgreementLpgEdit")!;
        set => HttpData["subAktivitasNilaiAgreementLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiAgreementLPG
    /// </summary>
    public class SubAktivitasNilaiAgreementLpgEdit : SubAktivitasNilaiAgreementLpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiAgreementLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiAgreementLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiAgreementLpgEditBase : SubAktivitasNilaiAgreementLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiAgreementLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiAgreementLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiAgreementLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiAgreementLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiAgreementLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiAgreementLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiAgreementLpgList")), "", TableVar, true);
            string pageId = "edit";
