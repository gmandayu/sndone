...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static MasterRegion masterRegion
    {
        get => HttpData.Resolve<MasterRegion>("MasterRegion");
        set => HttpData["MasterRegion"] = value;
    }

    /// <summary>
    /// Table class for MasterRegion
    /// </summary>
    public class MasterRegion : DbTable
    {
        ...
        public readonly DbField<SqlDbType> RegionCode;
        ...
        public MasterRegion()
        {
            ...
            Name = "MasterRegion";
            Type = "TABLE";
            UpdateTable = "dbo.MasterRegion"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdRegion = new(this, "x_IdRegion", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterRegion", "IdRegion", "CustomMsg"),
                IsUpload = false
            };
            IdRegion.Raw = true;
            IdRegion.Lookup = new Lookup<DbField>(IdRegion, "MasterRegion", true, "IdRegion", new List<string> {"IdRegion", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Region = new(this, "x_Region", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MasterRegion", "Region", "CustomMsg"),
                IsUpload = false
            };
            Region.Lookup = new Lookup<DbField>(Region, "MasterRegion", true, "Region", new List<string> {"Region", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Region", Region);

            // RegionCode
            RegionCode = new(this, "x_RegionCode", 202, SqlDbType.NVarChar) {
                Name = "RegionCode",
                Expression = "[RegionCode]",
                UseBasicSearch = true,
                BasicSearchExpression = "[RegionCode]",
                DateTimeFormat = -1,
                VirtualExpression = "[RegionCode]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("MasterRegion", "RegionCode", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("RegionCode", RegionCode);
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MasterRegion type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdRegion"))
                    row["IdRegion"] = lastInsertedId;
                else
                    row.Add("IdRegion", lastInsertedId);
                IdRegion.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                RegionCode.DbValue = row["RegionCode"]; // Set DB value only
            } catch {}
        }
        ...
        private string _sqlKeyFilter => "[IdRegion] = @IdRegion@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MasterRegionView" => Language.Phrase("View"),
                "MasterRegionEdit" => Language.Phrase("Edit"),
                "MasterRegionAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MasterRegionView",
                Config.ApiAddAction => "MasterRegionAdd",
                Config.ApiEditAction => "MasterRegionEdit",
                Config.ApiDeleteAction => "MasterRegionDelete",
                Config.ApiListAction => "MasterRegionList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MasterRegionList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MasterRegionView", parm);
            else
                url = KeyUrl("MasterRegionView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MasterRegionAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MasterRegionEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterRegionList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MasterRegionAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterRegionList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MasterRegionDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdRegion\":" + ConvertToJson(IdRegion.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdRegion.CurrentValue)) {
                url += "/" + IdRegion.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdRegion", out object? v0)) { // IdRegion // DN
                    key = UrlDecode(v0); // DN
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdRegion.CurrentValue = keys;
                else
                    IdRegion.OldValue = keys;
        ...
        {
            string pageName = "MasterRegionList";
        ...
        public async Task RenderEditRow()
        {
            ...
            RegionCode.EditValue = RegionCode.CurrentValue;
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(RegionCode);
                        } else {
                            await doc.ExportField(IdRegion);
                            await doc.ExportField(Region);
                            await doc.ExportField(RegionCode);
