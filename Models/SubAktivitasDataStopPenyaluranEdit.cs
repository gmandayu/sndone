...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStopPenyaluranEditBase : SubAktivitasDataStopPenyaluran
    {
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStopPenyaluranList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStopPenyaluranList") {
                                ...
                                returnUrl = "SubAktivitasDataStopPenyaluranList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
