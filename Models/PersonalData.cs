...
public partial class SnDOne {
    ...
    public class PersonalDataBase : AspNetMakerPage
    {
        ...
        // Constructor
        public PersonalDataBase(Controller? controller)
        {
            // Initialize
            CurrentPage = this;
        if (controller != null)
        ...
        // Constructor
        public PersonalDataBase() : this(null) { }
        ...
        protected async Task<IActionResult> PersonalDataResult() {
            ...
            if (row != null) {
                foreach (var fldName in fldNames) {
                    if (row.ContainsKey(fldName) && GetUserInfo<object>(fldName, row) is var info && info != null)
        ...
        protected async Task<bool> DeletePersonalData() {
            ...
            if (ComparePassword(GetUserInfo<string>(Config.LoginPasswordFieldName, row), pwd)) {
                try {
