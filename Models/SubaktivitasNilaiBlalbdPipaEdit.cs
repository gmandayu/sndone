...
public partial class SnDOne {
    ...
    public class SubaktivitasNilaiBlalbdPipaEditBase : SubaktivitasNilaiBlalbdPipa
    {
        ...
        // Constructor
        public SubaktivitasNilaiBlalbdPipaEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubaktivitasNilaiBlalbdPipaEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasNilaiBlalbdPipaList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubaktivitasNilaiBlalbdPipaList") {
                        ...
                        returnUrl = "SubaktivitasNilaiBlalbdPipaList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
