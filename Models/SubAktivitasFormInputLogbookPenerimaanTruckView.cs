...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbookPenerimaanTruckViewBase : SubAktivitasFormInputLogbookPenerimaanTruck
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanTruckViewBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanTruckViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputLogbookPenerimaanTruckList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputLogbookPenerimaanTruckList"); // Return to list page
                            }
                        }
                    break;
            }
