...
public partial class SnDOne {
    ...
    public class SubAktivitasLogbookPenerimaanStsPymBbmEditBase : SubAktivitasLogbookPenerimaanStsPymBbm
    {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanStsPymBbmEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanStsPymBbmEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasLogbookPenerimaanStsPymBbmList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubAktivitasLogbookPenerimaanStsPymBbmList") {
                        ...
                        returnUrl = "SubAktivitasLogbookPenerimaanStsPymBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
