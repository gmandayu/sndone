...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputDataStopPembongkaranEditBase : SubAktivitasFormInputDataStopPembongkaran
    {
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputDataStopPembongkaranList"); // No matching record, return to list
                        }
                    break;
