...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiBLnAlDelete
    /// </summary>
    public static SubAktivitasFormInputNilaiBLnAlDelete subAktivitasFormInputNilaiBLnAlDelete
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiBLnAlDelete>("subAktivitasFormInputNilaiBLnAlDelete")!;
        set => HttpData["subAktivitasFormInputNilaiBLnAlDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiBLnAL
    /// </summary>
    public class SubAktivitasFormInputNilaiBLnAlDelete : SubAktivitasFormInputNilaiBLnAlDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiBLnAlDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiBLnAlDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiBLnAlDeleteBase : SubAktivitasFormInputNilaiBLnAl
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiBLnAlDelete";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLnAlDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiBLnAlDelete";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLnAlDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputNilaiBLnAlList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputNilaiBLnAlList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputNilaiBLnAlDelete?.PageRender();
            }
            return PageResult();
        }
