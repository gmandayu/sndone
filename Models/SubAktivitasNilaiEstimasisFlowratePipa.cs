...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiEstimasisFlowratePipa
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiEstimasisFlowratePipa subAktivitasNilaiEstimasisFlowratePipa
    {
        get => HttpData.Resolve<SubAktivitasNilaiEstimasisFlowratePipa>("SubAktivitasNilaiEstimasisFlowratePipa");
        set => HttpData["SubAktivitasNilaiEstimasisFlowratePipa"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiEstimasisFlowratePipa
    /// </summary>
    public class SubAktivitasNilaiEstimasisFlowratePipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> StrippingTime;

        public readonly DbField<SqlDbType> LamaPembongkaran;
        ...
        // Constructor
        public SubAktivitasNilaiEstimasisFlowratePipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiEstimasisFlowratePipa";
            Name = "SubAktivitasNilaiEstimasisFlowratePipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiEstimasisFlowratePipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Nominasi = new(this, "x_Nominasi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "Nominasi", "CustomMsg"),
                IsUpload = false
            };
            ...
            Pressure = new(this, "x_Pressure", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "Pressure", "CustomMsg"),
                IsUpload = false
            };
            ...
            Flowrate = new(this, "x_Flowrate", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "Flowrate", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Flowrate", Flowrate);

            // StrippingTime
            StrippingTime = new(this, "x_StrippingTime", 202, SqlDbType.NVarChar) {
                Name = "StrippingTime",
                Expression = "[StrippingTime]",
                BasicSearchExpression = "[StrippingTime]",
                DateTimeFormat = -1,
                VirtualExpression = "[StrippingTime]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "StrippingTime", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("StrippingTime", StrippingTime);

            // LamaPembongkaran
            LamaPembongkaran = new(this, "x_LamaPembongkaran", 202, SqlDbType.NVarChar) {
                Name = "LamaPembongkaran",
                Expression = "[LamaPembongkaran]",
                UseBasicSearch = true,
                BasicSearchExpression = "[LamaPembongkaran]",
                DateTimeFormat = -1,
                VirtualExpression = "[LamaPembongkaran]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "LamaPembongkaran", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LamaPembongkaran", LamaPembongkaran);
            ...
            ETC = new(this, "x_ETC", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "ETC", "CustomMsg"),
                IsUpload = false
            };
            ETC.Raw = true;
            Fields.Add("ETC", ETC);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiEstimasisFlowratePipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiEstimasisFlowratePipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiEstimasisFlowratePipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                StrippingTime.DbValue = row["StrippingTime"]; // Set DB value only
                LamaPembongkaran.DbValue = row["LamaPembongkaran"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiEstimasisFlowratePipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiEstimasisFlowratePipaView" => Language.Phrase("View"),
                "SubAktivitasNilaiEstimasisFlowratePipaEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiEstimasisFlowratePipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiEstimasisFlowratePipaView",
                Config.ApiAddAction => "SubAktivitasNilaiEstimasisFlowratePipaAdd",
                Config.ApiEditAction => "SubAktivitasNilaiEstimasisFlowratePipaEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiEstimasisFlowratePipaDelete",
                Config.ApiListAction => "SubAktivitasNilaiEstimasisFlowratePipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiEstimasisFlowratePipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiEstimasisFlowratePipaView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiEstimasisFlowratePipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiEstimasisFlowratePipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiEstimasisFlowratePipaAdd?" + parm;
            else
                url = "SubAktivitasNilaiEstimasisFlowratePipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiEstimasisFlowratePipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiEstimasisFlowratePipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiEstimasisFlowratePipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiEstimasisFlowratePipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiEstimasisFlowratePipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiEstimasisFlowratePipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            StrippingTime.EditValue = StrippingTime.CurrentValue;
            StrippingTime.PlaceHolder = RemoveHtml(StrippingTime.Caption);

            // LamaPembongkaran
            LamaPembongkaran.SetupEditAttributes();
            LamaPembongkaran.EditValue = ConvertToString(LamaPembongkaran.CurrentValue); // DN
            LamaPembongkaran.ViewCustomAttributes = "";
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(LamaPembongkaran);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(LamaPembongkaran);
