...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbookPenerimaanStsPymLpgDelete
    /// </summary>
    public static SubAktivitasFormInputLogbookPenerimaanStsPymLpgDelete subAktivitasFormInputLogbookPenerimaanStsPymLpgDelete
    {
        get => HttpData.Get<SubAktivitasFormInputLogbookPenerimaanStsPymLpgDelete>("subAktivitasFormInputLogbookPenerimaanStsPymLpgDelete")!;
        set => HttpData["subAktivitasFormInputLogbookPenerimaanStsPymLpgDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbookPenerimaanSTSPymLPG
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanStsPymLpgDelete : SubAktivitasFormInputLogbookPenerimaanStsPymLpgDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanStsPymLpgDeleteBase : SubAktivitasFormInputLogbookPenerimaanStsPymLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbookPenerimaanStsPymLpgDelete";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbookPenerimaanStsPymLpgDelete";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanStsPymLpgDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputLogbookPenerimaanStsPymLpgList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputLogbookPenerimaanStsPymLpgList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputLogbookPenerimaanStsPymLpgDelete?.PageRender();
            }
            return PageResult();
        }
