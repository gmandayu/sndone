...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit
    /// </summary>
    public static SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit subAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit
    {
        get => HttpData.Get<SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit>("subAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit")!;
        set => HttpData["subAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasHasilPemeriksaanPenyaluranSTSPyrBBM
    /// </summary>
    public class SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit : SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEditBase
    {
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEditBase : SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmList")), "", TableVar, true);
            string pageId = "edit";
