...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputMonitoringStockStsPymSbbmEdit
    /// </summary>
    public static SubAktivitasFormInputMonitoringStockStsPymSbbmEdit subAktivitasFormInputMonitoringStockStsPymSbbmEdit
    {
        get => HttpData.Get<SubAktivitasFormInputMonitoringStockStsPymSbbmEdit>("subAktivitasFormInputMonitoringStockStsPymSbbmEdit")!;
        set => HttpData["subAktivitasFormInputMonitoringStockStsPymSbbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputMonitoringStockSTSPymSBBM
    /// </summary>
    public class SubAktivitasFormInputMonitoringStockStsPymSbbmEdit : SubAktivitasFormInputMonitoringStockStsPymSbbmEditBase
    {
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSbbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSbbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputMonitoringStockStsPymSbbmEditBase : SubAktivitasFormInputMonitoringStockStsPymSbbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputMonitoringStockStsPymSbbmEdit";
        ...
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSbbmEditBase(Controller? controller)
        {
            TableName = "SubAktivitasFormInputMonitoringStockSTSPymSBBM";
        ...
        if (controller != null)
            ...
            // Table object (subAktivitasFormInputMonitoringStockStsPymSbbm)
            if (subAktivitasFormInputMonitoringStockStsPymSbbm == null || subAktivitasFormInputMonitoringStockStsPymSbbm is SubAktivitasFormInputMonitoringStockStsPymSbbm)
                subAktivitasFormInputMonitoringStockStsPymSbbm = this;
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputMonitoringStockStsPymSbbmEdit";
        ...
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSbbmEditBase() : this(null) { }
            ...
            string pageName = GetPageName(url);
                ...
                // List / View / Master View page
                    if (!SameString(pageName, ListUrl))
                    {
                        ...
                        result.Add("view", pageName == "SubAktivitasFormInputMonitoringStockStsPymSbbmView" ? "1" : "0"); // If View page, no primary button
                    }
                    else
                    {
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputMonitoringStockStsPymSbbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputMonitoringStockStsPymSbbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputMonitoringStockStsPymSbbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputMonitoringStockStsPymSbbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'NomorTangki'
            NomorTangki.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(NomorTangki, "NomorTangki", "x_NomorTangki");
            ...
            // Standard handling for 'QuantityAwal'
            QuantityAwal.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(QuantityAwal, "QuantityAwal", "x_QuantityAwal");

            // Standard handling for 'QuantityAkhir'
            QuantityAkhir.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(QuantityAkhir, "QuantityAkhir", "x_QuantityAkhir");
            ...
            // Standard handling for 'TanggalQuantityAwal'
            TanggalQuantityAwal.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(TanggalQuantityAwal, "TanggalQuantityAwal", "x_TanggalQuantityAwal", true, validate, true);

            // Standard handling for 'TanggalQuantityAkhir'
            TanggalQuantityAkhir.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(TanggalQuantityAkhir, "TanggalQuantityAkhir", "x_TanggalQuantityAkhir", true, validate, true);
        }
        #pragma warning restore 1998
        ...
        public void RestoreFormValues()
        {
            ...
            NomorTangki.CurrentValue = NomorTangki.FormValue;
            Produk.CurrentValue = Produk.FormValue;
            Aktivitas2.CurrentValue = Aktivitas2.FormValue;
            QuantityAwal.CurrentValue = QuantityAwal.FormValue;
            QuantityAkhir.CurrentValue = QuantityAkhir.FormValue;
            ...
            TanggalQuantityAwal.CurrentValue = TanggalQuantityAwal.FormValue;
            TanggalQuantityAwal.CurrentValue = UnformatDateTime(TanggalQuantityAwal.CurrentValue, TanggalQuantityAwal.FormatPattern);
            TanggalQuantityAkhir.CurrentValue = TanggalQuantityAkhir.FormValue;
            TanggalQuantityAkhir.CurrentValue = UnformatDateTime(TanggalQuantityAkhir.CurrentValue, TanggalQuantityAkhir.FormatPattern);
        }
        ...
        public async Task RenderRow()
        {
            ...
            // QuantityAwal
            QuantityAwal.RowCssClass = "row";

            // QuantityAkhir
            QuantityAkhir.RowCssClass = "row";
            ...
            // TanggalQuantityAwal
            TanggalQuantityAwal.RowCssClass = "row";

            // TanggalQuantityAkhir
            TanggalQuantityAkhir.RowCssClass = "row";
            ...
            if (RowType == RowType.View) {
                ...
                NomorTangki.EditValue = HtmlEncode(NomorTangki.CurrentValue);
                ...
                if (!Aktivitas2.Raw)
                    Aktivitas2.CurrentValue = HtmlDecode(Aktivitas2.CurrentValue);
                Aktivitas2.EditValue = HtmlEncode(Aktivitas2.CurrentValue);
                Aktivitas2.PlaceHolder = RemoveHtml(Aktivitas2.Caption);

                // QuantityAwal
                QuantityAwal.SetupEditAttributes();
                if (!QuantityAwal.Raw)
                    QuantityAwal.CurrentValue = HtmlDecode(QuantityAwal.CurrentValue);
                QuantityAwal.EditValue = HtmlEncode(QuantityAwal.CurrentValue);
                QuantityAwal.PlaceHolder = RemoveHtml(QuantityAwal.Caption);

                // QuantityAkhir
                QuantityAkhir.SetupEditAttributes();
                if (!QuantityAkhir.Raw)
                    QuantityAkhir.CurrentValue = HtmlDecode(QuantityAkhir.CurrentValue);
                QuantityAkhir.EditValue = HtmlEncode(QuantityAkhir.CurrentValue);
                QuantityAkhir.PlaceHolder = RemoveHtml(QuantityAkhir.Caption);
                ...
                // TanggalQuantityAwal
                TanggalQuantityAwal.SetupEditAttributes();
                TanggalQuantityAwal.EditValue = FormatDateTime(TanggalQuantityAwal.CurrentValue, TanggalQuantityAwal.FormatPattern);
                TanggalQuantityAwal.PlaceHolder = RemoveHtml(TanggalQuantityAwal.Caption);

                // TanggalQuantityAkhir
                TanggalQuantityAkhir.SetupEditAttributes();
                TanggalQuantityAkhir.EditValue = FormatDateTime(TanggalQuantityAkhir.CurrentValue, TanggalQuantityAkhir.FormatPattern);
                TanggalQuantityAkhir.PlaceHolder = RemoveHtml(TanggalQuantityAkhir.Caption);
        ...
        private void ValidateCustomid() {
            if (id.Visible && id.Required) {
                if (!id.IsDetailKey && Empty(id.FormValue)) {
                    id.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidProses() {
            if (idProses.Visible && idProses.Required) {
                if (!idProses.IsDetailKey && Empty(idProses.FormValue)) {
                    idProses.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidAktifitas() {
            if (idAktifitas.Visible && idAktifitas.Required) {
                if (!idAktifitas.IsDetailKey && Empty(idAktifitas.FormValue)) {
                    idAktifitas.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNoReferensi() {
            if (NoReferensi.Visible && NoReferensi.Required) {
                if (!NoReferensi.IsDetailKey && Empty(NoReferensi.FormValue)) {
                    NoReferensi.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }

        private void ValidateCustomNomorTangki() {
            if (NomorTangki.Visible && NomorTangki.Required) {
                if (!NomorTangki.IsDetailKey && Empty(NomorTangki.FormValue)) {
                    NomorTangki.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        private void ValidateCustomProduk() {
            if (Produk.Visible && Produk.Required) {
                if (!Produk.IsDetailKey && Empty(Produk.FormValue)) {
                    Produk.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        private void ValidateCustomAktivitas2() {
            if (Aktivitas2.Visible && Aktivitas2.Required) {
                if (!Aktivitas2.IsDetailKey && Empty(Aktivitas2.FormValue)) {
                    Aktivitas2.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }

        private void ValidateCustomQuantityAwal() {
            if (QuantityAwal.Visible && QuantityAwal.Required) {
                if (!QuantityAwal.IsDetailKey && Empty(QuantityAwal.FormValue)) {
                    QuantityAwal.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }

        private void ValidateCustomQuantityAkhir() {
            if (QuantityAkhir.Visible && QuantityAkhir.Required) {
                if (!QuantityAkhir.IsDetailKey && Empty(QuantityAkhir.FormValue)) {
                    QuantityAkhir.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        private void ValidateCustomFlowrate() {
            if (Flowrate.Visible && Flowrate.Required) {
                if (!Flowrate.IsDetailKey && Empty(Flowrate.FormValue)) {
                    Flowrate.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        private void ValidateCustomKeterangan() {
            if (Keterangan.Visible && Keterangan.Required) {
                if (!Keterangan.IsDetailKey && Empty(Keterangan.FormValue)) {
                    Keterangan.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        private void ValidateCustomuserInput() {
            if (userInput.Visible && userInput.Required) {
                if (!userInput.IsDetailKey && Empty(userInput.FormValue)) {
                    userInput.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        private void ValidateCustometlDate() {
            if (etlDate.Visible && etlDate.Required) {
                if (!etlDate.IsDetailKey && Empty(etlDate.FormValue)) {
                    etlDate.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLastUpdatedBy() {
            if (LastUpdatedBy.Visible && LastUpdatedBy.Required) {
                if (!LastUpdatedBy.IsDetailKey && Empty(LastUpdatedBy.FormValue)) {
                    LastUpdatedBy.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        private void ValidateCustomlastUpdatedDate() {
            if (lastUpdatedDate.Visible && lastUpdatedDate.Required) {
                if (!lastUpdatedDate.IsDetailKey && Empty(lastUpdatedDate.FormValue)) {
                    lastUpdatedDate.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }

        private void ValidateCustomTanggalQuantityAwal() {
            if (TanggalQuantityAwal.Visible && TanggalQuantityAwal.Required) {
                if (!TanggalQuantityAwal.IsDetailKey && Empty(TanggalQuantityAwal.FormValue)) {
                    TanggalQuantityAwal.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }

        private void ValidateCustomTanggalQuantityAkhir() {
            if (TanggalQuantityAkhir.Visible && TanggalQuantityAkhir.Required) {
                if (!TanggalQuantityAkhir.IsDetailKey && Empty(TanggalQuantityAkhir.FormValue)) {
                    TanggalQuantityAkhir.AddErrorMessage(ConvertToString(TanggalQuantityAkhir.RequiredErrorMessage).Replace("%s", TanggalQuantityAkhir.Caption));
                }
            }
        }
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ...
                ValidateCustomNomorTangki();
                ValidateCustomProduk();
                ValidateCustomAktivitas2();
                ValidateCustomQuantityAwal();
                ValidateCustomQuantityAkhir();
                ...
                ValidateCustomTanggalQuantityAwal();
                if (!CheckDate(TanggalQuantityAwal.FormValue, TanggalQuantityAwal.FormatPattern)) {
                    TanggalQuantityAwal.AddErrorMessage(TanggalQuantityAwal.GetErrorMessage(false));
                }
                ValidateCustomTanggalQuantityAkhir();
                if (!CheckDate(TanggalQuantityAkhir.FormValue, TanggalQuantityAkhir.FormatPattern)) {
                    TanggalQuantityAkhir.AddErrorMessage(TanggalQuantityAkhir.GetErrorMessage(false));
                }
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // NomorTangki
            NomorTangki.SetDbValue(rsnew, NomorTangki.CurrentValue, NomorTangki.ReadOnly);
            ...
            // QuantityAwal
            QuantityAwal.SetDbValue(rsnew, QuantityAwal.CurrentValue, QuantityAwal.ReadOnly);

            // QuantityAkhir
            QuantityAkhir.SetDbValue(rsnew, QuantityAkhir.CurrentValue, QuantityAkhir.ReadOnly);
            ...
            // TanggalQuantityAwal
            TanggalQuantityAwal.SetDbValue(rsnew, ConvertToDateTime(TanggalQuantityAwal.CurrentValue, TanggalQuantityAwal.FormatPattern), TanggalQuantityAwal.ReadOnly);

            // TanggalQuantityAkhir
            TanggalQuantityAkhir.SetDbValue(rsnew, ConvertToDateTime(TanggalQuantityAkhir.CurrentValue, TanggalQuantityAkhir.FormatPattern), TanggalQuantityAkhir.ReadOnly);
            return rsnew;
        }
        ...
        protected void RestoreEditFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("NomorTangki", out value)) // NomorTangki
                NomorTangki.CurrentValue = value;
            ...
            if (row.TryGetValue("QuantityAwal", out value)) // QuantityAwal
                QuantityAwal.CurrentValue = value;
            if (row.TryGetValue("QuantityAkhir", out value)) // QuantityAkhir
                QuantityAkhir.CurrentValue = value;
            ...
            if (row.TryGetValue("TanggalQuantityAwal", out value)) // TanggalQuantityAwal
                TanggalQuantityAwal.CurrentValue = value;
            if (row.TryGetValue("TanggalQuantityAkhir", out value)) // TanggalQuantityAkhir
                TanggalQuantityAkhir.CurrentValue = value;
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputMonitoringStockStsPymSbbmList")), "", TableVar, true);
            string pageId = "edit";
