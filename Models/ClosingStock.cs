...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static ClosingStock closingStock
    {
        get => HttpData.Resolve<ClosingStock>("ClosingStock");
        set => HttpData["ClosingStock"] = value;
    }

    /// <summary>
    /// Table class for ClosingStock
    /// </summary>
    public class ClosingStock : DbTable
    {
        public override Dictionary<string, string> KeyFields { get; set; } = new() { // DN
            { "IdClosingStock", "IdClosingStock" },
        };
        ...
        public readonly DbField<SqlDbType> IdClosingStock;

        public readonly DbField<SqlDbType> IdTemplate;

        public readonly DbField<SqlDbType> NomorClosingStock;
        ...
        public readonly DbField<SqlDbType> TanggalClosingStock;
        ...
        public ClosingStock()
        {
            ...
            Name = "ClosingStock";
            Type = "TABLE";
            UpdateTable = "dbo.ClosingStock"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // IdClosingStock
            IdClosingStock = new(this, "x_IdClosingStock", 3, SqlDbType.Int) {
                Name = "IdClosingStock",
                Expression = "[IdClosingStock]",
                BasicSearchExpression = "CAST([IdClosingStock] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[IdClosingStock]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("ClosingStock", "IdClosingStock", "CustomMsg"),
                IsUpload = false
            };
            IdClosingStock.Raw = true;
            Fields.Add("IdClosingStock", IdClosingStock);
            ...
            IdTemplate = new(this, "x_IdTemplate", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "IdTemplate", "CustomMsg"),
                IsUpload = false
            };
            IdTemplate.Raw = true;
            IdTemplate.GetDefault = () => 30;
            Fields.Add("IdTemplate", IdTemplate);

            // NomorClosingStock
            NomorClosingStock = new(this, "x_NomorClosingStock", 200, SqlDbType.VarChar) {
                Name = "NomorClosingStock",
                Expression = "[NomorClosingStock]",
                BasicSearchExpression = "[NomorClosingStock]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorClosingStock]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("ClosingStock", "NomorClosingStock", "CustomMsg"),
                IsUpload = false
            };
            NomorClosingStock.Lookup = new Lookup<DbField>(NomorClosingStock, "ClosingStock", true, "NomorClosingStock", new List<string> {"NomorClosingStock", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NomorClosingStock", NomorClosingStock);

            // Proses
            Proses2 = new(this, "x_Proses2", 202, SqlDbType.NVarChar) {
                Name = "Proses",
                Expression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorClosingStock AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorClosingStock AS NVARCHAR(50))+'</a>'",
                UseBasicSearch = true,
                BasicSearchExpression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorClosingStock AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorClosingStock AS NVARCHAR(50))+'</a>'",
                DateTimeFormat = -1,
                VirtualExpression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorClosingStock AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorClosingStock AS NVARCHAR(50))+'</a>'",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("ClosingStock", "Proses2", "CustomMsg"),
                IsUpload = false
            };
            Proses2.Lookup = new Lookup<DbField>(Proses2, "ClosingStock", true, "Proses", new List<string> {"Proses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LookupPlant = new(this, "x_LookupPlant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("ClosingStock", "LookupPlant", "CustomMsg"),
                IsUpload = false
            };
            LookupPlant.Raw = true;
            LookupPlant.Lookup = new Lookup<DbField>(LookupPlant, "ClosingStock", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Plant = new(this, "x_Plant", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "Plant", "CustomMsg"),
                IsUpload = false
            };
            Plant.Lookup = new Lookup<DbField>(Plant, "MasterPlant", true, "IdPlant", new List<string> {"Plant", "Nama_Terminal", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {"Plant", "JenisPlant"}, new List<string> {"x_PlantForLookup", "x_LookupJenisPlant"}, false, "", "", "CONCAT([Plant],'" + ValueSeparator(1, Plant) + "',[Nama_Terminal])");
            ...
            TipeProdukSTS = new(this, "x_TipeProdukSTS", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("ClosingStock", "TipeProdukSTS", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdTangki = new(this, "x_IdTangki", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "IdTangki", "CustomMsg"),
                IsUpload = false
            };
            IdTangki.Raw = true;
            ...
            // TanggalClosingStock
            TanggalClosingStock = new(this, "x_TanggalClosingStock", 135, SqlDbType.DateTime) {
                Name = "TanggalClosingStock",
                Expression = "[TanggalClosingStock]",
                BasicSearchExpression = CastDateFieldForLike("[TanggalClosingStock]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[TanggalClosingStock]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("ClosingStock", "TanggalClosingStock", "CustomMsg"),
                IsUpload = false
            };
            TanggalClosingStock.Raw = true;
            Fields.Add("TanggalClosingStock", TanggalClosingStock);
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                OptionCount = 1,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "Produk", "CustomMsg"),
                IsUpload = false
            };
            Produk.Lookup = new Lookup<DbField>(Produk, "MasterProduk", false, "NoProduk", new List<string> {"NoProduk", "NamaProduk", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "CONCAT([NoProduk],'" + ValueSeparator(1, Produk) + "',[NamaProduk])");
            ...
            StatusProses = new(this, "x_StatusProses", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "StatusProses", "CustomMsg"),
                IsUpload = false
            };
            StatusProses.Lookup = new Lookup<DbField>(StatusProses, "ClosingStock", true, "StatusProses", new List<string> {"StatusProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            PersentaseProgress = new(this, "x_PersentaseProgress", 131, SqlDbType.Decimal) {
                ...
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "PersentaseProgress", "CustomMsg"),
                IsUpload = false
            };
            PersentaseProgress.Raw = true;
            PersentaseProgress.Lookup = new Lookup<DbField>(PersentaseProgress, "ClosingStock", true, "PersentaseProgress", new List<string> {"PersentaseProgress", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Catatan = new(this, "x_Catatan", 201, SqlDbType.Text) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "Catatan", "CustomMsg"),
                IsUpload = false
            };
            Catatan.Lookup = new Lookup<DbField>(Catatan, "ClosingStock", true, "Catatan", new List<string> {"Catatan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            DibuatOleh.Lookup = new Lookup<DbField>(DibuatOleh, "ClosingStock", true, "DibuatOleh", new List<string> {"DibuatOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            TanggalDibuat.Raw = true;
            TanggalDibuat.Lookup = new Lookup<DbField>(TanggalDibuat, "ClosingStock", true, "TanggalDibuat", new List<string> {"TanggalDibuat", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            DiperbaruiOleh.Lookup = new Lookup<DbField>(DiperbaruiOleh, "ClosingStock", true, "DiperbaruiOleh", new List<string> {"DiperbaruiOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiperbarui.Raw = true;
            TanggalDiperbarui.Lookup = new Lookup<DbField>(TanggalDiperbarui, "ClosingStock", true, "TanggalDiperbarui", new List<string> {"TanggalDiperbarui", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            PlantForLookup = new(this, "x_PlantForLookup", 200, SqlDbType.VarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "PlantForLookup", "CustomMsg"),
                IsUpload = false
            };
            ...
            LookupJenisPlant = new(this, "x_LookupJenisPlant", 200, SqlDbType.VarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("ClosingStock", "LookupJenisPlant", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get {
                string select = "*, '<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorClosingStock AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorClosingStock AS NVARCHAR(50))+'</a>' AS [Proses], '' AS [PlantForLookup], '' AS [LookupJenisPlant]";
                if (select == "*") {
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.ClosingStock type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdClosingStock"))
                    row["IdClosingStock"] = lastInsertedId;
                else
                    row.Add("IdClosingStock", lastInsertedId);
                IdClosingStock.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                IdClosingStock.DbValue = row["IdClosingStock"]; // Set DB value only
                IdTemplate.DbValue = row["IdTemplate"]; // Set DB value only
                NomorClosingStock.DbValue = row["NomorClosingStock"]; // Set DB value only
                ...
                TanggalClosingStock.DbValue = row["TanggalClosingStock"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[IdClosingStock] = @IdClosingStock@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "ClosingStockView" => Language.Phrase("View"),
                "ClosingStockEdit" => Language.Phrase("Edit"),
                "ClosingStockAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "ClosingStockView",
                Config.ApiAddAction => "ClosingStockAdd",
                Config.ApiEditAction => "ClosingStockEdit",
                Config.ApiDeleteAction => "ClosingStockDelete",
                Config.ApiListAction => "ClosingStockList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "ClosingStockList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("ClosingStockView", parm);
            else
                url = KeyUrl("ClosingStockView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "ClosingStockAdd";
        ...
        {
            string url = "";
            url = KeyUrl("ClosingStockEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("ClosingStockList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("ClosingStockAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("ClosingStockList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("ClosingStockDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdClosingStock\":" + ConvertToJson(IdClosingStock.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdClosingStock.CurrentValue)) {
                url += "/" + IdClosingStock.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdClosingStock", out object? v0)) { // IdClosingStock // DN
                    key = UrlDecode(v0); // DN
                } else if (IsApi() && !Empty(keyValues)) {
                    key = keyValues[0];
                } else {
                    key = Param("IdClosingStock");
                }
                keysList.Add(key);
            }
            // Check keys
            foreach (var keys in keysList) {
                if (KeyFields.Count > 1 && (!IsArray(keys) || keys.Length != KeyFields.Count))
                    continue;
                if (!IsNumeric(keys)) // IdClosingStock
                    continue;
                result.Add(keys);
            }
            return result;
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdClosingStock.CurrentValue = keys;
                else
                    IdClosingStock.OldValue = keys;
        ...
        {
            string pageName = "ClosingStockList";
        ...
        public async Task RenderListRow()
        {
            ...
            IdTangki.ViewValue = Empty(curVal4) ? DbNullValue : FormatNumber(IdTangki.CurrentValue, IdTangki.FormatPattern);
            if (!Empty(curVal4)) {
            ...
            // IdClosingStock
            IdClosingStock.HrefValue = "";
            IdClosingStock.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // IdClosingStock
            IdClosingStock.SetupEditAttributes();
            IdClosingStock.EditValue = IdClosingStock.CurrentValue;
            IdClosingStock.EditValue = FormatNumber(IdClosingStock.EditValue, IdClosingStock.FormatPattern);
            IdClosingStock.ViewCustomAttributes = "";
            ...
            // awallookupbung
            string curVal4 = ConvertToString(IdTangki.CurrentValue);
            IdTangki.EditValue = Empty(curVal4) ? DbNullValue : FormatNumber(IdTangki.CurrentValue, IdTangki.FormatPattern);
            if (!Empty(curVal4)) {
                if (IdTangki.Lookup != null && IsDictionary(IdTangki.Lookup?.Options) && IdTangki.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(IdClosingStock);
                        doc.ExportCaption(IdTemplate);
                        doc.ExportCaption(NomorClosingStock);
                        ...
                        doc.ExportCaption(TanggalClosingStock);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(IdClosingStock);
                            await doc.ExportField(IdTemplate);
                            await doc.ExportField(NomorClosingStock);
                            ...
                            await doc.ExportField(TanggalClosingStock);
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            try {
                ...
                var plantLookup = rsnew["PlantForLookup"].ToString();

                // Jalankan SP GenerateNomorReferensiPenimbunan untuk ClosingStock
                string sql = $"EXEC GenerateNomorReferensiPenimbunan {idPlant}, {idTangki}, 'ClosingStock'";
                var nomorRefObj = ExecuteScalar(sql);
                if (nomorRefObj == null)
                    throw new Exception("Gagal menghasilkan NomorReferensi.");
                string nomorClosing = nomorRefObj.ToString();
                rsnew["NomorClosingStock"] = nomorClosing;

                // Panggil GetPlantDateTime dengan NomorClosingStock atau IdPlant
                DateTime plantTime = DateTime.Now; // fallback
                var plantObj = ExecuteScalar($"EXEC dbo.GetPlantDateTime @NomorReferensi = '{nomorClosing}'");
                if (plantObj != null && DateTime.TryParse(plantObj.ToString(), out var tmp))
                    plantTime = tmp;

                // Set kolom waktu menggunakan plant time
        ...
        public void RowInserted(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            try {
                var nomorReferensi = rsnew["NomorClosingStock"].ToString();
                var jenisProses = "ClosingStock";
                var dibuatOleh = CurrentUserName();
                int idPlant = Convert.ToInt32(rsnew["Plant"]);
                string sql = $"EXEC GenerateProsesAktivitas_ClosingStock '{nomorReferensi}', '{jenisProses}', '{dibuatOleh}', {idPlant}";
                ExecuteScalar(sql);
            } catch (Exception ex) {
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            try {
                // Ambil nomor closing dari data baru atau lama
                string nomorClosing = rsnew.ContainsKey("NomorClosingStock")
                    ? rsnew["NomorClosingStock"].ToString()
                    : rsold["NomorClosingStock"].ToString();
