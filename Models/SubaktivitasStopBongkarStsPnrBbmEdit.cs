...
public partial class SnDOne {
    ...
    public class SubaktivitasStopBongkarStsPnrBbmEditBase : SubaktivitasStopBongkarStsPnrBbm
    {
        ...
        // Constructor
        public SubaktivitasStopBongkarStsPnrBbmEditBase()
        {
        ...
        // Constructor
        public SubaktivitasStopBongkarStsPnrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasStopBongkarStsPnrBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasStopBongkarStsPnrBbmList") {
                                ...
                                returnUrl = "SubaktivitasStopBongkarStsPnrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
