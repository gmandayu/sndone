...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasStartBongkarStsPnrBbm
    /// </summary>
    [MaybeNull]
    public static SubaktivitasStartBongkarStsPnrBbm subaktivitasStartBongkarStsPnrBbm
    {
        get => HttpData.Resolve<SubaktivitasStartBongkarStsPnrBbm>("SubaktivitasStartBongkarSTSPnrBBM");
        set => HttpData["SubaktivitasStartBongkarSTSPnrBBM"] = value;
    }

    /// <summary>
    /// Table class for SubaktivitasStartBongkarSTSPnrBBM
    /// </summary>
    public class SubaktivitasStartBongkarStsPnrBbm : DbTable
    {
        ...
        // Constructor
        public SubaktivitasStartBongkarStsPnrBbm()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubaktivitasStartBongkarSTSPnrBBM";
            Name = "SubaktivitasStartBongkarSTSPnrBBM";
            Type = "TABLE";
            UpdateTable = "dbo.SubaktivitasStartBongkarSTSPnrBBM"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasStartBongkarSTSPnrBBM", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasStartBongkarSTSPnrBBM", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasStartBongkarSTSPnrBBM", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasStartBongkarSTSPnrBBM", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasStartBongkarSTSPnrBBM", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasStartBongkarSTSPnrBBM", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasStartBongkarSTSPnrBBM", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            tglStartBongkar = new(this, "x_tglStartBongkar", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasStartBongkarSTSPnrBBM", "tglStartBongkar", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasStartBongkarSTSPnrBBM", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasStartBongkarSTSPnrBBM", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubaktivitasStartBongkarSTSPnrBBM";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubaktivitasStartBongkarStspnrBbm type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubaktivitasStartBongkarStsPnrBbmList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubaktivitasStartBongkarStsPnrBbmView" => Language.Phrase("View"),
                "SubaktivitasStartBongkarStsPnrBbmEdit" => Language.Phrase("Edit"),
                "SubaktivitasStartBongkarStsPnrBbmAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubaktivitasStartBongkarStsPnrBbmView",
                Config.ApiAddAction => "SubaktivitasStartBongkarStsPnrBbmAdd",
                Config.ApiEditAction => "SubaktivitasStartBongkarStsPnrBbmEdit",
                Config.ApiDeleteAction => "SubaktivitasStartBongkarStsPnrBbmDelete",
                Config.ApiListAction => "SubaktivitasStartBongkarStsPnrBbmList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubaktivitasStartBongkarStsPnrBbmList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubaktivitasStartBongkarStsPnrBbmView", parm);
            else
                url = KeyUrl("SubaktivitasStartBongkarStsPnrBbmView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubaktivitasStartBongkarStsPnrBbmAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubaktivitasStartBongkarStsPnrBbmAdd?" + parm;
            else
                url = "SubaktivitasStartBongkarStsPnrBbmAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasStartBongkarStsPnrBbmEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasStartBongkarStsPnrBbmList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasStartBongkarStsPnrBbmAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasStartBongkarStsPnrBbmList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubaktivitasStartBongkarStsPnrBbmDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubaktivitasStartBongkarStsPnrBbmList";
