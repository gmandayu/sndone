...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStopPembongkaranDelete
    /// </summary>
    public static SubAktivitasFormInputDataStopPembongkaranDelete subAktivitasFormInputDataStopPembongkaranDelete
    {
        get => HttpData.Get<SubAktivitasFormInputDataStopPembongkaranDelete>("subAktivitasFormInputDataStopPembongkaranDelete")!;
        set => HttpData["subAktivitasFormInputDataStopPembongkaranDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStopPembongkaran
    /// </summary>
    public class SubAktivitasFormInputDataStopPembongkaranDelete : SubAktivitasFormInputDataStopPembongkaranDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStopPembongkaranDeleteBase : SubAktivitasFormInputDataStopPembongkaran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStopPembongkaranDelete";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStopPembongkaranDelete";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputDataStopPembongkaranList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputDataStopPembongkaranList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputDataStopPembongkaranDelete?.PageRender();
            }
            return PageResult();
        }
