...
public partial class SnDOne {
    /// <summary>
    /// detailMasterPipaView
    /// </summary>
    public static DetailMasterPipaView detailMasterPipaView
    {
        get => HttpData.Get<DetailMasterPipaView>("detailMasterPipaView")!;
        set => HttpData["detailMasterPipaView"] = value;
    }

    /// <summary>
    /// Page class for DetailMasterPipa
    /// </summary>
    public class DetailMasterPipaView : DetailMasterPipaViewBase
    {
        // Constructor
        public DetailMasterPipaView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public DetailMasterPipaView() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class DetailMasterPipaViewBase : DetailMasterPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "detailMasterPipaView";
        ...
        // Constructor
        public DetailMasterPipaViewBase()
        {
        ...
        // Page name
        public string PageName => "DetailMasterPipaView";
        ...
        // Constructor
        public DetailMasterPipaViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "DetailMasterPipaList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("DetailMasterPipaList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                detailMasterPipaView?.PageRender();
            }
            return PageResult();
        }
