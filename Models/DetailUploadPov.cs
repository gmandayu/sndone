...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static DetailUploadPov detailUploadPov
    {
        get => HttpData.Resolve<DetailUploadPov>("DetailUploadPOV");
        set => HttpData["DetailUploadPOV"] = value;
    }

    /// <summary>
    /// Table class for DetailUploadPOV
    /// </summary>
    public class DetailUploadPov : DbTable
    {
        ...
        public readonly DbField<SqlDbType> idPOV;
        ...
        // Constructor
        public DetailUploadPov()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "DetailUploadPOV";
            Name = "DetailUploadPOV";
            Type = "TABLE";
            UpdateTable = "dbo.DetailUploadPOV"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("DetailUploadPOV", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            // idPOV
            idPOV = new(this, "x_idPOV", 3, SqlDbType.Int) {
                Name = "idPOV",
                Expression = "[idPOV]",
                BasicSearchExpression = "CAST([idPOV] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[idPOV]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("DetailUploadPOV", "idPOV", "CustomMsg"),
                IsUpload = false
            };
            idPOV.Raw = true;
            Fields.Add("idPOV", idPOV);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("DetailUploadPOV", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            FileName = new(this, "x_FileName", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadPOV", "FileName", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadPOV", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadPOV", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadPOV", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("DetailUploadPOV", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.DetailUploadPOV";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.DetailUploadPov type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                idPOV.DbValue = row["idPOV"]; // Set DB value only
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "DetailUploadPovView" => Language.Phrase("View"),
                "DetailUploadPovEdit" => Language.Phrase("Edit"),
                "DetailUploadPovAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "DetailUploadPovView",
                Config.ApiAddAction => "DetailUploadPovAdd",
                Config.ApiEditAction => "DetailUploadPovEdit",
                Config.ApiDeleteAction => "DetailUploadPovDelete",
                Config.ApiListAction => "DetailUploadPovList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "DetailUploadPovList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("DetailUploadPovView", parm);
            else
                url = KeyUrl("DetailUploadPovView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "DetailUploadPovAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "DetailUploadPovAdd?" + parm;
            else
                url = "DetailUploadPovAdd";
        ...
        {
            string url = "";
            url = KeyUrl("DetailUploadPovEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("DetailUploadPovList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("DetailUploadPovAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("DetailUploadPovList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("DetailUploadPovDelete", parm)); // DN
        }
        ...
        {
            string pageName = "DetailUploadPovList";
        ...
        public async Task RenderListRow()
        {
            ...
            // idPOV
            idPOV.ViewValue = idPOV.CurrentValue;
            idPOV.ViewValue = FormatNumber(idPOV.ViewValue, idPOV.FormatPattern);
            idPOV.ViewCustomAttributes = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // idPOV
            idPOV.SetupEditAttributes();
            idPOV.EditValue = idPOV.CurrentValue;
            idPOV.PlaceHolder = RemoveHtml(idPOV.Caption);
            if (!Empty(idPOV.EditValue) && IsNumeric(idPOV.EditValue))
                idPOV.EditValue = FormatNumber(idPOV.EditValue, null);
