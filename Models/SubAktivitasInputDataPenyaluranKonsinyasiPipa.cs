...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputDataPenyaluranKonsinyasiPipa
    /// </summary>
    [MaybeNull]
    public static SubAktivitasInputDataPenyaluranKonsinyasiPipa subAktivitasInputDataPenyaluranKonsinyasiPipa
    {
        get => HttpData.Resolve<SubAktivitasInputDataPenyaluranKonsinyasiPipa>("SubAktivitasInputDataPenyaluranKonsinyasiPipa");
        set => HttpData["SubAktivitasInputDataPenyaluranKonsinyasiPipa"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasInputDataPenyaluranKonsinyasiPipa
    /// </summary>
    public class SubAktivitasInputDataPenyaluranKonsinyasiPipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> NoUrut;
        ...
        // Constructor
        public SubAktivitasInputDataPenyaluranKonsinyasiPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasInputDataPenyaluranKonsinyasiPipa";
            Name = "SubAktivitasInputDataPenyaluranKonsinyasiPipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasInputDataPenyaluranKonsinyasiPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            Nominasi = new(this, "x_Nominasi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "Nominasi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Nominasi", Nominasi);

            // NoUrut
            NoUrut = new(this, "x_NoUrut", 202, SqlDbType.NVarChar) {
                Name = "NoUrut",
                Expression = "[NoUrut]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NoUrut]",
                DateTimeFormat = -1,
                VirtualExpression = "[NoUrut]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "NoUrut", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NoUrut", NoUrut);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataPenyaluranKonsinyasiPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasInputDataPenyaluranKonsinyasiPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasInputDataPenyaluranKonsinyasiPipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                NoUrut.DbValue = row["NoUrut"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasInputDataPenyaluranKonsinyasiPipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasInputDataPenyaluranKonsinyasiPipaView" => Language.Phrase("View"),
                "SubAktivitasInputDataPenyaluranKonsinyasiPipaEdit" => Language.Phrase("Edit"),
                "SubAktivitasInputDataPenyaluranKonsinyasiPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasInputDataPenyaluranKonsinyasiPipaView",
                Config.ApiAddAction => "SubAktivitasInputDataPenyaluranKonsinyasiPipaAdd",
                Config.ApiEditAction => "SubAktivitasInputDataPenyaluranKonsinyasiPipaEdit",
                Config.ApiDeleteAction => "SubAktivitasInputDataPenyaluranKonsinyasiPipaDelete",
                Config.ApiListAction => "SubAktivitasInputDataPenyaluranKonsinyasiPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasInputDataPenyaluranKonsinyasiPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasInputDataPenyaluranKonsinyasiPipaView", parm);
            else
                url = KeyUrl("SubAktivitasInputDataPenyaluranKonsinyasiPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasInputDataPenyaluranKonsinyasiPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasInputDataPenyaluranKonsinyasiPipaAdd?" + parm;
            else
                url = "SubAktivitasInputDataPenyaluranKonsinyasiPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasInputDataPenyaluranKonsinyasiPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasInputDataPenyaluranKonsinyasiPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasInputDataPenyaluranKonsinyasiPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasInputDataPenyaluranKonsinyasiPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasInputDataPenyaluranKonsinyasiPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasInputDataPenyaluranKonsinyasiPipaList";
        ...
        public async Task RenderListRow()
        {
            ...
            Produk.ViewValue = Empty(curVal4) ? DbNullValue : Produk.CurrentValue;
            if (!Empty(curVal4)) {
        ...
        public async Task RenderEditRow()
        {
            ...
            // awallookupbung
            string curVal4 = ConvertToString(Produk.CurrentValue);
            Produk.EditValue = Empty(curVal4) ? DbNullValue : Produk.CurrentValue;
            if (!Empty(curVal4)) {
                if (Produk.Lookup != null && IsDictionary(Produk.Lookup?.Options) && Produk.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    Produk.EditValue = Produk.LookupCacheOption(curVal4);
                } else { // Lookup from database // DN
                    string filterWrk4 = SearchFilter(Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchExpression, "=", Produk.CurrentValue, Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchDataType, "");
                    string? sqlWrk4 = Produk.Lookup?.GetSql(false, filterWrk4, null, this, true, true);
                    List<Dictionary<string, object>>? rswrk4 = sqlWrk4 != null ? Connection.GetRows(sqlWrk4) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
            ...
            // NoUrut
            NoUrut.SetupEditAttributes();
            if (!NoUrut.Raw)
                NoUrut.CurrentValue = HtmlDecode(NoUrut.CurrentValue);
            NoUrut.EditValue = NoUrut.CurrentValue;
            NoUrut.PlaceHolder = RemoveHtml(NoUrut.Caption);
