...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbMonitoringStockRtwDelete
    /// </summary>
    public static SubAktivitasFormInputLogbMonitoringStockRtwDelete subAktivitasFormInputLogbMonitoringStockRtwDelete
    {
        get => HttpData.Get<SubAktivitasFormInputLogbMonitoringStockRtwDelete>("subAktivitasFormInputLogbMonitoringStockRtwDelete")!;
        set => HttpData["subAktivitasFormInputLogbMonitoringStockRtwDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbMonitoringStockRTW
    /// </summary>
    public class SubAktivitasFormInputLogbMonitoringStockRtwDelete : SubAktivitasFormInputLogbMonitoringStockRtwDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbMonitoringStockRtwDeleteBase : SubAktivitasFormInputLogbMonitoringStockRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbMonitoringStockRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbMonitoringStockRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputLogbMonitoringStockRtwList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputLogbMonitoringStockRtwList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputLogbMonitoringStockRtwDelete?.PageRender();
            }
            return PageResult();
        }
