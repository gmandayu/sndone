...
public partial class SnDOne {
    ...
    public class SubaktivitasNilaiAgreementEditBase : SubaktivitasNilaiAgreement
    {
        ...
        // Constructor
        public SubaktivitasNilaiAgreementEditBase()
        {
        ...
        // Constructor
        public SubaktivitasNilaiAgreementEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasNilaiAgreementList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasNilaiAgreementList") {
                                ...
                                returnUrl = "SubaktivitasNilaiAgreementList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
