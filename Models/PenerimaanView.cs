...
public partial class SnDOne {
    ...
    public class PenerimaanViewBase : Penerimaan
    {
        ...
        // Constructor
        public PenerimaanViewBase(Controller? controller)
        {
        ...
        // Constructor
        public PenerimaanViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdPenerimaan", out v) && !Empty(v))
                {
                IdPenerimaan.QueryValue = UrlDecode(v);
                RecordKeys["IdPenerimaan"] = IdPenerimaan.QueryValue;
                return;
                }
                if (Get("IdPenerimaan", out sv))
                {
