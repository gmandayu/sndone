...
public partial class SnDOne {
    ...
    public class SamplingLabTestSearchBase : SamplingLabTest
    {
        ...
        // Constructor
        public SamplingLabTestSearchBase()
        {
        ...
        // Constructor
        public SamplingLabTestSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected void LoadSearchValues() {
            ...
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_NomorSamplingLabTest"))
            ...
            // IdReferensi
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_IdReferensi"))
