...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasStartBongkarLpgEdit
    /// </summary>
    public static SubAktivitasStartBongkarLpgEdit subAktivitasStartBongkarLpgEdit
    {
        get => HttpData.Get<SubAktivitasStartBongkarLpgEdit>("subAktivitasStartBongkarLpgEdit")!;
        set => HttpData["subAktivitasStartBongkarLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasStartBongkarLPG
    /// </summary>
    public class SubAktivitasStartBongkarLpgEdit : SubAktivitasStartBongkarLpgEditBase
    {
        // Constructor
        public SubAktivitasStartBongkarLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasStartBongkarLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasStartBongkarLpgEditBase : SubAktivitasStartBongkarLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasStartBongkarLpgEdit";
        ...
        // Constructor
        public SubAktivitasStartBongkarLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasStartBongkarLpgEdit";
        ...
        // Constructor
        public SubAktivitasStartBongkarLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasStartBongkarLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasStartBongkarLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasStartBongkarLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasStartBongkarLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasStartBongkarLpgList")), "", TableVar, true);
            string pageId = "edit";
