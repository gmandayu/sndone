...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStopPembongkaranPipaListBase : SubAktivitasDataStopPembongkaranPipa
    {
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranPipaListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranPipaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            if (filter.TryGetValue("x_tglStopBongkar", out sv)) {
                RestoreFieldFilter(tglStopBongkar, filter, "tglStopBongkar", sv);
            }
