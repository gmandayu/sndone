...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit
    /// </summary>
    public static SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit subAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit
    {
        get => HttpData.Get<SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit>("subAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit")!;
        set => HttpData["subAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasKeberangkatanKapalPenyaluranSTSPyrBBM
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit : SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEditBase
    {
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEditBase : SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasKeberangkatanKapalPenyaluranStsPyrBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasKeberangkatanKapalPenyaluranStsPyrBbmList")), "", TableVar, true);
            string pageId = "edit";
