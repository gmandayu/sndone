...
public partial class SnDOne {
    ...
    public class PenimbunanPenyaluranViewBase : PenimbunanPenyaluran
    {
        ...
        // Constructor
        public PenimbunanPenyaluranViewBase(Controller? controller)
        {
        ...
        // Constructor
        public PenimbunanPenyaluranViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdPenimbunanPenyaluran", out v) && !Empty(v))
                {
                IdPenimbunanPenyaluran.QueryValue = UrlDecode(v);
                RecordKeys["IdPenimbunanPenyaluran"] = IdPenimbunanPenyaluran.QueryValue;
                return;
                }
                if (Get("IdPenimbunanPenyaluran", out sv))
                {
