...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit
    /// </summary>
    public static SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit subAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit
    {
        get => HttpData.Get<SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit>("subAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit")!;
        set => HttpData["subAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiAgreementPenyaluranSTSPyrBBM
    /// </summary>
    public class SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit : SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEditBase
    {
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEditBase : SubAktivitasNilaiAgreementPenyaluranStsPyrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranStsPyrBbmEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiAgreementPenyaluranStsPyrBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiAgreementPenyaluranStsPyrBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiAgreementPenyaluranStsPyrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiAgreementPenyaluranStsPyrBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiAgreementPenyaluranStsPyrBbmList")), "", TableVar, true);
            string pageId = "edit";
