...
public partial class SnDOne {
    ...
    public class SetUserModAddBase : SetUserMod
    {
        ...
        // Constructor
        public SetUserModAddBase(Controller? controller)
        {
        ...
        // Constructor
        public SetUserModAddBase() : this(null) { }
        ...
        private void ValidateCustomTanggal() {
            if (Tanggal.Visible && Tanggal.Required) {
                if (!Tanggal.IsDetailKey && Empty(Tanggal.FormValue)) {
                    Tanggal.AddErrorMessage(ConvertToString(UserMOD.RequiredErrorMessage).Replace("%s", UserMOD.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLookupPlant() {
            if (LookupPlant.Visible && LookupPlant.Required) {
                if (!LookupPlant.IsDetailKey && Empty(LookupPlant.FormValue)) {
                    LookupPlant.AddErrorMessage(ConvertToString(UserMOD.RequiredErrorMessage).Replace("%s", UserMOD.Caption));
                }
            }
        }
        ...
        private void ValidateCustomPlant() {
            if (Plant.Visible && Plant.Required) {
                if (!Plant.IsDetailKey && Empty(Plant.FormValue)) {
                    Plant.AddErrorMessage(ConvertToString(UserMOD.RequiredErrorMessage).Replace("%s", UserMOD.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLookupUserMod() {
            if (LookupUserMod.Visible && LookupUserMod.Required) {
                if (!LookupUserMod.IsDetailKey && Empty(LookupUserMod.FormValue)) {
                    LookupUserMod.AddErrorMessage(ConvertToString(UserMOD.RequiredErrorMessage).Replace("%s", UserMOD.Caption));
                }
            }
        }
