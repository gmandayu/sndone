...
public partial class SnDOne {
    ...
    /// samplingLabTestView
    /// </summary>
    public static SamplingLabTestView samplingLabTestView
    {
        get => HttpData.Get<SamplingLabTestView>("samplingLabTestView")!;
        set => HttpData["samplingLabTestView"] = value;
    }

    /// <summary>
    /// Page class for SamplingLabTest
    /// </summary>
    public class SamplingLabTestView : SamplingLabTestViewBase
    {
        // Constructor
        public SamplingLabTestView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SamplingLabTestView() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class SamplingLabTestViewBase : SamplingLabTest
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "samplingLabTestView";
        ...
        // Constructor
        public SamplingLabTestViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdSamplingLabTest"] = keys[0];
            } else {
                RecordKeys["IdSamplingLabTest"] = RouteValues.TryGetValue("IdSamplingLabTest", out obj) && obj != null ? UrlDecode(obj) : Get("IdSamplingLabTest"); // DN
            }
        ...
        // Page name
        public string PageName => "SamplingLabTestView";
        ...
        {
            IdSamplingLabTest.SetVisibility();
        ...
        // Constructor
        public SamplingLabTestViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdSamplingLabTest", out v) && !Empty(v)) { // DN
                IdSamplingLabTest.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdSamplingLabTest"] = IdSamplingLabTest.QueryValue;
            } else if (Get("IdSamplingLabTest", out sv)) {
                IdSamplingLabTest.QueryValue = sv.ToString();
                RecordKeys["IdSamplingLabTest"] = IdSamplingLabTest.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdSamplingLabTest.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdSamplingLabTest"] = IdSamplingLabTest.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "SamplingLabTestList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SamplingLabTestList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                samplingLabTestView?.PageRender();
            }
            return PageResult();
        }
        ...
        public async Task ExportData(dynamic? doc, string[] keys)
        {
            ...
            StartRecord = 1;
            if (keys.Length >= 1) {
                IdSamplingLabTest.OldValue = keys[0];
