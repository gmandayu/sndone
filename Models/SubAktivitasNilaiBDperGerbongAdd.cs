...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiBDperGerbongAddBase : SubAktivitasNilaiBDperGerbong
    {
        ...
        // Constructor
        public SubAktivitasNilaiBDperGerbongAddBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasNilaiBDperGerbongAddBase() : this(null) { }
        ...
        private void ValidateCustometlDate() {
            if (etlDate.Visible && etlDate.Required) {
                if (!etlDate.IsDetailKey && Empty(etlDate.FormValue)) {
                    etlDate.AddErrorMessage(ConvertToString(Produk.RequiredErrorMessage).Replace("%s", Produk.Caption));
                }
            }
        }
