...
public partial class SnDOne {
    ...
    public class MasterTemplateAddBase : MasterTemplate
    {
        ...
        // Constructor
        public MasterTemplateAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MasterTemplateList"); // No matching record, return to List page // DN
                    }
