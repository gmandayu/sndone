...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasKapalBerangkatStsPnrBbm
    /// </summary>
    [MaybeNull]
    public static SubaktivitasKapalBerangkatStsPnrBbm subaktivitasKapalBerangkatStsPnrBbm
    {
        get => HttpData.Resolve<SubaktivitasKapalBerangkatStsPnrBbm>("SubaktivitasKapalBerangkatSTSPnrBBM");
        set => HttpData["SubaktivitasKapalBerangkatSTSPnrBBM"] = value;
    }

    /// <summary>
    /// Table class for SubaktivitasKapalBerangkatSTSPnrBBM
    /// </summary>
    public class SubaktivitasKapalBerangkatStsPnrBbm : DbTable
    {
        ...
        public readonly DbField<SqlDbType> tglBerangkat;
        ...
        // Constructor
        public SubaktivitasKapalBerangkatStsPnrBbm()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubaktivitasKapalBerangkatSTSPnrBBM";
            Name = "SubaktivitasKapalBerangkatSTSPnrBBM";
            Type = "TABLE";
            UpdateTable = "dbo.SubaktivitasKapalBerangkatSTSPnrBBM"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasKapalBerangkatSTSPnrBBM", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasKapalBerangkatSTSPnrBBM", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasKapalBerangkatSTSPnrBBM", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasKapalBerangkatSTSPnrBBM", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasKapalBerangkatSTSPnrBBM", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasKapalBerangkatSTSPnrBBM", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasKapalBerangkatSTSPnrBBM", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            // tglBerangkat
            tglBerangkat = new(this, "x_tglBerangkat", 135, SqlDbType.DateTime) {
                Name = "tglBerangkat",
                Expression = "[tglBerangkat]",
                BasicSearchExpression = CastDateFieldForLike("[tglBerangkat]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[tglBerangkat]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasKapalBerangkatSTSPnrBBM", "tglBerangkat", "CustomMsg"),
                IsUpload = false
            };
            tglBerangkat.Raw = true;
            Fields.Add("tglBerangkat", tglBerangkat);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasKapalBerangkatSTSPnrBBM", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasKapalBerangkatSTSPnrBBM", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubaktivitasKapalBerangkatSTSPnrBBM";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubaktivitasKapalBerangkatStspnrBbm type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                tglBerangkat.DbValue = row["tglBerangkat"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubaktivitasKapalBerangkatStsPnrBbmList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubaktivitasKapalBerangkatStsPnrBbmView" => Language.Phrase("View"),
                "SubaktivitasKapalBerangkatStsPnrBbmEdit" => Language.Phrase("Edit"),
                "SubaktivitasKapalBerangkatStsPnrBbmAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubaktivitasKapalBerangkatStsPnrBbmView",
                Config.ApiAddAction => "SubaktivitasKapalBerangkatStsPnrBbmAdd",
                Config.ApiEditAction => "SubaktivitasKapalBerangkatStsPnrBbmEdit",
                Config.ApiDeleteAction => "SubaktivitasKapalBerangkatStsPnrBbmDelete",
                Config.ApiListAction => "SubaktivitasKapalBerangkatStsPnrBbmList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubaktivitasKapalBerangkatStsPnrBbmList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubaktivitasKapalBerangkatStsPnrBbmView", parm);
            else
                url = KeyUrl("SubaktivitasKapalBerangkatStsPnrBbmView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubaktivitasKapalBerangkatStsPnrBbmAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubaktivitasKapalBerangkatStsPnrBbmAdd?" + parm;
            else
                url = "SubaktivitasKapalBerangkatStsPnrBbmAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasKapalBerangkatStsPnrBbmEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasKapalBerangkatStsPnrBbmList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasKapalBerangkatStsPnrBbmAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasKapalBerangkatStsPnrBbmList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubaktivitasKapalBerangkatStsPnrBbmDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubaktivitasKapalBerangkatStsPnrBbmList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // tglBerangkat
            tglBerangkat.SetupEditAttributes();
            tglBerangkat.EditValue = FormatDateTime(tglBerangkat.CurrentValue, tglBerangkat.FormatPattern);
            tglBerangkat.PlaceHolder = RemoveHtml(tglBerangkat.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(tglBerangkat);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(tglBerangkat);
