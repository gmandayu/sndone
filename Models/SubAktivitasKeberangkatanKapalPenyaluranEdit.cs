...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasKeberangkatanKapalPenyaluranEdit
    /// </summary>
    public static SubAktivitasKeberangkatanKapalPenyaluranEdit subAktivitasKeberangkatanKapalPenyaluranEdit
    {
        get => HttpData.Get<SubAktivitasKeberangkatanKapalPenyaluranEdit>("subAktivitasKeberangkatanKapalPenyaluranEdit")!;
        set => HttpData["subAktivitasKeberangkatanKapalPenyaluranEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasKeberangkatanKapalPenyaluran
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenyaluranEdit : SubAktivitasKeberangkatanKapalPenyaluranEditBase
    {
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasKeberangkatanKapalPenyaluranEditBase : SubAktivitasKeberangkatanKapalPenyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasKeberangkatanKapalPenyaluranEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasKeberangkatanKapalPenyaluranEdit";
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasKeberangkatanKapalPenyaluranList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanKapalPenyaluranList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasKeberangkatanKapalPenyaluranList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasKeberangkatanKapalPenyaluranEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasKeberangkatanKapalPenyaluranList")), "", TableVar, true);
            string pageId = "edit";
