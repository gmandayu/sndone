...
public partial class SnDOne {
    ...
    public class SubaktivitasKapalBerangkatStsPnrBbmEditBase : SubaktivitasKapalBerangkatStsPnrBbm
    {
        ...
        // Constructor
        public SubaktivitasKapalBerangkatStsPnrBbmEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubaktivitasKapalBerangkatStsPnrBbmEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasKapalBerangkatStsPnrBbmList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubaktivitasKapalBerangkatStsPnrBbmList") {
                        ...
                        returnUrl = "SubaktivitasKapalBerangkatStsPnrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
