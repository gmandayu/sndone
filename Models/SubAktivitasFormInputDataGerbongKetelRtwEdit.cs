...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputDataGerbongKetelRtwEditBase : SubAktivitasFormInputDataGerbongKetelRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputDataGerbongKetelRtwList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputDataGerbongKetelRtwList") {
                                ...
                                returnUrl = "SubAktivitasFormInputDataGerbongKetelRtwList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'Jns_Produk' before field var 'x_Jns_Produk'
            val = CurrentForm.HasValue("Jns_Produk") ? CurrentForm.GetValue("Jns_Produk") : CurrentForm.GetValue("x_Jns_Produk");
            if (!Jns_Produk.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("Jns_Produk") && !CurrentForm.HasValue("x_Jns_Produk")) // DN
                    Jns_Produk.Visible = false; // Disable update for API request
                else
                    Jns_Produk.SetFormValue(val);
            }
            ...
            bool validateForm = true;
                ...
                if (Jns_Produk.Visible && Jns_Produk.Required) {
                    if (!Jns_Produk.IsDetailKey && Empty(Jns_Produk.FormValue)) {
                        Jns_Produk.AddErrorMessage(ConvertToString(Jns_Produk.RequiredErrorMessage).Replace("%s", Jns_Produk.Caption));
                    }
                }
