...
public partial class SnDOne {
    ...
    /// masterDokumenDelete
    /// </summary>
    public static MasterDokumenDelete masterDokumenDelete
    {
        get => HttpData.Get<MasterDokumenDelete>("masterDokumenDelete")!;
        set => HttpData["masterDokumenDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterDokumen
    /// </summary>
    public class MasterDokumenDelete : MasterDokumenDeleteBase
    {
        // Constructor
        public MasterDokumenDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterDokumenDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterDokumenDeleteBase : MasterDokumen
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterDokumenDelete";
        ...
        // Constructor
        public MasterDokumenDeleteBase()
        {
        ...
        // Page name
        public string PageName => "MasterDokumenDelete";
        ...
        // Constructor
        public MasterDokumenDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterDokumenList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterDokumenList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                masterDokumenDelete?.PageRender();
            }
            return PageResult();
        }
