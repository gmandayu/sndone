...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLogbookPenerimaanStsPymLpgEdit
    /// </summary>
    public static SubAktivitasLogbookPenerimaanStsPymLpgEdit subAktivitasLogbookPenerimaanStsPymLpgEdit
    {
        get => HttpData.Get<SubAktivitasLogbookPenerimaanStsPymLpgEdit>("subAktivitasLogbookPenerimaanStsPymLpgEdit")!;
        set => HttpData["subAktivitasLogbookPenerimaanStsPymLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasLogbookPenerimaanSTSPymLPG
    /// </summary>
    public class SubAktivitasLogbookPenerimaanStsPymLpgEdit : SubAktivitasLogbookPenerimaanStsPymLpgEditBase
    {
        // Constructor
        public SubAktivitasLogbookPenerimaanStsPymLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasLogbookPenerimaanStsPymLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasLogbookPenerimaanStsPymLpgEditBase : SubAktivitasLogbookPenerimaanStsPymLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasLogbookPenerimaanStsPymLpgEdit";
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanStsPymLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasLogbookPenerimaanStsPymLpgEdit";
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanStsPymLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasLogbookPenerimaanStsPymLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasLogbookPenerimaanStsPymLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasLogbookPenerimaanStsPymLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasLogbookPenerimaanStsPymLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasLogbookPenerimaanStsPymLpgList")), "", TableVar, true);
            string pageId = "edit";
