...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasDataKapalEdit
    /// </summary>
    public static SubaktivitasDataKapalEdit subaktivitasDataKapalEdit
    {
        get => HttpData.Get<SubaktivitasDataKapalEdit>("subaktivitasDataKapalEdit")!;
        set => HttpData["subaktivitasDataKapalEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasDataKapal
    /// </summary>
    public class SubaktivitasDataKapalEdit : SubaktivitasDataKapalEditBase
    {
        // Constructor
        public SubaktivitasDataKapalEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasDataKapalEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasDataKapalEditBase : SubaktivitasDataKapal
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasDataKapalEdit";
        ...
        // Constructor
        public SubaktivitasDataKapalEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasDataKapalEdit";
        ...
        // Constructor
        public SubaktivitasDataKapalEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasDataKapalList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasDataKapalList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasDataKapalList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasDataKapalEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            SetNormalField(nominasi, "nominasi", "x_nominasi", true, validate, false);
            if (!id.IsDetailKey) {
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ...
                if (!CheckNumber(nominasi.FormValue)) {
                    nominasi.AddErrorMessage(nominasi.GetErrorMessage(false));
                }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasDataKapalList")), "", TableVar, true);
            string pageId = "edit";
