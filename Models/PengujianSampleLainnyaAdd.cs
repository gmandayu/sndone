...
public partial class SnDOne {
    /// <summary>
    /// pengujianSampleLainnyaAdd
    /// </summary>
    public static PengujianSampleLainnyaAdd pengujianSampleLainnyaAdd
    {
        get => HttpData.Get<PengujianSampleLainnyaAdd>("pengujianSampleLainnyaAdd")!;
        set => HttpData["pengujianSampleLainnyaAdd"] = value;
    }

    /// <summary>
    /// Page class for PengujianSampleLainnya
    /// </summary>
    public class PengujianSampleLainnyaAdd : PengujianSampleLainnyaAddBase
    {
        // Constructor
        public PengujianSampleLainnyaAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PengujianSampleLainnyaAdd() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PengujianSampleLainnyaAddBase : PengujianSampleLainnya
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "pengujianSampleLainnyaAdd";
        ...
        // Constructor
        public PengujianSampleLainnyaAddBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "PengujianSampleLainnyaAdd";
        ...
        {
            id.Visible = false;
            NomorPengujianSampelLainnya.Visible = false;
        ...
        // Constructor
        public PengujianSampleLainnyaAddBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private string DetermineReturnUrl()
        {
            ...
            else if (GetPageName(returnUrl) == "PengujianSampleLainnyaView")
                returnUrl = ViewUrl;
            return returnUrl;
        }
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        pengujianSampleLainnyaAdd?.PageRender();
                    }
        }
            ...
            if (RowType == RowType.View) {
                ...
                if (idPlant.Lookup != null && IsDictionary(idPlant.Lookup?.Options) && idPlant.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    ...
                    if (curVal == "") {
                        ...
                        filterWrk = SearchFilter(idPlant.Lookup?.GetTable()?.Fields["IdPlant"].SearchExpression, "=", idPlant.CurrentValue, idPlant.Lookup?.GetTable()?.Fields["IdPlant"].SearchDataType, "");
                    }
                    string? sqlWrk = idPlant.Lookup?.GetSql(true, filterWrk, null, this, false, true);
                    List<Dictionary<string, object>>? rswrk = sqlWrk != null ? Connection.GetRows(sqlWrk) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
                    idPlant.EditValue = rswrk;
                }
                ...
                if (Produk.Lookup != null && IsDictionary(Produk.Lookup?.Options) && Produk.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    Produk.EditValue = Produk.Lookup?.Options.Values.ToList();
                } else { // Lookup from database
                    string filterWrk2 = "";
                    if (curVal2 == "") {
                        filterWrk2 = "0=1";
                    } else {
                        filterWrk2 = SearchFilter(Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchExpression, "=", Produk.CurrentValue, Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchDataType, "");
                    }
                    string? sqlWrk2 = Produk.Lookup?.GetSql(true, filterWrk2, null, this, false, true);
                    List<Dictionary<string, object>>? rswrk2 = sqlWrk2 != null ? Connection.GetRows(sqlWrk2) : null; // Must use Sync to avoid overwriting ViewValue in RenderViewRow
                    Produk.EditValue = rswrk2;
                }
