...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStartPenyaluranEditBase : SubAktivitasDataStartPenyaluran
    {
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStartPenyaluranList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStartPenyaluranList") {
                                ...
                                returnUrl = "SubAktivitasDataStartPenyaluranList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
