...
public partial class SnDOne {
    ...
    public class SubaktivitasHasilPemeriksaanEditBase : SubaktivitasHasilPemeriksaan
    {
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanEditBase()
        {
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasHasilPemeriksaanList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasHasilPemeriksaanList") {
                                ...
                                returnUrl = "SubaktivitasHasilPemeriksaanList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
