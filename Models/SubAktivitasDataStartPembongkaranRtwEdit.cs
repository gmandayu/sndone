...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStartPembongkaranRtwEditBase : SubAktivitasDataStartPembongkaranRtw
    {
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStartPembongkaranRtwList"); // No matching record, return to list
                        }
                    break;
