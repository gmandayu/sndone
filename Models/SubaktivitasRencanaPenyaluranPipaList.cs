...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasRencanaPenyaluranPipaList
    /// </summary>
    public static SubaktivitasRencanaPenyaluranPipaList subaktivitasRencanaPenyaluranPipaList
    {
        get => HttpData.Get<SubaktivitasRencanaPenyaluranPipaList>("subaktivitasRencanaPenyaluranPipaList")!;
        set => HttpData["subaktivitasRencanaPenyaluranPipaList"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasRencanaPenyaluranPipa
    /// </summary>
    public class SubaktivitasRencanaPenyaluranPipaList : SubaktivitasRencanaPenyaluranPipaListBase
    {
        // Constructor
        public SubaktivitasRencanaPenyaluranPipaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasRencanaPenyaluranPipaList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasRencanaPenyaluranPipaListBase : SubaktivitasRencanaPenyaluranPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasRencanaPenyaluranPipaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubaktivitasRencanaPenyaluranPipalist";
        ...
        // Constructor
        public SubaktivitasRencanaPenyaluranPipaListBase()
        {
            TableName = "SubaktivitasRencanaPenyaluranPipa";

            // CSS class name as context
            TableVar = "SubaktivitasRencanaPenyaluranPipa";
            ...
            // Table object (subaktivitasRencanaPenyaluranPipa)
            if (subaktivitasRencanaPenyaluranPipa == null || subaktivitasRencanaPenyaluranPipa is SubaktivitasRencanaPenyaluranPipa)
                subaktivitasRencanaPenyaluranPipa = this;

            // Initialize URLs
            AddUrl = "SubaktivitasRencanaPenyaluranPipaAdd";
            ...
            MultiDeleteUrl = "SubaktivitasRencanaPenyaluranPipaDelete";
            MultiUpdateUrl = "SubaktivitasRencanaPenyaluranPipaUpdate";
        ...
        // Page name
        public string PageName => "SubaktivitasRencanaPenyaluranPipaList";
        ...
        public void SetVisibility()
        {
            ...
            RencanaPenyaluran2.SetVisibility();
        ...
        // Constructor
        public SubaktivitasRencanaPenyaluranPipaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubaktivitasRencanaPenyaluranPipaView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubaktivitasRencanaPenyaluranPipagrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subaktivitasRencanaPenyaluranPipaList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(RencanaPenyaluran2.AdvancedSearch.ToJson())); // Field RencanaPenyaluran
        ...
        protected bool RestoreFilterList() {
            ...
            // Field RencanaPenyaluran
            if (filter?.TryGetValue("x_RencanaPenyaluran2", out sv) ?? false) {
                RencanaPenyaluran2.AdvancedSearch.SearchValue = sv;
                RencanaPenyaluran2.AdvancedSearch.SearchOperator = filter["z_RencanaPenyaluran2"];
                RencanaPenyaluran2.AdvancedSearch.SearchCondition = filter["v_RencanaPenyaluran2"];
                RencanaPenyaluran2.AdvancedSearch.SearchValue2 = filter["y_RencanaPenyaluran2"];
                RencanaPenyaluran2.AdvancedSearch.SearchOperator2 = filter["w_RencanaPenyaluran2"];
                RencanaPenyaluran2.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(RencanaPenyaluran2);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(RencanaPenyaluran2, ctrl); // RencanaPenyaluran
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubaktivitasRencanaPenyaluranPipa"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubaktivitasRencanaPenyaluranPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasRencanaPenyaluranPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("RencanaPenyaluran")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubaktivitasRencanaPenyaluranPipasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubaktivitasRencanaPenyaluranPipasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasRencanaPenyaluranPipalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubaktivitasRencanaPenyaluranPipa");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subaktivitasRencanaPenyaluranPipaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subaktivitasRencanaPenyaluranPipaList.RowCount) + "_SubaktivitasRencanaPenyaluranPipa");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subaktivitasRencanaPenyaluranPipaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subaktivitasRencanaPenyaluranPipaList.RowType == RowType.Add || IsEdit && subaktivitasRencanaPenyaluranPipaList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            RencanaPenyaluran2.SetDbValue(row["RencanaPenyaluran"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("RencanaPenyaluran", RencanaPenyaluran2.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // RencanaPenyaluran
                RencanaPenyaluran2.ViewValue = ConvertToString(RencanaPenyaluran2.CurrentValue); // DN
                RencanaPenyaluran2.ViewCustomAttributes = "";
                ...
                // RencanaPenyaluran
                RencanaPenyaluran2.HrefValue = "";
                RencanaPenyaluran2.TooltipValue = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubaktivitasRencanaPenyaluranPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubaktivitasRencanaPenyaluranPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubaktivitasRencanaPenyaluranPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
