...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputDataMobilTangkiEditBase : SubAktivitasFormInputDataMobilTangki
    {
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputDataMobilTangkiList"); // No matching record, return to list
                        }
                    break;
