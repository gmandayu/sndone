...
public partial class SnDOne {
    ...
    /// masterModaDelete
    /// </summary>
    public static MasterModaDelete masterModaDelete
    {
        get => HttpData.Get<MasterModaDelete>("masterModaDelete")!;
        set => HttpData["masterModaDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterModa
    /// </summary>
    public class MasterModaDelete : MasterModaDeleteBase
    {
        // Constructor
        public MasterModaDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterModaDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterModaDeleteBase : MasterModa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterModaDelete";
        ...
        // Page name
        public string PageName => "MasterModaDelete";
        ...
        // Constructor
        public MasterModaDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterModaList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterModaList"); // Return to list
                }
            }
