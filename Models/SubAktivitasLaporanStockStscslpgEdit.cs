...
public partial class SnDOne {
    ...
    public class SubAktivitasLaporanStockStscslpgEditBase : SubAktivitasLaporanStockStscslpg
    {
        ...
        // Constructor
        public SubAktivitasLaporanStockStscslpgEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasLaporanStockStscslpgEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasLaporanStockStscslpgList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubAktivitasLaporanStockStscslpgList") {
                        ...
                        returnUrl = "SubAktivitasLaporanStockStscslpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
