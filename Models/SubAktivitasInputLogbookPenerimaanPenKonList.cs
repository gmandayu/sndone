...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputLogbookPenerimaanPenKonList
    /// </summary>
    public static SubAktivitasInputLogbookPenerimaanPenKonList subAktivitasInputLogbookPenerimaanPenKonList
    {
        get => HttpData.Get<SubAktivitasInputLogbookPenerimaanPenKonList>("subAktivitasInputLogbookPenerimaanPenKonList")!;
        set => HttpData["subAktivitasInputLogbookPenerimaanPenKonList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasInputLogbookPenerimaanPenKon
    /// </summary>
    public class SubAktivitasInputLogbookPenerimaanPenKonList : SubAktivitasInputLogbookPenerimaanPenKonListBase
    {
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasInputLogbookPenerimaanPenKonListBase : SubAktivitasInputLogbookPenerimaanPenKon
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasInputLogbookPenerimaanPenKonList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasInputLogbookPenerimaanPenKonlist";
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonListBase()
        {
            ...
            // Initialize URLs
            AddUrl = "SubAktivitasInputLogbookPenerimaanPenKonAdd";
            ...
            MultiDeleteUrl = "SubAktivitasInputLogbookPenerimaanPenKonDelete";
            MultiUpdateUrl = "SubAktivitasInputLogbookPenerimaanPenKonUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasInputLogbookPenerimaanPenKonList";
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasInputLogbookPenerimaanPenKongrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasInputLogbookPenerimaanPenKonList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasInputLogbookPenerimaanPenKon"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasInputLogbookPenerimaanPenKonlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasInputLogbookPenerimaanPenKonlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasInputLogbookPenerimaanPenKonsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasInputLogbookPenerimaanPenKonsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasInputLogbookPenerimaanPenKonlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasInputLogbookPenerimaanPenKon");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasInputLogbookPenerimaanPenKonList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasInputLogbookPenerimaanPenKonList.RowCount) + "_SubAktivitasInputLogbookPenerimaanPenKon");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasInputLogbookPenerimaanPenKonList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasInputLogbookPenerimaanPenKonList.RowType == RowType.Add || IsEdit && subAktivitasInputLogbookPenerimaanPenKonList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasInputLogbookPenerimaanPenKonsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
