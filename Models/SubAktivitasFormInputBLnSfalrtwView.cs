...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputBLnSfalrtwView
    /// </summary>
    public static SubAktivitasFormInputBLnSfalrtwView subAktivitasFormInputBLnSfalrtwView
    {
        get => HttpData.Get<SubAktivitasFormInputBLnSfalrtwView>("subAktivitasFormInputBLnSfalrtwView")!;
        set => HttpData["subAktivitasFormInputBLnSfalrtwView"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputBLnSFALRTW
    /// </summary>
    public class SubAktivitasFormInputBLnSfalrtwView : SubAktivitasFormInputBLnSfalrtwViewBase
    {
        // Constructor
        public SubAktivitasFormInputBLnSfalrtwView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputBLnSfalrtwView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputBLnSfalrtwViewBase : SubAktivitasFormInputBLnSfalrtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputBLnSfalrtwView";
        ...
        // Constructor
        public SubAktivitasFormInputBLnSfalrtwViewBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputBLnSfalrtwView";
        ...
        // Constructor
        public SubAktivitasFormInputBLnSfalrtwViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputBLnSfalrtwList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputBLnSfalrtwList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputBLnSfalrtwView?.PageRender();
            }
            return PageResult();
        }
