...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit
    /// </summary>
    public static SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit subAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit
    {
        get => HttpData.Get<SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit>("subAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit")!;
        set => HttpData["subAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit : SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEditBase
    {
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEditBase : SubAktivitasNilaiNewBlsfadsfblstsPyrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEditBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit";
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList") {
                                ...
                                returnUrl = "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiNewBlsfadsfblstsPyrBbmEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList")), "", TableVar, true);
            string pageId = "edit";
