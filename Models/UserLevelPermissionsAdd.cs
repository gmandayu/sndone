...
public partial class SnDOne {
    ...
    public class UserLevelPermissionsAddBase : UserLevelPermissions
    {
        ...
        // Constructor
        public UserLevelPermissionsAddBase()
        {
        ...
        // Constructor
        public UserLevelPermissionsAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("UserLevelPermissionsList"); // No matching record, return to List page // DN
                    }
                    break;
