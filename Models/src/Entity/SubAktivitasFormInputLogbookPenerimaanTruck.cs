...
/**
 * Entity class for "SubAktivitasFormInputLogbookPenerimaanTruck" table
 */
[Table("SubAktivitasFormInputLogbookPenerimaanTruck")]
public class SubAktivitasFormInputLogbookPenerimaanTruck
{
    [Key("id")]
