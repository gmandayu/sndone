...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiBLdanAlrtwListBase : SubAktivitasNilaiBLdanAlrtw
    {
        ...
        // Constructor
        public SubAktivitasNilaiBLdanAlrtwListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasNilaiBLdanAlrtwListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field BL_KL_Obs
            if (filter.TryGetValue("x_BL_KL_Obs", out sv)) {
                RestoreFieldFilter(BL_KL_Obs, filter, "BL_KL_Obs", sv);
            }

            // Field BL_KL_15
            if (filter.TryGetValue("x_BL_KL_15", out sv)) {
                RestoreFieldFilter(BL_KL_15, filter, "BL_KL_15", sv);
            }
            ...
            // Field AL_KL_Obs
            if (filter.TryGetValue("x_AL_KL_Obs", out sv)) {
                RestoreFieldFilter(AL_KL_Obs, filter, "AL_KL_Obs", sv);
            }

            // Field AL_KL_15
            if (filter.TryGetValue("x_AL_KL_15", out sv)) {
                RestoreFieldFilter(AL_KL_15, filter, "AL_KL_15", sv);
            }
