...
public partial class SnDOne {
    ...
    public class PenyaluranDeleteBase : Penyaluran
    {
        ...
        // Constructor
        public PenyaluranDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("PenyaluranList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("PenyaluranList"); // Return to list
                }
            }
