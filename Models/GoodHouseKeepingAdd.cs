...
public partial class SnDOne {
    ...
    public class GoodHouseKeepingAddBase : GoodHouseKeeping
    {
        ...
        // Constructor
        public GoodHouseKeepingAddBase(Controller? controller)
        {
        ...
        // Constructor
        public GoodHouseKeepingAddBase() : this(null) { }
        ...
        private void ValidateCustomLookupPlant() {
            if (LookupPlant.Visible && LookupPlant.Required) {
                if (!LookupPlant.IsDetailKey && Empty(LookupPlant.FormValue)) {
                    LookupPlant.AddErrorMessage(ConvertToString(Catatan.RequiredErrorMessage).Replace("%s", Catatan.Caption));
                }
            }
        }
