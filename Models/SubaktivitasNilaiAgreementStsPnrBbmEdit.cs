...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiAgreementStsPnrBbmEdit
    /// </summary>
    public static SubaktivitasNilaiAgreementStsPnrBbmEdit subaktivitasNilaiAgreementStsPnrBbmEdit
    {
        get => HttpData.Get<SubaktivitasNilaiAgreementStsPnrBbmEdit>("subaktivitasNilaiAgreementStsPnrBbmEdit")!;
        set => HttpData["subaktivitasNilaiAgreementStsPnrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasNilaiAgreementSTSPnrBBM
    /// </summary>
    public class SubaktivitasNilaiAgreementStsPnrBbmEdit : SubaktivitasNilaiAgreementStsPnrBbmEditBase
    {
        // Constructor
        public SubaktivitasNilaiAgreementStsPnrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasNilaiAgreementStsPnrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasNilaiAgreementStsPnrBbmEditBase : SubaktivitasNilaiAgreementStsPnrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasNilaiAgreementStsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasNilaiAgreementStsPnrBbmEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasNilaiAgreementStsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasNilaiAgreementStsPnrBbmEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasNilaiAgreementStsPnrBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasNilaiAgreementStsPnrBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasNilaiAgreementStsPnrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasNilaiAgreementStsPnrBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasNilaiAgreementStsPnrBbmList")), "", TableVar, true);
            string pageId = "edit";
