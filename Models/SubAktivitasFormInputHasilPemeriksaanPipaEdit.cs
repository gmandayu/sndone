...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputHasilPemeriksaanPipaEdit
    /// </summary>
    public static SubAktivitasFormInputHasilPemeriksaanPipaEdit subAktivitasFormInputHasilPemeriksaanPipaEdit
    {
        get => HttpData.Get<SubAktivitasFormInputHasilPemeriksaanPipaEdit>("subAktivitasFormInputHasilPemeriksaanPipaEdit")!;
        set => HttpData["subAktivitasFormInputHasilPemeriksaanPipaEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputHasilPemeriksaanPipa
    /// </summary>
    public class SubAktivitasFormInputHasilPemeriksaanPipaEdit : SubAktivitasFormInputHasilPemeriksaanPipaEditBase
    {
        // Constructor
        public SubAktivitasFormInputHasilPemeriksaanPipaEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputHasilPemeriksaanPipaEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputHasilPemeriksaanPipaEditBase : SubAktivitasFormInputHasilPemeriksaanPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputHasilPemeriksaanPipaEdit";
        ...
        // Constructor
        public SubAktivitasFormInputHasilPemeriksaanPipaEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputHasilPemeriksaanPipaEdit";
        ...
        // Constructor
        public SubAktivitasFormInputHasilPemeriksaanPipaEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputHasilPemeriksaanPipaList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputHasilPemeriksaanPipaList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputHasilPemeriksaanPipaList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputHasilPemeriksaanPipaEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputHasilPemeriksaanPipaList")), "", TableVar, true);
            string pageId = "edit";
