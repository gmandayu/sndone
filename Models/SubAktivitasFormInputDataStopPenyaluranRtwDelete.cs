...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStopPenyaluranRtwDelete
    /// </summary>
    public static SubAktivitasFormInputDataStopPenyaluranRtwDelete subAktivitasFormInputDataStopPenyaluranRtwDelete
    {
        get => HttpData.Get<SubAktivitasFormInputDataStopPenyaluranRtwDelete>("subAktivitasFormInputDataStopPenyaluranRtwDelete")!;
        set => HttpData["subAktivitasFormInputDataStopPenyaluranRtwDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStopPenyaluranRTW
    /// </summary>
    public class SubAktivitasFormInputDataStopPenyaluranRtwDelete : SubAktivitasFormInputDataStopPenyaluranRtwDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputDataStopPenyaluranRtwDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStopPenyaluranRtwDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStopPenyaluranRtwDeleteBase : SubAktivitasFormInputDataStopPenyaluranRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStopPenyaluranRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPenyaluranRtwDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStopPenyaluranRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPenyaluranRtwDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputDataStopPenyaluranRtwList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputDataStopPenyaluranRtwList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputDataStopPenyaluranRtwDelete?.PageRender();
            }
            return PageResult();
        }
