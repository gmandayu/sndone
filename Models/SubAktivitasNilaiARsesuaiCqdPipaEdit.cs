...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiARsesuaiCqdPipaEditBase : SubAktivitasNilaiARsesuaiCqdPipa
    {
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaEditBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiARsesuaiCqdPipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiARsesuaiCqdPipaList") {
                                ...
                                returnUrl = "SubAktivitasNilaiARsesuaiCqdPipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
