...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiARsesuaiCqdlpgEditBase : SubAktivitasNilaiARsesuaiCqdlpg
    {
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdlpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdlpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiARsesuaiCqdlpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiARsesuaiCqdlpgList") {
                                ...
                                returnUrl = "SubAktivitasNilaiARsesuaiCqdlpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
