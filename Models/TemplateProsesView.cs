...
public partial class SnDOne {
    ...
    public class TemplateProsesViewBase : TemplateProses
    {
        ...
        // Constructor
        public TemplateProsesViewBase(Controller? controller)
        {
        ...
        // Constructor
        public TemplateProsesViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdTemplateProses", out v) && !Empty(v))
                {
                IdTemplateProses.QueryValue = UrlDecode(v);
                RecordKeys["IdTemplateProses"] = IdTemplateProses.QueryValue;
                return;
                }
                if (Get("IdTemplateProses", out sv))
                {
