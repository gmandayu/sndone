...
/**
 * Entity class for "SubaktivitasHasilPemeriksaanSTSPnrBBM" table
 */
[Table("SubaktivitasHasilPemeriksaanSTSPnrBBM")]
public class SubaktivitasHasilPemeriksaanStspnrBbm
{
    [Key("id")]
