...
public partial class SnDOne {
    ...
    /// masterPositionView
    /// </summary>
    public static MasterPositionView masterPositionView
    {
        get => HttpData.Get<MasterPositionView>("masterPositionView")!;
        set => HttpData["masterPositionView"] = value;
    }

    /// <summary>
    /// Page class for MasterPosition
    /// </summary>
    public class MasterPositionView : MasterPositionViewBase
    {
        // Constructor
        public MasterPositionView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterPositionView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterPositionViewBase : MasterPosition
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterPositionView";
        ...
        public MasterPositionViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdPosition"] = keys[0];
            } else {
                RecordKeys["IdPosition"] = RouteValues.TryGetValue("IdPosition", out obj) && obj != null ? UrlDecode(obj) : Get("IdPosition"); // DN
            }
        ...
        // Page name
        public string PageName => "MasterPositionView";
        ...
        // Constructor
        public MasterPositionViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdPosition", out v) && !Empty(v)) { // DN
                IdPosition.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdPosition"] = IdPosition.QueryValue;
            } else if (Get("IdPosition", out sv)) {
                IdPosition.QueryValue = sv.ToString();
                RecordKeys["IdPosition"] = IdPosition.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdPosition.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdPosition"] = IdPosition.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "MasterPositionList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterPositionList"); // Return to list page
                            }
                        }
                    break;
            }
