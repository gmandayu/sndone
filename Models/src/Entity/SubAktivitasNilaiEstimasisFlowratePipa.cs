...
/**
 * Entity class for "SubAktivitasNilaiEstimasisFlowratePipa" table
 */
[Table("SubAktivitasNilaiEstimasisFlowratePipa")]
public class SubAktivitasNilaiEstimasisFlowratePipa
{
    [Key("id")]
