...
public partial class SnDOne {
    /// <summary>
    /// aktivitasDokumenView
    /// </summary>
    public static AktivitasDokumenView aktivitasDokumenView
    {
        get => HttpData.Get<AktivitasDokumenView>("aktivitasDokumenView")!;
        set => HttpData["aktivitasDokumenView"] = value;
    }

    /// <summary>
    /// Page class for AktivitasDokumen
    /// </summary>
    public class AktivitasDokumenView : AktivitasDokumenViewBase
    {
        // Constructor
        public AktivitasDokumenView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AktivitasDokumenView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AktivitasDokumenViewBase : AktivitasDokumen
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "aktivitasDokumenView";
        ...
        // Constructor
        public AktivitasDokumenViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdAktivitasDokumen"] = keys[0];
            } else {
                RecordKeys["IdAktivitasDokumen"] = RouteValues.TryGetValue("IdAktivitasDokumen", out obj) && obj != null ? UrlDecode(obj) : Get("IdAktivitasDokumen"); // DN
            }
        ...
        // Page name
        public string PageName => "AktivitasDokumenView";
        ...
        // Constructor
        public AktivitasDokumenViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdAktivitasDokumen", out v) && !Empty(v)) { // DN
                IdAktivitasDokumen.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdAktivitasDokumen"] = IdAktivitasDokumen.QueryValue;
            } else if (Get("IdAktivitasDokumen", out sv)) {
                IdAktivitasDokumen.QueryValue = sv.ToString();
                RecordKeys["IdAktivitasDokumen"] = IdAktivitasDokumen.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdAktivitasDokumen.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdAktivitasDokumen"] = IdAktivitasDokumen.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "AktivitasDokumenList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("AktivitasDokumenList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                aktivitasDokumenView?.PageRender();
            }
            return PageResult();
        }
        ...
        public async Task ExportData(dynamic? doc, string[] keys)
        {
            ...
            StartRecord = 1;
            if (keys.Length >= 1) {
                IdAktivitasDokumen.OldValue = keys[0];
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("AktivitasDokumenList")), "", TableVar, true);
            string pageId = "view";
