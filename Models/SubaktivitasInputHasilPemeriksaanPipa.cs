...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasInputHasilPemeriksaanPipa
    /// </summary>
    [MaybeNull]
    public static SubaktivitasInputHasilPemeriksaanPipa subaktivitasInputHasilPemeriksaanPipa
    {
        get => HttpData.Resolve<SubaktivitasInputHasilPemeriksaanPipa>("SubaktivitasInputHasilPemeriksaanPipa");
        set => HttpData["SubaktivitasInputHasilPemeriksaanPipa"] = value;
    }

    /// <summary>
    /// Table class for SubaktivitasInputHasilPemeriksaanPipa
    /// </summary>
    public class SubaktivitasInputHasilPemeriksaanPipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> QuantityDischarge;
        ...
        // Constructor
        public SubaktivitasInputHasilPemeriksaanPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubaktivitasInputHasilPemeriksaanPipa";
            Name = "SubaktivitasInputHasilPemeriksaanPipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubaktivitasInputHasilPemeriksaanPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            TanggalJam = new(this, "x_TanggalJam", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "TanggalJam", "CustomMsg"),
                IsUpload = false
            };
            TanggalJam.Raw = true;
            ...
            NamaKegiatan = new(this, "x_NamaKegiatan", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "NamaKegiatan", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            Density = new(this, "x_Density", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "Density", "CustomMsg"),
                IsUpload = false
            };
            ...
            Temperature = new(this, "x_Temperature", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "Temperature", "CustomMsg"),
                IsUpload = false
            };
            ...
            Pressure = new(this, "x_Pressure", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "Pressure", "CustomMsg"),
                IsUpload = false
            };
            ...
            Keterangan = new(this, "x_Keterangan", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Keterangan", Keterangan);

            // QuantityDischarge
            QuantityDischarge = new(this, "x_QuantityDischarge", 202, SqlDbType.NVarChar) {
                Name = "QuantityDischarge",
                Expression = "[QuantityDischarge]",
                UseBasicSearch = true,
                BasicSearchExpression = "[QuantityDischarge]",
                DateTimeFormat = -1,
                VirtualExpression = "[QuantityDischarge]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "QuantityDischarge", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("QuantityDischarge", QuantityDischarge);
            ...
            Flowrate = new(this, "x_Flowrate", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "Flowrate", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubaktivitasInputHasilPemeriksaanPipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubaktivitasInputHasilPemeriksaanPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubaktivitasInputHasilPemeriksaanPipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                QuantityDischarge.DbValue = row["QuantityDischarge"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubaktivitasInputHasilPemeriksaanPipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubaktivitasInputHasilPemeriksaanPipaView" => Language.Phrase("View"),
                "SubaktivitasInputHasilPemeriksaanPipaEdit" => Language.Phrase("Edit"),
                "SubaktivitasInputHasilPemeriksaanPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubaktivitasInputHasilPemeriksaanPipaView",
                Config.ApiAddAction => "SubaktivitasInputHasilPemeriksaanPipaAdd",
                Config.ApiEditAction => "SubaktivitasInputHasilPemeriksaanPipaEdit",
                Config.ApiDeleteAction => "SubaktivitasInputHasilPemeriksaanPipaDelete",
                Config.ApiListAction => "SubaktivitasInputHasilPemeriksaanPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubaktivitasInputHasilPemeriksaanPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubaktivitasInputHasilPemeriksaanPipaView", parm);
            else
                url = KeyUrl("SubaktivitasInputHasilPemeriksaanPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubaktivitasInputHasilPemeriksaanPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubaktivitasInputHasilPemeriksaanPipaAdd?" + parm;
            else
                url = "SubaktivitasInputHasilPemeriksaanPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasInputHasilPemeriksaanPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasInputHasilPemeriksaanPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubaktivitasInputHasilPemeriksaanPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubaktivitasInputHasilPemeriksaanPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubaktivitasInputHasilPemeriksaanPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubaktivitasInputHasilPemeriksaanPipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            QuantityDischarge.EditValue = QuantityDischarge.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(QuantityDischarge);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(QuantityDischarge);
