...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStopPembongkaranRtwAddBase : SubAktivitasDataStopPembongkaranRtw
    {
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranRtwAddBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranRtwAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasDataStopPembongkaranRtwList"); // No matching record, return to List page // DN
                    }
                    break;
