...
public partial class SnDOne {
    ...
    /// masterDermagaView
    /// </summary>
    public static MasterDermagaView masterDermagaView
    {
        get => HttpData.Get<MasterDermagaView>("masterDermagaView")!;
        set => HttpData["masterDermagaView"] = value;
    }

    /// <summary>
    /// Page class for MasterDermaga
    /// </summary>
    public class MasterDermagaView : MasterDermagaViewBase
    {
        // Constructor
        public MasterDermagaView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterDermagaView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterDermagaViewBase : MasterDermaga
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterDermagaView";
        ...
        public MasterDermagaViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdDermaga"] = keys[0];
            } else {
                RecordKeys["IdDermaga"] = RouteValues.TryGetValue("IdDermaga", out obj) && obj != null ? UrlDecode(obj) : Get("IdDermaga"); // DN
            }
        ...
        // Page name
        public string PageName => "MasterDermagaView";
        ...
        // Constructor
        public MasterDermagaViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdDermaga", out v) && !Empty(v)) { // DN
                IdDermaga.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdDermaga"] = IdDermaga.QueryValue;
            } else if (Get("IdDermaga", out sv)) {
                IdDermaga.QueryValue = sv.ToString();
                RecordKeys["IdDermaga"] = IdDermaga.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdDermaga.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdDermaga"] = IdDermaga.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "MasterDermagaList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterDermagaList"); // Return to list page
                            }
                        }
                    break;
            }
