...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputMonitoringStockStsPymSlpgEdit
    /// </summary>
    public static SubAktivitasFormInputMonitoringStockStsPymSlpgEdit subAktivitasFormInputMonitoringStockStsPymSlpgEdit
    {
        get => HttpData.Get<SubAktivitasFormInputMonitoringStockStsPymSlpgEdit>("subAktivitasFormInputMonitoringStockStsPymSlpgEdit")!;
        set => HttpData["subAktivitasFormInputMonitoringStockStsPymSlpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputMonitoringStockSTSPymSLPG
    /// </summary>
    public class SubAktivitasFormInputMonitoringStockStsPymSlpgEdit : SubAktivitasFormInputMonitoringStockStsPymSlpgEditBase
    {
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSlpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSlpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputMonitoringStockStsPymSlpgEditBase : SubAktivitasFormInputMonitoringStockStsPymSlpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputMonitoringStockStsPymSlpgEdit";
        ...
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSlpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputMonitoringStockStsPymSlpgEdit";
        ...
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSlpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputMonitoringStockStsPymSlpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputMonitoringStockStsPymSlpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputMonitoringStockStsPymSlpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputMonitoringStockStsPymSlpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputMonitoringStockStsPymSlpgList")), "", TableVar, true);
            string pageId = "edit";
