...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStartPenyaluranStsPyrBbm
    /// </summary>
    [MaybeNull]
    public static SubAktivitasDataStartPenyaluranStsPyrBbm subAktivitasDataStartPenyaluranStsPyrBbm
    {
        get => HttpData.Resolve<SubAktivitasDataStartPenyaluranStsPyrBbm>("SubAktivitasDataStartPenyaluranSTSPyrBBM");
        set => HttpData["SubAktivitasDataStartPenyaluranSTSPyrBBM"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasDataStartPenyaluranSTSPyrBBM
    /// </summary>
    public class SubAktivitasDataStartPenyaluranStsPyrBbm : DbTable
    {
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranStsPyrBbm()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasDataStartPenyaluranSTSPyrBBM";
            Name = "SubAktivitasDataStartPenyaluranSTSPyrBBM";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasDataStartPenyaluranSTSPyrBBM"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPenyaluranSTSPyrBBM", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPenyaluranSTSPyrBBM", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPenyaluranSTSPyrBBM", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPenyaluranSTSPyrBBM", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPenyaluranSTSPyrBBM", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPenyaluranSTSPyrBBM", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPenyaluranSTSPyrBBM", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPenyaluranSTSPyrBBM", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPenyaluranSTSPyrBBM", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataStartPenyaluranSTSPyrBBM", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasDataStartPenyaluranSTSPyrBBM";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasDataStartPenyaluranStspyrBbm type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasDataStartPenyaluranStsPyrBbmList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasDataStartPenyaluranStsPyrBbmView" => Language.Phrase("View"),
                "SubAktivitasDataStartPenyaluranStsPyrBbmEdit" => Language.Phrase("Edit"),
                "SubAktivitasDataStartPenyaluranStsPyrBbmAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasDataStartPenyaluranStsPyrBbmView",
                Config.ApiAddAction => "SubAktivitasDataStartPenyaluranStsPyrBbmAdd",
                Config.ApiEditAction => "SubAktivitasDataStartPenyaluranStsPyrBbmEdit",
                Config.ApiDeleteAction => "SubAktivitasDataStartPenyaluranStsPyrBbmDelete",
                Config.ApiListAction => "SubAktivitasDataStartPenyaluranStsPyrBbmList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasDataStartPenyaluranStsPyrBbmList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasDataStartPenyaluranStsPyrBbmView", parm);
            else
                url = KeyUrl("SubAktivitasDataStartPenyaluranStsPyrBbmView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasDataStartPenyaluranStsPyrBbmAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasDataStartPenyaluranStsPyrBbmAdd?" + parm;
            else
                url = "SubAktivitasDataStartPenyaluranStsPyrBbmAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataStartPenyaluranStsPyrBbmEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataStartPenyaluranStsPyrBbmList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataStartPenyaluranStsPyrBbmAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataStartPenyaluranStsPyrBbmList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasDataStartPenyaluranStsPyrBbmDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasDataStartPenyaluranStsPyrBbmList";
