...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputKeberangkatanRtwDelete
    /// </summary>
    public static SubAktivitasFormInputKeberangkatanRtwDelete subAktivitasFormInputKeberangkatanRtwDelete
    {
        get => HttpData.Get<SubAktivitasFormInputKeberangkatanRtwDelete>("subAktivitasFormInputKeberangkatanRtwDelete")!;
        set => HttpData["subAktivitasFormInputKeberangkatanRtwDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputKeberangkatanRTW
    /// </summary>
    public class SubAktivitasFormInputKeberangkatanRtwDelete : SubAktivitasFormInputKeberangkatanRtwDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputKeberangkatanRtwDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputKeberangkatanRtwDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputKeberangkatanRtwDeleteBase : SubAktivitasFormInputKeberangkatanRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputKeberangkatanRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanRtwDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputKeberangkatanRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanRtwDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputKeberangkatanRtwList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputKeberangkatanRtwList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputKeberangkatanRtwDelete?.PageRender();
            }
            return PageResult();
        }
