...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputLogbookPenerimaanPenKonEdit
    /// </summary>
    public static SubAktivitasInputLogbookPenerimaanPenKonEdit subAktivitasInputLogbookPenerimaanPenKonEdit
    {
        get => HttpData.Get<SubAktivitasInputLogbookPenerimaanPenKonEdit>("subAktivitasInputLogbookPenerimaanPenKonEdit")!;
        set => HttpData["subAktivitasInputLogbookPenerimaanPenKonEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasInputLogbookPenerimaanPenKon
    /// </summary>
    public class SubAktivitasInputLogbookPenerimaanPenKonEdit : SubAktivitasInputLogbookPenerimaanPenKonEditBase
    {
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasInputLogbookPenerimaanPenKonEditBase : SubAktivitasInputLogbookPenerimaanPenKon
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasInputLogbookPenerimaanPenKonEdit";
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonEditBase(Controller? controller)
        {
            TableName = "SubAktivitasInputLogbookPenerimaanPenKon";
        ...
        if (controller != null)
            ...
            // Table object (subAktivitasInputLogbookPenerimaanPenKon)
            if (subAktivitasInputLogbookPenerimaanPenKon == null || subAktivitasInputLogbookPenerimaanPenKon is SubAktivitasInputLogbookPenerimaanPenKon)
                subAktivitasInputLogbookPenerimaanPenKon = this;
        ...
        // Page name
        public string PageName => "SubAktivitasInputLogbookPenerimaanPenKonEdit";
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPenKonEditBase() : this(null) { }
            ...
            string pageName = GetPageName(url);
                ...
                // List / View / Master View page
                    if (!SameString(pageName, ListUrl))
                    {
                        ...
                        result.Add("view", pageName == "SubAktivitasInputLogbookPenerimaanPenKonView" ? "1" : "0"); // If View page, no primary button
                    }
                    else
                    {
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasInputLogbookPenerimaanPenKonList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasInputLogbookPenerimaanPenKonList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasInputLogbookPenerimaanPenKonList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasInputLogbookPenerimaanPenKonEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasInputLogbookPenerimaanPenKonList")), "", TableVar, true);
            string pageId = "edit";
