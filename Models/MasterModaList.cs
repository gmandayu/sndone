...
public partial class SnDOne {
    ...
    public class MasterModaListBase : MasterModa
    {
        ...
        // Constructor
        public MasterModaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public void ShowFilterList()
        {
            ...
            // Field NamaModa
            filter = QueryBuilderWhere("NamaModa");
            if (Empty(filter))
                BuildSearchSql(ref filter, NamaModa, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + NamaModa.Caption + "</span>" + captionSuffix + filter + "</div>";
            if (!Empty(BasicSearch.Keyword))
        ...
        protected void LoadSearchValues() {
            ...
            // NamaModa
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_NamaModa[]"))
