...
public partial class SnDOne {
    ...
    /// masterPicView
    /// </summary>
    public static MasterPicView masterPicView
    {
        get => HttpData.Get<MasterPicView>("masterPicView")!;
        set => HttpData["masterPicView"] = value;
    }

    /// <summary>
    /// Page class for MasterPIC
    /// </summary>
    public class MasterPicView : MasterPicViewBase
    {
        // Constructor
        public MasterPicView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterPicView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterPicViewBase : MasterPic
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterPicView";
        ...
        public MasterPicViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdPIC"] = keys[0];
            } else {
                RecordKeys["IdPIC"] = RouteValues.TryGetValue("IdPIC", out obj) && obj != null ? UrlDecode(obj) : Get("IdPIC"); // DN
            }
        ...
        // Page name
        public string PageName => "MasterPicView";
        ...
        // Constructor
        public MasterPicViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdPIC", out v) && !Empty(v)) { // DN
                IdPIC.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdPIC"] = IdPIC.QueryValue;
            } else if (Get("IdPIC", out sv)) {
                IdPIC.QueryValue = sv.ToString();
                RecordKeys["IdPIC"] = IdPIC.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdPIC.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdPIC"] = IdPIC.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "MasterPicList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterPicList"); // Return to list page
                            }
                        }
                    break;
            }
