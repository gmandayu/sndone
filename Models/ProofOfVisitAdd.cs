...
public partial class SnDOne {
    ...
    /// proofOfVisitAdd
    /// </summary>
    public static ProofOfVisitAdd proofOfVisitAdd
    {
        get => HttpData.Get<ProofOfVisitAdd>("proofOfVisitAdd")!;
        set => HttpData["proofOfVisitAdd"] = value;
    }

    /// <summary>
    /// Page class for ProofOfVisit
    /// </summary>
    public class ProofOfVisitAdd : ProofOfVisitAddBase
    {
        // Constructor
        public ProofOfVisitAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ProofOfVisitAdd() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class ProofOfVisitAddBase : ProofOfVisit
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "proofOfVisitAdd";
        ...
        // Page name
        public string PageName => "ProofOfVisitAdd";
        ...
        // Constructor
        public ProofOfVisitAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("ProofOfVisitList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "ProofOfVisitView")
        ...
        protected void LoadDefaultValues() {
            ...
            DiperbaruiOleh.DefaultValue = DiperbaruiOleh.GetDefault(); // DN
            DiperbaruiOleh.OldValue = DiperbaruiOleh.DefaultValue;
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                if (!NomorProofOfVisit.Raw)
                    NomorProofOfVisit.CurrentValue = HtmlDecode(NomorProofOfVisit.CurrentValue);
                NomorProofOfVisit.EditValue = HtmlEncode(NomorProofOfVisit.CurrentValue);
                NomorProofOfVisit.PlaceHolder = RemoveHtml(NomorProofOfVisit.Caption);
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            if (insertRow) {
                try {
                    ...
                    rsnew["IdProofOfVisit"] = IdProofOfVisit.CurrentValue!;
                } catch (Exception e) {
                    if (Config.Debug)
                        throw;
        ...
        protected Dictionary<string, object> GetAddRow()
        {
            try {
                ...
                // NomorProofOfVisit
                NomorProofOfVisit.SetDbValue(rsnew, NomorProofOfVisit.CurrentValue);
        ...
        {
            object? value;
            if (row.TryGetValue("NomorProofOfVisit", out value)) // NomorProofOfVisit
                NomorProofOfVisit.SetFormValue(ConvertToString(value));
