...
public partial class SnDOne {
    ...
    public class SubAktivitasHasilPemeriksaanPenyaluranEditBase : SubAktivitasHasilPemeriksaanPenyaluran
    {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranEditBase()
        {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasHasilPemeriksaanPenyaluranList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasHasilPemeriksaanPenyaluranList") {
                                ...
                                returnUrl = "SubAktivitasHasilPemeriksaanPenyaluranList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
