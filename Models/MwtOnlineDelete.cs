...
public partial class SnDOne {
    ...
    /// mwtOnlineDelete
    /// </summary>
    public static MwtOnlineDelete mwtOnlineDelete
    {
        get => HttpData.Get<MwtOnlineDelete>("mwtOnlineDelete")!;
        set => HttpData["mwtOnlineDelete"] = value;
    }

    /// <summary>
    /// Page class for MWTOnline
    /// </summary>
    public class MwtOnlineDelete : MwtOnlineDeleteBase
    {
        // Constructor
        public MwtOnlineDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MwtOnlineDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class MwtOnlineDeleteBase : MwtOnline
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mwtOnlineDelete";
        ...
        // Page name
        public string PageName => "MwtOnlineDelete";
        ...
        // Constructor
        public MwtOnlineDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MwtOnlineList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MwtOnlineList"); // Return to list
                }
            }
