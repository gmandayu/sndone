...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbMonitoringStockRtwListBase : SubAktivitasFormInputLogbMonitoringStockRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwListBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected bool RestoreFilterList() {
            ...
            // Field NoTangki
            if (filter?.TryGetValue("x_NoTangki", out sv) ?? false) {
                NoTangki.AdvancedSearch.SearchValue = sv;
                NoTangki.AdvancedSearch.SearchOperator = filter["z_NoTangki"];
                NoTangki.AdvancedSearch.SearchCondition = filter["v_NoTangki"];
                NoTangki.AdvancedSearch.SearchValue2 = filter["y_NoTangki"];
                NoTangki.AdvancedSearch.SearchOperator2 = filter["w_NoTangki"];
                NoTangki.AdvancedSearch.Save();
            }
            ...
            // Field LevelTangki
            if (filter?.TryGetValue("x_LevelTangki", out sv) ?? false) {
                LevelTangki.AdvancedSearch.SearchValue = sv;
                LevelTangki.AdvancedSearch.SearchOperator = filter["z_LevelTangki"];
                LevelTangki.AdvancedSearch.SearchCondition = filter["v_LevelTangki"];
                LevelTangki.AdvancedSearch.SearchValue2 = filter["y_LevelTangki"];
                LevelTangki.AdvancedSearch.SearchOperator2 = filter["w_LevelTangki"];
                LevelTangki.AdvancedSearch.Save();
            }
