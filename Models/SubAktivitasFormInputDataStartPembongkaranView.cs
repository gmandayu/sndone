...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputDataStartPembongkaranViewBase : SubAktivitasFormInputDataStartPembongkaran
    {
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranViewBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPembongkaranViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputDataStartPembongkaranList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputDataStartPembongkaranList"); // Return to list page
                            }
                        }
                    break;
            }
