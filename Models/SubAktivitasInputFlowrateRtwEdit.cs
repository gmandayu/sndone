...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputFlowrateRtwEdit
    /// </summary>
    public static SubAktivitasInputFlowrateRtwEdit subAktivitasInputFlowrateRtwEdit
    {
        get => HttpData.Get<SubAktivitasInputFlowrateRtwEdit>("subAktivitasInputFlowrateRtwEdit")!;
        set => HttpData["subAktivitasInputFlowrateRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasInputFlowrateRTW
    /// </summary>
    public class SubAktivitasInputFlowrateRtwEdit : SubAktivitasInputFlowrateRtwEditBase
    {
        // Constructor
        public SubAktivitasInputFlowrateRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasInputFlowrateRtwEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasInputFlowrateRtwEditBase : SubAktivitasInputFlowrateRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasInputFlowrateRtwEdit";
        ...
        // Constructor
        public SubAktivitasInputFlowrateRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasInputFlowrateRtwEdit";
        ...
        // Constructor
        public SubAktivitasInputFlowrateRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasInputFlowrateRtwList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasInputFlowrateRtwList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasInputFlowrateRtwList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasInputFlowrateRtwEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasInputFlowrateRtwList")), "", TableVar, true);
            string pageId = "edit";
