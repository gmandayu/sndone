...
public partial class SnDOne {
    ...
    public class SubAktivitasKeberangkatanRtwEditBase : SubAktivitasKeberangkatanRtw
    {
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasKeberangkatanRtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasKeberangkatanRtwList"); // No matching record, return to list
                        }
                    break;
