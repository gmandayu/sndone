...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasKapalBerangkatStsPnrBbmEdit
    /// </summary>
    public static SubaktivitasKapalBerangkatStsPnrBbmEdit subaktivitasKapalBerangkatStsPnrBbmEdit
    {
        get => HttpData.Get<SubaktivitasKapalBerangkatStsPnrBbmEdit>("subaktivitasKapalBerangkatStsPnrBbmEdit")!;
        set => HttpData["subaktivitasKapalBerangkatStsPnrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasKapalBerangkatSTSPnrBBM
    /// </summary>
    public class SubaktivitasKapalBerangkatStsPnrBbmEdit : SubaktivitasKapalBerangkatStsPnrBbmEditBase
    {
        // Constructor
        public SubaktivitasKapalBerangkatStsPnrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasKapalBerangkatStsPnrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasKapalBerangkatStsPnrBbmEditBase : SubaktivitasKapalBerangkatStsPnrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasKapalBerangkatStsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasKapalBerangkatStsPnrBbmEditBase()
        {
        ...
        // Page name
        public string PageName => "SubaktivitasKapalBerangkatStsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasKapalBerangkatStsPnrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasKapalBerangkatStsPnrBbmList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "SubaktivitasKapalBerangkatStsPnrBbmList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasKapalBerangkatStsPnrBbmList") {
                                ...
                                returnUrl = "SubaktivitasKapalBerangkatStsPnrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subaktivitasKapalBerangkatStsPnrBbmEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'tglBerangkat' before field var 'x_tglBerangkat'
            val = CurrentForm.HasValue("tglBerangkat") ? CurrentForm.GetValue("tglBerangkat") : CurrentForm.GetValue("x_tglBerangkat");
            if (!tglBerangkat.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("tglBerangkat") && !CurrentForm.HasValue("x_tglBerangkat")) // DN
                    tglBerangkat.Visible = false; // Disable update for API request
                else
                    tglBerangkat.SetFormValue(val, true, validate);
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasKapalBerangkatStsPnrBbmList")), "", TableVar, true);
            string pageId = "edit";
