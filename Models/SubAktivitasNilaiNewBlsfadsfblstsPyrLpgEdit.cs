...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEditBase : SubAktivitasNilaiNewBlsfadsfblstsPyrLpg
    {
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList") {
                        ...
                        returnUrl = "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
