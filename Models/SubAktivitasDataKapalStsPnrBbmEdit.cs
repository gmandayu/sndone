...
public partial class SnDOne {
    ...
    public class SubAktivitasDataKapalStsPnrBbmEditBase : SubAktivitasDataKapalStsPnrBbm
    {
        ...
        // Constructor
        public SubAktivitasDataKapalStsPnrBbmEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataKapalStsPnrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataKapalStsPnrBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataKapalStsPnrBbmList") {
                                ...
                                returnUrl = "SubAktivitasDataKapalStsPnrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'tgltiba' before field var 'x_tgltiba'
            val = CurrentForm.HasValue("tgltiba") ? CurrentForm.GetValue("tgltiba") : CurrentForm.GetValue("x_tgltiba");
            if (!tgltiba.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("tgltiba") && !CurrentForm.HasValue("x_tgltiba")) // DN
                    tgltiba.Visible = false; // Disable update for API request
                else
                    tgltiba.SetFormValue(val, true, validate);
