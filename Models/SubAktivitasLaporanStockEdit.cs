...
public partial class SnDOne {
    ...
    public class SubAktivitasLaporanStockEditBase : SubAktivitasLaporanStock
    {
        ...
        // Constructor
        public SubAktivitasLaporanStockEditBase()
        {
        ...
        // Constructor
        public SubAktivitasLaporanStockEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasLaporanStockList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasLaporanStockList") {
                                ...
                                returnUrl = "SubAktivitasLaporanStockList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
