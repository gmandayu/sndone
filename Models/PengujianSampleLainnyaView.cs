...
public partial class SnDOne {
    /// <summary>
    /// pengujianSampleLainnyaView
    /// </summary>
    public static PengujianSampleLainnyaView pengujianSampleLainnyaView
    {
        get => HttpData.Get<PengujianSampleLainnyaView>("pengujianSampleLainnyaView")!;
        set => HttpData["pengujianSampleLainnyaView"] = value;
    }

    /// <summary>
    /// Page class for PengujianSampleLainnya
    /// </summary>
    public class PengujianSampleLainnyaView : PengujianSampleLainnyaViewBase
    {
        // Constructor
        public PengujianSampleLainnyaView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PengujianSampleLainnyaView() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PengujianSampleLainnyaViewBase : PengujianSampleLainnya
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "pengujianSampleLainnyaView";
        ...
        // Constructor
        public PengujianSampleLainnyaViewBase()
        {
        ...
        // Page name
        public string PageName => "PengujianSampleLainnyaView";
        ...
        // Constructor
        public PengujianSampleLainnyaViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "PengujianSampleLainnyaList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("PengujianSampleLainnyaList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                pengujianSampleLainnyaView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fPengujianSampleLainnyaview\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fPengujianSampleLainnyaview\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fPengujianSampleLainnyaview\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
