...
public partial class SnDOne {
    ...
    public class FormInputGoodHouseKeepingListBase : FormInputGoodHouseKeeping
    {
        ...
        // Constructor
        public FormInputGoodHouseKeepingListBase(Controller? controller)
        {
        ...
        // Constructor
        public FormInputGoodHouseKeepingListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field tgltiba
            if (filter.TryGetValue("x_tgltiba", out sv)) {
                RestoreFieldFilter(tgltiba, filter, "tgltiba", sv);
            }
        ...
        private string BuildFieldFilters(FilterConfiguration config)
        {
            ...
            filterList += ProcessFieldFilter("tgltiba", tgltiba, true, config);
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void LoadFieldtgltibaSearchValues()
        {
            // tgltiba
            LoadPrimarySearchValuetgltiba();
            LoadSearchOperatortgltiba();
        }
        private void LoadPrimarySearchValuetgltiba()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_tgltiba[]")) {
        ...
        private void LoadSearchOperatortgltiba()
        {
