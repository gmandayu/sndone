...
public partial class SnDOne {
    ...
    public class FormInputGoodHouseKeepingViewBase : FormInputGoodHouseKeeping
    {
        ...
        // Constructor
        public FormInputGoodHouseKeepingViewBase()
        {
        ...
        // Constructor
        public FormInputGoodHouseKeepingViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "FormInputGoodHouseKeepingList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("FormInputGoodHouseKeepingList"); // Return to list page
                            }
                        }
                    break;
            }
