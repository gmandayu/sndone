...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiARsesuaiCqdEdit
    /// </summary>
    public static SubAktivitasNilaiARsesuaiCqdEdit subAktivitasNilaiARsesuaiCqdEdit
    {
        get => HttpData.Get<SubAktivitasNilaiARsesuaiCqdEdit>("subAktivitasNilaiARsesuaiCqdEdit")!;
        set => HttpData["subAktivitasNilaiARsesuaiCqdEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiARsesuaiCQD
    /// </summary>
    public class SubAktivitasNilaiARsesuaiCqdEdit : SubAktivitasNilaiARsesuaiCqdEditBase
    {
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiARsesuaiCqdEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiARsesuaiCqdEditBase : SubAktivitasNilaiARsesuaiCqd
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiARsesuaiCqdEdit";
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiARsesuaiCqdEdit";
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiARsesuaiCqdList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiARsesuaiCqdList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiARsesuaiCqdList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiARsesuaiCqdEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void ValidateCustomKL_Obs() {
            if (KL_Obs.Visible && KL_Obs.Required) {
                if (!KL_Obs.IsDetailKey && Empty(KL_Obs.FormValue)) {
                    KL_Obs.AddErrorMessage(ConvertToString(MT.RequiredErrorMessage).Replace("%s", MT.Caption));
                }
            }
        }
        ...
        private void ValidateCustomKL_15() {
            if (KL_15.Visible && KL_15.Required) {
                if (!KL_15.IsDetailKey && Empty(KL_15.FormValue)) {
                    KL_15.AddErrorMessage(ConvertToString(MT.RequiredErrorMessage).Replace("%s", MT.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiARsesuaiCqdList")), "", TableVar, true);
            string pageId = "edit";
