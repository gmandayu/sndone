...
public partial class SnDOne {
    /// <summary>
    /// samplingLabTestSearch
    /// </summary>
    public static SamplingLabTestSearch samplingLabTestSearch
    {
        get => HttpData.Get<SamplingLabTestSearch>("samplingLabTestSearch")!;
        set => HttpData["samplingLabTestSearch"] = value;
    }

    /// <summary>
    /// Page class for SamplingLabTest
    /// </summary>
    public class SamplingLabTestSearch : SamplingLabTestSearchBase
    {
        // Constructor
        public SamplingLabTestSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SamplingLabTestSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SamplingLabTestSearchBase : SamplingLabTest
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "samplingLabTestSearch";
        ...
        // Constructor
        public SamplingLabTestSearchBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SamplingLabTestSearch";
        ...
        // Constructor
        public SamplingLabTestSearchBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "SamplingLabTestList?" + srchStr;
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        samplingLabTestSearch?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        {
            if (!IsAddOrEdit && Form.ContainsKey("x_NomorSamplingLabTest")) {
                NomorSamplingLabTest.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_NomorSamplingLabTest", Config.FilterOptionSeparator);
            }
        }

        private void LoadSearchOperatorNomorSamplingLabTest()
        {
            if (Form.ContainsKey("z_NomorSamplingLabTest"))
                NomorSamplingLabTest.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_NomorSamplingLabTest", Config.FilterOptionSeparator);
        }
        ...
        {
            if (!IsAddOrEdit && Form.ContainsKey("x_IdReferensi")) {
                IdReferensi.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_IdReferensi", Config.FilterOptionSeparator);
            }
        }

        private void LoadSearchOperatorIdReferensi()
        {
            if (Form.ContainsKey("z_IdReferensi"))
                IdReferensi.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_IdReferensi", Config.FilterOptionSeparator);
        }

        private void LoadSecondarySearchValuesIdReferensi()
        {
            if (Form.ContainsKey("v_IdReferensi"))
                IdReferensi.AdvancedSearch.SearchCondition = CurrentForm.GetValue("v_IdReferensi", Config.FilterOptionSeparator);
            if (Form.ContainsKey("y_IdReferensi"))
                IdReferensi.AdvancedSearch.SearchValue2 = CurrentForm.GetValue("y_IdReferensi", Config.FilterOptionSeparator);
            if (Form.ContainsKey("w_IdReferensi"))
                IdReferensi.AdvancedSearch.SearchOperator2 = CurrentForm.GetValue("w_IdReferensi", Config.FilterOptionSeparator);
        }
