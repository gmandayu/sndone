...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasHasilPemeriksaanLpgEdit
    /// </summary>
    public static SubaktivitasHasilPemeriksaanLpgEdit subaktivitasHasilPemeriksaanLpgEdit
    {
        get => HttpData.Get<SubaktivitasHasilPemeriksaanLpgEdit>("subaktivitasHasilPemeriksaanLpgEdit")!;
        set => HttpData["subaktivitasHasilPemeriksaanLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasHasilPemeriksaanLPG
    /// </summary>
    public class SubaktivitasHasilPemeriksaanLpgEdit : SubaktivitasHasilPemeriksaanLpgEditBase
    {
        // Constructor
        public SubaktivitasHasilPemeriksaanLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasHasilPemeriksaanLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasHasilPemeriksaanLpgEditBase : SubaktivitasHasilPemeriksaanLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasHasilPemeriksaanLpgEdit";
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasHasilPemeriksaanLpgEdit";
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasHasilPemeriksaanLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasHasilPemeriksaanLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasHasilPemeriksaanLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasHasilPemeriksaanLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasHasilPemeriksaanLpgList")), "", TableVar, true);
            string pageId = "edit";
