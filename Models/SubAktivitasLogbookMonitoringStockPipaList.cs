...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLogbookMonitoringStockPipaList
    /// </summary>
    public static SubAktivitasLogbookMonitoringStockPipaList subAktivitasLogbookMonitoringStockPipaList
    {
        get => HttpData.Get<SubAktivitasLogbookMonitoringStockPipaList>("subAktivitasLogbookMonitoringStockPipaList")!;
        set => HttpData["subAktivitasLogbookMonitoringStockPipaList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasLogbookMonitoringStockPipa
    /// </summary>
    public class SubAktivitasLogbookMonitoringStockPipaList : SubAktivitasLogbookMonitoringStockPipaListBase
    {
        // Constructor
        public SubAktivitasLogbookMonitoringStockPipaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasLogbookMonitoringStockPipaList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasLogbookMonitoringStockPipaListBase : SubAktivitasLogbookMonitoringStockPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasLogbookMonitoringStockPipaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasLogbookMonitoringStockPipalist";
        ...
        // Constructor
        public SubAktivitasLogbookMonitoringStockPipaListBase()
        {
            TableName = "SubAktivitasLogbookMonitoringStockPipa";

            // CSS class name as context
            TableVar = "SubAktivitasLogbookMonitoringStockPipa";
            ...
            // Table object (subAktivitasLogbookMonitoringStockPipa)
            if (subAktivitasLogbookMonitoringStockPipa == null || subAktivitasLogbookMonitoringStockPipa is SubAktivitasLogbookMonitoringStockPipa)
                subAktivitasLogbookMonitoringStockPipa = this;

            // Initialize URLs
            AddUrl = "SubAktivitasLogbookMonitoringStockPipaAdd";
            ...
            MultiDeleteUrl = "SubAktivitasLogbookMonitoringStockPipaDelete";
            MultiUpdateUrl = "SubAktivitasLogbookMonitoringStockPipaUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasLogbookMonitoringStockPipaList";
        ...
        public void SetVisibility()
        {
            ...
            Nomor_Tangki.SetVisibility();
            Produk.SetVisibility();
            Aktivitas2.SetVisibility();
            Level_Tangki.SetVisibility();
            Volume_KL.SetVisibility();
        ...
        // Constructor
        public SubAktivitasLogbookMonitoringStockPipaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasLogbookMonitoringStockPipaView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasLogbookMonitoringStockPipagrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasLogbookMonitoringStockPipaList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(Nomor_Tangki.AdvancedSearch.ToJson())); // Field Nomor_Tangki
            ...
            filters.Merge(JObject.Parse(Level_Tangki.AdvancedSearch.ToJson())); // Field Level_Tangki
            filters.Merge(JObject.Parse(Volume_KL.AdvancedSearch.ToJson())); // Field Volume_KL
        ...
        protected bool RestoreFilterList() {
            ...
            // Field Nomor_Tangki
            if (filter?.TryGetValue("x_Nomor_Tangki", out sv) ?? false) {
                Nomor_Tangki.AdvancedSearch.SearchValue = sv;
                Nomor_Tangki.AdvancedSearch.SearchOperator = filter["z_Nomor_Tangki"];
                Nomor_Tangki.AdvancedSearch.SearchCondition = filter["v_Nomor_Tangki"];
                Nomor_Tangki.AdvancedSearch.SearchValue2 = filter["y_Nomor_Tangki"];
                Nomor_Tangki.AdvancedSearch.SearchOperator2 = filter["w_Nomor_Tangki"];
                Nomor_Tangki.AdvancedSearch.Save();
            }
            ...
            // Field Level_Tangki
            if (filter?.TryGetValue("x_Level_Tangki", out sv) ?? false) {
                Level_Tangki.AdvancedSearch.SearchValue = sv;
                Level_Tangki.AdvancedSearch.SearchOperator = filter["z_Level_Tangki"];
                Level_Tangki.AdvancedSearch.SearchCondition = filter["v_Level_Tangki"];
                Level_Tangki.AdvancedSearch.SearchValue2 = filter["y_Level_Tangki"];
                Level_Tangki.AdvancedSearch.SearchOperator2 = filter["w_Level_Tangki"];
                Level_Tangki.AdvancedSearch.Save();
            }

            // Field Volume_KL
            if (filter?.TryGetValue("x_Volume_KL", out sv) ?? false) {
                Volume_KL.AdvancedSearch.SearchValue = sv;
                Volume_KL.AdvancedSearch.SearchOperator = filter["z_Volume_KL"];
                Volume_KL.AdvancedSearch.SearchCondition = filter["v_Volume_KL"];
                Volume_KL.AdvancedSearch.SearchValue2 = filter["y_Volume_KL"];
                Volume_KL.AdvancedSearch.SearchOperator2 = filter["w_Volume_KL"];
                Volume_KL.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(Nomor_Tangki);
            searchFlds.Add(Produk);
            searchFlds.Add(Aktivitas2);
            searchFlds.Add(Level_Tangki);
            searchFlds.Add(Volume_KL);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(Nomor_Tangki, ctrl); // Nomor_Tangki
                UpdateSort(Produk, ctrl); // Produk
                UpdateSort(Aktivitas2, ctrl); // Aktivitas
                UpdateSort(Level_Tangki, ctrl); // Level_Tangki
                UpdateSort(Volume_KL, ctrl); // Volume_KL
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasLogbookMonitoringStockPipa"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasLogbookMonitoringStockPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasLogbookMonitoringStockPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("Nomor_Tangki")); // DN
                CreateColumnOption(option.Add("Produk")); // DN
                CreateColumnOption(option.Add("Aktivitas")); // DN
                CreateColumnOption(option.Add("Level_Tangki")); // DN
                CreateColumnOption(option.Add("Volume_KL")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasLogbookMonitoringStockPipasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasLogbookMonitoringStockPipasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasLogbookMonitoringStockPipalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasLogbookMonitoringStockPipa");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasLogbookMonitoringStockPipaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasLogbookMonitoringStockPipaList.RowCount) + "_SubAktivitasLogbookMonitoringStockPipa");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasLogbookMonitoringStockPipaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasLogbookMonitoringStockPipaList.RowType == RowType.Add || IsEdit && subAktivitasLogbookMonitoringStockPipaList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            Nomor_Tangki.SetDbValue(row["Nomor_Tangki"]);
            Produk.SetDbValue(row["Produk"]);
            Aktivitas2.SetDbValue(row["Aktivitas"]);
            Level_Tangki.SetDbValue(row["Level_Tangki"]);
            Volume_KL.SetDbValue(row["Volume_KL"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("Nomor_Tangki", Nomor_Tangki.DefaultValue ?? DbNullValue); // DN
            row.Add("Produk", Produk.DefaultValue ?? DbNullValue); // DN
            row.Add("Aktivitas", Aktivitas2.DefaultValue ?? DbNullValue); // DN
            row.Add("Level_Tangki", Level_Tangki.DefaultValue ?? DbNullValue); // DN
            row.Add("Volume_KL", Volume_KL.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // Nomor_Tangki
                Nomor_Tangki.ViewValue = ConvertToString(Nomor_Tangki.CurrentValue); // DN
                Nomor_Tangki.ViewCustomAttributes = "";
                ...
                // Level_Tangki
                Level_Tangki.ViewValue = ConvertToString(Level_Tangki.CurrentValue); // DN
                Level_Tangki.ViewCustomAttributes = "";

                // Volume_KL
                Volume_KL.ViewValue = ConvertToString(Volume_KL.CurrentValue); // DN
                Volume_KL.ViewCustomAttributes = "";
                ...
                IdPlant.ViewValue = FormatNumber(IdPlant.ViewValue, IdPlant.FormatPattern);
                ...
                // Nomor_Tangki
                Nomor_Tangki.HrefValue = "";
                Nomor_Tangki.TooltipValue = "";
                ...
                // Level_Tangki
                Level_Tangki.HrefValue = "";
                Level_Tangki.TooltipValue = "";

                // Volume_KL
                Volume_KL.HrefValue = "";
                Volume_KL.TooltipValue = "";
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasLogbookMonitoringStockPipasrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
