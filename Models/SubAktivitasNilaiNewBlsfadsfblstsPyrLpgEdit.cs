...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit
    /// </summary>
    public static SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit subAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit>("subAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit")!;
        set => HttpData["subAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiNewBLSFADSFBLSTSPyrLPG
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit : SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEditBase : SubAktivitasNilaiNewBlsfadsfblstsPyrLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEditBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList") {
                                ...
                                returnUrl = "SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiNewBlsfadsfblstsPyrLpgEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                string curVal5 = ConvertToString(NoPenerimaan.CurrentValue);
                if (NoPenerimaan.Lookup != null && IsDictionary(NoPenerimaan.Lookup?.Options) && NoPenerimaan.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    ...
                    if (curVal5 == "") {
                        ...
                        filterWrk5 = SearchFilter(NoPenerimaan.Lookup?.GetTable()?.Fields["NomorPenerimaan"].SearchExpression, "=", NoPenerimaan.CurrentValue, NoPenerimaan.Lookup?.GetTable()?.Fields["NomorPenerimaan"].SearchDataType, "");
                    }
                    var lookupFilter5 = () => NoPenerimaan.GetSelectFilter();
                    string? sqlWrk5 = NoPenerimaan.Lookup?.GetSql(true, filterWrk5, lookupFilter5, this, false, true);
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ...
                if (LastUpdatedBy.Visible && LastUpdatedBy.Required) {
                    if (Empty(LastUpdatedBy.FormValue)) {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiNewBlsfadsfblstsPyrLpgList")), "", TableVar, true);
            string pageId = "edit";
