...
/**
 * Entity class for "SubAktivitasFormInputLogbookPenerimaanPipa" table
 */
[Table("SubAktivitasFormInputLogbookPenerimaanPipa")]
public class SubAktivitasFormInputLogbookPenerimaanPipa
{
    [Key("id")]
