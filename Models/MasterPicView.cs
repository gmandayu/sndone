...
public partial class SnDOne {
    ...
    public class MasterPicViewBase : MasterPic
    {
        ...
        // Constructor
        public MasterPicViewBase(Controller? controller)
        {
            TableName = "MasterPIC";
        ...
        // Constructor
        public MasterPicViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdPIC", out v) && !Empty(v))
                {
                IdPIC.QueryValue = UrlDecode(v);
