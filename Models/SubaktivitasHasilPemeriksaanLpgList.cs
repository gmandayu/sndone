...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasHasilPemeriksaanLpgList
    /// </summary>
    public static SubaktivitasHasilPemeriksaanLpgList subaktivitasHasilPemeriksaanLpgList
    {
        get => HttpData.Get<SubaktivitasHasilPemeriksaanLpgList>("subaktivitasHasilPemeriksaanLpgList")!;
        set => HttpData["subaktivitasHasilPemeriksaanLpgList"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasHasilPemeriksaanLPG
    /// </summary>
    public class SubaktivitasHasilPemeriksaanLpgList : SubaktivitasHasilPemeriksaanLpgListBase
    {
        // Constructor
        public SubaktivitasHasilPemeriksaanLpgList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasHasilPemeriksaanLpgList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasHasilPemeriksaanLpgListBase : SubaktivitasHasilPemeriksaanLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasHasilPemeriksaanLpgList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubaktivitasHasilPemeriksaanLPGlist";
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanLpgListBase()
        {
            TableName = "SubaktivitasHasilPemeriksaanLPG";

            // CSS class name as context
            TableVar = "SubaktivitasHasilPemeriksaanLPG";
            ...
            // Table object (subaktivitasHasilPemeriksaanLpg)
            if (subaktivitasHasilPemeriksaanLpg == null || subaktivitasHasilPemeriksaanLpg is SubaktivitasHasilPemeriksaanLpg)
                subaktivitasHasilPemeriksaanLpg = this;

            // Initialize URLs
            AddUrl = "SubaktivitasHasilPemeriksaanLpgAdd";
            ...
            MultiDeleteUrl = "SubaktivitasHasilPemeriksaanLpgDelete";
            MultiUpdateUrl = "SubaktivitasHasilPemeriksaanLpgUpdate";
        ...
        // Page name
        public string PageName => "SubaktivitasHasilPemeriksaanLpgList";
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanLpgListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubaktivitasHasilPemeriksaanLpgView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubaktivitasHasilPemeriksaanLPGgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subaktivitasHasilPemeriksaanLpgList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubaktivitasHasilPemeriksaanLPG"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubaktivitasHasilPemeriksaanLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasHasilPemeriksaanLPGlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubaktivitasHasilPemeriksaanLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubaktivitasHasilPemeriksaanLPGsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasHasilPemeriksaanLPGlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubaktivitasHasilPemeriksaanLPG");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subaktivitasHasilPemeriksaanLpgList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subaktivitasHasilPemeriksaanLpgList.RowCount) + "_SubaktivitasHasilPemeriksaanLPG");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subaktivitasHasilPemeriksaanLpgList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subaktivitasHasilPemeriksaanLpgList.RowType == RowType.Add || IsEdit && subaktivitasHasilPemeriksaanLpgList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubaktivitasHasilPemeriksaanLPGsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
