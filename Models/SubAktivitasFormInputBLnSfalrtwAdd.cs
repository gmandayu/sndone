...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputBLnSfalrtwAddBase : SubAktivitasFormInputBLnSfalrtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputBLnSfalrtwAddBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputBLnSfalrtwAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasFormInputBLnSfalrtwList"); // No matching record, return to List page // DN
                    }
                    break;
