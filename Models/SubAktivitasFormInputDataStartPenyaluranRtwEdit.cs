...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputDataStartPenyaluranRtwEditBase : SubAktivitasFormInputDataStartPenyaluranRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPenyaluranRtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputDataStartPenyaluranRtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputDataStartPenyaluranRtwList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputDataStartPenyaluranRtwList") {
                                ...
                                returnUrl = "SubAktivitasFormInputDataStartPenyaluranRtwList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
