...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiARsesuaiCqdPipaLpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiARsesuaiCqdPipaLpg subAktivitasNilaiARsesuaiCqdPipaLpg
    {
        get => HttpData.Resolve<SubAktivitasNilaiARsesuaiCqdPipaLpg>("SubAktivitasNilaiARsesuaiCQDPipaLPG");
        set => HttpData["SubAktivitasNilaiARsesuaiCQDPipaLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiARsesuaiCQDPipaLPG
    /// </summary>
    public class SubAktivitasNilaiARsesuaiCqdPipaLpg : DbTable
    {
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipaLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiARsesuaiCQDPipaLPG";
            Name = "SubAktivitasNilaiARsesuaiCQDPipaLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiARsesuaiCQDPipaLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipaLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipaLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipaLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipaLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            MT = new(this, "x_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipaLPG", "MT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("MT", MT);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipaLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipaLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipaLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipaLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipaLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiARsesuaiCQDPipaLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiArsesuaiCqdpipaLpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiARsesuaiCqdPipaLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiARsesuaiCqdPipaLpgView" => Language.Phrase("View"),
                "SubAktivitasNilaiARsesuaiCqdPipaLpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiARsesuaiCqdPipaLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiARsesuaiCqdPipaLpgView",
                Config.ApiAddAction => "SubAktivitasNilaiARsesuaiCqdPipaLpgAdd",
                Config.ApiEditAction => "SubAktivitasNilaiARsesuaiCqdPipaLpgEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiARsesuaiCqdPipaLpgDelete",
                Config.ApiListAction => "SubAktivitasNilaiARsesuaiCqdPipaLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiARsesuaiCqdPipaLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaLpgView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiARsesuaiCqdPipaLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiARsesuaiCqdPipaLpgAdd?" + parm;
            else
                url = "SubAktivitasNilaiARsesuaiCqdPipaLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiARsesuaiCqdPipaLpgList";
