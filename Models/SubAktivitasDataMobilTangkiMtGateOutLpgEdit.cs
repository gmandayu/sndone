...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataMobilTangkiMtGateOutLpgEdit
    /// </summary>
    public static SubAktivitasDataMobilTangkiMtGateOutLpgEdit subAktivitasDataMobilTangkiMtGateOutLpgEdit
    {
        get => HttpData.Get<SubAktivitasDataMobilTangkiMtGateOutLpgEdit>("subAktivitasDataMobilTangkiMtGateOutLpgEdit")!;
        set => HttpData["subAktivitasDataMobilTangkiMtGateOutLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataMobilTangkiMTGateOutLPG
    /// </summary>
    public class SubAktivitasDataMobilTangkiMtGateOutLpgEdit : SubAktivitasDataMobilTangkiMtGateOutLpgEditBase
    {
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataMobilTangkiMtGateOutLpgEditBase : SubAktivitasDataMobilTangkiMtGateOutLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataMobilTangkiMtGateOutLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataMobilTangkiMtGateOutLpgEdit";
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataMobilTangkiMtGateOutLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataMobilTangkiMtGateOutLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataMobilTangkiMtGateOutLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataMobilTangkiMtGateOutLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void ValidateCustomNoReferensi() {
            if (NoReferensi.Visible && NoReferensi.Required) {
                if (!NoReferensi.IsDetailKey && Empty(NoReferensi.FormValue)) {
                    NoReferensi.AddErrorMessage(ConvertToString(NomorSegel.RequiredErrorMessage).Replace("%s", NomorSegel.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidProses() {
            if (idProses.Visible && idProses.Required) {
                if (!idProses.IsDetailKey && Empty(idProses.FormValue)) {
                    idProses.AddErrorMessage(ConvertToString(NomorSegel.RequiredErrorMessage).Replace("%s", NomorSegel.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidAktifitas() {
            if (idAktifitas.Visible && idAktifitas.Required) {
                if (!idAktifitas.IsDetailKey && Empty(idAktifitas.FormValue)) {
                    idAktifitas.AddErrorMessage(ConvertToString(NomorSegel.RequiredErrorMessage).Replace("%s", NomorSegel.Caption));
                }
            }
        }
        ...
        private void ValidateCustomStatusAktivitas() {
            if (StatusAktivitas.Visible && StatusAktivitas.Required) {
                if (!StatusAktivitas.IsDetailKey && Empty(StatusAktivitas.FormValue)) {
                    StatusAktivitas.AddErrorMessage(ConvertToString(NomorSegel.RequiredErrorMessage).Replace("%s", NomorSegel.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLastUpdatedBy() {
            if (LastUpdatedBy.Visible && LastUpdatedBy.Required) {
                if (!LastUpdatedBy.IsDetailKey && Empty(LastUpdatedBy.FormValue)) {
                    LastUpdatedBy.AddErrorMessage(ConvertToString(NomorSegel.RequiredErrorMessage).Replace("%s", NomorSegel.Caption));
                }
            }
        }
        ...
        private void ValidateCustomlastUpdatedDate() {
            if (lastUpdatedDate.Visible && lastUpdatedDate.Required) {
                if (!lastUpdatedDate.IsDetailKey && Empty(lastUpdatedDate.FormValue)) {
                    lastUpdatedDate.AddErrorMessage(ConvertToString(NomorSegel.RequiredErrorMessage).Replace("%s", NomorSegel.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNomorPolisi() {
            if (NomorPolisi.Visible && NomorPolisi.Required) {
                if (!NomorPolisi.IsDetailKey && Empty(NomorPolisi.FormValue)) {
                    NomorPolisi.AddErrorMessage(ConvertToString(NomorSegel.RequiredErrorMessage).Replace("%s", NomorSegel.Caption));
                }
            }
        }
        ...
        private void ValidateCustomAMT() {
            if (AMT.Visible && AMT.Required) {
                if (!AMT.IsDetailKey && Empty(AMT.FormValue)) {
                    AMT.AddErrorMessage(ConvertToString(NomorSegel.RequiredErrorMessage).Replace("%s", NomorSegel.Caption));
                }
            }
        }
        ...
        private void ValidateCustomWaktuGateOut() {
            if (WaktuGateOut.Visible && WaktuGateOut.Required) {
                if (!WaktuGateOut.IsDetailKey && Empty(WaktuGateOut.FormValue)) {
                    WaktuGateOut.AddErrorMessage(ConvertToString(NomorSegel.RequiredErrorMessage).Replace("%s", NomorSegel.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataMobilTangkiMtGateOutLpgList")), "", TableVar, true);
            string pageId = "edit";
