...
public partial class SnDOne {
    ...
    public class SetPjsAddBase : SetPjs
    {
        ...
        // Constructor
        public SetPjsAddBase(Controller? controller)
        {
            TableName = "SetPjs";
        ...
        // Constructor
        public SetPjsAddBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        protected async Task LoadFormValues() {
            ...
            SetNormalField(DiperbaharuiTanggal, "DiperbaharuiTanggal", "x_DiperbaharuiTanggal", true, validate, true);
        }
        #pragma warning restore 1998
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                DiperbaharuiOleh.EditValue = Empty(curVal8) ? DbNullValue : HtmlEncode(DiperbaharuiOleh.CurrentValue);
                if (!Empty(curVal8)) {
        ...
        private void ValidateCustomRedirectLink() {
            if (RedirectLink.Visible && RedirectLink.Required) {
                if (!RedirectLink.IsDetailKey && Empty(RedirectLink.FormValue)) {
                    RedirectLink.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNama() {
            if (Nama.Visible && Nama.Required) {
                if (!Nama.IsDetailKey && Empty(Nama.FormValue)) {
                    Nama.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomOrganizationLevel() {
            if (OrganizationLevel.Visible && OrganizationLevel.Required) {
                if (!OrganizationLevel.IsDetailKey && Empty(OrganizationLevel.FormValue)) {
                    OrganizationLevel.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomRegion() {
            if (Region.Visible && Region.Required) {
                if (!Region.IsDetailKey && Empty(Region.FormValue)) {
                    Region.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomPlant() {
            if (Plant.Visible && Plant.Required) {
                if (!Plant.IsDetailKey && Empty(Plant.FormValue)) {
                    Plant.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomPosisiAwal() {
            if (PosisiAwal.Visible && PosisiAwal.Required) {
                if (!PosisiAwal.IsDetailKey && Empty(PosisiAwal.FormValue)) {
                    PosisiAwal.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomPosisiPJS() {
            if (PosisiPJS.Visible && PosisiPJS.Required) {
                if (!PosisiPJS.IsDetailKey && Empty(PosisiPJS.FormValue)) {
                    PosisiPJS.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLookupPosition() {
            if (LookupPosition.Visible && LookupPosition.Required) {
                if (!LookupPosition.IsDetailKey && Empty(LookupPosition.FormValue)) {
                    LookupPosition.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomTanggalMulai() {
            if (TanggalMulai.Visible && TanggalMulai.Required) {
                if (!TanggalMulai.IsDetailKey && Empty(TanggalMulai.FormValue)) {
                    TanggalMulai.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomTanggalSelesai() {
            if (TanggalSelesai.Visible && TanggalSelesai.Required) {
                if (!TanggalSelesai.IsDetailKey && Empty(TanggalSelesai.FormValue)) {
                    TanggalSelesai.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomKeterangan() {
            if (Keterangan.Visible && Keterangan.Required) {
                if (!Keterangan.IsDetailKey && Empty(Keterangan.FormValue)) {
                    Keterangan.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomRemaks() {
            if (Remaks.Visible && Remaks.Required) {
                if (!Remaks.IsDetailKey && Empty(Remaks.FormValue)) {
                    Remaks.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
        ...
        private void ValidateCustomDiperbaharuiOleh() {
            if (DiperbaharuiOleh.Visible && DiperbaharuiOleh.Required) {
                if (!DiperbaharuiOleh.IsDetailKey && Empty(DiperbaharuiOleh.FormValue)) {
                    DiperbaharuiOleh.AddErrorMessage(ConvertToString(DiperbaharuiTanggal.RequiredErrorMessage).Replace("%s", DiperbaharuiTanggal.Caption));
                }
            }
        }
