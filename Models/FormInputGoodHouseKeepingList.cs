...
public partial class SnDOne {
    /// <summary>
    /// formInputGoodHouseKeepingList
    /// </summary>
    public static FormInputGoodHouseKeepingList formInputGoodHouseKeepingList
    {
        get => HttpData.Get<FormInputGoodHouseKeepingList>("formInputGoodHouseKeepingList")!;
        set => HttpData["formInputGoodHouseKeepingList"] = value;
    }

    /// <summary>
    /// Page class for FormInputGoodHouseKeeping
    /// </summary>
    public class FormInputGoodHouseKeepingList : FormInputGoodHouseKeepingListBase
    {
        // Constructor
        public FormInputGoodHouseKeepingList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public FormInputGoodHouseKeepingList() : base()
        {
        }
        ...
        public override void PageDataRendering(ref string header) {
            // Example:
            //header = "your header";
            // Sembunyikan master di halaman LIST tanpa kedip
            header += @"
                <style>
                /* khusus page LIST FormInputGoodHouseKeeping */
                .ew-master-div,
    ...
    /// Page base class
    /// </summary>
    public class FormInputGoodHouseKeepingListBase : FormInputGoodHouseKeeping
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "formInputGoodHouseKeepingList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fFormInputGoodHouseKeepinglist";
        ...
        // Constructor
        public FormInputGoodHouseKeepingListBase()
        {
            TableName = "FormInputGoodHouseKeeping";

            // CSS class name as context
            TableVar = "FormInputGoodHouseKeeping";
            ...
            // Table object (formInputGoodHouseKeeping)
            if (formInputGoodHouseKeeping == null || formInputGoodHouseKeeping is FormInputGoodHouseKeeping)
                formInputGoodHouseKeeping = this;

            // Initialize URLs
            AddUrl = "FormInputGoodHouseKeepingAdd";
            ...
            MultiDeleteUrl = "FormInputGoodHouseKeepingDelete";
            MultiUpdateUrl = "FormInputGoodHouseKeepingUpdate";
        ...
        // Page name
        public string PageName => "FormInputGoodHouseKeepingList";
        ...
        // Constructor
        public FormInputGoodHouseKeepingListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "FormInputGoodHouseKeepingView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fFormInputGoodHouseKeepinggrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                formInputGoodHouseKeepingList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(tgltiba.AdvancedSearch.ToJson())); // Field tgltiba
        ...
        protected bool RestoreFilterList() {
            ...
            // Field tgltiba
            if (filter?.TryGetValue("x_tgltiba", out sv) ?? false) {
                tgltiba.AdvancedSearch.SearchValue = sv;
                tgltiba.AdvancedSearch.SearchOperator = filter["z_tgltiba"];
                tgltiba.AdvancedSearch.SearchCondition = filter["v_tgltiba"];
                tgltiba.AdvancedSearch.SearchValue2 = filter["y_tgltiba"];
                tgltiba.AdvancedSearch.SearchOperator2 = filter["w_tgltiba"];
                tgltiba.AdvancedSearch.Save();
            }
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            BuildSearchSql(ref where, tgltiba, def, true); // tgltiba
            ...
            if (!def && Command == "search") {
                tgltiba.AdvancedSearch.Save(); // tgltiba
        ...
        public void ShowFilterList()
        {
            ...
            // Field tgltiba
            filter = QueryBuilderWhere("tgltiba");
            if (Empty(filter))
                BuildSearchSql(ref filter, tgltiba, false, true);
            if (!Empty(filter))
                filterList += "<div><span class=\"" + captionClass + "\">" + tgltiba.Caption + "</span>" + captionSuffix + filter + "</div>";
        ...
        protected bool CheckSearchParms() {
            ...
            if (NoReferensi.AdvancedSearch.IssetSession)
                return true;
            if (tgltiba.AdvancedSearch.IssetSession)
                return true;
        ...
        protected void ResetAdvancedSearchParms() {
            ...
            tgltiba.AdvancedSearch.UnsetSession();
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(tgltiba, ctrl); // tgltiba
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""FormInputGoodHouseKeeping"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""FormInputGoodHouseKeeping"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalAdd && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-copy"" title=""{copycaption}"" data-table=""FormInputGoodHouseKeeping"" data-caption=""{copycaption}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(CopyUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("CopyLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fFormInputGoodHouseKeepinglist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fFormInputGoodHouseKeepinglist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""FormInputGoodHouseKeeping"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            item.Body = $@"<button type=""button"" class=""ew-action ew-multi-delete"" title=""{deleteTitle}"" data-caption=""{deleteTitle}"" form=""fFormInputGoodHouseKeepinglist""" +
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("tgltiba")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fFormInputGoodHouseKeepingsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fFormInputGoodHouseKeepingsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fFormInputGoodHouseKeepinglist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_FormInputGoodHouseKeeping");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(formInputGoodHouseKeepingList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(formInputGoodHouseKeepingList.RowCount) + "_FormInputGoodHouseKeeping");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(formInputGoodHouseKeepingList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && formInputGoodHouseKeepingList.RowType == RowType.Add || IsEdit && formInputGoodHouseKeepingList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void LoadSearchValues() {
            ...
            // tgltiba
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_tgltiba[]"))
                    tgltiba.AdvancedSearch.SearchValue = Get("x_tgltiba[]", Config.FilterOptionSeparator);
                else
                    tgltiba.AdvancedSearch.SearchValue = Get("tgltiba"); // Default Value // DN
            if (!Empty(tgltiba.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_tgltiba"))
                tgltiba.AdvancedSearch.SearchOperator = Get("z_tgltiba", Config.FilterOptionSeparator);
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            tgltiba.SetDbValue(row["tgltiba"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("tgltiba", tgltiba.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // tgltiba
                tgltiba.ViewValue = tgltiba.CurrentValue;
                tgltiba.ViewValue = FormatDateTime(tgltiba.ViewValue, tgltiba.FormatPattern);
                tgltiba.ViewCustomAttributes = "";
                ...
                // tgltiba
                if (tgltiba.UseFilter && !Empty(tgltiba.AdvancedSearch.SearchValue)) {
                    tgltiba.EditValue = ConvertToString(tgltiba.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fFormInputGoodHouseKeepinglist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fFormInputGoodHouseKeepinglist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fFormInputGoodHouseKeepinglist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fFormInputGoodHouseKeepingsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
