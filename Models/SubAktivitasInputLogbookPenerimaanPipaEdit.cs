...
public partial class SnDOne {
    ...
    public class SubAktivitasInputLogbookPenerimaanPipaEditBase : SubAktivitasInputLogbookPenerimaanPipa
    {
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPipaEditBase()
        {
        ...
        // Constructor
        public SubAktivitasInputLogbookPenerimaanPipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasInputLogbookPenerimaanPipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasInputLogbookPenerimaanPipaList") {
                                ...
                                returnUrl = "SubAktivitasInputLogbookPenerimaanPipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
