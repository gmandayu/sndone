...
public partial class SnDOne {
    ...
    /// masterToolsView
    /// </summary>
    public static MasterToolsView masterToolsView
    {
        get => HttpData.Get<MasterToolsView>("masterToolsView")!;
        set => HttpData["masterToolsView"] = value;
    }

    /// <summary>
    /// Page class for MasterTools
    /// </summary>
    public class MasterToolsView : MasterToolsViewBase
    {
        // Constructor
        public MasterToolsView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterToolsView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterToolsViewBase : MasterTools
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterToolsView";
        ...
        public MasterToolsViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdTools"] = keys[0];
            } else {
                RecordKeys["IdTools"] = RouteValues.TryGetValue("IdTools", out obj) && obj != null ? UrlDecode(obj) : Get("IdTools"); // DN
            }
        ...
        // Page name
        public string PageName => "MasterToolsView";
        ...
        // Constructor
        public MasterToolsViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdTools", out v) && !Empty(v)) { // DN
                IdTools.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdTools"] = IdTools.QueryValue;
            } else if (Get("IdTools", out sv)) {
                IdTools.QueryValue = sv.ToString();
                RecordKeys["IdTools"] = IdTools.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdTools.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdTools"] = IdTools.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "MasterToolsList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterToolsList"); // Return to list page
                            }
                        }
                    break;
            }
