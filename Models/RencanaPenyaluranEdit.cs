...
public partial class SnDOne {
    ...
    public class RencanaPenyaluranEditBase : RencanaPenyaluran
    {
        ...
        // Constructor
        public RencanaPenyaluranEditBase(Controller? controller)
        {
        ...
        // Constructor
        public RencanaPenyaluranEditBase() : this(null) { }
        ...
        private async Task<ActionSetupResult> SetupCurrentAction()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("IdRencanaPenyaluran", out rv)) {
                    IdRencanaPenyaluran.FormValue = UrlDecode(rv);
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'NomorRencanaPenyaluran'
            NomorRencanaPenyaluran.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(NomorRencanaPenyaluran, "NomorRencanaPenyaluran", "x_NomorRencanaPenyaluran");
            ...
            if (!IdRencanaPenyaluran.IsDetailKey) {
                SetNormalField(IdRencanaPenyaluran, "IdRencanaPenyaluran", "x_IdRencanaPenyaluran");
            }
        }
        #pragma warning restore 1998
        ...
        private void ValidateCustomNomorRencanaPenyaluran() {
            if (NomorRencanaPenyaluran.Visible && NomorRencanaPenyaluran.Required) {
                if (!NomorRencanaPenyaluran.IsDetailKey && Empty(NomorRencanaPenyaluran.FormValue)) {
                    NomorRencanaPenyaluran.AddErrorMessage(ConvertToString(LookupJenisPlant.RequiredErrorMessage).Replace("%s", LookupJenisPlant.Caption));
                }
            }
        }
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ValidateCustomNomorRencanaPenyaluran();
