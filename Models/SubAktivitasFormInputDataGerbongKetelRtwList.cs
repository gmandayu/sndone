...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputDataGerbongKetelRtwListBase : SubAktivitasFormInputDataGerbongKetelRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasFormInputDataGerbongKetelRtwListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field Jns_Produk
            if (filter.TryGetValue("x_Jns_Produk", out sv)) {
                RestoreFieldFilter(Jns_Produk, filter, "Jns_Produk", sv);
            }
