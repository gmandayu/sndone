...
public partial class SnDOne {
    /// <summary>
    /// templateAktivitasDokumenEdit
    /// </summary>
    public static TemplateAktivitasDokumenEdit templateAktivitasDokumenEdit
    {
        get => HttpData.Get<TemplateAktivitasDokumenEdit>("templateAktivitasDokumenEdit")!;
        set => HttpData["templateAktivitasDokumenEdit"] = value;
    }

    /// <summary>
    /// Page class for TemplateAktivitasDokumen
    /// </summary>
    public class TemplateAktivitasDokumenEdit : TemplateAktivitasDokumenEditBase
    {
        // Constructor
        public TemplateAktivitasDokumenEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TemplateAktivitasDokumenEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TemplateAktivitasDokumenEditBase : TemplateAktivitasDokumen
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "templateAktivitasDokumenEdit";
        ...
        // Constructor
        public TemplateAktivitasDokumenEditBase()
        {
        ...
        // Page name
        public string PageName => "TemplateAktivitasDokumenEdit";
        ...
        // Constructor
        public TemplateAktivitasDokumenEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("IdTemplateAktivitasDokumen", out rv)) { // DN
                    IdTemplateAktivitasDokumen.FormValue = UrlDecode(rv); // DN
                    IdTemplateAktivitasDokumen.OldValue = IdTemplateAktivitasDokumen.FormValue;
                } else if (CurrentForm.HasValue("x_IdTemplateAktivitasDokumen")) {
                    IdTemplateAktivitasDokumen.FormValue = CurrentForm.GetValue("x_IdTemplateAktivitasDokumen");
                    IdTemplateAktivitasDokumen.OldValue = IdTemplateAktivitasDokumen.FormValue;
                } else if (!Empty(keyValues)) {
                    IdTemplateAktivitasDokumen.OldValue = ConvertToString(keyValues[0]);
                } else {
                ...
                if (!Empty(Post("action"))) {
                    ...
                    if (RouteValues.TryGetValue("IdTemplateAktivitasDokumen", out rv)) { // DN
                        IdTemplateAktivitasDokumen.QueryValue = UrlDecode(rv); // DN
                        loadByQuery = true;
                    } else if (Get("IdTemplateAktivitasDokumen", out sv)) {
                        IdTemplateAktivitasDokumen.QueryValue = sv.ToString();
                        loadByQuery = true;
                    } else {
                        IdTemplateAktivitasDokumen.CurrentValue = DbNullValue;
                    }
                }
        ...
        if (postBack) {
            ...
            if (IsApi() && RouteValues.TryGetValue("key", out object? k)) {
                ...
                IdTemplateAktivitasDokumen.FormValue = ConvertToString(keyValues[0]);
            }
        }
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("TemplateAktivitasDokumenList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "TemplateAktivitasDokumenList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "TemplateAktivitasDokumenList") {
                                ...
                                returnUrl = "TemplateAktivitasDokumenList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                templateAktivitasDokumenEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected async Task LoadFormValues() {
            ...
            if (!IdTemplateAktivitasDokumen.IsDetailKey)
        ...
        public async Task RenderRow()
        {
            ...
            IdTemplateAktivitasDokumen.RowCssClass = "row";
