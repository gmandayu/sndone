...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiSfblstsPymLpgEdit
    /// </summary>
    public static SubaktivitasNilaiSfblstsPymLpgEdit subaktivitasNilaiSfblstsPymLpgEdit
    {
        get => HttpData.Get<SubaktivitasNilaiSfblstsPymLpgEdit>("subaktivitasNilaiSfblstsPymLpgEdit")!;
        set => HttpData["subaktivitasNilaiSfblstsPymLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasNilaiSFBLSTSPymLPG
    /// </summary>
    public class SubaktivitasNilaiSfblstsPymLpgEdit : SubaktivitasNilaiSfblstsPymLpgEditBase
    {
        // Constructor
        public SubaktivitasNilaiSfblstsPymLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasNilaiSfblstsPymLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasNilaiSfblstsPymLpgEditBase : SubaktivitasNilaiSfblstsPymLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasNilaiSfblstsPymLpgEdit";
        ...
        // Constructor
        public SubaktivitasNilaiSfblstsPymLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasNilaiSfblstsPymLpgEdit";
        ...
        // Constructor
        public SubaktivitasNilaiSfblstsPymLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasNilaiSfblstsPymLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasNilaiSfblstsPymLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasNilaiSfblstsPymLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasNilaiSfblstsPymLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasNilaiSfblstsPymLpgList")), "", TableVar, true);
            string pageId = "edit";
