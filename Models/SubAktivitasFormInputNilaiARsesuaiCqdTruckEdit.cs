...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputNilaiARsesuaiCqdTruckEditBase : SubAktivitasFormInputNilaiARsesuaiCqdTruck
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputNilaiARsesuaiCqdTruckList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputNilaiARsesuaiCqdTruckList") {
                                ...
                                returnUrl = "SubAktivitasFormInputNilaiARsesuaiCqdTruckList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
