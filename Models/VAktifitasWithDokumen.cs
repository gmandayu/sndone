...
public partial class SnDOne {
    /// <summary>
    /// vAktifitasWithDokumen
    /// </summary>
    [MaybeNull]
    public static VAktifitasWithDokumen vAktifitasWithDokumen
    {
        get => HttpData.Resolve<VAktifitasWithDokumen>("v_aktifitas_with_dokumen");
        set => HttpData["v_aktifitas_with_dokumen"] = value;
    }

    /// <summary>
    /// Table class for v_aktifitas_with_dokumen
    /// </summary>
    public class VAktifitasWithDokumen : DbTable
    {
        ...
        // Constructor
        public VAktifitasWithDokumen()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "v_aktifitas_with_dokumen";
            Name = "v_aktifitas_with_dokumen";
            Type = "VIEW";
            UpdateTable = "dbo.v_aktifitas_with_dokumen"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdAktivitas = new(this, "x_IdAktivitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "IdAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NamaAktivitas = new(this, "x_NamaAktivitas", 203, SqlDbType.NText) {
                ...
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "NamaAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            Nama_Proses = new(this, "x_Nama_Proses", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "Nama_Proses", "CustomMsg"),
                IsUpload = false
            };
            ...
            No_referensi = new(this, "x_No_referensi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "No_referensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            Shipment = new(this, "x_Shipment", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "Shipment", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdDokumen = new(this, "x_IdDokumen", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "IdDokumen", "CustomMsg"),
                IsUpload = false
            };
            IdDokumen.Raw = true;
            ...
            NamaDokumen = new(this, "x_NamaDokumen", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "NamaDokumen", "CustomMsg"),
                IsUpload = false
            };
            ...
            PathFile = new(this, "x_PathFile", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "PathFile", "CustomMsg"),
                IsUpload = true
            };
            ...
            TanggalUploadDok = new(this, "x_TanggalUploadDok", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "TanggalUploadDok", "CustomMsg"),
                IsUpload = false
            };
            ...
            UserUploadDok = new(this, "x_UserUploadDok", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "UserUploadDok", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdProses = new(this, "x_IdProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_with_dokumen", "IdProses", "CustomMsg"),
                IsUpload = false
            };
            IdProses.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.v_aktifitas_with_dokumen";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.VAktifitasWithDokuman type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "VAktifitasWithDokumenList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "VAktifitasWithDokumenView" => Language.Phrase("View"),
                "VAktifitasWithDokumenEdit" => Language.Phrase("Edit"),
                "VAktifitasWithDokumenAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "VAktifitasWithDokumenView",
                Config.ApiAddAction => "VAktifitasWithDokumenAdd",
                Config.ApiEditAction => "VAktifitasWithDokumenEdit",
                Config.ApiDeleteAction => "VAktifitasWithDokumenDelete",
                Config.ApiListAction => "VAktifitasWithDokumenList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "VAktifitasWithDokumenList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("VAktifitasWithDokumenView", parm);
            else
                url = KeyUrl("VAktifitasWithDokumenView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "VAktifitasWithDokumenAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "VAktifitasWithDokumenAdd?" + parm;
            else
                url = "VAktifitasWithDokumenAdd";
        ...
        {
            string url = "";
            url = KeyUrl("VAktifitasWithDokumenEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("VAktifitasWithDokumenList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("VAktifitasWithDokumenAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("VAktifitasWithDokumenList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("VAktifitasWithDokumenDelete", parm)); // DN
        }
        ...
        {
            string pageName = "VAktifitasWithDokumenList";
        ...
        public async Task RenderEditRow()
        {
            ...
            IdDokumen.EditValue = FormatNumber(IdDokumen.EditValue, IdDokumen.FormatPattern);
            IdDokumen.ViewCustomAttributes = "";

            // NamaDokumen
            NamaDokumen.SetupEditAttributes();
            NamaDokumen.EditValue = ConvertToString(NamaDokumen.CurrentValue); // DN
            NamaDokumen.ViewCustomAttributes = "";
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            try {
                // Ambil NoReferensi (No_referensi) dari data baru jika ada, jika tidak pakai data lama
                string noReferensi = rsnew.ContainsKey("No_referensi")
                    ? rsnew["No_referensi"]?.ToString()
                    : rsold.ContainsKey("No_referensi")
                        ? rsold["No_referensi"]?.ToString()
                        : null;

                // Panggil SP GetPlantDateTime untuk mendapatkan waktu lokal plant
                ...
                // Jika ada path file baru, update tanggal upload dan user upload
                if (rsnew.ContainsKey("PathFile")) {
                    rsnew["TanggalUploadDok"] = plantTime;      // gunakan waktu plant
                    rsnew["UserUploadDok"]    = CurrentUserName();
                }

                // Tetap set user & waktu diperbarui menggunakan plantTime
                rsnew["DiperbaruiOleh"]    = CurrentUserName();
                rsnew["TanggalDiperbarui"] = plantTime;
            } catch (Exception ex) {
                Log("Error in Row_Updating (v_aktivitas_with_dokuemt): " + ex.Message);
