...
public partial class SnDOne {
    ...
    public class SubAktivitasStopPembongkaranPenKonEditBase : SubAktivitasStopPembongkaranPenKon
    {
        ...
        // Constructor
        public SubAktivitasStopPembongkaranPenKonEditBase()
        {
        ...
        // Constructor
        public SubAktivitasStopPembongkaranPenKonEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasStopPembongkaranPenKonList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasStopPembongkaranPenKonList") {
                                ...
                                returnUrl = "SubAktivitasStopPembongkaranPenKonList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
