...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static MasterDokumen masterDokumen
    {
        get => HttpData.Resolve<MasterDokumen>("MasterDokumen");
        set => HttpData["MasterDokumen"] = value;
    }

    /// <summary>
    /// Table class for MasterDokumen
    /// </summary>
    public class MasterDokumen : DbTable
    {
        ...
        public MasterDokumen()
        {
            ...
            Name = "MasterDokumen";
            Type = "TABLE";
            UpdateTable = "dbo.MasterDokumen"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdDokumen = new(this, "x_IdDokumen", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("MasterDokumen", "IdDokumen", "CustomMsg"),
                IsUpload = false
            };
            IdDokumen.Raw = true;
            IdDokumen.Lookup = new Lookup<DbField>(IdDokumen, "MasterDokumen", true, "IdDokumen", new List<string> {"IdDokumen", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            NamaDokumen = new(this, "x_NamaDokumen", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("MasterDokumen", "NamaDokumen", "CustomMsg"),
                IsUpload = false
            };
            NamaDokumen.Lookup = new Lookup<DbField>(NamaDokumen, "MasterDokumen", true, "NamaDokumen", new List<string> {"NamaDokumen", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        {
            get => _sqlFrom ?? "dbo.MasterDokumen";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.MasterDokuman type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdDokumen"))
                    row["IdDokumen"] = lastInsertedId;
                else
                    row.Add("IdDokumen", lastInsertedId);
                IdDokumen.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        private string _sqlKeyFilter => "[IdDokumen] = @IdDokumen@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "MasterDokumenView" => Language.Phrase("View"),
                "MasterDokumenEdit" => Language.Phrase("Edit"),
                "MasterDokumenAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "MasterDokumenView",
                Config.ApiAddAction => "MasterDokumenAdd",
                Config.ApiEditAction => "MasterDokumenEdit",
                Config.ApiDeleteAction => "MasterDokumenDelete",
                Config.ApiListAction => "MasterDokumenList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "MasterDokumenList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("MasterDokumenView", parm);
            else
                url = KeyUrl("MasterDokumenView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "MasterDokumenAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "MasterDokumenAdd?" + parm;
            else
                url = "MasterDokumenAdd";
        ...
        {
            string url = "";
            url = KeyUrl("MasterDokumenEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterDokumenList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("MasterDokumenAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("MasterDokumenList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("MasterDokumenDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdDokumen\":" + ConvertToJson(IdDokumen.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdDokumen.CurrentValue)) {
                url += "/" + IdDokumen.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdDokumen", out object? v0)) { // IdDokumen // DN
                    key = UrlDecode(v0); // DN
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdDokumen.CurrentValue = keys;
                else
                    IdDokumen.OldValue = keys;
        ...
        {
            string pageName = "MasterDokumenList";
