...
public partial class SnDOne {
    /// <summary>
    /// subAkivitasNilaiAktualDischargePipaLpg
    /// </summary>
    [MaybeNull]
    public static SubAkivitasNilaiAktualDischargePipaLpg subAkivitasNilaiAktualDischargePipaLpg
    {
        get => HttpData.Resolve<SubAkivitasNilaiAktualDischargePipaLpg>("SubAkivitasNilaiAktualDischargePipaLPG");
        set => HttpData["SubAkivitasNilaiAktualDischargePipaLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAkivitasNilaiAktualDischargePipaLPG
    /// </summary>
    public class SubAkivitasNilaiAktualDischargePipaLpg : DbTable
    {
        ...
        // Constructor
        public SubAkivitasNilaiAktualDischargePipaLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAkivitasNilaiAktualDischargePipaLPG";
            Name = "SubAkivitasNilaiAktualDischargePipaLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAkivitasNilaiAktualDischargePipaLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipaLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipaLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipaLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipaLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipaLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipaLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipaLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            AktualDischarge_mt = new(this, "x_AktualDischarge_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipaLPG", "AktualDischarge_mt", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipaLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAkivitasNilaiAktualDischargePipaLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAkivitasNilaiAktualDischargePipaLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAkivitasNilaiAktualDischargePipaLpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAkivitasNilaiAktualDischargePipaLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAkivitasNilaiAktualDischargePipaLpgView" => Language.Phrase("View"),
                "SubAkivitasNilaiAktualDischargePipaLpgEdit" => Language.Phrase("Edit"),
                "SubAkivitasNilaiAktualDischargePipaLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAkivitasNilaiAktualDischargePipaLpgView",
                Config.ApiAddAction => "SubAkivitasNilaiAktualDischargePipaLpgAdd",
                Config.ApiEditAction => "SubAkivitasNilaiAktualDischargePipaLpgEdit",
                Config.ApiDeleteAction => "SubAkivitasNilaiAktualDischargePipaLpgDelete",
                Config.ApiListAction => "SubAkivitasNilaiAktualDischargePipaLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAkivitasNilaiAktualDischargePipaLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAkivitasNilaiAktualDischargePipaLpgView", parm);
            else
                url = KeyUrl("SubAkivitasNilaiAktualDischargePipaLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAkivitasNilaiAktualDischargePipaLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAkivitasNilaiAktualDischargePipaLpgAdd?" + parm;
            else
                url = "SubAkivitasNilaiAktualDischargePipaLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAkivitasNilaiAktualDischargePipaLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAkivitasNilaiAktualDischargePipaLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAkivitasNilaiAktualDischargePipaLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAkivitasNilaiAktualDischargePipaLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAkivitasNilaiAktualDischargePipaLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAkivitasNilaiAktualDischargePipaLpgList";
