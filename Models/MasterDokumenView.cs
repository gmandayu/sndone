...
public partial class SnDOne {
    ...
    /// masterDokumenView
    /// </summary>
    public static MasterDokumenView masterDokumenView
    {
        get => HttpData.Get<MasterDokumenView>("masterDokumenView")!;
        set => HttpData["masterDokumenView"] = value;
    }

    /// <summary>
    /// Page class for MasterDokumen
    /// </summary>
    public class MasterDokumenView : MasterDokumenViewBase
    {
        // Constructor
        public MasterDokumenView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterDokumenView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterDokumenViewBase : MasterDokumen
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterDokumenView";
        ...
        public MasterDokumenViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["IdDokumen"] = keys[0];
            } else {
                RecordKeys["IdDokumen"] = RouteValues.TryGetValue("IdDokumen", out obj) && obj != null ? UrlDecode(obj) : Get("IdDokumen"); // DN
            }
        ...
        // Page name
        public string PageName => "MasterDokumenView";
        ...
        // Constructor
        public MasterDokumenViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("IdDokumen", out v) && !Empty(v)) { // DN
                IdDokumen.QueryValue = UrlDecode(v); // DN
                RecordKeys["IdDokumen"] = IdDokumen.QueryValue;
            } else if (Get("IdDokumen", out sv)) {
                IdDokumen.QueryValue = sv.ToString();
                RecordKeys["IdDokumen"] = IdDokumen.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                IdDokumen.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["IdDokumen"] = IdDokumen.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "MasterDokumenList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("MasterDokumenList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("MasterDokumenList")), "", TableVar, true);
            string pageId = "view";
