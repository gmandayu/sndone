...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStopPembongkaranView
    /// </summary>
    public static SubAktivitasFormInputDataStopPembongkaranView subAktivitasFormInputDataStopPembongkaranView
    {
        get => HttpData.Get<SubAktivitasFormInputDataStopPembongkaranView>("subAktivitasFormInputDataStopPembongkaranView")!;
        set => HttpData["subAktivitasFormInputDataStopPembongkaranView"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStopPembongkaran
    /// </summary>
    public class SubAktivitasFormInputDataStopPembongkaranView : SubAktivitasFormInputDataStopPembongkaranViewBase
    {
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStopPembongkaranViewBase : SubAktivitasFormInputDataStopPembongkaran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStopPembongkaranView";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranViewBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStopPembongkaranView";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void PageRunEnd()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputDataStopPembongkaranView?.PageRender();
            }
        }
