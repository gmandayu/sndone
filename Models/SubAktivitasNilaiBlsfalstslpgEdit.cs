...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiBlsfalstslpgEdit
    /// </summary>
    public static SubAktivitasNilaiBlsfalstslpgEdit subAktivitasNilaiBlsfalstslpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiBlsfalstslpgEdit>("subAktivitasNilaiBlsfalstslpgEdit")!;
        set => HttpData["subAktivitasNilaiBlsfalstslpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiBLSFALSTSLPG
    /// </summary>
    public class SubAktivitasNilaiBlsfalstslpgEdit : SubAktivitasNilaiBlsfalstslpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiBlsfalstslpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiBlsfalstslpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiBlsfalstslpgEditBase : SubAktivitasNilaiBlsfalstslpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiBlsfalstslpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalstslpgEditBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiBlsfalstslpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalstslpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiBlsfalstslpgList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "SubAktivitasNilaiBlsfalstslpgList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiBlsfalstslpgList") {
                                ...
                                returnUrl = "SubAktivitasNilaiBlsfalstslpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiBlsfalstslpgEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiBlsfalstslpgList")), "", TableVar, true);
            string pageId = "edit";
