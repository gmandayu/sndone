...
public partial class SnDOne {
    /// <summary>
    /// subAkivitasNilaiAktualDischargePipaList
    /// </summary>
    public static SubAkivitasNilaiAktualDischargePipaList subAkivitasNilaiAktualDischargePipaList
    {
        get => HttpData.Get<SubAkivitasNilaiAktualDischargePipaList>("subAkivitasNilaiAktualDischargePipaList")!;
        set => HttpData["subAkivitasNilaiAktualDischargePipaList"] = value;
    }

    /// <summary>
    /// Page class for SubAkivitasNilaiAktualDischargePipa
    /// </summary>
    public class SubAkivitasNilaiAktualDischargePipaList : SubAkivitasNilaiAktualDischargePipaListBase
    {
        // Constructor
        public SubAkivitasNilaiAktualDischargePipaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAkivitasNilaiAktualDischargePipaList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAkivitasNilaiAktualDischargePipaListBase : SubAkivitasNilaiAktualDischargePipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAkivitasNilaiAktualDischargePipaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAkivitasNilaiAktualDischargePipalist";
        ...
        // Constructor
        public SubAkivitasNilaiAktualDischargePipaListBase()
        {
            TableName = "SubAkivitasNilaiAktualDischargePipa";

            // CSS class name as context
            TableVar = "SubAkivitasNilaiAktualDischargePipa";
            ...
            // Table object (subAkivitasNilaiAktualDischargePipa)
            if (subAkivitasNilaiAktualDischargePipa == null || subAkivitasNilaiAktualDischargePipa is SubAkivitasNilaiAktualDischargePipa)
                subAkivitasNilaiAktualDischargePipa = this;

            // Initialize URLs
            AddUrl = "SubAkivitasNilaiAktualDischargePipaAdd";
            ...
            MultiDeleteUrl = "SubAkivitasNilaiAktualDischargePipaDelete";
            MultiUpdateUrl = "SubAkivitasNilaiAktualDischargePipaUpdate";
        ...
        // Page name
        public string PageName => "SubAkivitasNilaiAktualDischargePipaList";
        ...
        public void SetVisibility()
        {
            ...
            AktualDischarge_klobs.SetVisibility();
            AktualDischarge_kl15.SetVisibility();
            AktualDischarge_barrels.SetVisibility();
            AktualDischarge_lt.SetVisibility();
            AktualDischarge_mt.SetVisibility();
        ...
        // Constructor
        public SubAkivitasNilaiAktualDischargePipaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAkivitasNilaiAktualDischargePipaView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAkivitasNilaiAktualDischargePipagrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAkivitasNilaiAktualDischargePipaList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(AktualDischarge_klobs.AdvancedSearch.ToJson())); // Field AktualDischarge_klobs
            filters.Merge(JObject.Parse(AktualDischarge_kl15.AdvancedSearch.ToJson())); // Field AktualDischarge_kl15
            filters.Merge(JObject.Parse(AktualDischarge_barrels.AdvancedSearch.ToJson())); // Field AktualDischarge_barrels
            filters.Merge(JObject.Parse(AktualDischarge_lt.AdvancedSearch.ToJson())); // Field AktualDischarge_lt
            filters.Merge(JObject.Parse(AktualDischarge_mt.AdvancedSearch.ToJson())); // Field AktualDischarge_mt
        ...
        protected bool RestoreFilterList() {
            ...
            // Field AktualDischarge_klobs
            if (filter?.TryGetValue("x_AktualDischarge_klobs", out sv) ?? false) {
                AktualDischarge_klobs.AdvancedSearch.SearchValue = sv;
                AktualDischarge_klobs.AdvancedSearch.SearchOperator = filter["z_AktualDischarge_klobs"];
                AktualDischarge_klobs.AdvancedSearch.SearchCondition = filter["v_AktualDischarge_klobs"];
                AktualDischarge_klobs.AdvancedSearch.SearchValue2 = filter["y_AktualDischarge_klobs"];
                AktualDischarge_klobs.AdvancedSearch.SearchOperator2 = filter["w_AktualDischarge_klobs"];
                AktualDischarge_klobs.AdvancedSearch.Save();
            }

            // Field AktualDischarge_kl15
            if (filter?.TryGetValue("x_AktualDischarge_kl15", out sv) ?? false) {
                AktualDischarge_kl15.AdvancedSearch.SearchValue = sv;
                AktualDischarge_kl15.AdvancedSearch.SearchOperator = filter["z_AktualDischarge_kl15"];
                AktualDischarge_kl15.AdvancedSearch.SearchCondition = filter["v_AktualDischarge_kl15"];
                AktualDischarge_kl15.AdvancedSearch.SearchValue2 = filter["y_AktualDischarge_kl15"];
                AktualDischarge_kl15.AdvancedSearch.SearchOperator2 = filter["w_AktualDischarge_kl15"];
                AktualDischarge_kl15.AdvancedSearch.Save();
            }

            // Field AktualDischarge_barrels
            if (filter?.TryGetValue("x_AktualDischarge_barrels", out sv) ?? false) {
                AktualDischarge_barrels.AdvancedSearch.SearchValue = sv;
                AktualDischarge_barrels.AdvancedSearch.SearchOperator = filter["z_AktualDischarge_barrels"];
                AktualDischarge_barrels.AdvancedSearch.SearchCondition = filter["v_AktualDischarge_barrels"];
                AktualDischarge_barrels.AdvancedSearch.SearchValue2 = filter["y_AktualDischarge_barrels"];
                AktualDischarge_barrels.AdvancedSearch.SearchOperator2 = filter["w_AktualDischarge_barrels"];
                AktualDischarge_barrels.AdvancedSearch.Save();
            }

            // Field AktualDischarge_lt
            if (filter?.TryGetValue("x_AktualDischarge_lt", out sv) ?? false) {
                AktualDischarge_lt.AdvancedSearch.SearchValue = sv;
                AktualDischarge_lt.AdvancedSearch.SearchOperator = filter["z_AktualDischarge_lt"];
                AktualDischarge_lt.AdvancedSearch.SearchCondition = filter["v_AktualDischarge_lt"];
                AktualDischarge_lt.AdvancedSearch.SearchValue2 = filter["y_AktualDischarge_lt"];
                AktualDischarge_lt.AdvancedSearch.SearchOperator2 = filter["w_AktualDischarge_lt"];
                AktualDischarge_lt.AdvancedSearch.Save();
            }

            // Field AktualDischarge_mt
            if (filter?.TryGetValue("x_AktualDischarge_mt", out sv) ?? false) {
                AktualDischarge_mt.AdvancedSearch.SearchValue = sv;
                AktualDischarge_mt.AdvancedSearch.SearchOperator = filter["z_AktualDischarge_mt"];
                AktualDischarge_mt.AdvancedSearch.SearchCondition = filter["v_AktualDischarge_mt"];
                AktualDischarge_mt.AdvancedSearch.SearchValue2 = filter["y_AktualDischarge_mt"];
                AktualDischarge_mt.AdvancedSearch.SearchOperator2 = filter["w_AktualDischarge_mt"];
                AktualDischarge_mt.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(AktualDischarge_klobs);
            searchFlds.Add(AktualDischarge_kl15);
            searchFlds.Add(AktualDischarge_barrels);
            searchFlds.Add(AktualDischarge_lt);
            searchFlds.Add(AktualDischarge_mt);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(AktualDischarge_klobs, ctrl); // AktualDischarge_klobs
                UpdateSort(AktualDischarge_kl15, ctrl); // AktualDischarge_kl15
                UpdateSort(AktualDischarge_barrels, ctrl); // AktualDischarge_barrels
                UpdateSort(AktualDischarge_lt, ctrl); // AktualDischarge_lt
                UpdateSort(AktualDischarge_mt, ctrl); // AktualDischarge_mt
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    id.Sort = "";
                    idAktifitas.Sort = "";
                    AktualDischarge_klobs.Sort = "";
                    AktualDischarge_kl15.Sort = "";
                    AktualDischarge_barrels.Sort = "";
                    AktualDischarge_lt.Sort = "";
                    AktualDischarge_mt.Sort = "";
                    userInput.Sort = "";
                    etlDate.Sort = "";
                    idProses.Sort = "";
                    LastUpdatedBy.Sort = "";
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAkivitasNilaiAktualDischargePipa"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAkivitasNilaiAktualDischargePipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAkivitasNilaiAktualDischargePipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("AktualDischarge_klobs")); // DN
                CreateColumnOption(option.Add("AktualDischarge_kl15")); // DN
                CreateColumnOption(option.Add("AktualDischarge_barrels")); // DN
                CreateColumnOption(option.Add("AktualDischarge_lt")); // DN
                CreateColumnOption(option.Add("AktualDischarge_mt")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAkivitasNilaiAktualDischargePipasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAkivitasNilaiAktualDischargePipasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAkivitasNilaiAktualDischargePipalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAkivitasNilaiAktualDischargePipa");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAkivitasNilaiAktualDischargePipaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAkivitasNilaiAktualDischargePipaList.RowCount) + "_SubAkivitasNilaiAktualDischargePipa");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAkivitasNilaiAktualDischargePipaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAkivitasNilaiAktualDischargePipaList.RowType == RowType.Add || IsEdit && subAkivitasNilaiAktualDischargePipaList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            AktualDischarge_klobs.SetDbValue(row["AktualDischarge_klobs"]);
            AktualDischarge_kl15.SetDbValue(row["AktualDischarge_kl15"]);
            AktualDischarge_barrels.SetDbValue(row["AktualDischarge_barrels"]);
            AktualDischarge_lt.SetDbValue(row["AktualDischarge_lt"]);
            AktualDischarge_mt.SetDbValue(row["AktualDischarge_mt"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("AktualDischarge_klobs", AktualDischarge_klobs.DefaultValue ?? DbNullValue); // DN
            row.Add("AktualDischarge_kl15", AktualDischarge_kl15.DefaultValue ?? DbNullValue); // DN
            row.Add("AktualDischarge_barrels", AktualDischarge_barrels.DefaultValue ?? DbNullValue); // DN
            row.Add("AktualDischarge_lt", AktualDischarge_lt.DefaultValue ?? DbNullValue); // DN
            row.Add("AktualDischarge_mt", AktualDischarge_mt.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            // AktualDischarge_klobs

            // AktualDischarge_kl15

            // AktualDischarge_barrels
            ...
            if (RowType == RowType.View) {
                ...
                // AktualDischarge_klobs
                AktualDischarge_klobs.ViewValue = ConvertToString(AktualDischarge_klobs.CurrentValue); // DN
                AktualDischarge_klobs.ViewCustomAttributes = "";

                // AktualDischarge_kl15
                AktualDischarge_kl15.ViewValue = ConvertToString(AktualDischarge_kl15.CurrentValue); // DN
                AktualDischarge_kl15.ViewCustomAttributes = "";

                // AktualDischarge_barrels
                AktualDischarge_barrels.ViewValue = ConvertToString(AktualDischarge_barrels.CurrentValue); // DN
                AktualDischarge_barrels.ViewCustomAttributes = "";

                // AktualDischarge_lt
                AktualDischarge_lt.ViewValue = ConvertToString(AktualDischarge_lt.CurrentValue); // DN
                AktualDischarge_lt.ViewCustomAttributes = "";

                // AktualDischarge_mt
                AktualDischarge_mt.ViewValue = ConvertToString(AktualDischarge_mt.CurrentValue); // DN
                AktualDischarge_mt.ViewCustomAttributes = "";
                ...
                // AktualDischarge_klobs
                AktualDischarge_klobs.HrefValue = "";
                AktualDischarge_klobs.TooltipValue = "";

                // AktualDischarge_kl15
                AktualDischarge_kl15.HrefValue = "";
                AktualDischarge_kl15.TooltipValue = "";

                // AktualDischarge_barrels
                AktualDischarge_barrels.HrefValue = "";
                AktualDischarge_barrels.TooltipValue = "";

                // AktualDischarge_lt
                AktualDischarge_lt.HrefValue = "";
                AktualDischarge_lt.TooltipValue = "";

                // AktualDischarge_mt
                AktualDischarge_mt.HrefValue = "";
                AktualDischarge_mt.TooltipValue = "";
