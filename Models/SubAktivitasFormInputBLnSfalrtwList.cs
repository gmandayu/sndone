...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputBLnSfalrtwList
    /// </summary>
    public static SubAktivitasFormInputBLnSfalrtwList subAktivitasFormInputBLnSfalrtwList
    {
        get => HttpData.Get<SubAktivitasFormInputBLnSfalrtwList>("subAktivitasFormInputBLnSfalrtwList")!;
        set => HttpData["subAktivitasFormInputBLnSfalrtwList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputBLnSFALRTW
    /// </summary>
    public class SubAktivitasFormInputBLnSfalrtwList : SubAktivitasFormInputBLnSfalrtwListBase
    {
        // Constructor
        public SubAktivitasFormInputBLnSfalrtwList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputBLnSfalrtwList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputBLnSfalrtwListBase : SubAktivitasFormInputBLnSfalrtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputBLnSfalrtwList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasFormInputBLnSFALRTWlist";
        ...
        // Constructor
        public SubAktivitasFormInputBLnSfalrtwListBase()
        {
            TableName = "SubAktivitasFormInputBLnSFALRTW";

            // CSS class name as context
            TableVar = "SubAktivitasFormInputBLnSFALRTW";
            ...
            // Initialize URLs
            AddUrl = "SubAktivitasFormInputBLnSfalrtwAdd";
            ...
            MultiDeleteUrl = "SubAktivitasFormInputBLnSfalrtwDelete";
            MultiUpdateUrl = "SubAktivitasFormInputBLnSfalrtwUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputBLnSfalrtwList";
        ...
        // Constructor
        public SubAktivitasFormInputBLnSfalrtwListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasFormInputBLnSFALRTWgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputBLnSfalrtwList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(SFAL_KLObs.AdvancedSearch.ToJson())); // Field SFAL_KLObs
            filters.Merge(JObject.Parse(SFAL_KL15.AdvancedSearch.ToJson())); // Field SFAL_KL15
            filters.Merge(JObject.Parse(SFAL_Barrels.AdvancedSearch.ToJson())); // Field SFAL_Barrels
            filters.Merge(JObject.Parse(SFAL_LT.AdvancedSearch.ToJson())); // Field SFAL_LT
            filters.Merge(JObject.Parse(SFAL_MT.AdvancedSearch.ToJson())); // Field SFAL_MT
        ...
        protected bool RestoreFilterList() {
            ...
            // Field SFAL_KLObs
            if (filter?.TryGetValue("x_SFAL_KLObs", out sv) ?? false) {
                SFAL_KLObs.AdvancedSearch.SearchValue = sv;
                SFAL_KLObs.AdvancedSearch.SearchOperator = filter["z_SFAL_KLObs"];
                SFAL_KLObs.AdvancedSearch.SearchCondition = filter["v_SFAL_KLObs"];
                SFAL_KLObs.AdvancedSearch.SearchValue2 = filter["y_SFAL_KLObs"];
                SFAL_KLObs.AdvancedSearch.SearchOperator2 = filter["w_SFAL_KLObs"];
                SFAL_KLObs.AdvancedSearch.Save();
            }

            // Field SFAL_KL15
            if (filter?.TryGetValue("x_SFAL_KL15", out sv) ?? false) {
                SFAL_KL15.AdvancedSearch.SearchValue = sv;
                SFAL_KL15.AdvancedSearch.SearchOperator = filter["z_SFAL_KL15"];
                SFAL_KL15.AdvancedSearch.SearchCondition = filter["v_SFAL_KL15"];
                SFAL_KL15.AdvancedSearch.SearchValue2 = filter["y_SFAL_KL15"];
                SFAL_KL15.AdvancedSearch.SearchOperator2 = filter["w_SFAL_KL15"];
                SFAL_KL15.AdvancedSearch.Save();
            }

            // Field SFAL_Barrels
            if (filter?.TryGetValue("x_SFAL_Barrels", out sv) ?? false) {
                SFAL_Barrels.AdvancedSearch.SearchValue = sv;
                SFAL_Barrels.AdvancedSearch.SearchOperator = filter["z_SFAL_Barrels"];
                SFAL_Barrels.AdvancedSearch.SearchCondition = filter["v_SFAL_Barrels"];
                SFAL_Barrels.AdvancedSearch.SearchValue2 = filter["y_SFAL_Barrels"];
                SFAL_Barrels.AdvancedSearch.SearchOperator2 = filter["w_SFAL_Barrels"];
                SFAL_Barrels.AdvancedSearch.Save();
            }

            // Field SFAL_LT
            if (filter?.TryGetValue("x_SFAL_LT", out sv) ?? false) {
                SFAL_LT.AdvancedSearch.SearchValue = sv;
                SFAL_LT.AdvancedSearch.SearchOperator = filter["z_SFAL_LT"];
                SFAL_LT.AdvancedSearch.SearchCondition = filter["v_SFAL_LT"];
                SFAL_LT.AdvancedSearch.SearchValue2 = filter["y_SFAL_LT"];
                SFAL_LT.AdvancedSearch.SearchOperator2 = filter["w_SFAL_LT"];
                SFAL_LT.AdvancedSearch.Save();
            }

            // Field SFAL_MT
            if (filter?.TryGetValue("x_SFAL_MT", out sv) ?? false) {
                SFAL_MT.AdvancedSearch.SearchValue = sv;
                SFAL_MT.AdvancedSearch.SearchOperator = filter["z_SFAL_MT"];
                SFAL_MT.AdvancedSearch.SearchCondition = filter["v_SFAL_MT"];
                SFAL_MT.AdvancedSearch.SearchValue2 = filter["y_SFAL_MT"];
                SFAL_MT.AdvancedSearch.SearchOperator2 = filter["w_SFAL_MT"];
                SFAL_MT.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(SFAL_KLObs);
            searchFlds.Add(SFAL_KL15);
            searchFlds.Add(SFAL_Barrels);
            searchFlds.Add(SFAL_LT);
            searchFlds.Add(SFAL_MT);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(SFAL_KLObs, ctrl); // SFAL_KLObs
                UpdateSort(SFAL_KL15, ctrl); // SFAL_KL15
                UpdateSort(SFAL_Barrels, ctrl); // SFAL_Barrels
                UpdateSort(SFAL_LT, ctrl); // SFAL_LT
                UpdateSort(SFAL_MT, ctrl); // SFAL_MT
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""SubAktivitasFormInputBLnSFALRTW"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasFormInputBLnSFALRTW"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalAdd && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-copy"" title=""{copycaption}"" data-table=""SubAktivitasFormInputBLnSFALRTW"" data-caption=""{copycaption}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(CopyUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("CopyLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputBLnSFALRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputBLnSFALRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""SubAktivitasFormInputBLnSFALRTW"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            item.Body = $@"<button type=""button"" class=""ew-action ew-multi-delete"" title=""{deleteTitle}"" data-caption=""{deleteTitle}"" form=""fSubAktivitasFormInputBLnSFALRTWlist""" +
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("SFAL_KLObs")); // DN
                CreateColumnOption(option.Add("SFAL_KL15")); // DN
                CreateColumnOption(option.Add("SFAL_Barrels")); // DN
                CreateColumnOption(option.Add("SFAL_LT")); // DN
                CreateColumnOption(option.Add("SFAL_MT")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasFormInputBLnSFALRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasFormInputBLnSFALRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputBLnSFALRTWlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasFormInputBLnSFALRTW");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasFormInputBLnSfalrtwList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasFormInputBLnSfalrtwList.RowCount) + "_SubAktivitasFormInputBLnSFALRTW");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasFormInputBLnSfalrtwList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasFormInputBLnSfalrtwList.RowType == RowType.Add || IsEdit && subAktivitasFormInputBLnSfalrtwList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                SFAL_KLObs.TooltipValue = "";

                // SFAL_KL15
                SFAL_KL15.HrefValue = "";
                SFAL_KL15.TooltipValue = "";

                // SFAL_Barrels
                SFAL_Barrels.HrefValue = "";
                SFAL_Barrels.TooltipValue = "";

                // SFAL_LT
                SFAL_LT.HrefValue = "";
                SFAL_LT.TooltipValue = "";

                // SFAL_MT
                SFAL_MT.HrefValue = "";
                SFAL_MT.TooltipValue = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasFormInputBLnSFALRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasFormInputBLnSFALRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasFormInputBLnSFALRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasFormInputBLnSFALRTWsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
