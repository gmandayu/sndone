...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiBLsesuaiCqlstsPymLpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpg subAktivitasFormInputNilaiBLsesuaiCqlstsPymLpg
    {
        get => HttpData.Resolve<SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpg>("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG");
        set => HttpData["SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG
    /// </summary>
    public class SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpg : DbTable
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG";
            Name = "SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            BL_MT = new(this, "x_BL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG", "BL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAL_MT = new(this, "x_SFAL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG", "SFAL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasFormInputNilaiBLsesuaiCQLSTSPymLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasFormInputNilaiBlsesuaiCqlstspymLpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgView" => Language.Phrase("View"),
                "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgView",
                Config.ApiAddAction => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgAdd",
                Config.ApiEditAction => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit",
                Config.ApiDeleteAction => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgDelete",
                Config.ApiListAction => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgView", parm);
            else
                url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgAdd?" + parm;
            else
                url = "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasFormInputNilaiBLsesuaiCqlstsPymLpgList";
