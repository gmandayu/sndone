...
public partial class SnDOne {
    /// <summary>
    /// penimbunanPenyaluranList
    /// </summary>
    public static PenimbunanPenyaluranList penimbunanPenyaluranList
    {
        get => HttpData.Get<PenimbunanPenyaluranList>("penimbunanPenyaluranList")!;
        set => HttpData["penimbunanPenyaluranList"] = value;
    }

    /// <summary>
    /// Page class for PenimbunanPenyaluran
    /// </summary>
    public class PenimbunanPenyaluranList : PenimbunanPenyaluranListBase
    {
        // Constructor
        public PenimbunanPenyaluranList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PenimbunanPenyaluranList() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class PenimbunanPenyaluranListBase : PenimbunanPenyaluran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "penimbunanPenyaluranList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fPenimbunanPenyaluranlist";
        ...
        // Constructor
        public PenimbunanPenyaluranListBase(Controller? controller)
        {
        ...
        if (controller != null)
            ...
            // Initialize URLs
            AddUrl = "PenimbunanPenyaluranAdd";
            ...
            MultiDeleteUrl = "PenimbunanPenyaluranDelete";
            MultiUpdateUrl = "PenimbunanPenyaluranUpdate";
        ...
        // Page name
        public string PageName => "PenimbunanPenyaluranList";
        ...
        public void SetVisibility()
        {
            ...
            NomorPenimbunanPenyaluran.Visible = false;
        ...
        // Constructor
        public PenimbunanPenyaluranListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void PrepareInitialSettings()
        {
            ...
            if (IsModal)
                FormName = "fPenimbunanPenyalurangrid";
        ...
        private void PageRunEnd()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                penimbunanPenyaluranList?.PageRender();
            }
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(IdModa.AdvancedSearch.ToJson())); // Field IdModa
            filters.Merge(JObject.Parse(LookupNoPenyaluran.AdvancedSearch.ToJson())); // Field LookupNoPenyaluran
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field IdModa
            if (filter.TryGetValue("x_IdModa", out sv)) {
                RestoreFieldFilter(IdModa, filter, "IdModa", sv);
            }

            // Field LookupNoPenyaluran
            if (filter.TryGetValue("x_LookupNoPenyaluran", out sv)) {
                RestoreFieldFilter(LookupNoPenyaluran, filter, "LookupNoPenyaluran", sv);
            }
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            BuildSearchSql(ref where, IdTangki, def, true); // IdTangki
            BuildSearchSql(ref where, StatusProses, def, true); // StatusProses
            BuildSearchSql(ref where, LookupNoPenyaluran, def, false); // LookupNoPenyaluran
            BuildSearchSql(ref where, NoPenyaluran, def, true); // NoPenyaluran
            ...
            if (!def && Command == "search") {
                IdModa.AdvancedSearch.Save(); // IdModa
                LookupNoPenyaluran.AdvancedSearch.Save(); // LookupNoPenyaluran
        ...
        private string BuildFieldFilters(FilterConfiguration config)
        {
            ...
            filterList += ProcessFieldFilter("IdTangki", IdTangki, true, config);
            filterList += ProcessFieldFilter("StatusProses", StatusProses, true, config);
            filterList += ProcessFieldFilter("NoPenyaluran", NoPenyaluran, true, config);
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(NomorPenimbunanPenyaluran);
            ...
            searchFlds.Add(IdTangki);
            searchFlds.Add(StatusProses);
            searchFlds.Add(NoPenyaluran);
        ...
        protected bool CheckSearchParms() {
            ...
            if (IdModa.AdvancedSearch.IssetSession)
                return true;
            if (IdTangki.AdvancedSearch.IssetSession)
                return true;
            if (StatusProses.AdvancedSearch.IssetSession)
                return true;
            if (LookupNoPenyaluran.AdvancedSearch.IssetSession)
                return true;
            if (NoPenyaluran.AdvancedSearch.IssetSession)
                return true;
        ...
        protected void ResetAdvancedSearchParms() {
            ...
            IdTangki.AdvancedSearch.UnsetSession();
            StatusProses.AdvancedSearch.UnsetSession();
            LookupNoPenyaluran.AdvancedSearch.UnsetSession();
            NoPenyaluran.AdvancedSearch.UnsetSession();
        ...
        protected void RestoreSearchParms() {
            ...
            IdTangki.AdvancedSearch.Load();
            StatusProses.AdvancedSearch.Load();
            LookupNoPenyaluran.AdvancedSearch.Load();
            NoPenyaluran.AdvancedSearch.Load();
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(IdTangki, ctrl); // IdTangki
                UpdateSort(StatusProses, ctrl); // StatusProses
                UpdateSort(NoPenyaluran, ctrl); // NoPenyaluran
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    IdPenimbunanPenyaluran.Sort = "";
                    NomorPenimbunanPenyaluran.Sort = "";
                    Proses2.Sort = "";
                    IdTemplate.Sort = "";
                    LookupPlant.Sort = "";
                    Plant.Sort = "";
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""PenimbunanPenyaluran"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""PenimbunanPenyaluran"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fPenimbunanPenyaluranlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fPenimbunanPenyaluranlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
            ...
            listOption?.SetBody("<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" + RowCount + "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" + HtmlEncode(IdPenimbunanPenyaluran.CurrentValue) + "\" data-ew-action=\"select-key\"></div>");
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""PenimbunanPenyaluran"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            item.Body = $@"<button type=""button"" class=""ew-action ew-multi-delete"" title=""{deleteTitle}"" data-caption=""{deleteTitle}"" form=""fPenimbunanPenyaluranlist""" +
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("IdTangki")); // DN
                CreateColumnOption(option.Add("StatusProses")); // DN
                CreateColumnOption(option.Add("NoPenyaluran")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fPenimbunanPenyaluransrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fPenimbunanPenyaluransrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fPenimbunanPenyaluranlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        private async Task<bool> HandleTemplateRow()
        {
            if ((IsGridAdd || IsGridEdit) && SameString(RowIndex, "$rowindex$")) { // Render template row first
                ...
                RowAttrs.Add("id", "r0_PenimbunanPenyaluran");
        ...
        private void SetupRowCountsAndAttributes()
        {
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(penimbunanPenyaluranList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(penimbunanPenyaluranList.RowCount) + "_PenimbunanPenyaluran");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(penimbunanPenyaluranList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && penimbunanPenyaluranList.RowType == RowType.Add || IsEdit && penimbunanPenyaluranList.RowType == RowType.Edit) // Inline-Add/Edit row
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void LoadFieldSearchValues()
        {
            ...
            LoadFieldIdTangkiSearchValues();
            LoadFieldStatusProsesSearchValues();
            LoadFieldLookupNoPenyaluranSearchValues();
            LoadFieldNoPenyaluranSearchValues();
        ...
        private void LoadFieldIdTangkiSearchValues()
        {
            // IdTangki
            LoadPrimarySearchValueIdTangki();
            LoadSearchOperatorIdTangki();
        }

        private void LoadPrimarySearchValueIdTangki()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_IdTangki[]")) {
                IdTangki.AdvancedSearch.SearchValue = Get("x_IdTangki[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                IdTangki.AdvancedSearch.SearchValue = Get("IdTangki"); // Default Value // DN
            }
            if (!Empty(IdTangki.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorIdTangki()
        {
            if (Query.ContainsKey("z_IdTangki"))
                IdTangki.AdvancedSearch.SearchOperator = Get("z_IdTangki", Config.FilterOptionSeparator);
        }
        ...
        private void LoadFieldLookupNoPenyaluranSearchValues()
        {
            // LookupNoPenyaluran
            LoadPrimarySearchValueLookupNoPenyaluran();
            LoadSearchOperatorLookupNoPenyaluran();
        }

        private void LoadPrimarySearchValueLookupNoPenyaluran()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_LookupNoPenyaluran")) {
                LookupNoPenyaluran.AdvancedSearch.SearchValue = Get("x_LookupNoPenyaluran");
            }
            else if (!IsAddOrEdit) {
                LookupNoPenyaluran.AdvancedSearch.SearchValue = Get("LookupNoPenyaluran"); // Default Value // DN
            }
            if (!Empty(LookupNoPenyaluran.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorLookupNoPenyaluran()
        {
            if (Query.ContainsKey("z_LookupNoPenyaluran"))
                LookupNoPenyaluran.AdvancedSearch.SearchOperator = Get("z_LookupNoPenyaluran");
        }

        private void LoadFieldNoPenyaluranSearchValues()
        {
            // NoPenyaluran
            LoadPrimarySearchValueNoPenyaluran();
            LoadSearchOperatorNoPenyaluran();
        }

        private void LoadPrimarySearchValueNoPenyaluran()
        {
            if (!IsAddOrEdit && Query.ContainsKey("x_NoPenyaluran[]")) {
                NoPenyaluran.AdvancedSearch.SearchValue = Get("x_NoPenyaluran[]", Config.FilterOptionSeparator);
            }
            else if (!IsAddOrEdit) {
                NoPenyaluran.AdvancedSearch.SearchValue = Get("NoPenyaluran"); // Default Value // DN
            }
            if (!Empty(NoPenyaluran.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
        }

        private void LoadSearchOperatorNoPenyaluran()
        {
            if (Query.ContainsKey("z_NoPenyaluran"))
                NoPenyaluran.AdvancedSearch.SearchOperator = Get("z_NoPenyaluran", Config.FilterOptionSeparator);
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // IdTangki
                if (IdTangki.UseFilter && !Empty(IdTangki.AdvancedSearch.SearchValue)) {
                    IdTangki.EditValue = ConvertToString(IdTangki.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }
                ...
                // NoPenyaluran
                if (NoPenyaluran.UseFilter && !Empty(NoPenyaluran.AdvancedSearch.SearchValue)) {
                    NoPenyaluran.EditValue = ConvertToString(NoPenyaluran.AdvancedSearch.SearchValue).Split(Config.FilterOptionSeparator).ToList();
                }
...
protected void SetupExportOptions() {
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fPenimbunanPenyaluransrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
            ...
            if (ModalSearch && !IsMobile())
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-table=\"PenimbunanPenyaluran\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-ew-action=\"modal\" data-url=\"" + AppPath("PenimbunanPenyaluranSearch") + "\" data-btn=\"SearchBtn\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            else
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" href=\"" + AppPath("PenimbunanPenyaluranSearch") + "\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            item.Visible = true;
