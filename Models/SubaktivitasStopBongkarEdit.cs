...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasStopBongkarEdit
    /// </summary>
    public static SubaktivitasStopBongkarEdit subaktivitasStopBongkarEdit
    {
        get => HttpData.Get<SubaktivitasStopBongkarEdit>("subaktivitasStopBongkarEdit")!;
        set => HttpData["subaktivitasStopBongkarEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasStopBongkar
    /// </summary>
    public class SubaktivitasStopBongkarEdit : SubaktivitasStopBongkarEditBase
    {
        // Constructor
        public SubaktivitasStopBongkarEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasStopBongkarEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasStopBongkarEditBase : SubaktivitasStopBongkar
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasStopBongkarEdit";
        ...
        // Constructor
        public SubaktivitasStopBongkarEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasStopBongkarEdit";
        ...
        // Constructor
        public SubaktivitasStopBongkarEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasStopBongkarList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasStopBongkarList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasStopBongkarList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasStopBongkarEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasStopBongkarList")), "", TableVar, true);
            string pageId = "edit";
