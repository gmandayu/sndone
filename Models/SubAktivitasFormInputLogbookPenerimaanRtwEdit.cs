...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbookPenerimaanRtwEdit
    /// </summary>
    public static SubAktivitasFormInputLogbookPenerimaanRtwEdit subAktivitasFormInputLogbookPenerimaanRtwEdit
    {
        get => HttpData.Get<SubAktivitasFormInputLogbookPenerimaanRtwEdit>("subAktivitasFormInputLogbookPenerimaanRtwEdit")!;
        set => HttpData["subAktivitasFormInputLogbookPenerimaanRtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbookPenerimaanRTW
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanRtwEdit : SubAktivitasFormInputLogbookPenerimaanRtwEditBase
    {
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanRtwEditBase : SubAktivitasFormInputLogbookPenerimaanRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbookPenerimaanRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbookPenerimaanRtwEdit";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanRtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputLogbookPenerimaanRtwList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputLogbookPenerimaanRtwList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputLogbookPenerimaanRtwList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputLogbookPenerimaanRtwEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'Level'
            Level.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(Level, "Level", "x_Level");
            ...
            // Standard handling for 'SubAktivitasFormInputHslPemeriksaanRTWId'
            SubAktivitasFormInputHslPemeriksaanRTWId.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(SubAktivitasFormInputHslPemeriksaanRTWId, "SubAktivitasFormInputHslPemeriksaanRTWId", "x_SubAktivitasFormInputHslPemeriksaanRTWId", true, validate, false);
        ...
        public void RestoreFormValues()
        {
            ...
            SubAktivitasFormInputHslPemeriksaanRTWId.CurrentValue = SubAktivitasFormInputHslPemeriksaanRTWId.FormValue;
        ...
        public async Task RenderRow()
        {
            ...
            SubAktivitasFormInputHslPemeriksaanRTWId.RowCssClass = "row";
        ...
        private void ValidateCustomid() {
            if (id.Visible && id.Required) {
                if (!id.IsDetailKey && Empty(id.FormValue)) {
                    id.AddErrorMessage(ConvertToString(IsQualityActive.RequiredErrorMessage).Replace("%s", IsQualityActive.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLevel() {
            if (Level.Visible && Level.Required) {
                if (!Level.IsDetailKey && Empty(Level.FormValue)) {
                    Level.AddErrorMessage(ConvertToString(IsQualityActive.RequiredErrorMessage).Replace("%s", IsQualityActive.Caption));
                }
            }
        }
        ...
        private void ValidateCustomVolume() {
            if (Volume.Visible && Volume.Required) {
                if (!Volume.IsDetailKey && Empty(Volume.FormValue)) {
                    Volume.AddErrorMessage(ConvertToString(IsQualityActive.RequiredErrorMessage).Replace("%s", IsQualityActive.Caption));
                }
            }
        }
        ...
        private void ValidateCustomFlowrate() {
            if (Flowrate.Visible && Flowrate.Required) {
                if (!Flowrate.IsDetailKey && Empty(Flowrate.FormValue)) {
                    Flowrate.AddErrorMessage(ConvertToString(IsQualityActive.RequiredErrorMessage).Replace("%s", IsQualityActive.Caption));
                }
            }
        }
        ...
        private void ValidateCustomSubAktivitasFormInputHslPemeriksaanRTWId() {
            if (SubAktivitasFormInputHslPemeriksaanRTWId.Visible && SubAktivitasFormInputHslPemeriksaanRTWId.Required) {
                if (!SubAktivitasFormInputHslPemeriksaanRTWId.IsDetailKey && Empty(SubAktivitasFormInputHslPemeriksaanRTWId.FormValue)) {
                    SubAktivitasFormInputHslPemeriksaanRTWId.AddErrorMessage(ConvertToString(IsQualityActive.RequiredErrorMessage).Replace("%s", IsQualityActive.Caption));
                }
            }
        }
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                ...
                ValidateCustomSubAktivitasFormInputHslPemeriksaanRTWId();
                if (!CheckInteger(SubAktivitasFormInputHslPemeriksaanRTWId.FormValue)) {
                    SubAktivitasFormInputHslPemeriksaanRTWId.AddErrorMessage(SubAktivitasFormInputHslPemeriksaanRTWId.GetErrorMessage(false));
                }
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // SubAktivitasFormInputHslPemeriksaanRTWId
            SubAktivitasFormInputHslPemeriksaanRTWId.SetDbValue(rsnew, SubAktivitasFormInputHslPemeriksaanRTWId.CurrentValue, SubAktivitasFormInputHslPemeriksaanRTWId.ReadOnly);
        ...
        protected void RestoreEditFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("SubAktivitasFormInputHslPemeriksaanRTWId", out value)) // SubAktivitasFormInputHslPemeriksaanRTWId
                SubAktivitasFormInputHslPemeriksaanRTWId.CurrentValue = value;
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputLogbookPenerimaanRtwList")), "", TableVar, true);
            string pageId = "edit";
