...
public partial class SnDOne {
    ...
    public class SubAktivitasSfadNewBlstsPnrBbmEditBase : SubAktivitasSfadNewBlstsPnrBbm
    {
        ...
        // Constructor
        public SubAktivitasSfadNewBlstsPnrBbmEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasSfadNewBlstsPnrBbmEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasSfadNewBlstsPnrBbmList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubAktivitasSfadNewBlstsPnrBbmList") {
                        ...
                        returnUrl = "SubAktivitasSfadNewBlstsPnrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
