...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiBlsfalPenyaluranLpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiBlsfalPenyaluranLpg subAktivitasNilaiBlsfalPenyaluranLpg
    {
        get => HttpData.Resolve<SubAktivitasNilaiBlsfalPenyaluranLpg>("SubAktivitasNilaiBLSFALPenyaluranLPG");
        set => HttpData["SubAktivitasNilaiBLSFALPenyaluranLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiBLSFALPenyaluranLPG
    /// </summary>
    public class SubAktivitasNilaiBlsfalPenyaluranLpg : DbTable
    {
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiBLSFALPenyaluranLPG";
            Name = "SubAktivitasNilaiBLSFALPenyaluranLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiBLSFALPenyaluranLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            BL_MT = new(this, "x_BL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranLPG", "BL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAL_MT = new(this, "x_SFAL_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranLPG", "SFAL_MT", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiBLSFALPenyaluranLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiBLSFALPenyaluranLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiBlsfalpenyaluranLpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiBlsfalPenyaluranLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiBlsfalPenyaluranLpgView" => Language.Phrase("View"),
                "SubAktivitasNilaiBlsfalPenyaluranLpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiBlsfalPenyaluranLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiBlsfalPenyaluranLpgView",
                Config.ApiAddAction => "SubAktivitasNilaiBlsfalPenyaluranLpgAdd",
                Config.ApiEditAction => "SubAktivitasNilaiBlsfalPenyaluranLpgEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiBlsfalPenyaluranLpgDelete",
                Config.ApiListAction => "SubAktivitasNilaiBlsfalPenyaluranLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiBlsfalPenyaluranLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiBlsfalPenyaluranLpgView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiBlsfalPenyaluranLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiBlsfalPenyaluranLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiBlsfalPenyaluranLpgAdd?" + parm;
            else
                url = "SubAktivitasNilaiBlsfalPenyaluranLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiBlsfalPenyaluranLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiBlsfalPenyaluranLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiBlsfalPenyaluranLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiBlsfalPenyaluranLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiBlsfalPenyaluranLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiBlsfalPenyaluranLpgList";
