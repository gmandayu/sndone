...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static Penimbunan penimbunan
    {
        get => HttpData.Resolve<Penimbunan>("Penimbunan");
        set => HttpData["Penimbunan"] = value;
    }

    /// <summary>
    /// Table class for Penimbunan
    /// </summary>
    public class Penimbunan : DbTable
    {
        public override Dictionary<string, string> KeyFields { get; set; } = new() { // DN
            { "IdPenimbunan", "IdPenimbunan" },
        };
        ...
        public readonly DbField<SqlDbType> NomorPenimbunan;
        ...
        public readonly DbField<SqlDbType> LookupPenerimaan;
        ...
        public Penimbunan()
        {
            ...
            Name = "Penimbunan";
            Type = "TABLE";
            UpdateTable = "dbo.Penimbunan"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdPenimbunan = new(this, "x_IdPenimbunan", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Penimbunan", "IdPenimbunan", "CustomMsg"),
                IsUpload = false
            };
            ...
            Proses2 = new(this, "x_Proses2", 202, SqlDbType.NVarChar) {
                Name = "Proses",
                Expression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorPenimbunan AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorPenimbunan AS NVARCHAR(50))+'</a>'",
                UseBasicSearch = true,
                BasicSearchExpression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorPenimbunan AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorPenimbunan AS NVARCHAR(50))+'</a>'",
                DateTimeFormat = -1,
                VirtualExpression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorPenimbunan AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorPenimbunan AS NVARCHAR(50))+'</a>'",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("Penimbunan", "Proses2", "CustomMsg"),
                IsUpload = false
            };
            Proses2.Lookup = new Lookup<DbField>(Proses2, "Penimbunan", true, "Proses", new List<string> {"Proses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Proses", Proses2);

            // NomorPenimbunan
            NomorPenimbunan = new(this, "x_NomorPenimbunan", 200, SqlDbType.VarChar) {
                Name = "NomorPenimbunan",
                Expression = "[NomorPenimbunan]",
                BasicSearchExpression = "[NomorPenimbunan]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorPenimbunan]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("Penimbunan", "NomorPenimbunan", "CustomMsg"),
                IsUpload = false
            };
            NomorPenimbunan.Lookup = new Lookup<DbField>(NomorPenimbunan, "Penimbunan", true, "NomorPenimbunan", new List<string> {"NomorPenimbunan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NomorPenimbunan", NomorPenimbunan);
            ...
            IdTemplate = new(this, "x_IdTemplate", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "IdTemplate", "CustomMsg"),
                IsUpload = false
            };
            IdTemplate.Raw = true;
            IdTemplate.GetDefault = () => 7;
            ...
            LookupPlant = new(this, "x_LookupPlant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Penimbunan", "LookupPlant", "CustomMsg"),
                IsUpload = false
            };
            LookupPlant.Raw = true;
            LookupPlant.Lookup = new Lookup<DbField>(LookupPlant, "Penimbunan", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Plant = new(this, "x_Plant", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "Plant", "CustomMsg"),
                IsUpload = false
            };
            Plant.Lookup = new Lookup<DbField>(Plant, "MasterPlant", true, "IdPlant", new List<string> {"Plant", "Nama_Terminal", "", ""}, "", "", new List<string> {}, new List<string> {"x_IdPenerimaan"}, new List<string> {}, new List<string> {}, new List<string> {"Plant", "JenisPlant"}, new List<string> {"x_PlantForLookup", "x_LookupJenisPlant"}, true, "", "", "CONCAT([Plant],'" + ValueSeparator(1, Plant) + "',[Nama_Terminal])");
            ...
            TipeProdukSTS = new(this, "x_TipeProdukSTS", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Penimbunan", "TipeProdukSTS", "CustomMsg"),
                IsUpload = false
            };
            TipeProdukSTS.Lookup = new Lookup<DbField>(TipeProdukSTS, "MasterProduk", true, "TipeProduk", new List<string> {"TipeProduk", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[TipeProduk]");
            Fields.Add("TipeProdukSTS", TipeProdukSTS);

            // LookupPenerimaan
            LookupPenerimaan = new(this, "x_LookupPenerimaan", 200, SqlDbType.VarChar) {
                Name = "LookupPenerimaan",
                Expression = "''",
                ...
                OptionCount = 1,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "LookupPenerimaan", "CustomMsg"),
                IsUpload = false
            };
            LookupPenerimaan.Lookup = new Lookup<DbField>(LookupPenerimaan, "Penimbunan", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("LookupPenerimaan", LookupPenerimaan);
            ...
            IdPenerimaan = new(this, "x_IdPenerimaan", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Penimbunan", "IdPenerimaan", "CustomMsg"),
                IsUpload = false
            };
            IdPenerimaan.Raw = true;
            IdPenerimaan.Lookup = new Lookup<DbField>(IdPenerimaan, "Penerimaan", true, "IdPenerimaan", new List<string> {"NomorPenerimaan", "", "", ""}, "", "", new List<string> {"x_Plant"}, new List<string> {}, new List<string> {"IdPlant"}, new List<string> {"x_IdPlant"}, new List<string> {"IdPlant"}, new List<string> {"x_Plant"}, false, "", "", "[NomorPenerimaan]");
            ...
            IdTangki = new(this, "x_IdTangki", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "IdTangki", "CustomMsg"),
                IsUpload = false
            };
            IdTangki.Raw = true;
            ...
            StatusProses = new(this, "x_StatusProses", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "StatusProses", "CustomMsg"),
                IsUpload = false
            };
            StatusProses.Lookup = new Lookup<DbField>(StatusProses, "Penimbunan", true, "StatusProses", new List<string> {"StatusProses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            PersentaseProgress = new(this, "x_PersentaseProgress", 131, SqlDbType.Decimal) {
                ...
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "PersentaseProgress", "CustomMsg"),
                IsUpload = false
            };
            PersentaseProgress.Raw = true;
            PersentaseProgress.Lookup = new Lookup<DbField>(PersentaseProgress, "Penimbunan", true, "PersentaseProgress", new List<string> {"PersentaseProgress", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Catatan = new(this, "x_Catatan", 201, SqlDbType.Text) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "Catatan", "CustomMsg"),
                IsUpload = false
            };
            Catatan.Lookup = new Lookup<DbField>(Catatan, "Penimbunan", true, "Catatan", new List<string> {"Catatan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            DibuatOleh.Lookup = new Lookup<DbField>(DibuatOleh, "Penimbunan", true, "DibuatOleh", new List<string> {"DibuatOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            TanggalDibuat.Raw = true;
            TanggalDibuat.Lookup = new Lookup<DbField>(TanggalDibuat, "Penimbunan", true, "TanggalDibuat", new List<string> {"TanggalDibuat", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            DiperbaruiOleh.Lookup = new Lookup<DbField>(DiperbaruiOleh, "Penimbunan", true, "DiperbaruiOleh", new List<string> {"DiperbaruiOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiperbarui.Raw = true;
            TanggalDiperbarui.Lookup = new Lookup<DbField>(TanggalDiperbarui, "Penimbunan", true, "TanggalDiperbarui", new List<string> {"TanggalDiperbarui", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            TanggalDiperbarui.GetAutoUpdateValue = () => CurrentDateTime();
            TanggalDiperbarui.GetDefault = () => "Waiting";
            ...
            PlantForLookup = new(this, "x_PlantForLookup", 200, SqlDbType.VarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "PlantForLookup", "CustomMsg"),
                IsUpload = false
            };
            ...
            LookupJenisPlant = new(this, "x_LookupJenisPlant", 200, SqlDbType.VarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("Penimbunan", "LookupJenisPlant", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get {
                string select = "*, '<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NomorPenimbunan AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorPenimbunan AS NVARCHAR(50))+'</a>' AS [Proses], '' AS [LookupPenerimaan], '' AS [PlantForLookup], '' AS [LookupJenisPlant]";
                if (select == "*") {
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.Penimbunan type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdPenimbunan"))
                    row["IdPenimbunan"] = lastInsertedId;
                else
                    row.Add("IdPenimbunan", lastInsertedId);
                IdPenimbunan.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                NomorPenimbunan.DbValue = row["NomorPenimbunan"]; // Set DB value only
                ...
                LookupPenerimaan.DbValue = row["LookupPenerimaan"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[IdPenimbunan] = @IdPenimbunan@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "PenimbunanView" => Language.Phrase("View"),
                "PenimbunanEdit" => Language.Phrase("Edit"),
                "PenimbunanAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "PenimbunanView",
                Config.ApiAddAction => "PenimbunanAdd",
                Config.ApiEditAction => "PenimbunanEdit",
                Config.ApiDeleteAction => "PenimbunanDelete",
                Config.ApiListAction => "PenimbunanList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "PenimbunanList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("PenimbunanView", parm);
            else
                url = KeyUrl("PenimbunanView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "PenimbunanAdd";
        ...
        {
            string url = "";
            url = KeyUrl("PenimbunanEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("PenimbunanList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("PenimbunanAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("PenimbunanList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("PenimbunanDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdPenimbunan\":" + ConvertToJson(IdPenimbunan.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdPenimbunan.CurrentValue)) {
                url += "/" + IdPenimbunan.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdPenimbunan", out object? v0)) { // IdPenimbunan // DN
                    key = UrlDecode(v0); // DN
                } else if (IsApi() && !Empty(keyValues)) {
                    key = keyValues[0];
                } else {
                    key = Param("IdPenimbunan");
                }
                keysList.Add(key);
            }
            // Check keys
            foreach (var keys in keysList) {
                if (KeyFields.Count > 1 && (!IsArray(keys) || keys.Length != KeyFields.Count))
                    continue;
                if (!IsNumeric(keys)) // IdPenimbunan
                    continue;
                result.Add(keys);
            }
            return result;
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdPenimbunan.CurrentValue = keys;
                else
                    IdPenimbunan.OldValue = keys;
        ...
        {
            string pageName = "PenimbunanList";
        ...
        public async Task RenderListRow()
        {
            ...
            // LookupPenerimaan
            LookupPenerimaan.CellCssStyle = "white-space: nowrap;";
            ...
            // NomorPenimbunan
            NomorPenimbunan.ViewValue = ConvertToString(NomorPenimbunan.CurrentValue); // DN
            NomorPenimbunan.ViewCustomAttributes = "";
            ...
            // NomorPenimbunan
            NomorPenimbunan.HrefValue = "";
            NomorPenimbunan.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // NomorPenimbunan
            NomorPenimbunan.SetupEditAttributes();
            NomorPenimbunan.EditValue = ConvertToString(NomorPenimbunan.CurrentValue); // DN
            NomorPenimbunan.ViewCustomAttributes = "";
            ...
            IdPenerimaan.EditValue = FormatNumber(IdPenerimaan.EditValue, IdPenerimaan.FormatPattern);
            IdPenerimaan.ViewCustomAttributes = "";
        ...
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            try {
                var idPenerimaan = rsnew["IdPenerimaan"].ToString();
                var idTangki     = rsnew["IdTangki"].ToString();
                var plant        = rsnew["PlantForLookup"].ToString();
                var idPlant      = rsnew["Plant"];

                // Generate NomorPenimbunan
                string sql = $"EXEC GenerateNomorReferensiPenimbunan {idPlant}, {idTangki}, 'PenimbunanPenerimaan'";
                var nomorReferensiObj = ExecuteScalar(sql);
                if (nomorReferensiObj == null)
                    throw new Exception("Gagal menghasilkan NomorPenimbunan.");
                string nomorPenimbunan = nomorReferensiObj.ToString();
                rsnew["NomorPenimbunan"] = nomorPenimbunan;
                rsnew["DibuatOleh"] = CurrentUserName();

                // Ambil waktu plant via GetPlantDateTime berdasarkan NomorPenimbunan
                DateTime plantTime = DateTime.Now; // fallback
                var plantObj = ExecuteScalar($"EXEC dbo.GetPlantDateTime @NomorReferensi = '{nomorPenimbunan}'");
                if (plantObj != null && DateTime.TryParse(plantObj.ToString(), out var pt))
                    plantTime = pt;

                // Set kolom tanggal dengan plant time
                rsnew["TanggalDibuat"]    = plantTime;
                rsnew["TanggalDiperbarui"] = plantTime;
                rsnew["DiperbaruiOleh"]   = CurrentUserName();
            } catch (Exception ex) {
                Log("Error in Row_Inserting (GenerateNomorReferensiPenimbunan): " + ex.Message);
        ...
        public void RowInserted(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew) {
            try {
                string nomorPenimbunan = rsnew["NomorPenimbunan"].ToString();
                string jenisProses = "Penimbunan";
                string dibuatOleh = CurrentUserName();
                int idPenerimaan = Convert.ToInt32(rsnew["IdPenerimaan"]);
                string sql = $"EXEC GenerateProsesAktivitas_Penimbunan '{nomorPenimbunan}', '{jenisProses}', '{dibuatOleh}', {idPenerimaan}";
                ExecuteScalar(sql);
                int modaTransportasi;
                bool isRefinery;
                string tipeProduk, noPenerimaan, jenisPlant;
                string sqlCheck = @"
                    SELECT 
                        p.ModaTransportasi,
                        p.NomorPenerimaan,
                        ...
                        mpl.JenisPlant
                    FROM Penerimaan p
                    JOIN MasterProduk mp ON p.KodeProduk = mp.NoProduk
                    JOIN MasterPlant mpl ON p.IdPlant = mpl.IdPlant
                    WHERE p.IdPenerimaan = @IdPenerimaan";
                using var sqlConnection = GetConnection("Db").OpenConnection();
                using (var cmd = new SqlCommand(sqlCheck, sqlConnection))
                {
                    ...
                    using (var rd = cmd.ExecuteReader())
                    {
                        if (!rd.Read())
                            return;
                        modaTransportasi = Convert.ToInt32(rd["ModaTransportasi"]);
                        noPenerimaan = rd["NomorPenerimaan"]?.ToString();
                        tipeProduk = rd["TipeProduk"]?.ToString();
                        jenisPlant = rd["JenisPlant"]?.ToString();
                        isRefinery = rd["Refinery"] == DBNull.Value ? false : Convert.ToBoolean(rd["Refinery"]);
                    }
                }
                if (modaTransportasi == 1 && tipeProduk == "BBM" && jenisPlant == "Non STS")
                {
                    GenerateLogbookPenerimaan(sqlConnection, noPenerimaan, "SubaktivitasNilaiAgreement", "SubaktivitasStartBongkar", "SubAktivitasLogbookPenerimaan", "34");
                } 
                else if (modaTransportasi == 2 && tipeProduk == "LPG" && jenisPlant == "Non STS")
                {
                    GenerateLogbookPenerimaan(sqlConnection, noPenerimaan, "SubAktivitasNilaiAgreementLPG", "SubAktivitasStartBongkarLPG", "SubAktivitasLogbookPenerimaanLPG", "148");
                }
                else if (modaTransportasi == 1 && tipeProduk == "BBM" && jenisPlant == "STS")
                {
                    GenerateLogbookPenerimaan(sqlConnection, noPenerimaan, "SubaktivitasNilaiAgreementSTSPnrBBM", "SubaktivitasStartBongkarSTSPnrBBM", "SubAktivitasLogbookPenerimaanSTSPymBBM", "209");
                }
                else if (modaTransportasi == 2 && tipeProduk == "LPG" && jenisPlant == "STS")
                {
                    GenerateLogbookPenerimaan(sqlConnection, noPenerimaan, "SubAktivitasNilaiAgreementSTSLPG", "SubAktivitasStartBongkarSTSLPG", "SubAktivitasLogbookPenerimaanSTSPymLPG", "250");
                }
                else if (isRefinery && modaTransportasi == 5)
                {
                    GenerateLogbookPenerimaan(sqlConnection, noPenerimaan, "SubAktivitasNilaiEstimasisFlowratePipa", "SubAktivitasDataStartPembongkaranPipa", "SubAktivitasFormInputLogbookPenerimaanPipa", "465");
                }
                else if (modaTransportasi == 3)
                {
                    GenerateLogbookPenerimaan(sqlConnection, noPenerimaan, "SubAktivitasFormInputFlowrate", "SubAktivitasFormInputDataStartPembongkaran", "SubAktivitasFormInputLogbookPenerimaanTruck", "432", "Tanggal");
                }
                else if (modaTransportasi == 4)
                {
                    GenerateLogbookPenerimaan(sqlConnection, noPenerimaan, "SubAktivitasFormInputFlowrateRTW", "SubAktivitasDataStartPembongkaranRTW", "SubAktivitasFormInputLogbookPenerimaanRTW", "394", "Tanggal");
                }
                else if (modaTransportasi == 5)
                {
                    GenerateLogbookPenerimaan(sqlConnection, noPenerimaan, "SubAktivitasNilaiEstimasisFlowratePipa", "SubAktivitasDataStartPembongkaranPipa", "SubAktivitasFormInputLogbookPenerimaanPipa", "325");
                }
                else if (modaTransportasi == 6)
                {
                    GenerateLogbookPenerimaan(sqlConnection, noPenerimaan, "SubAktivitasNilaiEstimasisFlowratePipa", "SubAktivitasDataStartPembongkaranPipa", "SubAktivitasFormInputLogbookPenerimaanPipa", "361");
                }
            } catch (Exception ex) {
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            try {
                // Ambil NomorPenimbunan dari data baru atau lama
                string nomorPenimbunan = rsnew.ContainsKey("NomorPenimbunan")
                    ? rsnew["NomorPenimbunan"].ToString()
                    : rsold["NomorPenimbunan"].ToString();
        ...
        public void RowRendering() {
            if (TipeProdukSTS.CurrentValue == null || string.IsNullOrEmpty(TipeProdukSTS.CurrentValue.ToString()))
            {
            ...
            if (IdPenerimaan.CurrentValue != null && !string.IsNullOrEmpty(IdPenerimaan.CurrentValue.ToString()))
            {
                using var sqlConnection = GetConnection("Db").OpenConnection();
                int idPenerimaan = Convert.ToInt32(IdPenerimaan.CurrentValue.ToString());
                string NoPenerimaan = "";
                using (var cmd = new SqlCommand(@"
                    SELECT 
                        NomorPenerimaan
                    ...
                    WHERE IdPenerimaan = @IdPenerimaan", sqlConnection))
                {
                    ...
                    {
                        if (rd.Read()) {
                            NoPenerimaan  = rd.IsDBNull(0) ? "" : rd.GetString(0);
                        }
                    }
                }
                IdPenerimaan.ViewValue = NoPenerimaan;
                IdPenerimaan.CurrentValue = NoPenerimaan;
            }
        }
