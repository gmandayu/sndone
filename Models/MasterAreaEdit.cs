...
public partial class SnDOne {
    ...
    public class MasterAreaEditBase : MasterArea
    {
        ...
        // Constructor
        public MasterAreaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("MasterAreaList"); // No matching record, return to list
                        }
                    break;
