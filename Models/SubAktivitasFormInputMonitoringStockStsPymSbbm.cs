...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputMonitoringStockStsPymSbbm
    /// </summary>
    [MaybeNull]
    public static SubAktivitasFormInputMonitoringStockStsPymSbbm subAktivitasFormInputMonitoringStockStsPymSbbm
    {
        get => HttpData.Resolve<SubAktivitasFormInputMonitoringStockStsPymSbbm>("SubAktivitasFormInputMonitoringStockSTSPymSBBM");
        set => HttpData["SubAktivitasFormInputMonitoringStockSTSPymSBBM"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasFormInputMonitoringStockSTSPymSBBM
    /// </summary>
    public class SubAktivitasFormInputMonitoringStockStsPymSbbm : DbTable
    {
        ...
        public readonly DbField<SqlDbType> QuantityAwal;

        public readonly DbField<SqlDbType> QuantityAkhir;
        ...
        public readonly DbField<SqlDbType> TanggalQuantityAwal;

        public readonly DbField<SqlDbType> TanggalQuantityAkhir;

        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSbbm()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasFormInputMonitoringStockSTSPymSBBM";
            Name = "SubAktivitasFormInputMonitoringStockSTSPymSBBM";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasFormInputMonitoringStockSTSPymSBBM"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomorTangki = new(this, "x_NomorTangki", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "NomorTangki", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "Produk", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Produk", Produk);

            // Aktivitas
            Aktivitas2 = new(this, "x_Aktivitas2", 202, SqlDbType.NVarChar) {
                Name = "Aktivitas",
                Expression = "[Aktivitas]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Aktivitas]",
                DateTimeFormat = -1,
                VirtualExpression = "[Aktivitas]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "Aktivitas2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Aktivitas", Aktivitas2);

            // QuantityAwal
            QuantityAwal = new(this, "x_QuantityAwal", 202, SqlDbType.NVarChar) {
                Name = "QuantityAwal",
                Expression = "[QuantityAwal]",
                UseBasicSearch = true,
                BasicSearchExpression = "[QuantityAwal]",
                DateTimeFormat = -1,
                VirtualExpression = "[QuantityAwal]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "QuantityAwal", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("QuantityAwal", QuantityAwal);

            // QuantityAkhir
            QuantityAkhir = new(this, "x_QuantityAkhir", 202, SqlDbType.NVarChar) {
                Name = "QuantityAkhir",
                Expression = "[QuantityAkhir]",
                UseBasicSearch = true,
                BasicSearchExpression = "[QuantityAkhir]",
                DateTimeFormat = -1,
                VirtualExpression = "[QuantityAkhir]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "QuantityAkhir", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("QuantityAkhir", QuantityAkhir);
            ...
            Flowrate = new(this, "x_Flowrate", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "Flowrate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Keterangan = new(this, "x_Keterangan", 203, SqlDbType.NText) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            // TanggalQuantityAwal
            TanggalQuantityAwal = new(this, "x_TanggalQuantityAwal", 135, SqlDbType.DateTime) {
                Name = "TanggalQuantityAwal",
                Expression = "[TanggalQuantityAwal]",
                BasicSearchExpression = CastDateFieldForLike("[TanggalQuantityAwal]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[TanggalQuantityAwal]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "TanggalQuantityAwal", "CustomMsg"),
                IsUpload = false
            };
            TanggalQuantityAwal.Raw = true;
            Fields.Add("TanggalQuantityAwal", TanggalQuantityAwal);

            // TanggalQuantityAkhir
            TanggalQuantityAkhir = new(this, "x_TanggalQuantityAkhir", 135, SqlDbType.DateTime) {
                Name = "TanggalQuantityAkhir",
                Expression = "[TanggalQuantityAkhir]",
                BasicSearchExpression = CastDateFieldForLike("[TanggalQuantityAkhir]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[TanggalQuantityAkhir]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasFormInputMonitoringStockSTSPymSBBM", "TanggalQuantityAkhir", "CustomMsg"),
                IsUpload = false
            };
            TanggalQuantityAkhir.Raw = true;
            Fields.Add("TanggalQuantityAkhir", TanggalQuantityAkhir);
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasFormInputMonitoringStockSTSPymSBBM";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasFormInputMonitoringStockStspymSbbm type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                QuantityAwal.DbValue = row["QuantityAwal"]; // Set DB value only
                QuantityAkhir.DbValue = row["QuantityAkhir"]; // Set DB value only
                ...
                TanggalQuantityAwal.DbValue = row["TanggalQuantityAwal"]; // Set DB value only
                TanggalQuantityAkhir.DbValue = row["TanggalQuantityAkhir"]; // Set DB value only
            } catch {}
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasFormInputMonitoringStockStsPymSbbmList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasFormInputMonitoringStockStsPymSbbmView" => Language.Phrase("View"),
                "SubAktivitasFormInputMonitoringStockStsPymSbbmEdit" => Language.Phrase("Edit"),
                "SubAktivitasFormInputMonitoringStockStsPymSbbmAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasFormInputMonitoringStockStsPymSbbmView",
                Config.ApiAddAction => "SubAktivitasFormInputMonitoringStockStsPymSbbmAdd",
                Config.ApiEditAction => "SubAktivitasFormInputMonitoringStockStsPymSbbmEdit",
                Config.ApiDeleteAction => "SubAktivitasFormInputMonitoringStockStsPymSbbmDelete",
                Config.ApiListAction => "SubAktivitasFormInputMonitoringStockStsPymSbbmList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasFormInputMonitoringStockStsPymSbbmList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasFormInputMonitoringStockStsPymSbbmView", parm);
            else
                url = KeyUrl("SubAktivitasFormInputMonitoringStockStsPymSbbmView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasFormInputMonitoringStockStsPymSbbmAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasFormInputMonitoringStockStsPymSbbmAdd?" + parm;
            else
                url = "SubAktivitasFormInputMonitoringStockStsPymSbbmAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputMonitoringStockStsPymSbbmEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputMonitoringStockStsPymSbbmList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasFormInputMonitoringStockStsPymSbbmAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasFormInputMonitoringStockStsPymSbbmList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasFormInputMonitoringStockStsPymSbbmDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasFormInputMonitoringStockStsPymSbbmList";
        ...
        public async Task RenderEditRow()
        {
            ...
            Aktivitas2.EditValue = Aktivitas2.CurrentValue;
            ...
            QuantityAwal.EditValue = QuantityAwal.CurrentValue;
            ...
            QuantityAkhir.EditValue = QuantityAkhir.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(QuantityAwal);
                        doc.ExportCaption(QuantityAkhir);
                        ...
                        doc.ExportCaption(TanggalQuantityAwal);
                        doc.ExportCaption(TanggalQuantityAkhir);
                    } else {
                        doc.ExportCaption(id);
                        doc.ExportCaption(idProses);
                        doc.ExportCaption(idAktifitas);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(QuantityAwal);
                            await doc.ExportField(QuantityAkhir);
                            ...
                            await doc.ExportField(TanggalQuantityAwal);
                            await doc.ExportField(TanggalQuantityAkhir);
                        } else {
                            await doc.ExportField(id);
                            await doc.ExportField(idProses);
                            await doc.ExportField(idAktifitas);
