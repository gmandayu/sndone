...
public partial class SnDOne {
    ...
    public class MasterDermagaViewBase : MasterDermaga
    {
        ...
        // Constructor
        public MasterDermagaViewBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterDermagaViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdDermaga", out v) && !Empty(v))
                {
                IdDermaga.QueryValue = UrlDecode(v);
                RecordKeys["IdDermaga"] = IdDermaga.QueryValue;
                return;
                }
                if (Get("IdDermaga", out sv))
                {
