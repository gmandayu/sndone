...
public partial class SnDOne {
    ...
    public class SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEditBase : SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbm
    {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEditBase()
        {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmList") {
                                ...
                                returnUrl = "SubAktivitasHasilPemeriksaanPenyaluranStsPyrBbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
