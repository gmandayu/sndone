...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasHasilPemeriksaanPipa
    /// </summary>
    [MaybeNull]
    public static SubAktivitasHasilPemeriksaanPipa subAktivitasHasilPemeriksaanPipa
    {
        get => HttpData.Resolve<SubAktivitasHasilPemeriksaanPipa>("SubAktivitasHasilPemeriksaanPipa");
        set => HttpData["SubAktivitasHasilPemeriksaanPipa"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasHasilPemeriksaanPipa
    /// </summary>
    public class SubAktivitasHasilPemeriksaanPipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> NoBatch;

        public readonly DbField<SqlDbType> Tanggal;

        public readonly DbField<SqlDbType> Nama_Kegiatan;
        ...
        public readonly DbField<SqlDbType> Pressure;

        public readonly DbField<SqlDbType> VolumeDischarge;
        ...
        public readonly DbField<SqlDbType> TotalTerima;
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasHasilPemeriksaanPipa";
            Name = "SubAktivitasHasilPemeriksaanPipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasHasilPemeriksaanPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NoReferensi", NoReferensi);

            // NoBatch
            NoBatch = new(this, "x_NoBatch", 202, SqlDbType.NVarChar) {
                Name = "NoBatch",
                Expression = "[NoBatch]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NoBatch]",
                DateTimeFormat = -1,
                VirtualExpression = "[NoBatch]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "NoBatch", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NoBatch", NoBatch);
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            ...
            // Nama_Kegiatan
            Nama_Kegiatan = new(this, "x_Nama_Kegiatan", 202, SqlDbType.NVarChar) {
                Name = "Nama_Kegiatan",
                Expression = "[Nama_Kegiatan]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Nama_Kegiatan]",
                DateTimeFormat = -1,
                VirtualExpression = "[Nama_Kegiatan]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "Nama_Kegiatan", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Nama_Kegiatan", Nama_Kegiatan);
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            Density = new(this, "x_Density", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "Density", "CustomMsg"),
                IsUpload = false
            };
            ...
            Temperature = new(this, "x_Temperature", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "Temperature", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Temperature", Temperature);

            // Pressure
            Pressure = new(this, "x_Pressure", 202, SqlDbType.NVarChar) {
                Name = "Pressure",
                Expression = "[Pressure]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Pressure]",
                DateTimeFormat = -1,
                VirtualExpression = "[Pressure]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "Pressure", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Pressure", Pressure);

            // VolumeDischarge
            VolumeDischarge = new(this, "x_VolumeDischarge", 202, SqlDbType.NVarChar) {
                Name = "VolumeDischarge",
                Expression = "[VolumeDischarge]",
                UseBasicSearch = true,
                BasicSearchExpression = "[VolumeDischarge]",
                DateTimeFormat = -1,
                VirtualExpression = "[VolumeDischarge]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "VolumeDischarge", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("VolumeDischarge", VolumeDischarge);
            ...
            Flowrate = new(this, "x_Flowrate", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "Flowrate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Keterangan = new(this, "x_Keterangan", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            SubAktivitasHasilPemeriksaanId = new(this, "x_SubAktivitasHasilPemeriksaanId", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "SubAktivitasHasilPemeriksaanId", "CustomMsg"),
                IsUpload = false
            };
            ...
            // TotalTerima
            TotalTerima = new(this, "x_TotalTerima", 202, SqlDbType.NVarChar) {
                Name = "TotalTerima",
                Expression = "[TotalTerima]",
                UseBasicSearch = true,
                BasicSearchExpression = "[TotalTerima]",
                DateTimeFormat = -1,
                VirtualExpression = "[TotalTerima]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "TotalTerima", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("TotalTerima", TotalTerima);

            // ETC
            ETC = new(this, "x_ETC", 135, SqlDbType.DateTime) {
                Name = "ETC",
                Expression = "[ETC]",
                BasicSearchExpression = CastDateFieldForLike("[ETC]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "ETC", "CustomMsg"),
                IsUpload = false
            };
            ETC.Raw = true;
            Fields.Add("ETC", ETC);
            ...
            ETA = new(this, "x_ETA", 135, SqlDbType.DateTime) {
                Name = "ETA",
                Expression = "[ETA]",
                BasicSearchExpression = CastDateFieldForLike("[ETA]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "ETA", "CustomMsg"),
                IsUpload = false
            };
            ETA.Raw = true;
            Fields.Add("ETA", ETA);
            ...
            ETA2 = new(this, "x_ETA2", 135, SqlDbType.DateTime) {
                Name = "ETA2",
                Expression = "[ETA2]",
                BasicSearchExpression = CastDateFieldForLike("[ETA2]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "ETA2", "CustomMsg"),
                IsUpload = false
            };
            ETA2.Raw = true;
            ...
            ETA3 = new(this, "x_ETA3", 135, SqlDbType.DateTime) {
                Name = "ETA3",
                Expression = "[ETA3]",
                BasicSearchExpression = CastDateFieldForLike("[ETA3]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasHasilPemeriksaanPipa", "ETA3", "CustomMsg"),
                IsUpload = false
            };
            ETA3.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasHasilPemeriksaanPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasHasilPemeriksaanPipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                NoBatch.DbValue = row["NoBatch"]; // Set DB value only
                Tanggal.DbValue = row["Tanggal"]; // Set DB value only
                Nama_Kegiatan.DbValue = row["Nama_Kegiatan"]; // Set DB value only
                ...
                Pressure.DbValue = row["Pressure"]; // Set DB value only
                VolumeDischarge.DbValue = row["VolumeDischarge"]; // Set DB value only
                ...
                TotalTerima.DbValue = row["TotalTerima"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasHasilPemeriksaanPipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasHasilPemeriksaanPipaView" => Language.Phrase("View"),
                "SubAktivitasHasilPemeriksaanPipaEdit" => Language.Phrase("Edit"),
                "SubAktivitasHasilPemeriksaanPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasHasilPemeriksaanPipaView",
                Config.ApiAddAction => "SubAktivitasHasilPemeriksaanPipaAdd",
                Config.ApiEditAction => "SubAktivitasHasilPemeriksaanPipaEdit",
                Config.ApiDeleteAction => "SubAktivitasHasilPemeriksaanPipaDelete",
                Config.ApiListAction => "SubAktivitasHasilPemeriksaanPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasHasilPemeriksaanPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasHasilPemeriksaanPipaView", parm);
            else
                url = KeyUrl("SubAktivitasHasilPemeriksaanPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasHasilPemeriksaanPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasHasilPemeriksaanPipaAdd?" + parm;
            else
                url = "SubAktivitasHasilPemeriksaanPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasHasilPemeriksaanPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasHasilPemeriksaanPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasHasilPemeriksaanPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasHasilPemeriksaanPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasHasilPemeriksaanPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasHasilPemeriksaanPipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            NoBatch.EditValue = NoBatch.CurrentValue;
            ...
            Nama_Kegiatan.EditValue = Nama_Kegiatan.CurrentValue;
            ...
            Pressure.EditValue = Pressure.CurrentValue;
            ...
            VolumeDischarge.EditValue = VolumeDischarge.CurrentValue;
            ...
            TotalTerima.EditValue = TotalTerima.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(NoBatch);
                        doc.ExportCaption(Tanggal);
                        doc.ExportCaption(Nama_Kegiatan);
                        doc.ExportCaption(Produk);
                        doc.ExportCaption(Density);
                        doc.ExportCaption(Temperature);
                        doc.ExportCaption(Pressure);
                        doc.ExportCaption(VolumeDischarge);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(NoBatch);
                            await doc.ExportField(Tanggal);
                            await doc.ExportField(Nama_Kegiatan);
                            await doc.ExportField(Produk);
                            await doc.ExportField(Density);
                            await doc.ExportField(Temperature);
                            await doc.ExportField(Pressure);
                            await doc.ExportField(VolumeDischarge);
                            ...
                            await doc.ExportField(TotalTerima);
