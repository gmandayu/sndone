...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiEtcetaPipaList
    /// </summary>
    public static SubAktivitasNilaiEtcetaPipaList subAktivitasNilaiEtcetaPipaList
    {
        get => HttpData.Get<SubAktivitasNilaiEtcetaPipaList>("subAktivitasNilaiEtcetaPipaList")!;
        set => HttpData["subAktivitasNilaiEtcetaPipaList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiETCETAPipa
    /// </summary>
    public class SubAktivitasNilaiEtcetaPipaList : SubAktivitasNilaiEtcetaPipaListBase
    {
        // Constructor
        public SubAktivitasNilaiEtcetaPipaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiEtcetaPipaList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiEtcetaPipaListBase : SubAktivitasNilaiEtcetaPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiEtcetaPipaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasNilaiETCETAPipalist";
        ...
        // Constructor
        public SubAktivitasNilaiEtcetaPipaListBase()
        {
            TableName = "SubAktivitasNilaiETCETAPipa";

            // CSS class name as context
            TableVar = "SubAktivitasNilaiETCETAPipa";
            ...
            // Table object (subAktivitasNilaiEtcetaPipa)
            if (subAktivitasNilaiEtcetaPipa == null || subAktivitasNilaiEtcetaPipa is SubAktivitasNilaiEtcetaPipa)
                subAktivitasNilaiEtcetaPipa = this;

            // Initialize URLs
            AddUrl = "SubAktivitasNilaiEtcetaPipaAdd";
            ...
            MultiDeleteUrl = "SubAktivitasNilaiEtcetaPipaDelete";
            MultiUpdateUrl = "SubAktivitasNilaiEtcetaPipaUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiEtcetaPipaList";
        ...
        public void SetVisibility()
        {
            ...
            IsiPipa.SetVisibility();
            IsiPipa2.SetVisibility();
            IsiPipa3.SetVisibility();
            Flowrate.SetVisibility();
            LamaPengisian.SetVisibility();
            LamaPengiriman.SetVisibility();
            LamaPengiriman2.SetVisibility();
            LamaPengiriman3.SetVisibility();
            ETC.SetVisibility();
            ETA.SetVisibility();
            ETA2.SetVisibility();
            ETA3.SetVisibility();
        ...
        // Constructor
        public SubAktivitasNilaiEtcetaPipaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasNilaiEtcetaPipaView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasNilaiETCETAPipagrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiEtcetaPipaList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(IsiPipa.AdvancedSearch.ToJson())); // Field IsiPipa
            filters.Merge(JObject.Parse(IsiPipa2.AdvancedSearch.ToJson())); // Field IsiPipa2
            filters.Merge(JObject.Parse(IsiPipa3.AdvancedSearch.ToJson())); // Field IsiPipa3
            filters.Merge(JObject.Parse(Flowrate.AdvancedSearch.ToJson())); // Field Flowrate
            filters.Merge(JObject.Parse(LamaPengisian.AdvancedSearch.ToJson())); // Field LamaPengisian
            filters.Merge(JObject.Parse(LamaPengiriman.AdvancedSearch.ToJson())); // Field LamaPengiriman
            filters.Merge(JObject.Parse(LamaPengiriman2.AdvancedSearch.ToJson())); // Field LamaPengiriman2
            filters.Merge(JObject.Parse(LamaPengiriman3.AdvancedSearch.ToJson())); // Field LamaPengiriman3
        ...
        protected bool RestoreFilterList() {
            ...
            // Field IsiPipa
            if (filter?.TryGetValue("x_IsiPipa", out sv) ?? false) {
                IsiPipa.AdvancedSearch.SearchValue = sv;
                IsiPipa.AdvancedSearch.SearchOperator = filter["z_IsiPipa"];
                IsiPipa.AdvancedSearch.SearchCondition = filter["v_IsiPipa"];
                IsiPipa.AdvancedSearch.SearchValue2 = filter["y_IsiPipa"];
                IsiPipa.AdvancedSearch.SearchOperator2 = filter["w_IsiPipa"];
                IsiPipa.AdvancedSearch.Save();
            }

            // Field IsiPipa2
            if (filter?.TryGetValue("x_IsiPipa2", out sv) ?? false) {
                IsiPipa2.AdvancedSearch.SearchValue = sv;
                IsiPipa2.AdvancedSearch.SearchOperator = filter["z_IsiPipa2"];
                IsiPipa2.AdvancedSearch.SearchCondition = filter["v_IsiPipa2"];
                IsiPipa2.AdvancedSearch.SearchValue2 = filter["y_IsiPipa2"];
                IsiPipa2.AdvancedSearch.SearchOperator2 = filter["w_IsiPipa2"];
                IsiPipa2.AdvancedSearch.Save();
            }

            // Field IsiPipa3
            if (filter?.TryGetValue("x_IsiPipa3", out sv) ?? false) {
                IsiPipa3.AdvancedSearch.SearchValue = sv;
                IsiPipa3.AdvancedSearch.SearchOperator = filter["z_IsiPipa3"];
                IsiPipa3.AdvancedSearch.SearchCondition = filter["v_IsiPipa3"];
                IsiPipa3.AdvancedSearch.SearchValue2 = filter["y_IsiPipa3"];
                IsiPipa3.AdvancedSearch.SearchOperator2 = filter["w_IsiPipa3"];
                IsiPipa3.AdvancedSearch.Save();
            }
            ...
            // Field LamaPengisian
            if (filter?.TryGetValue("x_LamaPengisian", out sv) ?? false) {
                LamaPengisian.AdvancedSearch.SearchValue = sv;
                LamaPengisian.AdvancedSearch.SearchOperator = filter["z_LamaPengisian"];
                LamaPengisian.AdvancedSearch.SearchCondition = filter["v_LamaPengisian"];
                LamaPengisian.AdvancedSearch.SearchValue2 = filter["y_LamaPengisian"];
                LamaPengisian.AdvancedSearch.SearchOperator2 = filter["w_LamaPengisian"];
                LamaPengisian.AdvancedSearch.Save();
            }

            // Field LamaPengiriman
            if (filter?.TryGetValue("x_LamaPengiriman", out sv) ?? false) {
                LamaPengiriman.AdvancedSearch.SearchValue = sv;
                LamaPengiriman.AdvancedSearch.SearchOperator = filter["z_LamaPengiriman"];
                LamaPengiriman.AdvancedSearch.SearchCondition = filter["v_LamaPengiriman"];
                LamaPengiriman.AdvancedSearch.SearchValue2 = filter["y_LamaPengiriman"];
                LamaPengiriman.AdvancedSearch.SearchOperator2 = filter["w_LamaPengiriman"];
                LamaPengiriman.AdvancedSearch.Save();
            }

            // Field LamaPengiriman2
            if (filter?.TryGetValue("x_LamaPengiriman2", out sv) ?? false) {
                LamaPengiriman2.AdvancedSearch.SearchValue = sv;
                LamaPengiriman2.AdvancedSearch.SearchOperator = filter["z_LamaPengiriman2"];
                LamaPengiriman2.AdvancedSearch.SearchCondition = filter["v_LamaPengiriman2"];
                LamaPengiriman2.AdvancedSearch.SearchValue2 = filter["y_LamaPengiriman2"];
                LamaPengiriman2.AdvancedSearch.SearchOperator2 = filter["w_LamaPengiriman2"];
                LamaPengiriman2.AdvancedSearch.Save();
            }

            // Field LamaPengiriman3
            if (filter?.TryGetValue("x_LamaPengiriman3", out sv) ?? false) {
                LamaPengiriman3.AdvancedSearch.SearchValue = sv;
                LamaPengiriman3.AdvancedSearch.SearchOperator = filter["z_LamaPengiriman3"];
                LamaPengiriman3.AdvancedSearch.SearchCondition = filter["v_LamaPengiriman3"];
                LamaPengiriman3.AdvancedSearch.SearchValue2 = filter["y_LamaPengiriman3"];
                LamaPengiriman3.AdvancedSearch.SearchOperator2 = filter["w_LamaPengiriman3"];
                LamaPengiriman3.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(IsiPipa);
            searchFlds.Add(IsiPipa2);
            searchFlds.Add(IsiPipa3);
            searchFlds.Add(Flowrate);
            searchFlds.Add(LamaPengisian);
            searchFlds.Add(LamaPengiriman);
            searchFlds.Add(LamaPengiriman2);
            searchFlds.Add(LamaPengiriman3);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(IsiPipa, ctrl); // IsiPipa
                UpdateSort(IsiPipa2, ctrl); // IsiPipa2
                UpdateSort(IsiPipa3, ctrl); // IsiPipa3
                UpdateSort(Flowrate, ctrl); // Flowrate
                UpdateSort(LamaPengisian, ctrl); // LamaPengisian
                UpdateSort(LamaPengiriman, ctrl); // LamaPengiriman
                UpdateSort(LamaPengiriman2, ctrl); // LamaPengiriman2
                UpdateSort(LamaPengiriman3, ctrl); // LamaPengiriman3
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    LamaPengisian.Sort = "";
                    LamaPengiriman.Sort = "";
                    LamaPengiriman2.Sort = "";
                    LamaPengiriman3.Sort = "";
                    ETC.Sort = "";
                    ETA.Sort = "";
                    ETA2.Sort = "";
                    ETA3.Sort = "";
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasNilaiETCETAPipa"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasNilaiETCETAPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasNilaiETCETAPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("IsiPipa")); // DN
                CreateColumnOption(option.Add("IsiPipa2")); // DN
                CreateColumnOption(option.Add("IsiPipa3")); // DN
                CreateColumnOption(option.Add("Flowrate")); // DN
                CreateColumnOption(option.Add("LamaPengisian")); // DN
                CreateColumnOption(option.Add("LamaPengiriman")); // DN
                CreateColumnOption(option.Add("LamaPengiriman2")); // DN
                CreateColumnOption(option.Add("LamaPengiriman3")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasNilaiETCETAPipasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasNilaiETCETAPipasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasNilaiETCETAPipalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasNilaiETCETAPipa");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasNilaiEtcetaPipaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasNilaiEtcetaPipaList.RowCount) + "_SubAktivitasNilaiETCETAPipa");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasNilaiEtcetaPipaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasNilaiEtcetaPipaList.RowType == RowType.Add || IsEdit && subAktivitasNilaiEtcetaPipaList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            IsiPipa.SetDbValue(row["IsiPipa"]);
            IsiPipa2.SetDbValue(row["IsiPipa2"]);
            IsiPipa3.SetDbValue(row["IsiPipa3"]);
            Flowrate.SetDbValue(row["Flowrate"]);
            LamaPengisian.SetDbValue(row["LamaPengisian"]);
            LamaPengiriman.SetDbValue(row["LamaPengiriman"]);
            LamaPengiriman2.SetDbValue(row["LamaPengiriman2"]);
            LamaPengiriman3.SetDbValue(row["LamaPengiriman3"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("IsiPipa", IsiPipa.DefaultValue ?? DbNullValue); // DN
            row.Add("IsiPipa2", IsiPipa2.DefaultValue ?? DbNullValue); // DN
            row.Add("IsiPipa3", IsiPipa3.DefaultValue ?? DbNullValue); // DN
            row.Add("Flowrate", Flowrate.DefaultValue ?? DbNullValue); // DN
            row.Add("LamaPengisian", LamaPengisian.DefaultValue ?? DbNullValue); // DN
            row.Add("LamaPengiriman", LamaPengiriman.DefaultValue ?? DbNullValue); // DN
            row.Add("LamaPengiriman2", LamaPengiriman2.DefaultValue ?? DbNullValue); // DN
            row.Add("LamaPengiriman3", LamaPengiriman3.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // IsiPipa
                IsiPipa.ViewValue = ConvertToString(IsiPipa.CurrentValue); // DN
                IsiPipa.ViewCustomAttributes = "";

                // IsiPipa2
                IsiPipa2.ViewValue = ConvertToString(IsiPipa2.CurrentValue); // DN
                IsiPipa2.ViewCustomAttributes = "";

                // IsiPipa3
                IsiPipa3.ViewValue = ConvertToString(IsiPipa3.CurrentValue); // DN
                IsiPipa3.ViewCustomAttributes = "";
                ...
                // LamaPengisian
                LamaPengisian.ViewValue = ConvertToString(LamaPengisian.CurrentValue); // DN
                LamaPengisian.ViewCustomAttributes = "";

                // LamaPengiriman
                LamaPengiriman.ViewValue = ConvertToString(LamaPengiriman.CurrentValue); // DN
                LamaPengiriman.ViewCustomAttributes = "";

                // LamaPengiriman2
                LamaPengiriman2.ViewValue = ConvertToString(LamaPengiriman2.CurrentValue); // DN
                LamaPengiriman2.ViewCustomAttributes = "";

                // LamaPengiriman3
                LamaPengiriman3.ViewValue = ConvertToString(LamaPengiriman3.CurrentValue); // DN
                LamaPengiriman3.ViewCustomAttributes = "";
                ...
                // IsiPipa
                IsiPipa.HrefValue = "";
                IsiPipa.TooltipValue = "";

                // IsiPipa2
                IsiPipa2.HrefValue = "";
                IsiPipa2.TooltipValue = "";

                // IsiPipa3
                IsiPipa3.HrefValue = "";
                IsiPipa3.TooltipValue = "";
                ...
                // LamaPengisian
                LamaPengisian.HrefValue = "";
                LamaPengisian.TooltipValue = "";

                // LamaPengiriman
                LamaPengiriman.HrefValue = "";
                LamaPengiriman.TooltipValue = "";

                // LamaPengiriman2
                LamaPengiriman2.HrefValue = "";
                LamaPengiriman2.TooltipValue = "";

                // LamaPengiriman3
                LamaPengiriman3.HrefValue = "";
                LamaPengiriman3.TooltipValue = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasNilaiETCETAPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasNilaiETCETAPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasNilaiETCETAPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
