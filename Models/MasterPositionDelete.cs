...
public partial class SnDOne {
    /// <summary>
    /// masterPositionDelete
    /// </summary>
    public static MasterPositionDelete masterPositionDelete
    {
        get => HttpData.Get<MasterPositionDelete>("masterPositionDelete")!;
        set => HttpData["masterPositionDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterPosition
    /// </summary>
    public class MasterPositionDelete : MasterPositionDeleteBase
    {
        // Constructor
        public MasterPositionDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterPositionDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterPositionDeleteBase : MasterPosition
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterPositionDelete";
        ...
        // Constructor
        public MasterPositionDeleteBase()
        {
        ...
        // Page name
        public string PageName => "MasterPositionDelete";
        ...
        // Constructor
        public MasterPositionDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterPositionList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterPositionList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                masterPositionDelete?.PageRender();
            }
            return PageResult();
        }
