...
public partial class SnDOne {
    ...
    public class SubAktivitasTotalRencanaPenyaluranEditBase : SubAktivitasTotalRencanaPenyaluran
    {
        ...
        // Constructor
        public SubAktivitasTotalRencanaPenyaluranEditBase()
        {
        ...
        // Constructor
        public SubAktivitasTotalRencanaPenyaluranEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasTotalRencanaPenyaluranList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasTotalRencanaPenyaluranList") {
                                ...
                                returnUrl = "SubAktivitasTotalRencanaPenyaluranList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'RencanaPenyaluranKL' before field var 'x_RencanaPenyaluranKL'
            val = CurrentForm.HasValue("RencanaPenyaluranKL") ? CurrentForm.GetValue("RencanaPenyaluranKL") : CurrentForm.GetValue("x_RencanaPenyaluranKL");
            if (!RencanaPenyaluranKL.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("RencanaPenyaluranKL") && !CurrentForm.HasValue("x_RencanaPenyaluranKL")) // DN
                    RencanaPenyaluranKL.Visible = false; // Disable update for API request
                else
                    RencanaPenyaluranKL.SetFormValue(val);
            }
            ...
            bool validateForm = true;
                ...
                if (RencanaPenyaluranKL.Visible && RencanaPenyaluranKL.Required) {
                    if (!RencanaPenyaluranKL.IsDetailKey && Empty(RencanaPenyaluranKL.FormValue)) {
                        RencanaPenyaluranKL.AddErrorMessage(ConvertToString(RencanaPenyaluranKL.RequiredErrorMessage).Replace("%s", RencanaPenyaluranKL.Caption));
                    }
                }
