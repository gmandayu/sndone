...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiBdEdit
    /// </summary>
    public static SubAktivitasFormInputNilaiBdEdit subAktivitasFormInputNilaiBdEdit
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiBdEdit>("subAktivitasFormInputNilaiBdEdit")!;
        set => HttpData["subAktivitasFormInputNilaiBdEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiBD
    /// </summary>
    public class SubAktivitasFormInputNilaiBdEdit : SubAktivitasFormInputNilaiBdEditBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiBdEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiBdEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiBdEditBase : SubAktivitasFormInputNilaiBd
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiBdEdit";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBdEditBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiBdEdit";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBdEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputNilaiBdList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputNilaiBdList") {
                                ...
                                returnUrl = "SubAktivitasFormInputNilaiBdList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputNilaiBdEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
