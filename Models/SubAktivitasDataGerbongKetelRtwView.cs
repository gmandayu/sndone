...
public partial class SnDOne {
    ...
    public class SubAktivitasDataGerbongKetelRtwViewBase : SubAktivitasDataGerbongKetelRtw
    {
        ...
        // Constructor
        public SubAktivitasDataGerbongKetelRtwViewBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasDataGerbongKetelRtwViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("id", out v) && !Empty(v))
                {
                id.QueryValue = UrlDecode(v);
