...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiBdView
    /// </summary>
    public static SubAktivitasFormInputNilaiBdView subAktivitasFormInputNilaiBdView
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiBdView>("subAktivitasFormInputNilaiBdView")!;
        set => HttpData["subAktivitasFormInputNilaiBdView"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiBD
    /// </summary>
    public class SubAktivitasFormInputNilaiBdView : SubAktivitasFormInputNilaiBdViewBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiBdView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiBdView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiBdViewBase : SubAktivitasFormInputNilaiBd
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiBdView";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBdViewBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiBdView";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBdViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputNilaiBdList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputNilaiBdList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputNilaiBdView?.PageRender();
            }
            return PageResult();
        }
