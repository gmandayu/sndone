...
public partial class SnDOne {
    ...
    public class PenyimpananSampleAddBase : PenyimpananSample
    {
        ...
        // Constructor
        public PenyimpananSampleAddBase()
        {
        ...
        // Constructor
        public PenyimpananSampleAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("PenyimpananSampleList"); // No matching record, return to List page // DN
                    }
                    break;
        ...
        protected async Task LoadFormValues() {
            ...
            if (!ExpiredEst.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("ExpiredEst") && !CurrentForm.HasValue("x_ExpiredEst")) // DN
                    ...
                    ExpiredEst.SetFormValue(val, true, validate);
