...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static VSampleOperasional vSampleOperasional
    {
        get => HttpData.Resolve<VSampleOperasional>("VSampleOperasional");
        set => HttpData["VSampleOperasional"] = value;
    }

    /// <summary>
    /// Table class for VSampleOperasional
    /// </summary>
    public class VSampleOperasional : DbTable
    {
        ...
        public readonly DbField<SqlDbType> Moda;
        ...
        public readonly DbField<SqlDbType> StatusPrevProses;

        // Constructor
        public VSampleOperasional()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "VSampleOperasional";
            Name = "VSampleOperasional";
            Type = "VIEW";
            UpdateTable = "dbo.VSampleOperasional"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            NoReferensi = new(this, "x_NoReferensi", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("VSampleOperasional", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            RedirectLink = new(this, "x_RedirectLink", 202, SqlDbType.NVarChar) {
                Name = "RedirectLink",
                Expression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NoReferensi AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NoReferensi AS NVARCHAR(50))+'</a>'",
                UseBasicSearch = true,
                BasicSearchExpression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NoReferensi AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NoReferensi AS NVARCHAR(50))+'</a>'",
                DateTimeFormat = -1,
                VirtualExpression = "'<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NoReferensi AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NoReferensi AS NVARCHAR(50))+'</a>'",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("VSampleOperasional", "RedirectLink", "CustomMsg"),
                IsUpload = false
            };
            RedirectLink.Lookup = new Lookup<DbField>(RedirectLink, "VSampleOperasional", true, "RedirectLink", new List<string> {"RedirectLink", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("RedirectLink", RedirectLink);

            // Proses
            Proses2 = new(this, "x_Proses2", 200, SqlDbType.VarChar) {
                Name = "Proses",
                Expression = "[Proses]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Proses]",
                DateTimeFormat = -1,
                VirtualExpression = "[Proses]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"],
                CustomMessage = Language.FieldPhrase("VSampleOperasional", "Proses2", "CustomMsg"),
                IsUpload = false
            };
            Proses2.Lookup = new Lookup<DbField>(Proses2, "VSampleOperasional", true, "Proses", new List<string> {"Proses", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Proses", Proses2);

            // Plant
            Plant = new(this, "x_Plant", 203, SqlDbType.NText) {
                Name = "Plant",
                Expression = "[Plant]",
                UseBasicSearch = true,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"],
                CustomMessage = Language.FieldPhrase("VSampleOperasional", "Plant", "CustomMsg"),
                IsUpload = false
            };
            Plant.Lookup = new Lookup<DbField>(Plant, "VSampleOperasional", true, "Plant", new List<string> {"Plant", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Plant", Plant);

            // Moda
            Moda = new(this, "x_Moda", 200, SqlDbType.VarChar) {
                Name = "Moda",
                Expression = "[Moda]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Moda]",
                DateTimeFormat = -1,
                VirtualExpression = "[Moda]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("VSampleOperasional", "Moda", "CustomMsg"),
                IsUpload = false
            };
            Moda.Lookup = new Lookup<DbField>(Moda, "VSampleOperasional", true, "Moda", new List<string> {"Moda", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Moda", Moda);
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("VSampleOperasional", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            Tanggal.Lookup = new Lookup<DbField>(Tanggal, "VSampleOperasional", true, "Tanggal", new List<string> {"Tanggal", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("Tanggal", Tanggal);

            // NamaDokumen
            NamaDokumen = new(this, "x_NamaDokumen", 200, SqlDbType.VarChar) {
                Name = "NamaDokumen",
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("VSampleOperasional", "NamaDokumen", "CustomMsg"),
                IsUpload = false
            };
            NamaDokumen.Lookup = new Lookup<DbField>(NamaDokumen, "VSampleOperasional", true, "NamaDokumen", new List<string> {"NamaDokumen", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("NamaDokumen", NamaDokumen);

            // DownloadDokumen
            DownloadDokumen = new(this, "x_DownloadDokumen", 203, SqlDbType.NText) {
                Name = "DownloadDokumen",
                Expression = "CASE WHEN StatusUpload = 'Uploaded' THEN '<a class=' + CHAR(34) + 'download-document btn btn-primary m-1' + CHAR(34) + ' IdAktivitasDokumen=' + CAST(IdAktivitasDokumen AS NVARCHAR(255)) +'><i class='+CHAR(34) + 'fas fa-download me-2' + CHAR(34)+'></i> Download Document</a>' ELSE '<p class='+CHAR(34)+'text-center m-1' +CHAR(34)+ ' IdAktivitasDokumen=' + CAST(IdAktivitasDokumen AS NVARCHAR(255)) +'>Not Uploaded</p>' END",
                BasicSearchExpression = "CASE WHEN StatusUpload = 'Uploaded' THEN '<a class=' + CHAR(34) + 'download-document btn btn-primary m-1' + CHAR(34) + ' IdAktivitasDokumen=' + CAST(IdAktivitasDokumen AS NVARCHAR(255)) +'><i class='+CHAR(34) + 'fas fa-download me-2' + CHAR(34)+'></i> Download Document</a>' ELSE '<p class='+CHAR(34)+'text-center m-1' +CHAR(34)+ ' IdAktivitasDokumen=' + CAST(IdAktivitasDokumen AS NVARCHAR(255)) +'>Not Uploaded</p>' END",
                DateTimeFormat = -1,
                VirtualExpression = "CASE WHEN StatusUpload = 'Uploaded' THEN '<a class=' + CHAR(34) + 'download-document btn btn-primary m-1' + CHAR(34) + ' IdAktivitasDokumen=' + CAST(IdAktivitasDokumen AS NVARCHAR(255)) +'><i class='+CHAR(34) + 'fas fa-download me-2' + CHAR(34)+'></i> Download Document</a>' ELSE '<p class='+CHAR(34)+'text-center m-1' +CHAR(34)+ ' IdAktivitasDokumen=' + CAST(IdAktivitasDokumen AS NVARCHAR(255)) +'>Not Uploaded</p>' END",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("VSampleOperasional", "DownloadDokumen", "CustomMsg"),
                IsUpload = false
            };
            ...
            IdAktivitasDokumen = new(this, "x_IdAktivitasDokumen", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("VSampleOperasional", "IdAktivitasDokumen", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusUpload = new(this, "x_StatusUpload", 200, SqlDbType.VarChar) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("VSampleOperasional", "StatusUpload", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("StatusUpload", StatusUpload);

            // StatusPrevProses
            StatusPrevProses = new(this, "x_StatusPrevProses", 200, SqlDbType.VarChar) {
                Name = "StatusPrevProses",
                Expression = "[StatusPrevProses]",
                BasicSearchExpression = "[StatusPrevProses]",
                DateTimeFormat = -1,
                VirtualExpression = "[StatusPrevProses]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                Sortable = false, // Allow sort
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("VSampleOperasional", "StatusPrevProses", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("StatusPrevProses", StatusPrevProses);
        ...
        {
            get => _sqlFrom ?? "dbo.VSampleOperasional";
            set => _sqlFrom = value;
        }
        ...
        {
            get {
                string select = "*, '<a href=ProsesList?cmd=search&x_IdReferensi%5B%5D='+ CAST(NoReferensi AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NoReferensi AS NVARCHAR(50))+'</a>' AS [RedirectLink], CASE WHEN StatusUpload = 'Uploaded' THEN '<a class=' + CHAR(34) + 'download-document btn btn-primary m-1' + CHAR(34) + ' IdAktivitasDokumen=' + CAST(IdAktivitasDokumen AS NVARCHAR(255)) +'><i class='+CHAR(34) + 'fas fa-download me-2' + CHAR(34)+'></i> Download Document</a>' ELSE '<p class='+CHAR(34)+'text-center m-1' +CHAR(34)+ ' IdAktivitasDokumen=' + CAST(IdAktivitasDokumen AS NVARCHAR(255)) +'>Not Uploaded</p>' END AS [DownloadDokumen]";
                if (select == "*") {
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.VsampleOperasional type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Moda.DbValue = row["Moda"]; // Set DB value only
                ...
                StatusPrevProses.DbValue = row["StatusPrevProses"]; // Set DB value only
            } catch {}
        }
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "VSampleOperasionalView" => Language.Phrase("View"),
                "VSampleOperasionalEdit" => Language.Phrase("Edit"),
                "VSampleOperasionalAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "VSampleOperasionalView",
                Config.ApiAddAction => "VSampleOperasionalAdd",
                Config.ApiEditAction => "VSampleOperasionalEdit",
                Config.ApiDeleteAction => "VSampleOperasionalDelete",
                Config.ApiListAction => "VSampleOperasionalList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "VSampleOperasionalList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("VSampleOperasionalView", parm);
            else
                url = KeyUrl("VSampleOperasionalView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "VSampleOperasionalAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "VSampleOperasionalAdd?" + parm;
            else
                url = "VSampleOperasionalAdd";
        ...
        {
            string url = "";
            url = KeyUrl("VSampleOperasionalEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("VSampleOperasionalList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("VSampleOperasionalAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("VSampleOperasionalList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("VSampleOperasionalDelete", parm)); // DN
        }
        ...
        {
            string pageName = "VSampleOperasionalList";
        ...
        public async Task RenderListRow()
        {
            ...
            IdAktivitasDokumen.ViewValue = FormatNumber(IdAktivitasDokumen.ViewValue, IdAktivitasDokumen.FormatPattern);
            ...
            // StatusPrevProses
            StatusPrevProses.ViewValue = ConvertToString(StatusPrevProses.CurrentValue); // DN
            StatusPrevProses.ViewCustomAttributes = "";
            ...
            // StatusPrevProses
            StatusPrevProses.HrefValue = "";
            StatusPrevProses.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // Moda
            Moda.SetupEditAttributes();
            if (!Moda.Raw)
                Moda.CurrentValue = HtmlDecode(Moda.CurrentValue);
            Moda.EditValue = Moda.CurrentValue;
            Moda.PlaceHolder = RemoveHtml(Moda.Caption);
            ...
            IdAktivitasDokumen.PlaceHolder = RemoveHtml(IdAktivitasDokumen.Caption);
            if (!Empty(IdAktivitasDokumen.EditValue) && IsNumeric(IdAktivitasDokumen.EditValue))
                IdAktivitasDokumen.EditValue = FormatNumber(IdAktivitasDokumen.EditValue, null);
            ...
            // StatusPrevProses
            StatusPrevProses.SetupEditAttributes();
            if (!StatusPrevProses.Raw)
                StatusPrevProses.CurrentValue = HtmlDecode(StatusPrevProses.CurrentValue);
            StatusPrevProses.EditValue = StatusPrevProses.CurrentValue;
            StatusPrevProses.PlaceHolder = RemoveHtml(StatusPrevProses.Caption);
        ...
        {
            try {
                // Pewarnaan DownloadDokumen
                if (StatusUpload.CurrentValue != null && StatusUpload.CurrentValue.ToString() != "Uploaded")
                {
                    string warna = "#fff";
                    string warnaFont = "#fff";
                    switch (StatusPrevProses.CurrentValue.ToString()) {
                        case "Completed":
                        case "Editing":
                        case "Completed Edit": 
                            warna = "#ba313b"; // Merah
                    ...
                    DownloadDokumen.CellCssStyle =
                        $"background-color:{warna}; color:{warnaFont}; font-weight:bold; text-align:center;";
                }
            } catch (Exception ex) {
                Log("Error in VSampleOperasional Row_Rendered: " + ex.Message);
            }
        }
