...
public partial class SnDOne {
    ...
    public class MasterRegionViewBase : MasterRegion
    {
        ...
        // Constructor
        public MasterRegionViewBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterRegionViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdRegion", out v) && !Empty(v))
                {
                IdRegion.QueryValue = UrlDecode(v);
                RecordKeys["IdRegion"] = IdRegion.QueryValue;
                return;
                }
                if (Get("IdRegion", out sv))
                {
