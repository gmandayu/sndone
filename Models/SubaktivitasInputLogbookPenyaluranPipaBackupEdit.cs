...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasInputLogbookPenyaluranPipaBackupEdit
    /// </summary>
    public static SubaktivitasInputLogbookPenyaluranPipaBackupEdit subaktivitasInputLogbookPenyaluranPipaBackupEdit
    {
        get => HttpData.Get<SubaktivitasInputLogbookPenyaluranPipaBackupEdit>("subaktivitasInputLogbookPenyaluranPipaBackupEdit")!;
        set => HttpData["subaktivitasInputLogbookPenyaluranPipaBackupEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasInputLogbookPenyaluranPipa_Backup
    /// </summary>
    public class SubaktivitasInputLogbookPenyaluranPipaBackupEdit : SubaktivitasInputLogbookPenyaluranPipaBackupEditBase
    {
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasInputLogbookPenyaluranPipaBackupEditBase : SubaktivitasInputLogbookPenyaluranPipaBackup
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasInputLogbookPenyaluranPipaBackupEdit";
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasInputLogbookPenyaluranPipaBackupEdit";
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaBackupEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasInputLogbookPenyaluranPipaBackupEdit?.PageRender();
                    }
        }
        ...
        private void ValidateCustomid() {
            if (id.Visible && id.Required) {
                if (!id.IsDetailKey && Empty(id.FormValue)) {
                    id.AddErrorMessage(ConvertToString(NoReferensi.RequiredErrorMessage).Replace("%s", NoReferensi.Caption));
                }
            }
        }
