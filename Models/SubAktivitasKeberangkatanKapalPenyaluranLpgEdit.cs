...
public partial class SnDOne {
    ...
    public class SubAktivitasKeberangkatanKapalPenyaluranLpgEditBase : SubAktivitasKeberangkatanKapalPenyaluranLpg
    {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasKeberangkatanKapalPenyaluranLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasKeberangkatanKapalPenyaluranLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasKeberangkatanKapalPenyaluranLpgList") {
                                ...
                                returnUrl = "SubAktivitasKeberangkatanKapalPenyaluranLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
