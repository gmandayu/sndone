...
public partial class SnDOne {
    /// <summary>
    /// formInputGoodHouseKeepingEdit
    /// </summary>
    public static FormInputGoodHouseKeepingEdit formInputGoodHouseKeepingEdit
    {
        get => HttpData.Get<FormInputGoodHouseKeepingEdit>("formInputGoodHouseKeepingEdit")!;
        set => HttpData["formInputGoodHouseKeepingEdit"] = value;
    }

    /// <summary>
    /// Page class for FormInputGoodHouseKeeping
    /// </summary>
    public class FormInputGoodHouseKeepingEdit : FormInputGoodHouseKeepingEditBase
    {
        // Constructor
        public FormInputGoodHouseKeepingEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public FormInputGoodHouseKeepingEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class FormInputGoodHouseKeepingEditBase : FormInputGoodHouseKeeping
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "formInputGoodHouseKeepingEdit";
        ...
        // Constructor
        public FormInputGoodHouseKeepingEditBase()
        {
        ...
        // Page name
        public string PageName => "FormInputGoodHouseKeepingEdit";
        ...
        // Constructor
        public FormInputGoodHouseKeepingEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("FormInputGoodHouseKeepingList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                formInputGoodHouseKeepingEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
