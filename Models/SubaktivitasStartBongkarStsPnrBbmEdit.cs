...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasStartBongkarStsPnrBbmEdit
    /// </summary>
    public static SubaktivitasStartBongkarStsPnrBbmEdit subaktivitasStartBongkarStsPnrBbmEdit
    {
        get => HttpData.Get<SubaktivitasStartBongkarStsPnrBbmEdit>("subaktivitasStartBongkarStsPnrBbmEdit")!;
        set => HttpData["subaktivitasStartBongkarStsPnrBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasStartBongkarSTSPnrBBM
    /// </summary>
    public class SubaktivitasStartBongkarStsPnrBbmEdit : SubaktivitasStartBongkarStsPnrBbmEditBase
    {
        // Constructor
        public SubaktivitasStartBongkarStsPnrBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasStartBongkarStsPnrBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasStartBongkarStsPnrBbmEditBase : SubaktivitasStartBongkarStsPnrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasStartBongkarStsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasStartBongkarStsPnrBbmEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasStartBongkarStsPnrBbmEdit";
        ...
        // Constructor
        public SubaktivitasStartBongkarStsPnrBbmEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasStartBongkarStsPnrBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasStartBongkarStsPnrBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasStartBongkarStsPnrBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasStartBongkarStsPnrBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasStartBongkarStsPnrBbmList")), "", TableVar, true);
            string pageId = "edit";
