...
public partial class SnDOne {
    ...
    public class SubAktivitasInputDataPenyaluranKonsinyasiPipaListBase : SubAktivitasInputDataPenyaluranKonsinyasiPipa
    {
        ...
        // Constructor
        public SubAktivitasInputDataPenyaluranKonsinyasiPipaListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasInputDataPenyaluranKonsinyasiPipaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field NoUrut
            if (filter.TryGetValue("x_NoUrut", out sv)) {
                RestoreFieldFilter(NoUrut, filter, "NoUrut", sv);
            }
