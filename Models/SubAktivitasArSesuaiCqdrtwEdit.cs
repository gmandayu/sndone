...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasArSesuaiCqdrtwEdit
    /// </summary>
    public static SubAktivitasArSesuaiCqdrtwEdit subAktivitasArSesuaiCqdrtwEdit
    {
        get => HttpData.Get<SubAktivitasArSesuaiCqdrtwEdit>("subAktivitasArSesuaiCqdrtwEdit")!;
        set => HttpData["subAktivitasArSesuaiCqdrtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasARSesuaiCQDRTW
    /// </summary>
    public class SubAktivitasArSesuaiCqdrtwEdit : SubAktivitasArSesuaiCqdrtwEditBase
    {
        // Constructor
        public SubAktivitasArSesuaiCqdrtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasArSesuaiCqdrtwEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasArSesuaiCqdrtwEditBase : SubAktivitasArSesuaiCqdrtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasArSesuaiCqdrtwEdit";
        ...
        // Constructor
        public SubAktivitasArSesuaiCqdrtwEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasArSesuaiCqdrtwEdit";
        ...
        // Constructor
        public SubAktivitasArSesuaiCqdrtwEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasArSesuaiCqdrtwList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasArSesuaiCqdrtwList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasArSesuaiCqdrtwList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasArSesuaiCqdrtwEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasArSesuaiCqdrtwList")), "", TableVar, true);
            string pageId = "edit";
