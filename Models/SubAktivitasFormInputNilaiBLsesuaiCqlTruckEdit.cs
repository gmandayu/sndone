...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiBLsesuaiCqlTruckEdit
    /// </summary>
    public static SubAktivitasFormInputNilaiBLsesuaiCqlTruckEdit subAktivitasFormInputNilaiBLsesuaiCqlTruckEdit
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiBLsesuaiCqlTruckEdit>("subAktivitasFormInputNilaiBLsesuaiCqlTruckEdit")!;
        set => HttpData["subAktivitasFormInputNilaiBLsesuaiCqlTruckEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiBLsesuaiCQLTruck
    /// </summary>
    public class SubAktivitasFormInputNilaiBLsesuaiCqlTruckEdit : SubAktivitasFormInputNilaiBLsesuaiCqlTruckEditBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiBLsesuaiCqlTruckEditBase : SubAktivitasFormInputNilaiBLsesuaiCqlTruck
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiBLsesuaiCqlTruckEdit";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiBLsesuaiCqlTruckEdit";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasFormInputNilaiBLsesuaiCqlTruckList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasFormInputNilaiBLsesuaiCqlTruckList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasFormInputNilaiBLsesuaiCqlTruckList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasFormInputNilaiBLsesuaiCqlTruckEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void ValidateCustomidAktifitas() {
            if (idAktifitas.Visible && idAktifitas.Required) {
                if (!idAktifitas.IsDetailKey && Empty(idAktifitas.FormValue)) {
                    idAktifitas.AddErrorMessage(ConvertToString(TotalPenyaluran.RequiredErrorMessage).Replace("%s", TotalPenyaluran.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidProses() {
            if (idProses.Visible && idProses.Required) {
                if (!idProses.IsDetailKey && Empty(idProses.FormValue)) {
                    idProses.AddErrorMessage(ConvertToString(TotalPenyaluran.RequiredErrorMessage).Replace("%s", TotalPenyaluran.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNoReferensi() {
            if (NoReferensi.Visible && NoReferensi.Required) {
                if (!NoReferensi.IsDetailKey && Empty(NoReferensi.FormValue)) {
                    NoReferensi.AddErrorMessage(ConvertToString(TotalPenyaluran.RequiredErrorMessage).Replace("%s", TotalPenyaluran.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLastUpdatedBy() {
            if (LastUpdatedBy.Visible && LastUpdatedBy.Required) {
                if (!LastUpdatedBy.IsDetailKey && Empty(LastUpdatedBy.FormValue)) {
                    LastUpdatedBy.AddErrorMessage(ConvertToString(TotalPenyaluran.RequiredErrorMessage).Replace("%s", TotalPenyaluran.Caption));
                }
            }
        }
        ...
        private void ValidateCustomlastUpdatedDate() {
            if (lastUpdatedDate.Visible && lastUpdatedDate.Required) {
                if (!lastUpdatedDate.IsDetailKey && Empty(lastUpdatedDate.FormValue)) {
                    lastUpdatedDate.AddErrorMessage(ConvertToString(TotalPenyaluran.RequiredErrorMessage).Replace("%s", TotalPenyaluran.Caption));
                }
            }
        }
        ...
        private void ValidateCustomStatusAktivitas() {
            if (StatusAktivitas.Visible && StatusAktivitas.Required) {
                if (!StatusAktivitas.IsDetailKey && Empty(StatusAktivitas.FormValue)) {
                    StatusAktivitas.AddErrorMessage(ConvertToString(TotalPenyaluran.RequiredErrorMessage).Replace("%s", TotalPenyaluran.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputNilaiBLsesuaiCqlTruckList")), "", TableVar, true);
            string pageId = "edit";
