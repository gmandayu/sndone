...
/**
 * Entity class for "SubAktivitasLogbookPenerimaan" table
 */
[Table("SubAktivitasLogbookPenerimaan")]
public class SubAktivitasLogbookPenerimaan
{
    [Key("id")]
    ...
    public bool? IsQualityActive { get; set; }
}
