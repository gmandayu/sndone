...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiEtcetaPipaListBase : SubAktivitasNilaiEtcetaPipa
    {
        ...
        // Constructor
        public SubAktivitasNilaiEtcetaPipaListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasNilaiEtcetaPipaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            // Field IsiPipa
            if (filter.TryGetValue("x_IsiPipa", out sv)) {
                RestoreFieldFilter(IsiPipa, filter, "IsiPipa", sv);
            }

            // Field IsiPipa2
            if (filter.TryGetValue("x_IsiPipa2", out sv)) {
                RestoreFieldFilter(IsiPipa2, filter, "IsiPipa2", sv);
            }

            // Field IsiPipa3
            if (filter.TryGetValue("x_IsiPipa3", out sv)) {
                RestoreFieldFilter(IsiPipa3, filter, "IsiPipa3", sv);
            }
            ...
            // Field LamaPengisian
            if (filter.TryGetValue("x_LamaPengisian", out sv)) {
                RestoreFieldFilter(LamaPengisian, filter, "LamaPengisian", sv);
            }

            // Field LamaPengiriman
            if (filter.TryGetValue("x_LamaPengiriman", out sv)) {
                RestoreFieldFilter(LamaPengiriman, filter, "LamaPengiriman", sv);
            }

            // Field LamaPengiriman2
            if (filter.TryGetValue("x_LamaPengiriman2", out sv)) {
                RestoreFieldFilter(LamaPengiriman2, filter, "LamaPengiriman2", sv);
            }

            // Field LamaPengiriman3
            if (filter.TryGetValue("x_LamaPengiriman3", out sv)) {
                RestoreFieldFilter(LamaPengiriman3, filter, "LamaPengiriman3", sv);
            }

            // Field ETC
            if (filter.TryGetValue("x_ETC", out sv)) {
                RestoreFieldFilter(ETC, filter, "ETC", sv);
            }

            // Field ETA
            if (filter.TryGetValue("x_ETA", out sv)) {
                RestoreFieldFilter(ETA, filter, "ETA", sv);
            }

            // Field ETA2
            if (filter.TryGetValue("x_ETA2", out sv)) {
                RestoreFieldFilter(ETA2, filter, "ETA2", sv);
            }

            // Field ETA3
            if (filter.TryGetValue("x_ETA3", out sv)) {
                RestoreFieldFilter(ETA3, filter, "ETA3", sv);
            }
