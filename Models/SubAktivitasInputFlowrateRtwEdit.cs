...
public partial class SnDOne {
    ...
    public class SubAktivitasInputFlowrateRtwEditBase : SubAktivitasInputFlowrateRtw
    {
        ...
        // Constructor
        public SubAktivitasInputFlowrateRtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasInputFlowrateRtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasInputFlowrateRtwList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasInputFlowrateRtwList") {
                                ...
                                returnUrl = "SubAktivitasInputFlowrateRtwList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
