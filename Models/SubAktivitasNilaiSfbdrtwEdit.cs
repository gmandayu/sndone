...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiSfbdrtwEdit
    /// </summary>
    public static SubAktivitasNilaiSfbdrtwEdit subAktivitasNilaiSfbdrtwEdit
    {
        get => HttpData.Get<SubAktivitasNilaiSfbdrtwEdit>("subAktivitasNilaiSfbdrtwEdit")!;
        set => HttpData["subAktivitasNilaiSfbdrtwEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiSFBDRTW
    /// </summary>
    public class SubAktivitasNilaiSfbdrtwEdit : SubAktivitasNilaiSfbdrtwEditBase
    {
        // Constructor
        public SubAktivitasNilaiSfbdrtwEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiSfbdrtwEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiSfbdrtwEditBase : SubAktivitasNilaiSfbdrtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiSfbdrtwEdit";
        ...
        // Constructor
        public SubAktivitasNilaiSfbdrtwEditBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiSfbdrtwEdit";
        ...
        // Constructor
        public SubAktivitasNilaiSfbdrtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiSfbdrtwList"); // No matching record, return to list
                        }
                    break;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiSfbdrtwEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // SFBD_KL_Obs
            SFBD_KL_Obs.SetDbValue(rsnew, SFBD_KL_Obs.CurrentValue, SFBD_KL_Obs.ReadOnly);

            // SFBD_KL_15
            SFBD_KL_15.SetDbValue(rsnew, SFBD_KL_15.CurrentValue, SFBD_KL_15.ReadOnly);

            // SFBD_Barrels
            SFBD_Barrels.SetDbValue(rsnew, SFBD_Barrels.CurrentValue, SFBD_Barrels.ReadOnly);

            // SFBD_LT
            SFBD_LT.SetDbValue(rsnew, SFBD_LT.CurrentValue, SFBD_LT.ReadOnly);

            // SFBD_MT
            SFBD_MT.SetDbValue(rsnew, SFBD_MT.CurrentValue, SFBD_MT.ReadOnly);
            return rsnew;
        }
