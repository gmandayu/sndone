...
public partial class SnDOne {
    ...
    public class MappingPositionAddBase : MappingPosition
    {
        ...
        // Constructor
        public MappingPositionAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("MappingPositionList"); // No matching record, return to List page // DN
                    }
                    break;
                    ...
                    if (res) { // Add successful
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "MappingPositionList") {
                                ...
                                returnUrl = "MappingPositionList"; // Return list page content
                            }
                        }
        ...
        protected async Task LoadFormValues() {
            ...
            if (!IdRegion.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("IdRegion") && !CurrentForm.HasValue("x_IdRegion")) // DN
                    IdRegion.Visible = false; // Disable update for API request
                else
