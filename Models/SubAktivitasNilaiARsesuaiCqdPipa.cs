...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiARsesuaiCqdPipa
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiARsesuaiCqdPipa subAktivitasNilaiARsesuaiCqdPipa
    {
        get => HttpData.Resolve<SubAktivitasNilaiARsesuaiCqdPipa>("SubAktivitasNilaiARsesuaiCQDPipa");
        set => HttpData["SubAktivitasNilaiARsesuaiCQDPipa"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiARsesuaiCQDPipa
    /// </summary>
    public class SubAktivitasNilaiARsesuaiCqdPipa : DbTable
    {
        ...
        public readonly DbField<SqlDbType> KlObs;

        public readonly DbField<SqlDbType> Kl15;
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqdPipa()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiARsesuaiCQDPipa";
            Name = "SubAktivitasNilaiARsesuaiCQDPipa";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiARsesuaiCQDPipa"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NoReferensi", NoReferensi);

            // KlObs
            KlObs = new(this, "x_KlObs", 202, SqlDbType.NVarChar) {
                Name = "KlObs",
                Expression = "[KlObs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[KlObs]",
                DateTimeFormat = -1,
                VirtualExpression = "[KlObs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "KlObs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("KlObs", KlObs);

            // Kl15
            Kl15 = new(this, "x_Kl15", 202, SqlDbType.NVarChar) {
                Name = "Kl15",
                Expression = "[Kl15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Kl15]",
                DateTimeFormat = -1,
                VirtualExpression = "[Kl15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "Kl15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Kl15", Kl15);
            ...
            Barrels = new(this, "x_Barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "Barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            LT = new(this, "x_LT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "LT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LT", LT);
            ...
            MT = new(this, "x_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "MT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("MT", MT);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQDPipa", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiARsesuaiCQDPipa";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiArsesuaiCqdpipa type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                KlObs.DbValue = row["KlObs"]; // Set DB value only
                Kl15.DbValue = row["Kl15"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiARsesuaiCqdPipaList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiARsesuaiCqdPipaView" => Language.Phrase("View"),
                "SubAktivitasNilaiARsesuaiCqdPipaEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiARsesuaiCqdPipaAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiARsesuaiCqdPipaView",
                Config.ApiAddAction => "SubAktivitasNilaiARsesuaiCqdPipaAdd",
                Config.ApiEditAction => "SubAktivitasNilaiARsesuaiCqdPipaEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiARsesuaiCqdPipaDelete",
                Config.ApiListAction => "SubAktivitasNilaiARsesuaiCqdPipaList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiARsesuaiCqdPipaList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiARsesuaiCqdPipaAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiARsesuaiCqdPipaAdd?" + parm;
            else
                url = "SubAktivitasNilaiARsesuaiCqdPipaAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiARsesuaiCqdPipaDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiARsesuaiCqdPipaList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // KlObs
            KlObs.SetupEditAttributes();
            if (!KlObs.Raw)
                KlObs.CurrentValue = HtmlDecode(KlObs.CurrentValue);
            KlObs.EditValue = KlObs.CurrentValue;
            KlObs.PlaceHolder = RemoveHtml(KlObs.Caption);

            // Kl15
            Kl15.SetupEditAttributes();
            if (!Kl15.Raw)
                Kl15.CurrentValue = HtmlDecode(Kl15.CurrentValue);
            Kl15.EditValue = Kl15.CurrentValue;
            Kl15.PlaceHolder = RemoveHtml(Kl15.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(KlObs);
                        doc.ExportCaption(Kl15);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(KlObs);
                            await doc.ExportField(Kl15);
