...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiAgreementPenyaluranLpg
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiAgreementPenyaluranLpg subAktivitasNilaiAgreementPenyaluranLpg
    {
        get => HttpData.Resolve<SubAktivitasNilaiAgreementPenyaluranLpg>("SubAktivitasNilaiAgreementPenyaluranLPG");
        set => HttpData["SubAktivitasNilaiAgreementPenyaluranLPG"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiAgreementPenyaluranLPG
    /// </summary>
    public class SubAktivitasNilaiAgreementPenyaluranLpg : DbTable
    {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenyaluranLpg()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiAgreementPenyaluranLPG";
            Name = "SubAktivitasNilaiAgreementPenyaluranLPG";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiAgreementPenyaluranLPG"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Flowrate = new(this, "x_Flowrate", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "Flowrate", "CustomMsg"),
                IsUpload = false
            };
            ...
            Pressure = new(this, "x_Pressure", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "Pressure", "CustomMsg"),
                IsUpload = false
            };
            ...
            LamaPembongkaran = new(this, "x_LamaPembongkaran", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "LamaPembongkaran", "CustomMsg"),
                IsUpload = false
            };
            ...
            ETC = new(this, "x_ETC", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "ETC", "CustomMsg"),
                IsUpload = false
            };
            ETC.Raw = true;
            Fields.Add("ETC", ETC);
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiAgreementPenyaluranLPG", "userInput", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiAgreementPenyaluranLPG";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiAgreementPenyaluranLpg type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiAgreementPenyaluranLpgList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiAgreementPenyaluranLpgView" => Language.Phrase("View"),
                "SubAktivitasNilaiAgreementPenyaluranLpgEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiAgreementPenyaluranLpgAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiAgreementPenyaluranLpgView",
                Config.ApiAddAction => "SubAktivitasNilaiAgreementPenyaluranLpgAdd",
                Config.ApiEditAction => "SubAktivitasNilaiAgreementPenyaluranLpgEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiAgreementPenyaluranLpgDelete",
                Config.ApiListAction => "SubAktivitasNilaiAgreementPenyaluranLpgList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiAgreementPenyaluranLpgList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiAgreementPenyaluranLpgView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiAgreementPenyaluranLpgView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiAgreementPenyaluranLpgAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiAgreementPenyaluranLpgAdd?" + parm;
            else
                url = "SubAktivitasNilaiAgreementPenyaluranLpgAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiAgreementPenyaluranLpgEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiAgreementPenyaluranLpgList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiAgreementPenyaluranLpgAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiAgreementPenyaluranLpgList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiAgreementPenyaluranLpgDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiAgreementPenyaluranLpgList";
