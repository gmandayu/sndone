...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStopPembongkaranPipaList
    /// </summary>
    public static SubAktivitasDataStopPembongkaranPipaList subAktivitasDataStopPembongkaranPipaList
    {
        get => HttpData.Get<SubAktivitasDataStopPembongkaranPipaList>("subAktivitasDataStopPembongkaranPipaList")!;
        set => HttpData["subAktivitasDataStopPembongkaranPipaList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStopPembongkaranPipa
    /// </summary>
    public class SubAktivitasDataStopPembongkaranPipaList : SubAktivitasDataStopPembongkaranPipaListBase
    {
        // Constructor
        public SubAktivitasDataStopPembongkaranPipaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStopPembongkaranPipaList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStopPembongkaranPipaListBase : SubAktivitasDataStopPembongkaranPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStopPembongkaranPipaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasDataStopPembongkaranPipalist";
        ...
        // Constructor
        public SubAktivitasDataStopPembongkaranPipaListBase()
        {
            TableName = "SubAktivitasDataStopPembongkaranPipa";

            // CSS class name as context
            TableVar = "SubAktivitasDataStopPembongkaranPipa";
            ...
            // Table object (subAktivitasDataStopPembongkaranPipa)
            if (subAktivitasDataStopPembongkaranPipa == null || subAktivitasDataStopPembongkaranPipa is SubAktivitasDataStopPembongkaranPipa)
                subAktivitasDataStopPembongkaranPipa = this;

            // Initialize URLs
            AddUrl = "SubAktivitasDataStopPembongkaranPipaAdd";
            ...
            MultiDeleteUrl = "SubAktivitasDataStopPembongkaranPipaDelete";
            MultiUpdateUrl = "SubAktivitasDataStopPembongkaranPipaUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasDataStopPembongkaranPipaList";
        ...
        public void SetVisibility()
        {
            ...
            tglStopBongkar.SetVisibility();
            userInput.SetVisibility();
            etlDate.SetVisibility();
        }

        // Constructor
        public SubAktivitasDataStopPembongkaranPipaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasDataStopPembongkaranPipaView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasDataStopPembongkaranPipagrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasDataStopPembongkaranPipaList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(tglStopBongkar.AdvancedSearch.ToJson())); // Field tglStopBongkar
        ...
        protected bool RestoreFilterList() {
            ...
            // Field tglStopBongkar
            if (filter?.TryGetValue("x_tglStopBongkar", out sv) ?? false) {
                tglStopBongkar.AdvancedSearch.SearchValue = sv;
                tglStopBongkar.AdvancedSearch.SearchOperator = filter["z_tglStopBongkar"];
                tglStopBongkar.AdvancedSearch.SearchCondition = filter["v_tglStopBongkar"];
                tglStopBongkar.AdvancedSearch.SearchValue2 = filter["y_tglStopBongkar"];
                tglStopBongkar.AdvancedSearch.SearchOperator2 = filter["w_tglStopBongkar"];
                tglStopBongkar.AdvancedSearch.Save();
            }
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(tglStopBongkar, ctrl); // tglStopBongkar
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasDataStopPembongkaranPipa"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataStopPembongkaranPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataStopPembongkaranPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("tglStopBongkar")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasDataStopPembongkaranPipasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasDataStopPembongkaranPipasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataStopPembongkaranPipalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasDataStopPembongkaranPipa");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasDataStopPembongkaranPipaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasDataStopPembongkaranPipaList.RowCount) + "_SubAktivitasDataStopPembongkaranPipa");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasDataStopPembongkaranPipaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasDataStopPembongkaranPipaList.RowType == RowType.Add || IsEdit && subAktivitasDataStopPembongkaranPipaList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            tglStopBongkar.SetDbValue(row["tglStopBongkar"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("tglStopBongkar", tglStopBongkar.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // tglStopBongkar
                tglStopBongkar.ViewValue = tglStopBongkar.CurrentValue;
                tglStopBongkar.ViewValue = FormatDateTime(tglStopBongkar.ViewValue, tglStopBongkar.FormatPattern);
                tglStopBongkar.ViewCustomAttributes = "";
                ...
                // tglStopBongkar
                tglStopBongkar.HrefValue = "";
                tglStopBongkar.TooltipValue = "";
