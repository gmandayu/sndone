...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiARsesuaiCqdTruckDelete
    /// </summary>
    public static SubAktivitasFormInputNilaiARsesuaiCqdTruckDelete subAktivitasFormInputNilaiARsesuaiCqdTruckDelete
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiARsesuaiCqdTruckDelete>("subAktivitasFormInputNilaiARsesuaiCqdTruckDelete")!;
        set => HttpData["subAktivitasFormInputNilaiARsesuaiCqdTruckDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiARsesuaiCQDTruck
    /// </summary>
    public class SubAktivitasFormInputNilaiARsesuaiCqdTruckDelete : SubAktivitasFormInputNilaiARsesuaiCqdTruckDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiARsesuaiCqdTruckDeleteBase : SubAktivitasFormInputNilaiARsesuaiCqdTruck
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiARsesuaiCqdTruckDelete";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiARsesuaiCqdTruckDelete";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputNilaiARsesuaiCqdTruckList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputNilaiARsesuaiCqdTruckList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputNilaiARsesuaiCqdTruckDelete?.PageRender();
            }
            return PageResult();
        }
