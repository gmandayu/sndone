...
public partial class SnDOne {
    ...
    public class SubAktivitasDataMobilTangkiMtGateInEditBase : SubAktivitasDataMobilTangkiMtGateIn
    {
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataMobilTangkiMtGateInList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataMobilTangkiMtGateInList") {
                                ...
                                returnUrl = "SubAktivitasDataMobilTangkiMtGateInList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
