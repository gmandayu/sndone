...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiNewBlsfadsfblstsPyrBbmList
    /// </summary>
    public static SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList subAktivitasNilaiNewBlsfadsfblstsPyrBbmList
    {
        get => HttpData.Get<SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList>("subAktivitasNilaiNewBlsfadsfblstsPyrBbmList")!;
        set => HttpData["subAktivitasNilaiNewBlsfadsfblstsPyrBbmList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList : SubAktivitasNilaiNewBlsfadsfblstsPyrBbmListBase
    {
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfblstsPyrBbmListBase : SubAktivitasNilaiNewBlsfadsfblstsPyrBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiNewBlsfadsfblstsPyrBbmList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasNilaiNewBLSFADSFBLSTSPyrBBMlist";
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrBbmListBase()
        {
            ...
            // Table object (subAktivitasNilaiNewBlsfadsfblstsPyrBbm)
            if (subAktivitasNilaiNewBlsfadsfblstsPyrBbm == null || subAktivitasNilaiNewBlsfadsfblstsPyrBbm is SubAktivitasNilaiNewBlsfadsfblstsPyrBbm)
                subAktivitasNilaiNewBlsfadsfblstsPyrBbm = this;

            // Initialize URLs
            AddUrl = "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmAdd";
            ...
            MultiDeleteUrl = "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmDelete";
            MultiUpdateUrl = "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmList";
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfblstsPyrBbmListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasNilaiNewBlsfadsfblstsPyrBbmView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasNilaiNewBLSFADSFBLSTSPyrBBMgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiNewBlsfadsfblstsPyrBbmList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(SFBL_KLObs);
            searchFlds.Add(SFBL_KL15);
            searchFlds.Add(SFBL_Barrels);
            searchFlds.Add(SFBL_LT);
            searchFlds.Add(SFBL_MT);
            searchFlds.Add(userInput);
            searchFlds.Add(LastUpdatedBy);
            searchFlds.Add(NoPenerimaan);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(SFBL_KLObs, ctrl); // SFBL_KLObs
                UpdateSort(SFBL_KL15, ctrl); // SFBL_KL15
                UpdateSort(SFBL_Barrels, ctrl); // SFBL_Barrels
                UpdateSort(SFBL_LT, ctrl); // SFBL_LT
                UpdateSort(SFBL_MT, ctrl); // SFBL_MT
                ...
                UpdateSort(ExROB, ctrl); // ExROB
                UpdateSort(NoPenerimaan, ctrl); // NoPenerimaan
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasNilaiNewBLSFADSFBLSTSPyrBBMlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasNilaiNewBLSFADSFBLSTSPyrBBMlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("SFBL_KLObs")); // DN
                CreateColumnOption(option.Add("SFBL_KL15")); // DN
                CreateColumnOption(option.Add("SFBL_Barrels")); // DN
                CreateColumnOption(option.Add("SFBL_LT")); // DN
                CreateColumnOption(option.Add("SFBL_MT")); // DN
                ...
                CreateColumnOption(option.Add("ExROB")); // DN
                CreateColumnOption(option.Add("NoPenerimaan")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasNilaiNewBLSFADSFBLSTSPyrBBMsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasNilaiNewBLSFADSFBLSTSPyrBBMsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasNilaiNewBLSFADSFBLSTSPyrBBMlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasNilaiNewBlsfadsfblstsPyrBbmList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasNilaiNewBlsfadsfblstsPyrBbmList.RowCount) + "_SubAktivitasNilaiNewBLSFADSFBLSTSPyrBBM");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasNilaiNewBlsfadsfblstsPyrBbmList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasNilaiNewBlsfadsfblstsPyrBbmList.RowType == RowType.Add || IsEdit && subAktivitasNilaiNewBlsfadsfblstsPyrBbmList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasNilaiNewBLSFADSFBLSTSPyrBBMlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasNilaiNewBLSFADSFBLSTSPyrBBMlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasNilaiNewBLSFADSFBLSTSPyrBBMlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
