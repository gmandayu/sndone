...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputDataStopPembongkaranViewBase : SubAktivitasFormInputDataStopPembongkaran
    {
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranViewBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputDataStopPembongkaranList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputDataStopPembongkaranList"); // Return to list page
                            }
                        }
                    break;
            }
