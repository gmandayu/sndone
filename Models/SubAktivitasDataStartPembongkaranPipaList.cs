...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStartPembongkaranPipaList
    /// </summary>
    public static SubAktivitasDataStartPembongkaranPipaList subAktivitasDataStartPembongkaranPipaList
    {
        get => HttpData.Get<SubAktivitasDataStartPembongkaranPipaList>("subAktivitasDataStartPembongkaranPipaList")!;
        set => HttpData["subAktivitasDataStartPembongkaranPipaList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStartPembongkaranPipa
    /// </summary>
    public class SubAktivitasDataStartPembongkaranPipaList : SubAktivitasDataStartPembongkaranPipaListBase
    {
        // Constructor
        public SubAktivitasDataStartPembongkaranPipaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStartPembongkaranPipaList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStartPembongkaranPipaListBase : SubAktivitasDataStartPembongkaranPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStartPembongkaranPipaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasDataStartPembongkaranPipalist";
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranPipaListBase()
        {
            TableName = "SubAktivitasDataStartPembongkaranPipa";

            // CSS class name as context
            TableVar = "SubAktivitasDataStartPembongkaranPipa";
            ...
            // Table object (subAktivitasDataStartPembongkaranPipa)
            if (subAktivitasDataStartPembongkaranPipa == null || subAktivitasDataStartPembongkaranPipa is SubAktivitasDataStartPembongkaranPipa)
                subAktivitasDataStartPembongkaranPipa = this;

            // Initialize URLs
            AddUrl = "SubAktivitasDataStartPembongkaranPipaAdd";
            ...
            MultiDeleteUrl = "SubAktivitasDataStartPembongkaranPipaDelete";
            MultiUpdateUrl = "SubAktivitasDataStartPembongkaranPipaUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasDataStartPembongkaranPipaList";
        ...
        public void SetVisibility()
        {
            ...
            tglStartBongkar.SetVisibility();
            userInput.SetVisibility();
            etlDate.SetVisibility();
        }

        // Constructor
        public SubAktivitasDataStartPembongkaranPipaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasDataStartPembongkaranPipaView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasDataStartPembongkaranPipagrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasDataStartPembongkaranPipaList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(tglStartBongkar.AdvancedSearch.ToJson())); // Field tglStartBongkar
        ...
        protected bool RestoreFilterList() {
            ...
            // Field tglStartBongkar
            if (filter?.TryGetValue("x_tglStartBongkar", out sv) ?? false) {
                tglStartBongkar.AdvancedSearch.SearchValue = sv;
                tglStartBongkar.AdvancedSearch.SearchOperator = filter["z_tglStartBongkar"];
                tglStartBongkar.AdvancedSearch.SearchCondition = filter["v_tglStartBongkar"];
                tglStartBongkar.AdvancedSearch.SearchValue2 = filter["y_tglStartBongkar"];
                tglStartBongkar.AdvancedSearch.SearchOperator2 = filter["w_tglStartBongkar"];
                tglStartBongkar.AdvancedSearch.Save();
            }
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(tglStartBongkar, ctrl); // tglStartBongkar
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasDataStartPembongkaranPipa"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataStartPembongkaranPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataStartPembongkaranPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("tglStartBongkar")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasDataStartPembongkaranPipasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasDataStartPembongkaranPipasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasDataStartPembongkaranPipalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasDataStartPembongkaranPipa");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasDataStartPembongkaranPipaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasDataStartPembongkaranPipaList.RowCount) + "_SubAktivitasDataStartPembongkaranPipa");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasDataStartPembongkaranPipaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasDataStartPembongkaranPipaList.RowType == RowType.Add || IsEdit && subAktivitasDataStartPembongkaranPipaList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            tglStartBongkar.SetDbValue(row["tglStartBongkar"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("tglStartBongkar", tglStartBongkar.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // tglStartBongkar
                tglStartBongkar.ViewValue = tglStartBongkar.CurrentValue;
                tglStartBongkar.ViewValue = FormatDateTime(tglStartBongkar.ViewValue, tglStartBongkar.FormatPattern);
                tglStartBongkar.ViewCustomAttributes = "";
                ...
                // tglStartBongkar
                tglStartBongkar.HrefValue = "";
                tglStartBongkar.TooltipValue = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasDataStartPembongkaranPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasDataStartPembongkaranPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasDataStartPembongkaranPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
