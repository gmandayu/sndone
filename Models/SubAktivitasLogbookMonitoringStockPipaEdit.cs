...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasLogbookMonitoringStockPipaEdit
    /// </summary>
    public static SubAktivitasLogbookMonitoringStockPipaEdit subAktivitasLogbookMonitoringStockPipaEdit
    {
        get => HttpData.Get<SubAktivitasLogbookMonitoringStockPipaEdit>("subAktivitasLogbookMonitoringStockPipaEdit")!;
        set => HttpData["subAktivitasLogbookMonitoringStockPipaEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasLogbookMonitoringStockPipa
    /// </summary>
    public class SubAktivitasLogbookMonitoringStockPipaEdit : SubAktivitasLogbookMonitoringStockPipaEditBase
    {
        // Constructor
        public SubAktivitasLogbookMonitoringStockPipaEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasLogbookMonitoringStockPipaEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasLogbookMonitoringStockPipaEditBase : SubAktivitasLogbookMonitoringStockPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasLogbookMonitoringStockPipaEdit";
        ...
        // Constructor
        public SubAktivitasLogbookMonitoringStockPipaEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasLogbookMonitoringStockPipaEdit";
        ...
        // Constructor
        public SubAktivitasLogbookMonitoringStockPipaEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasLogbookMonitoringStockPipaList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasLogbookMonitoringStockPipaList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasLogbookMonitoringStockPipaList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasLogbookMonitoringStockPipaEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'Volume_KL'
            Volume_KL.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(Volume_KL, "Volume_KL", "x_Volume_KL");
        ...
        public void RestoreFormValues()
        {
            ...
            Volume_KL.CurrentValue = Volume_KL.FormValue;
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // Volume_KL
                Volume_KL.SetupEditAttributes();
                if (!Volume_KL.Raw)
                    Volume_KL.CurrentValue = HtmlDecode(Volume_KL.CurrentValue);
                Volume_KL.EditValue = HtmlEncode(Volume_KL.CurrentValue);
                Volume_KL.PlaceHolder = RemoveHtml(Volume_KL.Caption);
        ...
        private void ValidateCustomVolume_KL() {
            if (Volume_KL.Visible && Volume_KL.Required) {
                if (!Volume_KL.IsDetailKey && Empty(Volume_KL.FormValue)) {
                    Volume_KL.AddErrorMessage(ConvertToString(IdPlant.RequiredErrorMessage).Replace("%s", IdPlant.Caption));
                }
            }
        }
        ...
        private void ValidateCustomFlowrate() {
            if (Flowrate.Visible && Flowrate.Required) {
                if (!Flowrate.IsDetailKey && Empty(Flowrate.FormValue)) {
                    Flowrate.AddErrorMessage(ConvertToString(IdPlant.RequiredErrorMessage).Replace("%s", IdPlant.Caption));
                }
            }
        }
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // Volume_KL
            Volume_KL.SetDbValue(rsnew, Volume_KL.CurrentValue, Volume_KL.ReadOnly);
        ...
        protected void RestoreEditFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("Volume_KL", out value)) // Volume_KL
                Volume_KL.CurrentValue = value;
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasLogbookMonitoringStockPipaList")), "", TableVar, true);
            string pageId = "edit";
