...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static VAktifitasSandar vAktifitasSandar
    {
        get => HttpData.Resolve<VAktifitasSandar>("v_aktifitas_sandar");
        set => HttpData["v_aktifitas_sandar"] = value;
    }

    /// <summary>
    /// Table class for v_aktifitas_sandar
    /// </summary>
    public class VAktifitasSandar : DbTable
    {
        ...
        // Constructor
        public VAktifitasSandar()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "v_aktifitas_sandar";
            Name = "v_aktifitas_sandar";
            Type = "VIEW";
            UpdateTable = "dbo.v_aktifitas_sandar"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            IdAktivitas = new(this, "x_IdAktivitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("v_aktifitas_sandar", "IdAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NamaAktivitas = new(this, "x_NamaAktivitas", 203, SqlDbType.NText) {
                ...
                CustomMessage = Language.FieldPhrase("v_aktifitas_sandar", "NamaAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            Nama_Proses = new(this, "x_Nama_Proses", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_sandar", "Nama_Proses", "CustomMsg"),
                IsUpload = false
            };
            ...
            No_referensi = new(this, "x_No_referensi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_sandar", "No_referensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_sandar", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_sandar", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            Shipment = new(this, "x_Shipment", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_sandar", "Shipment", "CustomMsg"),
                IsUpload = false
            };
            ...
            sandar_nama_kapal = new(this, "x_sandar_nama_kapal", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_sandar", "sandar_nama_kapal", "CustomMsg"),
                IsUpload = false
            };
            sandar_nama_kapal.Lookup = new Lookup<DbField>(sandar_nama_kapal, "v_aktifitas_sandar", true, "sandar_nama_kapal", new List<string> {"sandar_nama_kapal", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            sandar_tgl_tiba = new(this, "x_sandar_tgl_tiba", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("v_aktifitas_sandar", "sandar_tgl_tiba", "CustomMsg"),
                IsUpload = false
            };
            sandar_tgl_tiba.Raw = true;
            sandar_tgl_tiba.Lookup = new Lookup<DbField>(sandar_tgl_tiba, "v_aktifitas_sandar", true, "sandar_tgl_tiba", new List<string> {"sandar_tgl_tiba", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            sandar_nominasi = new(this, "x_sandar_nominasi", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_sandar", "sandar_nominasi", "CustomMsg"),
                IsUpload = false
            };
            sandar_nominasi.Lookup = new Lookup<DbField>(sandar_nominasi, "v_aktifitas_sandar", true, "sandar_nominasi", new List<string> {"sandar_nominasi", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            IdProses = new(this, "x_IdProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("v_aktifitas_sandar", "IdProses", "CustomMsg"),
                IsUpload = false
            };
            IdProses.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.v_aktifitas_sandar";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.VAktifitasSandar type", "data");
            row = row.Where(kvp => {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "VAktifitasSandarView" => Language.Phrase("View"),
                "VAktifitasSandarEdit" => Language.Phrase("Edit"),
                "VAktifitasSandarAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "VAktifitasSandarView",
                Config.ApiAddAction => "VAktifitasSandarAdd",
                Config.ApiEditAction => "VAktifitasSandarEdit",
                Config.ApiDeleteAction => "VAktifitasSandarDelete",
                Config.ApiListAction => "VAktifitasSandarList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "VAktifitasSandarList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("VAktifitasSandarView", parm);
            else
                url = KeyUrl("VAktifitasSandarView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "VAktifitasSandarAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "VAktifitasSandarAdd?" + parm;
            else
                url = "VAktifitasSandarAdd";
        ...
        {
            string url = "";
            url = KeyUrl("VAktifitasSandarEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("VAktifitasSandarList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("VAktifitasSandarAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("VAktifitasSandarList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("VAktifitasSandarDelete", parm)); // DN
        }
        ...
        {
            string pageName = "VAktifitasSandarList";
