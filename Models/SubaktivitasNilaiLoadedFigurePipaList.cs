...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiLoadedFigurePipaList
    /// </summary>
    public static SubaktivitasNilaiLoadedFigurePipaList subaktivitasNilaiLoadedFigurePipaList
    {
        get => HttpData.Get<SubaktivitasNilaiLoadedFigurePipaList>("subaktivitasNilaiLoadedFigurePipaList")!;
        set => HttpData["subaktivitasNilaiLoadedFigurePipaList"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasNilaiLoadedFigurePipa
    /// </summary>
    public class SubaktivitasNilaiLoadedFigurePipaList : SubaktivitasNilaiLoadedFigurePipaListBase
    {
        // Constructor
        public SubaktivitasNilaiLoadedFigurePipaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasNilaiLoadedFigurePipaList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasNilaiLoadedFigurePipaListBase : SubaktivitasNilaiLoadedFigurePipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasNilaiLoadedFigurePipaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubaktivitasNilaiLoadedFigurePipalist";
        ...
        // Constructor
        public SubaktivitasNilaiLoadedFigurePipaListBase()
        {
            TableName = "SubaktivitasNilaiLoadedFigurePipa";

            // CSS class name as context
            TableVar = "SubaktivitasNilaiLoadedFigurePipa";
            ...
            // Table object (subaktivitasNilaiLoadedFigurePipa)
            if (subaktivitasNilaiLoadedFigurePipa == null || subaktivitasNilaiLoadedFigurePipa is SubaktivitasNilaiLoadedFigurePipa)
                subaktivitasNilaiLoadedFigurePipa = this;

            // Initialize URLs
            AddUrl = "SubaktivitasNilaiLoadedFigurePipaAdd";
            ...
            MultiDeleteUrl = "SubaktivitasNilaiLoadedFigurePipaDelete";
            MultiUpdateUrl = "SubaktivitasNilaiLoadedFigurePipaUpdate";
        ...
        // Page name
        public string PageName => "SubaktivitasNilaiLoadedFigurePipaList";
        ...
        // Constructor
        public SubaktivitasNilaiLoadedFigurePipaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubaktivitasNilaiLoadedFigurePipaView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubaktivitasNilaiLoadedFigurePipagrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subaktivitasNilaiLoadedFigurePipaList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(klobs.AdvancedSearch.ToJson())); // Field klobs
            filters.Merge(JObject.Parse(kl15.AdvancedSearch.ToJson())); // Field kl15
        ...
        protected bool RestoreFilterList() {
            ...
            // Field klobs
            if (filter?.TryGetValue("x_klobs", out sv) ?? false) {
                klobs.AdvancedSearch.SearchValue = sv;
                klobs.AdvancedSearch.SearchOperator = filter["z_klobs"];
                klobs.AdvancedSearch.SearchCondition = filter["v_klobs"];
                klobs.AdvancedSearch.SearchValue2 = filter["y_klobs"];
                klobs.AdvancedSearch.SearchOperator2 = filter["w_klobs"];
                klobs.AdvancedSearch.Save();
            }

            // Field kl15
            if (filter?.TryGetValue("x_kl15", out sv) ?? false) {
                kl15.AdvancedSearch.SearchValue = sv;
                kl15.AdvancedSearch.SearchOperator = filter["z_kl15"];
                kl15.AdvancedSearch.SearchCondition = filter["v_kl15"];
                kl15.AdvancedSearch.SearchValue2 = filter["y_kl15"];
                kl15.AdvancedSearch.SearchOperator2 = filter["w_kl15"];
                kl15.AdvancedSearch.Save();
            }
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(klobs, ctrl); // klobs
                UpdateSort(kl15, ctrl); // kl15
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubaktivitasNilaiLoadedFigurePipa"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubaktivitasNilaiLoadedFigurePipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasNilaiLoadedFigurePipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("klobs")); // DN
                CreateColumnOption(option.Add("kl15")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubaktivitasNilaiLoadedFigurePipasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubaktivitasNilaiLoadedFigurePipasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubaktivitasNilaiLoadedFigurePipalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubaktivitasNilaiLoadedFigurePipa");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subaktivitasNilaiLoadedFigurePipaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subaktivitasNilaiLoadedFigurePipaList.RowCount) + "_SubaktivitasNilaiLoadedFigurePipa");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subaktivitasNilaiLoadedFigurePipaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subaktivitasNilaiLoadedFigurePipaList.RowType == RowType.Add || IsEdit && subaktivitasNilaiLoadedFigurePipaList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            klobs.SetDbValue(row["klobs"]);
            kl15.SetDbValue(row["kl15"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("klobs", klobs.DefaultValue ?? DbNullValue); // DN
            row.Add("kl15", kl15.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // klobs
                klobs.ViewValue = ConvertToString(klobs.CurrentValue); // DN
                klobs.ViewCustomAttributes = "";

                // kl15
                kl15.ViewValue = ConvertToString(kl15.CurrentValue); // DN
                kl15.ViewCustomAttributes = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubaktivitasNilaiLoadedFigurePipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubaktivitasNilaiLoadedFigurePipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubaktivitasNilaiLoadedFigurePipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
