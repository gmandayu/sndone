...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiNewBlsfadsfbllpgEdit
    /// </summary>
    public static SubAktivitasNilaiNewBlsfadsfbllpgEdit subAktivitasNilaiNewBlsfadsfbllpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiNewBlsfadsfbllpgEdit>("subAktivitasNilaiNewBlsfadsfbllpgEdit")!;
        set => HttpData["subAktivitasNilaiNewBlsfadsfbllpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiNewBLSFADSFBLLPG
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfbllpgEdit : SubAktivitasNilaiNewBlsfadsfbllpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfbllpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiNewBlsfadsfbllpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiNewBlsfadsfbllpgEditBase : SubAktivitasNilaiNewBlsfadsfbllpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiNewBlsfadsfbllpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfbllpgEditBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiNewBlsfadsfbllpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiNewBlsfadsfbllpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiNewBlsfadsfbllpgList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "SubAktivitasNilaiNewBlsfadsfbllpgList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiNewBlsfadsfbllpgList") {
                                ...
                                returnUrl = "SubAktivitasNilaiNewBlsfadsfbllpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasNilaiNewBlsfadsfbllpgEdit?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiNewBlsfadsfbllpgList")), "", TableVar, true);
            string pageId = "edit";
