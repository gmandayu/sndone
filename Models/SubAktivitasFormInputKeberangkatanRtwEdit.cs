...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputKeberangkatanRtwEditBase : SubAktivitasFormInputKeberangkatanRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanRtwEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputKeberangkatanRtwEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputKeberangkatanRtwList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputKeberangkatanRtwList") {
                                ...
                                returnUrl = "SubAktivitasFormInputKeberangkatanRtwList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
