...
public partial class SnDOne {
    /// <summary>
    /// goodHouseKeepingDelete
    /// </summary>
    public static GoodHouseKeepingDelete goodHouseKeepingDelete
    {
        get => HttpData.Get<GoodHouseKeepingDelete>("goodHouseKeepingDelete")!;
        set => HttpData["goodHouseKeepingDelete"] = value;
    }

    /// <summary>
    /// Page class for GoodHouseKeeping
    /// </summary>
    public class GoodHouseKeepingDelete : GoodHouseKeepingDeleteBase
    {
        // Constructor
        public GoodHouseKeepingDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public GoodHouseKeepingDelete() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class GoodHouseKeepingDeleteBase : GoodHouseKeeping
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "goodHouseKeepingDelete";
        ...
        // Constructor
        public GoodHouseKeepingDeleteBase()
        {
        ...
        // Page name
        public string PageName => "GoodHouseKeepingDelete";
        ...
        // Constructor
        public GoodHouseKeepingDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("GoodHouseKeepingList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("GoodHouseKeepingList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                goodHouseKeepingDelete?.PageRender();
            }
            return PageResult();
        }
