...
public partial class SnDOne {
    ...
    public class SubaktivitasNilaiBlsfalEditBase : SubaktivitasNilaiBlsfal
    {
        ...
        // Constructor
        public SubaktivitasNilaiBlsfalEditBase(Controller? controller)
        {
        ...
        // Constructor
        public SubaktivitasNilaiBlsfalEditBase() : this(null) { }
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasNilaiBlsfalList");
            }
            return null;
        }
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    ...
                    if (GetPageName(returnUrl) != "SubaktivitasNilaiBlsfalList") {
                        ...
                        returnUrl = "SubaktivitasNilaiBlsfalList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
