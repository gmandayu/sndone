...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputBLsesuaiCqlrtwViewBase : SubAktivitasFormInputBLsesuaiCqlrtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputBLsesuaiCqlrtwViewBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputBLsesuaiCqlrtwViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputBLsesuaiCqlrtwList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputBLsesuaiCqlrtwList"); // Return to list page
                            }
                        }
                    break;
            }
