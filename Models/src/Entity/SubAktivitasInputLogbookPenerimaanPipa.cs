...
/**
 * Entity class for "SubAktivitasInputLogbookPenerimaanPipa" table
 */
[Table("SubAktivitasInputLogbookPenerimaanPipa")]
public class SubAktivitasInputLogbookPenerimaanPipa
{
    [Key("id")]
