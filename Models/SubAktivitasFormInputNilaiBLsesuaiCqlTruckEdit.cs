...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputNilaiBLsesuaiCqlTruckEditBase : SubAktivitasFormInputNilaiBLsesuaiCqlTruck
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiBLsesuaiCqlTruckEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputNilaiBLsesuaiCqlTruckList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputNilaiBLsesuaiCqlTruckList") {
                                ...
                                returnUrl = "SubAktivitasFormInputNilaiBLsesuaiCqlTruckList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
