...
public partial class SnDOne {
    ...
    public class SubAktivitasLogbookPenerimaanEditBase : SubAktivitasLogbookPenerimaan
    {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanEditBase()
        {
        ...
        // Constructor
        public SubAktivitasLogbookPenerimaanEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasLogbookPenerimaanList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasLogbookPenerimaanList") {
                                ...
                                returnUrl = "SubAktivitasLogbookPenerimaanList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
