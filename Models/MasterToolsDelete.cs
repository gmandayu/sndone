...
public partial class SnDOne {
    ...
    /// masterToolsDelete
    /// </summary>
    public static MasterToolsDelete masterToolsDelete
    {
        get => HttpData.Get<MasterToolsDelete>("masterToolsDelete")!;
        set => HttpData["masterToolsDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterTools
    /// </summary>
    public class MasterToolsDelete : MasterToolsDeleteBase
    {
        // Constructor
        public MasterToolsDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterToolsDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterToolsDeleteBase : MasterTools
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterToolsDelete";
        ...
        // Page name
        public string PageName => "MasterToolsDelete";
        ...
        // Constructor
        public MasterToolsDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterToolsList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterToolsList"); // Return to list
                }
            }
