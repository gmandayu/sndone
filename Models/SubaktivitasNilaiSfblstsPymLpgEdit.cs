...
public partial class SnDOne {
    ...
    public class SubaktivitasNilaiSfblstsPymLpgEditBase : SubaktivitasNilaiSfblstsPymLpg
    {
        ...
        // Constructor
        public SubaktivitasNilaiSfblstsPymLpgEditBase()
        {
        ...
        // Constructor
        public SubaktivitasNilaiSfblstsPymLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasNilaiSfblstsPymLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasNilaiSfblstsPymLpgList") {
                                ...
                                returnUrl = "SubaktivitasNilaiSfblstsPymLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
