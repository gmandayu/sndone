...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasHasilPemeriksaanEdit
    /// </summary>
    public static SubaktivitasHasilPemeriksaanEdit subaktivitasHasilPemeriksaanEdit
    {
        get => HttpData.Get<SubaktivitasHasilPemeriksaanEdit>("subaktivitasHasilPemeriksaanEdit")!;
        set => HttpData["subaktivitasHasilPemeriksaanEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasHasilPemeriksaan
    /// </summary>
    public class SubaktivitasHasilPemeriksaanEdit : SubaktivitasHasilPemeriksaanEditBase
    {
        // Constructor
        public SubaktivitasHasilPemeriksaanEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasHasilPemeriksaanEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasHasilPemeriksaanEditBase : SubaktivitasHasilPemeriksaan
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasHasilPemeriksaanEdit";
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubaktivitasHasilPemeriksaanEdit";
        ...
        // Constructor
        public SubaktivitasHasilPemeriksaanEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasHasilPemeriksaanList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasHasilPemeriksaanList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasHasilPemeriksaanList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasHasilPemeriksaanEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasHasilPemeriksaanList")), "", TableVar, true);
            string pageId = "edit";
