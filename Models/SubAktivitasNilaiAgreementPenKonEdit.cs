...
public partial class SnDOne {
    ...
    public class SubAktivitasNilaiAgreementPenKonEditBase : SubAktivitasNilaiAgreementPenKon
    {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenKonEditBase()
        {
        ...
        // Constructor
        public SubAktivitasNilaiAgreementPenKonEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasNilaiAgreementPenKonList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasNilaiAgreementPenKonList") {
                                ...
                                returnUrl = "SubAktivitasNilaiAgreementPenKonList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
