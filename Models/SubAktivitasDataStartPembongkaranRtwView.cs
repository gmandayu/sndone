...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStartPembongkaranRtwViewBase : SubAktivitasDataStartPembongkaranRtw
    {
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwViewBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasDataStartPembongkaranRtwList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasDataStartPembongkaranRtwList"); // Return to list page
                            }
                        }
                    break;
            }
