...
public partial class SnDOne {
    ...
    public class SubaktivitasKapalBerangkatEditBase : SubaktivitasKapalBerangkat
    {
        ...
        // Constructor
        public SubaktivitasKapalBerangkatEditBase()
        {
        ...
        // Constructor
        public SubaktivitasKapalBerangkatEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasKapalBerangkatList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasKapalBerangkatList") {
                                ...
                                returnUrl = "SubaktivitasKapalBerangkatList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
