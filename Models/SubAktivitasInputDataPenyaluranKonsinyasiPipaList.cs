...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputDataPenyaluranKonsinyasiPipaList
    /// </summary>
    public static SubAktivitasInputDataPenyaluranKonsinyasiPipaList subAktivitasInputDataPenyaluranKonsinyasiPipaList
    {
        get => HttpData.Get<SubAktivitasInputDataPenyaluranKonsinyasiPipaList>("subAktivitasInputDataPenyaluranKonsinyasiPipaList")!;
        set => HttpData["subAktivitasInputDataPenyaluranKonsinyasiPipaList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasInputDataPenyaluranKonsinyasiPipa
    /// </summary>
    public class SubAktivitasInputDataPenyaluranKonsinyasiPipaList : SubAktivitasInputDataPenyaluranKonsinyasiPipaListBase
    {
        // Constructor
        public SubAktivitasInputDataPenyaluranKonsinyasiPipaList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasInputDataPenyaluranKonsinyasiPipaList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasInputDataPenyaluranKonsinyasiPipaListBase : SubAktivitasInputDataPenyaluranKonsinyasiPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasInputDataPenyaluranKonsinyasiPipaList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasInputDataPenyaluranKonsinyasiPipalist";
        ...
        // Constructor
        public SubAktivitasInputDataPenyaluranKonsinyasiPipaListBase()
        {
            TableName = "SubAktivitasInputDataPenyaluranKonsinyasiPipa";

            // CSS class name as context
            TableVar = "SubAktivitasInputDataPenyaluranKonsinyasiPipa";
            ...
            // Table object (subAktivitasInputDataPenyaluranKonsinyasiPipa)
            if (subAktivitasInputDataPenyaluranKonsinyasiPipa == null || subAktivitasInputDataPenyaluranKonsinyasiPipa is SubAktivitasInputDataPenyaluranKonsinyasiPipa)
                subAktivitasInputDataPenyaluranKonsinyasiPipa = this;

            // Initialize URLs
            AddUrl = "SubAktivitasInputDataPenyaluranKonsinyasiPipaAdd";
            ...
            MultiDeleteUrl = "SubAktivitasInputDataPenyaluranKonsinyasiPipaDelete";
            MultiUpdateUrl = "SubAktivitasInputDataPenyaluranKonsinyasiPipaUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasInputDataPenyaluranKonsinyasiPipaList";
        ...
        public void SetVisibility()
        {
            ...
            NoUrut.SetVisibility();
            userInput.SetVisibility();
            etlDate.SetVisibility();
        }

        // Constructor
        public SubAktivitasInputDataPenyaluranKonsinyasiPipaListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        var result = new Dictionary<string, string> { {"url", GetUrl(url)}, {"modal", "1"} }; // Assume return to modal for simplicity
                            if (!SameString(pageName, ListUrl)) { // Not List page
                                ...
                                result.Add("view", pageName == "SubAktivitasInputDataPenyaluranKonsinyasiPipaView" ? "1" : "0"); // If View page, no primary button
                            } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasInputDataPenyaluranKonsinyasiPipagrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasInputDataPenyaluranKonsinyasiPipaList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(NoUrut.AdvancedSearch.ToJson())); // Field NoUrut
        ...
        protected bool RestoreFilterList() {
            ...
            // Field NoUrut
            if (filter?.TryGetValue("x_NoUrut", out sv) ?? false) {
                NoUrut.AdvancedSearch.SearchValue = sv;
                NoUrut.AdvancedSearch.SearchOperator = filter["z_NoUrut"];
                NoUrut.AdvancedSearch.SearchCondition = filter["v_NoUrut"];
                NoUrut.AdvancedSearch.SearchValue2 = filter["y_NoUrut"];
                NoUrut.AdvancedSearch.SearchOperator2 = filter["w_NoUrut"];
                NoUrut.AdvancedSearch.Save();
            }
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasInputDataPenyaluranKonsinyasiPipa"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasInputDataPenyaluranKonsinyasiPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasInputDataPenyaluranKonsinyasiPipalist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("NoUrut")); // DN
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasInputDataPenyaluranKonsinyasiPipasrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasInputDataPenyaluranKonsinyasiPipasrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasInputDataPenyaluranKonsinyasiPipalist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasInputDataPenyaluranKonsinyasiPipa");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasInputDataPenyaluranKonsinyasiPipaList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasInputDataPenyaluranKonsinyasiPipaList.RowCount) + "_SubAktivitasInputDataPenyaluranKonsinyasiPipa");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasInputDataPenyaluranKonsinyasiPipaList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasInputDataPenyaluranKonsinyasiPipaList.RowType == RowType.Add || IsEdit && subAktivitasInputDataPenyaluranKonsinyasiPipaList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("NoUrut", NoUrut.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                string curVal4 = ConvertToString(Produk.CurrentValue);
                if (!Empty(curVal4)) {
                    if (Produk.Lookup != null && IsDictionary(Produk.Lookup?.Options) && Produk.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                        Produk.ViewValue = Produk.LookupCacheOption(curVal4);
                    } else { // Lookup from database // DN
                        string filterWrk4 = SearchFilter(Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchExpression, "=", Produk.CurrentValue, Produk.Lookup?.GetTable()?.Fields["NoProduk"].SearchDataType, "");
                        string? sqlWrk4 = Produk.Lookup?.GetSql(false, filterWrk4, null, this, true, true);
                        ...
                        if (rswrk4?.Count > 0 && Produk.Lookup != null) { // Lookup values found
                            var listwrk = Produk.Lookup?.RenderViewRow(rswrk4[0]);
                ...
                // NoUrut
                NoUrut.ViewValue = ConvertToString(NoUrut.CurrentValue); // DN
                NoUrut.ViewCustomAttributes = "";
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasInputDataPenyaluranKonsinyasiPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasInputDataPenyaluranKonsinyasiPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasInputDataPenyaluranKonsinyasiPipalist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fSubAktivitasInputDataPenyaluranKonsinyasiPipalist\" data-ew-action=\"email\" data-custom=\"false\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasInputDataPenyaluranKonsinyasiPipasrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
