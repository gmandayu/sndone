...
public partial class SnDOne {
    /// <summary>
    /// userLevelPermissionsView
    /// </summary>
    public static UserLevelPermissionsView userLevelPermissionsView
    {
        get => HttpData.Get<UserLevelPermissionsView>("userLevelPermissionsView")!;
        set => HttpData["userLevelPermissionsView"] = value;
    }

    /// <summary>
    /// Page class for UserLevelPermissions
    /// </summary>
    public class UserLevelPermissionsView : UserLevelPermissionsViewBase
    {
        // Constructor
        public UserLevelPermissionsView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public UserLevelPermissionsView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class UserLevelPermissionsViewBase : UserLevelPermissions
    {
        // Page ID
        ...
        // Constructor
        public UserLevelPermissionsViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["UserLevelID"] = keys[0];
                if (keys.Length > 1)
                    RecordKeys["_TableName"] = keys[1];
            } else {
                RecordKeys["UserLevelID"] = RouteValues.TryGetValue("UserLevelID", out obj) && obj != null ? UrlDecode(obj) : Get("UserLevelID"); // DN
                RecordKeys["_TableName"] = RouteValues.TryGetValue("_TableName", out obj) && obj != null ? UrlDecode(obj) : Get("_TableName"); // DN
            }
        ...
        // Page name
        public string PageName => "UserLevelPermissionsView";
        ...
        // Constructor
        public UserLevelPermissionsViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("UserLevelID", out v) && !Empty(v)) { // DN
                UserLevelID.QueryValue = UrlDecode(v); // DN
                RecordKeys["UserLevelID"] = UserLevelID.QueryValue;
            } else if (Get("UserLevelID", out sv)) {
                UserLevelID.QueryValue = sv.ToString();
                RecordKeys["UserLevelID"] = UserLevelID.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                UserLevelID.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["UserLevelID"] = UserLevelID.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "UserLevelPermissionsList"; // Return to list
            }
            if (RouteValues.TryGetValue("_TableName", out v) && !Empty(v)) { // DN
                _TableName.QueryValue = UrlDecode(v); // DN
                RecordKeys["_TableName"] = _TableName.QueryValue;
            } else if (Get("_TableName", out sv)) {
                _TableName.QueryValue = sv.ToString();
                RecordKeys["_TableName"] = _TableName.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                _TableName.QueryValue = ConvertToString(keyValues[1]);
                RecordKeys["_TableName"] = _TableName.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "UserLevelPermissionsList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("UserLevelPermissionsList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                userLevelPermissionsView?.PageRender();
            }
            return PageResult();
        }
