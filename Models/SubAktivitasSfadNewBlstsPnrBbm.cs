...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasSfadNewBlstsPnrBbm
    /// </summary>
    [MaybeNull]
    public static SubAktivitasSfadNewBlstsPnrBbm subAktivitasSfadNewBlstsPnrBbm
    {
        get => HttpData.Resolve<SubAktivitasSfadNewBlstsPnrBbm>("SubAktivitasSFADNewBLSTSPnrBBM");
        set => HttpData["SubAktivitasSFADNewBLSTSPnrBBM"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasSFADNewBLSTSPnrBBM
    /// </summary>
    public class SubAktivitasSfadNewBlstsPnrBbm : DbTable
    {
        ...
        public readonly DbField<SqlDbType> ApakahAdaROB;

        public readonly DbField<SqlDbType> ApakahTerdapatROB;

        public readonly DbField<SqlDbType> Import;

        public readonly DbField<SqlDbType> Tujuan;

        public readonly DbField<SqlDbType> SFAD_klobs;

        public readonly DbField<SqlDbType> SFAD_kl15;

        public readonly DbField<SqlDbType> SFAD_barrels;

        public readonly DbField<SqlDbType> SFAD_lt;

        public readonly DbField<SqlDbType> SFAD_mt;

        public readonly DbField<SqlDbType> NewBl_klobs;

        public readonly DbField<SqlDbType> NewBl_kl15;

        public readonly DbField<SqlDbType> NewBl_barrels;

        public readonly DbField<SqlDbType> NewBl_lt;

        public readonly DbField<SqlDbType> NewBl_mt;

        public readonly DbField<SqlDbType> AR45B_klobs;

        public readonly DbField<SqlDbType> AR45B_kl15;

        public readonly DbField<SqlDbType> AR45B_barrels;

        public readonly DbField<SqlDbType> AR45B_lt;

        public readonly DbField<SqlDbType> AR45B_mt;
        ...
        // Constructor
        public SubAktivitasSfadNewBlstsPnrBbm()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasSFADNewBLSTSPnrBBM";
            Name = "SubAktivitasSFADNewBLSTSPnrBBM";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasSFADNewBLSTSPnrBBM"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            // ApakahAdaROB
            ApakahAdaROB = new(this, "x_ApakahAdaROB", 202, SqlDbType.NVarChar) {
                Name = "ApakahAdaROB",
                Expression = "[ApakahAdaROB]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ApakahAdaROB]",
                DateTimeFormat = -1,
                VirtualExpression = "[ApakahAdaROB]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "ApakahAdaROB", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ApakahAdaROB", ApakahAdaROB);

            // ApakahTerdapatROB
            ApakahTerdapatROB = new(this, "x_ApakahTerdapatROB", 11, SqlDbType.Bit) {
                Name = "ApakahTerdapatROB",
                Expression = "[ApakahTerdapatROB]",
                BasicSearchExpression = "[ApakahTerdapatROB]",
                DateTimeFormat = -1,
                VirtualExpression = "[ApakahTerdapatROB]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "ApakahTerdapatROB", "CustomMsg"),
                IsUpload = false
            };
            ApakahTerdapatROB.Raw = true;
            ApakahTerdapatROB.Lookup = new Lookup<DbField>(ApakahTerdapatROB, "SubAktivitasSFADNewBLSTSPnrBBM", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ApakahTerdapatROB.UserValues = ["1"];
            Fields.Add("ApakahTerdapatROB", ApakahTerdapatROB);

            // Import
            Import = new(this, "x_Import", 11, SqlDbType.Bit) {
                Name = "Import",
                Expression = "[Import]",
                BasicSearchExpression = "[Import]",
                DateTimeFormat = -1,
                VirtualExpression = "[Import]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "Import", "CustomMsg"),
                IsUpload = false
            };
            Import.Raw = true;
            Import.Lookup = new Lookup<DbField>(Import, "SubAktivitasSFADNewBLSTSPnrBBM", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Import.UserValues = ["1"];
            Fields.Add("Import", Import);

            // Tujuan
            Tujuan = new(this, "x_Tujuan", 3, SqlDbType.Int) {
                Name = "Tujuan",
                Expression = "[Tujuan]",
                BasicSearchExpression = "CAST([Tujuan] AS NVARCHAR)",
                DateTimeFormat = -1,
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "Tujuan", "CustomMsg"),
                IsUpload = false
            };
            Tujuan.Raw = true;
            Tujuan.Lookup = new Lookup<DbField>(Tujuan, "MasterPlant", false, "IdPlant", new List<string> {"Plant", "Nama_Terminal", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "CONCAT([Plant],'" + ValueSeparator(1, Tujuan) + "',[Nama_Terminal])");
            Fields.Add("Tujuan", Tujuan);

            // SFAD_klobs
            SFAD_klobs = new(this, "x_SFAD_klobs", 202, SqlDbType.NVarChar) {
                Name = "SFAD_klobs",
                Expression = "[SFAD_klobs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAD_klobs]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAD_klobs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "SFAD_klobs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAD_klobs", SFAD_klobs);

            // SFAD_kl15
            SFAD_kl15 = new(this, "x_SFAD_kl15", 202, SqlDbType.NVarChar) {
                Name = "SFAD_kl15",
                Expression = "[SFAD_kl15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAD_kl15]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAD_kl15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "SFAD_kl15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAD_kl15", SFAD_kl15);

            // SFAD_barrels
            SFAD_barrels = new(this, "x_SFAD_barrels", 202, SqlDbType.NVarChar) {
                Name = "SFAD_barrels",
                Expression = "[SFAD_barrels]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAD_barrels]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAD_barrels]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "SFAD_barrels", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAD_barrels", SFAD_barrels);

            // SFAD_lt
            SFAD_lt = new(this, "x_SFAD_lt", 202, SqlDbType.NVarChar) {
                Name = "SFAD_lt",
                Expression = "[SFAD_lt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAD_lt]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAD_lt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "SFAD_lt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAD_lt", SFAD_lt);

            // SFAD_mt
            SFAD_mt = new(this, "x_SFAD_mt", 202, SqlDbType.NVarChar) {
                Name = "SFAD_mt",
                Expression = "[SFAD_mt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[SFAD_mt]",
                DateTimeFormat = -1,
                VirtualExpression = "[SFAD_mt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "SFAD_mt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("SFAD_mt", SFAD_mt);

            // NewBl_klobs
            NewBl_klobs = new(this, "x_NewBl_klobs", 202, SqlDbType.NVarChar) {
                Name = "NewBl_klobs",
                Expression = "[NewBl_klobs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NewBl_klobs]",
                DateTimeFormat = -1,
                VirtualExpression = "[NewBl_klobs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "NewBl_klobs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NewBl_klobs", NewBl_klobs);

            // NewBl_kl15
            NewBl_kl15 = new(this, "x_NewBl_kl15", 202, SqlDbType.NVarChar) {
                Name = "NewBl_kl15",
                Expression = "[NewBl_kl15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NewBl_kl15]",
                DateTimeFormat = -1,
                VirtualExpression = "[NewBl_kl15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "NewBl_kl15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NewBl_kl15", NewBl_kl15);

            // NewBl_barrels
            NewBl_barrels = new(this, "x_NewBl_barrels", 202, SqlDbType.NVarChar) {
                Name = "NewBl_barrels",
                Expression = "[NewBl_barrels]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NewBl_barrels]",
                DateTimeFormat = -1,
                VirtualExpression = "[NewBl_barrels]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "NewBl_barrels", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NewBl_barrels", NewBl_barrels);

            // NewBl_lt
            NewBl_lt = new(this, "x_NewBl_lt", 202, SqlDbType.NVarChar) {
                Name = "NewBl_lt",
                Expression = "[NewBl_lt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NewBl_lt]",
                DateTimeFormat = -1,
                VirtualExpression = "[NewBl_lt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "NewBl_lt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NewBl_lt", NewBl_lt);

            // NewBl_mt
            NewBl_mt = new(this, "x_NewBl_mt", 202, SqlDbType.NVarChar) {
                Name = "NewBl_mt",
                Expression = "[NewBl_mt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NewBl_mt]",
                DateTimeFormat = -1,
                VirtualExpression = "[NewBl_mt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "NewBl_mt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NewBl_mt", NewBl_mt);

            // AR45B_klobs
            AR45B_klobs = new(this, "x_AR45B_klobs", 202, SqlDbType.NVarChar) {
                Name = "AR45B_klobs",
                Expression = "[AR45B_klobs]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AR45B_klobs]",
                DateTimeFormat = -1,
                VirtualExpression = "[AR45B_klobs]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "AR45B_klobs", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AR45B_klobs", AR45B_klobs);

            // AR45B_kl15
            AR45B_kl15 = new(this, "x_AR45B_kl15", 202, SqlDbType.NVarChar) {
                Name = "AR45B_kl15",
                Expression = "[AR45B_kl15]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AR45B_kl15]",
                DateTimeFormat = -1,
                VirtualExpression = "[AR45B_kl15]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "AR45B_kl15", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AR45B_kl15", AR45B_kl15);

            // AR45B_barrels
            AR45B_barrels = new(this, "x_AR45B_barrels", 202, SqlDbType.NVarChar) {
                Name = "AR45B_barrels",
                Expression = "[AR45B_barrels]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AR45B_barrels]",
                DateTimeFormat = -1,
                VirtualExpression = "[AR45B_barrels]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "AR45B_barrels", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AR45B_barrels", AR45B_barrels);

            // AR45B_lt
            AR45B_lt = new(this, "x_AR45B_lt", 202, SqlDbType.NVarChar) {
                Name = "AR45B_lt",
                Expression = "[AR45B_lt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AR45B_lt]",
                DateTimeFormat = -1,
                VirtualExpression = "[AR45B_lt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "AR45B_lt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AR45B_lt", AR45B_lt);

            // AR45B_mt
            AR45B_mt = new(this, "x_AR45B_mt", 202, SqlDbType.NVarChar) {
                Name = "AR45B_mt",
                Expression = "[AR45B_mt]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AR45B_mt]",
                DateTimeFormat = -1,
                VirtualExpression = "[AR45B_mt]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "AR45B_mt", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AR45B_mt", AR45B_mt);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBLSTSPnrBBM", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasSFADNewBLSTSPnrBBM";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasSfadnewBlstspnrBbm type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                ApakahAdaROB.DbValue = row["ApakahAdaROB"]; // Set DB value only
                ApakahTerdapatROB.DbValue = (ConvertToBool(row["ApakahTerdapatROB"]) ? "1" : "0"); // Set DB value only
                Import.DbValue = (ConvertToBool(row["Import"]) ? "1" : "0"); // Set DB value only
                Tujuan.DbValue = row["Tujuan"]; // Set DB value only
                SFAD_klobs.DbValue = row["SFAD_klobs"]; // Set DB value only
                SFAD_kl15.DbValue = row["SFAD_kl15"]; // Set DB value only
                SFAD_barrels.DbValue = row["SFAD_barrels"]; // Set DB value only
                SFAD_lt.DbValue = row["SFAD_lt"]; // Set DB value only
                SFAD_mt.DbValue = row["SFAD_mt"]; // Set DB value only
                NewBl_klobs.DbValue = row["NewBl_klobs"]; // Set DB value only
                NewBl_kl15.DbValue = row["NewBl_kl15"]; // Set DB value only
                NewBl_barrels.DbValue = row["NewBl_barrels"]; // Set DB value only
                NewBl_lt.DbValue = row["NewBl_lt"]; // Set DB value only
                NewBl_mt.DbValue = row["NewBl_mt"]; // Set DB value only
                AR45B_klobs.DbValue = row["AR45B_klobs"]; // Set DB value only
                AR45B_kl15.DbValue = row["AR45B_kl15"]; // Set DB value only
                AR45B_barrels.DbValue = row["AR45B_barrels"]; // Set DB value only
                AR45B_lt.DbValue = row["AR45B_lt"]; // Set DB value only
                AR45B_mt.DbValue = row["AR45B_mt"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasSfadNewBlstsPnrBbmList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasSfadNewBlstsPnrBbmView" => Language.Phrase("View"),
                "SubAktivitasSfadNewBlstsPnrBbmEdit" => Language.Phrase("Edit"),
                "SubAktivitasSfadNewBlstsPnrBbmAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasSfadNewBlstsPnrBbmView",
                Config.ApiAddAction => "SubAktivitasSfadNewBlstsPnrBbmAdd",
                Config.ApiEditAction => "SubAktivitasSfadNewBlstsPnrBbmEdit",
                Config.ApiDeleteAction => "SubAktivitasSfadNewBlstsPnrBbmDelete",
                Config.ApiListAction => "SubAktivitasSfadNewBlstsPnrBbmList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasSfadNewBlstsPnrBbmList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasSfadNewBlstsPnrBbmView", parm);
            else
                url = KeyUrl("SubAktivitasSfadNewBlstsPnrBbmView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasSfadNewBlstsPnrBbmAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasSfadNewBlstsPnrBbmAdd?" + parm;
            else
                url = "SubAktivitasSfadNewBlstsPnrBbmAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasSfadNewBlstsPnrBbmEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasSfadNewBlstsPnrBbmList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasSfadNewBlstsPnrBbmAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasSfadNewBlstsPnrBbmList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasSfadNewBlstsPnrBbmDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasSfadNewBlstsPnrBbmList";
        ...
        public async Task RenderListRow()
        {
            ...
            idAktifitas.ViewValue = Empty(curVal2) ? DbNullValue : FormatNumber(idAktifitas.CurrentValue, idAktifitas.FormatPattern);
            if (!Empty(curVal2)) {
            ...
            StatusAktivitas.ViewValue = Empty(curVal3) ? DbNullValue : FormatNumber(StatusAktivitas.CurrentValue, StatusAktivitas.FormatPattern);
            if (!Empty(curVal3)) {
            ...
            Tujuan.ViewValue = Empty(curVal6) ? DbNullValue : FormatNumber(Tujuan.CurrentValue, Tujuan.FormatPattern);
            if (!Empty(curVal6)) {
            ...
            ApakahTerdapatROB.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // ApakahAdaROB
            ApakahAdaROB.SetupEditAttributes();
            if (!ApakahAdaROB.Raw)
                ApakahAdaROB.CurrentValue = HtmlDecode(ApakahAdaROB.CurrentValue);
            ApakahAdaROB.EditValue = ApakahAdaROB.CurrentValue;
            ...
            SFAD_klobs.EditValue = SFAD_klobs.CurrentValue;
            ...
            SFAD_kl15.EditValue = SFAD_kl15.CurrentValue;
            ...
            SFAD_barrels.EditValue = SFAD_barrels.CurrentValue;
            ...
            SFAD_lt.EditValue = SFAD_lt.CurrentValue;
            ...
            SFAD_mt.EditValue = SFAD_mt.CurrentValue;
            ...
            NewBl_klobs.EditValue = NewBl_klobs.CurrentValue;
            ...
            NewBl_kl15.EditValue = NewBl_kl15.CurrentValue;
            ...
            NewBl_barrels.EditValue = NewBl_barrels.CurrentValue;
            ...
            NewBl_lt.EditValue = NewBl_lt.CurrentValue;
            ...
            NewBl_mt.EditValue = NewBl_mt.CurrentValue;
            ...
            AR45B_klobs.EditValue = AR45B_klobs.CurrentValue;
            ...
            AR45B_kl15.EditValue = AR45B_kl15.CurrentValue;
            ...
            AR45B_barrels.EditValue = AR45B_barrels.CurrentValue;
            ...
            AR45B_lt.EditValue = AR45B_lt.CurrentValue;
            ...
            AR45B_mt.EditValue = AR45B_mt.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(ApakahAdaROB);
                        doc.ExportCaption(ApakahTerdapatROB);
                        doc.ExportCaption(Import);
                        doc.ExportCaption(Tujuan);
                        doc.ExportCaption(SFAD_klobs);
                        doc.ExportCaption(SFAD_kl15);
                        doc.ExportCaption(SFAD_barrels);
                        doc.ExportCaption(SFAD_lt);
                        doc.ExportCaption(SFAD_mt);
                        doc.ExportCaption(NewBl_klobs);
                        doc.ExportCaption(NewBl_kl15);
                        doc.ExportCaption(NewBl_barrels);
                        doc.ExportCaption(NewBl_lt);
                        doc.ExportCaption(NewBl_mt);
                        doc.ExportCaption(AR45B_klobs);
                        doc.ExportCaption(AR45B_kl15);
                        doc.ExportCaption(AR45B_barrels);
                        doc.ExportCaption(AR45B_lt);
                        doc.ExportCaption(AR45B_mt);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(ApakahAdaROB);
                            await doc.ExportField(ApakahTerdapatROB);
                            await doc.ExportField(Import);
                            await doc.ExportField(Tujuan);
                            await doc.ExportField(SFAD_klobs);
                            await doc.ExportField(SFAD_kl15);
                            await doc.ExportField(SFAD_barrels);
                            await doc.ExportField(SFAD_lt);
                            await doc.ExportField(SFAD_mt);
                            await doc.ExportField(NewBl_klobs);
                            await doc.ExportField(NewBl_kl15);
                            await doc.ExportField(NewBl_barrels);
                            await doc.ExportField(NewBl_lt);
                            await doc.ExportField(NewBl_mt);
                            await doc.ExportField(AR45B_klobs);
                            await doc.ExportField(AR45B_kl15);
                            await doc.ExportField(AR45B_barrels);
                            await doc.ExportField(AR45B_lt);
                            await doc.ExportField(AR45B_mt);
