...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputDataStopPembongkaranAdd
    /// </summary>
    public static SubAktivitasFormInputDataStopPembongkaranAdd subAktivitasFormInputDataStopPembongkaranAdd
    {
        get => HttpData.Get<SubAktivitasFormInputDataStopPembongkaranAdd>("subAktivitasFormInputDataStopPembongkaranAdd")!;
        set => HttpData["subAktivitasFormInputDataStopPembongkaranAdd"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputDataStopPembongkaran
    /// </summary>
    public class SubAktivitasFormInputDataStopPembongkaranAdd : SubAktivitasFormInputDataStopPembongkaranAddBase
    {
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputDataStopPembongkaranAddBase : SubAktivitasFormInputDataStopPembongkaran
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputDataStopPembongkaranAdd";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranAddBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputDataStopPembongkaranAdd";
        ...
        // Constructor
        public SubAktivitasFormInputDataStopPembongkaranAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasFormInputDataStopPembongkaranList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "SubAktivitasFormInputDataStopPembongkaranView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputDataStopPembongkaranList") {
                                ...
                                returnUrl = "SubAktivitasFormInputDataStopPembongkaranList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputDataStopPembongkaranAdd?.PageRender();
            }
            return PageResult();
        }
