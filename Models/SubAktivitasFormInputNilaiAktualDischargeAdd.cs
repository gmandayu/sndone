...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputNilaiAktualDischargeAddBase : SubAktivitasFormInputNilaiAktualDischarge
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeAddBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktualDischargeAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasFormInputNilaiAktualDischargeList"); // No matching record, return to List page // DN
                    }
                    break;
