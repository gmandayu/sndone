...
public partial class SnDOne {
    ...
    public class PenimbunanSearchBase : Penimbunan
    {
        ...
        // Constructor
        public PenimbunanSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected void LoadSearchValues() {
            ...
            // NomorPenimbunan
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_NomorPenimbunan"))
            ...
            // LookupPenerimaan
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_LookupPenerimaan"))
                    LookupPenerimaan.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_LookupPenerimaan", Config.FilterOptionSeparator);
            if (Form.ContainsKey("z_LookupPenerimaan"))
                LookupPenerimaan.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_LookupPenerimaan", Config.FilterOptionSeparator);

            // IdPenerimaan
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_IdPenerimaan"))
