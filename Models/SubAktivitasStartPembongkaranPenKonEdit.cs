...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasStartPembongkaranPenKonEdit
    /// </summary>
    public static SubAktivitasStartPembongkaranPenKonEdit subAktivitasStartPembongkaranPenKonEdit
    {
        get => HttpData.Get<SubAktivitasStartPembongkaranPenKonEdit>("subAktivitasStartPembongkaranPenKonEdit")!;
        set => HttpData["subAktivitasStartPembongkaranPenKonEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasStartPembongkaranPenKon
    /// </summary>
    public class SubAktivitasStartPembongkaranPenKonEdit : SubAktivitasStartPembongkaranPenKonEditBase
    {
        // Constructor
        public SubAktivitasStartPembongkaranPenKonEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasStartPembongkaranPenKonEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasStartPembongkaranPenKonEditBase : SubAktivitasStartPembongkaranPenKon
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasStartPembongkaranPenKonEdit";
        ...
        // Constructor
        public SubAktivitasStartPembongkaranPenKonEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasStartPembongkaranPenKonEdit";
        ...
        // Constructor
        public SubAktivitasStartPembongkaranPenKonEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasStartPembongkaranPenKonList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasStartPembongkaranPenKonList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasStartPembongkaranPenKonList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasStartPembongkaranPenKonEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasStartPembongkaranPenKonList")), "", TableVar, true);
            string pageId = "edit";
