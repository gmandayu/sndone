...
public partial class SnDOne {
    /// <summary>
    /// pengujianSampleLainnyaDelete
    /// </summary>
    public static PengujianSampleLainnyaDelete pengujianSampleLainnyaDelete
    {
        get => HttpData.Get<PengujianSampleLainnyaDelete>("pengujianSampleLainnyaDelete")!;
        set => HttpData["pengujianSampleLainnyaDelete"] = value;
    }

    /// <summary>
    /// Page class for PengujianSampleLainnya
    /// </summary>
    public class PengujianSampleLainnyaDelete : PengujianSampleLainnyaDeleteBase
    {
        // Constructor
        public PengujianSampleLainnyaDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public PengujianSampleLainnyaDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class PengujianSampleLainnyaDeleteBase : PengujianSampleLainnya
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "pengujianSampleLainnyaDelete";
        ...
        // Constructor
        public PengujianSampleLainnyaDeleteBase()
        {
        ...
        // Page name
        public string PageName => "PengujianSampleLainnyaDelete";
        ...
        // Constructor
        public PengujianSampleLainnyaDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("PengujianSampleLainnyaList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("PengujianSampleLainnyaList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                pengujianSampleLainnyaDelete?.PageRender();
            }
            return PageResult();
        }
