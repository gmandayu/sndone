...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataMobilTangkiMtGateInEdit
    /// </summary>
    public static SubAktivitasDataMobilTangkiMtGateInEdit subAktivitasDataMobilTangkiMtGateInEdit
    {
        get => HttpData.Get<SubAktivitasDataMobilTangkiMtGateInEdit>("subAktivitasDataMobilTangkiMtGateInEdit")!;
        set => HttpData["subAktivitasDataMobilTangkiMtGateInEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataMobilTangkiMTGateIn
    /// </summary>
    public class SubAktivitasDataMobilTangkiMtGateInEdit : SubAktivitasDataMobilTangkiMtGateInEditBase
    {
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataMobilTangkiMtGateInEditBase : SubAktivitasDataMobilTangkiMtGateIn
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataMobilTangkiMtGateInEdit";
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataMobilTangkiMtGateInEdit";
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateInEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasDataMobilTangkiMtGateInList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasDataMobilTangkiMtGateInList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasDataMobilTangkiMtGateInList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasDataMobilTangkiMtGateInEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        private void ValidateCustomNoReferensi() {
            if (NoReferensi.Visible && NoReferensi.Required) {
                if (!NoReferensi.IsDetailKey && Empty(NoReferensi.FormValue)) {
                    NoReferensi.AddErrorMessage(ConvertToString(WaktuGateIn.RequiredErrorMessage).Replace("%s", WaktuGateIn.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidProses() {
            if (idProses.Visible && idProses.Required) {
                if (!idProses.IsDetailKey && Empty(idProses.FormValue)) {
                    idProses.AddErrorMessage(ConvertToString(WaktuGateIn.RequiredErrorMessage).Replace("%s", WaktuGateIn.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidAktifitas() {
            if (idAktifitas.Visible && idAktifitas.Required) {
                if (!idAktifitas.IsDetailKey && Empty(idAktifitas.FormValue)) {
                    idAktifitas.AddErrorMessage(ConvertToString(WaktuGateIn.RequiredErrorMessage).Replace("%s", WaktuGateIn.Caption));
                }
            }
        }
        ...
        private void ValidateCustomStatusAktivitas() {
            if (StatusAktivitas.Visible && StatusAktivitas.Required) {
                if (!StatusAktivitas.IsDetailKey && Empty(StatusAktivitas.FormValue)) {
                    StatusAktivitas.AddErrorMessage(ConvertToString(WaktuGateIn.RequiredErrorMessage).Replace("%s", WaktuGateIn.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLastUpdatedBy() {
            if (LastUpdatedBy.Visible && LastUpdatedBy.Required) {
                if (!LastUpdatedBy.IsDetailKey && Empty(LastUpdatedBy.FormValue)) {
                    LastUpdatedBy.AddErrorMessage(ConvertToString(WaktuGateIn.RequiredErrorMessage).Replace("%s", WaktuGateIn.Caption));
                }
            }
        }
        ...
        private void ValidateCustomlastUpdatedDate() {
            if (lastUpdatedDate.Visible && lastUpdatedDate.Required) {
                if (!lastUpdatedDate.IsDetailKey && Empty(lastUpdatedDate.FormValue)) {
                    lastUpdatedDate.AddErrorMessage(ConvertToString(WaktuGateIn.RequiredErrorMessage).Replace("%s", WaktuGateIn.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNomorPolisi() {
            if (NomorPolisi.Visible && NomorPolisi.Required) {
                if (!NomorPolisi.IsDetailKey && Empty(NomorPolisi.FormValue)) {
                    NomorPolisi.AddErrorMessage(ConvertToString(WaktuGateIn.RequiredErrorMessage).Replace("%s", WaktuGateIn.Caption));
                }
            }
        }
        ...
        private void ValidateCustomAMT() {
            if (AMT.Visible && AMT.Required) {
                if (!AMT.IsDetailKey && Empty(AMT.FormValue)) {
                    AMT.AddErrorMessage(ConvertToString(WaktuGateIn.RequiredErrorMessage).Replace("%s", WaktuGateIn.Caption));
                }
            }
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasDataMobilTangkiMtGateInList")), "", TableVar, true);
            string pageId = "edit";
