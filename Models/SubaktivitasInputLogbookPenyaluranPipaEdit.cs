...
public partial class SnDOne {
    ...
    public class SubaktivitasInputLogbookPenyaluranPipaEditBase : SubaktivitasInputLogbookPenyaluranPipa
    {
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaEditBase()
        {
        ...
        // Constructor
        public SubaktivitasInputLogbookPenyaluranPipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasInputLogbookPenyaluranPipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasInputLogbookPenyaluranPipaList") {
                                ...
                                returnUrl = "SubaktivitasInputLogbookPenyaluranPipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
