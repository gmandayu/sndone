...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static GoodHouseKeeping goodHouseKeeping
    {
        get => HttpData.Resolve<GoodHouseKeeping>("GoodHouseKeeping");
        set => HttpData["GoodHouseKeeping"] = value;
    }

    /// <summary>
    /// Table class for GoodHouseKeeping
    /// </summary>
    public class GoodHouseKeeping : DbTable
    {
        public override Dictionary<string, string> KeyFields { get; set; } = new() { // DN
            { "IdGoodHouseKeeping", "IdGoodHouseKeeping" },
        };
        ...
        public readonly DbField<SqlDbType> IdGoodHouseKeeping;

        public readonly DbField<SqlDbType> NomorGoodHouseKeeping;
        ...
        // Constructor
        public GoodHouseKeeping()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "GoodHouseKeeping";
            Name = "GoodHouseKeeping";
            Type = "TABLE";
            UpdateTable = "dbo.GoodHouseKeeping"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // IdGoodHouseKeeping
            IdGoodHouseKeeping = new(this, "x_IdGoodHouseKeeping", 3, SqlDbType.Int) {
                Name = "IdGoodHouseKeeping",
                Expression = "[IdGoodHouseKeeping]",
                BasicSearchExpression = "CAST([IdGoodHouseKeeping] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[IdGoodHouseKeeping]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("GoodHouseKeeping", "IdGoodHouseKeeping", "CustomMsg"),
                IsUpload = false
            };
            IdGoodHouseKeeping.Raw = true;
            Fields.Add("IdGoodHouseKeeping", IdGoodHouseKeeping);

            // NomorGoodHouseKeeping
            NomorGoodHouseKeeping = new(this, "x_NomorGoodHouseKeeping", 202, SqlDbType.NVarChar) {
                Name = "NomorGoodHouseKeeping",
                Expression = "[NomorGoodHouseKeeping]",
                BasicSearchExpression = "[NomorGoodHouseKeeping]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorGoodHouseKeeping]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("GoodHouseKeeping", "NomorGoodHouseKeeping", "CustomMsg"),
                IsUpload = false
            };
            NomorGoodHouseKeeping.GetLinkPrefix = () => "FormInputGoodHouseKeepingList?showmaster=GoodHouseKeeping&fk_NomorGoodHouseKeeping=";
            Fields.Add("NomorGoodHouseKeeping", NomorGoodHouseKeeping);

            // LinkRedirect
            LinkRedirect = new(this, "x_LinkRedirect", 202, SqlDbType.NVarChar) {
                Name = "LinkRedirect",
                Expression = "'<a href=FormInputGoodHouseKeepingList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorGoodHouseKeeping AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorGoodHouseKeeping AS NVARCHAR(50))+'</a>'",
                UseBasicSearch = true,
                BasicSearchExpression = "'<a href=FormInputGoodHouseKeepingList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorGoodHouseKeeping AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorGoodHouseKeeping AS NVARCHAR(50))+'</a>'",
                DateTimeFormat = -1,
                VirtualExpression = "'<a href=FormInputGoodHouseKeepingList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorGoodHouseKeeping AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorGoodHouseKeeping AS NVARCHAR(50))+'</a>'",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("GoodHouseKeeping", "LinkRedirect", "CustomMsg"),
                IsUpload = false
            };
            LinkRedirect.Lookup = new Lookup<DbField>(LinkRedirect, "GoodHouseKeeping", true, "LinkRedirect", new List<string> {"LinkRedirect", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LookupPlant = new(this, "x_LookupPlant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("GoodHouseKeeping", "LookupPlant", "CustomMsg"),
                IsUpload = false
            };
            LookupPlant.Raw = true;
            LookupPlant.Lookup = new Lookup<DbField>(LookupPlant, "GoodHouseKeeping", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Plant = new(this, "x_Plant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("GoodHouseKeeping", "Plant", "CustomMsg"),
                IsUpload = false
            };
            Plant.Raw = true;
            ...
            Catatan = new(this, "x_Catatan", 203, SqlDbType.NText) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("GoodHouseKeeping", "Catatan", "CustomMsg"),
                IsUpload = false
            };
            Catatan.Lookup = new Lookup<DbField>(Catatan, "GoodHouseKeeping", true, "Catatan", new List<string> {"Catatan", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DibuatOleh = new(this, "x_DibuatOleh", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("GoodHouseKeeping", "DibuatOleh", "CustomMsg"),
                IsUpload = false
            };
            DibuatOleh.Lookup = new Lookup<DbField>(DibuatOleh, "GoodHouseKeeping", true, "DibuatOleh", new List<string> {"DibuatOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDibuat = new(this, "x_TanggalDibuat", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("GoodHouseKeeping", "TanggalDibuat", "CustomMsg"),
                IsUpload = false
            };
            TanggalDibuat.Raw = true;
            TanggalDibuat.Lookup = new Lookup<DbField>(TanggalDibuat, "GoodHouseKeeping", true, "TanggalDibuat", new List<string> {"TanggalDibuat", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            DiperbaruiOleh = new(this, "x_DiperbaruiOleh", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("GoodHouseKeeping", "DiperbaruiOleh", "CustomMsg"),
                IsUpload = false
            };
            DiperbaruiOleh.Lookup = new Lookup<DbField>(DiperbaruiOleh, "GoodHouseKeeping", true, "DiperbaruiOleh", new List<string> {"DiperbaruiOleh", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            TanggalDiperbarui = new(this, "x_TanggalDiperbarui", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("GoodHouseKeeping", "TanggalDiperbarui", "CustomMsg"),
                IsUpload = false
            };
            TanggalDiperbarui.Raw = true;
            TanggalDiperbarui.Lookup = new Lookup<DbField>(TanggalDiperbarui, "GoodHouseKeeping", true, "TanggalDiperbarui", new List<string> {"TanggalDiperbarui", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            TanggalDiperbarui.GetAutoUpdateValue = () => CurrentDateTime();
            TanggalDiperbarui.GetDefault = () => CurrentUserName();
        ...
        {
            get => _sqlFrom ?? "dbo.GoodHouseKeeping";
            set => _sqlFrom = value;
        }
        ...
        {
            get {
                string select = "*, '<a href=FormInputGoodHouseKeepingList?cmd=search&x_NoReferensi%5B%5D='+ CAST(NomorGoodHouseKeeping AS NVARCHAR(50)) +'&search=&searchtype=>'+ CAST(NomorGoodHouseKeeping AS NVARCHAR(50))+'</a>' AS [LinkRedirect]";
                if (select == "*") {
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.GoodHouseKeeping type", "data");
            row = row.Where(kvp => {
            ...
            try {
                ...
                if (row.ContainsKey("IdGoodHouseKeeping"))
                    row["IdGoodHouseKeeping"] = lastInsertedId;
                else
                    row.Add("IdGoodHouseKeeping", lastInsertedId);
                IdGoodHouseKeeping.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                IdGoodHouseKeeping.DbValue = row["IdGoodHouseKeeping"]; // Set DB value only
                NomorGoodHouseKeeping.DbValue = row["NomorGoodHouseKeeping"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[IdGoodHouseKeeping] = @IdGoodHouseKeeping@";
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "GoodHouseKeepingView" => Language.Phrase("View"),
                "GoodHouseKeepingEdit" => Language.Phrase("Edit"),
                "GoodHouseKeepingAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "GoodHouseKeepingView",
                Config.ApiAddAction => "GoodHouseKeepingAdd",
                Config.ApiEditAction => "GoodHouseKeepingEdit",
                Config.ApiDeleteAction => "GoodHouseKeepingDelete",
                Config.ApiListAction => "GoodHouseKeepingList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "GoodHouseKeepingList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("GoodHouseKeepingView", parm);
            else
                url = KeyUrl("GoodHouseKeepingView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "GoodHouseKeepingAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "GoodHouseKeepingAdd?" + parm;
            else
                url = "GoodHouseKeepingAdd";
        ...
        {
            string url = "";
            url = KeyUrl("GoodHouseKeepingEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("GoodHouseKeepingList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("GoodHouseKeepingAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("GoodHouseKeepingList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("GoodHouseKeepingDelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"IdGoodHouseKeeping\":" + ConvertToJson(IdGoodHouseKeeping.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        {
            if (!IsNull(IdGoodHouseKeeping.CurrentValue)) {
                url += "/" + IdGoodHouseKeeping.CurrentValue;
            } else {
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("IdGoodHouseKeeping", out object? v0)) { // IdGoodHouseKeeping // DN
                    key = UrlDecode(v0); // DN
                } else if (IsApi() && !Empty(keyValues)) {
                    key = keyValues[0];
                } else {
                    key = Param("IdGoodHouseKeeping");
                }
                keysList.Add(key);
            }
            // Check keys
            foreach (var keys in keysList) {
                if (KeyFields.Count > 1 && (!IsArray(keys) || keys.Length != KeyFields.Count))
                    continue;
                if (!IsNumeric(keys)) // IdGoodHouseKeeping
                    continue;
                result.Add(keys);
            }
            return result;
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    IdGoodHouseKeeping.CurrentValue = keys;
                else
                    IdGoodHouseKeeping.OldValue = keys;
        ...
        public void LoadListRowValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            IdGoodHouseKeeping.SetDbValue(row["IdGoodHouseKeeping"]);
            NomorGoodHouseKeeping.SetDbValue(row["NomorGoodHouseKeeping"]);
        ...
        {
            string pageName = "GoodHouseKeepingList";
        ...
        public async Task RenderListRow()
        {
            ...
            // IdGoodHouseKeeping
            IdGoodHouseKeeping.ViewValue = IdGoodHouseKeeping.CurrentValue;
            IdGoodHouseKeeping.ViewCustomAttributes = "";

            // NomorGoodHouseKeeping
            NomorGoodHouseKeeping.ViewValue = ConvertToString(NomorGoodHouseKeeping.CurrentValue); // DN
            NomorGoodHouseKeeping.ViewCustomAttributes = "";
            ...
            // IdGoodHouseKeeping
            IdGoodHouseKeeping.HrefValue = "";
            IdGoodHouseKeeping.TooltipValue = "";

            // NomorGoodHouseKeeping
            if (!IsNull(NomorGoodHouseKeeping.CurrentValue)) {
                NomorGoodHouseKeeping.HrefValue = NomorGoodHouseKeeping.GetLinkPrefix() + ConvertToString(!Empty(NomorGoodHouseKeeping.ViewValue) && !IsList(NomorGoodHouseKeeping.ViewValue) ? RemoveHtml(ConvertToString(NomorGoodHouseKeeping.ViewValue)) : ConvertToString(NomorGoodHouseKeeping.CurrentValue)); // Add prefix/suffix
                NomorGoodHouseKeeping.LinkAttrs["target"] = ""; // Add target
                if (IsExport())
                    NomorGoodHouseKeeping.HrefValue = FullUrl(ConvertToString(NomorGoodHouseKeeping.HrefValue), "href");
            } else {
                NomorGoodHouseKeeping.HrefValue = "";
            }
            NomorGoodHouseKeeping.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // IdGoodHouseKeeping
            IdGoodHouseKeeping.SetupEditAttributes();
            IdGoodHouseKeeping.EditValue = IdGoodHouseKeeping.CurrentValue;
            IdGoodHouseKeeping.ViewCustomAttributes = "";

            // NomorGoodHouseKeeping
            NomorGoodHouseKeeping.SetupEditAttributes();
            NomorGoodHouseKeeping.EditValue = ConvertToString(NomorGoodHouseKeeping.CurrentValue); // DN
            NomorGoodHouseKeeping.ViewCustomAttributes = "";
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(IdGoodHouseKeeping);
                        doc.ExportCaption(NomorGoodHouseKeeping);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(IdGoodHouseKeeping);
                            await doc.ExportField(NomorGoodHouseKeeping);
        ...
        // Row Inserting event for GoodHouseKeeping
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew)
        {
            try {
                // Ambil IdPlant dari field Plant (nilai SELECT adalah IdPlant)
                var idPlant = rsnew["Plant"].ToString();

                // Panggil SP untuk generate nomor GHK
                var nomorObj = ExecuteScalar($"EXEC dbo.GenerateNomorGoodHouseKeeping @IdPlant = {idPlant}");
                if (nomorObj == null)
                    throw new Exception("Gagal menghasilkan NomorGoodHouseKeeping.");
                string nomorGhk = nomorObj.ToString();
                rsnew["NomorGoodHouseKeeping"] = nomorGhk;
                ...
                Log("Error in GoodHouseKeeping Row_Inserting: " + ex.Message);
                CancelMessage = "Gagal menyimpan data GHK: " + ex.Message;
                return false;
            }
            return true;
        }
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew)
        {
            try {
                ...
                Log("Error in GoodHouseKeeping Row_Updating: " + ex.Message);
        ...
        public bool RowDeleting(Dictionary<string, object> rs) {
            string NoReferensi = rs.ContainsKey("NomorGoodHouseKeeping") ? rs["NomorGoodHouseKeeping"].ToString() : "";
            if (string.IsNullOrEmpty(NoReferensi)) {
                SuccessMessage = "Data Good House Keeping berhasil dihapus, namun gagal menghapus data Form Input Good House Keeping";
                return true;
            }
            using (SqlConnection sqlConnection = GetConnection("Db").OpenConnection()) {
                string sqlData = "DELETE FROM FormInputGoodHouseKeeping WHERE NoReferensi = @NoReferensi;";
