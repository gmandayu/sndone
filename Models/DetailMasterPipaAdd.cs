...
public partial class SnDOne {
    ...
    /// detailMasterPipaAdd
    /// </summary>
    public static DetailMasterPipaAdd detailMasterPipaAdd
    {
        get => HttpData.Get<DetailMasterPipaAdd>("detailMasterPipaAdd")!;
        set => HttpData["detailMasterPipaAdd"] = value;
    }

    /// <summary>
    /// Page class for DetailMasterPipa
    /// </summary>
    public class DetailMasterPipaAdd : DetailMasterPipaAddBase
    {
        // Constructor
        public DetailMasterPipaAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public DetailMasterPipaAdd() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class DetailMasterPipaAddBase : DetailMasterPipa
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "detailMasterPipaAdd";
        ...
        // Constructor
        public DetailMasterPipaAddBase()
        {
        ...
        // Page name
        public string PageName => "DetailMasterPipaAdd";
        ...
        // Constructor
        public DetailMasterPipaAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("DetailMasterPipaList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "DetailMasterPipaView")
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                detailMasterPipaAdd?.PageRender();
            }
            return PageResult();
        }
        ...
        protected Dictionary<string, object> GetAddRow()
        {
            try {
                ...
                // idPlantTujuan
                idPlantTujuan.SetDbValue(rsnew, idPlantTujuan.CurrentValue);

                // Panjang
                Panjang.SetDbValue(rsnew, Panjang.CurrentValue);

                // Diameter
                Diameter.SetDbValue(rsnew, Diameter.CurrentValue);
        ...
        private void RestoreAddFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("idPlantTujuan", out value)) // idPlantTujuan
                idPlantTujuan.SetFormValue(ConvertToString(value));
            if (row.TryGetValue("Panjang", out value)) // Panjang
                Panjang.SetFormValue(ConvertToString(value));
            if (row.TryGetValue("Diameter", out value)) // Diameter
                Diameter.SetFormValue(ConvertToString(value));
