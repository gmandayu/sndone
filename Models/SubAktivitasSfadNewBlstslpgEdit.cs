...
public partial class SnDOne {
    ...
    public class SubAktivitasSfadNewBlstslpgEditBase : SubAktivitasSfadNewBlstslpg
    {
        ...
        // Constructor
        public SubAktivitasSfadNewBlstslpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasSfadNewBlstslpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasSfadNewBlstslpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasSfadNewBlstslpgList") {
                                ...
                                returnUrl = "SubAktivitasSfadNewBlstslpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
