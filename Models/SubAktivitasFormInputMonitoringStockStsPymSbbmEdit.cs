...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputMonitoringStockStsPymSbbmEditBase : SubAktivitasFormInputMonitoringStockStsPymSbbm
    {
        ...
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSbbmEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputMonitoringStockStsPymSbbmEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputMonitoringStockStsPymSbbmList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputMonitoringStockStsPymSbbmList") {
                                ...
                                returnUrl = "SubAktivitasFormInputMonitoringStockStsPymSbbmList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
