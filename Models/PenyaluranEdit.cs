...
public partial class SnDOne {
    ...
    public class PenyaluranEditBase : Penyaluran
    {
        ...
        // Constructor
        public PenyaluranEditBase(Controller? controller)
        {
        ...
        // Constructor
        public PenyaluranEditBase() : this(null) { }
        ...
        private async Task<ActionSetupResult> SetupCurrentAction()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("IdPenyaluran", out rv)) {
                    IdPenyaluran.FormValue = UrlDecode(rv);
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'NomorPenyaluran'
            NomorPenyaluran.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(NomorPenyaluran, "NomorPenyaluran", "x_NomorPenyaluran");
        ...
        private void ValidateCustomNomorPenyaluran() {
            if (NomorPenyaluran.Visible && NomorPenyaluran.Required) {
                if (!NomorPenyaluran.IsDetailKey && Empty(NomorPenyaluran.FormValue)) {
                    NomorPenyaluran.AddErrorMessage(ConvertToString(MultipleQuantity.RequiredErrorMessage).Replace("%s", MultipleQuantity.Caption));
                }
            }
        }
