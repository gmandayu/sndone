...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasSfadNewBl
    /// </summary>
    [MaybeNull]
    public static SubAktivitasSfadNewBl subAktivitasSfadNewBl
    {
        get => HttpData.Resolve<SubAktivitasSfadNewBl>("SubAktivitasSFADNewBL");
        set => HttpData["SubAktivitasSFADNewBL"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasSFADNewBL
    /// </summary>
    public class SubAktivitasSfadNewBl : DbTable
    {
        ...
        // Constructor
        public SubAktivitasSfadNewBl()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasSFADNewBL";
            Name = "SubAktivitasSFADNewBL";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasSFADNewBL"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            ApakahAdaROB = new(this, "x_ApakahAdaROB", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "ApakahAdaROB", "CustomMsg"),
                IsUpload = false
            };
            ...
            Import = new(this, "x_Import", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "Import", "CustomMsg"),
                IsUpload = false
            };
            Import.Raw = true;
            Import.Lookup = new Lookup<DbField>(Import, "SubAktivitasSFADNewBL", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Import.UserValues = ["1"];
            ...
            ApakahTerdapatROB = new(this, "x_ApakahTerdapatROB", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "ApakahTerdapatROB", "CustomMsg"),
                IsUpload = false
            };
            ApakahTerdapatROB.Raw = true;
            ApakahTerdapatROB.Lookup = new Lookup<DbField>(ApakahTerdapatROB, "SubAktivitasSFADNewBL", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Tujuan = new(this, "x_Tujuan", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "Tujuan", "CustomMsg"),
                IsUpload = false
            };
            Tujuan.Raw = true;
            ...
            SFAD_klobs = new(this, "x_SFAD_klobs", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "SFAD_klobs", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_kl15 = new(this, "x_SFAD_kl15", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "SFAD_kl15", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_barrels = new(this, "x_SFAD_barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "SFAD_barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_lt = new(this, "x_SFAD_lt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "SFAD_lt", "CustomMsg"),
                IsUpload = false
            };
            ...
            SFAD_mt = new(this, "x_SFAD_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "SFAD_mt", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBl_klobs = new(this, "x_NewBl_klobs", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "NewBl_klobs", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBl_kl15 = new(this, "x_NewBl_kl15", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "NewBl_kl15", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBl_barrels = new(this, "x_NewBl_barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "NewBl_barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBl_lt = new(this, "x_NewBl_lt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "NewBl_lt", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewBl_mt = new(this, "x_NewBl_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "NewBl_mt", "CustomMsg"),
                IsUpload = false
            };
            ...
            AR45B_klobs = new(this, "x_AR45B_klobs", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "AR45B_klobs", "CustomMsg"),
                IsUpload = false
            };
            ...
            AR45B_kl15 = new(this, "x_AR45B_kl15", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "AR45B_kl15", "CustomMsg"),
                IsUpload = false
            };
            ...
            AR45B_barrels = new(this, "x_AR45B_barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "AR45B_barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            AR45B_lt = new(this, "x_AR45B_lt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "AR45B_lt", "CustomMsg"),
                IsUpload = false
            };
            ...
            AR45B_mt = new(this, "x_AR45B_mt", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasSFADNewBL", "AR45B_mt", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasSFADNewBL";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasSfadnewBl type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasSfadNewBlList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasSfadNewBlView" => Language.Phrase("View"),
                "SubAktivitasSfadNewBlEdit" => Language.Phrase("Edit"),
                "SubAktivitasSfadNewBlAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasSfadNewBlView",
                Config.ApiAddAction => "SubAktivitasSfadNewBlAdd",
                Config.ApiEditAction => "SubAktivitasSfadNewBlEdit",
                Config.ApiDeleteAction => "SubAktivitasSfadNewBlDelete",
                Config.ApiListAction => "SubAktivitasSfadNewBlList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasSfadNewBlList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasSfadNewBlView", parm);
            else
                url = KeyUrl("SubAktivitasSfadNewBlView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasSfadNewBlAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasSfadNewBlAdd?" + parm;
            else
                url = "SubAktivitasSfadNewBlAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasSfadNewBlEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasSfadNewBlList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasSfadNewBlAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasSfadNewBlList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasSfadNewBlDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasSfadNewBlList";
        ...
        public async Task RenderListRow()
        {
            ...
            idProses.ViewValue = Empty(curVal2) ? DbNullValue : FormatNumber(idProses.CurrentValue, idProses.FormatPattern);
            if (!Empty(curVal2)) {
            ...
            // awallookupbung
            string curVal7 = ConvertToString(Tujuan.CurrentValue);
            Tujuan.ViewValue = Empty(curVal7) ? DbNullValue : Tujuan.CurrentValue;
            if (!Empty(curVal7)) {
                if (Tujuan.Lookup != null && IsDictionary(Tujuan.Lookup?.Options) && Tujuan.Lookup?.Options.Values.Count > 0) { // Load from cache // DN
                    Tujuan.ViewValue = Tujuan.LookupCacheOption(curVal7);
                } else { // Lookup from database // DN
                    string filterWrk7 = SearchFilter(Tujuan.Lookup?.GetTable()?.Fields["IdPlant"].SearchExpression, "=", Tujuan.CurrentValue, Tujuan.Lookup?.GetTable()?.Fields["IdPlant"].SearchDataType, "");
                    string? sqlWrk7 = Tujuan.Lookup?.GetSql(false, filterWrk7, null, this, true, true);
                    ...
                    if (rswrk7?.Count > 0 && Tujuan.Lookup != null) { // Lookup values found
                        var listwrk = Tujuan.Lookup?.RenderViewRow(rswrk7[0]);
