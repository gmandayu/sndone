...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputFlowrateRtwDelete
    /// </summary>
    public static SubAktivitasFormInputFlowrateRtwDelete subAktivitasFormInputFlowrateRtwDelete
    {
        get => HttpData.Get<SubAktivitasFormInputFlowrateRtwDelete>("subAktivitasFormInputFlowrateRtwDelete")!;
        set => HttpData["subAktivitasFormInputFlowrateRtwDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputFlowrateRTW
    /// </summary>
    public class SubAktivitasFormInputFlowrateRtwDelete : SubAktivitasFormInputFlowrateRtwDeleteBase
    {
        // Constructor
        public SubAktivitasFormInputFlowrateRtwDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputFlowrateRtwDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputFlowrateRtwDeleteBase : SubAktivitasFormInputFlowrateRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputFlowrateRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateRtwDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputFlowrateRtwDelete";
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateRtwDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasFormInputFlowrateRtwList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasFormInputFlowrateRtwList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputFlowrateRtwDelete?.PageRender();
            }
            return PageResult();
        }
