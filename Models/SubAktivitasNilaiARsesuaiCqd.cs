...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiARsesuaiCqd
    /// </summary>
    [MaybeNull]
    public static SubAktivitasNilaiARsesuaiCqd subAktivitasNilaiARsesuaiCqd
    {
        get => HttpData.Resolve<SubAktivitasNilaiARsesuaiCqd>("SubAktivitasNilaiARsesuaiCQD");
        set => HttpData["SubAktivitasNilaiARsesuaiCQD"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasNilaiARsesuaiCQD
    /// </summary>
    public class SubAktivitasNilaiARsesuaiCqd : DbTable
    {
        ...
        // Constructor
        public SubAktivitasNilaiARsesuaiCqd()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasNilaiARsesuaiCQD";
            Name = "SubAktivitasNilaiARsesuaiCQD";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasNilaiARsesuaiCQD"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            KL_Obs = new(this, "x_KL_Obs", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "KL_Obs", "CustomMsg"),
                IsUpload = false
            };
            ...
            KL_15 = new(this, "x_KL_15", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "KL_15", "CustomMsg"),
                IsUpload = false
            };
            ...
            Barrels = new(this, "x_Barrels", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "Barrels", "CustomMsg"),
                IsUpload = false
            };
            ...
            LT = new(this, "x_LT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "LT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("LT", LT);
            ...
            MT = new(this, "x_MT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "MT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("MT", MT);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasNilaiARsesuaiCQD", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasNilaiARsesuaiCQD";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasNilaiArsesuaiCqd type", "data");
            row = row.Where(kvp => {
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasNilaiARsesuaiCqdList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasNilaiARsesuaiCqdView" => Language.Phrase("View"),
                "SubAktivitasNilaiARsesuaiCqdEdit" => Language.Phrase("Edit"),
                "SubAktivitasNilaiARsesuaiCqdAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasNilaiARsesuaiCqdView",
                Config.ApiAddAction => "SubAktivitasNilaiARsesuaiCqdAdd",
                Config.ApiEditAction => "SubAktivitasNilaiARsesuaiCqdEdit",
                Config.ApiDeleteAction => "SubAktivitasNilaiARsesuaiCqdDelete",
                Config.ApiListAction => "SubAktivitasNilaiARsesuaiCqdList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasNilaiARsesuaiCqdList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasNilaiARsesuaiCqdView", parm);
            else
                url = KeyUrl("SubAktivitasNilaiARsesuaiCqdView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasNilaiARsesuaiCqdAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasNilaiARsesuaiCqdAdd?" + parm;
            else
                url = "SubAktivitasNilaiARsesuaiCqdAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiARsesuaiCqdEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiARsesuaiCqdList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasNilaiARsesuaiCqdAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasNilaiARsesuaiCqdList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasNilaiARsesuaiCqdDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasNilaiARsesuaiCqdList";
