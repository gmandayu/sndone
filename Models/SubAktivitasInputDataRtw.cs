...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static SubAktivitasInputDataRtw subAktivitasInputDataRtw
    {
        get => HttpData.Resolve<SubAktivitasInputDataRtw>("SubAktivitasInputDataRTW");
        set => HttpData["SubAktivitasInputDataRTW"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasInputDataRTW
    /// </summary>
    public class SubAktivitasInputDataRtw : DbTable
    {
        ...
        public readonly DbField<SqlDbType> NomorGerbongKertel;

        public readonly DbField<SqlDbType> MeterAwal;

        public readonly DbField<SqlDbType> MeterAkhir;
        ...
        public readonly DbField<SqlDbType> NoMeter;

        public readonly DbField<SqlDbType> Quantity;

        public readonly DbField<SqlDbType> HasilPengukuranT2;

        public readonly DbField<SqlDbType> PICPengisian;

        public readonly DbField<SqlDbType> NomorGerbongKertel2;

        public readonly DbField<SqlDbType> NomorGerbongKertel3;

        public readonly DbField<SqlDbType> Quantity2;

        public readonly DbField<SqlDbType> Quantity3;

        public readonly DbField<SqlDbType> HasilPengukuranT2_2;

        public readonly DbField<SqlDbType> HasilPengukuranT2_3;

        public readonly DbField<SqlDbType> TotalGK;

        public readonly DbField<SqlDbType> Selisih;

        // Constructor
        public SubAktivitasInputDataRtw()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasInputDataRTW";
            Name = "SubAktivitasInputDataRTW";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasInputDataRTW"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            Produk = new(this, "x_Produk", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "Produk", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            // NomorGerbongKertel
            NomorGerbongKertel = new(this, "x_NomorGerbongKertel", 202, SqlDbType.NVarChar) {
                Name = "NomorGerbongKertel",
                Expression = "[NomorGerbongKertel]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NomorGerbongKertel]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorGerbongKertel]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "NomorGerbongKertel", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NomorGerbongKertel", NomorGerbongKertel);
            ...
            MeterAwal = new(this, "x_MeterAwal", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "MeterAwal", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("MeterAwal", MeterAwal);

            // MeterAkhir
            MeterAkhir = new(this, "x_MeterAkhir", 202, SqlDbType.NVarChar) {
                Name = "MeterAkhir",
                Expression = "[MeterAkhir]",
                UseBasicSearch = true,
                BasicSearchExpression = "[MeterAkhir]",
                DateTimeFormat = -1,
                VirtualExpression = "[MeterAkhir]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "MeterAkhir", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("MeterAkhir", MeterAkhir);

            // Total
            Total = new(this, "x_Total", 202, SqlDbType.NVarChar) {
                Name = "Total",
                Expression = "[Total]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Total]",
                DateTimeFormat = -1,
                VirtualExpression = "[Total]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "Total", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            // NoMeter
            NoMeter = new(this, "x_NoMeter", 202, SqlDbType.NVarChar) {
                Name = "NoMeter",
                Expression = "[NoMeter]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NoMeter]",
                DateTimeFormat = -1,
                VirtualExpression = "[NoMeter]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "NoMeter", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NoMeter", NoMeter);
            ...
            Quantity = new(this, "x_Quantity", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "Quantity", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Quantity", Quantity);

            // HasilPengukuranT2
            HasilPengukuranT2 = new(this, "x_HasilPengukuranT2", 202, SqlDbType.NVarChar) {
                Name = "HasilPengukuranT2",
                Expression = "[HasilPengukuranT2]",
                UseBasicSearch = true,
                BasicSearchExpression = "[HasilPengukuranT2]",
                DateTimeFormat = -1,
                VirtualExpression = "[HasilPengukuranT2]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "HasilPengukuranT2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("HasilPengukuranT2", HasilPengukuranT2);

            // PICPengisian
            PICPengisian = new(this, "x_PICPengisian", 202, SqlDbType.NVarChar) {
                Name = "PICPengisian",
                Expression = "[PICPengisian]",
                UseBasicSearch = true,
                BasicSearchExpression = "[PICPengisian]",
                DateTimeFormat = -1,
                VirtualExpression = "[PICPengisian]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "PICPengisian", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("PICPengisian", PICPengisian);

            // NomorGerbongKertel2
            NomorGerbongKertel2 = new(this, "x_NomorGerbongKertel2", 202, SqlDbType.NVarChar) {
                Name = "NomorGerbongKertel2",
                Expression = "[NomorGerbongKertel2]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NomorGerbongKertel2]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorGerbongKertel2]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "NomorGerbongKertel2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NomorGerbongKertel2", NomorGerbongKertel2);

            // NomorGerbongKertel3
            NomorGerbongKertel3 = new(this, "x_NomorGerbongKertel3", 202, SqlDbType.NVarChar) {
                Name = "NomorGerbongKertel3",
                Expression = "[NomorGerbongKertel3]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NomorGerbongKertel3]",
                DateTimeFormat = -1,
                VirtualExpression = "[NomorGerbongKertel3]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "NomorGerbongKertel3", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NomorGerbongKertel3", NomorGerbongKertel3);

            // Quantity2
            Quantity2 = new(this, "x_Quantity2", 202, SqlDbType.NVarChar) {
                Name = "Quantity2",
                Expression = "[Quantity2]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Quantity2]",
                DateTimeFormat = -1,
                VirtualExpression = "[Quantity2]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "Quantity2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Quantity2", Quantity2);

            // Quantity3
            Quantity3 = new(this, "x_Quantity3", 202, SqlDbType.NVarChar) {
                Name = "Quantity3",
                Expression = "[Quantity3]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Quantity3]",
                DateTimeFormat = -1,
                VirtualExpression = "[Quantity3]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "Quantity3", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Quantity3", Quantity3);

            // HasilPengukuranT2_2
            HasilPengukuranT2_2 = new(this, "x_HasilPengukuranT2_2", 202, SqlDbType.NVarChar) {
                Name = "HasilPengukuranT2_2",
                Expression = "[HasilPengukuranT2_2]",
                UseBasicSearch = true,
                BasicSearchExpression = "[HasilPengukuranT2_2]",
                DateTimeFormat = -1,
                VirtualExpression = "[HasilPengukuranT2_2]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "HasilPengukuranT2_2", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("HasilPengukuranT2_2", HasilPengukuranT2_2);

            // HasilPengukuranT2_3
            HasilPengukuranT2_3 = new(this, "x_HasilPengukuranT2_3", 202, SqlDbType.NVarChar) {
                Name = "HasilPengukuranT2_3",
                Expression = "[HasilPengukuranT2_3]",
                UseBasicSearch = true,
                BasicSearchExpression = "[HasilPengukuranT2_3]",
                DateTimeFormat = -1,
                VirtualExpression = "[HasilPengukuranT2_3]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "HasilPengukuranT2_3", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("HasilPengukuranT2_3", HasilPengukuranT2_3);

            // TotalGK
            TotalGK = new(this, "x_TotalGK", 202, SqlDbType.NVarChar) {
                Name = "TotalGK",
                Expression = "[TotalGK]",
                UseBasicSearch = true,
                BasicSearchExpression = "[TotalGK]",
                DateTimeFormat = -1,
                VirtualExpression = "[TotalGK]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "TotalGK", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("TotalGK", TotalGK);

            // Selisih
            Selisih = new(this, "x_Selisih", 202, SqlDbType.NVarChar) {
                Name = "Selisih",
                Expression = "[Selisih]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Selisih]",
                DateTimeFormat = -1,
                VirtualExpression = "[Selisih]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasInputDataRTW", "Selisih", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Selisih", Selisih);
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasInputDataRTW";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasInputDataRtw type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                NomorGerbongKertel.DbValue = row["NomorGerbongKertel"]; // Set DB value only
                MeterAwal.DbValue = row["MeterAwal"]; // Set DB value only
                MeterAkhir.DbValue = row["MeterAkhir"]; // Set DB value only
                ...
                NoMeter.DbValue = row["NoMeter"]; // Set DB value only
                Quantity.DbValue = row["Quantity"]; // Set DB value only
                HasilPengukuranT2.DbValue = row["HasilPengukuranT2"]; // Set DB value only
                PICPengisian.DbValue = row["PICPengisian"]; // Set DB value only
                NomorGerbongKertel2.DbValue = row["NomorGerbongKertel2"]; // Set DB value only
                NomorGerbongKertel3.DbValue = row["NomorGerbongKertel3"]; // Set DB value only
                Quantity2.DbValue = row["Quantity2"]; // Set DB value only
                Quantity3.DbValue = row["Quantity3"]; // Set DB value only
                HasilPengukuranT2_2.DbValue = row["HasilPengukuranT2_2"]; // Set DB value only
                HasilPengukuranT2_3.DbValue = row["HasilPengukuranT2_3"]; // Set DB value only
                TotalGK.DbValue = row["TotalGK"]; // Set DB value only
                Selisih.DbValue = row["Selisih"]; // Set DB value only
            } catch {}
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasInputDataRtwList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasInputDataRtwView" => Language.Phrase("View"),
                "SubAktivitasInputDataRtwEdit" => Language.Phrase("Edit"),
                "SubAktivitasInputDataRtwAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasInputDataRtwView",
                Config.ApiAddAction => "SubAktivitasInputDataRtwAdd",
                Config.ApiEditAction => "SubAktivitasInputDataRtwEdit",
                Config.ApiDeleteAction => "SubAktivitasInputDataRtwDelete",
                Config.ApiListAction => "SubAktivitasInputDataRtwList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasInputDataRtwList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasInputDataRtwView", parm);
            else
                url = KeyUrl("SubAktivitasInputDataRtwView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasInputDataRtwAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasInputDataRtwAdd?" + parm;
            else
                url = "SubAktivitasInputDataRtwAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasInputDataRtwEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasInputDataRtwList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasInputDataRtwAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasInputDataRtwList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasInputDataRtwDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasInputDataRtwList";
        ...
        public async Task RenderEditRow()
        {
            ...
            NomorGerbongKertel.EditValue = NomorGerbongKertel.CurrentValue;
            ...
            MeterAkhir.EditValue = MeterAkhir.CurrentValue;
            ...
            NoMeter.EditValue = NoMeter.CurrentValue;
            ...
            HasilPengukuranT2.EditValue = HasilPengukuranT2.CurrentValue;
            ...
            PICPengisian.EditValue = PICPengisian.CurrentValue;
            ...
            NomorGerbongKertel2.EditValue = NomorGerbongKertel2.CurrentValue;
            ...
            NomorGerbongKertel3.EditValue = NomorGerbongKertel3.CurrentValue;
            ...
            Quantity2.EditValue = Quantity2.CurrentValue;
            ...
            Quantity3.EditValue = Quantity3.CurrentValue;
            ...
            HasilPengukuranT2_2.EditValue = HasilPengukuranT2_2.CurrentValue;
            ...
            HasilPengukuranT2_3.EditValue = HasilPengukuranT2_3.CurrentValue;
            ...
            TotalGK.EditValue = TotalGK.CurrentValue;
            ...
            Selisih.EditValue = Selisih.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(NomorGerbongKertel);
                        doc.ExportCaption(MeterAwal);
                        doc.ExportCaption(MeterAkhir);
                        doc.ExportCaption(Total);
                        doc.ExportCaption(userInput);
                        doc.ExportCaption(etlDate);
                        doc.ExportCaption(NoMeter);
                        doc.ExportCaption(Quantity);
                        doc.ExportCaption(HasilPengukuranT2);
                        doc.ExportCaption(PICPengisian);
                        doc.ExportCaption(NomorGerbongKertel2);
                        doc.ExportCaption(NomorGerbongKertel3);
                        doc.ExportCaption(Quantity2);
                        doc.ExportCaption(Quantity3);
                        doc.ExportCaption(HasilPengukuranT2_2);
                        doc.ExportCaption(HasilPengukuranT2_3);
                        doc.ExportCaption(TotalGK);
                        doc.ExportCaption(Selisih);
                    } else {
                        doc.ExportCaption(id);
                        doc.ExportCaption(idAktifitas);
                        doc.ExportCaption(idProses);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(NomorGerbongKertel);
                            await doc.ExportField(MeterAwal);
                            await doc.ExportField(MeterAkhir);
                            await doc.ExportField(Total);
                            await doc.ExportField(userInput);
                            await doc.ExportField(etlDate);
                            await doc.ExportField(NoMeter);
                            await doc.ExportField(Quantity);
                            await doc.ExportField(HasilPengukuranT2);
                            await doc.ExportField(PICPengisian);
                            await doc.ExportField(NomorGerbongKertel2);
                            await doc.ExportField(NomorGerbongKertel3);
                            await doc.ExportField(Quantity2);
                            await doc.ExportField(Quantity3);
                            await doc.ExportField(HasilPengukuranT2_2);
                            await doc.ExportField(HasilPengukuranT2_3);
                            await doc.ExportField(TotalGK);
                            await doc.ExportField(Selisih);
                        } else {
                            await doc.ExportField(id);
                            await doc.ExportField(idAktifitas);
                            await doc.ExportField(idProses);
