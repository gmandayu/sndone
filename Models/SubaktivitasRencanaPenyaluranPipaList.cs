...
public partial class SnDOne {
    ...
    public class SubaktivitasRencanaPenyaluranPipaListBase : SubaktivitasRencanaPenyaluranPipa
    {
        ...
        // Constructor
        public SubaktivitasRencanaPenyaluranPipaListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubaktivitasRencanaPenyaluranPipaListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            if (filter.TryGetValue("x_RencanaPenyaluran2", out sv)) {
                RestoreFieldFilter(RencanaPenyaluran2, filter, "RencanaPenyaluran2", sv);
            }
