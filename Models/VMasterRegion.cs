...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static VMasterRegion vMasterRegion
    {
        get => HttpData.Resolve<VMasterRegion>("VMasterRegion");
        set => HttpData["VMasterRegion"] = value;
    }

    /// <summary>
    /// Table class for VMasterRegion
    /// </summary>
    public class VMasterRegion : DbTable
    {
        ...
        // Constructor
        public VMasterRegion()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "VMasterRegion";
            Name = "VMasterRegion";
            Type = "VIEW";
            UpdateTable = "dbo.VMasterRegion"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Region = new(this, "x_Region", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("VMasterRegion", "Region", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.VMasterRegion";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.VmasterRegion type", "data");
            row = row.Where(kvp => {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "VMasterRegionView" => Language.Phrase("View"),
                "VMasterRegionEdit" => Language.Phrase("Edit"),
                "VMasterRegionAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "VMasterRegionView",
                Config.ApiAddAction => "VMasterRegionAdd",
                Config.ApiEditAction => "VMasterRegionEdit",
                Config.ApiDeleteAction => "VMasterRegionDelete",
                Config.ApiListAction => "VMasterRegionList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "VMasterRegionList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("VMasterRegionView", parm);
            else
                url = KeyUrl("VMasterRegionView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "VMasterRegionAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "VMasterRegionAdd?" + parm;
            else
                url = "VMasterRegionAdd";
        ...
        {
            string url = "";
            url = KeyUrl("VMasterRegionEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("VMasterRegionList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("VMasterRegionAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("VMasterRegionList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("VMasterRegionDelete", parm)); // DN
        }
        ...
        {
            string pageName = "VMasterRegionList";
