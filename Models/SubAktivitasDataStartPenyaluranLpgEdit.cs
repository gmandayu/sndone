...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStartPenyaluranLpgEditBase : SubAktivitasDataStartPenyaluranLpg
    {
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStartPenyaluranLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStartPenyaluranLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStartPenyaluranLpgList") {
                                ...
                                returnUrl = "SubAktivitasDataStartPenyaluranLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
