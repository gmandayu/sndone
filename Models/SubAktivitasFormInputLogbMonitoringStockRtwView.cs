...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputLogbMonitoringStockRtwViewBase : SubAktivitasFormInputLogbMonitoringStockRtw
    {
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwViewBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputLogbMonitoringStockRtwViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputLogbMonitoringStockRtwList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputLogbMonitoringStockRtwList"); // Return to list page
                            }
                        }
                    break;
            }
