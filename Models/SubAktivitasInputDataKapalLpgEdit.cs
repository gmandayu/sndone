...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasInputDataKapalLpgEdit
    /// </summary>
    public static SubAktivitasInputDataKapalLpgEdit subAktivitasInputDataKapalLpgEdit
    {
        get => HttpData.Get<SubAktivitasInputDataKapalLpgEdit>("subAktivitasInputDataKapalLpgEdit")!;
        set => HttpData["subAktivitasInputDataKapalLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasInputDataKapalLPG
    /// </summary>
    public class SubAktivitasInputDataKapalLpgEdit : SubAktivitasInputDataKapalLpgEditBase
    {
        // Constructor
        public SubAktivitasInputDataKapalLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasInputDataKapalLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasInputDataKapalLpgEditBase : SubAktivitasInputDataKapalLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasInputDataKapalLpgEdit";
        ...
        // Constructor
        public SubAktivitasInputDataKapalLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasInputDataKapalLpgEdit";
        ...
        // Constructor
        public SubAktivitasInputDataKapalLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasInputDataKapalLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasInputDataKapalLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasInputDataKapalLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasInputDataKapalLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasInputDataKapalLpgList")), "", TableVar, true);
            string pageId = "edit";
