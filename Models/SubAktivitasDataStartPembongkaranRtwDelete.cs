...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataStartPembongkaranRtwDelete
    /// </summary>
    public static SubAktivitasDataStartPembongkaranRtwDelete subAktivitasDataStartPembongkaranRtwDelete
    {
        get => HttpData.Get<SubAktivitasDataStartPembongkaranRtwDelete>("subAktivitasDataStartPembongkaranRtwDelete")!;
        set => HttpData["subAktivitasDataStartPembongkaranRtwDelete"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasDataStartPembongkaranRTW
    /// </summary>
    public class SubAktivitasDataStartPembongkaranRtwDelete : SubAktivitasDataStartPembongkaranRtwDeleteBase
    {
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasDataStartPembongkaranRtwDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasDataStartPembongkaranRtwDeleteBase : SubAktivitasDataStartPembongkaranRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasDataStartPembongkaranRtwDelete";
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwDeleteBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasDataStartPembongkaranRtwDelete";
        ...
        // Constructor
        public SubAktivitasDataStartPembongkaranRtwDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("SubAktivitasDataStartPembongkaranRtwList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("SubAktivitasDataStartPembongkaranRtwList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasDataStartPembongkaranRtwDelete?.PageRender();
            }
            return PageResult();
        }
