...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputLogbookPenerimaanTruckView
    /// </summary>
    public static SubAktivitasFormInputLogbookPenerimaanTruckView subAktivitasFormInputLogbookPenerimaanTruckView
    {
        get => HttpData.Get<SubAktivitasFormInputLogbookPenerimaanTruckView>("subAktivitasFormInputLogbookPenerimaanTruckView")!;
        set => HttpData["subAktivitasFormInputLogbookPenerimaanTruckView"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputLogbookPenerimaanTruck
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanTruckView : SubAktivitasFormInputLogbookPenerimaanTruckViewBase
    {
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanTruckView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanTruckView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputLogbookPenerimaanTruckViewBase : SubAktivitasFormInputLogbookPenerimaanTruck
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputLogbookPenerimaanTruckView";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanTruckViewBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputLogbookPenerimaanTruckView";
        ...
        // Constructor
        public SubAktivitasFormInputLogbookPenerimaanTruckViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            if (!loadCurrentRecord)
                returnUrl = "SubAktivitasFormInputLogbookPenerimaanTruckList";
        }
        ...
        private void PageRunEnd()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputLogbookPenerimaanTruckView?.PageRender();
            }
        }
        ...
        private IActionResult NoRecordResult()
        {
            ...
            return Terminate("SubAktivitasFormInputLogbookPenerimaanTruckList");
        }
