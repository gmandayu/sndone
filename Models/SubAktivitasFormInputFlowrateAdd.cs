...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputFlowrateAdd
    /// </summary>
    public static SubAktivitasFormInputFlowrateAdd subAktivitasFormInputFlowrateAdd
    {
        get => HttpData.Get<SubAktivitasFormInputFlowrateAdd>("subAktivitasFormInputFlowrateAdd")!;
        set => HttpData["subAktivitasFormInputFlowrateAdd"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputFlowrate
    /// </summary>
    public class SubAktivitasFormInputFlowrateAdd : SubAktivitasFormInputFlowrateAddBase
    {
        // Constructor
        public SubAktivitasFormInputFlowrateAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputFlowrateAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputFlowrateAddBase : SubAktivitasFormInputFlowrate
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputFlowrateAdd";
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateAddBase()
        {
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputFlowrateAdd";
        ...
        // Constructor
        public SubAktivitasFormInputFlowrateAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasFormInputFlowrateList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = ReturnUrl;
                        if (GetPageName(returnUrl) == "SubAktivitasFormInputFlowrateList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "SubAktivitasFormInputFlowrateView")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputFlowrateList") {
                                ...
                                returnUrl = "SubAktivitasFormInputFlowrateList"; // Return list page content
                            }
                        }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputFlowrateAdd?.PageRender();
            }
            return PageResult();
        }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasFormInputFlowrateList")), "", TableVar, true);
