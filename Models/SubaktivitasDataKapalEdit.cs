...
public partial class SnDOne {
    ...
    public class SubaktivitasDataKapalEditBase : SubaktivitasDataKapal
    {
        ...
        // Constructor
        public SubaktivitasDataKapalEditBase()
        {
        ...
        // Constructor
        public SubaktivitasDataKapalEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubaktivitasDataKapalList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubaktivitasDataKapalList") {
                                ...
                                returnUrl = "SubaktivitasDataKapalList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            if (!nominasi.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("nominasi") && !CurrentForm.HasValue("x_nominasi")) // DN
                    ...
                    nominasi.SetFormValue(val, true, validate);
            }
