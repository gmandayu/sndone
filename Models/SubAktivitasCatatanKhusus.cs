...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasCatatanKhusus
    /// </summary>
    [MaybeNull]
    public static SubAktivitasCatatanKhusus subAktivitasCatatanKhusus
    {
        get => HttpData.Resolve<SubAktivitasCatatanKhusus>("SubAktivitasCatatanKhusus");
        set => HttpData["SubAktivitasCatatanKhusus"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasCatatanKhusus
    /// </summary>
    public class SubAktivitasCatatanKhusus : DbTable
    {
        ...
        public readonly DbField<SqlDbType> Kontaminasi;

        public readonly DbField<SqlDbType> Insident;

        public readonly DbField<SqlDbType> CuacaBuruk;
        ...
        // Constructor
        public SubAktivitasCatatanKhusus()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasCatatanKhusus";
            Name = "SubAktivitasCatatanKhusus";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasCatatanKhusus"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NoReferensi", NoReferensi);

            // Kontaminasi
            Kontaminasi = new(this, "x_Kontaminasi", 202, SqlDbType.NVarChar) {
                Name = "Kontaminasi",
                Expression = "[Kontaminasi]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Kontaminasi]",
                DateTimeFormat = -1,
                VirtualExpression = "[Kontaminasi]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "Kontaminasi", "CustomMsg"),
                IsUpload = false
            };
            Kontaminasi.Lookup = new Lookup<DbField>(Kontaminasi, "SubAktivitasCatatanKhusus", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Kontaminasi.GetEditCustomAttributes = () => "disabled data-can-edit=\"1\"";
            Fields.Add("Kontaminasi", Kontaminasi);

            // Insident
            Insident = new(this, "x_Insident", 202, SqlDbType.NVarChar) {
                Name = "Insident",
                Expression = "[Insident]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Insident]",
                DateTimeFormat = -1,
                VirtualExpression = "[Insident]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "Insident", "CustomMsg"),
                IsUpload = false
            };
            Insident.Lookup = new Lookup<DbField>(Insident, "SubAktivitasCatatanKhusus", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Insident.GetEditCustomAttributes = () => "disabled data-can-edit=\"1\"";
            Fields.Add("Insident", Insident);

            // CuacaBuruk
            CuacaBuruk = new(this, "x_CuacaBuruk", 202, SqlDbType.NVarChar) {
                Name = "CuacaBuruk",
                Expression = "[CuacaBuruk]",
                UseBasicSearch = true,
                BasicSearchExpression = "[CuacaBuruk]",
                DateTimeFormat = -1,
                VirtualExpression = "[CuacaBuruk]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "CuacaBuruk", "CustomMsg"),
                IsUpload = false
            };
            CuacaBuruk.Lookup = new Lookup<DbField>(CuacaBuruk, "SubAktivitasCatatanKhusus", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            CuacaBuruk.GetEditCustomAttributes = () => "disabled data-can-edit=\"1\"";
            Fields.Add("CuacaBuruk", CuacaBuruk);
            ...
            Keterangan = new(this, "x_Keterangan", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "Keterangan", "CustomMsg"),
                IsUpload = false
            };
            Keterangan.GetEditCustomAttributes = () => "disabled data-can-edit=\"1\"";
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasCatatanKhusus", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasCatatanKhusus";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasCatatanKhusus type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Kontaminasi.DbValue = row["Kontaminasi"]; // Set DB value only
                Insident.DbValue = row["Insident"]; // Set DB value only
                CuacaBuruk.DbValue = row["CuacaBuruk"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasCatatanKhususList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasCatatanKhususView" => Language.Phrase("View"),
                "SubAktivitasCatatanKhususEdit" => Language.Phrase("Edit"),
                "SubAktivitasCatatanKhususAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasCatatanKhususView",
                Config.ApiAddAction => "SubAktivitasCatatanKhususAdd",
                Config.ApiEditAction => "SubAktivitasCatatanKhususEdit",
                Config.ApiDeleteAction => "SubAktivitasCatatanKhususDelete",
                Config.ApiListAction => "SubAktivitasCatatanKhususList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasCatatanKhususList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasCatatanKhususView", parm);
            else
                url = KeyUrl("SubAktivitasCatatanKhususView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasCatatanKhususAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasCatatanKhususAdd?" + parm;
            else
                url = "SubAktivitasCatatanKhususAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasCatatanKhususEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasCatatanKhususList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasCatatanKhususAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasCatatanKhususList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasCatatanKhususDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasCatatanKhususList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // Kontaminasi
            Kontaminasi.SetupEditAttributes();
            Kontaminasi.EditCustomAttributes = Kontaminasi.GetEditCustomAttributes();
            Kontaminasi.EditValue = Kontaminasi.Options(true);
            Kontaminasi.PlaceHolder = RemoveHtml(Kontaminasi.Caption);

            // Insident
            Insident.SetupEditAttributes();
            Insident.EditCustomAttributes = Insident.GetEditCustomAttributes();
            Insident.EditValue = Insident.Options(true);
            Insident.PlaceHolder = RemoveHtml(Insident.Caption);

            // CuacaBuruk
            CuacaBuruk.SetupEditAttributes();
            CuacaBuruk.EditCustomAttributes = CuacaBuruk.GetEditCustomAttributes();
            CuacaBuruk.EditValue = CuacaBuruk.Options(true);
            CuacaBuruk.PlaceHolder = RemoveHtml(CuacaBuruk.Caption);

            // Keterangan
            Keterangan.SetupEditAttributes();
            Keterangan.EditCustomAttributes = Keterangan.GetEditCustomAttributes();
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(Kontaminasi);
                        doc.ExportCaption(Insident);
                        doc.ExportCaption(CuacaBuruk);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(Kontaminasi);
                            await doc.ExportField(Insident);
                            await doc.ExportField(CuacaBuruk);
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew) {
            ...
            try 
            {
                var nomorReferensi = rsnew.ContainsKey("NoReferensi") ? rsnew["NoReferensi"].ToString() : rsold["NoReferensi"].ToString();
                var plantTimeObj = ExecuteScalar("EXEC dbo.GetPlantDateTime @NomorReferensi = '" + nomorReferensi + "';");
                DateTime dt = DateTime.Now;
                if (plantTimeObj != null && DateTime.TryParse(plantTimeObj.ToString(), out var tmp))
                    dt = tmp;
                rsnew["LastUpdatedBy"] = CurrentUserName();
                rsnew["lastUpdatedDate"] = dt;
            }
            catch (Exception ex)
            {
                Log("[ERR] RowUpdating: " + ex.Message);
