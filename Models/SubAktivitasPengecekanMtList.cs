...
public partial class SnDOne {
    ...
    public class SubAktivitasPengecekanMtListBase : SubAktivitasPengecekanMt
    {
        ...
        // Constructor
        public SubAktivitasPengecekanMtListBase(Controller? controller)
        {
        ...
        // Constructor
        public SubAktivitasPengecekanMtListBase() : this(null) { }
...
private StringValues GetKeys(Dictionary<string, string>? dict)
{
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private void ProcessFieldFilters(Dictionary<string, string>? filter)
        {
            ...
            if (filter.TryGetValue("x_JamPemeriksaan", out sv)) {
                RestoreFieldFilter(JamPemeriksaan, filter, "JamPemeriksaan", sv);
            }
