...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputDataMobilTangkiAddBase : SubAktivitasFormInputDataMobilTangki
    {
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiAddBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputDataMobilTangkiAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("SubAktivitasFormInputDataMobilTangkiList"); // No matching record, return to List page // DN
                    }
                    break;
                    ...
                    if (res) { // Add successful
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputDataMobilTangkiList") {
                                ...
                                returnUrl = "SubAktivitasFormInputDataMobilTangkiList"; // Return list page content
                            }
                        }
