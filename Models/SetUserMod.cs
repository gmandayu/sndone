...
public partial class SnDOne {
    ...
    /// </summary>
    [MaybeNull]
    public static SetUserMod setUserMod
    {
        get => HttpData.Resolve<SetUserMod>("SetUserMOD");
        set => HttpData["SetUserMOD"] = value;
    }

    /// <summary>
    /// Table class for SetUserMOD
    /// </summary>
    public class SetUserMod : DbTable
    {
        ...
        public readonly DbField<SqlDbType> LookupUserMod;

        public readonly DbField<SqlDbType> UserMOD;
        ...
        public SetUserMod()
        {
            ...
            Name = "SetUserMOD";
            Type = "TABLE";
            UpdateTable = "dbo.SetUserMOD"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SetUserMOD", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            id.Lookup = new Lookup<DbField>(id, "SetUserMOD", true, "id", new List<string> {"id", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("id", id);
            ...
            Tanggal = new(this, "x_Tanggal", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("SetUserMOD", "Tanggal", "CustomMsg"),
                IsUpload = false
            };
            Tanggal.Raw = true;
            Tanggal.Lookup = new Lookup<DbField>(Tanggal, "SetUserMOD", true, "Tanggal", new List<string> {"Tanggal", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LookupPlant = new(this, "x_LookupPlant", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SetUserMOD", "LookupPlant", "CustomMsg"),
                IsUpload = false
            };
            LookupPlant.Raw = true;
            LookupPlant.Lookup = new Lookup<DbField>(LookupPlant, "SetUserMOD", true, "LookupPlant", new List<string> {"LookupPlant", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Plant = new(this, "x_Plant", 3, SqlDbType.Int) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SetUserMOD", "Plant", "CustomMsg"),
                IsUpload = false
            };
            Plant.Raw = true;
            ...
            // LookupUserMod
            LookupUserMod = new(this, "x_LookupUserMod", 3, SqlDbType.Int) {
                Name = "LookupUserMod",
                Expression = "[LookupUserMod]",
                BasicSearchExpression = "CAST([LookupUserMod] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[LookupUserMod]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SetUserMOD", "LookupUserMod", "CustomMsg"),
                IsUpload = false
            };
            LookupUserMod.Raw = true;
            LookupUserMod.Lookup = new Lookup<DbField>(LookupUserMod, "SetUserMOD", true, "LookupUserMod", new List<string> {"LookupUserMod", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            Fields.Add("LookupUserMod", LookupUserMod);

            // UserMOD
            UserMOD = new(this, "x_UserMOD", 3, SqlDbType.Int) {
                Name = "UserMOD",
                Expression = "[UserMOD]",
                UseBasicSearch = true,
                BasicSearchExpression = "CAST([UserMOD] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[UserMOD]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SetUserMOD", "UserMOD", "CustomMsg"),
                IsUpload = false
            };
            UserMOD.Raw = true;
            UserMOD.Lookup = new Lookup<DbField>(UserMOD, "MasterUser", true, "IdUser", new List<string> {"NamaLengkap", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[NamaLengkap]");
            Fields.Add("UserMOD", UserMOD);
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SetUserMOD", "userInput", "CustomMsg"),
                IsUpload = false
            };
            userInput.Lookup = new Lookup<DbField>(userInput, "SetUserMOD", true, "userInput", new List<string> {"userInput", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SetUserMOD", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            etlDate.Lookup = new Lookup<DbField>(etlDate, "SetUserMOD", true, "etlDate", new List<string> {"etlDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SetUserMOD", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            LastUpdatedBy.Lookup = new Lookup<DbField>(LastUpdatedBy, "SetUserMOD", true, "LastUpdatedBy", new List<string> {"LastUpdatedBy", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SetUserMOD", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            lastUpdatedDate.Raw = true;
            lastUpdatedDate.Lookup = new Lookup<DbField>(lastUpdatedDate, "SetUserMOD", true, "lastUpdatedDate", new List<string> {"lastUpdatedDate", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SetUserMod type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                LookupUserMod.DbValue = row["LookupUserMod"]; // Set DB value only
                UserMOD.DbValue = row["UserMOD"]; // Set DB value only
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SetUserModView" => Language.Phrase("View"),
                "SetUserModEdit" => Language.Phrase("Edit"),
                "SetUserModAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SetUserModView",
                Config.ApiAddAction => "SetUserModAdd",
                Config.ApiEditAction => "SetUserModEdit",
                Config.ApiDeleteAction => "SetUserModDelete",
                Config.ApiListAction => "SetUserModList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SetUserModList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SetUserModView", parm);
            else
                url = KeyUrl("SetUserModView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SetUserModAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SetUserModEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SetUserModList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SetUserModAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SetUserModList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SetUserModDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SetUserModList";
        ...
        public async Task RenderListRow()
        {
            ...
            LookupUserMod.TooltipValue = "";

            // UserMOD
            UserMOD.HrefValue = "";
            UserMOD.TooltipValue = "";
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(LookupPlant);
                        doc.ExportCaption(Plant);
                        doc.ExportCaption(LookupUserMod);
                        doc.ExportCaption(UserMOD);
                        doc.ExportCaption(userInput);
                        doc.ExportCaption(etlDate);
                        doc.ExportCaption(LastUpdatedBy);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(LookupPlant);
                            await doc.ExportField(Plant);
                            await doc.ExportField(LookupUserMod);
                            await doc.ExportField(UserMOD);
                            await doc.ExportField(userInput);
                            await doc.ExportField(etlDate);
                            await doc.ExportField(LastUpdatedBy);
        ...
        // Row Inserting (SetUserMOD) — Plant = IdPlant (lookup), map ke kode Plant + rule 1 Plant/1 Hari
        public bool RowInserting(Dictionary<string, object>? rsold, Dictionary<string, object> rsnew)
        {
            try
            {
                ...
                // --- 1) Ambil & validasi IdPlant (wajib) ---
                string idPlant = "";

                // Field Plant pada form adalah LINK FIELD (IdPlant)
                if (rsnew.TryGetValue("Plant", out var plantVal) && plantVal != null && !Empty(plantVal))
                    idPlant = Convert.ToString(plantVal)?.Trim() ?? "";

                // ambil tanggal
                // DateTime tglSet = DateTime.Today;
                // if (rsnew.TryGetValue("Tanggal", out var vTglNew) && vTglNew != null && DateTime.TryParse(Convert.ToString(vTglNew), out var tglBaru))
                //     tglSet = tglBaru.Date;
                // else if (rsold.TryGetValue("Tanggal", out var vTglOld) && vTglOld != null && DateTime.TryParse(Convert.ToString(vTglOld), out var tglLama))
                //     tglSet = tglLama.Date;
                // else
                //     tglSet = plantTime.Date;

                // Fallback kalau dikirim sebagai IdPlant
                if (string.IsNullOrEmpty(idPlant) &&
                    rsnew.TryGetValue("IdPlant", out var vIdPlant) && vIdPlant != null && !Empty(vIdPlant))
                ...
                // var exists = Convert.ToInt32(conn.ExecuteScalar(@"
                //     SELECT COUNT(1)
                //     FROM dbo.SetUserMOD WITH (NOLOCK)
                //     WHERE Plant = @p0
                //       AND CAST(Tanggal AS date) = @p1",
                //     new { p0 = plantVal, p1 = tglSet.Date }
                // )) > 0;

                // if (exists)
                // {
                //     CancelMessage = "Sudah ada penetapan MOD untuk Plant dan tanggal tersebut.";
                //     return false;
                // }
                ...
                // --- 3) Map IdPlant -> kode Plant (yang akan disimpan di kolom Plant) ---
                string plantCode = Convert.ToString(conn.ExecuteScalar(
                    "SELECT TOP 1 Plant FROM dbo.MasterPlant WHERE IdPlant = @p0",
                    new { p0 = idPlant }
                )) ?? "";
                if (string.IsNullOrEmpty(plantCode))
                {
                    CancelMessage = "Plant tidak valid.";
                    return false;
                }
                // rsnew["Plant"] = plantCode; // simpan kode Plant, bukan IdPlant

                // --- 4) Tanggal (boleh diisi user, default = plantTime) ---
                DateTime tanggalFinal;
                if (rsnew.TryGetValue("Tanggal", out var tglVal) && tglVal != null && !Empty(tglVal))
                {
                    if (!DateTime.TryParse(Convert.ToString(tglVal), out tanggalFinal))
                    {
                        CancelMessage = "Format Tanggal tidak valid.";
                        return false;
                    }
                    rsnew["Tanggal"] = tanggalFinal; // pakai input user
                }
                else
                {
                    tanggalFinal = plantTime;
                    rsnew["Tanggal"] = plantTime;
                }

                // --- 6) Audit fields (readonly) ---
                rsnew["userInput"]       = CurrentUserName();
                rsnew["etlDate"]         = plantTime;
                rsnew["LastUpdatedBy"]   = CurrentUserName();
                rsnew["lastUpdatedDate"] = plantTime;

                // --- 7) Aturan "1 Plant / 1 Hari" (berdasarkan kode Plant & tanggal) ---
                bool exists = Convert.ToInt32(conn.ExecuteScalar(@"
                    SELECT COUNT(1)
                    FROM dbo.SetUserMOD WITH (NOLOCK)
                    WHERE Plant = @p0
                      AND CAST(Tanggal AS date) = @p1",
                    new { p0 = idPlant, p1 = tanggalFinal.Date }
                )) > 0;
                if (exists)
                {
                    CancelMessage = $"Sudah ada penetapan MOD untuk Plant dan tanggal tersebut.";
                ...
                // (Opsional, aktifkan jika wajib 1 plant yg sama untuk user terpilih)
                // if (rsnew.TryGetValue("UserMOD", out var vUserMod) && vUserMod != null && !Empty(vUserMod)) {
                //     var userPlant = Convert.ToString(conn.ExecuteScalar(
                //         "SELECT TOP 1 Plant FROM dbo.MasterUser WHERE IdUser = @p0 AND StatusAktif = 1",
                //         new { p0 = vUserMod }
                //     )) ?? "";
                //     if (!userPlant.Equals(plantCode, StringComparison.OrdinalIgnoreCase)) {
                //         CancelMessage = "User MOD yang dipilih tidak sesuai Plant.";
                //         return false;
                //     }
                // }
            }
            ...
            {
                Log("Error in SetUserMOD Row_Inserting: " + ex.Message);
                CancelMessage = "Gagal menyimpan data SetUserMOD: " + ex.Message;
                return false;
            }
            return true;
        }
        ...
        public bool RowUpdating(Dictionary<string, object> rsold, Dictionary<string, object> rsnew)
        {
            try
            {
                ...
                // --- 1) Ambil IdPlant (dari nilai baru; kalau kosong pakai lama) ---
                string idPlant = "";
                if (rsold.TryGetValue("Tanggal", out var dateNowString))
                {
                    if (DateTime.TryParse(Convert.ToString(dateNowString), out DateTime tanggalData))
                    {
                        DateTime today = DateTime.Today;
                        if (tanggalData < today)
                        {
                            CancelMessage = "Tidak dapat melakukan perubahan data dengan tanggal yang sudah lewat.";
                            return false;
                        }
                    }
                }
                // Field Plant datang sebagai link field lookup (IdPlant)
                if (rsnew.TryGetValue("Plant", out var vPlantNew) && vPlantNew != null && !Empty(vPlantNew))
                    idPlant = Convert.ToString(vPlantNew)?.Trim() ?? "";

                // Fallback: bila IdPlant dipost terpisah (mis. "IdPlant")
                if (string.IsNullOrEmpty(idPlant) && rsnew.TryGetValue("IdPlant", out var vIdPlantNew) && vIdPlantNew != null && !Empty(vIdPlantNew))
                    idPlant = Convert.ToString(vIdPlantNew)?.Trim() ?? "";

                // Jika tetap kosong, ambil dari record lama (catatan: di lama biasanya sudah berupa KODE plant, jadi perlu diterjemahkan ke IdPlant jika perlu)
                if (string.IsNullOrEmpty(idPlant))
                {
                    // Coba baca dari old value "Plant" (bisa berisi kode Plant)
                    string? oldPlant = Convert.ToString(rsold.TryGetValue("Plant", out var op) ? op : null);

                    // Jika oldPlant adalah kode Plant, terjemahkan ke IdPlant
                    if (!Empty(oldPlant))
                    {
                        var idPlantObj = conn.ExecuteScalar(
                            "SELECT TOP 1 IdPlant FROM dbo.MasterPlant WHERE Plant = @p0 OR CONVERT(varchar(50), IdPlant) = @p0",
                            new { p0 = oldPlant }
                        );
                        if (idPlantObj != null)
                            idPlant = Convert.ToString(idPlantObj);
                    }
                }
                if (string.IsNullOrEmpty(idPlant))
                {
                ...
                // --- 2) Ambil waktu lokal plant untuk audit ---
                DateTime plantTime = DateTime.Now;
                var plantObj = conn.ExecuteScalar("EXEC dbo.GetPlantDateTime @IdPlant = @p0", new { p0 = idPlant });
                if (plantObj != null && DateTime.TryParse(Convert.ToString(plantObj), out var tmpTime))
                    plantTime = tmpTime;

                // --- 3) (Opsional tapi disarankan) Validasi: UserMOD harus berasal dari Plant yang sama ---
                //      Jika kolom UserMOD diubah atau Plant diubah, pastikan MasterUser.Plant == kode Plant yang dipilih
                // bool plantChanged = rsnew.ContainsKey("Plant");
                // bool userChanged  = rsnew.ContainsKey("UserMOD");

                // if (plantChanged || userChanged)
                // {
                //     // Ambil kode Plant (string) dari MasterPlant berdasarkan IdPlant baru
                //     string? kodePlantBaru = Convert.ToString(conn.ExecuteScalar(
                //         "SELECT Plant FROM dbo.MasterPlant WHERE IdPlant = @p0", new { p0 = idPlant }
                //     ));

                //     // Jika user tidak berubah, pakai nilai lama
                //     string idUserMod = Convert.ToString(
                //         userChanged ? rsnew["UserMOD"] : (rsold.TryGetValue("UserMOD", out var uo) ? uo : null)
                //     );

                //     if (!Empty(idUserMod) && !Empty(kodePlantBaru))
                //     {
                //         // Pastikan user kandidat memang punya Plant yang sama
                //         var userPlant = Convert.ToString(conn.ExecuteScalar(
                //             "SELECT TOP 1 Plant FROM dbo.MasterUser WHERE IdUser = @p0 AND StatusAktif = 1",
                //             new { p0 = idUserMod }
                //         ));

                //         if (!string.Equals(userPlant?.Trim(), kodePlantBaru?.Trim(), StringComparison.OrdinalIgnoreCase))
                //         {
                //             CancelMessage = "User MOD yang dipilih tidak sesuai Plant.";
                //             return false;
                //         }
                ...
                //     // Sinkronkan nilai yang disimpan di kolom Plant menjadi kode Plant
                //     if (!Empty(kodePlantBaru))
                //         rsnew["Plant"] = kodePlantBaru!;
                // }

                // --- 4) (Disarankan) Jaga aturan “1 Plant / 1 Hari” ---
                // Tentukan tanggal (tanpa jam) yang akan berlaku sesudah update
                // Jika field Tanggal diedit, gunakan nilainya; jika tidak, pakai lama.
                DateTime tglSet = DateTime.Today;
                if (rsnew.TryGetValue("Tanggal", out var vTglNew) && vTglNew != null && DateTime.TryParse(Convert.ToString(vTglNew), out var tglBaru))
                    tglSet = tglBaru.Date;
                else if (rsold.TryGetValue("Tanggal", out var vTglOld) && vTglOld != null && DateTime.TryParse(Convert.ToString(vTglOld), out var tglLama))
                ...
                // Ambil kodePlant tujuan untuk pengecekan unik
                string kodePlantForCheck = Convert.ToString(
                    rsnew.ContainsKey("Plant") ? rsnew["Plant"] :
                    (rsold.TryGetValue("Plant", out var vp) ? vp : "")
                ) ?? "";

                // Cek ada baris lain (bukan current id) dengan Plant & Tanggal yang sama
                var currentId = Convert.ToInt64(rsold["id"]);
                if (rsold.TryGetValue("Tanggal", out var oldDateString) && oldDateString != null &&
                    rsnew.TryGetValue("Tanggal", out var newDateString) && newDateString != null &&
                    DateTime.TryParse(Convert.ToString(oldDateString), out var oldDate) &&
                    DateTime.TryParse(Convert.ToString(newDateString), out var newDate))
                {
                    // Ambil hanya bagian tanggal (tanpa waktu)
                    var tanggalLama = oldDate.Date;
                    var tanggalBaru = newDate.Date;
                    if (tanggalLama != tanggalBaru)
                    {
                        var exists = Convert.ToInt32(conn.ExecuteScalar(@"
                            ...
                            AND CAST(Tanggal AS date) = @p1
                            AND id <> @p2",
                            new { p0 = kodePlantForCheck, p1 = tglSet.Date, p2 = currentId }
                        )) > 0;
                        if (exists)
                        {
                            CancelMessage = "Sudah ada penetapan MOD untuk Plant dan tanggal tersebut.";
                ...
                // etlDate & userInput bersifat read-only → tidak diubah di sini
                // (Jika ingin segarkan etlDate saat update, uncomment baris berikut)
                // rsnew["etlDate"] = plantTime;
                return true;
            }
            catch (Exception ex)
            {
                Log("Error in SetUserMOD Row_Updating: " + ex.Message);
        ...
        public bool RowDeleting(Dictionary<string, object> rs) {
            ...
            if (rs.TryGetValue("Tanggal", out var dateNowString))
            {
                if (DateTime.TryParse(Convert.ToString(dateNowString), out DateTime tanggalData))
                {
                    DateTime today = DateTime.Today;
                    if (tanggalData < today)
                    {
                        CancelMessage = "Data dengan tanggal yang sudah lewat tidak dapat dihapus.";
                        return false;
                    }
                }
            }
        ...
        public void RowRendered() {
            // Plant tampilkan kode + nama terminal
