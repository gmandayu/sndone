...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiSfbdlpgEdit
    /// </summary>
    public static SubAktivitasNilaiSfbdlpgEdit subAktivitasNilaiSfbdlpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiSfbdlpgEdit>("subAktivitasNilaiSfbdlpgEdit")!;
        set => HttpData["subAktivitasNilaiSfbdlpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiSFBDLPG
    /// </summary>
    public class SubAktivitasNilaiSfbdlpgEdit : SubAktivitasNilaiSfbdlpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiSfbdlpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiSfbdlpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiSfbdlpgEditBase : SubAktivitasNilaiSfbdlpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiSfbdlpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiSfbdlpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiSfbdlpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiSfbdlpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiSfbdlpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiSfbdlpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiSfbdlpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiSfbdlpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiSfbdlpgList")), "", TableVar, true);
            string pageId = "edit";
