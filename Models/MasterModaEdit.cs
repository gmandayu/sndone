...
public partial class SnDOne {
    ...
    public class MasterModaEditBase : MasterModa
    {
        ...
        // Constructor
        public MasterModaEditBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterModaEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<ActionSetupResult> SetupCurrentAction()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("IdModa", out rv)) {
                    IdModa.FormValue = UrlDecode(rv);
                ...
                if (!Empty(Post("action"))) {
                    ...
                    if (RouteValues.TryGetValue("IdModa", out rv)) {
                        IdModa.QueryValue = UrlDecode(rv);
                        loadByQuery = true;
