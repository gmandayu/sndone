...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputHasilPemeriksaanPipaEditBase : SubAktivitasFormInputHasilPemeriksaanPipa
    {
        ...
        // Constructor
        public SubAktivitasFormInputHasilPemeriksaanPipaEditBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputHasilPemeriksaanPipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasFormInputHasilPemeriksaanPipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasFormInputHasilPemeriksaanPipaList") {
                                ...
                                returnUrl = "SubAktivitasFormInputHasilPemeriksaanPipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
