...
public partial class SnDOne {
    ...
    public class SubAktivitasStopPenyaluranPipaEditBase : SubAktivitasStopPenyaluranPipa
    {
        ...
        // Constructor
        public SubAktivitasStopPenyaluranPipaEditBase()
        {
        ...
        // Constructor
        public SubAktivitasStopPenyaluranPipaEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasStopPenyaluranPipaList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasStopPenyaluranPipaList") {
                                ...
                                returnUrl = "SubAktivitasStopPenyaluranPipaList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
