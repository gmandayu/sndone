...
public partial class SnDOne {
    ...
    public class SubAktivitasDataMobilTangkiMtGateOutEditBase : SubAktivitasDataMobilTangkiMtGateOut
    {
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOutEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataMobilTangkiMtGateOutList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataMobilTangkiMtGateOutList") {
                                ...
                                returnUrl = "SubAktivitasDataMobilTangkiMtGateOutList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
