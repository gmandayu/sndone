...
public partial class SnDOne {
    ...
    public class SubAkivitasNilaiAktualDischargePipaLpgEditBase : SubAkivitasNilaiAktualDischargePipaLpg
    {
        ...
        // Constructor
        public SubAkivitasNilaiAktualDischargePipaLpgEditBase()
        {
        ...
        // Constructor
        public SubAkivitasNilaiAktualDischargePipaLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAkivitasNilaiAktualDischargePipaLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAkivitasNilaiAktualDischargePipaLpgList") {
                                ...
                                returnUrl = "SubAkivitasNilaiAktualDischargePipaLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
