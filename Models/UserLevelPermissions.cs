...
public partial class SnDOne {
    ...
    public class UserLevelPermissions : DbTable
    {
        ...
        public UserLevelPermissions()
        {
            ...
            _TableName.Raw = true;
            _TableName.Lookup = new Lookup<DbField>(_TableName, "UserLevelPermissions", true, "TableName", new List<string> {"TableName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
            ...
            Permission.Raw = true;
            Permission.Lookup = new Lookup<DbField>(Permission, "UserLevelPermissions", true, "Permission", new List<string> {"Permission", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "");
