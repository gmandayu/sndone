...
public partial class SnDOne {
    ...
    public class AktivitasDokumenViewBase : AktivitasDokumen
    {
        ...
        // Constructor
        public AktivitasDokumenViewBase(Controller? controller)
        {
        ...
        // Constructor
        public AktivitasDokumenViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdAktivitasDokumen", out v) && !Empty(v))
                {
                IdAktivitasDokumen.QueryValue = UrlDecode(v);
                RecordKeys["IdAktivitasDokumen"] = IdAktivitasDokumen.QueryValue;
                return;
                }
                if (Get("IdAktivitasDokumen", out sv))
                {
            ...
            if (!loadCurrentRecord)
                returnUrl = "AktivitasDokumenList";
        }
