...
public partial class SnDOne {
    ...
    public class SubAktivitasTotalPenyaluranEditBase : SubAktivitasTotalPenyaluran
    {
        ...
        // Constructor
        public SubAktivitasTotalPenyaluranEditBase()
        {
        ...
        // Constructor
        public SubAktivitasTotalPenyaluranEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasTotalPenyaluranList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasTotalPenyaluranList") {
                                ...
                                returnUrl = "SubAktivitasTotalPenyaluranList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
