...
public partial class SnDOne {
    ...
    public class MasterDokumenViewBase : MasterDokumen
    {
        ...
        // Constructor
        public MasterDokumenViewBase(Controller? controller)
        {
        ...
        // Constructor
        public MasterDokumenViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("IdDokumen", out v) && !Empty(v))
                {
                IdDokumen.QueryValue = UrlDecode(v);
                RecordKeys["IdDokumen"] = IdDokumen.QueryValue;
                return;
                }
                if (Get("IdDokumen", out sv))
                {
        ...
        private IActionResult NoRecordResult()
        {
            ...
            return Terminate("MasterDokumenList");
        }
