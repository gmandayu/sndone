...
public partial class SnDOne {
    ...
    public class SubAktivitasHasilPemeriksaanStslpgEditBase : SubAktivitasHasilPemeriksaanStslpg
    {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanStslpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasHasilPemeriksaanStslpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasHasilPemeriksaanStslpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasHasilPemeriksaanStslpgList") {
                                ...
                                returnUrl = "SubAktivitasHasilPemeriksaanStslpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
