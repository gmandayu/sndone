...
public partial class SnDOne {
    /// <summary>
    /// subaktivitasNilaiSfblstsPymBbmEdit
    /// </summary>
    public static SubaktivitasNilaiSfblstsPymBbmEdit subaktivitasNilaiSfblstsPymBbmEdit
    {
        get => HttpData.Get<SubaktivitasNilaiSfblstsPymBbmEdit>("subaktivitasNilaiSfblstsPymBbmEdit")!;
        set => HttpData["subaktivitasNilaiSfblstsPymBbmEdit"] = value;
    }

    /// <summary>
    /// Page class for SubaktivitasNilaiSFBLSTSPymBBM
    /// </summary>
    public class SubaktivitasNilaiSfblstsPymBbmEdit : SubaktivitasNilaiSfblstsPymBbmEditBase
    {
        // Constructor
        public SubaktivitasNilaiSfblstsPymBbmEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubaktivitasNilaiSfblstsPymBbmEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubaktivitasNilaiSfblstsPymBbmEditBase : SubaktivitasNilaiSfblstsPymBbm
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subaktivitasNilaiSfblstsPymBbmEdit";
        ...
        // Constructor
        public SubaktivitasNilaiSfblstsPymBbmEditBase(Controller? controller)
        {
            TableName = "SubaktivitasNilaiSFBLSTSPymBBM";
        ...
        if (controller != null)
            ...
            // Table object (subaktivitasNilaiSfblstsPymBbm)
            if (subaktivitasNilaiSfblstsPymBbm == null || subaktivitasNilaiSfblstsPymBbm is SubaktivitasNilaiSfblstsPymBbm)
                subaktivitasNilaiSfblstsPymBbm = this;
        ...
        // Page name
        public string PageName => "SubaktivitasNilaiSfblstsPymBbmEdit";
        ...
        // Constructor
        public SubaktivitasNilaiSfblstsPymBbmEditBase() : this(null) { }
            ...
            string pageName = GetPageName(url);
                ...
                // List / View / Master View page
                    if (!SameString(pageName, ListUrl))
                    {
                        ...
                        result.Add("view", pageName == "SubaktivitasNilaiSfblstsPymBbmView" ? "1" : "0"); // If View page, no primary button
                    }
                    else
                    {
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubaktivitasNilaiSfblstsPymBbmList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubaktivitasNilaiSfblstsPymBbmList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubaktivitasNilaiSfblstsPymBbmList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subaktivitasNilaiSfblstsPymBbmEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected async Task LoadFormValues() {
            ...
            // Standard handling for 'klobs'
            klobs.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(klobs, "klobs", "x_klobs");

            // Standard handling for 'kl15'
            kl15.MultiUpdate = string.Empty; // initialize (will be set later for update control if needed)
            SetNormalField(kl15, "kl15", "x_kl15");
        ...
        public void RestoreFormValues()
        {
            ...
            klobs.CurrentValue = klobs.FormValue;
            kl15.CurrentValue = kl15.FormValue;
        ...
        public async Task RenderRow()
        {
            ...
            // klobs
            klobs.RowCssClass = "row";

            // kl15
            kl15.RowCssClass = "row";
            ...
            if (RowType == RowType.View) {
                ...
                klobs.EditValue = HtmlEncode(klobs.CurrentValue);
                ...
                kl15.EditValue = HtmlEncode(kl15.CurrentValue);
        ...
        private void ValidateCustomidProses() {
            if (idProses.Visible && idProses.Required) {
                if (!idProses.IsDetailKey && Empty(idProses.FormValue)) {
                    idProses.AddErrorMessage(ConvertToString(mt.RequiredErrorMessage).Replace("%s", mt.Caption));
                }
            }
        }
        ...
        private void ValidateCustomidAktifitas() {
            if (idAktifitas.Visible && idAktifitas.Required) {
                if (!idAktifitas.IsDetailKey && Empty(idAktifitas.FormValue)) {
                    idAktifitas.AddErrorMessage(ConvertToString(mt.RequiredErrorMessage).Replace("%s", mt.Caption));
                }
            }
        }
        ...
        private void ValidateCustomNoReferensi() {
            if (NoReferensi.Visible && NoReferensi.Required) {
                if (!NoReferensi.IsDetailKey && Empty(NoReferensi.FormValue)) {
                    NoReferensi.AddErrorMessage(ConvertToString(mt.RequiredErrorMessage).Replace("%s", mt.Caption));
                }
            }
        }
        ...
        private void ValidateCustomlastUpdatedDate() {
            if (lastUpdatedDate.Visible && lastUpdatedDate.Required) {
                if (!lastUpdatedDate.IsDetailKey && Empty(lastUpdatedDate.FormValue)) {
                    lastUpdatedDate.AddErrorMessage(ConvertToString(mt.RequiredErrorMessage).Replace("%s", mt.Caption));
                }
            }
        }
        ...
        private void ValidateCustomLastUpdatedBy() {
            if (LastUpdatedBy.Visible && LastUpdatedBy.Required) {
                if (!LastUpdatedBy.IsDetailKey && Empty(LastUpdatedBy.FormValue)) {
                    LastUpdatedBy.AddErrorMessage(ConvertToString(mt.RequiredErrorMessage).Replace("%s", mt.Caption));
                }
            }
        }
        ...
        private void ValidateCustomStatusAktivitas() {
            if (StatusAktivitas.Visible && StatusAktivitas.Required) {
                if (!StatusAktivitas.IsDetailKey && Empty(StatusAktivitas.FormValue)) {
                    StatusAktivitas.AddErrorMessage(ConvertToString(mt.RequiredErrorMessage).Replace("%s", mt.Caption));
                }
            }
        }

        private void ValidateCustomklobs() {
            if (klobs.Visible && klobs.Required) {
                if (!klobs.IsDetailKey && Empty(klobs.FormValue)) {
                    klobs.AddErrorMessage(ConvertToString(mt.RequiredErrorMessage).Replace("%s", mt.Caption));
                }
            }
        }

        private void ValidateCustomkl15() {
            if (kl15.Visible && kl15.Required) {
                if (!kl15.IsDetailKey && Empty(kl15.FormValue)) {
                    kl15.AddErrorMessage(ConvertToString(mt.RequiredErrorMessage).Replace("%s", mt.Caption));
                }
            }
        }
        ...
        private void ValidateCustombarrels() {
            if (barrels.Visible && barrels.Required) {
                if (!barrels.IsDetailKey && Empty(barrels.FormValue)) {
                    barrels.AddErrorMessage(ConvertToString(mt.RequiredErrorMessage).Replace("%s", mt.Caption));
                }
            }
        }
        ...
        private void ValidateCustomlt() {
            if (lt.Visible && lt.Required) {
                if (!lt.IsDetailKey && Empty(lt.FormValue)) {
                    lt.AddErrorMessage(ConvertToString(mt.RequiredErrorMessage).Replace("%s", mt.Caption));
                }
            }
        }
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // klobs
            klobs.SetDbValue(rsnew, klobs.CurrentValue, klobs.ReadOnly);

            // kl15
            kl15.SetDbValue(rsnew, kl15.CurrentValue, kl15.ReadOnly);
        ...
        {
            object? value;
            if (row.TryGetValue("klobs", out value)) // klobs
                klobs.CurrentValue = value;
            if (row.TryGetValue("kl15", out value)) // kl15
                kl15.CurrentValue = value;
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubaktivitasNilaiSfblstsPymBbmList")), "", TableVar, true);
            string pageId = "edit";
