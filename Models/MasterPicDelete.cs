...
public partial class SnDOne {
    ...
    /// masterPicDelete
    /// </summary>
    public static MasterPicDelete masterPicDelete
    {
        get => HttpData.Get<MasterPicDelete>("masterPicDelete")!;
        set => HttpData["masterPicDelete"] = value;
    }

    /// <summary>
    /// Page class for MasterPIC
    /// </summary>
    public class MasterPicDelete : MasterPicDeleteBase
    {
        // Constructor
        public MasterPicDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MasterPicDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MasterPicDeleteBase : MasterPic
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "masterPicDelete";
        ...
        // Page name
        public string PageName => "MasterPicDelete";
        ...
        // Constructor
        public MasterPicDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("MasterPicList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("MasterPicList"); // Return to list
                }
            }
