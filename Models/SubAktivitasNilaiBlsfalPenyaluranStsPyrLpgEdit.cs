...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit
    /// </summary>
    public static SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit subAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit
    {
        get => HttpData.Get<SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit>("subAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit")!;
        set => HttpData["subAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasNilaiBLSFALPenyaluranSTSPyrLPG
    /// </summary>
    public class SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit : SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEditBase
    {
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEditBase : SubAktivitasNilaiBlsfalPenyaluranStsPyrLpg
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEditBase(Controller? controller)
        {
        ...
        // Page name
        public string PageName => "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit";
        ...
        // Constructor
        public SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgEditBase() : this(null) { }
    ...
    return Post("keys[]", out StringValues k) ? k : StringValues.Empty;
        ...
        private async Task<IActionResult?> HandleShowAction(bool loaded)
        {
            ...
            if (!loaded) {
                if (Empty(FailureMessage))
                    FailureMessage = Language.Phrase("NoRecord");
                return Terminate("SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgList");
            }
            return null;
        }
        ...
        private async Task<IActionResult?> HandleUpdateAction()
        {
            ...
            if (res) {
                ...
                if (IsModal && UseAjaxActions) {
                    IsModal = false;
                    if (GetPageName(returnUrl) != "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgList") {
                        TempData["Return-Url"] = returnUrl;
                        returnUrl = "SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgList";
                    }
                }
                if (IsJsonResponse()) {
                    ClearMessages();
        ...
        private void PageRunEnd()
        {
                    ...
                    if (!IsApi() && !IsTerminated) {
                        ...
                        // Page Render event
                        subAktivitasNilaiBlsfalPenyaluranStsPyrLpgEdit?.PageRender();
                    }
        }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("SubAktivitasNilaiBlsfalPenyaluranStsPyrLpgList")), "", TableVar, true);
            string pageId = "edit";
