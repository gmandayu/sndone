...
public partial class SnDOne {
    ...
    public class UserLevelPermissionsViewBase : UserLevelPermissions
    {
        ...
        // Constructor
        public UserLevelPermissionsViewBase(Controller? controller)
        {
        ...
        // Constructor
        public UserLevelPermissionsViewBase() : this(null) { }
...
protected string GetRecordKeyValue(Dictionary<string, object> dict) {
        ...
        private void ResolvePrimaryKeys(string[] keyValues, bool loadCurrentRecord, ref string returnUrl)
        {
            ...
            Microsoft.Extensions.Primitives.StringValues sv;
                if (RouteValues.TryGetValue("UserLevelID", out v) && !Empty(v))
                {
                UserLevelID.QueryValue = UrlDecode(v);
                RecordKeys["UserLevelID"] = UserLevelID.QueryValue;
                return;
                }
                if (Get("UserLevelID", out sv))
                {
                ...
                if (RouteValues.TryGetValue("_TableName", out v) && !Empty(v))
                {
                _TableName.QueryValue = UrlDecode(v);
                RecordKeys["_TableName"] = _TableName.QueryValue;
                return;
                }
                if (Get("_TableName", out sv))
                {
