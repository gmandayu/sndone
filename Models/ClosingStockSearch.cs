...
public partial class SnDOne {
    ...
    public class ClosingStockSearchBase : ClosingStock
    {
        ...
        // Constructor
        public ClosingStockSearchBase(Controller? controller)
        {
        ...
        // Constructor
        public ClosingStockSearchBase() : this(null) { }
...
private void ResolveLookupView(dynamic fld, string keyFieldName, string fallbackType = "auto")
{
    ...
    if (rswrk?.Count > 0 && fld.Lookup != null)
    {
        ...
        {
            if (!IsAddOrEdit && Form.ContainsKey("x_NomorClosingStock")) {
        ...
        {
            if (!IsAddOrEdit && Form.ContainsKey("x_TanggalClosingStock")) {
                TanggalClosingStock.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_TanggalClosingStock");
            }
        }
        ...
        private void LoadSearchOperatorTanggalClosingStock()
        {
            if (Form.ContainsKey("z_TanggalClosingStock"))
                TanggalClosingStock.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_TanggalClosingStock");
        }
        ...
        {
            if (!IsAddOrEdit && Form.ContainsKey("x_Produk")) {
                Produk.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_Produk");
            }
        }
        ...
        private void LoadSearchOperatorProduk()
        {
            if (Form.ContainsKey("z_Produk"))
                Produk.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_Produk");
        }
