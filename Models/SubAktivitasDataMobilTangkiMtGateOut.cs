...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasDataMobilTangkiMtGateOut
    /// </summary>
    [MaybeNull]
    public static SubAktivitasDataMobilTangkiMtGateOut subAktivitasDataMobilTangkiMtGateOut
    {
        get => HttpData.Resolve<SubAktivitasDataMobilTangkiMtGateOut>("SubAktivitasDataMobilTangkiMTGateOut");
        set => HttpData["SubAktivitasDataMobilTangkiMTGateOut"] = value;
    }

    /// <summary>
    /// Table class for SubAktivitasDataMobilTangkiMTGateOut
    /// </summary>
    public class SubAktivitasDataMobilTangkiMtGateOut : DbTable
    {
        ...
        public readonly DbField<SqlDbType> WaktuGateOut;

        // Constructor
        public SubAktivitasDataMobilTangkiMtGateOut()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "SubAktivitasDataMobilTangkiMTGateOut";
            Name = "SubAktivitasDataMobilTangkiMTGateOut";
            Type = "TABLE";
            UpdateTable = "dbo.SubAktivitasDataMobilTangkiMTGateOut"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new(this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "id", "CustomMsg"),
                IsUpload = false
            };
            id.Raw = true;
            Fields.Add("id", id);
            ...
            NoReferensi = new(this, "x_NoReferensi", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "NoReferensi", "CustomMsg"),
                IsUpload = false
            };
            ...
            idProses = new(this, "x_idProses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "idProses", "CustomMsg"),
                IsUpload = false
            };
            idProses.Raw = true;
            ...
            idAktifitas = new(this, "x_idAktifitas", 3, SqlDbType.Int) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "idAktifitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            StatusAktivitas = new(this, "x_StatusAktivitas", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "StatusAktivitas", "CustomMsg"),
                IsUpload = false
            };
            ...
            LastUpdatedBy = new(this, "x_LastUpdatedBy", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "LastUpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            lastUpdatedDate = new(this, "x_lastUpdatedDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "lastUpdatedDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            NomorPolisi = new(this, "x_NomorPolisi", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "NomorPolisi", "CustomMsg"),
                IsUpload = false
            };
            ...
            AMT = new(this, "x_AMT", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "AMT", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AMT", AMT);
            ...
            NomorSegel = new(this, "x_NomorSegel", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "NomorSegel", "CustomMsg"),
                IsUpload = false
            };
            ...
            userInput = new(this, "x_userInput", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "userInput", "CustomMsg"),
                IsUpload = false
            };
            ...
            etlDate = new(this, "x_etlDate", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "etlDate", "CustomMsg"),
                IsUpload = false
            };
            etlDate.Raw = true;
            ...
            // WaktuGateOut
            WaktuGateOut = new(this, "x_WaktuGateOut", 135, SqlDbType.DateTime) {
                Name = "WaktuGateOut",
                Expression = "[WaktuGateOut]",
                BasicSearchExpression = CastDateFieldForLike("[WaktuGateOut]", 9, "DB"),
                DateTimeFormat = 9,
                VirtualExpression = "[WaktuGateOut]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(9)),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"],
                CustomMessage = Language.FieldPhrase("SubAktivitasDataMobilTangkiMTGateOut", "WaktuGateOut", "CustomMsg"),
                IsUpload = false
            };
            WaktuGateOut.Raw = true;
            Fields.Add("WaktuGateOut", WaktuGateOut);
        ...
        {
            get => _sqlFrom ?? "dbo.SubAktivitasDataMobilTangkiMTGateOut";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.SubAktivitasDataMobilTangkiMtgateOut type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                WaktuGateOut.DbValue = row["WaktuGateOut"]; // Set DB value only
            } catch {}
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "SubAktivitasDataMobilTangkiMtGateOutList";
                }
            }
            set {
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "SubAktivitasDataMobilTangkiMtGateOutView" => Language.Phrase("View"),
                "SubAktivitasDataMobilTangkiMtGateOutEdit" => Language.Phrase("Edit"),
                "SubAktivitasDataMobilTangkiMtGateOutAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubAktivitasDataMobilTangkiMtGateOutView",
                Config.ApiAddAction => "SubAktivitasDataMobilTangkiMtGateOutAdd",
                Config.ApiEditAction => "SubAktivitasDataMobilTangkiMtGateOutEdit",
                Config.ApiDeleteAction => "SubAktivitasDataMobilTangkiMtGateOutDelete",
                Config.ApiListAction => "SubAktivitasDataMobilTangkiMtGateOutList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "SubAktivitasDataMobilTangkiMtGateOutList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("SubAktivitasDataMobilTangkiMtGateOutView", parm);
            else
                url = KeyUrl("SubAktivitasDataMobilTangkiMtGateOutView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "SubAktivitasDataMobilTangkiMtGateOutAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "SubAktivitasDataMobilTangkiMtGateOutAdd?" + parm;
            else
                url = "SubAktivitasDataMobilTangkiMtGateOutAdd";
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataMobilTangkiMtGateOutEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataMobilTangkiMtGateOutList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("SubAktivitasDataMobilTangkiMtGateOutAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("SubAktivitasDataMobilTangkiMtGateOutList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("SubAktivitasDataMobilTangkiMtGateOutDelete", parm)); // DN
        }
        ...
        {
            string pageName = "SubAktivitasDataMobilTangkiMtGateOutList";
        ...
        public async Task RenderEditRow()
        {
            ...
            NomorSegel.EditValue = NomorSegel.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(WaktuGateOut);
                    } else {
                        doc.ExportCaption(id);
                        doc.ExportCaption(NoReferensi);
                        doc.ExportCaption(idProses);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(WaktuGateOut);
                        } else {
                            await doc.ExportField(id);
                            await doc.ExportField(NoReferensi);
                            await doc.ExportField(idProses);
