...
public partial class SnDOne {
    ...
    public class SubAktivitasFormInputNilaiARsesuaiCqdTruckViewBase : SubAktivitasFormInputNilaiARsesuaiCqdTruck
    {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckViewBase()
        {
        ...
        // Constructor
        public SubAktivitasFormInputNilaiARsesuaiCqdTruckViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SubAktivitasFormInputNilaiARsesuaiCqdTruckList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SubAktivitasFormInputNilaiARsesuaiCqdTruckList"); // Return to list page
                            }
                        }
                    break;
            }
