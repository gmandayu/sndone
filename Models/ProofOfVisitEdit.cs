...
public partial class SnDOne {
    ...
    /// proofOfVisitEdit
    /// </summary>
    public static ProofOfVisitEdit proofOfVisitEdit
    {
        get => HttpData.Get<ProofOfVisitEdit>("proofOfVisitEdit")!;
        set => HttpData["proofOfVisitEdit"] = value;
    }

    /// <summary>
    /// Page class for ProofOfVisit
    /// </summary>
    public class ProofOfVisitEdit : ProofOfVisitEditBase
    {
        // Constructor
        public ProofOfVisitEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ProofOfVisitEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ProofOfVisitEditBase : ProofOfVisit
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "proofOfVisitEdit";
        ...
        // Page name
        public string PageName => "ProofOfVisitEdit";
        ...
        {
            IdProofOfVisit.SetVisibility();
            NomorProofOfVisit.SetVisibility();
            LinkRedirect.Visible = false;
            LookupPlant.Visible = false;
            Plant.SetVisibility();
            JumlahKetidaksesuaiaan.Visible = false;
            TotalPengisian.Visible = false;
        ...
        // Constructor
        public ProofOfVisitEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsApi()) {
                ...
                if (RouteValues.TryGetValue("IdProofOfVisit", out rv)) { // DN
                    IdProofOfVisit.FormValue = UrlDecode(rv); // DN
                    IdProofOfVisit.OldValue = IdProofOfVisit.FormValue;
                } else if (CurrentForm.HasValue("x_IdProofOfVisit")) {
                    IdProofOfVisit.FormValue = CurrentForm.GetValue("x_IdProofOfVisit");
                    IdProofOfVisit.OldValue = IdProofOfVisit.FormValue;
                } else if (!Empty(keyValues)) {
                    IdProofOfVisit.OldValue = ConvertToString(keyValues[0]);
                } else {
                ...
                if (!Empty(Post("action"))) {
                    ...
                    if (RouteValues.TryGetValue("IdProofOfVisit", out rv)) { // DN
                        IdProofOfVisit.QueryValue = UrlDecode(rv); // DN
                        loadByQuery = true;
                    } else if (Get("IdProofOfVisit", out sv)) {
                        IdProofOfVisit.QueryValue = sv.ToString();
                        loadByQuery = true;
                    } else {
                        IdProofOfVisit.CurrentValue = DbNullValue;
                    }
                }
        ...
        if (postBack) {
            ...
            if (IsApi() && RouteValues.TryGetValue("key", out object? k)) {
                ...
                IdProofOfVisit.FormValue = ConvertToString(keyValues[0]);
            }
        }
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("ProofOfVisitList"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = ReturnUrl;
                    if (GetPageName(returnUrl) == "ProofOfVisitList")
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "ProofOfVisitList") {
                                ...
                                returnUrl = "ProofOfVisitList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
        ...
        protected async Task LoadFormValues() {
            ...
            // Check field name 'IdProofOfVisit' before field var 'x_IdProofOfVisit'
            val = CurrentForm.HasValue("IdProofOfVisit") ? CurrentForm.GetValue("IdProofOfVisit") : CurrentForm.GetValue("x_IdProofOfVisit");
            if (!IdProofOfVisit.IsDetailKey)
                IdProofOfVisit.SetFormValue(val);

            // Check field name 'NomorProofOfVisit' before field var 'x_NomorProofOfVisit'
            val = CurrentForm.HasValue("NomorProofOfVisit") ? CurrentForm.GetValue("NomorProofOfVisit") : CurrentForm.GetValue("x_NomorProofOfVisit");
            if (!NomorProofOfVisit.IsDetailKey) {
                if (IsApi() && !CurrentForm.HasValue("NomorProofOfVisit") && !CurrentForm.HasValue("x_NomorProofOfVisit")) // DN
                    NomorProofOfVisit.Visible = false; // Disable update for API request
                else
                    NomorProofOfVisit.SetFormValue(val);
            }
        ...
        {
            IdProofOfVisit.CurrentValue = IdProofOfVisit.FormValue;
            NomorProofOfVisit.CurrentValue = NomorProofOfVisit.FormValue;
        ...
        public async Task RenderRow()
        {
            ...
            // IdProofOfVisit
            IdProofOfVisit.RowCssClass = "row";

            // NomorProofOfVisit
            NomorProofOfVisit.RowCssClass = "row";
            ...
            JumlahKetidaksesuaiaan.RowCssClass = "row";

            // TotalPengisian
            TotalPengisian.RowCssClass = "row";
        ...
        protected async Task<bool> ValidateForm() {
            ...
            bool validateForm = true;
                if (IdProofOfVisit.Visible && IdProofOfVisit.Required) {
                    if (!IdProofOfVisit.IsDetailKey && Empty(IdProofOfVisit.FormValue)) {
                        IdProofOfVisit.AddErrorMessage(ConvertToString(IdProofOfVisit.RequiredErrorMessage).Replace("%s", IdProofOfVisit.Caption));
                    }
                }
                if (NomorProofOfVisit.Visible && NomorProofOfVisit.Required) {
                    if (!NomorProofOfVisit.IsDetailKey && Empty(NomorProofOfVisit.FormValue)) {
                        NomorProofOfVisit.AddErrorMessage(ConvertToString(NomorProofOfVisit.RequiredErrorMessage).Replace("%s", NomorProofOfVisit.Caption));
                    }
                }
        ...
        protected void SetupBreadcrumb()
        {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("ProofOfVisitList")), "", TableVar, true);
            string pageId = "edit";
