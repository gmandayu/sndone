...
public partial class SnDOne {
    ...
    public class SubAktivitasDataStopPenyaluranStsPyrLpgEditBase : SubAktivitasDataStopPenyaluranStsPyrLpg
    {
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranStsPyrLpgEditBase()
        {
        ...
        // Constructor
        public SubAktivitasDataStopPenyaluranStsPyrLpgEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("SubAktivitasDataStopPenyaluranStsPyrLpgList"); // No matching record, return to list
                        }
                    break;
                    ...
                    if (res) { // Update record based on key
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "SubAktivitasDataStopPenyaluranStsPyrLpgList") {
                                ...
                                returnUrl = "SubAktivitasDataStopPenyaluranStsPyrLpgList"; // Return list page content
                            }
                        }
                        if (IsJsonResponse()) {
