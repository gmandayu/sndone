...
public partial class SnDOne {
    /// <summary>
    /// subAktivitasFormInputNilaiAktDischargeRtwList
    /// </summary>
    public static SubAktivitasFormInputNilaiAktDischargeRtwList subAktivitasFormInputNilaiAktDischargeRtwList
    {
        get => HttpData.Get<SubAktivitasFormInputNilaiAktDischargeRtwList>("subAktivitasFormInputNilaiAktDischargeRtwList")!;
        set => HttpData["subAktivitasFormInputNilaiAktDischargeRtwList"] = value;
    }

    /// <summary>
    /// Page class for SubAktivitasFormInputNilaiAktDischargeRTW
    /// </summary>
    public class SubAktivitasFormInputNilaiAktDischargeRtwList : SubAktivitasFormInputNilaiAktDischargeRtwListBase
    {
        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubAktivitasFormInputNilaiAktDischargeRtwListBase : SubAktivitasFormInputNilaiAktDischargeRtw
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subAktivitasFormInputNilaiAktDischargeRtwList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fSubAktivitasFormInputNilaiAktDischargeRTWlist";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwListBase()
        {
            TableName = "SubAktivitasFormInputNilaiAktDischargeRTW";

            // CSS class name as context
            TableVar = "SubAktivitasFormInputNilaiAktDischargeRTW";
            ...
            // Initialize URLs
            AddUrl = "SubAktivitasFormInputNilaiAktDischargeRtwAdd";
            ...
            MultiDeleteUrl = "SubAktivitasFormInputNilaiAktDischargeRtwDelete";
            MultiUpdateUrl = "SubAktivitasFormInputNilaiAktDischargeRtwUpdate";
        ...
        // Page name
        public string PageName => "SubAktivitasFormInputNilaiAktDischargeRtwList";
        ...
        // Constructor
        public SubAktivitasFormInputNilaiAktDischargeRtwListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fSubAktivitasFormInputNilaiAktDischargeRTWgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subAktivitasFormInputNilaiAktDischargeRtwList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public string GetFilterList()
        {
            ...
            filters.Merge(JObject.Parse(StatusAktivitas.AdvancedSearch.ToJson())); // Field StatusAktivitas
            ...
            filters.Merge(JObject.Parse(Import.AdvancedSearch.ToJson())); // Field Import
            filters.Merge(JObject.Parse(ApakahAdaROB.AdvancedSearch.ToJson())); // Field ApakahAdaROB
            filters.Merge(JObject.Parse(Tujuan.AdvancedSearch.ToJson())); // Field Tujuan
            filters.Merge(JObject.Parse(SFAD_KLObs.AdvancedSearch.ToJson())); // Field SFAD_KLObs
            filters.Merge(JObject.Parse(SFAD_KL15.AdvancedSearch.ToJson())); // Field SFAD_KL15
            filters.Merge(JObject.Parse(SFAD_Barrels.AdvancedSearch.ToJson())); // Field SFAD_Barrels
            filters.Merge(JObject.Parse(SFAD_LT.AdvancedSearch.ToJson())); // Field SFAD_LT
            filters.Merge(JObject.Parse(SFAD_MT.AdvancedSearch.ToJson())); // Field SFAD_MT
            filters.Merge(JObject.Parse(NewBL_KLObs.AdvancedSearch.ToJson())); // Field NewBL_KLObs
            filters.Merge(JObject.Parse(NewBL_KL15.AdvancedSearch.ToJson())); // Field NewBL_KL15
            filters.Merge(JObject.Parse(NewBL_Barrels.AdvancedSearch.ToJson())); // Field NewBL_Barrels
            filters.Merge(JObject.Parse(NewBL_LT.AdvancedSearch.ToJson())); // Field NewBL_LT
            filters.Merge(JObject.Parse(NewBL_MT.AdvancedSearch.ToJson())); // Field NewBL_MT
            ...
            filters.Merge(JObject.Parse(AR45B_klobs.AdvancedSearch.ToJson())); // Field AR45B_klobs
            filters.Merge(JObject.Parse(AR45B_kl15.AdvancedSearch.ToJson())); // Field AR45B_kl15
            filters.Merge(JObject.Parse(AR45B_Barrel.AdvancedSearch.ToJson())); // Field AR45B_Barrel
            filters.Merge(JObject.Parse(AR45B_lt.AdvancedSearch.ToJson())); // Field AR45B_lt
            filters.Merge(JObject.Parse(AR45B_mt.AdvancedSearch.ToJson())); // Field AR45B_mt
        ...
        protected bool RestoreFilterList() {
            ...
            // Field NoReferensi
            if (filter?.TryGetValue("x_NoReferensi", out sv) ?? false) {
                NoReferensi.AdvancedSearch.SearchValue = sv;
                NoReferensi.AdvancedSearch.SearchOperator = filter["z_NoReferensi"];
                NoReferensi.AdvancedSearch.SearchCondition = filter["v_NoReferensi"];
                NoReferensi.AdvancedSearch.SearchValue2 = filter["y_NoReferensi"];
                NoReferensi.AdvancedSearch.SearchOperator2 = filter["w_NoReferensi"];
                NoReferensi.AdvancedSearch.Save();
            }

            // Field idProses
            if (filter?.TryGetValue("x_idProses", out sv) ?? false) {
                idProses.AdvancedSearch.SearchValue = sv;
                idProses.AdvancedSearch.SearchOperator = filter["z_idProses"];
                idProses.AdvancedSearch.SearchCondition = filter["v_idProses"];
                idProses.AdvancedSearch.SearchValue2 = filter["y_idProses"];
                idProses.AdvancedSearch.SearchOperator2 = filter["w_idProses"];
                idProses.AdvancedSearch.Save();
            }

            // Field idAktifitas
            if (filter?.TryGetValue("x_idAktifitas", out sv) ?? false) {
                idAktifitas.AdvancedSearch.SearchValue = sv;
                idAktifitas.AdvancedSearch.SearchOperator = filter["z_idAktifitas"];
                idAktifitas.AdvancedSearch.SearchCondition = filter["v_idAktifitas"];
                idAktifitas.AdvancedSearch.SearchValue2 = filter["y_idAktifitas"];
                idAktifitas.AdvancedSearch.SearchOperator2 = filter["w_idAktifitas"];
                idAktifitas.AdvancedSearch.Save();
            }

            // Field StatusAktivitas
            if (filter?.TryGetValue("x_StatusAktivitas", out sv) ?? false) {
                StatusAktivitas.AdvancedSearch.SearchValue = sv;
                StatusAktivitas.AdvancedSearch.SearchOperator = filter["z_StatusAktivitas"];
                StatusAktivitas.AdvancedSearch.SearchCondition = filter["v_StatusAktivitas"];
                StatusAktivitas.AdvancedSearch.SearchValue2 = filter["y_StatusAktivitas"];
                StatusAktivitas.AdvancedSearch.SearchOperator2 = filter["w_StatusAktivitas"];
                StatusAktivitas.AdvancedSearch.Save();
            }
            ...
            // Field Import
            if (filter?.TryGetValue("x_Import", out sv) ?? false) {
                Import.AdvancedSearch.SearchValue = sv;
                Import.AdvancedSearch.SearchOperator = filter["z_Import"];
                Import.AdvancedSearch.SearchCondition = filter["v_Import"];
                Import.AdvancedSearch.SearchValue2 = filter["y_Import"];
                Import.AdvancedSearch.SearchOperator2 = filter["w_Import"];
                Import.AdvancedSearch.Save();
            }

            // Field ApakahAdaROB
            if (filter?.TryGetValue("x_ApakahAdaROB", out sv) ?? false) {
                ApakahAdaROB.AdvancedSearch.SearchValue = sv;
                ApakahAdaROB.AdvancedSearch.SearchOperator = filter["z_ApakahAdaROB"];
                ApakahAdaROB.AdvancedSearch.SearchCondition = filter["v_ApakahAdaROB"];
                ApakahAdaROB.AdvancedSearch.SearchValue2 = filter["y_ApakahAdaROB"];
                ApakahAdaROB.AdvancedSearch.SearchOperator2 = filter["w_ApakahAdaROB"];
                ApakahAdaROB.AdvancedSearch.Save();
            }

            // Field Tujuan
            if (filter?.TryGetValue("x_Tujuan", out sv) ?? false) {
                Tujuan.AdvancedSearch.SearchValue = sv;
                Tujuan.AdvancedSearch.SearchOperator = filter["z_Tujuan"];
                Tujuan.AdvancedSearch.SearchCondition = filter["v_Tujuan"];
                Tujuan.AdvancedSearch.SearchValue2 = filter["y_Tujuan"];
                Tujuan.AdvancedSearch.SearchOperator2 = filter["w_Tujuan"];
                Tujuan.AdvancedSearch.Save();
            }

            // Field SFAD_KLObs
            if (filter?.TryGetValue("x_SFAD_KLObs", out sv) ?? false) {
                SFAD_KLObs.AdvancedSearch.SearchValue = sv;
                SFAD_KLObs.AdvancedSearch.SearchOperator = filter["z_SFAD_KLObs"];
                SFAD_KLObs.AdvancedSearch.SearchCondition = filter["v_SFAD_KLObs"];
                SFAD_KLObs.AdvancedSearch.SearchValue2 = filter["y_SFAD_KLObs"];
                SFAD_KLObs.AdvancedSearch.SearchOperator2 = filter["w_SFAD_KLObs"];
                SFAD_KLObs.AdvancedSearch.Save();
            }

            // Field SFAD_KL15
            if (filter?.TryGetValue("x_SFAD_KL15", out sv) ?? false) {
                SFAD_KL15.AdvancedSearch.SearchValue = sv;
                SFAD_KL15.AdvancedSearch.SearchOperator = filter["z_SFAD_KL15"];
                SFAD_KL15.AdvancedSearch.SearchCondition = filter["v_SFAD_KL15"];
                SFAD_KL15.AdvancedSearch.SearchValue2 = filter["y_SFAD_KL15"];
                SFAD_KL15.AdvancedSearch.SearchOperator2 = filter["w_SFAD_KL15"];
                SFAD_KL15.AdvancedSearch.Save();
            }

            // Field SFAD_Barrels
            if (filter?.TryGetValue("x_SFAD_Barrels", out sv) ?? false) {
                SFAD_Barrels.AdvancedSearch.SearchValue = sv;
                SFAD_Barrels.AdvancedSearch.SearchOperator = filter["z_SFAD_Barrels"];
                SFAD_Barrels.AdvancedSearch.SearchCondition = filter["v_SFAD_Barrels"];
                SFAD_Barrels.AdvancedSearch.SearchValue2 = filter["y_SFAD_Barrels"];
                SFAD_Barrels.AdvancedSearch.SearchOperator2 = filter["w_SFAD_Barrels"];
                SFAD_Barrels.AdvancedSearch.Save();
            }

            // Field SFAD_LT
            if (filter?.TryGetValue("x_SFAD_LT", out sv) ?? false) {
                SFAD_LT.AdvancedSearch.SearchValue = sv;
                SFAD_LT.AdvancedSearch.SearchOperator = filter["z_SFAD_LT"];
                SFAD_LT.AdvancedSearch.SearchCondition = filter["v_SFAD_LT"];
                SFAD_LT.AdvancedSearch.SearchValue2 = filter["y_SFAD_LT"];
                SFAD_LT.AdvancedSearch.SearchOperator2 = filter["w_SFAD_LT"];
                SFAD_LT.AdvancedSearch.Save();
            }

            // Field SFAD_MT
            if (filter?.TryGetValue("x_SFAD_MT", out sv) ?? false) {
                SFAD_MT.AdvancedSearch.SearchValue = sv;
                SFAD_MT.AdvancedSearch.SearchOperator = filter["z_SFAD_MT"];
                SFAD_MT.AdvancedSearch.SearchCondition = filter["v_SFAD_MT"];
                SFAD_MT.AdvancedSearch.SearchValue2 = filter["y_SFAD_MT"];
                SFAD_MT.AdvancedSearch.SearchOperator2 = filter["w_SFAD_MT"];
                SFAD_MT.AdvancedSearch.Save();
            }

            // Field NewBL_KLObs
            if (filter?.TryGetValue("x_NewBL_KLObs", out sv) ?? false) {
                NewBL_KLObs.AdvancedSearch.SearchValue = sv;
                NewBL_KLObs.AdvancedSearch.SearchOperator = filter["z_NewBL_KLObs"];
                NewBL_KLObs.AdvancedSearch.SearchCondition = filter["v_NewBL_KLObs"];
                NewBL_KLObs.AdvancedSearch.SearchValue2 = filter["y_NewBL_KLObs"];
                NewBL_KLObs.AdvancedSearch.SearchOperator2 = filter["w_NewBL_KLObs"];
                NewBL_KLObs.AdvancedSearch.Save();
            }

            // Field NewBL_KL15
            if (filter?.TryGetValue("x_NewBL_KL15", out sv) ?? false) {
                NewBL_KL15.AdvancedSearch.SearchValue = sv;
                NewBL_KL15.AdvancedSearch.SearchOperator = filter["z_NewBL_KL15"];
                NewBL_KL15.AdvancedSearch.SearchCondition = filter["v_NewBL_KL15"];
                NewBL_KL15.AdvancedSearch.SearchValue2 = filter["y_NewBL_KL15"];
                NewBL_KL15.AdvancedSearch.SearchOperator2 = filter["w_NewBL_KL15"];
                NewBL_KL15.AdvancedSearch.Save();
            }

            // Field NewBL_Barrels
            if (filter?.TryGetValue("x_NewBL_Barrels", out sv) ?? false) {
                NewBL_Barrels.AdvancedSearch.SearchValue = sv;
                NewBL_Barrels.AdvancedSearch.SearchOperator = filter["z_NewBL_Barrels"];
                NewBL_Barrels.AdvancedSearch.SearchCondition = filter["v_NewBL_Barrels"];
                NewBL_Barrels.AdvancedSearch.SearchValue2 = filter["y_NewBL_Barrels"];
                NewBL_Barrels.AdvancedSearch.SearchOperator2 = filter["w_NewBL_Barrels"];
                NewBL_Barrels.AdvancedSearch.Save();
            }

            // Field NewBL_LT
            if (filter?.TryGetValue("x_NewBL_LT", out sv) ?? false) {
                NewBL_LT.AdvancedSearch.SearchValue = sv;
                NewBL_LT.AdvancedSearch.SearchOperator = filter["z_NewBL_LT"];
                NewBL_LT.AdvancedSearch.SearchCondition = filter["v_NewBL_LT"];
                NewBL_LT.AdvancedSearch.SearchValue2 = filter["y_NewBL_LT"];
                NewBL_LT.AdvancedSearch.SearchOperator2 = filter["w_NewBL_LT"];
                NewBL_LT.AdvancedSearch.Save();
            }

            // Field NewBL_MT
            if (filter?.TryGetValue("x_NewBL_MT", out sv) ?? false) {
                NewBL_MT.AdvancedSearch.SearchValue = sv;
                NewBL_MT.AdvancedSearch.SearchOperator = filter["z_NewBL_MT"];
                NewBL_MT.AdvancedSearch.SearchCondition = filter["v_NewBL_MT"];
                NewBL_MT.AdvancedSearch.SearchValue2 = filter["y_NewBL_MT"];
                NewBL_MT.AdvancedSearch.SearchOperator2 = filter["w_NewBL_MT"];
                NewBL_MT.AdvancedSearch.Save();
            }

            // Field userInput
            if (filter?.TryGetValue("x_userInput", out sv) ?? false) {
                userInput.AdvancedSearch.SearchValue = sv;
                userInput.AdvancedSearch.SearchOperator = filter["z_userInput"];
                userInput.AdvancedSearch.SearchCondition = filter["v_userInput"];
                userInput.AdvancedSearch.SearchValue2 = filter["y_userInput"];
                userInput.AdvancedSearch.SearchOperator2 = filter["w_userInput"];
                userInput.AdvancedSearch.Save();
            }
            ...
            // Field AR45B_klobs
            if (filter?.TryGetValue("x_AR45B_klobs", out sv) ?? false) {
                AR45B_klobs.AdvancedSearch.SearchValue = sv;
                AR45B_klobs.AdvancedSearch.SearchOperator = filter["z_AR45B_klobs"];
                AR45B_klobs.AdvancedSearch.SearchCondition = filter["v_AR45B_klobs"];
                AR45B_klobs.AdvancedSearch.SearchValue2 = filter["y_AR45B_klobs"];
                AR45B_klobs.AdvancedSearch.SearchOperator2 = filter["w_AR45B_klobs"];
                AR45B_klobs.AdvancedSearch.Save();
            }

            // Field AR45B_kl15
            if (filter?.TryGetValue("x_AR45B_kl15", out sv) ?? false) {
                AR45B_kl15.AdvancedSearch.SearchValue = sv;
                AR45B_kl15.AdvancedSearch.SearchOperator = filter["z_AR45B_kl15"];
                AR45B_kl15.AdvancedSearch.SearchCondition = filter["v_AR45B_kl15"];
                AR45B_kl15.AdvancedSearch.SearchValue2 = filter["y_AR45B_kl15"];
                AR45B_kl15.AdvancedSearch.SearchOperator2 = filter["w_AR45B_kl15"];
                AR45B_kl15.AdvancedSearch.Save();
            }

            // Field AR45B_Barrel
            if (filter?.TryGetValue("x_AR45B_Barrel", out sv) ?? false) {
                AR45B_Barrel.AdvancedSearch.SearchValue = sv;
                AR45B_Barrel.AdvancedSearch.SearchOperator = filter["z_AR45B_Barrel"];
                AR45B_Barrel.AdvancedSearch.SearchCondition = filter["v_AR45B_Barrel"];
                AR45B_Barrel.AdvancedSearch.SearchValue2 = filter["y_AR45B_Barrel"];
                AR45B_Barrel.AdvancedSearch.SearchOperator2 = filter["w_AR45B_Barrel"];
                AR45B_Barrel.AdvancedSearch.Save();
            }

            // Field AR45B_lt
            if (filter?.TryGetValue("x_AR45B_lt", out sv) ?? false) {
                AR45B_lt.AdvancedSearch.SearchValue = sv;
                AR45B_lt.AdvancedSearch.SearchOperator = filter["z_AR45B_lt"];
                AR45B_lt.AdvancedSearch.SearchCondition = filter["v_AR45B_lt"];
                AR45B_lt.AdvancedSearch.SearchValue2 = filter["y_AR45B_lt"];
                AR45B_lt.AdvancedSearch.SearchOperator2 = filter["w_AR45B_lt"];
                AR45B_lt.AdvancedSearch.Save();
            }

            // Field AR45B_mt
            if (filter?.TryGetValue("x_AR45B_mt", out sv) ?? false) {
                AR45B_mt.AdvancedSearch.SearchValue = sv;
                AR45B_mt.AdvancedSearch.SearchOperator = filter["z_AR45B_mt"];
                AR45B_mt.AdvancedSearch.SearchCondition = filter["v_AR45B_mt"];
                AR45B_mt.AdvancedSearch.SearchValue2 = filter["y_AR45B_mt"];
                AR45B_mt.AdvancedSearch.SearchOperator2 = filter["w_AR45B_mt"];
                AR45B_mt.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(Import);
            searchFlds.Add(Tujuan);
            searchFlds.Add(SFAD_KLObs);
            searchFlds.Add(SFAD_KL15);
            searchFlds.Add(SFAD_Barrels);
            searchFlds.Add(SFAD_LT);
            searchFlds.Add(SFAD_MT);
            searchFlds.Add(NewBL_KLObs);
            searchFlds.Add(NewBL_KL15);
            searchFlds.Add(NewBL_Barrels);
            searchFlds.Add(NewBL_LT);
            searchFlds.Add(NewBL_MT);
            searchFlds.Add(userInput);
            searchFlds.Add(AR45B_klobs);
            searchFlds.Add(AR45B_kl15);
            searchFlds.Add(AR45B_Barrel);
            searchFlds.Add(AR45B_lt);
            searchFlds.Add(AR45B_mt);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(Import, ctrl); // Import
                UpdateSort(ApakahAdaROB, ctrl); // ApakahAdaROB
                UpdateSort(Tujuan, ctrl); // Tujuan
                UpdateSort(SFAD_KLObs, ctrl); // SFAD_KLObs
                UpdateSort(SFAD_KL15, ctrl); // SFAD_KL15
                UpdateSort(SFAD_Barrels, ctrl); // SFAD_Barrels
                UpdateSort(SFAD_LT, ctrl); // SFAD_LT
                UpdateSort(SFAD_MT, ctrl); // SFAD_MT
                UpdateSort(NewBL_KLObs, ctrl); // NewBL_KLObs
                UpdateSort(NewBL_KL15, ctrl); // NewBL_KL15
                UpdateSort(NewBL_Barrels, ctrl); // NewBL_Barrels
                UpdateSort(NewBL_LT, ctrl); // NewBL_LT
                UpdateSort(NewBL_MT, ctrl); // NewBL_MT
                UpdateSort(userInput, ctrl); // userInput
                UpdateSort(etlDate, ctrl); // etlDate
                UpdateSort(AR45B_klobs, ctrl); // AR45B_klobs
                UpdateSort(AR45B_kl15, ctrl); // AR45B_kl15
                UpdateSort(AR45B_Barrel, ctrl); // AR45B_Barrel
                UpdateSort(AR45B_lt, ctrl); // AR45B_lt
                UpdateSort(AR45B_mt, ctrl); // AR45B_mt
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""SubAktivitasFormInputNilaiAktDischargeRTW"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""SubAktivitasFormInputNilaiAktDischargeRTW"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalAdd && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-copy"" title=""{copycaption}"" data-table=""SubAktivitasFormInputNilaiAktDischargeRTW"" data-caption=""{copycaption}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(CopyUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("CopyLink") + "</a>");
                else
                    ...
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        if (action != "") {
                            ...
                            string link = disabled
                                ...
                                : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + title + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputNilaiAktDischargeRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + " " + caption + "</button></li>";
                            if (!Empty(link)) {
                                links.Add(link);
                                if (Empty(body)) // Setup first button
                                    body = disabled
                                    ? "<div class=\"alert alert-light\">" + icon + " " + caption + "</div>"
                                    : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputNilaiAktDischargeRTWlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttributes() + ">" + icon + caption + "</button>";
                            }
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            if (ModalAdd && !IsMobile())
                item.Body = $@"<a class=""ew-add-edit ew-add"" title=""{addTitle}"" data-table=""SubAktivitasFormInputNilaiAktDischargeRTW"" data-caption=""{addTitle}"" data-ew-action=""modal"" data-action=""add"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(AddUrl)) + "\" data-btn=\"AddBtn\">" + Language.Phrase("AddLink") + "</a>";
            else
            ...
            item.Body = $@"<button type=""button"" class=""ew-action ew-multi-delete"" title=""{deleteTitle}"" data-caption=""{deleteTitle}"" form=""fSubAktivitasFormInputNilaiAktDischargeRTWlist""" +
            ...
            if (UseColumnVisibility) {
                ...
                CreateColumnOption(option.Add("Import")); // DN
                CreateColumnOption(option.Add("ApakahAdaROB")); // DN
                CreateColumnOption(option.Add("Tujuan")); // DN
                CreateColumnOption(option.Add("SFAD_KLObs")); // DN
                CreateColumnOption(option.Add("SFAD_KL15")); // DN
                CreateColumnOption(option.Add("SFAD_Barrels")); // DN
                CreateColumnOption(option.Add("SFAD_LT")); // DN
                CreateColumnOption(option.Add("SFAD_MT")); // DN
                CreateColumnOption(option.Add("NewBL_KLObs")); // DN
                CreateColumnOption(option.Add("NewBL_KL15")); // DN
                CreateColumnOption(option.Add("NewBL_Barrels")); // DN
                CreateColumnOption(option.Add("NewBL_LT")); // DN
                CreateColumnOption(option.Add("NewBL_MT")); // DN
                CreateColumnOption(option.Add("userInput")); // DN
                CreateColumnOption(option.Add("etlDate")); // DN
                CreateColumnOption(option.Add("AR45B_klobs")); // DN
                CreateColumnOption(option.Add("AR45B_kl15")); // DN
                CreateColumnOption(option.Add("AR45B_Barrel")); // DN
                CreateColumnOption(option.Add("AR45B_lt")); // DN
                CreateColumnOption(option.Add("AR45B_mt")); // DN
            }
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fSubAktivitasFormInputNilaiAktDischargeRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fSubAktivitasFormInputNilaiAktDischargeRTWsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fSubAktivitasFormInputNilaiAktDischargeRTWlist\"" + act.ToDataAttributes() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_SubAktivitasFormInputNilaiAktDischargeRTW");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(subAktivitasFormInputNilaiAktDischargeRtwList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(subAktivitasFormInputNilaiAktDischargeRtwList.RowCount) + "_SubAktivitasFormInputNilaiAktDischargeRTW");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(subAktivitasFormInputNilaiAktDischargeRtwList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && subAktivitasFormInputNilaiAktDischargeRtwList.RowType == RowType.Add || IsEdit && subAktivitasFormInputNilaiAktDischargeRtwList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                SFAD_KLObs.TooltipValue = "";

                // SFAD_KL15
                SFAD_KL15.HrefValue = "";
                SFAD_KL15.TooltipValue = "";

                // SFAD_Barrels
                SFAD_Barrels.HrefValue = "";
                SFAD_Barrels.TooltipValue = "";

                // SFAD_LT
                SFAD_LT.HrefValue = "";
                SFAD_LT.TooltipValue = "";

                // SFAD_MT
                SFAD_MT.HrefValue = "";
                SFAD_MT.TooltipValue = "";

                // NewBL_KLObs
                NewBL_KLObs.HrefValue = "";
                NewBL_KLObs.TooltipValue = "";

                // NewBL_KL15
                NewBL_KL15.HrefValue = "";
                NewBL_KL15.TooltipValue = "";

                // NewBL_Barrels
                NewBL_Barrels.HrefValue = "";
                NewBL_Barrels.TooltipValue = "";

                // NewBL_LT
                NewBL_LT.HrefValue = "";
                NewBL_LT.TooltipValue = "";

                // NewBL_MT
                NewBL_MT.HrefValue = "";
                NewBL_MT.TooltipValue = "";
                ...
                AR45B_klobs.TooltipValue = "";

                // AR45B_kl15
                AR45B_kl15.HrefValue = "";
                AR45B_kl15.TooltipValue = "";

                // AR45B_Barrel
                AR45B_Barrel.HrefValue = "";
                AR45B_Barrel.TooltipValue = "";

                // AR45B_lt
                AR45B_lt.HrefValue = "";
                AR45B_lt.TooltipValue = "";

                // AR45B_mt
                AR45B_mt.HrefValue = "";
                AR45B_mt.TooltipValue = "";
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"fSubAktivitasFormInputNilaiAktDischargeRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"fSubAktivitasFormInputNilaiAktDischargeRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"fSubAktivitasFormInputNilaiAktDischargeRTWlist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fSubAktivitasFormInputNilaiAktDischargeRTWsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
