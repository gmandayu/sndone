...
public partial class SnDOne {
    ...
    /// setUserModView
    /// </summary>
    public static SetUserModView setUserModView
    {
        get => HttpData.Get<SetUserModView>("setUserModView")!;
        set => HttpData["setUserModView"] = value;
    }

    /// <summary>
    /// Page class for SetUserMOD
    /// </summary>
    public class SetUserModView : SetUserModViewBase
    {
        // Constructor
        public SetUserModView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SetUserModView() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class SetUserModViewBase : SetUserMod
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "setUserModView";
        ...
        // Page name
        public string PageName => "SetUserModView";
        ...
        // Constructor
        public SetUserModViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "SetUserModList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("SetUserModList"); // Return to list page
                            }
                        }
                    break;
            }
